	...
	while (true)
	{
		...
		if (Global_14513.f_1 != 9)
		{
			...
			else if (Global_14495)
			{
				...
				{
					iLocal_53 = 1;
					func_62(Global_14494, iLocal_51);
				...
				else
				{
					...
					if (iLocal_54)
					{
						...
						if (iLocal_56 == -1)
						{
							...
							iVar0 = func_62(Global_14494, iLocal_51);
							func_61(Global_14494, "SET_HEADER", "EM_INBOX", 0, 0, 0, 0);
							iLocal_55 = 0;
							if (iVar0 > 0)
							{
							...
							func_72(1);
							func_71(0);
							func_60(Global_14494, "DISPLAY_VIEW", 8f, fLocal_66, -1082130432, -1082130432, -1082130432);
						}
						else
						{
							...
							if (iLocal_57 == -1)
							{
								...
								func_52(Global_14494, iLocal_51, iLocal_56);
								Global_16882 = 0;
							...
							else
							{
								...
								func_36(Global_14494, iLocal_51, iLocal_56);
								func_60(Global_14494, "DISPLAY_VIEW", 9f, -1082130432, -1082130432, -1082130432, -1082130432);
							}
						}
						iLocal_54 = 0;
			...
			else if (Global_15822 == 4 || Global_15822 == 3)
			{
				...
				else
				{
					...
					if (Global_106070.f_28022[Global_1698 /*29*/].f_24[Global_14513] == 0)
					{
						...
						func_9(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1698 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_60(Global_14494, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_9(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), &(Global_106070.f_28022[Global_1698 /*29*/].f_7), &cVar0, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), 0);
					}
				}
				func_60(Global_14494, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_9(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_13()
{
	...
	if (!iLocal_60)
	{
		...
		{
			iLocal_60 = 1;
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_14494, "SET_INPUT_EVENT");
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	...
	if (CONTROLS::IS_CONTROL_PRESSED(2, 179))
	{
		if (iLocal_64)
		{
			...
			StringCopy(&Global_68478, sLocal_65, 64);
			func_14(7, 0, 0);
			iLocal_64 = 0;
			func_33();
		}
...
void func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_28(Global_37284[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_28(Global_37284[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_24(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		{
			func_25(UI::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_26(iParam1)), 0));
		}
		switch (Global_14513)
		{
			case 0:
...
void func_36(var uParam0, int iParam1, int iParam2)
{
	...
	if (!Global_46222[iVar0 /*120*/].f_86[iVar2])
	{
		...
		while (iVar6 < iVar7)
		{
			...
			Var10 = { func_28(Global_37284[iVar8 /*12*/].f_1) };
...
void func_52(var uParam0, int iParam1, int iParam2)
{
	...
	if (!bVar5)
	{
		...
		Var8 = { func_28(Global_37284[iVar6 /*12*/].f_1) };
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0, "SET_DATA_SLOT");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(9);
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
		...
		if (Global_40609[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				iVar6 = Global_40609[iVar2 /*46*/].f_32[iVar10];
				Var7 = { func_28(Global_37284[iVar6 /*12*/]) };
				Var8 = { func_28(Global_37284[iVar6 /*12*/].f_1) };
				iVar12 = func_54(iParam1, Global_37284[iVar6 /*12*/].f_3);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0, "SET_DATA_SLOT");
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(9);
	...
	else
	{
		...
		while (iVar14 < 7)
		{
			if (Global_46584[iVar14 /*203*/].f_1 == iVar2)
			{
				iVar13 = iVar14;
			}
			iVar14++;
		...
		{
			iVar15 = Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/];
			iVar16 = Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/];
			Var17 = { func_28(Global_37284[iVar15 /*12*/]) };
			Var18 = { func_28(Global_37284[iVar15 /*12*/].f_1) };
			if (Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/].f_1)
			{
				MemCopy(&Var18, {Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/].f_2}, 16);
			}
			if (Global_37284[iVar15 /*12*/].f_4 == 0)
			{
				func_73(0);
			}
			else if (bVar1)
			...
			bVar19 = false;
			bVar19 = func_53(uParam0, Global_46584[iVar13 /*203*/].f_1, iVar3, iVar16);
			if (!bVar19)
			{
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0, "SET_DATA_SLOT");
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(9);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
				func_7(func_55(Global_37284[iVar15 /*12*/].f_3));
				func_7(func_55(Global_37284[iVar15 /*12*/].f_2));
				func_7(&Var17);
				if (Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6 > 0)
				{
					GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_46584[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				}
				...
				func_7(func_38(Global_37284[iVar15 /*12*/].f_2));
				func_37(iVar15, Global_37284[iVar15 /*12*/].f_2);
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			}
		}
	}
...
int func_53(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar5 < 16)
	{
		...
		{
			case 72:
				if (Global_106070.f_24876[iVar6 /*4*/] == 0)
				{
					bVar7 = true;
				}
				break;
			...
			case 73:
				if (Global_106070.f_24876[iVar6 /*4*/] == 1)
				{
					bVar7 = true;
				}
				break;
			...
			case 74:
				if (Global_106070.f_24876[iVar6 /*4*/] == 2)
				{
					bVar7 = true;
				}
				break;
		...
		if (bVar7)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(9);
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar2);
			GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("PROPR_INCEMAIL4");
			UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sVar8);
			UI::ADD_TEXT_COMPONENT_INTEGER(Global_106070.f_24876[iVar6 /*4*/].f_3);
			GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			iVar2++;
			iVar0 = 1;
...
int func_62(var uParam0, int iParam1)
{
	...
	while (iVar3 < iVar2)
	{
		...
		{
			iVar9 = Global_46222[iVar0 /*120*/].f_18[iVar1];
			iVar10 = -1;
			iVar11 = 0;
			iVar11 = 0;
			while (iVar11 < 7)
			{
				if (Global_46584[iVar11 /*203*/].f_1 == iVar9)
				{
					iVar10 = iVar11;
				}
				iVar11++;
			...
			{
				iVar12 = Global_46222[iVar0 /*120*/].f_1[iVar1];
				iVar13 = 0;
				if (Global_46222[iVar0 /*120*/].f_69[iVar1])
				{
					iVar13 = 1;
				}
				iVar14 = Global_46584[iVar10 /*203*/].f_10[iVar12 /*48*/];
				if (iVar13 == 1)
				{
					if (Global_37284[iVar14 /*12*/].f_4 > 0)
					{
						if (Global_46222[iVar0 /*120*/].f_35[iVar1] == 0)
						{
							iVar13 = 2;
				...
				Var15 = { func_28(Global_37284[iVar14 /*12*/]) };
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0, "SET_DATA_SLOT");
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(8);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar3);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar13);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
				func_7(func_55(Global_37284[iVar14 /*12*/].f_2));
				func_7(&Var15);
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			}
		}
...
void func_63(int iParam0)
{
	...
	while (iVar5 < iVar2)
	{
		...
		{
			iVar7 = Global_46222[iVar0 /*120*/].f_18[iVar3];
			iVar8 = -1;
			iVar9 = 0;
			iVar9 = 0;
			while (iVar9 < 7)
			{
				if (Global_46584[iVar9 /*203*/].f_1 == iVar7)
				{
					iVar8 = iVar9;
				}
				iVar9++;
		...
		{
			iVar10 = Var4;
			Var4.f_1[iVar10] = Global_46222[iVar0 /*120*/].f_1[iVar3];
			Var4.f_18[iVar10] = Global_46222[iVar0 /*120*/].f_18[iVar3];
			Var4.f_35[iVar10] = Global_46222[iVar0 /*120*/].f_35[iVar3];
			Var4.f_52[iVar10] = Global_46222[iVar0 /*120*/].f_52[iVar3];
			Var4.f_69[iVar10] = Global_46222[iVar0 /*120*/].f_69[iVar3];
			Var4.f_86[iVar10] = Global_46222[iVar0 /*120*/].f_86[iVar3];
			Var4++;
		}
		iVar3++;
		if (iVar3 == 16)
	...
	while (iVar5 < 16)
	{
		Global_46222[iVar0 /*120*/].f_103[iVar5] = 0;
		Global_46222[iVar0 /*120*/].f_1[iVar5] = Var4.f_1[iVar5];
		Global_46222[iVar0 /*120*/].f_18[iVar5] = Var4.f_18[iVar5];
		Global_46222[iVar0 /*120*/].f_35[iVar5] = Var4.f_35[iVar5];
		Global_46222[iVar0 /*120*/].f_52[iVar5] = Var4.f_52[iVar5];
		Global_46222[iVar0 /*120*/].f_69[iVar5] = Var4.f_69[iVar5];
		Global_46222[iVar0 /*120*/].f_86[iVar5] = Var4.f_86[iVar5];
		iVar5++;
	}
}
...
void func_64()
{
	...
	fVar0 = func_65(vLocal_48, vLocal_47, -90f, 0f, 90f, Global_14473, 350f, 0);
	if (Global_3187 == 0)
	{
...
float func_65(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_67((SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
		...
		Global_14441 = { func_66(vParam0, vParam1, fVar2) };
		Global_14444 = { func_66(vParam2, vParam3, fVar2) };
	}
	else
	{
...
void func_69()
{
	...
	fVar0 = func_65(vLocal_47, vLocal_48, Global_14473, -90f, 0f, 90f, 350f, 0);
	if (Global_3187 == 0)
	{
...
void func_71(bool bParam0)
{
	...
	if (bParam0)
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_14494, "SET_SOFT_KEYS");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
