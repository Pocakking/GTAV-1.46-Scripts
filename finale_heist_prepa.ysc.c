...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("M_STS", 0);
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_32();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_257))
			{
				func_30(sLocal_257);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				GAMEPLAY::CLEAR_AREA(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, false);
				func_2();
				func_389();
			}
			break;
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_19(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
void func_34()
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			{
				UNK1::_0x293220DA1B46CEBC(5f, 6f, 4);
				func_54();
				func_49();
			}
			break;
...
int func_57(int iParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vParam1, fParam10, fParam10, 2f, false, true, 2))
			{
				...
				{
					UI::CLEAR_THIS_PRINT(func_67(func_68()));
				}
				*iParam5 = 1;
	...
	else
	{
		...
		if (!*iParam6)
		{
			...
			{
				UI::CLEAR_THIS_PRINT(func_60(func_68(), 0));
			}
...
bool func_65(char* sParam0, int iParam1, char* sParam2)
{
		...
		case 0:
			...
			else if (func_81(1, vLocal_265, 0))
			{
				if (((func_81(2, Local_290.f_1, Local_290.f_4) && func_81(4, vLocal_265, 0)) && func_81(3, vLocal_265, 0)) && func_81(5, vLocal_265, 0))
				{
					...
					if (UI::GET_BLIP_FROM_ENTITY(Local_290) != 0)
					{
						iVar0 = UI::GET_BLIP_FROM_ENTITY(Local_290);
		...
		case 1:
			if (bParam1)
			{
				if (((func_81(2, Local_290.f_1, Local_290.f_4) && func_81(4, vLocal_265, 0)) && func_81(3, vLocal_265, 0)) && func_81(5, vLocal_265, 0))
				{
					...
					func_71();
					GAMEPLAY::CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_289[0 /*22*/].f_1, 5f, 0);
					func_76();
					func_74();
					bLocal_28 = false;
					func_35(1, 1, 1);
...
void func_71()
{
	...
	iLocal_467 = 1;
	func_373(27, 0);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35240[13 /*31*/], 4, 1, 0);
	iLocal_468 = 0;
}
...
void func_72()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
	...
	while (iVar0 <= 2)
	{
		...
		if (!func_77(Local_289[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					AI::TASK_START_SCENARIO_AT_POSITION(Local_289[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					AI::TASK_USE_MOBILE_PHONE(Local_289[iVar0 /*22*/], 1, 1);
					break;
				}
		}
...
int func_81(int iParam0, vector3 vParam1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_258, 0);
			UI::REQUEST_ADDITIONAL_TEXT(cLocal_293, 6);
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_89824.f_9[iVar0], 1))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_9[iVar0], 1, 1);
						Local_289[iVar0 /*22*/] = Global_89824.f_9[iVar0];
						if (func_370(Local_289[iVar0 /*22*/]))
						{
							PED::SET_PED_TARGET_LOSS_RESPONSE(Local_289[iVar0 /*22*/], 2);
							AUDIO::STOP_PED_SPEAKING(Local_289[iVar0 /*22*/], 1);
							func_86(iVar0);
							iVar1++;
						}
					}
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				if (func_7(Global_89824[iVar3]))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[iVar3], 1, 1);
					Local_291[iVar4 /*6*/] = Global_89824[iVar3];
		...
		switch (*iParam2)
		{
			case 0:
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0))
				{
					...
					if (func_65(func_59(func_68()), 0, 0))
					{
						UI::CLEAR_THIS_PRINT(func_59(func_68()));
					}
					if (*iParam0 == iParam6)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_60(func_68(), bParam7));
					}
					if (func_68() != 33)
					{
						func_93(iParam0);
...
int func_106(int iParam0, int iParam1)
{
	...
	{
		case 0:
			AI::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_266, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_43[iParam0] = 3;
			break;
...
int func_108(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_POSITION_OCCUPIED(Local_254[iLocal_470 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, 0, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
...
void func_119(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_77(Local_289[iParam0 /*22*/], -875674219))
					{
						PED::_0xF1C03A5352243A30(Local_289[iParam0 /*22*/]);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 0);
					}
					Local_289[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
				}
			}
			else
			{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 6000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 2))
				{
					func_126(iParam0);
					func_124();
					return;
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
				{
					Local_289[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9) && !bLocal_272)
					{
						func_126(iParam0);
						func_124();
						return;
		...
		case 6:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!PED::IS_PED_BEING_STUNNED(Local_289[iParam0 /*22*/], 0) && !AI::IS_PED_IN_WRITHE(Local_289[iParam0 /*22*/]))
				{
					Local_289[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
					func_126(iParam0);
				}
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 3000)
			{
				func_124();
				return;
			}
		...
		case 7:
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_274 && func_123(iParam0, 15))
				{
					func_72();
					func_133(iParam0);
					UI::_0xC594B315EDF2D4AF(Local_289[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_465 != -1)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_465) > 12000)
						{
							func_122(-1);
						}
					...
					if ((func_77(Local_289[iParam0 /*22*/], -2128726980) || func_77(Local_289[iParam0 /*22*/], -982327190)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
					{
						...
						{
							AI::TASK_ARREST_PED(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
						}
					}
				}
			}
			if (!iLocal_463)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1) && GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
int func_123(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_124()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_189(&(Local_289[iVar0 /*22*/].f_6));
			Local_289[iVar0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_126(int iParam0)
{
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_370(Local_289[iParam0 /*22*/]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
			}
...
void func_127(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !ENTITY::IS_ENTITY_DEAD(Local_289[iParam0 /*22*/], 0))
	{
		if (func_132(iParam0) && func_130(Local_289[iParam0 /*22*/], 30f))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 3))
			{
				iLocal_464 = 1;
			}
...
void func_133(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_18 != 1 && !func_77(Local_289[iParam0 /*22*/], 242628503))
	{
		...
		if (iParam0 == 2)
		{
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
				AI::TASK_ACHIEVE_HEADING(0, Local_289[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_459[2] && GAMEPLAY::IS_STRING_NULL_OR_EMPTY("sResumeRoot"))
			{
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			}
			else
			{
				AI::TASK_USE_MOBILE_PHONE(0, 1, 1);
			}
			AI::CLOSE_SEQUENCE_TASK(uVar0);
			AI::TASK_PERFORM_SEQUENCE(Local_289[iParam0 /*22*/], uVar0);
...
void func_134()
{
	if (func_12(&uLocal_46, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (!func_102())
		{
			if ((!GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_471, "NONE") && !GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_475, "NONE")) && !func_65("PR_TAKBACK", 0, 0))
			{
	...
	switch (Local_289[iParam0 /*22*/].f_21)
	{
		case 0:
			...
			else if (iParam0 == 2)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
					AI::TASK_START_SCENARIO_IN_PLACE(Local_289[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_171(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		...
		{
			if (Local_289[func_144(iParam0) /*22*/].f_20 != 3 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 7500)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_289[func_144(iParam0) /*22*/].f_20 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 7500)
			{
				if (!bLocal_273)
				{
					if (iParam0 == 0)
		...
		Local_289[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
		Local_289[func_144(iParam0) /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_172(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	Var0 = { func_175() };
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam1) || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Var0))
	{
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 7500)
			{
				if (!bLocal_272)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_289[iParam0 /*22*/].f_19 != 2 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_289[iParam0 /*22*/].f_19 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		if (bLocal_272)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12))
			{
				GAMEPLAY::SET_BIT(&(Local_289[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
	...
	if ((!func_143(iParam0) && Local_289[iParam0 /*22*/].f_20 != 6) && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				...
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0)) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 11))
				{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_281) > 4000)
			{
				iLocal_282 = 0;
			}
		}
...
{
	if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iParam1))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), iParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_180(int iParam0, int iParam1)
{
	if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iParam1))
	{
		GAMEPLAY::SET_BIT(&(Local_289[iParam0 /*22*/].f_15), iParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_184(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			...
			else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, true, 0) || GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12))
			{
				func_185(iParam0, iVar0);
			}
			iVar0++;
		...
		case 4:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 7))
					{
						func_180(iParam0, 7);
					}
				}
...
void func_187(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1)) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10))
				{
					func_180(iParam0, 10);
				}
			}
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6))
				{
					func_180(iParam0, 6);
				}
			}
		...
		case 3:
			if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 14))
			{
				func_180(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
				else
				{
					GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 4))
			{
				if ((!PED::IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_289[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_289[iParam0 /*22*/]))
				{
					func_180(iParam0, 4);
	...
	switch (Local_289[iParam0 /*22*/].f_19)
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					if ((GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 13) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_276) > 2500) && !iLocal_466)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_120(&uLocal_294, cLocal_293, sVar0, 7, 0, 0);
						GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 13);
						GAMEPLAY::CLEAR_BIT(&(Local_289[func_144(iParam0) /*22*/].f_15), 13);
						iLocal_466 = 1;
					}
					Local_289[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1500, 2000)
			{
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 5);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
		...
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				if (((fVar1 < 12f && !Local_289[iParam0 /*22*/].f_16) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !func_77(Local_289[iParam0 /*22*/], -875674219))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 11);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
...
void func_195(int iParam0)
{
	...
	if (!iLocal_466)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 13))
		{
			if (GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10))
			{
				if (Local_289[iParam0 /*22*/].f_16)
		...
		else if (func_132(iParam0))
		{
			if (bVar0)
			{
				...
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10) && !GAMEPLAY::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6))
					{
						GAMEPLAY::CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_199()
{
	if ((Local_289[0 /*22*/].f_18 == 1 && Local_289[1 /*22*/].f_18 == 1) && Local_289[2 /*22*/].f_18 == 1)
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_289[2 /*22*/].f_15, 2) && !GAMEPLAY::IS_BIT_SET(Local_289[2 /*22*/].f_15, 4))
			{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_70(iLocal_40, bLocal_28))
			{
				...
				if (OBJECT::_DOES_DOOR_EXIST(Global_35240[13 /*31*/]))
				{
					AUDIO::_0x06C0023BED16DD6B(Global_35240[13 /*31*/], 1);
				}
				iLocal_479 = 0;
				UNK1::_0x293220DA1B46CEBC(2f, 10f, 4);
				iLocal_41 = 1;
			}
			break;
		...
		case 1:
			...
			{
				UNK1::_0x293220DA1B46CEBC(7f, 7f, 4);
				iLocal_479 = 1;
			}
			if (func_7(Local_290))
			{
				...
				{
					UNK1::_0x293220DA1B46CEBC(10f, 6f, 4);
					iLocal_41 = 2;
				}
				if (bLocal_274)
				{
...
void func_205(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
var func_239()
{
	...
	func_249(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_248(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_247(&uVar0, TIME::GET_CLOCK_HOURS());
	func_242(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_241(&uVar0, TIME::GET_CLOCK_MONTH());
	func_240(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_266(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_267(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_267(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_267(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_267(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_288(int iParam0)
{
	...
	func_289(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_292(func_294(iParam1, uParam0->f_2), Global_71014, 0);
...
int func_292(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_293(iParam1)];
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_289(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_289(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_267(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_357()
{
	if (bLocal_274)
	{
		if (PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0))
		{
			if (func_12(&uLocal_150, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
			{
				func_359(Global_35240[13 /*31*/], &fLocal_270);
				return;
			}
		}
		else
		{
			func_358(Global_35240[13 /*31*/], &fLocal_270);
		}
	}
...
{
	if (OBJECT::_DOES_DOOR_EXIST(iParam0))
	{
		if (*fParam1 != 0f)
		{
...
void func_368()
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_290))
	{
		if (iLocal_268)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_267) > 5000)
			{
				func_365(2);
				return;
			}
...
void func_378()
{
	...
	if (!OBJECT::_DOES_DOOR_EXIST(iLocal_269))
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35240[13 /*31*/], 1, 1, 0);
...
void func_384()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
void func_389()
{
	...
	if (OBJECT::_DOES_DOOR_EXIST(Global_35240[13 /*31*/]))
	{
		AUDIO::_0x06C0023BED16DD6B(Global_35240[13 /*31*/], 0);
	}
	OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35240[13 /*31*/], 0f, 1, 1);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35240[13 /*31*/], 4, 1, 1);
