...
void func_6(int iParam0)
{
	...
	{
		case 0:
			Global_106070.f_25045 = 1;
			Global_106070.f_25045.f_3 = 1;
			break;
		
		case 1:
			Global_106070.f_25045 = 2;
			Global_106070.f_25045.f_4 = 1;
			break;
		
		case 2:
			Global_106070.f_25045 = 3;
			Global_106070.f_25045.f_5 = 1;
			break;
		
		case 3:
			Global_106070.f_25045 = 4;
			Global_106070.f_25045.f_6 = 1;
			break;
		
		case 4:
			Global_106070.f_25045 = 0;
			Global_106070.f_25045.f_7 = 1;
			break;
	}
}
...
void func_8()
{
	...
	StringIntConCat(&Var0, Global_106070.f_25045 + 1, 16);
	func_9(&Var0, -1);
}
...
bool func_10()
{
	return Global_106067;
}

void func_11()
{
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		func_12(&Global_106068);
		Global_106068 = -1;
		iLocal_149 = 2;
		iLocal_148 = 3;
	}
...
void func_13()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (SCRIPT::HAS_SCRIPT_LOADED("Country_Race"))
		{
			if (iLocal_149 == 2)
			{
				iLocal_149 = func_17(&Global_106068, 2, 9, 0, 0);
			}
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_60(), 5f, 5f, 5f, 1, true, 0))
		{
			...
			if (func_41())
			{
				if (func_38())
				{
					...
					func_33();
					func_32();
					if (((!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_31(1)) && !func_30(0)) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
...
void func_28()
{
	...
	{
		if (!func_25("CRACECAR") && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
		{
			UI::CLEAR_HELP(1);
...
void func_32()
{
	...
	{
		Var0 = { func_26() };
		if (!func_25(&Var0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
		{
			UI::CLEAR_HELP(1);
			func_29(&Var0, 1, 1, -1);
		}
...
void func_35()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_152 + 5000)
	{
...
int func_43()
{
	if ((!Global_106070.f_25045.f_9 && !Global_106070.f_25045.f_8) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_60()) < 84100f)
	{
		Global_106070.f_25045.f_9 = func_54();
		func_51();
		if (!Global_106070.f_25045.f_9)
		{
			if (func_61(iLocal_151) && func_61(iLocal_150))
			{
				if (!UI::HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("mission_stat_watcher")) <= 0)
				{
	...
	else
	{
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_60()) > 90000f)
		{
			...
			if (Global_106070.f_25045.f_9)
			{
				Global_106070.f_25045.f_9 = 0;
			}
			if (Global_106070.f_25045.f_8)
			{
				Global_106070.f_25045.f_8 = 0;
			}
		}
		if (Global_106070.f_25045.f_9)
		{
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_60(), 5f, 5f, 5f, 1, true, 0))
			{
				if (UI::HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3))
				{
					if (!func_25("CRACEDISRUPT") && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
						UI::CLEAR_HELP(1);
...
void func_44(bool bParam0)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_150) && !ENTITY::DOES_ENTITY_EXIST(iLocal_151))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(func_50()) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_motox_02")))
		{
			...
			VEHICLE::_0x2B6747FAA9DB9D6B(iLocal_150, 1);
			...
			AI::TASK_START_SCENARIO_IN_PLACE(iLocal_151, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
...
void func_51()
{
	if (func_61(iLocal_151))
	{
		if ((!PED::IS_PED_FLEEING(iLocal_151) && !PED::IS_PED_IN_COMBAT(iLocal_151, 0)) && !PED::IS_PED_RAGDOLL(iLocal_151))
		{
			...
			if (func_52(iLocal_150) || Global_106070.f_25045.f_9)
			{
				PED::_0xF1C03A5352243A30(iLocal_151);
				AI::TASK_COMBAT_PED(iLocal_151, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
...
void func_62(bool bParam0)
{
	...
	if (func_61(iLocal_151))
	{
		...
		{
			AI::TASK_WANDER_STANDARD(iLocal_151, 1193033728, 0);
		}
	}
	...
	if (bParam0)
	{
		GAMEPLAY::CLEAR_AREA(func_60(), 100f, 1, 0, 0, false);
	}
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
	{
		CAM::STOP_GAMEPLAY_HINT(0);
