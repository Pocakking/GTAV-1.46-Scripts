...
void func_12()
{
	...
	switch (Local_238.f_50)
	{
		case 0:
			...
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_237, Local_238.f_50))
				{
					...
					GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar1 + Vector(10f, 0f, 0f), &(vVar1.f_2), 0, 0);
					vVar1.z = (vVar1.z - 25f);
					GAMEPLAY::_0xBFE5756E7407064A(vVar0, vVar1, iVar2, 1, joaat("weapon_airstrike_rocket"), PLAYER::PLAYER_PED_ID(), 1, 0, -1f, PLAYER::PLAYER_PED_ID(), 1, 1, 0, 0, 0, 0);
					func_10(&(Local_238.f_51), 0, 0);
					iLocal_57 = 1;
					GAMEPLAY::SET_BIT(&iLocal_237, Local_238.f_50);
				}
			}
		...
		case 1:
			if (!func_11(&(Local_238.f_51)))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_237, Local_238.f_50))
				{
					...
					GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar1 + Vector(10f, 0f, 0f), &(vVar1.f_2), 0, 0);
					vVar1.z = (vVar1.z - 25f);
					GAMEPLAY::_0xBFE5756E7407064A(vVar0, vVar1, iVar2, 1, joaat("weapon_airstrike_rocket"), NETWORK::NET_TO_PED(Local_238.f_2.f_3), 1, 0, -1f, PLAYER::PLAYER_PED_ID(), 1, 0, 0, 0, 0, 0);
					func_10(&(Local_238.f_51), 0, 0);
					GAMEPLAY::SET_BIT(&iLocal_237, Local_238.f_50);
				}
			}
	...
	if (bLocal_58)
	{
		if (!iLocal_59)
		{
			if (func_14(Local_238.f_2))
			{
				...
				{
					fLocal_62 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar2, vVar1, 0);
				}
				else
				{
					iLocal_59 = 1;
...
void func_25()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else if (GAMEPLAY::_0xDFB4138EEFED7B81(PLAYER::PLAYER_PED_ID(), joaat("weapon_flare"), 100f, &(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 1))
			{
				...
				if (!iLocal_55)
				{
					if (!func_79(Local_238.f_2.f_3))
					{
						...
						{
							func_78();
							AI::CLEAR_PED_TASKS(NETWORK::NET_TO_PED(Local_238.f_2.f_3));
							AI::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_238.f_2.f_3), uLocal_49);
	...
	switch (Local_238.f_2.f_2)
	{
		...
		case 2:
			if (func_14(Local_238.f_2))
			{
				bLocal_58 = true;
				iVar0 = NETWORK::NET_TO_VEH(Local_238.f_2);
				if (!UI::DOES_BLIP_EXIST(iLocal_47))
				{
					iLocal_47 = UI::ADD_BLIP_FOR_ENTITY(iVar0);
					UI::SET_BLIP_SPRITE(iLocal_47, 16);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_47, "AIRSTRIKE_5");
					UI::_0x75A16C3DA34F1245(iLocal_47, 0);
				}
				else
				{
					UI::SET_BLIP_ROTATION(iLocal_47, SYSTEM::CEIL(ENTITY::GET_ENTITY_HEADING(iVar0)));
				}
				if (!iLocal_53)
				{
					if (!func_16(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2))
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, ENTITY::GET_ENTITY_COORDS(iVar0, 1), 1) <= (60f * 5f))
					{
				...
				if (!iLocal_235)
				{
					if (!Local_238.f_54)
					{
						if (!func_79(Local_238.f_2.f_3))
						{
							if (!func_16(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2))
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_47(PLAYER::PLAYER_ID()), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_238.f_2.f_3), 1), 0) <= 250f)
								{
									if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, ENTITY::GET_ENTITY_COORDS(iVar0, 1), 1) >= (60f * 2.5f))
									{
					...
					if (!Local_238.f_53)
					{
						if (!func_16(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2))
						{
							if (func_29() == 2)
							{
								...
								vVar1.z = -200f;
								vVar2.z = 1500f;
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 75f, 75f, 1000f, 0, 1, 0) && GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar1, vVar2, joaat("weapon_flare"), 0))
								{
									Local_238.f_53 = 1;
								}
							}
	...
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_238.f_2.f_3) && func_75(Local_238.f_2.f_3.f_1)) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_238.f_2))
	{
		if (func_14(Local_238.f_2))
		{
			if (func_53(&(Local_238.f_2.f_3), Local_238.f_2, 22, Local_238.f_2.f_3.f_1, -1, 1, 1, 1))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_238.f_2.f_3), Global_1574981);
				...
				func_52();
				AI::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_238.f_2.f_3), uLocal_48);
				VEHICLE::_SET_PLANE_MIN_HEIGHT_ABOVE_GROUND(NETWORK::NET_TO_VEH(Local_238.f_2), SYSTEM::ROUND(50f));
			}
		}
	}
...
void func_52()
{
	if (!iLocal_50)
	{
		if (func_14(Local_238.f_2))
		{
			...
			AI::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, vLocal_60 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
			AI::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
			...
			if (AUDIO::LOAD_STREAM("AIRSTRIKE_FLYOVER", 0))
			{
				...
				if (func_56(vVar0, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
				{
					if (func_55(&(Local_238.f_2), Local_238.f_2.f_1, vVar0, fVar1, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
					{
						...
						ROPE::ACTIVATE_PHYSICS(NETWORK::NET_TO_VEH(Local_238.f_2));
						...
						ENTITY::_SET_ENTITY_REGISTER(NETWORK::NET_TO_VEH(Local_238.f_2), 0);
	...
	if (iParam2 && !bParam5)
	{
		if (func_23(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_62(PLAYER::PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_58(iVar1) || !bParam8) && !Global_2423801[iVar1 /*413*/].f_259)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_62(iVar1), vParam0, 1) <= (fVar2 + fParam1))
								{
				...
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_58(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_47(iVar1), vParam0, 1) < fParam1)
								{
									return 1;
								}
							}
...
Vector3 func_73(vector3 vParam0, float fParam1, float fParam2, float fParam3)
{
	...
	fVar1 = (fParam3 / 2f);
	vVar0 = { func_74(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) };
...
void func_78()
{
	if (!iLocal_51)
	{
		if (func_14(Local_238.f_2))
		{
			...
			AI::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
			AI::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, SYSTEM::CEIL((50f + 5f)), 20, 1);
...
void func_87()
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_238.f_2.f_3) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_238.f_2))
	{
		if (func_14(Local_238.f_2) && !func_79(Local_238.f_2.f_3))
		{
			AI::TASK_PLANE_MISSION(NETWORK::NET_TO_PED(Local_238.f_2.f_3), NETWORK::NET_TO_VEH(Local_238.f_2), 0, PLAYER::PLAYER_PED_ID(), 1f, 1f, 1f, 8, 60f, 1000f, -1f, 400, 400, 1);
		}
	}
...
int func_91()
{
	...
	if (func_92() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_92()) == 0)
		{
			return 1;
		}
	}
