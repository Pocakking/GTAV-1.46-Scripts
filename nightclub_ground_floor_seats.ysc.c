...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 1:
			...
			if (func_64(uParam0))
			{
				uParam0->f_141.f_6 = GAMEPLAY::GET_GAME_TIMER();
				func_65(uParam0, 2);
			}
			break;
		...
		case 2:
			if (func_63(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_141.f_2 /*14*/]) && func_62(PLAYER::PLAYER_PED_ID(), (uParam0[uParam0->f_141.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_141.f_2 /*14*/]))
			{
				...
				else
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_141.f_6) > 150)
						{
		...
		case 5:
			...
			if ((iVar6 != 1 && iVar6 != 0) || func_34(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar8, 5f))
			{
				...
				uParam0->f_141.f_8.f_4 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
		...
		case 8:
			iVar10 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_141.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_141.f_8.f_1)
			{
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_141.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!UI::IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_141), 0)) && !func_32(&(uParam0->f_141), 4)) && !func_22()) && !func_20(1)) && uParam0->f_141.f_8.f_2 != 3)
			{
				if (uParam0->f_141.f_5 == -1)
				{
...
int func_51(var uParam0)
{
	...
	switch (uParam0->f_141.f_8)
	{
		...
		default:
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, func_14(uParam0->f_141.f_8));
	}
	if (uParam0->f_141.f_8 == 1)
	{
		if (func_12())
...
int func_55(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_63(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_141.f_2 /*14*/]) || func_57(iVar1) == uParam0->f_141.f_2)
				{
					return 1;
				}
			}
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_141.f_4 > 4)
	{
		...
		uParam0->f_141.f_7 = GAMEPLAY::GET_FRAME_COUNT();
	}
	else if ((GAMEPLAY::GET_FRAME_COUNT() - uParam0->f_141.f_7) < 5)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_68());
	}
}
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_141), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_85()
{
	if (Global_2423801[PLAYER::PLAYER_ID() /*413*/].f_309.f_7 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2423801[PLAYER::PLAYER_ID() /*413*/].f_309.f_7, 1, 0))
		{
			return 0;
		}
...
void func_86()
{
	...
	func_87(3, &uLocal_153, 3, 1);
	func_87(5, &uLocal_153, 5, 1);
	func_87(6, &uLocal_153, 6, 2);
	func_87(7, &uLocal_153, 7, 1);
	func_87(8, &uLocal_153, 8, 2);
	func_87(9, &uLocal_153, 9, 1);
}
