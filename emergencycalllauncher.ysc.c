...
void func_3()
{
	...
	{
		Local_210 = { func_5() };
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY(&Local_210)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	switch (iLocal_44)
	{
		...
		case 1:
			if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("emergencycall")) == 0)
			{
				if (!func_29(130))
				{
					iLocal_43 = 1;
...
{
	Global_25683 = 1;
	StringCopy(&Global_25684, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}
