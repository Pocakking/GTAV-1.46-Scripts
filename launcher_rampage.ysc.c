		...
		if (iLocal_241 != -1)
		{
			if (!func_218())
			{
				*iParam0 = func_217(iLocal_241);
				...
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(iParam0->f_1)))
				{
					func_365("  -  Ambient Rampage Mission ID is invalid");
					func_350(iParam0, 1);
				}
				...
				GAMEPLAY::CLEAR_BIT(&(Global_106070.f_18546[*iParam0 /*6*/]), 3);
				...
				{
					func_4(500, 1);
					GAMEPLAY::CLEAR_AREA(vParam1, iParam0->f_15, 1, 0, 0, false);
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_52(iParam1)];
...
void func_61(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_63(Var7.f_1)) && iVar9 < 50)
			{
...
int func_78(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_94(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_79(iVar0, 0), true);
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_150(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_150(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_224(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		vVar1 = { Global_25834[(iLocal_239 + iVar0) /*23*/][0 /*3*/] };
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar2, vVar1, true) <= fParam0 && GAMEPLAY::ABSF((vVar2.z - vVar1.z)) < 1.5f)
		{
			return iVar0;
		}
		iVar0++;
	...
	while (true)
	{
		...
		if (func_265(52))
		{
			if (AI::IS_SCENARIO_GROUP_ENABLED("Rampage1"))
			{
				...
				AI::SET_SCENARIO_GROUP_ENABLED("Rampage1", false);
			}
		}
		func_264(*iParam0);
	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			if (func_127(iParam0->f_28[0]))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 4:
			...
			if (func_127(iParam0->f_28[0]))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 6:
			...
			if (func_127(iParam0->f_28[0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
			}
	...
	if (iLocal_69 < 0)
	{
		...
		switch (*iParam0)
		{
			case 52:
				...
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], -1, 0, 2);
			...
			case 55:
				...
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0->f_28[1], -1, 0, 2);
				CAM::GET_IS_MULTIPLAYER_BRIEF(1);
		...
		iLocal_69 = GAMEPLAY::GET_GAME_TIMER() + 2500;
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_69)
	{
		iLocal_69 = -1;
		return 1;
	}
			...
			if (func_127(uParam0->f_28[0]))
			{
				if (!func_146())
				{
					if (func_228(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_3", 8, 0, 0))
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_238, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
...
void func_269(var uParam0)
{
	...
	AI::TASK_PLAY_ANIM(uParam0->f_28[0], sVar0, "marines_idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
	...
	AI::TASK_PLAY_ANIM(uParam0->f_28[1], sVar0, "marines_idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
...
int func_270(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	iVar2 = GAMEPLAY::GET_GAME_TIMER() + 10000;
	while (GAMEPLAY::GET_GAME_TIMER() < iVar2)
	{
	...
	switch (iParam1)
	{
		...
		default:
			...
			if (iVar12 != -1)
			{
				...
				{
					if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar12, iVar13, &Var16))
					{
...
int func_273(int iParam0, int iParam1)
{
		...
		switch (iParam0)
		{
			...
			default:
				...
				if (iVar2 != -1)
				{
					...
					{
						if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar2, iVar3, &Var5))
						{
							if (!func_62(Var5.f_3))
							{
								if (Var5.f_3 == iParam1)
	...
	else
	{
		...
		switch (iParam0)
		{
			...
			default:
				...
				{
					iVar7 = 0;
					while (iVar7 < DLC1::GET_NUM_DLC_WEAPON_COMPONENTS(iVar6))
					{
						if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar6, iVar7, &Var9))
						{
							if (!func_62(Var9.f_3))
							{
								if (Var9.f_3 == iParam1)
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_306())
	{
		...
		{
			iVar0 = unk_0x9F672A3614564F11(GAMEPLAY::GET_HASH_KEY(&sVar10), 1671640801, 1);
		}
	}
	if (iVar0 > 0)
	{
...
void func_300(char* sParam0, char[8] cParam1, char[4] cParam2, char[4] cParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
	...
	switch (iParam5)
	{
		...
		case 4:
			if (iParam4 == Global_68473)
			{
				StringCopy(sParam0, "VE_BIG_YACHT_t0_v0", 64);
			}
			else if (iParam4 == Global_68474)
			{
				StringCopy(sParam0, "VE_BIG_TRUCK_t0_v0", 64);
			}
			else if (iParam4 == Global_68475)
			{
				StringCopy(sParam0, "VE_BALLISTIC_EQUIPMENT_t0_v0", 64);
			}
			else if (iParam4 == Global_68476)
			{
				StringCopy(sParam0, "VE_BIG_PLANE_t0_v0", 64);
			}
			else if (iParam4 == Global_68477)
			{
...
bool func_313(int iParam0, int iParam1, int iParam2)
{
	...
	return GAMEPLAY::IS_BIT_SET(iVar0, func_314(iVar1));
}
...
void func_332(var uParam0)
{
	...
	PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 11, 0, 0, 0);
	AI::TASK_PLAY_ANIM(uParam0->f_28[0], sVar1, "thugs_idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
	...
	AI::TASK_PLAY_ANIM(uParam0->f_28[1], sVar1, "thugs_idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
...
void func_333(var uParam0)
{
	...
	PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 11, 0, 0, 0);
	PED::SET_PED_NAME_DEBUG(uParam0->f_28[0], "RAMP:PED 0");
	AI::TASK_PLAY_ANIM(uParam0->f_28[0], sVar1, "mexicans_idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
	...
	PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 11, 0, 0, 0);
	PED::SET_PED_NAME_DEBUG(uParam0->f_28[1], "RAMP:PED 1");
	AI::TASK_PLAY_ANIM(uParam0->f_28[1], sVar1, "mexicans_idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
...
void func_337(var uParam0, bool bParam1, int iParam2)
{
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		...
		else
		{
			...
			iVar0 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("npcphone");
		}
		UI::SET_TEXT_RENDER_ID(iVar0);
...
void func_343(var uParam0)
{
	...
	if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		...
		if (func_127(uParam0->f_28[0]))
		{
			AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, sVar1, "redneck_idle_a", 8f, -8f, 513, 0, 1148846080, 0);
		}
		if (func_127(uParam0->f_28[1]))
		{
			AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[1], uParam0->f_59, sVar1, "redneck_idle_b", 8f, -8f, 513, 0, 1148846080, 0);
		}
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_59, true);
	}
