	...
	while (true)
	{
		...
		if (func_172())
		{
			...
			if (iLocal_39 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_27(0) == 0 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_59) > 2000)
					{
...
void func_3()
{
	func_4(&(Global_96664.f_2875), &Global_96664, 0, 1, 1, 0);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_15(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_24(14) || Global_105021))
			{
...
{
	return func_29(iParam0, Global_36117);
}
...
void func_30(int iParam0)
{
	...
	if (iLocal_43 != 9)
	{
		if (!Global_106070.f_19955.f_13)
		{
			if (Global_106070.f_19955.f_1 == 0 && Global_106070.f_19955.f_2 == 0)
			{
				if (!func_169(Global_106070.f_19955, 32))
				{
					func_166("MG_TRAF_AVAIL", 0, 0, -1, 10000, 7, 0, 0, 0);
					func_164(&(Global_106070.f_19955), 32);
				}
			}
			func_1(106, 1, 0);
			Global_106070.f_19955.f_13 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_45, 4f, 0, 0, 0, 0, false, 0);
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_30 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 25000);
					func_80(16);
					SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Traffick_Ground");
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_44, 1, 0);
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_44);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_106070.f_19955.f_12 = iVar5;
					func_1(106, 0, 0);
					Global_106070.f_19955.f_13 = 0;
				}
				*iParam0 = 0;
				func_42(&Global_104721, 2);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_31(Global_106070.f_19955.f_12))
			{
				func_162(0);
				iLocal_43 = 1;
			}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_39(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_52()
{
	...
	func_51(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_50(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_49(&uVar0, TIME::GET_CLOCK_HOURS());
	func_47(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_48(&uVar0, TIME::GET_CLOCK_MONTH());
	func_46(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_82(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_93232 != 10 && Global_93232 != 9)
	{
		...
		func_84(&Global_96664, cParam0, 0, "Start", iParam1, iParam2);
		func_83();
		Global_87505 = 0;
	}
}
...
void func_94(int iParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_95(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_95(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_97(Var7.f_1)) && iVar9 < 50)
			{
...
int func_108(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_110() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_87(func_109(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_112(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_128(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_113(iVar0, 0), 1);
...
Vector3 func_113(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_124(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_123())
			{
				if (func_122(Global_1589591))
				{
					return func_115(2, 2);
				}
				else if (func_114(Global_1589591))
				{
...
void func_133(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_151(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_52();
			}
...
void func_134(int iParam0, int iParam1)
{
	...
	func_14(iParam0, &(Global_106070.f_32605.f_5510));
}
...
void func_152(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_151(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_157(iParam0);
			func_156(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_163()
{
	if (func_27(9))
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("trevor2")) == 1)
		{
			if (!iLocal_36[0])
			{
				iLocal_36[0] = 1;
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("finale_heist2b")) == 1)
		{
			if (!iLocal_36[1])
			{
				iLocal_36[1] = 1;
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_air")) == 1)
		{
			if (!iLocal_36[2])
			{
				iLocal_36[2] = 1;
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 1)
		{
			if (!iLocal_36[3])
			{
				iLocal_36[3] = 1;
...
void func_170(int iParam0)
{
	...
	if (iLocal_39 != 9)
	{
		if (!Global_106070.f_19955.f_14)
		{
			func_1(105, 1, 0);
			Global_106070.f_19955.f_14 = 1;
			bVar0 = true;
		}
		else
		{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_42, 8f, 0, 0, 0, 0, false, 0);
					...
					func_164(&(Global_106070.f_19955), 128);
					iLocal_39 = 4;
				}
				else
				{
		...
		case 4:
			...
			else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 0)
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_40, 0))
				{
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					iLocal_30 = SYSTEM::START_NEW_SCRIPT("Traffick_Air", 25000);
					func_80(15);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_106070.f_19955.f_11 = uVar4;
					func_1(105, 0, 0);
					Global_106070.f_19955.f_14 = 0;
					iLocal_39 = 9;
				}
				*iParam0 = 0;
				func_42(&Global_104721, 1);
			}
			break;
		...
		case 9:
			if (fLocal_31 >= 50625f && func_31(Global_106070.f_19955.f_11))
			{
				func_171(0);
				iLocal_39 = 1;
			}
...
void func_171(bool bParam0)
{
	...
	if (func_169(Global_106070.f_19955, 128))
	{
		func_42(&(Global_106070.f_19955), 128);
	}
	iLocal_41 = 0;
}
...
int func_172()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 1 || SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_air")) == 1)
	{
		return 1;
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_181()) || Global_25461) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_181()) || Global_105117) || Global_25461) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_181()) || Global_105117) || Global_25461) || func_175()) || func_174(8, -1)) || func_129()) || func_180()) || func_179()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_181() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_174(8, -1)) || func_179()) || func_178()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_181()) || func_180()) || Global_105117) || Global_25461) || func_175()) || Global_37271) || func_174(8, -1)) || func_173()) || func_178()) || func_179()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	while (iVar0 < 8)
	{
		if (Global_90260[iVar0 /*17*/] && !Global_90260[iVar0 /*17*/].f_1)
		{
			if (Global_90260[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_190(Global_90260[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
