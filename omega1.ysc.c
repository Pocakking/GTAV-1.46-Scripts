...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_Omega1", 0);
				...
				if (func_222(Local_39.f_28[0]))
				{
					if (func_222(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_45)
						{
							...
							else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_224) > 7500)
							{
								if (!bLocal_43)
								{
...
void func_7(int iParam0, bool bParam1)
{
	...
	{
		func_174(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_11()
{
	...
	{
		func_13(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_26(var uParam0)
{
	...
	*uParam0 = 145;
	...
	func_30(&(uParam0->f_2869));
	func_28(&(uParam0->f_2875));
...
int func_36(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_87(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_87(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_79(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_79(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_37(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_152(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_87(iVar10, iParam1, iParam2, -1) };
		if (!func_77(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_87(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_87(iVar10, 14, uVar12[iVar1], -1) };
							func_55(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_70(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_79(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_70(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_87(iVar10, iVar0, func_45(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_87(iVar10, 14, uVar15[iVar1], -1) };
			func_55(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_70(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_79(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_87(iParam0, iParam1, iParam2, -1) };
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_56(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_79(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_79(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_70(int iParam0)
{
	...
	{
		func_76(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_152(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_86(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_86(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_86(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_89(int iParam0)
{
	...
	func_90(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_74(func_93(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_74(func_92(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_74(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_90(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_90(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_90(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_90(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_79(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_152(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_152(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_152(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_87(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_152(iParam0, 14, iVar4))
										{
											if (!func_43(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_87(iVar0, iVar2, iVar1, -1) };
						if (!func_43(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_79(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_79(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_158()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_154(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_155(iVar0) && (!func_95(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_155(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_163(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&cVar1, {func_160(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&cVar1, 0, Global_93269, 0);
		func_164(&cVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}

void func_164(char[4] cParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_169()
{
	...
	{
		func_158();
		GRAPHICS::_0xBF59707B3E5ED531(func_170(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_179(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_178();
...
int func_223()
{
	if (func_222(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(Local_39.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			iLocal_42 = 3;
			func_245(5);
			return 0;
		}
	...
	if (func_223())
	{
		switch (iLocal_41)
		{
			case 0:
				if (func_222(Local_39.f_28[0]))
				{
					AI::TASK_PERFORM_SEQUENCE(Local_39.f_28[0], iLocal_220);
				}
				func_248("O1_LEAVEAREA", 7500, 1);
				iLocal_224 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_222 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_41 = 1;
				break;
			...
			case 1:
				if (func_222(Local_39.f_28[0]))
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_222) > 3000)
					{
						iLocal_41 = 2;
					}
				}
...
void func_250(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_252(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_254(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_258(PLAYER::PLAYER_ID())) && !func_256(PLAYER::PLAYER_ID(), 0)) && !func_255()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_258(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_281()
{
	...
	if (func_223())
	{
		if (GAMEPLAY::GET_GAME_TIMER() < iLocal_221 && !func_282(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 4f, 1))
		{
			...
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 2000, 0, 2);
		}
		else
		{
			func_247(2);
...
void func_290()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("OMEGA1", 0);
	STREAMING::REQUEST_MODEL(iLocal_215);
	STREAMING::REQUEST_MODEL(iLocal_216);
	if (func_223())
	{
		if ((((STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1leadinoutscrap_1_rcm") && STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1")) && UI::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_215)) && STREAMING::HAS_MODEL_LOADED(iLocal_216))
		{
			AI::OPEN_SEQUENCE_TASK(&iLocal_220);
			AI::TASK_PLAY_ANIM(0, "rcmrc_omega_1leadinoutscrap_1_rcm", "leadout_scrap_1_rcm_omega", 8f, -8f, -1, 262144, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmrc_omega_1", "omega_idle_geiger_counter", 8f, -8f, -1, 262145, 0f, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(iLocal_220);
			if (func_222(Local_39.f_28[0]))
			{
			...
			iLocal_221 = GAMEPLAY::GET_GAME_TIMER() + 3500;
			func_247(1);
		}
	}
}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_294(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_305(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_307(iParam0, Global_36117);
}
...
void func_318(int iParam0)
{
	...
	if (func_222(iParam0))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, vLocal_225[0 /*3*/], vLocal_225[1 /*3*/], fLocal_226, 0, true, 0))
		{
			...
			{
				GAMEPLAY::GET_MODEL_DIMENSIONS(iVar3, &(vVar0[1 /*3*/]), &(vVar0[2 /*3*/]));
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_380(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_380(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_323(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_155(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_327(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_326(*iParam1);
				...
				func_324(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_324(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_330(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			...
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_336(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_337(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_353(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_333())
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_354(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_333())
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_355(int iParam0)
{
	if (iParam0 != func_333())
	{
		if (func_332(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_331(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_358(int iParam0, int iParam1)
{
	...
	func_359(iParam0, &(Global_106070.f_32605.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_360(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_386(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_387(iParam0, iParam1))
				{
...
void func_388(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	while (iVar0 < 68)
	{
		if (func_393(&(Global_70024.f_555[0 /*21*/]), iVar0))
		{
...
void func_389(int iParam0)
{
	...
	if (func_393(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_184(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_391(0, Global_70024.f_555[0 /*21*/].f_12) || !func_391(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_390(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_391(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_392(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_364(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_393(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_394(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_394(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_394(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_396(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_413(uParam0))
	{
		...
		if (func_412(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_398(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_398(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_400(iParam0, Global_70024.f_139[38], 0))
			{
				func_389(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_400(iParam0, Global_70024.f_139[43], 1))
			{
				func_389(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_394(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_401(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_360(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_360(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_360(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_404(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_403())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_360(iVar2 + 1)))
				{
...
bool func_414()
{
	return func_412(&(Global_99633.f_2875));
}

void func_415()
{
	func_416(&(Global_99633.f_2875));
}
...
int func_417(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_419(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_420()
{
	return func_413(&(Global_99633.f_2875));
}
...
int func_445()
{
	...
	iVar0 = func_446(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_449()
{
	...
	{
		if (func_444(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
