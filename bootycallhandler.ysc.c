	...
	switch (Global_105064)
	{
		case 0:
			if (!Global_105064.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_65(func_66(iVar0)) && (Global_105064.f_15[iVar1] + 120000) < GAMEPLAY::GET_GAME_TIMER())
					{
						if (func_63(iVar0))
						{
							func_62(iVar0, 0);
						...
						else
						{
							...
							else if (((GAMEPLAY::GET_GAME_TIMER() >= Global_105064.f_4[iVar1] && func_50()) && func_49(iVar0)) && func_48(iVar0) >= func_47(iVar0))
							{
...
void func_67()
{
	...
	switch (Global_105064)
	{
		case 0:
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() >= Global_105064.f_3)
				{
...
int func_74()
{
	...
	while (iVar0 < 10)
	{
		if (Global_106070.f_243[func_46() /*53*/].f_2[iVar0 /*5*/].f_4 && GAMEPLAY::GET_GAME_TIMER() >= Global_105064.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
...
void func_77()
{
	...
	{
		if (Global_105064.f_3 < (GAMEPLAY::GET_GAME_TIMER() + 120000))
		{
			func_80(1800000);
		}
