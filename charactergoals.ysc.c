...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iLocal_18)
		{
			...
			case 1:
				if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
				{
					...
					if (func_36(2, 999999))
					{
						...
						iLocal_22 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_18 = 2;
					}
			...
			case 2:
				iLocal_21 = GAMEPLAY::GET_GAME_TIMER();
...
int func_8(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_37(char* sParam0, int iParam1)
{
	...
	func_38(0.81f, 0.8f, sParam0, iParam1, 0);
}

void func_38(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
...
{
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appsidetask")) > 0)
	{
		return 0;
	}
	if (func_44() == 0)
