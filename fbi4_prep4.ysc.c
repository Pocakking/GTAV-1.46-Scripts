...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("M_MS", 0);
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_20();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_187))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_187, "PRE_FKICKOFF"))
				{
					while ((GAMEPLAY::GET_GAME_TIMER() - iLocal_199) < 3000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_22()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
		...
		case 1:
			...
			else
			{
				...
				if (bLocal_190)
				{
					iLocal_198 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_81 = 2;
				}
				...
				else if (func_87(PLAYER::PLAYER_PED_ID(), vLocal_196, 12f))
				{
					...
					if (UI::DOES_BLIP_EXIST(iLocal_192))
					{
						UI::SET_BLIP_COLOUR(iLocal_192, 2);
						UI::SET_BLIP_ROUTE_COLOUR(iLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_198) > 2000)
			{
				func_21(&iLocal_192);
...
bool func_80(char* sParam0, int iParam1, char* sParam2)
{
...
int func_91(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_188, 0);
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_203, 6);
		...
		case 0:
			if (func_88(iLocal_80, 0))
			{
				...
				if (func_263())
				{
					...
					while (!func_104(21) && (GAMEPLAY::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_24(500, 1);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_147(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_176(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_177(iParam0, iParam1))
				{
	...
	if (func_205(uParam0))
	{
		...
		if (func_204(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_191(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_187(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 1) < 10f)
					{
...
void func_193(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_147(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_147(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_147(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_196(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_195())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_147(iVar2 + 1)))
				{
	...
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			if (!bLocal_190)
			{
				...
				{
					iLocal_199 = GAMEPLAY::GET_GAME_TIMER();
					func_221(4);
					return;
				}
			}
...
void func_234(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_236() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_236() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_235(iParam0));
...
bool func_239(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_236() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_262(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_263())
	{
...
void func_269(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_270(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_273(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_277(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_270(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_270(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_278(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_336(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_337(uParam1, *(uParam1[iVar1 /*3*/]) + vVar5))
		{
			vVar5 = { -vVar5 };
		}
...
bool func_337(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_339(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
