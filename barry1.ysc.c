...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL3"))
		{
			func_553("B1_FAIL3", 1);
		}
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_GRM", 0);
...
void func_1()
{
	...
	if (iLocal_113)
	{
		if (bVar0 == 0 && bLocal_477 == 0)
		{
			...
			func_6(&uLocal_115);
			uLocal_115 = func_5(vLocal_106, 5, 1);
			iLocal_114 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			func_3(0);
			iLocal_113 = 0;
		}
	}
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_114 && bLocal_477 == 0)
		{
			func_2("B1_FAIL");
		}
	}
...
void func_3(int iParam0)
{
	...
	iVar0 = GAMEPLAY::GET_GAME_TIMER() + 2000;
...
void func_10(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_54(1);
			AUDIO::TRIGGER_MUSIC_EVENT("RC18A_STOP");
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_97))
			{
				func_536(1);
			}
			else
		...
		case 2:
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL"))
			{
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL2"))
			{
				func_11();
			}
			break;
...
void func_11()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_96 && iLocal_96 != -1)
	{
...
int func_13(int iParam0)
{
	...
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		if (func_567(PLAYER::PLAYER_PED_ID()))
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9("Michael", PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()));
	...
	switch (iLocal_99)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_270, 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_271, 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar2);
				AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar2);
			...
			{
				CAM::SET_CAM_ACTIVE(iVar3, 1);
			}
			iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 6000;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_34(&uLocal_308, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_96)
				{
					if (GAMEPLAY::GET_GAME_TIMER() < iLocal_96)
					{
					}
					iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 4500;
					bVar1 = true;
				}
			}
			else if (func_17(&uLocal_308, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_96)
			{
				iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_96)
				{
				}
				bVar1 = true;
		...
		case 4:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_16();
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_255, 0, 0);
					iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 3500;
					bVar1 = true;
				}
			}
			else
		...
		case 3:
			if (iParam0 == 1)
			{
				bVar1 = GAMEPLAY::GET_GAME_TIMER() > iLocal_96;
			}
			else
			{
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_96)
			...
			if (bVar1 == 1)
			{
				...
				iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_99 = 5;
			}
			break;
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_96)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_108, 200f, 0, 0, 0, 0, false, 0);
...
void func_16()
{
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_253))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_253);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_254))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_254);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_255))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_255);
	}
}
...
void func_25()
{
	...
	{
		if (func_28(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_27(PLAYER::PLAYER_PED_ID());
			if (func_26(iVar0) && (!func_29(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_26(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_38(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_43(PLAYER::PLAYER_ID())) && !func_40(PLAYER::PLAYER_ID(), 0)) && !func_39()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_43(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
{
	func_50(&(Global_99633.f_2875), vParam0, fParam1);
}
...
{
	if (func_52(Global_71445, 0f, 0f, 0f, 0))
	{
...
void func_62()
{
	...
	while (iVar0 < Local_502)
	{
		if (func_4(&(Local_502[iVar0 /*33*/])))
		{
			...
			AI::TASK_SMART_FLEE_COORD(Local_502[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_64(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_266, 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_269, 8f, -2f, -1, 0, 0f, 0, 0, 0);
		...
		case 4:
			fLocal_126 = (fLocal_126 - (GAMEPLAY::GET_FRAME_TIME() * 512f));
			if (fLocal_126 <= 0f)
			{
				fLocal_126 = 0f;
		...
		case 3:
			...
			{
				func_2("B1_FAIL3");
				iLocal_96 = GAMEPLAY::GET_GAME_TIMER() + 50;
			}
			break;
	}
}
...
int func_65()
{
	...
	switch (iLocal_569)
	{
		case 0:
			...
			iLocal_570 = GAMEPLAY::GET_GAME_TIMER() + 400;
			iLocal_569++;
			break;
			...
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_570)
			{
				...
				if (CAM::_0xEE778F8C7E1142E2(0) != 4)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_545))
					{
						...
						CAM::SET_CAM_ACTIVE(iLocal_545, 1);
		...
		case 6:
			if (CAM::IS_GAMEPLAY_CAM_RENDERING())
			{
				if (CAM::DOES_CAM_EXIST(iLocal_545))
				{
					CAM::SET_CAM_ACTIVE(iLocal_545, 0);
...
int func_69(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 1), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			else
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 0), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			...
			CAM::_0x0FB82563989CF4FB(uParam0->f_9, (*uParam0)[uParam0->f_24], 0, 1);
			uParam0->f_24++;
			...
			CAM::SET_CAM_FOV((*uParam0)[uParam0->f_24], CAM::_0x80EC114669DAEFF4());
			CAM::_0x0FB82563989CF4FB(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
			uParam0->f_24++;
			uParam0->f_27 += 400;
			if (!CAM::DOES_CAM_EXIST((*uParam0)[uParam0->f_24]))
			{
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_17228.f_111)
			{
				AUDIO::PLAY_SOUND(-1, "CHARACTER_CHANGE_UP_MASTER", 0, 0, 0, 1);
				if (Global_17228.f_109 == -1)
				{
					Global_17228.f_109 = AUDIO::GET_SOUND_ID();
					Global_17228.f_110 = GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
				AUDIO::PLAY_SOUND(Global_17228.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
	...
	if (uParam0->f_17)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			if (CAM::DOES_CAM_EXIST(uParam0->f_11))
			{
				Global_1312466.f_1 = { CAM::GET_CAM_COORD(uParam0->f_9) };
				Global_1312466.f_4 = { CAM::GET_CAM_ROT(uParam0->f_9, 2) };
				Global_1312466.f_7 = CAM::GET_CAM_FOV(uParam0->f_9);
				CAM::SET_CAM_COORD(uParam0->f_11, Global_1312466.f_1);
				CAM::SET_CAM_ROT(uParam0->f_11, Global_1312466.f_4, 2);
				CAM::SET_CAM_FOV(uParam0->f_11, Global_1312466.f_7);
			}
			CAM::DESTROY_CAM(uParam0->f_9, 0);
		}
		if (uParam0->f_24 > 0)
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_17228.f_109 != -1 && Global_17228.f_110 == GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
			AUDIO::STOP_SOUND(Global_17228.f_109);
			AUDIO::RELEASE_SOUND_ID(Global_17228.f_109);
			Global_17228.f_109 = -1;
			Global_17228.f_110 = 0;
		}
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_327(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_326();
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_108, 250f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_108, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_108, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_108, 500f);
...
void func_274(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_275(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_277()
{
	...
	{
		GAMEPLAY::CLEAR_AREA(vLocal_542, 3f, 1, 0, 0, false);
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_299();
			}
...
void func_280(int iParam0, int iParam1)
{
	...
	func_317(iParam0, &(Global_106070.f_32605.f_5510));
}
...
var func_299()
{
	...
	func_309(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_308(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_307(&uVar0, TIME::GET_CLOCK_HOURS());
	func_302(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_301(&uVar0, TIME::GET_CLOCK_MONTH());
	func_300(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_305(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_310(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_52(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_52(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_52(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_313(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_310(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_315(iParam0);
			func_314(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_318(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	return func_323(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
...
void func_335(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
...
void func_338(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_522 != 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_522)
			{
				iLocal_522 = 0;
				iLocal_521 = 0;
			}
			if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_258))
			{
				AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_258, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(GAMEPLAY::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_339()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_281)
	{
		return;
	}
	if (!bLocal_278)
	...
	{
		iLocal_281 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
		if ((iLocal_280 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_280 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
bool func_344(char* sParam0, int iParam1, char* sParam2)
{
...
void func_345()
{
	...
	if (!iLocal_474)
	{
		iLocal_498 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_499, iLocal_500));
		return;
	}
	if (bLocal_477)
	{
		iLocal_498 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_499 * 3, iLocal_500 * 2));
		return;
	}
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_498)
	{
		if (func_361(&iVar1))
		{
...
int func_346(var uParam0)
{
	...
	{
		*uParam0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_496, fLocal_497), 6f) };
	}
...
int func_347(var uParam0, bool bParam1)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_106, 1) > fLocal_107)
	{
		return 0;
	}
...
Vector3 func_350(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_351(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
int func_353(var uParam0, vector3 vParam1, int iParam2, bool bParam3)
{
	...
	AI::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_2);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(uParam0->f_2, 1, 0f);
	ENTITY::SET_ENTITY_MAX_HEALTH(uParam0->f_2, iLocal_485);
	ENTITY::SET_ENTITY_HEALTH(uParam0->f_2, iLocal_485, 0);
	uParam0->f_4 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_276, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	...
	uParam0->f_5 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_276, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	...
	uParam0->f_6 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_276, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, 5f, 0f), 1, 1, 0);
	...
	*uParam0 = 1;
	uParam0->f_32 = 0;
	uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iParam2 * 500);
	uParam0->f_16 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_486, iLocal_487));
	uParam0->f_10 = func_354(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 1);
	uParam0->f_11 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(2f, 3f);
	uParam0->f_14 = (fLocal_509 + (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_513, fLocal_514) * fLocal_509));
	uParam0->f_15 = 0f;
	if (iLocal_116 == 1)
	{
	}
	AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 1000f, -8f, -1, 1, 0f, 0, 0, 0);
	iLocal_524++;
	return 1;
}
...
int func_357(var uParam0, float fParam1)
{
	...
	fVar0 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f);
	if (fVar0 > fParam1)
	{
		return 0;
	}
...
int func_358(var uParam0)
{
	...
	{
		iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar1);
...
float func_370(var uParam0)
{
	if (func_373(uParam0))
	{
		...
		{
			return (func_371(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_371(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_377(int iParam0)
{
	...
	{
		case 0:
			GAMEPLAY::SET_TIME_SCALE(fLocal_112);
			AUDIO::_0xDDC635D5B3262C56("BARRY_01_SLOWMO");
		...
		if (func_367(&iLocal_534, fLocal_537))
		{
			if (func_361(&iVar0))
			{
				if (func_379(vParam0, fParam1, &vVar1))
				{
					...
					func_374(&iLocal_534);
					fLocal_537 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1.5f, 2.5f);
				}
				else
				{
					func_374(&iLocal_534);
...
void func_380()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_279)
	{
		return;
	}
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	...
	StringIntConCat(&Var0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3) + 1, 16);
	func_35(&uLocal_308, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
{
	func_35(&uLocal_308, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	iLocal_279 = GAMEPLAY::GET_GAME_TIMER() + 1500;
	iLocal_281 = (iLocal_279 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
	iLocal_280 = (iLocal_279 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(12000, 18000));
...
int func_402(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_113, iParam1) || GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_327(1, 1093140480, 0))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_127, -1, 0, 0);
		...
		case 3:
			...
			if (iLocal_272 == 0)
			{
				...
				if (!GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_254))
				{
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_254, 0, 1);
				}
			}
			else
			{
...
int func_422(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_426(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_426(iVar2, iVar6)))
			{
				...
				{
					uVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_426(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_426(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_426(iVar2, iVar6)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_426(iVar2, iVar6));
				func_423(uVar1, func_426(iVar2, iVar6));
			}
		}
		iVar6++;
	}
...
void func_429(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		func_430(iParam0, &(Global_106070.f_2355.f_539.f_1749));
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0] = UI::_0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
...
void func_430(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_431(Var7.f_1)) && iVar9 < 50)
			{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257) && !func_330())
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_257, "leadin", 8f, -4f, -1, 2, 0f, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(Local_94.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_567(Local_94.f_28[0]))
			{
				if (!func_330() || GAMEPLAY::GET_GAME_TIMER() > iLocal_95)
				{
					*iParam0 = 4;
				}
			}
...
void func_438()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_481)
	{
		iLocal_479 = -1;
	}
...
void func_440(var uParam0)
{
	...
	if (func_469(uParam0) && bLocal_477 == 1)
	{
		...
		AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 8f, -8f, -1, 1, 0f, 0, 0, 0);
		func_58(uParam0);
		func_60(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
			{
				uParam0->f_31 = 0;
				uParam0->f_26 = 0;
				uParam0->f_1 = 2;
		...
		case 3:
			uParam0->f_15 = (uParam0->f_15 + (GAMEPLAY::GET_FRAME_TIME() * 512f));
		...
		case 5:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - GAMEPLAY::GET_GAME_TIMER()) * 255) / SYSTEM::TO_FLOAT(450));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
			func_74(uParam0->f_2, SYSTEM::FLOOR(uParam0->f_15), &iLocal_118);
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7 || uParam0->f_15 == 0f)
			{
		...
		case 6:
			...
			if (func_346(&vVar0))
			{
				...
				uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1250, 2000));
				uParam0->f_14 = (fLocal_509 + (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_513, fLocal_514) * fLocal_509));
				if (iLocal_116 == 1)
				{
				}
		...
		case 9:
			...
			if (!uParam0->f_32)
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 1227113341) != 1)
				{
					AI::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 1073741824, 1073741824, 0);
				}
			}
			if (!func_9())
			{
			...
			if (func_466(uParam0))
			{
				AI::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_2, 3f);
		...
		case 12:
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
			{
				if (iLocal_116 == 1)
				{
				}
		...
		case 13:
			...
			if (bLocal_477 == 1)
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
				{
					AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 4f, -4f, -1, 1, 0f, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
			uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE((iLocal_480 - 1500), (iLocal_480 - 500)));
			break;
		
		case 14:
			PED::SET_PED_NAME_DEBUG(uParam0->f_2, "WATCH END");
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7 && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_264, 3))
			{
				uParam0->f_1 = 9;
			}
			break;
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_508);
				func_59(&(uParam0->f_21));
				func_59(&(uParam0->f_22));
				func_59(&(uParam0->f_23));
				func_59(&(uParam0->f_24));
				...
				GRAPHICS::_SET_PARTICLE_FX_LOOPED_RANGE(uParam0->f_23, uParam0->f_12);
				AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0f, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			{
				if (((PED::IS_PED_FALLING(uParam0->f_2) || AI::IS_PED_GETTING_UP(uParam0->f_2)) || PED::IS_PED_RAGDOLL(uParam0->f_2)) || PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
				{
					return;
				}
			}
			if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0f, 0, 0, 0);
			}
			if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
		...
		case 7:
			if (func_441(uParam0) || GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
			{
				...
				uParam0->f_7 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			}
			break;
		
		case 8:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - GAMEPLAY::GET_GAME_TIMER()) * 255) / SYSTEM::TO_FLOAT(1000));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
...
void func_443(var uParam0)
{
	...
	if (GAMEPLAY::GET_FRAME_COUNT() >= uParam0->f_9 + 8)
	{
	...
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar3, vVar4, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar5, &uVar6, &uVar7);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				uParam0->f_9 = GAMEPLAY::GET_FRAME_COUNT();
				ENTITY::SET_ENTITY_RENDER_SCORCHED(PLAYER::PLAYER_PED_ID(), 1);
				uParam0->f_27 = { GAMEPLAY::_0x21C235BC64831E5A(vVar5, vVar3, vVar4, 0) };
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, 1) <= 0.7f)
				{
					fLocal_111 = 0f;
					if (GAMEPLAY::ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						if ((GAMEPLAY::GET_FRAME_COUNT() % 20) == 0)
						{
							GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar3, vVar4, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
						}
						if (iLocal_503 == 1)
						{
						...
						if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_8)
						{
							func_445();
							...
							uParam0->f_8 = (GAMEPLAY::GET_GAME_TIMER() + SYSTEM::ROUND((IntToFloat(iLocal_506) * 1.25f)));
							CONTROLS::SET_PAD_SHAKE(0, (iLocal_506 / 2), 255);
							CONTROLS::SET_PAD_SHAKE(0, (iLocal_506 / 2), 255);
						}
					}
				}
...
void func_445()
{
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_282)
	{
		return;
	}
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	...
	{
		iLocal_282 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 7000));
	}
}
...
void func_455(var uParam0)
{
	...
	else if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -982327190) != 1)
	{
		AI::TASK_STAND_STILL(uParam0->f_2, -1);
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_507 * 2);
	}
	if (!func_9())
	{
		return;
	...
	if (uParam0->f_26 == 0)
	{
		...
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar3, vVar4, 511, PLAYER::PLAYER_PED_ID(), 7);
		if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7 && uParam0->f_32)
		{
			func_60(&(uParam0->f_17));
	...
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar4, &uVar5, &uVar6);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_256, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar2);
				AI::TASK_PERFORM_SEQUENCE(uParam0->f_2, uVar2);
				AI::CLEAR_SEQUENCE_TASK(&uVar2);
				if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_22))
				{
					uParam0->f_22 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_490, 0, 0, 0);
				...
				uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_507);
				func_60(&(uParam0->f_17));
				uParam0->f_17 = AUDIO::GET_SOUND_ID();
				AUDIO::PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			}
...
void func_458(var uParam0)
{
	...
	iLocal_481 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_482);
	bLocal_477 = true;
	CAM::_0xCCD078C2665D2973(1);
	PED::SET_PED_NAME_DEBUG(uParam0->f_2, "SUMMON");
	func_436();
	iVar0 = func_461(CONTROLS::GET_DISABLED_CONTROL_NORMAL(0, 30));
	if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 30) || iVar0 != uParam0->f_20)
	{
		uParam0->f_20 = iVar0;
		uParam0->f_18++;
	}
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_19)
	{
		...
		uParam0->f_19 = GAMEPLAY::GET_GAME_TIMER() + 2000;
	}
	if (uParam0->f_18 > iLocal_483 || AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		...
		{
			AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_263, 8f, -8f, -1, 0, 0f, 0, 0, 0);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3))
		{
			AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0f, 0, 0, 0);
		...
		uParam0->f_18 = 0;
		uParam0->f_1 = 12;
		uParam0->f_7 = GAMEPLAY::GET_GAME_TIMER() + 2000;
		...
		if (iLocal_119 == 0)
		{
			...
			UNK1::_0x293220DA1B46CEBC(fVar1, 2f, 1);
		}
		iLocal_119++;
		return;
	}
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
	{
		AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_265, 8f, -8f, -1, 0, 0f, 0, 0, 0);
		func_60(&(uParam0->f_17));
		func_459();
	}
}
...
void func_462(var uParam0)
{
	...
	func_355(uParam0->f_2);
	AI::OPEN_SEQUENCE_TASK(&uVar0);
	AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_259, 8f, -8f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_261, 8f, -8f, -1, 1, 0f, 0, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
	AI::TASK_PERFORM_SEQUENCE(uParam0->f_2, uVar0);
	AI::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(uParam0->f_2, 0, 0);
	func_464(PLAYER::PLAYER_PED_ID(), uParam0->f_2);
	AI::OPEN_SEQUENCE_TASK(&uVar0);
	AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_260, 8f, -8f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_PLAY_ANIM(0, sLocal_256, sLocal_262, 8f, -8f, -1, 1, 0f, 0, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
	AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0);
	AI::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	...
	if (iLocal_523 == 0)
	{
		...
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_484) + 2000;
		CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_484 + 2000, 2000, 2000);
	}
	else
	{
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_484);
...
bool func_466(var uParam0)
{
	...
	return ((iLocal_478 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_481) && uParam0->f_30 == iLocal_479);
}
...
void func_470(var uParam0)
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_16)
	{
		if (uParam0->f_10 < 20f)
		{
			uParam0->f_16 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_486, iLocal_487));
...
int func_471(var uParam0)
{
	if (!func_475(uParam0))
	{
		...
		if (ENTITY::IS_ENTITY_DEAD(uParam0->f_2, 0) || PED::IS_PED_INJURED(uParam0->f_2))
		{
			...
			func_473();
			func_6(&(uParam0->f_3));
			uParam0->f_7 = GAMEPLAY::GET_GAME_TIMER() + 2500;
			if (iLocal_116 == 1)
			{
			}
			iLocal_525++;
			if (iLocal_521 == 0)
			{
				iLocal_522 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
			iLocal_521++;
...
void func_473()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_280)
	{
		return;
	}
	if (!bLocal_278)
	...
	{
		iLocal_280 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000));
		if ((iLocal_281 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_281 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_484(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_495(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_497(iParam0, Global_36117);
}
...
int func_501(int iParam0, int iParam1)
{
	...
	{
		SYSTEM::WAIT(0);
		if (GAMEPLAY::GET_GAME_TIMER() > iVar0 && !WEAPON::HAS_WEAPON_ASSET_LOADED(iParam0))
		{
			return 0;
		}
	}
...
void func_502()
{
	...
	if (func_515() == 1)
	{
		...
		if (func_567(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3))
			{
				AI::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, -8f);
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, 3))
			{
				AI::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, -8f);
			}
			ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
			func_429(PLAYER::PLAYER_PED_ID());
			WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
int func_506(var uParam0)
{
	...
	switch (iLocal_80)
	{
		...
		case 2:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(189.5964f, -956.0344f, 29.09179f, 5f, 0);
...
int func_530(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_81() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_142(func_528(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_540()
{
	...
	iVar0 = func_541(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_544()
{
	...
	{
		if (func_539(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_556(int iParam0)
{
	if (func_26(iParam0))
	{
		Global_106070.f_2355.f_539.f_298[iParam0 /*472*/] = { Global_106070.f_2355.f_539.f_1749 };
	}
}
...
void func_557(int iParam0, bool bParam1)
{
	...
	if (func_26(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_430(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_558(int iParam0, bool bParam1)
{
	...
	{
		iVar0 = func_27(iParam0);
		func_559(iParam0, &(Global_106070.f_2355.f_539.f_1749), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
...
void func_559(int iParam0, var uParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar15)
			{
				if (iVar8 < 50)
				{
					...
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_431(Var9.f_1))
						{
							if (iVar7 == 0)
							{
		...
		while (iVar11 < uParam1->f_221)
		{
			...
			if ((iVar8 != -1 && iVar8 < 50) && !func_431(Var9.f_1))
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var9) || func_431(Var9.f_1))
				{
...
void func_561(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
bool func_564(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_hatchet"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_291() && !Global_262145.f_19620)
				{
					return 0;
				}
			}
	...
	while (iVar0 < DLC1::GET_NUM_DLC_WEAPONS())
	{
		if (DLC1::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var1) || func_431(Var1.f_1))
				{
					return 0;
				}
			}
