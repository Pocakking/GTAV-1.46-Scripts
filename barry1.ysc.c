...
int func_69(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 1), CAM::GET_CAM_COORD(uParam0->f_11), true);
			}
			else
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 0), CAM::GET_CAM_COORD(uParam0->f_11), true);
			}
...
int func_347(var uParam0, bool bParam1)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_106, true) > fLocal_107)
	{
		return 0;
	}
	...
	else
	{
		...
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, true) <= 0.7f)
				{
					fLocal_111 = 0f;
