...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		if (func_46(iLocal_44))
		{
			if ((((!func_45() && !PED::IS_PED_FLEEING(iLocal_44)) && !PED::IS_PED_RAGDOLL(iLocal_44)) && !PED::IS_PED_PRONE(iLocal_44)) && !PED::IS_PED_INJURED(iLocal_44))
			{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_43) > 8000)
					{
	...
	while (iVar0 < 15)
	{
		...
		{
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(Local_210[iVar0 /*11*/]) || func_24(Local_210[iVar0 /*11*/]))
			{
				GAMEPLAY::SET_BIT(&(Global_106070.f_10021.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_10021.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_10021.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_106070.f_10021.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_11()
{
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			...
			case 1:
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("FS_TITLE");
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("FS_DESTROY");
				UI::ADD_TEXT_COMPONENT_INTEGER(func_5(2));
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			...
			case 2:
				...
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_41, "SHARD_ANIM_OUT");
...
void func_16(int iParam0, var uParam1)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(*iParam0, true), true) >= 110f && !ENTITY::IS_ENTITY_ON_SCREEN(*iParam0))
		{
			func_17(iParam0);
			*uParam1 = 0;
		}
...
void func_35()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_38(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(iVar0) && (!func_39(14) || Global_105021))
			{
...
void func_62()
{
	...
	{
		func_64(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
