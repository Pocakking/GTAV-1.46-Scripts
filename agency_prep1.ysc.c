...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_1006)
		{
			...
			{
				GAMEPLAY::CLEAR_AREA(vLocal_1003, 50f, 1, 0, 0, false);
				iLocal_1006 = 1;
			}
		}
		...
		if (!iLocal_1011)
		{
			if (Global_89824.f_358 == GAMEPLAY::GET_HASH_KEY("AHP1_TRUCKCALLED") || Global_89754)
			{
				func_90(543);
		...
		while (iVar0 <= 7)
		{
			if ((ENTITY::DOES_ENTITY_EXIST(iLocal_834[iVar0]) && !PED::IS_PED_INJURED(iLocal_834[iVar0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_832))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_834[iVar0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f)
				{
					...
					AI::TASK_SMART_FLEE_PED(iLocal_834[iVar0], PLAYER::PLAYER_PED_ID(), 300f, 20000, 1, 0);
				...
				else
				{
					...
					if (bLocal_1012)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_832, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_833, 0))
						{
							...
							{
								if (UI::DOES_BLIP_EXIST(iLocal_830))
								{
									UI::REMOVE_BLIP(&iLocal_830);
								}
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_832, 0))
				{
					...
					else if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_832))
					{
						if (!iLocal_1009)
						{
							...
							iLocal_1009 = 1;
							iLocal_1002 = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else if ((iLocal_1009 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_1002) < 7500) && UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						UI::CLEAR_PRINTS();
					}
...
void func_14(char* sParam0)
{
	...
	while (iVar0 < Global_89824.f_9)
	{
		...
		{
			PED::DELETE_PED(&(Global_89824.f_9[iVar0]));
		}
		iVar0++;
	}
	GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 1, 1, 0, false);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
			{
				...
				{
					if (UI::DOES_BLIP_EXIST(iLocal_831))
					{
						UI::REMOVE_BLIP(&iLocal_831);
					}
				}
				else if (!UI::DOES_BLIP_EXIST(iLocal_831))
				{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					...
					else
					{
						switch (iLocal_1035)
						{
							...
							case 2:
								AI::TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1015), iVar0, vLocal_1003, 15f, 0, 1938952078, 786484, 5f, 5f);
							...
							case 3:
								if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, 697.6884f, -1013.364f, 27.4968f, 688.3482f, -1013.179f, 22.32968f, 29.25f, 0, 1, 0))
								{
									if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, 1), vLocal_1016) < SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, 1), vLocal_1017))
									{
										if (bLocal_1012)
										{
											AI::TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1015), iVar0, vLocal_1017, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
										}
										else
										{
											AI::TASK_VEHICLE_PARK(func_84(iLocal_1015), iVar0, vLocal_1003, 180f, 1, 15f, 0);
										}
									}
									else if (bLocal_1012)
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1015), iVar0, vLocal_1016, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
									}
									else
									{
										AI::TASK_VEHICLE_PARK(func_84(iLocal_1015), iVar0, vLocal_1003, 0f, 1, 15f, 0);
									}
									iLocal_1035++;
								}
								break;
	...
	switch (iLocal_1022)
	{
		case 0:
			...
			if (func_65(0, 1, 145, 0, iVar1, &cLocal_1023, &cLocal_1027, 1))
			{
				...
				if (!iLocal_1032)
				{
					iLocal_1034 = GAMEPLAY::GET_GAME_TIMER();
				}
				iLocal_1022 = 1;
			}
			break;
		...
		case 1:
			if (bVar0)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1034) > 5000 || iLocal_1032)
				{
		...
		case 3:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1034) > 10000)
			{
				iLocal_1022 = 0;
			}
			break;
...
void func_87()
{
	...
	if (iLocal_1036 < 8)
	{
		if (iLocal_1036 < 4)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[iLocal_1036]))
			{
				if (!PED::IS_PED_INJURED(Global_89824.f_9[iLocal_1036]))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_89824.f_9[iLocal_1036], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 900f)
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_9[iLocal_1036], 1, 1);
						iLocal_834[iLocal_1036] = Global_89824.f_9[iLocal_1036];
						bVar0 = true;
						Global_89824.f_9[iLocal_1036] = 0;
					}
					else if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_89824.f_9[iLocal_1036], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_89824.f_9[iLocal_1036]))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_9[iLocal_1036], 1, 1);
						PED::DELETE_PED(&(Global_89824.f_9[iLocal_1036]));
					}
				}
			}
		}
...
void func_91()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(Global_89824[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_89824[0], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_89824[0], 0))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[0], 1, 1);
		iLocal_832 = Global_89824[0];
		Global_89824[0] = 0;
	}
	if ((ENTITY::DOES_ENTITY_EXIST(Global_89824[1]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_89824[1], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_89824[1], 0))
	{
	...
	if (func_10(0))
	{
		...
		GAMEPLAY::CLEAR_AREA(vVar0, 20f, 1, 0, 0, false);
		...
		while (iVar1 <= (iLocal_834 - 1))
		{
			...
			{
				AI::TASK_START_SCENARIO_IN_PLACE(iLocal_834[iVar1], "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
