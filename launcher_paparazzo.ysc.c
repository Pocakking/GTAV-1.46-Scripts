	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_268(&Var0, 1);
	}
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_199(var uParam0, bool bParam1)
{
	...
	if ((func_236(*uParam0) || func_234(*uParam0)) || Global_71450 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_235() && Global_93232.f_11 == 6) && iParam0 == func_165(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_126(uParam0->f_41[0]))
			{
				...
				if (func_126(uParam0->f_28[0]))
				{
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
			...
			AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 0);
			GAMEPLAY::CLEAR_AREA_OF_PEDS(-70.12f, 298.33f, 105.25f, 30f, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar1]);
		...
		case 3:
			if (func_126(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					AI::TASK_PLAY_ANIM(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0f, 0, 0, 0);
...
void func_268(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 1);
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("paparazzo3")) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
