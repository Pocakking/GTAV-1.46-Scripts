			...
			switch (iLocal_50)
			{
				...
				case 4:
					...
					while (iVar0 < iLocal_98)
					{
						...
						{
							if (UI::DOES_BLIP_EXIST(uLocal_105[iVar0]))
							{
								UI::REMOVE_BLIP(&(uLocal_105[iVar0]));
							}
						}
						else
						{
							if (AI::IS_PED_IN_WRITHE(iLocal_98[iVar0]))
							{
								if (UI::DOES_BLIP_EXIST(uLocal_105[iVar0]))
								{
									UI::REMOVE_BLIP(&(uLocal_105[iVar0]));
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_98[iVar0], PLAYER::PLAYER_PED_ID(), 30f, 30f, 30f, 0, 1, 0))
							{
								if (!func_108())
								{
									if (iLocal_95 < GAMEPLAY::GET_GAME_TIMER())
									{
										...
										iLocal_95 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4500, 6000));
									}
								}
							}
							bLocal_79 = true;
				...
				case 3:
					...
					if (func_30(&uLocal_114, &uLocal_120, &uLocal_109, cLocal_261, sLocal_262, &bLocal_76, 78))
					{
						...
						AI::REMOVE_COVER_POINT(iLocal_108);
						iVar0 = 0;
						while (iVar0 < iLocal_98)
						{
...
{
	iParam0->f_1 = (func_34(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_61()
{
	...
	if (SYSTEM::TIMERA() > 10000)
	{
		...
		while (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_93(PLAYER::PLAYER_ID()), vLocal_53, 1) < 209f && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			SYSTEM::WAIT(0);
		}
		func_62(18);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_72(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_109()
{
	...
	switch (iLocal_94)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA(vLocal_53, 100f, 1, 0, 0, false);
			...
			iLocal_108 = AI::ADD_COVER_POINT(-1173.509f, 4924.365f, 222.21f, 277.2293f, 2, 0, 2, 1);
		...
		case 6:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
			{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("TREVOR", 0))
				{
					...
					AI::TASK_PUT_PED_DIRECTLY_INTO_COVER(PLAYER::PLAYER_PED_ID(), -1173.509f, 4924.365f, 222.21f, -1, 0, 0f, 1, 0, iLocal_108, 0);
				...
				while (iVar1 < iLocal_98)
				{
					if (((iVar1 == 0 || iVar1 == 5) || iVar1 == 6) || iVar1 == 10)
					{
						...
						PED::SET_PED_SHOOT_RATE(iLocal_98[iVar1], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(40, 60));
						AI::TASK_COMBAT_PED(iLocal_98[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
					else if (iVar1 == 2)
					{
					...
					else if (iVar1 > 10 && iVar1 < 20)
					{
						if (((((!PED::IS_PED_INJURED(iLocal_98[iVar1]) && !PED::IS_PED_INJURED(iLocal_98[11])) && !PED::IS_PED_INJURED(iLocal_98[12])) && !PED::IS_PED_INJURED(iLocal_98[13])) && !PED::IS_PED_INJURED(iLocal_98[14])) && !PED::IS_PED_INJURED(iLocal_98[15]))
						{
							...
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1159.33f, 4924.412f, 221.6576f, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
							...
							AI::TASK_PERFORM_SEQUENCE(iLocal_98[15], uLocal_107);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_107);
							AI::OPEN_SEQUENCE_TASK(&uLocal_107);
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1163.279f, 4932.933f, 222.541f, PLAYER::PLAYER_PED_ID(), 1f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
							AI::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), 5000, 0);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 7500, 0);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(uLocal_107);
							AI::TASK_PERFORM_SEQUENCE(iLocal_98[14], uLocal_107);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_107);
							AI::OPEN_SEQUENCE_TASK(&uLocal_107);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2500, 0);
							AI::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), 5000, 0);
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1156.175f, 4926.073f, 221.3447f, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 6500, 0);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(uLocal_107);
							AI::TASK_PERFORM_SEQUENCE(iLocal_98[13], uLocal_107);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_107);
							AI::OPEN_SEQUENCE_TASK(&uLocal_107);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000, 0);
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1157.962f, 4922.196f, 221.309f, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5500, 0);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(uLocal_107);
							AI::TASK_PERFORM_SEQUENCE(iLocal_98[12], uLocal_107);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_107);
							AI::OPEN_SEQUENCE_TASK(&uLocal_107);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), 10000, 0);
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1161.475f, 4916.061f, 220.5658f, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(uLocal_107);
							AI::TASK_PERFORM_SEQUENCE(iLocal_98[11], uLocal_107);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_107);
...
void func_150()
{
	if (fLocal_87 > 0f)
	{
		fLocal_87 = (fLocal_87 - (0.6f / (1f / GAMEPLAY::GET_FRAME_TIME())));
	}
	else
	{
		fLocal_87 = 0f;
	...
	if (fLocal_87 >= 0f)
	{
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35240[10 /*31*/], fLocal_87, 0, 1);
		OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35240[10 /*31*/], 4, 0, 1);
	}
	if (fLocal_86 < 0f)
	{
		fLocal_86 = (fLocal_86 + (0.6f / (1f / GAMEPLAY::GET_FRAME_TIME())));
	}
	else
	{
		fLocal_86 = 0f;
	...
	if (fLocal_86 <= 0f)
	{
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35240[9 /*31*/], fLocal_86, 0, 1);
...
void func_152()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if ((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_o_acult_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_anim_cash_pile_02"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@altruist_cult")) && AUDIO::PREPARE_MUSIC_EVENT("AC_DELIVERED")) && WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_assaultrifle")))
			{
				...
				else
				{
					...
					{
						AI::CLEAR_PED_TASKS(uLocal_97[0]);
						PED::REMOVE_PED_FROM_GROUP(uLocal_97[0]);
						AI::CLEAR_PED_TASKS(uLocal_97[1]);
		...
		case 1:
			...
			GAMEPLAY::CLEAR_AREA(vLocal_54, 12f, 1, 0, 0, false);
			...
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_92, "random@altruist_cult", sLocal_265, 1000f, -2f, 4, 0, 1148846080, 0);
			AI::TASK_SYNCHRONIZED_SCENE(iLocal_98[0], iLocal_92, "random@altruist_cult", sLocal_263, 1000f, -2f, 4, 0, 1148846080, 0);
			if (Global_106070.f_24967.f_5 >= 2)
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_98[1], iLocal_92, "random@altruist_cult", sLocal_264, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			...
			if (!PED::IS_PED_INJURED(uLocal_97[0]) && !PED::IS_PED_INJURED(uLocal_97[1]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(uLocal_97[0], iLocal_92, "random@altruist_cult", sLocal_266, 1000f, -2f, 4, 0, 1148846080, 0);
				AI::TASK_SYNCHRONIZED_SCENE(uLocal_97[1], iLocal_92, "random@altruist_cult", sLocal_267, 1000f, -2f, 4, 0, 1148846080, 0);
			}
			iLocal_93++;
			break;
	...
	switch (iLocal_93)
	{
		...
		case 4:
			if (Global_106070.f_24967.f_5 < 3)
			{
				...
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_268, "cult_p4_cam"))
				{
					CAM::RENDER_SCRIPT_CAMS(false, 0, 3000, 1, 0, 0);
				}
				else
...
void func_181()
{
	if (func_184())
	{
		...
		while (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_93(PLAYER::PLAYER_ID()), vLocal_53, 1) < 209f)
		{
			SYSTEM::WAIT(0);
		}
	}
...
int func_182()
{
	if ((((((GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_55, vLocal_56, fLocal_57, 1) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_58, vLocal_59, fLocal_60, 1)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_61, vLocal_62, fLocal_63, 1)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_64, vLocal_65, fLocal_66, 1)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_67, vLocal_68, fLocal_69, 1)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_70, vLocal_71, fLocal_72, 1)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(vLocal_73, vLocal_74, fLocal_75, 1))
	{
		return 1;
	}
	return 0;
