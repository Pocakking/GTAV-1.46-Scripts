		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_70(Local_95.f_2))
				{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_96[iVar0 /*3*/].f_1, 6))
						{
							GAMEPLAY::SET_BIT(&Local_95, 9);
							GAMEPLAY::CLEAR_BIT(&(vLocal_96[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_95.f_20 != 3)
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_96[iVar0 /*3*/].f_1, 5))
						{
							Local_95.f_20 = 3;
							GAMEPLAY::CLEAR_BIT(&(vLocal_96[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
...
int func_41()
{
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 10))
			{
				...
				if (WATER::TEST_PROBE_AGAINST_WATER(vLocal_793 + Vector(2f, 0f, 0f), vLocal_793 - Vector(10f, 0f, 0f), &vLocal_793))
				{
					if (func_43(vLocal_793, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
					{
						...
						iLocal_791 = WORLDPROBE::START_SHAPE_TEST_BOX(vVar2, 10f, 10f, 25f, 0f, 0f, -1f, 2, 1, 0, 4);
						if (iLocal_791 == 0)
						{
							return 0;
						}
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_97, 10);
						}
					}
				}
			}
			else if (WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_791, &iLocal_792, &uVar0, &uVar0, &uVar1) == 2)
			{
				iLocal_791 = 0;
				if (iLocal_792 == 0)
				{
					if (func_42(&(Local_95.f_2), joaat("dinghy2"), vLocal_793, fLocal_794, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
					{
						...
						ENTITY::_SET_ENTITY_REGISTER(NETWORK::NET_TO_VEH(Local_95.f_2), 0);
					}
				}
				else
				{
					iLocal_792 = 0;
					GAMEPLAY::CLEAR_BIT(&iLocal_97, 10);
				}
			}
			else if (WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_791, &iLocal_792, &uVar0, &uVar0, &uVar1) == 0)
			{
				iLocal_791 = 0;
				GAMEPLAY::CLEAR_BIT(&iLocal_97, 10);
			}
	...
	if (iParam2 && !bParam5)
	{
		if (func_3(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_48(PLAYER::PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_45(iVar1) || !bParam8) && !Global_2423801[iVar1 /*413*/].f_259)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_48(iVar1), vParam0, 1) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_3(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_45(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_53(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_49(iVar1), vParam0, 1) < fParam1)
								{
									return 1;
								}
							}
...
Vector3 func_60(vector3 vParam0, float fParam1, float fParam2, float fParam3)
{
	...
	fVar1 = (fParam3 / 2f);
	vVar0 = { func_61(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) };
...
Vector3 func_63(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_95.f_10, func_37(iVar0), 1);
				if (fVar3 < fVar4)
				{
					iVar1 = iVar0;
					fVar4 = fVar3;
		...
		switch (vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2)
		{
			...
			case 1:
				if (func_70(Local_95.f_2))
				{
					...
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 0))
					{
						...
						GAMEPLAY::CLEAR_BIT(&(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
					}
				}
				break;
			...
			case 2:
				if (func_70(Local_95.f_2))
				{
					...
					{
						vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						GAMEPLAY::CLEAR_BIT(&(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 5);
						GAMEPLAY::SET_BIT(&(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 6);
						if (Local_95.f_21 >= 4)
						{
...
void func_73()
{
			...
			if (((vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				...
				if (vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_70(Local_95.f_2))
					{
						...
						{
							func_83(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, true), "BTX_ENTER", &uLocal_104, 0);
						}
					}
				}
				else
	...
	{
		uLocal_103 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
	}
}
			...
			while (iVar0 < uParam2->f_680)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_78(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_78(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_78(CONTROLS::_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
		...
		if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) || (!NETWORK::_0xA1607996431332DF(Local_95.f_3) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()))
		{
			...
			switch (Local_95.f_20)
			{
				...
				case 4:
					...
					if (PATHFIND::_0xF7B79A50B905A30D(fLocal_966, fLocal_968, fLocal_967, fLocal_969))
					{
						...
						{
							AI::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_102);
						}
					}
					break;
				...
				case 1:
					if (!GAMEPLAY::IS_BIT_SET(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1, 7))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 0) || PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2)))
						{
							...
							AI::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_100);
						}
						else
						{
							PED::SET_PED_DIES_IN_WATER(NETWORK::NET_TO_PED(Local_95.f_3), 0);
							...
							AI::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_101);
						}
						GAMEPLAY::SET_BIT(&(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 7);
					}
					break;
...
void func_102()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 4))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_PED(Local_95.f_3), 15f, 15f, 15f, 0, 1, 0))
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_106(&uLocal_795, "FMAMBAU", "FMA_BPDA", 12, 0, 0, 1))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_97, 4);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 6))
	{
		if (Local_95.f_20 == 4)
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				AI::TASK_LOOK_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_97, 6);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 5))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_95.f_7, (10f * 2f), (10f * 2f), (10f * 2f), 0, 1, 0))
		{
			...
			{
				AI::TASK_LOOK_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_97, 5);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 7))
	{
		if (Local_95.f_20 == 5)
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				AI::TASK_LOOK_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_97, 7);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_97, 8))
	{
		func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (Local_95.f_20 == 4)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) <= 0)
		{
			if (func_66(&uLocal_964, iLocal_963, 0))
			{
				...
				StringCopy(&Var1, "", 16);
				if (!GAMEPLAY::IS_BIT_SET(iLocal_98, iVar0))
				{
					switch (iVar0)
					{
						case 0:
					...
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Var1))
					{
						...
						if (func_106(&uLocal_795, "FMAMBAU", &Var1, 12, 0, 0, 1))
						{
							...
							GAMEPLAY::SET_BIT(&iLocal_98, iVar0);
							AI::TASK_LOOK_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
							iLocal_963 = (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 30001) + iVar0 * 500);
						}
					}
				}
			}
...
void func_125()
{
	if (!UI::DOES_BLIP_EXIST(iLocal_99))
	{
		if (func_70(Local_95.f_2))
		{
			iLocal_99 = UI::ADD_BLIP_FOR_ENTITY(NETWORK::NET_TO_VEH(Local_95.f_2));
			UI::SET_BLIP_SPRITE(iLocal_99, 356);
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_99, "BTX_BLIP");
			UI::SET_BLIP_FLASHES(iLocal_99, 1);
			UI::SET_BLIP_CATEGORY(iLocal_99, 6);
		}
	}
}
...
void func_126()
{
	if (func_70(Local_95.f_2))
	{
		...
		AI::OPEN_SEQUENCE_TASK(&uLocal_100);
		...
		AI::CLOSE_SEQUENCE_TASK(uLocal_100);
	}
}
...
int func_129()
{
	...
	if (func_130() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_130()) == 0)
		{
			return 1;
		}
	}
...
void func_142()
{
	AI::CLEAR_SEQUENCE_TASK(&uLocal_100);
	AI::CLEAR_SEQUENCE_TASK(&uLocal_101);
	AI::CLEAR_SEQUENCE_TASK(&uLocal_102);
}
