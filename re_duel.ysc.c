	...
	switch (iLocal_46)
	{
		...
		case 1:
			switch (iLocal_65)
			{
				...
				case 2:
					...
					if (!func_151(8) && func_85())
					{
						...
						if (func_224(Local_47[0 /*5*/]))
						{
							...
							AI::TASK_COMBAT_PED(Local_47[0 /*5*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							Local_47[0 /*5*/].f_3 = 3;
						}
						if (func_224(Local_47[1 /*5*/]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[1 /*5*/], false);
							AI::TASK_COMBAT_PED(Local_47[1 /*5*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							Local_47[1 /*5*/].f_3 = 3;
						}
				...
				case 3:
					if ((!func_224(Local_47[0 /*5*/]) || UI::DOES_BLIP_EXIST(Local_47[0 /*5*/].f_1)) && (!func_224(Local_47[1 /*5*/]) || UI::DOES_BLIP_EXIST(Local_47[1 /*5*/].f_1)))
					{
						iLocal_65++;
					}
					break;
				...
				case 9:
					if (func_93() || (func_224(Local_48[0 /*4*/]) && func_78(PLAYER::PLAYER_PED_ID(), Local_48[0 /*4*/], 1) <= 35f))
					{
						...
						iVar5 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6, 10);
						if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vVar1, iVar5, &vVar2, 1, 5f, 0f))
						{
							...
							if (((uVar8 & 4 == 0 && (!func_77() || uVar8 & 8 == 0)) && (func_76() || uVar8 & 1 == 0)) && !func_75(vVar2, 1084227584))
							{
								...
								if ((((!CAM::IS_SPHERE_VISIBLE(vVar2, 7f) && !CAM::IS_SPHERE_VISIBLE(vVar3, 7f)) && !CAM::IS_SPHERE_VISIBLE(vVar4, 7f)) && !func_75(vVar3, 1084227584)) && !func_75(vVar4, 1084227584))
								{
									...
									while (iVar9 <= 7)
									{
										if (func_224(Local_47[iVar9 /*5*/]))
										{
											...
											if (PED::IS_PED_IN_ANY_VEHICLE(Local_47[iVar9 /*5*/], 0))
											{
												...
												{
													UI::SET_BLIP_SCALE(Local_47[iVar9 /*5*/].f_1, 1f);
												}
												else
												{
													UI::SET_BLIP_ALPHA(Local_47[iVar9 /*5*/].f_1, 0);
													UI::_0x54318C915D27E4CE(Local_47[iVar9 /*5*/].f_1, 1);
												}
											}
										}
										iVar9++;
									...
									func_108(2);
									func_108(7);
									iLocal_69 = (GAMEPLAY::GET_GAME_TIMER() + 60000);
									func_68(6);
									iLocal_65++;
								}
							}
...
void func_61(int iParam0, int iParam1, var uParam2)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_48[iParam0 /*4*/], 0))
	{
		if ((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && Local_48[iParam0 /*4*/] != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && func_67(Local_48[iParam0 /*4*/]))
		{
			...
			else if (((((((((((GAMEPLAY::GET_GAME_TIMER() - *uParam2) > iVar2 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_59) > 1500) && func_78(Local_48[iParam0 /*4*/], iParam1, 1) > func_79(iParam1, vLocal_57, 1)) && func_66(iParam0)) && func_79(iParam1, vLocal_57, 1) >= fVar0) && func_78(Local_48[iParam0 /*4*/], iParam1, 1) >= fVar1) && func_65(Local_48[iParam0 /*4*/], vLocal_57, 1153138688)) && func_64(Local_48[iParam0 /*4*/], iParam1, vLocal_57)) && !func_63(vLocal_57)) && !CAM::IS_SPHERE_VISIBLE(vLocal_57, 4f)) && !func_75(vLocal_57, 1084227584))
			{
				GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_57, 1.5f, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_57, 5f, 0, 0, 0, 0, false, 0);
				if (iParam0 == 3 || iParam0 == 4)
				{
				...
				*uParam2 = GAMEPLAY::GET_GAME_TIMER();
				Local_48[iParam0 /*4*/].f_2 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_59 = GAMEPLAY::GET_GAME_TIMER();
			}
		}
		else
...
{
	GAMEPLAY::SET_BIT(&(Local_47[iParam0 /*5*/].f_2), iParam1);
}
...
int func_64(int iParam0, int iParam1, vector3 vParam2)
{
	...
	if (iParam0 == Local_48[3 /*4*/] && !UI::DOES_BLIP_EXIST(Local_47[0 /*5*/].f_1))
	{
		return 1;
	}
	if (iParam0 == Local_48[4 /*4*/] && !UI::DOES_BLIP_EXIST(Local_47[1 /*5*/].f_1))
	{
		return 1;
	}
	return 0;
...
int func_66(int iParam0)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		{
			if (IntToFloat(iVar3) == -1f || (GAMEPLAY::GET_GAME_TIMER() - Local_48[iVar2 /*4*/].f_2) > iVar3)
			{
				iVar3 = (GAMEPLAY::GET_GAME_TIMER() - Local_48[iVar2 /*4*/].f_2);
				iVar4 = iVar2;
			}
...
{
	GAMEPLAY::CLEAR_BIT(&iLocal_66, iParam0);
}
...
int func_71(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_72(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_72(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_73(int iParam0, vector3 vParam1)
{
	if (func_224(iParam0))
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam1, 3f, 0, 0, 0, 0, false, 0);
...
int func_80(int iParam0, bool bParam1, vector3 vParam2, float fParam3)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*5*/]))
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar65))
		{
			AI::TASK_START_SCENARIO_IN_PLACE(Local_47[iParam0 /*5*/], sVar65, -1, 0);
		}
		if (iVar11 > 0)
		{
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_91();
	AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_48[iParam0 /*4*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_48[iParam0 /*4*/], 0f, 20f, 0f), 30f, 0, 0, 262144, 4f, -1f);
	...
	if (func_224(Local_48[iParam2 /*4*/]))
	{
		...
		iLocal_71 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		if (func_224(Local_47[iParam3 /*5*/]))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam3 /*5*/], true);
			AI::TASK_VEHICLE_MISSION(Local_47[iParam3 /*5*/], Local_48[iParam2 /*4*/], Local_48[0 /*4*/], 2, 30f, 262144, -1f, -1f, 1);
		}
...
void func_90(int iParam0)
{
	...
	AI::TASK_PERFORM_SEQUENCE(iParam0, iLocal_82);
...
int func_92(vector3 vParam0, float fParam1)
{
	...
	if ((fVar1 / fVar0) <= fParam1 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, vParam0, true) < GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar2, vParam0, true))
	{
		return 1;
	}
	return 0;
...
{
	GAMEPLAY::SET_BIT(&iLocal_66, iParam0);
}
...
void func_120()
{
	...
	func_126();
	func_121();
	if ((func_151(5) && func_224(Local_48[iLocal_83 /*4*/])) && GAMEPLAY::GET_GAME_TIMER() < iLocal_67)
	{
	...
	if (func_151(6))
	{
		if (iLocal_68 == 0)
		{
			...
			{
				iLocal_68 = GAMEPLAY::GET_GAME_TIMER() + 30000;
			}
		}
		else if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_68)
		{
			func_68(6);
		}
	}
	if (func_151(7))
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_69)
		{
			func_68(7);
		}
	}
	if ((func_151(9) && func_224(Local_48[0 /*4*/])) && func_78(PLAYER::PLAYER_PED_ID(), Local_48[0 /*4*/], 1) <= 35f)
	{
		if (!func_151(10))
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_72) >= 1000 && !func_75(vLocal_52, 7f)) && func_79(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) >= 50f)
				{
					GAMEPLAY::CLEAR_AREA(vLocal_52, 7f, 1, 0, 0, false);
		...
		if (!func_151(11))
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_73) >= 1000 && !func_75(vLocal_53, 7f)) && func_79(PLAYER::PLAYER_PED_ID(), vLocal_53, 1) >= 50f)
				{
					GAMEPLAY::CLEAR_AREA(vLocal_53, 7f, 1, 0, 0, false);
	...
	if (func_151(8))
	{
		if (iLocal_70 == 0)
		{
			iLocal_70 = GAMEPLAY::GET_GAME_TIMER() + 3500;
		}
		else if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_70)
		{
			func_68(8);
			func_108(6);
		}
...
void func_121()
{
	...
	while (iVar0 < 8)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_47[iVar0 /*5*/]) && UI::DOES_BLIP_EXIST(Local_47[iVar0 /*5*/].f_1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_47[iVar0 /*5*/], 0))
			{
				if (!func_125(iVar0, 0))
				{
					UI::SET_BLIP_SCALE(Local_47[iVar0 /*5*/].f_1, 1f);
					func_62(iVar0, 0);
				}
				if (func_69(Local_47[iVar0 /*5*/], 0) != -1)
				{
					if (func_124(iVar0))
					{
						if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1) > 0)
						{
							UI::SET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1, 0);
							UI::_0x54318C915D27E4CE(Local_47[iVar0 /*5*/].f_1, 1);
						}
					}
					else if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1) == 0)
					{
						UI::SET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1, 255);
						UI::_0x54318C915D27E4CE(Local_47[iVar0 /*5*/].f_1, 0);
					}
				}
			}
			else if (func_125(iVar0, 0))
			{
				UI::SET_BLIP_SCALE(Local_47[iVar0 /*5*/].f_1, 0.7f);
				func_123(iVar0, 0);
				if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1) == 0)
				{
					UI::SET_BLIP_ALPHA(Local_47[iVar0 /*5*/].f_1, 255);
...
{
	GAMEPLAY::CLEAR_BIT(&(Local_47[iParam0 /*5*/].f_2), iParam1);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Local_47[iParam0 /*5*/].f_2, iParam1);
}
	...
	if (func_224(Local_47[iParam0 /*5*/]))
	{
		switch (iParam0)
		{
			...
			case 1:
				...
				{
					case 0:
						Local_47[iParam0 /*5*/].f_4 = GAMEPLAY::GET_GAME_TIMER();
					...
					case 1:
						if (func_224(Local_48[iVar0 /*4*/]))
						{
							...
							{
								if ((((((GAMEPLAY::GET_GAME_TIMER() >= iLocal_71 && !func_151(12)) && !ENTITY::IS_ENTITY_AT_COORD(Local_48[iVar0 /*4*/], vLocal_54, 7f, 7f, 7f, false, true, 0)) && func_79(PLAYER::PLAYER_PED_ID(), vLocal_54, 1) < func_78(Local_48[iVar0 /*4*/], PLAYER::PLAYER_PED_ID(), 1)) && !CAM::IS_SPHERE_VISIBLE(vLocal_54, 7f)) && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_48[iVar0 /*4*/], true), 7f)) && !func_75(vLocal_54, 8f))
								{
									fVar3 = func_74(vLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
									GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_54, 8f, 0, 0, 0, 0, false, 0);
									GAMEPLAY::CLEAR_AREA_OF_VEHICLES(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vLocal_54, fVar3, 0f, -8f, 0f), 8f, 0, 0, 0, 0, false, 0);
									...
									func_108(5);
									iLocal_83 = iVar0;
									iLocal_67 = GAMEPLAY::GET_GAME_TIMER() + 5000;
								}
								if (!func_151(12) && ENTITY::IS_ENTITY_AT_COORD(Local_48[iVar0 /*4*/], vLocal_54, 7f, 7f, 7f, false, true, 0))
								{
									func_108(12);
								}
								if (((GAMEPLAY::GET_GAME_TIMER() >= iLocal_71 && ENTITY::IS_ENTITY_OCCLUDED(Local_48[iVar0 /*4*/])) && func_224(Local_48[iVar1 /*4*/])) && func_78(Local_48[iVar0 /*4*/], Local_48[iVar1 /*4*/], 1) >= 20f)
								{
								...
								if ((func_125(iParam0, 3) || func_78(Local_47[iParam0 /*5*/], PLAYER::PLAYER_PED_ID(), 1) <= 15f) || (func_224(Local_48[iVar1 /*4*/]) && func_78(Local_48[iVar0 /*4*/], Local_48[iVar1 /*4*/], 1) <= 15f))
								{
									if (func_78(Local_47[iParam0 /*5*/], PLAYER::PLAYER_PED_ID(), 1) <= 15f)
									{
										if (!UI::DOES_BLIP_EXIST(Local_47[iParam0 /*5*/].f_1))
										{
											Local_47[iParam0 /*5*/].f_1 = func_70(Local_47[iParam0 /*5*/], 1, 145);
					...
					case 2:
						if (func_224(Local_48[iVar0 /*4*/]))
						{
							...
							AI::TASK_COMBAT_PED(Local_47[iParam0 /*5*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							Local_47[iParam0 /*5*/].f_3++;
						}
						break;
...
int func_136()
{
	...
	while (iVar1 < 8)
	{
		if (func_224(Local_47[iVar1 /*5*/]) && UI::DOES_BLIP_EXIST(Local_47[iVar1 /*5*/].f_1))
		{
			iVar0 = 0;
			iVar1 = 8;
		}
...
{
	return GAMEPLAY::IS_BIT_SET(iLocal_66, iParam0);
}
...
int func_155(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_192(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
