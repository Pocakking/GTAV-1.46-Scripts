...
void func_1()
{
	...
	if (Global_106070.f_10021.f_107 < fLocal_212)
	{
		if (iLocal_220 == 0)
		{
			if (!func_160(vLocal_219) && !func_159())
			{
				if (SYSTEM::VDIST(vLocal_219, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) >= 10f)
				{
					...
					vLocal_219 = { 0f, 0f, 0f };
					func_157();
					UI::_SET_NOTIFICATION_TEXT_ENTRY("EPSDES_WIPE");
		...
		if (iLocal_206)
		{
			if (func_154(iLocal_38))
			{
				if ((((!func_153() && !PED::IS_PED_FLEEING(iLocal_38)) && !PED::IS_PED_RAGDOLL(iLocal_38)) && !PED::IS_PED_PRONE(iLocal_38)) && !PED::IS_PED_INJURED(iLocal_38))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_209) > 8000)
						{
							if (func_141(&uLocal_41, "EPSDAUD", "EPSD_FOLLOW", 7, 0, 0, 0))
							{
								iLocal_209 = GAMEPLAY::GET_GAME_TIMER();
							}
						}
					}
				}
		...
		if (func_139(0))
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_217, vLocal_232, true);
						vLocal_217 = { vLocal_232 };
					}
				}
				if ((((((PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_ON_VEHICLE(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !AI::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 3155.104f, 4091.06f, 7.974625f, -322.8309f, 2861.712f, 250.5251f, 2250f, 0, true, 0))
					{
						if (func_137(PLAYER::PLAYER_PED_ID(), 12, iLocal_37))
						{
							if (func_136() && !func_159())
							{
								if (iLocal_220 == 0)
								{
									UI::_SET_NOTIFICATION_TEXT_ENTRY("EPSDES_IN");
									UI::_DRAW_NOTIFICATION(0, 1);
									iLocal_220 = 1;
								}
								func_132();
								if (fVar0 > 0.01f)
								{
									...
									Global_106070.f_10021.f_107 = (Global_106070.f_10021.f_107 + fVar0);
									if (func_131())
									{
										if (Global_106070.f_10021.f_107 >= 8000f)
										{
											Global_106070.f_10021.f_107 = fLocal_212;
										}
									}
									if (Global_106070.f_10021.f_107 < (1609f * 5f) && ((1609f * 5f) - Global_106070.f_10021.f_107) < (fLocal_210 - 160.9f))
									{
										if (func_131())
										{
											fVar2 = func_130(Global_106070.f_10021.f_107);
											fLocal_218 = fVar2;
										}
										else
										{
											fVar3 = (Global_106070.f_10021.f_107 / 160.9f);
											iVar4 = SYSTEM::FLOOR(fVar3);
											fVar5 = SYSTEM::TO_FLOAT(iVar4);
											fVar5 = (fVar5 / 10f);
											fLocal_218 = fVar5;
										}
										fLocal_210 = ((1609f * 5f) - Global_106070.f_10021.f_107);
										if (func_131())
										{
											if (fLocal_218 >= 7.95f)
											{
										...
										UI::_SET_NOTIFICATION_TEXT_ENTRY("EPSDES_01");
										UI::ADD_TEXT_COMPONENT_FLOAT(fLocal_218, 1);
										UI::_DRAW_NOTIFICATION(0, 1);
										iLocal_221 = 1;
										func_129();
										if (func_131())
							...
							{
								UI::_SET_NOTIFICATION_TEXT_ENTRY("EPSDES_OUT");
								UI::_DRAW_NOTIFICATION(0, 1);
				...
				if (iLocal_216)
				{
					Global_106070.f_10021.f_107 = (Global_106070.f_10021.f_107 + (160.9f - 5f));
					iLocal_216 = 0;
				}
			}
			else
			...
			if (bLocal_213)
			{
				func_9(0.8f, 0.3f, "EPSDES_D0", (fLocal_212 - Global_106070.f_10021.f_107), 1);
	...
	{
		UI::_SET_NOTIFICATION_TEXT_ENTRY("EPSDES_02");
...
void func_4()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_8(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_7(PLAYER::PLAYER_PED_ID());
			if (func_6(iVar0) && (!func_5(14) || Global_105021))
			{
...
int func_10(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_61(iVar10, iParam1, iParam2, -1) };
		if (!func_60(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_61(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_61(iVar10, 14, uVar12[iVar1], -1) };
							func_30(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_52(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_20(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_20(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_20(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_52(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_61(iVar10, iVar0, func_19(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_61(iVar10, 14, uVar15[iVar1], -1) };
			func_30(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_52(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_20(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_20(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_20(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_11(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_137(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_61(iParam0, iParam1, iParam2, -1) };
...
int func_18(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_137(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_30(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_31(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_32(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_20(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_37(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_20(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_45(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_45(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_45(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_32(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_32(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_32(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_32(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_52(int iParam0)
{
	...
	{
		func_59(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_54(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_55(iParam2)];
	if (iVar0 != 0)
	{
...
int func_57(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_55(iParam1)];
...
void func_63(int iParam0)
{
	...
	func_64(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_57(func_67(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_57(func_66(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_57(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_64(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_64(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_64(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_64(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_20(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_132()
{
	if (((!func_135() && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_222 == 1)
		{
			if (AI::IS_PED_WALKING(PLAYER::PLAYER_PED_ID()) || AI::IS_PED_STILL(PLAYER::PLAYER_PED_ID()))
			{
				func_133(PLAYER::PLAYER_PED_ID(), "CULT_TALK", 4);
				fLocal_230 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
				iLocal_231 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_222 = 0;
			}
		}
		else if (IntToFloat((GAMEPLAY::GET_GAME_TIMER() - iLocal_231)) > fLocal_230)
		{
			iLocal_222 = 1;
		}
	}
...
int func_136()
{
	...
	if (((((((((GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "DESRT") || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "SENORA")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "HARMO")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "RTRAK")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "SANDY")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "Zancudo")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "Alamo")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "Jail")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "zQ_UAR")) || GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_233, "COSI"))
	{
		return 1;
	}
	return 0;
...
int func_137(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_61(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_137(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_137(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_61(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_137(iParam0, 14, iVar4))
										{
											if (!func_16(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_61(iVar0, iVar2, iVar1, -1) };
						if (!func_16(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_20(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_20(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_138()
{
	if (((!func_135() && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_221 == 1)
		{
			if (iLocal_226 == -1)
			{
				iLocal_226 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 5);
				iLocal_229 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_228 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 750);
			}
			if (iLocal_227 < iLocal_226)
			{
				if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_229) >= iLocal_228)
					{
...
void func_158()
{
	Global_106070.f_10021.f_107 = 0f;
	fLocal_218 = 0f;
	fLocal_210 = (1609f * 5f);
}
...
void func_161()
{
	if (Global_106070.f_10021.f_107 < fLocal_212)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			fLocal_218 = (Global_106070.f_10021.f_107 / 160.9f);
			fLocal_210 = (1609f * 5f);
			iLocal_211 = 1;
			fLocal_230 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
			iLocal_231 = GAMEPLAY::GET_GAME_TIMER();
...
void func_169()
{
	...
	if (Global_106070.f_10021.f_107 >= fLocal_212 || func_167(94) == 1)
	{
		func_129();
		func_176(94, 1);
...
void func_171()
{
	...
	{
		func_175(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
