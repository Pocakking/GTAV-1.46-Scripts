			...
			if (!PED::IS_PED_INJURED(iLocal_63[iVar0]))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], false)) < 400f)
				{
					...
					if (!iLocal_52 || iLocal_61 < 3)
					{
						...
						{
							if (!AI::IS_PED_IN_WRITHE(iLocal_63[iVar0]))
							{
								func_48(&uLocal_68, 1);
					...
					{
						if (!func_49() && !AI::IS_PED_IN_WRITHE(iLocal_63[iVar0]))
						{
					...
					else if (!func_49())
					{
						...
						if (SYSTEM::TIMERA() > 5000 && !AI::IS_PED_IN_WRITHE(iLocal_63[iVar0]))
						{
							func_48(&uLocal_68, 1);
							func_47(&uLocal_68, 1, iLocal_63[iVar0], "BorderPatrol", 0, 1);
							if (func_34() == 0)
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iLocal_63[iVar0]))
		{
			...
			if (iLocal_54 || iLocal_55)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63[iVar0], 0))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_57[iVar0])
					{
						...
						{
							AI::TASK_VEHICLE_MISSION(iLocal_63[iVar0], iLocal_64[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						}
						if (!iLocal_55)
						{
						...
						if (!PED::IS_PED_INJURED(iLocal_63[iVar0]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63[iVar0], 0))
							{
								AI::TASK_DRIVE_BY(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
					...
					else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_58[iVar0])
					{
						...
						{
							AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_63[iVar0], iLocal_64[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							if (!iLocal_55)
							{
								SYSTEM::WAIT(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(400, 800));
							}
				...
				{
					AI::TASK_COMBAT_PED(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_63[iVar0], true);
				}
			}
			else if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63[iVar0], 0))
			{
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_63[iVar0], 579380604) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_63[iVar0], 579380604) != 0)
					{
						AI::CLEAR_PED_TASKS(iLocal_63[iVar0]);
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_64[iVar0], 0))
						{
							AI::TASK_VEHICLE_MISSION(iLocal_63[iVar0], iLocal_64[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							AI::TASK_LOOK_AT_ENTITY(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
						}
						iLocal_60[iVar0] = 0;
						iLocal_59[iVar0] = 1;
					}
			...
			{
				AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
			if (!PED::IS_PED_INJURED(iLocal_63[iVar0]))
			{
				if (ENTITY::IS_ENTITY_IN_WATER(iLocal_63[iVar0]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63[iVar0], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_63[iVar0], 0, 0);
					}
			...
			if (func_127())
			{
				AI::TASK_SMART_FLEE_PED(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
		}
...
void func_52()
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iLocal_63[iVar0]))
		{
			...
			{
				if (!UI::DOES_BLIP_EXIST(uLocal_65[iVar0]))
				{
					uLocal_65[iVar0] = func_53(iLocal_63[iVar0], 1, 145);
				}
			}
		}
		else if (UI::DOES_BLIP_EXIST(uLocal_65[iVar0]))
		{
			UI::REMOVE_BLIP(&(uLocal_65[iVar0]));
		}
		iVar0++;
	}
}
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!CAM::IS_SPHERE_VISIBLE(vVar0, 5f))
				{
					...
					while (iVar2 < 3)
					{
						...
						iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 5);
						if (iVar3 > 1)
						{
						...
						AI::TASK_LOOK_AT_ENTITY(iLocal_63[iVar2], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
						...
						PED::SET_PED_SHOOT_RATE(iLocal_63[iVar2], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(50, 100));
...
int func_85(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_121(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
...
int func_127()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((((PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("rhino")) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("ambulance"))) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), 1938952078)) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID())) || Global_105117 == 1)
				{
					return 1;
				}
			}
...
Vector3 func_140()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_47, true);
		iLocal_50 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_48, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_48, true);
			iLocal_50 = 2;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_49, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_49, true);
			iLocal_50 = 3;
		}
		if (iLocal_50 == 1)
		{
