...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		...
		GAMEPLAY::CLEAR_AREA(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_243();
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
{
	if ((func_241() && Global_93232.f_11 == 6) && iParam0 == func_165(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_248(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
					...
					if (func_125(PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
					}
				}
				else
				{
...
int func_256(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT("rcmminute1");
			GAMEPLAY::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (func_126(uParam0->f_28[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						...
						AI::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				...
				if (func_126(uParam0->f_28[1]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0f, 0, 0, 0);
