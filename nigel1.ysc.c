...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_NAMT", 0);
			...
			switch (iLocal_264)
			{
				...
				case 1:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 100f, 1, 1, 0, false);
						}
					...
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (func_298(Local_94.f_35[0]))
						{
							...
							if (func_298(Local_94.f_28[0]))
							{
								...
								AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_94.f_28[0]);
							...
							if (func_298(Local_94.f_28[1]))
							{
								...
								AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_94.f_28[1]);
							...
							AI::TASK_VEHICLE_DRIVE_WANDER(Local_94.f_28[0], Local_94.f_35[0], 20f, 786603);
						}
...
void func_228(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_232(PLAYER::PLAYER_ID())) && !func_230(PLAYER::PLAYER_ID(), 0)) && !func_229()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_232(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_237(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_238(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_240(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_288(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_285(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_242(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_272(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_261();
			}
...
var func_261()
{
	...
	func_271(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_270(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_269(&uVar0, TIME::GET_CLOCK_HOURS());
	func_264(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_263(&uVar0, TIME::GET_CLOCK_MONTH());
	func_262(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_267(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_272(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_279(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_279(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_279(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_275(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_272(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_277(iParam0);
			func_276(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_309(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_321(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
int func_355()
{
	...
	iVar0 = func_356(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
