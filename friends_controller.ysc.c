...
void __EntryFunction__()
{
	...
	while (iVar0 < 9)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_175[iVar0 /*19*/].f_18, 1))
			{
				func_457(iVar0, 0);
				Global_89062++;
			}
	...
	while (iLocal_87)
	{
		...
		else
		{
			...
			else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				{
					if (!SCRIPT::IS_THREAD_ACTIVE(Global_106070.f_18075.f_395))
					{
						if (func_398(&(Global_106070.f_18075.f_362[iLocal_90 /*3*/])))
						{
							if ((Global_106070.f_18075.f_381[iLocal_90] == -1 || !func_397(Global_106070.f_18075.f_381[iLocal_90])) || func_396(Global_106070.f_18075.f_381[iLocal_90]) == 6)
							{
								func_394(iLocal_90);
							}
						}
...
void func_2(var uParam0, var uParam1)
{
	...
	if (func_393() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		if (uParam0->f_49 == 0)
		{
			if (func_392(Global_90805.f_45) && !PED::IS_PED_INJURED((uParam0[Global_90805.f_45 /*15*/])->f_2))
			{
				AI::CLEAR_PED_TASKS((uParam0[Global_90805.f_45 /*15*/])->f_2);
			}
			func_391(uParam0);
			func_390(uParam0, 0);
			iVar0 = 0;
...
void func_5(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	switch (*uParam1)
	{
		...
		case 5:
			...
			{
				AI::TASK_CLEAR_LOOK_AT(uParam1->f_2);
			}
...
void func_6(var uParam0)
{
	...
	func_21(Global_89061, uParam0->f_74, &sVar5, &cVar6);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	...
	{
		AI::CLEAR_PED_TASKS((uParam0[uParam0->f_74 /*15*/])->f_2);
	}
	if (uParam0->f_78 != 0)
	{
...
void func_11(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_16(PLAYER::PLAYER_ID())) && !func_13(PLAYER::PLAYER_ID(), 0)) && !func_12()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_16(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
{
	iParam0->f_1 = (func_26(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
	...
	switch (uParam0->f_50)
	{
		...
		case 17:
			...
			if (!func_57(&(uParam0->f_54), 30f))
			{
				...
				else if (func_52(uParam0->f_53, 0) && CONTROLS::IS_CONTROL_PRESSED(0, 52))
				{
					func_83(uParam0, 18);
				}
				CONTROLS::SET_INPUT_EXCLUSIVE(0, 52);
			}
			else
			{
				func_83(uParam0, 19);
		...
		case 21:
			func_64(uParam0);
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || func_81(uParam0, uParam1, Global_89061, uParam0->f_51, 18, 1))
			{
				func_83(uParam0, 22);
			}
			break;
...
int func_37(var uParam0)
{
	...
	if (func_50(Global_89061, uParam0->f_1, &iVar0))
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_410, 0))
			{
				return 4;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_410, 1))
			{
				return 6;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_410, 2))
			{
				return 10;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_410, 3))
			{
				return 8;
			}
			else
...
int func_38(var uParam0)
{
	...
	if ((((Global_89173 == 0 || GAMEPLAY::IS_BIT_SET(Global_89175, uParam0->f_1)) && !func_45(Global_89061, uParam0->f_1, 1)) && !func_45(Global_89061, uParam0->f_1, 2)) && Global_106070.f_7660.f_919[Global_89061] != 5)
	{
		if (func_50(Global_89061, uParam0->f_1, &iVar0))
		{
			iVar2 = func_41(&iVar1);
...
bool func_45(int iParam0, int iParam1, int iParam2)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_175[iVar2 /*19*/].f_2, iParam2);
}
...
float func_58(var uParam0)
{
	if (func_59(uParam0))
	{
		...
		{
			return (func_26(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_66(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (uParam0->f_52)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_106070.f_18075.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_67())
...
int func_87()
{
	if (((((((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || Global_105117) || func_90()) || func_75(8, -1)) || func_89()) || func_88()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	return 1;
...
void func_93(var uParam0, var uParam1, var uParam2)
{
	...
	else if (*uParam1 != 0 && *uParam1 != 1)
	{
			...
			if (!func_351(uParam1, 0))
			{
				if (iVar7 != -1)
				{
					...
					if (iVar8 != 0)
					{
						...
						{
							func_279(Global_89061, uParam1->f_1, 2, 0, iVar8, iVar7, -1);
						}
					}
				}
			}
		...
		else if ((PED::IS_PED_FALLING(uParam1->f_2) || PED::IS_PED_IN_PARACHUTE_FREE_FALL(uParam1->f_2)) && (((!ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(uParam1->f_2) && !PED::IS_PED_INJURED(uParam1->f_2)) || !GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(uParam1->f_2, true), &fVar1, 0, 0)) || fVar1 < -200f))
		{
...
int func_94(var uParam0, var uParam1)
{
	...
	func_21(Global_89061, uParam1->f_1, &sVar4, &cVar5);
		...
		else
		{
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(&cVar0) && STREAMING::HAS_ANIM_DICT_LOADED(&sVar4)) && STREAMING::HAS_ANIM_DICT_LOADED(&cVar6))
			{
				if (AUDIO::PREPARE_SYNCHRONIZED_AUDIO_EVENT(&cVar8, 0))
				{
					...
					vVar14 = { 0f, 0f, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar13.x, vVar13.y) };
					vVar15 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar15, &(vVar15.f_2), 0, 0);
					uParam0->f_79 = { vVar15 };
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar15, 10f, 0, 0, 1, 1, false, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(vVar15, 5f, 0);
					uParam0->f_78 = func_96(vVar15, 5f);
					AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
					AI::CLEAR_PED_TASKS_IMMEDIATELY(uParam1->f_2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_76, &cVar0, &cVar1, 8f, -2f, 0, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(uParam1->f_2, uParam0->f_76, &cVar0, &cVar2, 8f, -2f, 0, 0, 1148846080, 0);
...
void func_97(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_99(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_150(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_110(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_110(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_110(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_142(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_150(iVar10, 14, uVar15[iVar1], -1) };
			func_120(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_142(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_110(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_110(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_110(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_121(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_110(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_110(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_152(int iParam0)
{
	...
	func_153(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_153(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_153(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_110(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_214(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_110(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_110(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_216(int iParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, var uParam6, var uParam7)
{
	...
	if (iParam0 == 0)
	{
		if (*uParam1 <= 0)
		{
			*uParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4);
		}
		StringCopy(sParam2, "FRIENDS@FRM@IG_2", 64);
	...
	else if (iParam0 == 1)
	{
		if (*uParam1 <= 0)
		{
			*uParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 8);
		}
		StringCopy(sParam2, "FRIENDS@FRF@IG_2", 64);
	...
	else if (iParam0 == 2)
	{
		if (*uParam1 <= 0)
		{
			*uParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 5);
		}
		StringCopy(sParam2, "FRIENDS@FRT@IG_2", 64);
...
int func_223(var uParam0, var uParam1, var uParam2, float fParam3)
{
	...
	else if (uParam1->f_12 == 4)
	{
		...
		else if (!PED::IS_PED_RAGDOLL(uParam1->f_2) && !PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam1->f_2))
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam1->f_2);
				AI::TASK_COMBAT_PED(uParam1->f_2, uParam1->f_5, 67108864, 16);
			}
		}
	}
					...
					if (func_230(uParam0))
					{
						if (func_85(Global_89061, uParam1->f_1) > 15f)
						{
							if (fParam3 < (8f * 8f))
							{
								if (func_351(uParam1, 0))
								{
									func_82(Global_89061, uParam1->f_1, 29, &sVar3, &cVar2);
								}
								else
								{
									func_82(Global_89061, uParam1->f_1, 22, &sVar3, &cVar2);
								}
								...
								if (func_68(uParam2, &sVar3, &cVar2, 4, 0, 0, 0))
								{
									...
									{
										AI::TASK_LOOK_AT_ENTITY(uParam1->f_2, PLAYER::PLAYER_PED_ID(), 4000, 3104, 4);
									}
					...
					if (func_230(uParam0))
					{
						if (func_85(Global_89061, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_82(Global_89061, uParam1->f_1, 23, &sVar3, &cVar2);
								}
								func_226(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_68(uParam2, &sVar3, &cVar2, 4, 0, 0, 0))
								{
					...
					if (func_230(uParam0))
					{
						if (func_85(Global_89061, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_82(Global_89061, uParam1->f_1, 24, &sVar3, &cVar2);
								}
								func_226(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_68(uParam2, &sVar3, &cVar2, 4, 0, 0, 0))
								{
				...
				else if (uParam1->f_4 == 4)
				{
					if (fParam3 < (8f * 8f))
					{
						if (func_85(Global_89061, uParam1->f_1) > 10f)
						{
							...
							{
								if ((((((((((Global_89157 && uParam0->f_50 == 0) && (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || (PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID())) < 10f))) && !PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0)) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_IN_AIR(uParam1->f_2)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(uParam1->f_2)) && !func_393()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && func_224(uParam0, uParam1))
								{
									return 1;
								}
							}
...
int func_224(var uParam0, var uParam1)
{
	...
	while (iVar10 < 3)
	{
		if (uParam0->f_61[iVar10] == 0)
		{
			if ((vVar9[iVar10 /*3*/] != 0f && vVar9[iVar10 /*3*/].f_1 != 0f) && vVar9[iVar10 /*3*/].f_2 != 0f)
			{
				...
				uParam0->f_61[iVar10] = WORLDPROBE::START_SHAPE_TEST_BOX(vVar11, vVar9[iVar10 /*3*/], 0f, 0f, fVar2, 2, iVar12, iVar3, 7);
			}
		}
		else
		{
			iVar13 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_61[iVar10], &iVar7, &uVar5, &uVar6, &uVar4);
			switch (iVar13)
			{
				case 2:
					if (iVar7 == 0)
					{
						...
						uParam0->f_65[iVar10] = GAMEPLAY::GET_GAME_TIMER();
					}
	...
	if ((GAMEPLAY::GET_GAME_TIMER() < uParam0->f_65[0] + 500 && GAMEPLAY::GET_GAME_TIMER() < uParam0->f_65[1] + 500) && GAMEPLAY::GET_GAME_TIMER() < uParam0->f_65[2] + 500)
	{
		return 1;
	}
	return 0;
...
{
	if ((uParam0->f_50 != 0 || func_67()) || UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		return 0;
	}
	return 1;
...
void func_231(var uParam0, int iParam1)
{
	if (!func_244(uParam0->f_2, 1805844857))
	{
		...
		AI::TASK_SMART_FLEE_PED(uParam0->f_2, iParam1, 1000f, -1, 0, 0);
	}
}
...
void func_233(var uParam0)
{
	...
	if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_2, uParam0->f_3, 75f, 75f, 75f, 0, 1, 0))
	{
		...
		if (iVar0 == -1)
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam0->f_2);
				AI::TASK_ENTER_VEHICLE(uParam0->f_2, uParam0->f_3, -1, -1, 2f, 524297, 0);
			}
		}
		else if (!func_244(uParam0->f_2, -875674219))
		{
			AI::CLEAR_PED_TASKS(uParam0->f_2);
			AI::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), -1);
		}
	}
	else
	{
...
void func_235(var uParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(uParam0->f_2);
		AI::TASK_ENTER_VEHICLE(uParam0->f_2, uParam0->f_3, -1, -1, 1f, 4194817, 0);
	}
}
...
void func_236(var uParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(uParam0->f_2);
		AI::TASK_WANDER_STANDARD(uParam0->f_2, 1193033728, 0);
	}
}
...
{
	if (GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(uParam0->f_2)) > 5f)
	{
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(uParam0->f_2, 0), -1, 0) == uParam0->f_2)
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam0->f_2);
				AI::TASK_VEHICLE_MISSION(uParam0->f_2, PED::GET_VEHICLE_PED_IS_IN(uParam0->f_2, 0), 0, 5, 0f, 786603, 0f, 0f, 1);
			}
		}
	}
	...
	{
		AI::CLEAR_PED_TASKS(uParam0->f_2);
		AI::TASK_LEAVE_ANY_VEHICLE(uParam0->f_2, 0, 0);
	}
}
...
void func_240(var uParam0, float fParam1, int iParam2)
{
	...
	{
		AI::CLEAR_PED_TASKS(uParam0->f_2);
		AI::TASK_VEHICLE_DRIVE_WANDER(uParam0->f_2, PED::GET_VEHICLE_PED_IS_IN(uParam0->f_2, 0), fParam1, iParam2);
	}
	else
	{
		AI::SET_DRIVE_TASK_CRUISE_SPEED(uParam0->f_2, fParam1);
	}
}
...
void func_245(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(uParam0->f_2, 0))
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam0->f_2);
				AI::TASK_LEAVE_ANY_VEHICLE(uParam0->f_2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1000), 1);
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 15f, 15f, 15f, 0, 1, 0))
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam0->f_2);
				AI::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 7.5f, 7.5f, 7.5f, 0, 1, 0))
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam0->f_2);
				AI::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), -1, 6f, 1f, 1073741824, 0);
			}
		}
		else if (!func_244(uParam0->f_2, -875674219))
		{
	...
	{
		AI::TASK_LOOK_AT_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), -1, 2048, 3);
	}
	if (!func_244(PLAYER::PLAYER_PED_ID(), 150319005))
	{
		AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_2, -1, 0, 3);
	}
}
...
void func_260(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0))
	{
		...
		else if (uParam1->f_4 == 61)
		{
			if (!PED::IS_PED_USING_ANY_SCENARIO(uParam1->f_2))
			{
				...
				if (iVar6 == 0)
				{
					AI::TASK_START_SCENARIO_IN_PLACE(uParam1->f_2, "WORLD_HUMAN_SMOKING", 0, 1);
				}
				else
				{
					AI::TASK_START_SCENARIO_IN_PLACE(uParam1->f_2, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			else
			{
	...
	else
	{
		...
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar7, -1, 0) == uParam1->f_2)
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam1->f_2);
				AI::TASK_VEHICLE_DRIVE_WANDER(uParam1->f_2, iVar7, 7.5f, 786603);
			}
		}
		else if (GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(iVar7)) < 10f)
		{
			if (!func_244(uParam1->f_2, -828834893))
			{
				AI::CLEAR_PED_TASKS(uParam1->f_2);
				AI::TASK_LEAVE_ANY_VEHICLE(uParam1->f_2, 0, 0);
			}
		}
		else if (!func_244(uParam1->f_2, 63541484))
		{
			AI::CLEAR_PED_TASKS(uParam1->f_2);
			AI::TASK_PAUSE(uParam1->f_2, -1);
		}
	}
}
...
int func_271(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (uParam1->f_9 == 0)
		{
			...
			uParam1->f_9 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar1, vVar2, iVar0, iVar3, 7);
		}
		else
		{
			iVar8 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam1->f_9, &iVar4, &uVar5, &uVar6, &iVar7);
			if (iVar8 == 2)
			{
				iVar9 = 0;
				if (PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0))
				...
				{
					uParam1->f_10 = GAMEPLAY::GET_GAME_TIMER();
				}
				uParam1->f_9 = 0;
			}
			else if (iVar8 == 0)
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - uParam1->f_10) < 500)
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID())) < 10f) && (!PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0) || GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(uParam1->f_2)) < 10f))
			{
...
int func_276(var uParam0, var uParam1, var uParam2)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (!PED::IS_PED_INJURED(Global_89165[uParam1->f_1]))
		{
		...
		else
		{
			...
			if (!PED::IS_PED_INJURED(uParam1->f_2))
			{
				if (GAMEPLAY::IS_BIT_SET(Global_90805.f_47, iVar0))
				{
				}
				else if (func_275(uParam1->f_2))
				{
...
void func_285(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_287() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_287() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_286(iParam0));
...
bool func_290(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_287() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_318(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14682)
	{
		if (Global_14513.f_1 == 6)
		{
			...
			func_319(1);
			func_322(Global_14494, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_320(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
int func_328(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			{
				iParam2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2);
			}
		}
...
int func_338(int iParam0, int iParam1)
{
	...
	bVar1 = false;
	if (GAMEPLAY::IS_BIT_SET(Var0.f_2, func_339()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
...
void func_340()
{
	...
	{
		if (func_342(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_350(vector3 vParam0, bool bParam1)
{
	...
	while (iVar0 <= (5 - 1))
	{
		...
		{
			if (!bParam1 || GAMEPLAY::IS_BIT_SET(Global_106070.f_7201.f_11[iVar0], 0))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88530[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
void func_353(int iParam0)
{
	if (func_59(iParam0))
	{
		if (!func_398(iParam0))
		{
			iParam0->f_2 = (func_26(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
...
void func_359(var uParam0)
{
	...
	while (iVar1 < Global_93222)
	{
		if (iVar0 < 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Global_93222[iVar1]))
			{
				iVar0 = iVar1;
			}
		}
...
var func_361()
{
	...
	func_371(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_370(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_369(&uVar0, TIME::GET_CLOCK_HOURS());
	func_364(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_363(&uVar0, TIME::GET_CLOCK_MONTH());
	func_362(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_367(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_372(int iParam0)
{
	...
	uVar2 = Global_106070.f_2355.f_539.f_2290[iVar0];
	uVar3 = Global_106070.f_2355.f_539.f_2294[iVar0];
	vVar4 = { Global_106070.f_2355.f_539.f_2298[iVar0 /*3*/] };
	func_374(iParam0, 0);
	if (!func_373(vVar1, 0f, 0f, 0f, 0))
	{
		fVar5 = GAMEPLAY::ABSF((Global_106070.f_2355.f_539.f_2280[iVar0 /*3*/].f_2 - vVar1.z));
		fVar6 = SYSTEM::VDIST2(vVar1, Global_106070.f_2355.f_539.f_2280[iVar0 /*3*/]);
		fVar7 = SYSTEM::VMAG(Global_106070.f_2355.f_539.f_2298[iVar0 /*3*/]);
		bVar8 = false;
		if (fVar7 > 25f)
		{
			if (fVar5 > 25f)
		...
		if (bVar8)
		{
			Global_106070.f_2355.f_539.f_2280[iVar0 /*3*/] = { vVar1 };
			Global_106070.f_2355.f_539.f_2290[iVar0] = uVar2;
			Global_106070.f_2355.f_539.f_2294[iVar0] = uVar3;
			Global_106070.f_2355.f_539.f_2298[iVar0 /*3*/] = { vVar4 };
		}
	}
}
...
void func_381(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_383(Var7.f_1)) && iVar9 < 50)
			{
...
void func_395(int iParam0)
{
	if (func_59(iParam0))
	{
		if (func_398(iParam0))
		{
			iParam0->f_1 = (func_26(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_2);
			iParam0->f_2 = 0f;
			GAMEPLAY::CLEAR_BIT(iParam0, 2);
		}
	}
	...
	else if (iVar4 == 3)
	{
		...
		if (!SCRIPT::IS_THREAD_ACTIVE(Global_106070.f_18075.f_395))
		{
			...
			else
			{
				...
				Global_106070.f_18075.f_395 = iVar7;
...
int func_414(int iParam0, int iParam1)
{
	if (iParam0 < 9)
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_175[iParam0 /*19*/].f_18, iParam1);
	}
	return 0;
}
...
void func_415(int iParam0, int iParam1, bool bParam2)
{
	if (iParam0 < 9)
	{
		if (bParam2)
		{
			GAMEPLAY::SET_BIT(&(Global_106070.f_18075.f_175[iParam0 /*19*/].f_18), iParam1);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106070.f_18075.f_175[iParam0 /*19*/].f_18), iParam1);
		}
	}
}
...
int func_416(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	{
		iVar14 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
		if (iVar14 == 0)
		{
...
int func_428(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	...
	else if (((((iParam4 && GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 100) < 15) && !(iParam0 == 2 && iParam1 == 0)) && !(iParam0 == 0 && iParam1 == 5)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_429(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		*uParam2 = 12;
		*uParam3 = 14;
		return 1;
...
int func_429(vector3 vParam0)
{
	...
	if (func_433())
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88628[0 /*18*/], true) < 10f)
		{
			return 1;
		}
		else
	...
	if (!func_431())
	{
		if (Global_90255 == 0)
		{
			...
			{
				if ((PATHFIND::_0x16F46FB18C8009E4(vVar0, 0, &vVar4) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, vVar4, true) < 10f) && GAMEPLAY::ABSF((vParam0.z - vVar4.z)) < 2.5f)
				{
					vVar3 = { vVar4 };
				}
				else if ((PATHFIND::_0x16F46FB18C8009E4(vVar0, 1, &vVar4) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, vVar4, true) < 10f) && GAMEPLAY::ABSF((vParam0.z - vVar4.z)) < 2.5f)
				{
					vVar3 = { vVar4 };
				}
				else
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3 + vVar5 * Vector(1f, 1f, 1f), 1, &vVar10, 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, vVar10, true) < 10f) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar9, vVar10, true) > 2f)
				{
					vVar10 = { vVar10 };
				}
				else
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3 + vVar5 * Vector(1f, 1f, 1f), 1, &vVar11, 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, vVar11, true) < 10f) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar9, vVar11, true) > 2f)
				{
					vVar11 = { vVar11 };
				}
				else
				...
				Global_88628[0 /*18*/] = { vVar3 };
				Global_88628[0 /*18*/].f_3 = { vVar10 - vVar3 };
				Global_88628[0 /*18*/].f_6 = { vVar11 - vVar3 };
				Global_88628[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_88628[0 /*18*/].f_12 = 0f;
				Global_88628[0 /*18*/].f_13 = { vVar9 };
...
int func_452(int iParam0)
{
	...
	if (!func_453(iVar0))
	{
		...
		else
		{
			...
			if (iVar3 < 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89161[iVar3]))
				{
					return 0;
				}
			}
...
{
	Global_88628[iLocal_86 /*18*/].f_17 = (Global_88628[iLocal_86 /*18*/].f_17 || iParam0);
}
...
{
	Global_88628[iLocal_86 /*18*/].f_9 = { vParam0 };
	Global_88628[iLocal_86 /*18*/].f_12 = fParam1;
	Global_88628[iLocal_86 /*18*/].f_13 = { vParam2 };
}

void func_466(int iParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, int iParam4)
{
	iLocal_86 = iParam0;
	Global_88628[iLocal_86 /*18*/] = { vParam1 };
	Global_88628[iLocal_86 /*18*/].f_3 = { vParam2 };
	Global_88628[iLocal_86 /*18*/].f_6 = { vParam3 };
	Global_88628[iLocal_86 /*18*/].f_17 = 0;
	Global_88628[iLocal_86 /*18*/].f_16 = iParam4;
}
...
void func_467()
{
	...
	while (iVar1 < 3)
	{
		if (!PED::IS_PED_INJURED(Global_89165[iVar1]))
		{
