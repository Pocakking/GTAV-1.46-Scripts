...
int func_3()
{
	...
	if (((((func_10(PLAYER::PLAYER_PED_ID()) && func_10(iLocal_43)) && !func_9()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_46) && func_8(PLAYER::PLAYER_PED_ID(), iLocal_43, 1) < 20f) && !GAMEPLAY::GET_MISSION_FLAG())
	{
		uVar0 = 16;
...
void func_12()
{
	if (func_10(iLocal_43))
	{
		...
		ENTITY::FREEZE_ENTITY_POSITION(iLocal_43, true);
		AI::TASK_PLAY_ANIM(iLocal_43, sLocal_44, sLocal_45, 8f, -8f, -1, 9, 0f, 0, 0, 0);
...
void func_21(bool bParam0)
{
	...
	UI::CLEAR_ADDITIONAL_TEXT(7, false);
