...
void __EntryFunction__()
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	uLocal_49 = UI::_0x4A9923385BDB9DAD();
	uLocal_50 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	iLocal_61 = -1;
	iLocal_62 = -1;
	bLocal_75 = true;
	iLocal_90 = -1;
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_2();
			func_1();
			UNK1::_0x208784099002BC30("m_Chinese2", 0);
		}
		iLocal_574 = 0;
		SYSTEM::WAIT(0);
	}
		...
		if (Local_153[iVar0 /*6*/].f_1 == 1)
		{
			switch (Local_153[iVar0 /*6*/])
			{
				...
				case 3:
					...
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						case 0:
							...
							iLocal_383 = 0;
							Local_153[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 3000;
							break;
						...
						case 1:
							if (!func_59())
							{
								if (!func_34())
								{
									...
									{
										if (GAMEPLAY::GET_GAME_TIMER() > Local_153[iVar0 /*6*/].f_5)
										{
											if (iLocal_383 < 13)
											{
												...
												{
													iLocal_383++;
													Local_153[iVar0 /*6*/].f_5 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 10000));
												}
											}
											else
											{
				...
				case 5:
					...
					{
						case -20:
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2460.073f, 4964.176f, 46.2405f, 1) < 250f)
							{
						...
						case 1:
							...
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2460.073f, 4964.176f, 46.2405f, 1) > 300f)
							{
				...
				case 7:
					if (Local_153[iVar0 /*6*/].f_2 == 0)
					{
						...
						if (iVar2 != -1)
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar2 /*33*/], 1785177548) == 7)
								{
									iVar2 = func_18(9);
									if (iVar2 != -1)
									{
				...
				case 8:
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 2473.061f, 4981.482f, 24.64584f, 1) < 250f)
								{
									Local_153[iVar0 /*6*/].f_2++;
								}
							}
				...
				case 14:
					...
					{
						case 0:
							Local_153[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 7000;
							Local_153[iVar0 /*6*/].f_2++;
							break;
						...
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_153[iVar0 /*6*/].f_5)
							{
								...
								AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), 2475.075f, 4945.965f, 44.0228f, 1f, 20000, 1193033728, 1056964608);
				...
				case 12:
					...
					{
						case 0:
							uLocal_173 = OBJECT::_0xB48FCED898292E52(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
							if (OBJECT::_0x52AF537A0C5B8AAD(uLocal_173))
							{
								OBJECT::_0x5C29F698D404C5E1(uLocal_173, 2);
								Local_153[iVar0 /*6*/].f_2++;
							}
							break;
						
						case 1:
							if (OBJECT::_0x899BA936634A322E(uLocal_173) == 3)
							{
								OBJECT::_0x5C29F698D404C5E1(uLocal_173, 4);
								Local_153[iVar0 /*6*/].f_2++;
							}
							break;
						...
						case 2:
							if (iLocal_174 == 1)
							{
								if (OBJECT::_0x899BA936634A322E(uLocal_173) == 5)
								{
									OBJECT::_0x5C29F698D404C5E1(uLocal_173, 6);
				...
				case 16:
					if (Local_153[iVar0 /*6*/].f_2 != -1)
					{
						if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"), 0) || !OBJECT::DOES_PICKUP_EXIST(uLocal_176))
						{
							...
							if (iLocal_180 != 0)
							{
								if (UI::DOES_BLIP_EXIST(iLocal_178))
								{
									UI::REMOVE_BLIP(&iLocal_178);
								}
				...
				case 17:
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2447.671f, 4951.438f, 43.25576f, 2454.664f, 4957.856f, 47.89117f, 6.8125f, 0, true, 0) && GAMEPLAY::GET_GAME_TIMER() > Local_153[iVar0 /*6*/].f_5)
					{
						if (UI::DOES_BLIP_EXIST(iLocal_178))
						{
							UI::REMOVE_BLIP(&iLocal_178);
						...
						switch (Local_153[iVar0 /*6*/].f_2)
						{
							case 0:
								if (!func_59())
								{
									...
									Local_153[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				...
				case 20:
					if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 0))
					{
						iLocal_380 = func_18(4);
						if (iLocal_380 != -1)
						{
							GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 0);
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 1))
					{
						if (!PED::IS_PED_INJURED(Local_113[iLocal_380 /*33*/]) && ENTITY::DOES_ENTITY_EXIST(Local_113[iLocal_380 /*33*/].f_20))
						{
							...
							{
								GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 1);
							}
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 2))
					{
						if (PED::IS_PED_INJURED(Local_113[iLocal_380 /*33*/]))
						{
							GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 2);
						}
						if (!PED::IS_PED_INJURED(Local_113[iLocal_380 /*33*/]))
						{
							...
							if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iLocal_380 /*33*/], -2017877118) == 2 || AI::GET_SCRIPT_TASK_STATUS(Local_113[iLocal_380 /*33*/], -2017877118) == 7)
							{
								GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 2);
							}
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 4))
					{
						iLocal_381 = func_18(5);
						if (iLocal_381 != -1)
						{
							GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 4);
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 5))
					{
						if (!PED::IS_PED_INJURED(Local_113[iLocal_381 /*33*/]))
						{
							if (ENTITY::DOES_ENTITY_EXIST(Local_113[iLocal_381 /*33*/].f_20))
							{
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_113[iLocal_381 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
								{
									...
									{
										GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 5);
									}
								}
							}
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 6))
					{
						if (PED::IS_PED_INJURED(Local_113[iLocal_381 /*33*/]))
						{
							GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 6);
						}
						if (!PED::IS_PED_INJURED(Local_113[iLocal_381 /*33*/]))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_113[iLocal_381 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
							...
							if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iLocal_381 /*33*/], -2017877118) == 2 || AI::GET_SCRIPT_TASK_STATUS(Local_113[iLocal_381 /*33*/], -2017877118) == 7)
							{
								GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 6);
							}
				...
				case 24:
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 1))
					{
					...
					if ((GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 0) && GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 1)) || iLocal_149 == 6)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_181))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_181, false);
				...
				case 26:
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						...
						case 2:
							if (AI::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1) && AI::DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(Local_113[13 /*33*/]))
								{
								...
								GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 1);
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[14 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
								PED::_0x2208438012482A1A(Local_113[14 /*33*/], 1, 1);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113[14 /*33*/], 0);
								GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 0);
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[13 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
								...
								AI::TASK_SYNCHRONIZED_SCENE(Local_113[12 /*33*/], Local_153[iVar0 /*6*/].f_5, "MISSChinese2_crystalMazeMCS1_IG", "bar_peds_action_janet", 1000f, -1000f, 1, 0, 1148846080, 0);
						...
						case 3:
							...
							if (!PED::IS_PED_INJURED(Local_113[13 /*33*/]) && !PED::IS_PED_INJURED(Local_113[14 /*33*/]))
							{
								...
								if (GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 0) && GAMEPLAY::IS_BIT_SET(Local_153[iVar0 /*6*/].f_5, 1))
								{
									Local_153[iVar0 /*6*/].f_2++;
								}
								else
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_113[13 /*33*/], 993674639) != 1)
									{
										if (AI::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1))
										{
											GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 0);
											AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[13 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113[13 /*33*/], 0);
										}
									}
									else
									...
									if (AI::GET_SCRIPT_TASK_STATUS(Local_113[14 /*33*/], 993674639) != 1)
									{
										if (AI::DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1))
										{
											GAMEPLAY::SET_BIT(&(Local_153[iVar0 /*6*/].f_5), 1);
											AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[14 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113[14 /*33*/], 0);
										}
									}
									else
						...
						case 6:
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_113[12 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_113[13 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_113[14 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
void func_12(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		if (iLocal_86 == 0)
		{
			...
			{
				if (UI::DOES_BLIP_EXIST(Local_109[iVar0 /*5*/].f_3))
				{
					if (UI::GET_BLIP_ALPHA(Local_109[iVar0 /*5*/].f_3) < 255)
					{
						UI::REMOVE_BLIP(&(Local_109[iVar0 /*5*/].f_3));
					}
					else
					{
						UI::SET_BLIP_ALPHA(Local_109[iVar0 /*5*/].f_3, 0);
					}
				}
				iVar0++;
			}
	...
	else if (iLocal_86)
	{
		...
		while (iVar0 < Local_109)
		{
			if (UI::DOES_BLIP_EXIST(Local_109[iVar0 /*5*/].f_3))
			{
				UI::SET_BLIP_ALPHA(Local_109[iVar0 /*5*/].f_3, 255);
			}
			else
			{
				Local_109[iVar0 /*5*/].f_3 = func_5(Local_109[iVar0 /*5*/], 0);
				UI::_0x54318C915D27E4CE(Local_109[iVar0 /*5*/].f_3, 1);
				UI::SET_BLIP_SCALE(Local_109[iVar0 /*5*/].f_3, 0.4f);
				UI::SET_BLIP_ALPHA(Local_109[iVar0 /*5*/].f_3, 0);
				UI::SET_BLIP_COLOUR(Local_109[iVar0 /*5*/].f_3, 5);
				UI::_0x75A16C3DA34F1245(Local_109[iVar0 /*5*/].f_3, 0);
			}
			iVar0++;
		}
		iLocal_86 = 0;
...
int func_14(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_6(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_27()
{
	...
	func_32(27, 0);
	GAMEPLAY::CLEAR_AREA(2479.875f, 4980.868f, 44.82052f, 60f, 1, 0, 0, false);
...
void func_58(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_51) || !GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_51, sParam0))
	{
		sLocal_51 = sParam0;
		iVar0 = 0;
		while (iVar0 <= 15)
		...
		if ((!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]) && !PED::IS_PED_DEAD_OR_DYING(Local_113[iVar0 /*33*/], 1)) || Local_119[iVar0 /*24*/].f_3 == 1)
		{
			switch (Local_119[iVar0 /*24*/].f_3)
			{
				case 1:
							...
							switch (Local_113[iVar0 /*33*/].f_2)
							{
								...
								case 8:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_02"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], Local_113[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_a", 1000f, -4f, 1, 0, 1148846080, 0);
								...
								case 9:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_01"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_113[iVar0 /*33*/].f_14, 1);
										func_100(&Local_119, iVar0, Local_113[iVar0 /*33*/], 0, 0, 0);
										AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], Local_113[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_b", 1000f, -4f, 1, 0, 1148846080, 0);
										PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
										func_99(iVar0, 4, 0, Local_113[iVar0 /*33*/].f_14);
									}
									break;
					...
					if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
					{
						ENTITY::_SET_ENTITY_REGISTER(Local_113[iVar0 /*33*/], 1);
						...
						switch (Local_113[iVar0 /*33*/].f_3)
						{
									...
									case 0:
										if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/].f_20))
										{
											...
											if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/].f_20))
											{
												...
												{
													AI::TASK_PLAY_ANIM(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0f, 0, 0, 0);
												}
												else
												{
													AI::TASK_PLAY_ANIM(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 1000f, -1f, -1, 1, 0f, 0, 0, 0);
												}
												ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_113[iVar0 /*33*/], 1, 1);
												PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
												Local_113[iVar0 /*33*/].f_5++;
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 6:
										if (ENTITY::IS_ENTITY_AT_COORD(Local_113[iVar0 /*33*/], Local_113[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, true, 0))
										{
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3))
											{
												AI::STOP_ANIM_TASK(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", -1.5f);
											}
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
											{
												AI::STOP_ANIM_TASK(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", -1.5f);
											}
											...
											if (func_68(iLocal_145))
											{
												if (Local_113[iVar0 /*33*/].f_2 == 4)
												{
													...
													AI::TASK_ENTER_VEHICLE(Local_113[iVar0 /*33*/], iLocal_145, -1, -1, 1f, 1, 0);
												...
												else
												{
													...
													AI::TASK_ENTER_VEHICLE(Local_113[iVar0 /*33*/], iLocal_145, -1, 0, 1f, 1, 0);
												}
											}
											Local_113[iVar0 /*33*/].f_5++;
													...
													if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_145, 0, 0))
													{
														...
														if (iVar1 >= 0)
														{
															if (!PED::IS_PED_INJURED(Local_113[iVar1 /*33*/]))
															{
																...
																{
																	func_93();
																	AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_145, 2367.668f, 5098.645f, 46.8185f, 12f, 0, joaat("burrito"), 786599, 5f, 5f);
																	AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_145, 19f, 786599);
							...
							case 5:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										func_93();
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2459.646f, 4977.735f, 50.5678f, 1f, 20000, 0.25f, 0, 40000f);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2456.221f, 4974.685f, 50.5678f, 1f, 20000, 0.25f, 0, 40000f);
										AI::TASK_PED_SLIDE_TO_COORD(0, 2456.221f, 4974.685f, 50.5678f, 92.5678f, 1061158912);
										AI::TASK_ACHIEVE_HEADING(0, 92.5678f, 0);
										func_92(&(Local_113[iVar0 /*33*/]), 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
									
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 242628503) == 7)
										{
									...
									case 2:
										func_93();
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2450.491f, 4986.83f, 50.5677f, 1f, 20000, 0.25f, 0, 40000f);
										AI::TASK_ACHIEVE_HEADING(0, 309.5567f, 0);
							...
							case 6:
								if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 993674639) == 7 && Local_113[iVar0 /*33*/].f_5 > 1)
								{
									Local_113[iVar0 /*33*/].f_5 = 0;
								}
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										AI::TASK_ACHIEVE_HEADING(Local_113[iVar0 /*33*/], 219f, 1500);
										Local_113[iVar0 /*33*/].f_5++;
										break;
									
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 1920390111) == 7)
										{
											AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND_ARMY", 0, 0);
											Local_113[iVar0 /*33*/].f_5++;
										}
										break;
								}
							...
							case 32:
								if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
								{
									...
									{
										case 0:
											AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", Local_113[iVar0 /*33*/].f_14, 0);
											Local_113[iVar0 /*33*/].f_5++;
											break;
										...
										case 1:
											...
											{
												iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
												if (iVar3 == 0)
												{
												...
												Local_113[iVar0 /*33*/].f_5++;
												Local_113[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
											}
											break;
										
										case 2:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
											{
												Local_113[iVar0 /*33*/].f_5 = 1;
											}
											break;
										...
										case 10:
											...
											{
												Local_113[iVar0 /*33*/].f_5++;
												Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 1000;
											}
											break;
										...
										case 11:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
											{
												AI::TASK_TURN_PED_TO_FACE_COORD(Local_113[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 5000);
												Local_113[iVar0 /*33*/].f_5++;
												Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 5000;
											}
											break;
										...
										case 12:
											...
											{
												if (GAMEPLAY::GET_GAME_TIMER() > (Local_113[iVar0 /*33*/].f_14 - 3000))
												{
													AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_113[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 0.25f, 0, 40000f);
													Local_113[iVar0 /*33*/].f_5 = 15;
												}
											}
											else if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
											{
										...
										case 13:
											func_93();
											AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2449.114f, 4981.984f, 45.8102f, 1f, 20000, 0.25f, 0, 40000f);
											AI::TASK_ACHIEVE_HEADING(0, 127.6328f, 3000);
											func_92(&(Local_113[iVar0 /*33*/]), 0);
											Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 3000;
											Local_113[iVar0 /*33*/].f_5++;
											break;
										
										case 14:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14 || AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 242628503) == 7)
											{
												Local_113[iVar0 /*33*/].f_5 = 0;
											}
											break;
										...
										case 16:
											if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 713668775) == 7)
											{
												Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 3000;
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
										{
											if (func_68(iLocal_145))
											{
												AI::TASK_ENTER_VEHICLE(Local_113[iVar0 /*33*/], iLocal_145, 20000, 1, 1f, 1, 0);
												Local_113[iVar0 /*33*/].f_5++;
												Local_113[iVar0 /*33*/].f_14 = 0;
												Local_113[iVar0 /*33*/].f_15 = 0;
											}
							...
							case 7:
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										{
											AI::TASK_SWAP_WEAPON(Local_113[iVar0 /*33*/], 0);
										}
										Local_113[iVar0 /*33*/].f_5++;
										break;
									...
									case 1:
										if (!WEAPON::GET_CURRENT_PED_WEAPON(Local_113[iVar0 /*33*/], &iVar4, 1))
										{
											...
											if (iVar0 == 1)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_113[2 /*33*/], 2000);
												}
											}
											else if (iVar0 == 2)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_113[1 /*33*/], 2000);
												}
											}
											else if (iVar0 == 6)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_113[7 /*33*/], 2000);
												}
											}
											else if (iVar0 == 7)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_113[6 /*33*/], 2000);
												}
											}
											if (Local_113[iVar0 /*33*/].f_14 != 0)
											{
												AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", Local_113[iVar0 /*33*/].f_14, 0);
											}
											else
											{
												AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
											}
											func_92(&(Local_113[iVar0 /*33*/]), 0);
											Local_113[iVar0 /*33*/].f_5++;
											Local_113[iVar0 /*33*/].f_15 = GAMEPLAY::GET_GAME_TIMER() + 15000;
										}
										break;
									
									case 2:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 242628503) == 7 || GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_15)
										{
											AI::CLEAR_PED_TASKS(Local_113[iVar0 /*33*/]);
											Local_113[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 3:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 242628503) == 7)
										{
											...
											{
												AI::TASK_SWAP_WEAPON(Local_113[iVar0 /*33*/], 1);
												Local_113[iVar0 /*33*/].f_5++;
											}
											else
											{
									...
									case 4:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 716706914) == 7)
										{
											if (Local_113[iVar0 /*33*/].f_4 == 5)
											{
							...
							case 13:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND", 0, 0);
										PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 14:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", 0, 0);
										PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
									
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 993674639) == 7)
										{
											Local_113[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 15:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_BINOCULARS", 0, 0);
										PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 16:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 0);
										PED::_0x2208438012482A1A(Local_113[iVar0 /*33*/], 0, 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 17:
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										...
										{
											AI::TASK_START_SCENARIO_IN_PLACE(Local_113[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 1);
											Local_113[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 2:
										...
										{
											AI::TASK_PLAY_ANIM(Local_113[iVar0 /*33*/], "misscarsteal2peeing", "peeing_loop", 8f, -8f, 25000, 1, 0f, 0, 0, 0);
											Local_113[iVar0 /*33*/].f_5++;
											Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 23000;
										}
										break;
							...
							case 18:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										func_93();
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2434.891f, 4973.864f, 50.5679f, 1f, 20000, 0.25f, 0, 40000f);
										AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_BINOCULARS", 0, 0);
										func_92(&(Local_113[iVar0 /*33*/]), 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 25:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										{
											case 12:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2433.04f, 4967.87f, 46.28f, 0.8f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2433.04f, 4967.87f, 46.28f, 0.8f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
											
											case 13:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2432.56f, 4968.38f, 46.27f, 0.8f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2432.56f, 4968.38f, 46.27f, 0.8f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
											
											case 14:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2433.12f, 4965.59f, 46.27f, 0.8f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2433.12f, 4965.59f, 46.27f, 0.8f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
											
											case 15:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2439.61f, 4960.99f, 46.27f, 0.4f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2439.697f, 4960.996f, 46.28f, 0.4f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
											
											case 16:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2440.16f, 4962.99f, 46.27f, 0.4f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2440.16f, 4962.99f, 46.27f, 0.4f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
											
											case 17:
												if (AI::DOES_SCENARIO_EXIST_IN_AREA(2438.23f, 4962.25f, 46.27f, 0.4f, 0))
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_113[iVar0 /*33*/], 2438.23f, 4962.25f, 46.27f, 0.4f, 0);
													Local_113[iVar0 /*33*/].f_5++;
												}
												break;
										}
									...
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 1647992574) == 7)
										{
											Local_113[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 28:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										{
											AI::TASK_HANDS_UP(Local_113[iVar0 /*33*/], 20000, 0, -1, 0);
									...
									case 3:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_113[iVar0 /*33*/]) || (func_90(ENTITY::GET_ENTITY_COORDS(Local_113[iVar0 /*33*/], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, true, 0)))
										{
											...
											{
												Local_113[iVar0 /*33*/].f_5++;
												Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 2000;
											}
										}
										else
										{
									...
									case 4:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
										{
											AI::TASK_SMART_FLEE_PED(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 200f, 200000, 0, 0);
							...
							case 30:
									...
									if (Local_113[iVar0 /*33*/].f_5 < 8)
									{
										if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_113[iVar0 /*33*/], 0, 2))
										{
											if (!WEAPON::HAS_PED_GOT_WEAPON(Local_113[iVar0 /*33*/], 0, 2))
											{
												...
												AI::TASK_COMBAT_PED(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
												func_88();
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sawnoffshotgun")))
										{
											if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
											{
												...
												AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_370, "misschinese2_crystalmaze", "_cower_loop", 1000f, -8f, 0, 0, 1148846080, 0);
												...
												AI::TASK_LOOK_AT_ENTITY(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
												Local_113[iVar0 /*33*/].f_5++;
											}
										}
										break;
									...
									case 3:
										...
										AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_369, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
										AI::TASK_LOOK_AT_ENTITY(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
										Local_113[iVar0 /*33*/].f_5++;
										break;
									...
									case 5:
										if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_369) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_369) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_369))
										{
											...
											AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_368, "misschinese2_crystalmaze", "_stand_loop", 4f, -8f, 0, 0, 1148846080, 0);
											Local_113[iVar0 /*33*/].f_5++;
											Local_113[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 2000));
										}
										break;
									...
									case 6:
										if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371) || iLocal_371 == 0)
										{
											if (GAMEPLAY::GET_GAME_TIMER() > Local_113[iVar0 /*33*/].f_14)
											{
												...
												if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2) == 1)
												{
													AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_371, "misschinese2_crystalmaze", "_stand_loop_a", 4f, -8f, 0, 0, 1148846080, 0);
												}
												else
												{
													AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_371, "misschinese2_crystalmaze", "_stand_loop_b", 4f, -8f, 0, 0, 1148846080, 0);
												}
											}
										}
									...
									case 8:
										...
										AI::TASK_SYNCHRONIZED_SCENE(Local_113[iVar0 /*33*/], iLocal_372, "misschinese2_crystalmaze", "_stand_to_aim", 4f, -8f, 0, 0, 1148846080, 0);
									...
									case 9:
										if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_372) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372))
										{
											...
											AI::CLEAR_PED_TASKS(Local_113[iVar0 /*33*/]);
											AI::TASK_AIM_GUN_AT_ENTITY(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 1);
											Local_113[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 10:
										if (!func_59())
										{
											if (func_35("CHI2_DALEA", 4, Local_113[iVar0 /*33*/], "ONEIL", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_113[iVar0 /*33*/], 0);
												AI::TASK_COMBAT_PED(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
												Local_113[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 4000));
												Local_113[iVar0 /*33*/].f_15 = 0;
												Local_113[iVar0 /*33*/].f_5++;
											}
										}
							...
							case 31:
								if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
								{
									if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_113[iVar0 /*33*/], true), 2f, 1))
									{
										Local_113[iVar0 /*33*/].f_5 = 5;
									}
								}
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										...
										{
											Local_113[iVar0 /*33*/].f_5++;
											Local_113[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 1300;
										}
										break;
									...
									case 5:
										AI::TASK_SMART_FLEE_PED(Local_113[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 50f, 1000, 0, 0);
										Local_113[iVar0 /*33*/].f_5++;
										break;
							...
							case 27:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, 999999, 0, 0);
										AI::TASK_COWER(0, -1);
										func_92(&(Local_113[iVar0 /*33*/]), 0);
										PED::SET_PED_KEEP_TASK(Local_113[iVar0 /*33*/], true);
										ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_113[iVar0 /*33*/]));
										if (UI::DOES_BLIP_EXIST(Local_113[iVar0 /*33*/].f_19))
										{
											UI::REMOVE_BLIP(&(Local_113[iVar0 /*33*/].f_19));
										}
										Local_113[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 4:
								...
								if (Local_113[iVar0 /*33*/].f_2 == 8)
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_113[iVar0 /*33*/].f_14))
									{
										if (Local_113[iVar0 /*33*/].f_5 == 0)
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 1785177548) == 1)
												{
								...
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_113[iVar0 /*33*/], 2106541073) == 7)
									{
										func_99(iVar0, 7, 0, 0);
									}
								}
							...
							case 11:
								switch (Local_119[iVar0 /*24*/].f_4)
								{
									case 1:
										...
										{
											Local_119[iVar0 /*24*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_114 * 4000);
											iLocal_114++;
										}
									...
									default:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_119[iVar0 /*24*/].f_4)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(Local_113[iVar0 /*33*/], 0);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_113[iVar0 /*33*/], 2451.677f, 4954.251f, 44.988f, 3f, 0, 0);
...
int func_80(int iParam0)
{
	...
	*iParam0 = 0;
	iVar0 = 0;
	*iParam0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10);
	bVar1 = false;
	while (!bVar1)
	{
...
bool func_84(char* sParam0, int iParam1, char* sParam2)
{
...
void func_92(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		AI::SET_SEQUENCE_TO_REPEAT(uLocal_81, 1);
	}
	AI::CLOSE_SEQUENCE_TASK(uLocal_81);
	if (!PED::IS_PED_DEAD_OR_DYING(*iParam0, 1))
	{
		AI::TASK_PERFORM_SEQUENCE(*iParam0, uLocal_81);
	}
	AI::CLEAR_SEQUENCE_TASK(&uLocal_81);
}

void func_93()
{
	AI::OPEN_SEQUENCE_TASK(&uLocal_81);
}
...
void func_94(int iParam0)
{
	...
	{
		case 7:
			if (Local_113[iParam0 /*33*/].f_15 > 2000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 0))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 4000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_113[iParam0 /*33*/].f_15 > 8000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2472.297f, 4962.687f, 47.2297f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 1);
			}
			break;
		
		case 5:
			if (Local_113[iParam0 /*33*/].f_15 > 3000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 0))
			{
				if (!PED::IS_PED_INJURED(Local_113[6 /*33*/]))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_113[iParam0 /*33*/], Local_113[6 /*33*/], 4000, 0, 2);
					GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 0);
				}
			}
			else if (Local_113[iParam0 /*33*/].f_15 > 11000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2494.634f, 5001.994f, 46.6624f, 7000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_113[iParam0 /*33*/].f_15 > 20000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 2))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2477.634f, 4966.994f, 46.6624f, 7000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 2);
			}
			break;
		...
		case 4:
			if (Local_113[iParam0 /*33*/].f_15 > 3000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 0))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 5000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_113[iParam0 /*33*/].f_15 > 10000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2461.449f, 4977.48f, 51.7483f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_113[iParam0 /*33*/].f_15 > 18000 && !GAMEPLAY::IS_BIT_SET(Local_113[iParam0 /*33*/].f_14, 2))
			{
				AI::TASK_LOOK_AT_COORD(Local_113[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_113[iParam0 /*33*/].f_14), 2);
			}
			break;
	}
...
int func_101(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, bool bParam5, int iParam6)
{
	...
	else
	{
		...
		PED::SET_PED_DIES_WHEN_INJURED(Local_113[iParam0 /*33*/], 1);
	...
	ENTITY::_SET_ENTITY_REGISTER(Local_113[iParam0 /*33*/], 1);
...
int func_105(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)
{
	...
	if (!func_53())
	{
		if (!UI::IS_MESSAGE_BEING_DISPLAYED())
		{
			...
			else if (iLocal_79 != GAMEPLAY::GET_GAME_TIMER())
			{
				iLocal_80++;
	...
	while (iVar0 < *uParam0)
	{
		if (!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iVar0 /*24*/], 1) && !PED::IS_PED_BEING_STEALTH_KILLED((*uParam0)[iVar0 /*24*/]))
		{
			if (!(uParam0[iVar0 /*24*/])->f_21)
			{
				...
				{
					case 4:
						if ((PED::IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_CHAIR") || PED::IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_ARMCHAIR")) || AI::GET_SCRIPT_TASK_STATUS((*uParam0)[iVar0 /*24*/], 1785177548) == 1)
						{
							if (!PED::IS_PED_INJURED((*uParam0)[iVar0 /*24*/]))
							{
								AI::CLEAR_PED_TASKS((*uParam0)[iVar0 /*24*/]);
							}
						...
						else if (AI::GET_SCRIPT_TASK_STATUS((*uParam0)[iVar0 /*24*/], 1647992574) == 7)
						{
										...
										if (PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 0))
										{
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, 0))
											{
												if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iVar2))
												{
													...
													AI::TASK_LEAVE_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 0, 0);
												}
											}
										}
										if (!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 0))
											...
											switch ((uParam0[iVar0 /*24*/])->f_1)
											{
												case 2:
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															if ((uParam0[iVar0 /*24*/])->f_10 >= 0)
															{
																if (ENTITY::DOES_ENTITY_EXIST((*uParam0)[(uParam0[iVar0 /*24*/])->f_10 /*24*/]))
																{
																	...
																	(uParam0[iVar0 /*24*/])->f_11 = GAMEPLAY::GET_GAME_TIMER() + 500;
																}
																else
																{
														...
														case 1:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_forward_small_intro_a", 4f, -4f, -1, 0, 0f, 0, 0, 0);
														...
														case 2:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_left_small_intro_a", 4f, -4f, -1, 0, 0f, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
														...
														case 3:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_right_small_intro_a", 4f, -4f, -1, 0, 0f, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
														...
														case 4:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_backward_small_intro_a", 4f, -4f, -1, 0, 0f, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
												...
												case 7:
													...
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															...
															{
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "buddy_shot_b", 4f, -4f, -1, 0, 0f, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															}
															else
															{
															...
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = GAMEPLAY::GET_GAME_TIMER() + 3000;
															break;
														...
														case 1:
															...
															AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(0, 200f, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = (GAMEPLAY::GET_GAME_TIMER() + iVar4);
															break;
														...
														default:
															...
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_5)
															{
																(uParam0[iVar0 /*24*/])->f_4++;
															}
															break;
													...
													if (!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 1))
													{
														switch ((uParam0[iVar0 /*24*/])->f_5)
														{
															case 0:
																...
																AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot", 4f, -4f, -1, 8, 0f, 0, 0, 0);
																(uParam0[iVar0 /*24*/])->f_5 = 3;
																break;
															
															case 1:
																PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*uParam0)[iVar0 /*24*/], 1);
																AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b", 4f, -4f, -1, 8, 0f, 0, 0, 0);
																WEAPON::SET_CURRENT_PED_WEAPON((*uParam0)[iVar0 /*24*/], WEAPON::GET_BEST_PED_WEAPON((*uParam0)[iVar0 /*24*/], 0), true);
																(uParam0[iVar0 /*24*/])->f_5 = 3;
																break;
															...
															case 3:
																if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot", 3))
																{
																	if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot") > 0.95f)
																	{
																		...
																		{
																			AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_d", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 6000), 8, 0f, 0, 0, 0);
																...
																if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b", 3))
																{
																	if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b") > 0.95f)
																	{
																		...
																		{
																			AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_e", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 6000), 8, 0f, 0, 0, 0);
																			(uParam0[iVar0 /*24*/])->f_5 = 6;
																		}
																	}
																}
															...
															case 4:
																if (GAMEPLAY::ABSF((ENTITY::GET_ENTITY_HEADING((*uParam0)[iVar0 /*24*/]) - (uParam0[iVar0 /*24*/])->f_18)) < 10f)
																{
																	AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_d", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 9000), 8, 0f, 0, 0, 0);
																	(uParam0[iVar0 /*24*/])->f_5 = 6;
																}
																break;
															...
															case 5:
																if (GAMEPLAY::ABSF((ENTITY::GET_ENTITY_HEADING((*uParam0)[iVar0 /*24*/]) - (uParam0[iVar0 /*24*/])->f_18)) < 10f)
																{
																	AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_f", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 9000), 8, 0f, 0, 0, 0);
																	(uParam0[iVar0 /*24*/])->f_5 = 6;
																}
																break;
															
															case 6:
																if (AI::GET_SCRIPT_TASK_STATUS((*uParam0)[iVar0 /*24*/], -2017877118) == 7)
																{
												...
												case 4:
													...
													{
														case 0:
															(uParam0[iVar0 /*24*/])->f_5 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000));
															break;
												...
												case 6:
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															if (iLocal_65 == 0)
															{
																if (!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 1))
																{
																	...
																	fVar7 = GAMEPLAY::ATAN(((vVar6.z - vVar5.z) / func_4((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 0)));
																	if (fVar7 > 20f)
																	{
																		(uParam0[iVar0 /*24*/])->f_5 = 1;
																	}
														...
														case 1:
															...
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_high", 4f, -8f, -1, 0, 0f, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
														...
														case 2:
															...
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
															AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_low", 4f, -8f, -1, 0, 0f, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
														...
														case 3:
															...
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
															AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_mid", 4f, -8f, -1, 0, 0f, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
														...
														case 4:
															if (bLocal_56)
															{
																if (GAMEPLAY::ABSF(func_113((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID())) < 20f)
																{
								...
								case 1:
									if (!(uParam0[iVar0 /*24*/])->f_21)
									{
										...
										if (!bVar8)
										{
											...
											(uParam0[iVar0 /*24*/])->f_5 = GAMEPLAY::GET_GAME_TIMER() + 2000;
											AI::TASK_COMBAT_PED((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 0, 16);
								...
								case 1:
									if (!(uParam0[iVar0 /*24*/])->f_20)
									{
										*(uParam1[0 /*3*/]) = { *(uParam1[0 /*3*/]) };
										...
										PED::SET_PED_TARGET_LOSS_RESPONSE((*uParam0)[iVar0 /*24*/], 1);
										(uParam0[iVar0 /*24*/])->f_4++;
										(uParam0[iVar0 /*24*/])->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 35000));
									}
									break;
								}
						}
...
int func_109(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5, bool bParam6)
{
	...
	{
		case 0:
			if (!GAMEPLAY::ARE_STRINGS_EQUAL("chi2_hear", vParam3.y))
			{
				if (func_59())
				{
				...
				if (func_105(vParam3.y, vParam3.z, (*uParam1)[iParam0 /*24*/], vParam3.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
				{
					...
					(uParam1[iParam0 /*24*/])->f_11 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				}
			}
			else
			{
		...
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() > (uParam1[iParam0 /*24*/])->f_11)
			{
				AI::TASK_TURN_PED_TO_FACE_COORD((*uParam1)[iParam0 /*24*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 5000);
				(uParam1[iParam0 /*24*/])->f_5++;
				(uParam1[iParam0 /*24*/])->f_11 = GAMEPLAY::GET_GAME_TIMER() + 5000;
			}
			break;
		...
		case 2:
			if (!GAMEPLAY::ARE_STRINGS_EQUAL("chi2_hear", vParam3.y))
			{
				...
				{
					if (GAMEPLAY::GET_GAME_TIMER() > ((uParam1[iParam0 /*24*/])->f_11 - 3000))
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD((*uParam1)[iParam0 /*24*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 0.1f, 0, 40000f);
						(uParam1[iParam0 /*24*/])->f_15 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
						(uParam1[iParam0 /*24*/])->f_5 = 5;
					}
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > (uParam1[iParam0 /*24*/])->f_11)
				{
			...
			{
				AI::TASK_ACHIEVE_HEADING((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_18, 2000);
		...
		case 3:
			func_93();
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, (uParam1[iParam0 /*24*/])->f_12, 1f, 20000, 0.2f, 4096, 40000f);
			AI::TASK_ACHIEVE_HEADING(0, (uParam1[iParam0 /*24*/])->f_18, 2000);
			func_92(uParam1[iParam0 /*24*/], 0);
			(uParam1[iParam0 /*24*/])->f_11 = GAMEPLAY::GET_GAME_TIMER() + 3000;
			(uParam1[iParam0 /*24*/])->f_5++;
			break;
		
		case 4:
			if (AI::GET_SCRIPT_TASK_STATUS((*uParam1)[iParam0 /*24*/], 242628503) == 7 || (GAMEPLAY::ARE_STRINGS_EQUAL("chi2_hear", vParam3.y) && AI::GET_SCRIPT_TASK_STATUS((*uParam1)[iParam0 /*24*/], 1920390111) == 7))
			{
				if (!GAMEPLAY::ARE_STRINGS_EQUAL(sParam2, ""))
				{
					AI::TASK_START_SCENARIO_IN_PLACE((*uParam1)[iParam0 /*24*/], sParam2, 0, 1);
				}
		...
		case 6:
			if (func_67((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_15, 1) < 2f || AI::GET_SCRIPT_TASK_STATUS((*uParam1)[iParam0 /*24*/], 713668775) == 7)
			{
				if (!PED::IS_PED_INJURED((*uParam1)[iParam0 /*24*/]))
				{
					AI::CLEAR_PED_TASKS((*uParam1)[iParam0 /*24*/]);
					func_93();
					AI::TASK_LOOK_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS((*uParam1)[iParam0 /*24*/], -5f, 3f, 0f), 2500, 0, 2);
					AI::TASK_LOOK_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS((*uParam1)[iParam0 /*24*/], 5f, 3f, 0f), 2500, 0, 2);
					func_92(uParam1[iParam0 /*24*/], 0);
					(uParam1[iParam0 /*24*/])->f_11 = GAMEPLAY::GET_GAME_TIMER() + 3000;
...
int func_110(int iParam0, var uParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_DEAD_OR_DYING((*uParam1)[iParam0 /*24*/], 1))
	{
		...
		else
		{
			...
			if (GAMEPLAY::ABSF((uParam1[iParam0 /*24*/])->f_18) > 20f)
			{
				if (bParam2)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, (*uParam1)[iVar3 /*24*/], 0);
				}
				else
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY((*uParam1)[iParam0 /*24*/], (*uParam1)[iVar3 /*24*/], 0);
				}
...
int func_112()
{
	...
	iVar1 = -1;
	AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "reaction_forward_big_intro_a", 4f, -2f, 1400, 0, 0f, 0, 0, 0);
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
		iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1100, 1800);
		iVar4 = (iVar4 + iVar3);
		if (iVar2 == iVar1)
		{
			iVar2++;
		...
		switch (iVar2)
		{
			case 0:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_a", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_b", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_c", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
				}
				break;
			...
			case 1:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_a", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_b", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_c", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
				}
				break;
			...
			case 2:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_a", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_b", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_c", 4f, -2f, iVar3, 0, 0f, 0, 0, 0);
						break;
				}
				break;
		}
...
void func_115(var uParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, struct<2> Param5, var uParam6, struct<2> Param7, var uParam8)
{
	...
	{
		bLocal_82 = false;
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || CONTROLS::IS_CONTROL_PRESSED(0, 24))
		{
			iVar0 = 0;
			while (iVar0 < *uParam0)
			{
								...
								if ((uParam0[iVar0 /*24*/])->f_3 <= 4)
								{
									if (func_4((*uParam0)[iVar0 /*24*/], (*uParam0)[iLocal_58 /*24*/], 1) < 8f)
									{
										if ((INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iLocal_58 /*24*/]) != 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iVar0 /*24*/]) != 0) || (INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iLocal_58 /*24*/]) == 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iVar0 /*24*/]) == 0))
										{
											...
											if (GAMEPLAY::ABSF((vVar3.z - vVar4.z)) < 2f)
											{
	...
	if (!iLocal_55)
	{
		...
		{
			iLocal_59 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			iLocal_55 = 1;
		}
	...
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_59)
	{
		if (func_82(Param1.f_1) || func_82(Param3.f_1))
		{
			bLocal_53 = true;
			...
			if ((uParam0[iVar0 /*24*/])->f_3 != 7)
			{
				...
				if ((uParam0[iVar0 /*24*/])->f_3 <= 4)
				{
					...
					if (!bLocal_82 && !PED::IS_PED_RAGDOLL((*uParam0)[iVar0 /*24*/]))
					{
						...
						{
							if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], true), 4f, 1, 1))
							{
								(uParam0[iVar0 /*24*/])->f_1 = 7;
							}
						}
						else if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], true), 6f, 1, 1))
						{
							(uParam0[iVar0 /*24*/])->f_1 = 7;
						}
						...
						if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], true), 1f, 1))
						{
							(uParam0[iVar0 /*24*/])->f_1 = 7;
						}
					}
...
void func_117()
{
	if (iLocal_392)
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&vLocal_397))
		{
			if (func_59())
			{
				if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_393) && !GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_393, "NULL"))
						{
							vLocal_397 = { func_83() };
							func_85();
						}
...
void func_120()
{
	...
	if (iLocal_102 == 0)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_109[0 /*5*/]))
		{
			...
			while (iVar0 < Local_109)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_109[(iVar0 - 1) /*5*/], Local_109[iVar0 /*5*/], 1));
				}
				if (Local_109[iVar0 /*5*/].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_109[iVar0 /*5*/]))
					{
						fVar4 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_109[iVar0 /*5*/], vVar1, 1);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_102 == 1)
	{
		...
		fVar7 = (SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_104)) / fLocal_110);
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_101[iVar0 /*5*/].f_4) > 1000)
			{
				GRAPHICS::FADE_DECALS_IN_RANGE(Local_101[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_101[iVar0 /*5*/].f_4) > 6000)
			{
...
void func_122(vector3 vParam0, int iParam1)
{
	...
	Local_101[iLocal_106 /*5*/].f_4 = GAMEPLAY::GET_GAME_TIMER();
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (CONTROLS::IS_CONTROL_PRESSED(0, 24) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_95 == 0)
				{
					...
					iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 250;
				}
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_95)
				{
					if (!bLocal_85)
					{
						...
						while (iVar0 < Local_109)
						{
							if (UI::DOES_BLIP_EXIST(Local_109[iVar0 /*5*/].f_3))
							{
								fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_98, UI::GET_BLIP_COORDS(Local_109[iVar0 /*5*/].f_3), 1);
								fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_109[iVar0 /*5*/], UI::GET_BLIP_COORDS(Local_109[iVar0 /*5*/].f_3), 1);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_91 != -1)
							{
								if (GAMEPLAY::ABSI((iLocal_92 - iVar5)) > 1)
								{
									iLocal_92 = -1;
								}
								if (iLocal_92 == -1)
								...
								if (GAMEPLAY::ABSI((iLocal_92 - iVar5)) < 3 && GAMEPLAY::ABSI((iLocal_92 - iVar5)) > 0)
								{
									if (iLocal_92 < iVar5)
									{
										iVar6 = iLocal_92;
										while (iVar6 <= (iVar5 - 1))
										{
											if (UI::DOES_BLIP_EXIST(Local_109[iVar6 /*5*/].f_3))
											{
												if (UI::GET_BLIP_ALPHA(Local_109[iVar6 /*5*/].f_3) > 0)
												{
													UI::SET_BLIP_ALPHA(Local_109[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (UI::DOES_BLIP_EXIST(Local_109[iVar5 /*5*/].f_3))
									{
										if (UI::GET_BLIP_ALPHA(Local_109[iVar5 /*5*/].f_3) > 0)
										{
											UI::SET_BLIP_ALPHA(Local_109[iVar5 /*5*/].f_3, 0);
...
Vector3 func_124()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar2, &uVar4, 0, 0);
...
void func_130(char* sParam0)
{
	...
	if (GAMEPLAY::IS_STRING_NULL(sLocal_151))
	{
		sLocal_151 = "CHFAIL";
	}
	func_132(sLocal_151);
	...
	if (!Local_389[iParam0 /*4*/].f_1)
	{
		if (func_152(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1, 0))
		{
			switch (Local_389[iParam0 /*4*/])
			{
				...
				case 5:
					if (!func_59() && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						func_7("FRMLK", 7500, 1);
						Local_389[iParam0 /*4*/].f_1 = 1;
					}
				...
				case 11:
					switch (Local_389[iParam0 /*4*/].f_2)
					{
						case 0:
							...
							{
								Local_389[iParam0 /*4*/].f_3 = GAMEPLAY::GET_GAME_TIMER() + 1000;
								Local_389[iParam0 /*4*/].f_2++;
							}
							break;
						
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_389[iParam0 /*4*/].f_3)
							{
								if (CONTROLS::_IS_INPUT_DISABLED(0))
								{
				...
				case 6:
					...
					{
						case 0:
							if (GAMEPLAY::GET_PROFILE_SETTING(211) != 0)
							{
								Local_389[iParam0 /*4*/].f_3 = GAMEPLAY::GET_GAME_TIMER() + 4000;
								Local_389[iParam0 /*4*/].f_2++;
							}
							break;
						...
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_389[iParam0 /*4*/].f_3)
							{
								...
								{
									if (!UI::IS_MESSAGE_BEING_DISPLAYED() && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										if (!func_59())
										{
											if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				...
				case 7:
					...
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_178, "FRMBLIPB");
					Local_389[iParam0 /*4*/].f_1 = 1;
					break;
					...
					switch (Local_389[iParam0 /*4*/].f_2)
					{
						...
						case 2:
							...
							if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar1, 1))
							{
								if (iVar1 == joaat("weapon_petrolcan"))
								{
									if (CONTROLS::IS_CONTROL_PRESSED(0, 24))
									{
										UI::CLEAR_HELP(1);
									}
								}
		...
		if (func_152(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9))
		{
			...
			switch (Local_390[iParam0 /*7*/])
			{
				...
				case 2:
					...
					{
						case 0:
							Local_390[iParam0 /*7*/].f_4 = GAMEPLAY::GET_GAME_TIMER() + 2000;
							Local_390[iParam0 /*7*/].f_3++;
							break;
						
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_390[iParam0 /*7*/].f_4)
							{
								if (func_59())
								{
									Local_390[iParam0 /*7*/].f_4 = GAMEPLAY::GET_GAME_TIMER() + 2000;
								...
								else
								{
									...
									if (func_159(&iVar0, 2, 1))
									{
										...
										{
											Local_390[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(8000, 14000));
										}
									}
									else
									{
				...
				case 9:
					switch (Local_390[iParam0 /*7*/].f_3)
					{
						case 0:
							if (!PED::IS_PED_INJURED(Local_113[Local_390[iParam0 /*7*/].f_4 /*33*/]))
							{
								Local_390[iParam0 /*7*/].f_3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 3);
							}
							break;
						...
						case 1:
							if (!PED::IS_PED_INJURED(Local_113[Local_390[iParam0 /*7*/].f_5 /*33*/]))
							{
								if (Local_390[iParam0 /*7*/].f_6 < 3)
								{
									...
									{
										Local_390[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(7000, 12000));
							...
							if (!PED::IS_PED_INJURED(Local_113[Local_390[iParam0 /*7*/].f_5 /*33*/]))
							{
								switch (Local_390[iParam0 /*7*/].f_6)
								{
									...
									case 9:
										...
										{
											Local_390[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 10000));
											Local_390[iParam0 /*7*/].f_6++;
											Local_390[iParam0 /*7*/].f_3 = 0;
										}
										break;
				...
				case 20:
					...
					{
						case 0:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_390[iParam0 /*7*/].f_5)
							{
								fVar4 = 999f;
						...
						case 1:
							...
							{
								Local_390[iParam0 /*7*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 6000;
								Local_390[iParam0 /*7*/].f_3 = 0;
							}
							break;
					}
					...
					switch (Local_390[iParam0 /*7*/].f_3)
					{
						...
						case 2:
							if (Local_390[iParam0 /*7*/].f_5 < 14)
							{
								...
								{
									Local_390[iParam0 /*7*/].f_3 = 1;
									Local_390[iParam0 /*7*/].f_4 = (12000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
			...
			switch (Local_385[iParam0 /*10*/])
			{
				...
				case 7:
					if ((!PED::IS_PED_INJURED(Local_113[12 /*33*/]) && !PED::IS_PED_INJURED(Local_113[13 /*33*/])) && !PED::IS_PED_INJURED(Local_113[14 /*33*/]))
					{
						if (func_169(6, 6) < 2)
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_113[12 /*33*/], 150319005) == 7)
								{
									AI::TASK_LOOK_AT_ENTITY(Local_113[13 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									AI::TASK_LOOK_AT_ENTITY(Local_113[14 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									AI::TASK_LOOK_AT_ENTITY(Local_113[12 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								}
							}
						}
					}
				...
				case 9:
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "missrampageintrooutro", "trvram_6_1h_run_outro", 3))
					{
						...
						if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY("walkinterruptible")))
						{
				...
				case 11:
					...
					{
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_385[iParam0 /*10*/].f_7)
							{
								if (INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())))
								{
									FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f)), 16, 1.5f, 1, 0, 1065353216, 0);
									Local_385[iParam0 /*10*/].f_9 = (Local_385[iParam0 /*10*/].f_9 - 1f);
									Local_385[iParam0 /*10*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 520));
								}
								else
								{
									Local_385[iParam0 /*10*/].f_6 = 2;
						...
						default:
							...
							{
								if (!GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_7, iVar5))
								{
									if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_384[iVar5 /*3*/], 5f))
									{
										GAMEPLAY::SET_BIT(&(Local_385[iParam0 /*10*/].f_7), iVar5);
										if (Local_385[iParam0 /*10*/].f_6 == 0)
										{
											Local_385[iParam0 /*10*/].f_6 = GAMEPLAY::GET_GAME_TIMER() + 1500;
										}
									}
								}
								iVar5++;
							}
							if (GAMEPLAY::GET_GAME_TIMER() > Local_385[iParam0 /*10*/].f_8)
							{
								Local_385[iParam0 /*10*/].f_8 = 0;
								iVar5 = 0;
								while (iVar5 < vLocal_384.x)
								{
									if (!GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_7, iVar5 + 9) && GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_7, iVar5))
									{
										FIRE::ADD_EXPLOSION(vLocal_384[iVar5 /*3*/], 16, 1.5f, 1, 0, 1065353216, 0);
										GAMEPLAY::SET_BIT(&(Local_385[iParam0 /*10*/].f_7), iVar5 + 9);
										iVar5 = 8;
										Local_385[iParam0 /*10*/].f_8 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(150, 320));
									}
									iVar5++;
								}
							}
							if (Local_385[iParam0 /*10*/].f_6 != 0)
							{
								if (GAMEPLAY::GET_GAME_TIMER() > Local_385[iParam0 /*10*/].f_6)
								{
									Local_385[iParam0 /*10*/].f_6 = 1;
									Local_385[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 300;
						...
						case 4:
							if (func_68(iLocal_144))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_144, 0))
								{
									if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_144))
									{
										Local_385[iParam0 /*10*/].f_7 = (Local_385[iParam0 /*10*/].f_7 + GAMEPLAY::GET_GAME_TIMER() + 7000);
										Local_385[iParam0 /*10*/].f_6++;
									}
								}
							}
							...
							if (func_68(iLocal_144))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_144, 0))
								{
									if (GAMEPLAY::GET_GAME_TIMER() > Local_385[iParam0 /*10*/].f_7)
									{
										...
										{
											Local_385[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 5000;
										}
									}
								}
							}
						...
						case 7:
							if (!func_82("CHI2_rad"))
							{
								if (func_68(iLocal_144))
								{
									if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_144, 0))
									{
										if (!CONTROLS::IS_CONTROL_PRESSED(0, 85))
										{
						...
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_113[11 /*33*/]))
						{
							if (GAMEPLAY::GET_GAME_TIMER() > Local_385[iParam0 /*10*/].f_7)
							{
								if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
								{
									...
									Local_385[iParam0 /*10*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 5000));
								}
							}
						}
					}
				...
				case 41:
					switch (Local_385[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if ((STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && STREAMING::HAS_MODEL_LOADED(joaat("ig_taocheng"))) && STREAMING::HAS_MODEL_LOADED(joaat("ig_taostranslator")))
							{
								...
								if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_113[11 /*33*/], Local_385[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								if (!PED::IS_PED_INJURED(Local_113[10 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_113[10 /*33*/], Local_385[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								Local_385[iParam0 /*10*/].f_6++;
							}
							break;
						...
						case 900:
								...
								if (!PED::IS_PED_RAGDOLL(Local_113[11 /*33*/]))
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_385[iParam0 /*10*/].f_7))
									{
										if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_385[iParam0 /*10*/].f_7) == 1f)
										{
											...
											{
												AI::TASK_SYNCHRONIZED_SCENE(Local_113[11 /*33*/], Local_385[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
												if (!PED::IS_PED_INJURED(Local_113[10 /*33*/]))
												{
													if (!PED::IS_PED_RAGDOLL(Local_113[10 /*33*/]))
													{
														if (!GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_8, 0))
														{
															AI::TASK_SYNCHRONIZED_SCENE(Local_113[10 /*33*/], Local_385[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
														}
													}
												}
											}
							...
							if (!PED::IS_PED_INJURED(Local_113[10 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_113[10 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_113[10 /*33*/])) || PED::IS_PED_INJURED(Local_113[11 /*33*/])) || (!PED::IS_PED_INJURED(Local_113[10 /*33*/]) && AI::GET_SCRIPT_TASK_STATUS(Local_113[10 /*33*/], 1785177548) == 2))
								{
									if (!GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_8, 0))
									{
										AI::CLEAR_PED_TASKS(Local_113[10 /*33*/]);
										func_93();
										AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 30f, 20000, 0, 0);
										AI::TASK_COWER(0, -1);
										func_92(&(Local_113[10 /*33*/]), 0);
										GAMEPLAY::SET_BIT(&(Local_385[iParam0 /*10*/].f_8), 0);
									}
								}
							}
							if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_113[11 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_113[11 /*33*/])) || GAMEPLAY::IS_BIT_SET(Local_385[iParam0 /*10*/].f_8, 1)) || (!PED::IS_PED_INJURED(Local_113[11 /*33*/]) && AI::GET_SCRIPT_TASK_STATUS(Local_113[11 /*33*/], 1785177548) == 2))
								{
					...
					if (func_67(PLAYER::PLAYER_PED_ID(), 1995.169f, 3062.162f, 46.049f, 1) < 7f)
					{
						if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_113[11 /*33*/], 150319005) != 1)
							{
								AI::TASK_LOOK_AT_ENTITY(Local_113[11 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
							}
						}
						if (!PED::IS_PED_INJURED(Local_113[10 /*33*/]))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_113[10 /*33*/], 150319005) != 1)
							{
								AI::TASK_LOOK_AT_ENTITY(Local_113[10 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
							}
						}
					}
					break;
				...
				case 16:
					...
					iVar14 = 0;
					GAMEPLAY::SET_BIT(&iVar14, 3);
					GAMEPLAY::SET_BIT(&iVar14, 8);
					GAMEPLAY::SET_BIT(&iVar14, 1);
					if (!OBJECT::DOES_PICKUP_EXIST(uLocal_176))
					{
						...
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_178, "FRMBLIP");
					}
					Local_385[iParam0 /*10*/].f_3 = 1;
					break;
				...
				case 20:
					...
					{
						case 0:
							Local_385[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 4000;
							Local_385[iParam0 /*10*/].f_6++;
							break;
				...
				case 23:
					...
					while (iVar15 < Local_113)
					{
						...
						{
							if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(Local_113[iVar15 /*33*/]) != GAMEPLAY::GET_HASH_KEY("V_8_BasementRm"))
							{
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
							{
								if (!PED::IS_PED_INJURED(Local_113[23 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/], Local_385[iParam0 /*10*/].f_8, "misschinese2_crystalmaze", "_stand_to_aim", 1000f, -8f, 0, 0, 1148846080, 0);
									Local_385[iParam0 /*10*/].f_6++;
								}
							}
							break;
				...
				case 33:
					...
					{
						case 0:
							AI::REQUEST_WAYPOINT_RECORDING("arm2_30");
							Local_385[iParam0 /*10*/].f_6++;
							break;
						
						case 1:
							if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("arm2_30"))
							{
								if (func_87(29))
								{
									AI::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("arm2_30", 1, 1065353216, 1056964608);
									AI::ASSISTED_MOVEMENT_SET_ROUTE_PROPERTIES("arm2_30", 2);
									Local_385[iParam0 /*10*/].f_6++;
								}
							}
							break;
						...
						case 2:
							if (!func_87(29))
							{
								AI::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("arm2_30", 0, 1065353216, 1056964608);
								Local_385[iParam0 /*10*/].f_6 = 1;
							}
							break;
					}
				...
				case 40:
					if (func_101(24, joaat("a_m_m_hillbilly_01"), 2433.123f, 4960.47f, 45.8218f, 301f, joaat("weapon_smg"), 1, 1))
					{
						...
						AI::TASK_COMBAT_PED(Local_113[24 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
...
void func_161()
{
	...
	while (iVar0 < Local_109)
	{
		if (!func_162(Local_109[iVar0 /*5*/], 0f, 0f, 0f, 0))
		{
			...
			GAMEPLAY::CLEAR_AREA(Local_109[iVar0 /*5*/], 2f, 1, 0, 0, false);
			iVar1 = 0;
...
void func_163(bool bParam0)
{
	...
	while (iVar0 < Local_109)
	{
		...
		{
			Local_109[iVar0 /*5*/] = { UI::GET_BLIP_COORDS(Local_109[iVar0 /*5*/].f_3) };
			if (!bParam0)
			{
				UI::SET_BLIP_ALPHA(Local_109[iVar0 /*5*/].f_3, 0);
			}
...
int func_168()
{
	if (((((CONTROLS::GET_CONTROL_VALUE(2, 30) != 127 || CONTROLS::GET_CONTROL_VALUE(2, 31) != 127) || CONTROLS::IS_CONTROL_PRESSED(2, 24)) || CONTROLS::IS_CONTROL_PRESSED(2, 25)) || CONTROLS::GET_CONTROL_VALUE(2, 2) != 127) || CONTROLS::GET_CONTROL_VALUE(2, 1) != 127)
	{
		return 1;
	}
	return 0;
		...
		switch (Local_388[iVar3 /*8*/])
		{
			...
			case 6:
				if (!Local_388[iVar3 /*8*/].f_2)
				{
					if (func_156(7))
					{
						if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(2493.155f, 4970.315f, 43.88038f, 3.25f, 1, 1) || GAMEPLAY::IS_BULLET_IN_AREA(2493.155f, 4970.315f, 43.88038f, 3.25f, 1))
						{
							Local_388[iVar3 /*8*/].f_2 = 1;
						}
					}
			...
			case 11:
				Local_388[iVar3 /*8*/].f_2 = 0;
				if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == GAMEPLAY::GET_HASH_KEY("V_8_BasementRm"))
				{
					Local_388[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 27:
				switch (Local_388[iVar3 /*8*/].f_4)
				{
					case 0:
						...
						Local_388[iVar3 /*8*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 8000;
						break;
					...
					case 1:
						...
						if (GAMEPLAY::GET_GAME_TIMER() > Local_388[iVar3 /*8*/].f_5)
						{
							Local_388[iVar3 /*8*/].f_4++;
						}
						break;
			...
			case 47:
				...
				{
					case 0:
						Local_388[iVar3 /*8*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 30000;
						Local_388[iVar3 /*8*/].f_4++;
						break;
...
void func_175()
{
	...
	if ((func_195() && iLocal_150 > 0) && GAMEPLAY::GET_GAME_TIMER() > iLocal_159)
	{
	...
	switch (iLocal_150)
	{
		case 0:
			...
			iLocal_159 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			GAMEPLAY::CLEAR_AREA(2570.53f, 4982.057f, 50.6819f, 100f, 1, 0, 0, false);
	...
	if (iLocal_133)
	{
		...
		bLocal_134 = false;
		iLocal_174 = 0;
		GAMEPLAY::CLEAR_AREA(2431.097f, 4967.043f, 41.3476f, 20f, 1, 0, 0, false);
		func_184();
	}
	if (!bLocal_134)
	{
		...
		if (iLocal_139 == -1 || ((iLocal_139 != -1 && iLocal_139 < 4) && fLocal_138 > (Local_137[iLocal_139 /*18*/].f_13 / 1000f)))
		{
			...
			if (iLocal_139 == 3)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_156, "misschinese2_crystalmaze", "trevor_barn_walk", 1000f, -8f, 0, 0, 1148846080, 0);
					}
			...
			else if (!bLocal_132)
			{
				...
				OBJECT::_0x5C29F698D404C5E1(uLocal_173, 9);
				GAMEPLAY::SET_TIME_SCALE(1f);
				STREAMING::END_SRL();
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					while (OBJECT::_0x899BA936634A322E(uLocal_173) != 10)
					{
						func_28(29, 1);
					}
					CAM::DO_SCREEN_FADE_IN(1000);
					...
					switch (iVar3)
					{
						case 0:
							switch (Local_136[iVar3 /*6*/].f_4)
							{
								case 0:
									iLocal_143 = 0;
									if (GAMEPLAY::GET_GAME_TIMER() > Local_136[iVar3 /*6*/].f_5)
									{
										func_122(vLocal_142[iLocal_143 /*3*/], 0);
										Local_136[iVar3 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 200;
						...
						case 1:
							FIRE::ADD_EXPLOSION(2432.534f, 4968.383f, 42.2389f, 4, 1056964608, 1, 0, 1065353216, 0);
							Local_136[iVar3 /*6*/] = 1;
							break;
						...
						case 5:
							switch (Local_136[iVar3 /*6*/].f_4)
							{
								case 0:
									fLocal_175 = 1f;
									Local_136[iVar3 /*6*/].f_4++;
									Local_136[iVar3 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 1300;
								...
								case 1:
									...
									GAMEPLAY::SET_TIME_SCALE(fLocal_175);
									if (GAMEPLAY::GET_GAME_TIMER() > Local_136[iVar3 /*6*/].f_5)
									{
										Local_136[iVar3 /*6*/].f_4++;
									}
...
void func_201()
{
	...
	if (((func_195() && iLocal_150 > 0) && iLocal_150 < 7) && GAMEPLAY::GET_GAME_TIMER() > iLocal_159)
	{
		iLocal_150 = 10;
		iLocal_158 = 0;
		bLocal_165 = true;
		...
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				if (iLocal_150 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA(2445.139f, 4978.642f, 52.1489f, 150f, 1, 1, 0, false);
					GAMEPLAY::CLEAR_AREA(2578.523f, 4982.284f, 51.4416f, 13f, 1, 0, 0, false);
					...
					AI::TASK_GO_STRAIGHT_TO_COORD(0, 2570.543f, 4982.002f, 50.6795f, 1f, 20000, 1193033728, 1056964608);
					AI::TASK_ACHIEVE_HEADING(0, 88.7065f, 0);
				...
				CAM::SET_CAM_ACTIVE(iLocal_155, 1);
				CAM::RENDER_SCRIPT_CAMS(true, 0, 3000, 1, 0, 0);
				UNK1::_0x48621C9FCA3EBD28(4);
				...
				while (iVar4 < Local_113)
				{
					if (!PED::IS_PED_INJURED(Local_113[iVar4 /*33*/]))
					{
						AUDIO::STOP_PED_SPEAKING(Local_113[iVar4 /*33*/], 1);
					}
					iVar4++;
				}
				...
				if (!PED::IS_PED_INJURED(iLocal_160))
				{
					func_93();
					AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2463.016f, 4974.97f, 45.5765f, 1f, -1, 0.5f, 1, 40000f);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2452.833f, 4964.785f, 45.5765f, 1f, -1, 0.5f, 1, 40000f);
					AI::TASK_PAUSE(0, 500);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2460.449f, 4976.938f, 45.5765f, 1f, -1, 0.5f, 0, 40000f);
		...
		case 11:
			...
			if ((CAM::IS_SCREEN_FADED_OUT() && !CUTSCENE::IS_CUTSCENE_PLAYING()) || (CUTSCENE::IS_CUTSCENE_ACTIVE() && CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(1)))
			{
				...
				while (iVar5 < Local_113)
				{
					...
					{
						AUDIO::STOP_PED_SPEAKING(Local_113[iVar5 /*33*/], 0);
					}
					iVar5++;
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
void func_203(var uParam0, var uParam1, char* sParam2, float fParam3, vector3 vParam4, float fParam5, int iParam6)
{
	...
	iLocal_68 = 0;
	iLocal_69 = 0;
	DECISIONEVENT::BLOCK_DECISION_MAKER_EVENT(-455129387, 31);
	iLocal_52 = 0;
}
...
void func_217()
{
	...
	{
		if (UI::DOES_BLIP_EXIST(Local_184.f_5))
		{
			UI::SET_BLIP_ROUTE(Local_184.f_6, false);
		}
		func_176(11);
	}
	else
	{
		switch (iLocal_150)
		{
			...
			case 1:
				...
				{
					UNK1::_0x293220DA1B46CEBC(6f, 6f, 3);
					iLocal_150++;
					func_211(&Local_184, 1, 0);
					func_31(3, 1);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_235(iParam0, 1) && !func_234(iParam0)) && !GAMEPLAY::IS_BIT_SET(iParam0->f_13, 0))
					{
						if (bParam22)
						{
				...
				else
				{
					...
					if (!UI::DOES_BLIP_EXIST(iParam0->f_5))
					{
						...
						if (!iParam23 == -1)
						{
							UI::SET_BLIP_SPRITE(iParam0->f_5, iParam23);
						}
						if (bParam27)
						{
					...
					else if (!func_229(vVar3, UI::GET_BLIP_COORDS(iParam0->f_5), 0.1f, 0))
					{
			...
			{
				if ((bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && (!GAMEPLAY::IS_BIT_SET(iParam0->f_13, 9) && !GAMEPLAY::IS_BIT_SET(iParam0->f_13, 22)))
				{
					func_240(sParam16);
					func_240(sParam19);
				...
				else
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, 0))
					{
						...
						if (!func_235(iParam0, 2))
						{
							...
							{
								if (!GAMEPLAY::IS_STRING_NULL(sParam19))
								{
									if (!GAMEPLAY::IS_BIT_SET(iParam0->f_13, 4))
									{
						...
						if (!func_235(iParam0, 2))
						{
							if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								if (!GAMEPLAY::IS_BIT_SET(iParam0->f_13, 13))
								{
									...
									iVar7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar6);
...
int func_224(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_225(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_225(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
void func_230(int iParam0, int iParam1)
{
	if (UI::DOES_BLIP_EXIST(iParam0))
	{
		if (UI::DOES_BLIP_EXIST(iParam1->f_6))
		{
			UI::SET_BLIP_ROUTE(iParam1->f_6, false);
		}
		UI::_0x3DDA37128DD1ACA8(0);
		UI::_0x67EEDEA1B9BAFD94();
		iParam1->f_6 = iParam0;
		UI::SET_BLIP_ROUTE(iParam0, true);
	}
}
						...
						if (func_239(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_256(uParam0->f_17[iVar0], uParam0->f_21))
									{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar10, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(uParam0->f_13, 13))
				{
					...
					if (!func_235(uParam0, 2))
					{
						...
						iVar18 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar17);
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
						...
						if (iVar10 != iParam10 && !ENTITY::IS_ENTITY_DEAD(iVar10, 0))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iVar10))
							{
								if (ENTITY::IS_ENTITY_IN_WATER(iVar10) && !VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iVar10))
								{
									...
									if (vVar19.z < -1f)
									{
										AI::TASK_LEAVE_VEHICLE(uParam0->f_17[iVar0], iVar10, 64);
									}
								}
							}
						}
								...
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, 0))
								{
									if (iVar10 != iParam10)
									{
										if (!PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar10))
										{
											...
											{
												AI::TASK_LEAVE_VEHICLE(uParam0->f_17[iVar0], iVar10, 4160);
											}
											else
											{
												AI::TASK_LEAVE_VEHICLE(uParam0->f_17[iVar0], iVar10, 64);
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar21))
						{
							...
							{
								if (func_250(iVar0, uParam0) || !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
					...
					if ((!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()) && !func_248(uParam0->f_17[iVar0], iParam10)) && !func_247(uParam0->f_17[iVar0], iParam10))
					{
						if (func_254(uParam0, uParam0->f_17[iVar0], fParam8, bParam11))
						{
							if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
							{
								...
								{
									iVar11 = AI::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470);
									if (iVar11 == 7)
									{
										AI::CLEAR_PED_TASKS(uParam0->f_17[iVar0]);
									}
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(uParam0->f_17[iVar0]))
								{
									if (!PED::IS_PED_IN_VEHICLE(uParam0->f_17[iVar0], iParam10, 0))
									{
										if (!func_227(uParam0->f_17[iVar0], 1))
										{
											...
											{
												iVar11 = AI::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], 451360105);
												if (iVar11 == 7)
												{
								...
								else
								{
									...
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_246(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !AI::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], 1);
						...
						else
						{
							...
							while (iVar0 < 3)
							{
								if (iVar7[iVar0])
								{
									...
									{
										if (!GAMEPLAY::IS_STRING_NULL(uVar13[iVar0]))
										{
											if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar13[iVar0], ""))
											{
...
void func_243(var uParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!GAMEPLAY::IS_STRING_NULL(sParam1))
		{
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(sParam1, ""))
			{
				func_244(sParam1, sParam2, 7500, 1);
			}
		}
	}
		...
		case 0:
			...
			if (func_204())
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[0]))
				{
					...
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_113[14 /*33*/], 1, 1);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_113[13 /*33*/], 1, 1);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_113[11 /*33*/], 1, 1);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_113[10 /*33*/], 1, 1);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_113[12 /*33*/], 1, 1);
					if (!PED::IS_PED_INJURED(Local_113[13 /*33*/]))
					{
				...
				CUTSCENE::START_CUTSCENE(0);
				UNK1::_0x48621C9FCA3EBD28(4);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(1991.22f, 3054.884f, 50.27741f, 87f, 0);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(1991.22f, 3054.884f, 50.27741f, 87f, 0);
		...
		case 2:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
			{
				if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_113[11 /*33*/], iVar0, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
			{
				if (!PED::IS_PED_INJURED(Local_113[10 /*33*/]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_113[10 /*33*/], iVar1, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				else if (STREAMING::HAS_ANIM_DICT_LOADED("missrampageintrooutro"))
				{
					...
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "missrampageintrooutro", "trvram_6_1h_run_outro", 1000f, -4f, -1, 0, 0.1f, 0, 0, 0);
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
			{
				...
				UNK1::_0x81CBAE94390F9F89();
				UNK1::_0x293220DA1B46CEBC(0f, 7f, 3);
				func_176(11);
			}
			break;
	}
...
void func_265()
{
	...
	{
		case 0:
			UI::REQUEST_ADDITIONAL_TEXT("FRMCHSE", 0);
			...
			GAMEPLAY::_SET_WEATHER_TYPE_OVER_TIME("EXTRASUNNY", 120f);
			...
			func_17(0, -1);
			AI::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", false);
			AI::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", false);
			if (func_359())
			{
				iVar0 = func_358();
				if (Global_87504 == 1)
...
void func_266(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			PED::ADD_SCENARIO_BLOCKING_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(40f, 40f, 40f), 0, 1, 1, 1);
			PED::SET_PED_NON_CREATION_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(0f, 40f, 40f));
			GAMEPLAY::CLEAR_AREA(1984.997f, 3052.905f, 46.8556f, 10f, 1, 0, 0, false);
		...
		case 4:
			...
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_274(), 2570.538f, 4982.031f, 50.6239f, 1) < 10f)
			{
		...
		case 9:
			...
			func_19(55, 1, 0, 1, 0);
			uLocal_173 = OBJECT::_0xB48FCED898292E52(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
			while (!OBJECT::_0x52AF537A0C5B8AAD(uLocal_173))
			{
				func_28(161, 1);
			}
			OBJECT::_0x5C29F698D404C5E1(uLocal_173, 9);
	...
	if (func_337(uParam0))
	{
		...
		if (func_336(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_314(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_283(iVar0 + 1));
			}
			iVar0++;
		}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_162(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 1) < 10f)
					{
...
void func_317(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_311(iParam0, iParam1))
				{
...
void func_318(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_283(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_283(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_283(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_326(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_325())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_283(iVar2 + 1)))
				{
...
void func_335(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_70024.f_555[0 /*21*/], iParam2) <= fParam1)
			{
				func_306(iVar0);
			}
		}
...
void func_353(int iParam0)
{
	...
	if (iParam0 != 3)
	{
		AI::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", true);
		AI::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", false);
	}
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	if (iLocal_379 != -1)
	...
	while (iVar0 < Local_113)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/]))
		{
			if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
			{
				if (iParam0 == 3)
				{
					AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_113[iVar0 /*33*/]);
				}
			}
	...
	if (iParam0 != 0 && iParam0 != 2)
	{
		GAMEPLAY::CLEAR_AREA(2438.433f, 4970.416f, 53.1778f, 450f, 1, 0, 0, false);
		FIRE::STOP_FIRE_IN_RANGE(2442.69f, 4970.348f, 46.33f, 30f);
	}
	iVar0 = 0;
	while (iVar0 < Local_153)
...
void func_354()
{
	DECISIONEVENT::UNBLOCK_DECISION_MAKER_EVENT(-455129387, 31);
}
...
void func_363(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		if (iVar1 != -1 && iVar1 != 94)
		{
			...
			STATS::PLAYSTATS_MISSION_CHECKPOINT(&cVar3, iVar2, Global_93269, iParam0);
		}
		else
		{
			...
			if (iVar4 != -1)
			{
				...
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_93269, iParam0);
			}
			else
			{
...
{
	func_365(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				...
				{
					if (iParam2 == 0 || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*uParam1, true), ENTITY::GET_ENTITY_COORDS(iParam0, true), 1) < 100f)
					{
...
void func_382(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		iVar6 = DLC1::GET_NUM_DLC_WEAPONS();
		iVar5 = 0;
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_384(Var7.f_1)) && iVar9 < 50)
			{
				if (!DLC1::_IS_DLC_DATA_EMPTY(Var7))
				{
					Var4 = Var7.f_1;
					Var4.f_1 = 0;
					Var4.f_2 = 0;
					...
					iVar10 = 0;
					iVar1 = 0;
					while (iVar1 < DLC1::GET_NUM_DLC_WEAPON_COMPONENTS(iVar5))
					{
						if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar5, iVar1, &Var8))
						{
							if (!func_383(Var8.f_3))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, Var4, Var8.f_3))
								{
									GAMEPLAY::SET_BIT(&(Var4.f_2), iVar10);
								}
								iVar10++;
							}
						}
...
void func_389(var uParam0, int iParam1)
{
	...
	*uParam0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	...
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("finale_choice")) > 0)
	{
...
int func_394(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_375(func_395(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_397(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_413(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_398(iVar0, 0), 1);
...
var func_414()
{
	...
	func_424(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_423(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_422(&uVar0, TIME::GET_CLOCK_HOURS());
	func_417(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_416(&uVar0, TIME::GET_CLOCK_MONTH());
	func_415(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_420(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
