	...
	while (true)
	{
		switch (iLocal_84)
		{
			...
			case 1:
				...
				iLocal_85 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("PSYCHOLOGY_REPORT");
				...
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_85, "SET_PLAYER_NAME");
				...
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_85, "SET_LETTER_TEXT");
				func_42("HEADER_1");
				func_42("HEADER_2");
...
void func_1(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_6(iParam0->f_1, 256) || (func_6(iParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(func_6(iParam0->f_1, 4096));
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_10(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar1 < 8)
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::SET_BIT(&(iParam0->f_2[iVar1 /*15*/].f_13), 0);
		}
...
struct<4> func_20(var uParam0)
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 24);
	uParam0->f_15 = iVar1;
...
struct<4> func_21(var uParam0)
{
	...
	if (((func_22(110) || func_22(95)) || func_22(106)) || func_22(107))
	{
		...
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 11);
	}
	else
	{
		StringCopy(&(uParam0->f_14), "N", 4);
		StringConCat(&Var0, "N", 16);
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 12);
	}
...
struct<4> func_23(var uParam0)
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 13);
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_18075.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
int func_36(int iParam0)
{
	...
	{
		case 0:
			return Global_106070.f_10021.f_90[0];
			break;
		
		case 1:
			return Global_106070.f_10021.f_90[1];
			break;
		
		case 2:
			return Global_106070.f_10021.f_90[2];
			break;
	}
	return 0;
}
...
struct<4> func_38(var uParam0)
{
	...
	if (iVar3 >= 1000000)
	{
		...
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 14);
	}
	else
	{
...
struct<4> func_41(var uParam0)
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 21);
	*uParam0 = iVar1;
	StringIntConCat(&Var0, iVar1, 16);
	return Var0;
}
...
void func_50(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
