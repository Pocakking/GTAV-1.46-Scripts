	...
	if (func_22(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_58)
		{
			...
			case 2:
				...
				{
					iLocal_83 = 1;
					AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_68.f_9);
	...
	if (func_22(Local_75))
	{
		if (func_423(Local_77))
		{
			if (func_57(2))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_75, iVar0, func_40(), func_50(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
...
void func_66()
{
	if (func_423(Local_68.f_9))
	{
		...
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_154, Local_68.f_9, 0);
		}
	}
	if (func_423(Local_75))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_153, Local_75, 0);
		}
	}
}
...
{
	func_98(&(Global_99633.f_2875), vParam0, fParam1);
}
...
{
	if (func_100(Global_71445, 0f, 0f, 0f, 0))
	{
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || AI::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_106()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_106(), func_73(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_120()
{
	...
	{
		func_123(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_128(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_179(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_176(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_129(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_130(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_160(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_149();
			}
...
void func_131(int iParam0, int iParam1)
{
	...
	func_170(iParam0, &(Global_106070.f_32605.f_5510));
}
...
var func_149()
{
	...
	func_152(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_151(&uVar0, TIME::GET_CLOCK_MONTH());
	func_150(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_155(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_160(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_100(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_100(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_100(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_163(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_160(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_168(iParam0);
			func_167(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_171(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	return func_188(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
...
void func_192(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_193(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_194(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_244(iVar10, iParam1, iParam2, -1) };
		if (!func_243(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_244(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_244(iVar10, 14, uVar12[iVar1], -1) };
							func_214(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_236(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_204(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_204(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_204(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_236(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_244(iVar10, iVar0, func_203(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_244(iVar10, 14, uVar15[iVar1], -1) };
			func_214(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_236(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_204(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_204(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_204(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_195(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_308(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_244(iParam0, iParam1, iParam2, -1) };
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_308(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_214(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_215(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_204(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_204(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_229(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_229(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_229(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_216(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_216(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_216(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_216(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_236(int iParam0)
{
	...
	{
		func_242(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_238(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_239(iParam2)];
	if (iVar0 != 0)
	{
...
int func_240(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_239(iParam1)];
...
void func_246(int iParam0)
{
	...
	func_247(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_240(func_250(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_240(func_249(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_240(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_253(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_247(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_247(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_247(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_247(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_204(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_308(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_244(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_308(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_308(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_244(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_308(iParam0, 14, iVar4))
										{
											if (!func_200(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_244(iVar0, iVar2, iVar1, -1) };
						if (!func_200(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_204(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_204(iParam1)))
	{
		return 1;
	}
	return 0;
				...
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 22 || Local_68.f_10 == 23)
					{
						...
						else
						{
							...
							{
								if (func_117(iLocal_123, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_109(Local_68.f_9, vLocal_332, 30f))
									{
...
bool func_313(char* sParam0, int iParam1, char* sParam2)
{
...
void func_314(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_61())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_313(sParam2, 0, 0))
				{
		...
		else
		{
			...
			if (iParam6 && !func_61())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_313(sParam1, 0, 0))
				{
...
void func_321()
{
	if (func_22(Local_68.f_9))
	{
		if (((Local_68.f_10 != 32 && Local_68.f_10 != 33) && Local_68.f_10 != 30) && Local_68.f_10 != 31)
		{
			...
			iLocal_142 = GAMEPLAY::GET_GAME_TIMER();
			Local_68.f_10 = 32;
		}
	}
}
...
int func_333(char* sParam0)
{
	if (!func_334(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_320(sParam0)) || func_320("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_334(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_342() || func_341(Global_4456448.f_152990)) || func_340())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_339(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_338(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_335(int iParam0)
{
	if (iParam0 != func_337())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_336(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
	...
	if (func_22(Local_68.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_68.f_10)
			{
				...
				case 3:
					if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
				...
				case 7:
					if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::_0xF1C03A5352243A30(Local_68.f_9);
				...
				case 39:
					if (!func_63(Local_68.f_9, 242628503))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&uLocal_145);
						AI::TASK_GOTO_ENTITY_AIMING(0, PLAYER::PLAYER_PED_ID(), fVar3, 30f);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_145);
						AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_145);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
					}
					break;
				
				case 40:
					if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
				...
				case 13:
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							{
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_68.f_13, 1f, 20000, 0.25f, 512, 40000f);
							}
							AI::TASK_ACHIEVE_HEADING(0, 190f, 0);
							AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_mountain", "base_jump_idle", 4f, -8f, -1, 1, 0f, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_145);
							AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_145);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
				...
				case 16:
					...
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							AI::OPEN_SEQUENCE_TASK(&uLocal_145);
							AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_mountain", "base_jump_spot", 8f, -1.5f, -1, 8, 0f, 0, 0, 0);
							AI::TASK_SKY_DIVE(0, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_145);
							AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_145);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
				...
				case 18:
					...
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (!AI::IS_PED_GETTING_UP(Local_68.f_9))
						{
				...
				case 19:
					...
					if (func_117(Local_68.f_18, 500))
					{
						if (PED::IS_PED_IN_PARACHUTE_FREE_FALL(Local_68.f_9))
						{
							...
							AI::TASK_PARACHUTE_TO_TARGET(Local_68.f_9, vLocal_333);
							Local_68.f_10 = 20;
						}
					}
					break;
				...
				case 20:
					...
					else if (PED::GET_PED_PARACHUTE_STATE(Local_68.f_9) == 2)
					{
						if (!iLocal_106)
						{
							...
							{
								AI::SET_PARACHUTE_TASK_TARGET(Local_68.f_9, vLocal_334);
								iLocal_106 = 1;
							}
						}
					}
				...
				case 22:
					if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
				...
				case 24:
					...
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, 0);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 17, 1);
					PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 173, 1);
					...
					if (func_95(Local_71[0 /*6*/]))
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_109(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_365(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
							...
							else if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
								{
									PED::_0xFE07FF6495D52E2A(Local_68.f_9, vLocal_332);
								...
								AI::TASK_ENTER_VEHICLE(Local_68.f_9, Local_71[0 /*6*/], 25000, -1, 2f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
								Local_68.f_10 = 25;
							}
						}
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					if (!iLocal_108)
					{
						if (!func_61())
						{
							iLocal_122 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_108 = 1;
						}
					}
					else if (!iLocal_86[0])
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_122) > 7500)
						{
							func_387(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_122) > 10000)
						{
							func_387(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 33 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_109(Local_68.f_9, vLocal_332, 25f))
					{
						...
						{
							if (func_117(iLocal_124, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_117(iLocal_123, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_109(Local_68.f_9, vLocal_332, 20f))
							{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_116))
						{
							if (iLocal_97)
							{
								uLocal_116 = func_391(vLocal_331, 5, 1);
							}
						}
						if (!iLocal_83)
						{
		...
		if (Local_69[0 /*20*/].f_14 == 0)
		{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(Local_73[0 /*9*/]))
			{
				...
				else
				{
					...
					{
						AI::TASK_PLAY_ANIM(Local_69[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49, 0f, 0, 0, 0);
					}
					if (!func_63(Local_69[0 /*20*/], -875674219))
					{
						if (func_423(Local_68.f_9))
						{
							AI::TASK_LOOK_AT_ENTITY(Local_69[0 /*20*/], Local_68.f_9, -1, 2060, 3);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_69[0 /*20*/], Local_68.f_9, -1);
						}
					}
				}
			}
...
void func_399()
{
	if (iLocal_139 < 10)
	{
		...
		{
			if (func_117(iLocal_140, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 4000)))
			{
				iLocal_92 = 0;
			}
		}
...
void func_439(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_172(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_442(*iParam1);
				...
				func_440(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_440(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_444(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			...
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_448(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_449(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_465(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			...
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_466(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_337())
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_467(int iParam0)
{
	if (iParam0 != func_337())
	{
		if (func_336(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_445(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_478(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_161(iParam0, iParam1))
				{
...
void func_479(vector3 vParam0, float fParam1, int iParam2)
{
	...
	while (iVar0 < 68)
	{
		if (func_160(&(Global_70024.f_555[0 /*21*/]), iVar0))
		{
...
void func_480(int iParam0)
{
	...
	if (func_160(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_70024.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_166(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_481(0, Global_70024.f_555[0 /*21*/].f_12) || !func_481(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_167(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_481(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_482(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_134(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
{
	return func_484(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_501(uParam0))
	{
		...
		if (func_500(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_486(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_486(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_488(iParam0, Global_70024.f_139[38], 0))
			{
				func_480(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_488(iParam0, Global_70024.f_139[43], 1))
			{
				func_480(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_100(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_489(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_171(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_171(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_171(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_492(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_491())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_171(iVar2 + 1)))
				{
...
bool func_502()
{
	return func_500(&(Global_99633.f_2875));
}

void func_503()
{
	func_504(&(Global_99633.f_2875));
}
...
int func_505(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_507(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_508()
{
	return func_501(&(Global_99633.f_2875));
}
...
void func_512()
{
	if (func_22(Local_68.f_9))
	{
		...
		Local_68.f_10 = 0;
		WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, joaat("gadget_parachute"), 1, 0, 1);
		...
		if (func_22(Local_69[0 /*20*/]))
		{
			AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_69[0 /*20*/], 0);
		}
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_mountain", "excited_idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_mountain", "excited_idle_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_mountain", "excited_idle_c", 8f, -8f, -1, 0, 0f, 0, 0, 0);
		AI::SET_SEQUENCE_TO_REPEAT(uLocal_145, 1);
		AI::CLOSE_SEQUENCE_TASK(uLocal_145);
		AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_145);
		AI::CLEAR_SEQUENCE_TASK(&uLocal_145);
		if (func_22(Local_69[0 /*20*/]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_69[0 /*20*/], Local_69[0 /*20*/].f_5, -1, 1, 1);
			}
...
void func_519()
{
	...
	GAMEPLAY::SET_BIT(&(Local_74[0 /*7*/].f_6), 3);
	GAMEPLAY::SET_BIT(&(Local_74[0 /*7*/].f_6), 4);
	GAMEPLAY::SET_BIT(&(Local_74[0 /*7*/].f_6), 1);
	iLocal_131 = 1;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_534()) || Global_25461) || func_540()) || func_88(8, -1)) || func_532()) || func_539()) || func_538()) || func_533()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_534()) || Global_105117) || Global_25461) || func_540()) || func_88(8, -1)) || func_532()) || func_539()) || func_538()) || func_533()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_534()) || Global_105117) || Global_25461) || func_540()) || func_88(8, -1)) || func_539()) || func_538()) || func_533()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_534() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_533()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_534()) || Global_25461) || func_540()) || func_88(8, -1)) || func_538()) || func_532()) || func_533()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_534()) || func_538()) || Global_105117) || Global_25461) || func_540()) || Global_37271) || func_88(8, -1)) || func_532()) || func_537()) || func_533()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_534()) || Global_105117) || Global_25461) || func_540()) || func_88(8, -1)) || func_532()) || func_537()) || func_539()) || func_538()) || func_533())
						{
							return 0;
						}
						break;
...
{
	return func_542(iParam0, Global_36117);
}
...
int func_552()
{
	...
	iVar0 = func_553(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_556()
{
	...
	{
		if (func_546(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
