				...
				case 13:
					if ((!PED::IS_PED_FALLING(Local_68.f_9) && !PED::IS_PED_RAGDOLL(Local_68.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0))
					{
						if (func_117(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							{
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_68.f_13, 1f, 20000, 0.25f, 512, 1193033728);
							}
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(iLocal_116))
						{
							if (iLocal_97)
							{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_100(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
