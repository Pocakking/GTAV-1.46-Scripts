...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_84))
		{
			UI::REMOVE_BLIP(&iLocal_84);
		}
		if (UI::DOES_BLIP_EXIST(iLocal_85))
		{
			UI::REMOVE_BLIP(&iLocal_85);
		}
		if (UI::DOES_BLIP_EXIST(iLocal_86))
		{
			UI::REMOVE_BLIP(&iLocal_86);
		}
...
void func_2(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_7(PLAYER::PLAYER_ID())) && !func_4(PLAYER::PLAYER_ID(), 0)) && !func_3()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_7(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_12()
{
	if (iLocal_102 == -1)
	{
		iLocal_102 = GAMEPLAY::GET_GAME_TIMER() + 5000;
	}
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_102)
	{
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_68[0 /*5*/]))
		{
			...
			while (iVar0 < Local_68)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], true));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_68[iVar0 /*5*/], vVar1, true);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_61 == 1)
	{
		...
		fVar7 = (SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_63)) / fLocal_69);
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_60[iVar0 /*5*/].f_4) > 1000)
			{
				GRAPHICS::FADE_DECALS_IN_RANGE(Local_60[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_60[iVar0 /*5*/].f_4) > 6000)
			{
...
void func_16(vector3 vParam0, int iParam1)
{
	...
	Local_60[iLocal_65 /*5*/].f_4 = GAMEPLAY::GET_GAME_TIMER();
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (CONTROLS::IS_CONTROL_PRESSED(0, 24) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_54 == 0)
				{
					...
					iLocal_54 = GAMEPLAY::GET_GAME_TIMER() + 250;
				}
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_54)
				{
					if (!bLocal_44)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_68)
						{
							if (UI::DOES_BLIP_EXIST(Local_68[iVar0 /*5*/].f_3))
							{
								fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_57, UI::GET_BLIP_COORDS(Local_68[iVar0 /*5*/].f_3), true);
								fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_68[iVar0 /*5*/], UI::GET_BLIP_COORDS(Local_68[iVar0 /*5*/].f_3), true);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_50 != -1)
							{
								if (GAMEPLAY::ABSI((iLocal_51 - iVar5)) > 1)
								{
									iLocal_51 = -1;
								}
								if (iLocal_51 == -1)
								...
								if (GAMEPLAY::ABSI((iLocal_51 - iVar5)) < 3 && GAMEPLAY::ABSI((iLocal_51 - iVar5)) > 0)
								{
									if (iLocal_51 < iVar5)
									{
										iVar6 = iLocal_51;
										while (iVar6 <= (iVar5 - 1))
										{
											if (UI::DOES_BLIP_EXIST(Local_68[iVar6 /*5*/].f_3))
											{
												if (UI::GET_BLIP_ALPHA(Local_68[iVar6 /*5*/].f_3) > 0)
												{
													UI::SET_BLIP_ALPHA(Local_68[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (UI::DOES_BLIP_EXIST(Local_68[iVar5 /*5*/].f_3))
									{
										if (UI::GET_BLIP_ALPHA(Local_68[iVar5 /*5*/].f_3) > 0)
										{
											UI::SET_BLIP_ALPHA(Local_68[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	switch (iLocal_71)
	{
		case 0:
			...
			if (Local_283.f_32 <= 0)
			{
				Local_283.f_32 = GAMEPLAY::GET_FRAME_COUNT();
			}
			...
			if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && func_98(&Local_283))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_80, 0))
				{
					...
					AI::TASK_PLAY_ANIM(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
					...
					DECISIONEVENT::SET_DECISION_MAKER(iLocal_78, -1143637011);
					DECISIONEVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, 24);
					DECISIONEVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, 46);
					DECISIONEVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, 61);
					DECISIONEVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, 136);
					DECISIONEVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(-1143637011, 55);
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!iLocal_92)
				{
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						...
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_80, false);
							AI::CLEAR_PED_TASKS(iLocal_78);
							AI::OPEN_SEQUENCE_TASK(&iLocal_107);
							...
							AI::CLEAR_SEQUENCE_TASK(&iLocal_107);
							func_89();
						}
				...
				else
				{
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_80, 0) && !UI::DOES_BLIP_EXIST(iLocal_85))
							{
								iLocal_85 = func_90(iLocal_80, 0, 0);
							}
						}
						else if (!UI::DOES_BLIP_EXIST(iLocal_84))
						{
							if (UI::DOES_BLIP_EXIST(iLocal_85))
							{
								UI::REMOVE_BLIP(&iLocal_85);
					...
					if (iLocal_103 >= 3)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("bulldozer")))
						{
							if (UI::DOES_BLIP_EXIST(iLocal_86))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_78) && !ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
								{
									if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, 0) && !UI::DOES_BLIP_EXIST(iLocal_85))
									{
										iLocal_85 = func_90(iLocal_80, 0, 0);
									}
								}
...
void func_42()
{
	switch (iLocal_103)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 3000)
				{
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 5000 && !func_23())
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, 0))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_81, 0))
						{
							...
							else if (!UI::DOES_BLIP_EXIST(iLocal_86))
							{
								iLocal_86 = func_90(iLocal_81, 0, 0);
								if (UI::DOES_BLIP_EXIST(iLocal_85))
								{
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 8000)
			{
				if (!func_23())
				{
...
void func_43()
{
	switch (iLocal_99)
	{
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_105) > iLocal_73 || func_45())
			{
				...
				GAMEPLAY::CREATE_INCIDENT(3, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_278, 0, 0);
				SYSTEM::SETTIMERA(0);
				iLocal_99 = 3;
			}
			break;
...
void func_46()
{
	...
	switch (iLocal_98)
	{
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 500 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, 0))
				{
					iLocal_73 = 0;
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_80, 0))
					{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, false, true, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, false, true, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 10000)
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(iLocal_80, false);
		...
		case 5:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_78))
				{
					...
					DECISIONEVENT::SET_DECISION_MAKER(iLocal_78, -455129387);
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					AI::OPEN_SEQUENCE_TASK(&iLocal_107);
					AI::TASK_PLAY_ANIM(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(iLocal_107, 1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_107);
					AI::TASK_PERFORM_SEQUENCE(iLocal_78, iLocal_107);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_107);
				}
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 6400)
				{
					...
					AI::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_PICNIC", vVar0, 304.8172f, 0, 1, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_107);
					AI::TASK_PERFORM_SEQUENCE(iLocal_78, iLocal_107);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_107);
...
int func_82()
{
	switch (func_83(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_91()
{
	...
	switch (iLocal_72)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_75, 50f, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_75, 30f, 0, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_75, 100f, 0);
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 3500)
			{
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_78);
					AI::TASK_LOOK_AT_COORD(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 1500)
			{
		...
		case 3:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 500)
			{
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 2000)
			{
				func_92(iLocal_276);
				func_92(iLocal_277);
		...
		case 6:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 500)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_78))
				{
					AI::TASK_LOOK_AT_COORD(iLocal_78, ENTITY::GET_ENTITY_COORDS(iLocal_78, true) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_72 = 7;
			}
		...
		case 7:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 2200 && !iLocal_96)
			{
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_104) > 2500)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_80, 0))
				{
		...
		case 8:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_80, 0))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_75, 50f, 0);
			}
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				AI::CLEAR_PED_TASKS(iLocal_78);
...
void func_109()
{
	...
	if (func_98(&Local_283))
	{
		...
		GAMEPLAY::CLEAR_AREA(vLocal_75, 10f, 1, 0, 0, false);
		iLocal_88[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(1668676931, -453.2f, -986.1f, 59.45f, true, true, false);
...
int func_128()
{
	if ((Global_106059 == func_68() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
...
int func_132(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_168(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_146(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_149()
{
	...
	func_155(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_154(&uVar0, TIME::GET_CLOCK_MINUTES());
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_166()) || Global_105117) || Global_25461) || func_165()) || func_37(8, -1)) || func_164()) || func_163()) || func_162()) || func_161()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_166()) || Global_25461) || func_165()) || func_37(8, -1)) || func_162()) || func_164()) || func_163()) || func_161()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_166()) || Global_105117) || Global_25461) || func_165()) || func_37(8, -1)) || func_164()) || func_163()) || func_161()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_166() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_37(8, -1)) || func_161()) || func_160()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_166()) || Global_25461) || func_165()) || func_37(8, -1)) || func_163()) || func_162()) || func_161()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_166()) || func_163()) || Global_105117) || Global_25461) || func_165()) || Global_37271) || func_37(8, -1)) || func_162()) || func_160()) || func_161()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_166()) || Global_105117) || Global_25461) || func_165()) || func_37(8, -1)) || func_162()) || func_160()) || func_164()) || func_163()) || func_161())
						{
							return 0;
						}
						break;
