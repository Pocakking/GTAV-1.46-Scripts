	...
	switch (iLocal_59)
	{
		...
		case 1:
			if (!CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				UI::SET_TEXT_RENDER_ID(iLocal_53);
				GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_51, 0.2f, 0.34f, 0.410001f, 0.69f, 100, 100, 100, 255, 0);
				UI::SET_TEXT_RENDER_ID(iLocal_54);
				if (bLocal_55)
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_52, "SET_TEXT");
					func_3("KEYNOTE_NAME");
...
void func_4()
{
	...
	while (iVar1 <= (16 - 1))
	{
		if (Local_22[iVar1] != -1)
		{
			if ((!GAMEPLAY::IS_BIT_SET(iLocal_39, iVar1) && iVar0 >= Local_22[iVar1]) && iVar0 < Local_22.f_17[iVar1])
			{
				func_5();
				GAMEPLAY::SET_BIT(&iLocal_39, iVar1);
			}
		}
		iVar1++;
	}
...
void func_8(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_13(PLAYER::PLAYER_ID())) && !func_10(PLAYER::PLAYER_ID(), 0)) && !func_9()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_13(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_18(bool bParam0)
{
	...
	iLocal_53 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("Big_Disp");
	iLocal_54 = UI::GET_DEFAULT_SCRIPT_RENDERTARGET_RENDER_ID();
...
{
	uParam0->f_22 = 0;
	GAMEPLAY::CLEAR_BIT(&uLocal_47, iParam1);
...
{
	uParam0->f_22 = 0;
	GAMEPLAY::CLEAR_BIT(&uLocal_45, iParam1);
	if (iParam1 == 0 && uParam0->f_22 == 0)
	{
	}
}
...
void func_23(var uParam0, int iParam1)
{
	...
	func_28(uParam0);
	GAMEPLAY::CLEAR_BIT(&uLocal_43, iParam1);
	switch (iParam1)
	{
		case 0:
...
void func_33(int iParam0, int iParam1)
{
	...
	*iParam0 = PED::ADD_SCENARIO_BLOCKING_AREA(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	AI::SET_SCENARIO_TYPE_ENABLED("DRIVE", false);
...
void func_34(bool bParam0)
{
	...
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(6, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(7, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(8, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(9, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(10, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(11, bParam0);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(12, bParam0);
}
...
void func_43(int iParam0)
{
	...
	AI::SET_SCENARIO_TYPE_ENABLED("DRIVE", true);
