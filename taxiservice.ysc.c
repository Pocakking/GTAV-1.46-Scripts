...
void __EntryFunction__()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	iLocal_44 = UI::_0x4A9923385BDB9DAD();
	iLocal_45 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	...
	iLocal_105 = -1;
	iLocal_106 = -1;
	sLocal_107 = CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 195, true);
	...
	else
	{
		if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		{
			if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
			{
				...
				PED::SET_PED_KEEP_TASK(Global_105102, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105102, false);
			}
		}
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				{
					if (PED::IS_PED_IN_VEHICLE(iVar2, Global_105101, 0))
					{
						AI::TASK_LEAVE_VEHICLE(iVar2, Global_105101, 64);
					}
				}
			}
			if (iVar0 > 1)
					...
					if (func_52(func_53()) >= iLocal_101)
					{
						if (bLocal_65)
						{
							if (iLocal_101 > 0)
							{
								...
								func_42(Global_105102, &iLocal_805);
...
Vector3 func_45(int iParam0)
{
	...
	{
		iVar4 = UI::GET_BLIP_INFO_ID_PICKUP_INDEX(iParam0);
		...
		switch (iLocal_808)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105102, Global_105101))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_idle", 3))
						{
			...
			case 1:
				...
				func_168(&Global_105101, iLocal_826);
				if (func_167())
				{
	...
	if (!func_214())
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_112))
		{
			if (iLocal_808 != 0)
			{
				...
				if (!GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_107, sVar0))
				{
					sLocal_107 = sVar0;
					iLocal_58 = 1;
				}
...
void func_62(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < uParam2->f_680)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_66(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_66(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_66(CONTROLS::_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
	...
	switch (iLocal_810)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT() && AUDIO::IS_AUDIO_SCENE_ACTIVE("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_105101, false);
				}
				UI::CLEAR_PRINTS();
		...
		case 3:
			if (Global_71221 == -1)
			{
				...
				func_113();
				func_112();
				GAMEPLAY::CLEAR_AREA(Global_105108, 5f, 1, 0, 0, false);
				func_108(1097859072);
				if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					ENTITY::SET_ENTITY_COORDS(Global_105101, Global_105108, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(Global_105101, Global_105114);
					ENTITY::FREEZE_ENTITY_POSITION(Global_105101, true);
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
				STREAMING::NEW_LOAD_SCENE_STOP();
				GAMEPLAY::CLEAR_AREA(Global_105108, 5000f, 1, 0, 0, false);
		...
		case 6:
			...
			{
				bVar1 = true;
				if (Global_84115[iLocal_802 /*34*/].f_13 == -1 && Global_84115[iLocal_802 /*34*/].f_14 == -1)
				{
					bVar1 = false;
				}
				if (bVar1)
				{
					if (((func_53() == 0 && !GAMEPLAY::IS_BIT_SET(Global_84115[iLocal_802 /*34*/].f_15, 8)) || (func_53() == 1 && !GAMEPLAY::IS_BIT_SET(Global_84115[iLocal_802 /*34*/].f_15, 9))) || (func_53() == 2 && !GAMEPLAY::IS_BIT_SET(Global_84115[iLocal_802 /*34*/].f_15, 10)))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					if (func_100(Global_84115[iLocal_802 /*34*/].f_13, Global_84115[iLocal_802 /*34*/].f_14))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					TIME::ADVANCE_CLOCK_TIME_TO(Global_84115[iLocal_802 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Global_105101, false);
					ENTITY::SET_ENTITY_HEADING(Global_105101, Global_105114);
					ENTITY::SET_ENTITY_COORDS(Global_105101, Global_105108, 1, false, 0, 1);
		...
		case 8:
			if (func_155(iLocal_89, 500))
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_105101, true);
				}
				if (!func_77())
				{
		...
		case 9:
			...
			{
				if (((!Global_90255 && iLocal_802 != -1) && iLocal_802 != 72) && iLocal_802 != 87)
				{
					func_106(iLocal_802);
				}
				func_156(0);
...
void func_78()
{
	...
	switch (iLocal_803)
	{
		case 92:
			vVar0 = { func_80(229, 0) };
			fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Global_105108, vVar0, true);
			if (fVar1 < 100f)
			{
				vVar0 = { func_79(Global_105108 - vVar0) };
				vVar0 = { (Global_105108 + (vVar0.x * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), (Global_105108.f_1 + (vVar0.y * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), Global_105108.f_2 };
...
float func_84(int iParam0)
{
	if (func_89(iParam0))
	{
		...
		{
			return (func_85(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_85(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_108(float fParam0)
{
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_105108, iVar2, &vVar3, 1, 3f, 0f))
			{
				iVar2++;
			}
		}
...
int func_109(int iParam0, vector3 vParam1, float fParam2)
{
	int iVar0[5];
	int iVar1;
...
void func_113()
{
	...
	fVar0 = func_116(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_105108);
	if (bLocal_64)
	{
...
float func_116(vector3 vParam0, vector3 vParam1)
{
...
void func_117()
{
	...
	fVar0 = (((func_116(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_105108) / 50f) * fLocal_73) * 2.4f);
...
void func_118()
{
	iLocal_103 = (iLocal_103 + SYSTEM::ROUND((GAMEPLAY::GET_FRAME_TIME() * 1000f)));
	if (iLocal_103 > 5000)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
	}
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_820, false) > 50f)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
	...
	if (iLocal_101 != iLocal_102)
	{
		...
		GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		fLocal_83 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_105108);
...
void func_119()
{
	...
	if (!func_37(14))
	{
		fVar1 = PATHFIND::CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINTS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_105108);
...
int func_121(int iParam0, var uParam1, float fParam2)
{
	vector3 vVar0;
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_807)
		{
			...
			case 2:
				...
				{
					if (func_122(&Global_105101, ENTITY::GET_ENTITY_COORDS(Global_105101, false), vLocal_816, uParam1, fParam2, &iLocal_88, 1000))
					{
						iLocal_807 = 3;
						return 1;
					}
...
int func_122(var uParam0, vector3 vParam1, vector3 vParam2, var uParam3, float fParam4, int iParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
					...
					if (PATHFIND::GET_CLOSEST_ROAD(*uParam3, 1f, 1, &uVar4, &uVar3, &iVar8, &iVar7, &fVar10, iVar15))
					{
						...
						if (func_123(vParam2, *uParam3) || fVar11 < 0.5f)
						{
							*uParam3 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam3, *fParam4, fVar9, 0f, 0f) };
							...
							if (!GAMEPLAY::IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(*uParam3, 3f, 3f, 3f, iVar5))
							{
...
int func_123(vector3 vParam0, vector3 vParam1)
{
	float fVar0;
	float fVar1;
...
int func_124(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
...
void func_125(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_126(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_128(vector3 vParam0, var uParam1, float fParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2[6];
...
bool func_129(vector3 vParam0, vector3 vParam1, float fParam2)
{
	return SYSTEM::VDIST2(vParam0, vParam1) <= (fParam2 * fParam2);
}

float func_130(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
...
bool func_133(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
...
int func_134(vector3 vParam0, int iParam1, int iParam2, bool bParam3)
{
	vector3 vVar0[15];
	vector3 vVar1[15];
	float fVar2[15];
...
int func_138(vector3 vParam0, vector3 vParam1, vector3 vParam2)
{
...
int func_139(vector3 vParam0, var uParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar4 < 63)
	{
		*iParam1 = iVar4;
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[*iParam1 /*6*/], 0) && !GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[*iParam1 /*6*/], 3))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Var5.f_26, func_150()))
			{
				vVar3 = { Var5.f_6 };
				if (uParam0->f_2 == 1f)
				{
...
int func_151(var uParam0, int iParam1, float fParam2)
{
	...
	while (iVar4 < 8)
	{
		if (Global_90260[iVar4 /*17*/])
		{
			if (Global_90260[iVar4 /*17*/].f_9 != 263)
			{
				if (UI::DOES_BLIP_EXIST(Global_25834[Global_90260[iVar4 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = { UI::GET_BLIP_COORDS(Global_25834[Global_90260[iVar4 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
					...
					if (fVar2 < fVar1)
					{
						if (fVar2 < Global_90260[iVar4 /*17*/].f_10.f_2)
						{
							fVar1 = fVar2;
							iVar0 = iVar4;
						}
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!PED::IS_PED_INJURED(iVar2))
				{
					if (!PED::IS_PED_SITTING_IN_VEHICLE(iVar2, Global_105101))
					{
						iVar3 = 0;
						if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_105101, iVar3, 0))
						{
							...
							{
								AI::CLEAR_PED_TASKS(iVar2);
								PED::SET_PED_INTO_VEHICLE(iVar2, Global_105101, iVar3);
							}
						}
						else
						{
...
void func_163()
{
	...
	if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105102, Global_105101))
		{
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(Global_105101, true) };
				fVar1 = ENTITY::GET_ENTITY_HEADING(Global_105101);
				AI::TASK_VEHICLE_PARK(Global_105102, Global_105101, vVar0, fVar1, 3, 60f, 0);
			}
		}
	}
}
		...
		if (bLocal_61)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
			{
				if (!PED::IS_PED_INJURED(Global_105102))
				{
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_idle", 3))
					{
						if (PED::IS_PED_HEADTRACKING_PED(Global_105102, PLAYER::PLAYER_PED_ID()))
						{
							AI::TASK_CLEAR_LOOK_AT(Global_105102);
						}
						AI::TASK_PLAY_ANIM(Global_105102, &cLocal_811, "leanover_exit", 4f, -4f, -1, 0, 0f, 0, 0, 0);
					}
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_exit", 3))
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(Global_105102, &cLocal_811, "leanover_exit", 1.2f);
						iLocal_90 = GAMEPLAY::GET_GAME_TIMER();
						func_168(&Global_105101, iLocal_826);
					}
					else if (!func_2(Global_105102, 242628503))
					{
						if (func_165(&iLocal_90, iLocal_826))
						{
							if (!func_2(Global_105102, -2118855366))
							{
								AI::TASK_VEHICLE_TEMP_ACTION(Global_105102, Global_105101, 1, 1000000);
						...
						else
						{
							...
							AI::OPEN_SEQUENCE_TASK(&iLocal_800);
							AI::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_105101, Global_105108, fVar1, iVar0, 45f);
							AI::TASK_VEHICLE_PARK(0, Global_105101, Global_105108, Global_105114, iLocal_110, 60f, 1);
							AI::CLOSE_SEQUENCE_TASK(iLocal_800);
							AI::TASK_PERFORM_SEQUENCE(Global_105102, iLocal_800);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_800);
						}
					}
				}
			}
...
int func_166()
{
	if ((ENTITY::IS_ENTITY_AT_COORD(Global_105101, Global_105108, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_808 == 4)
	{
		iLocal_56 = 1;
	...
	if (!PED::IS_PED_INJURED(Global_105102) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105102, Global_105101))
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_811))
			{
				...
				AI::OPEN_SEQUENCE_TASK(&iLocal_800);
				AI::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_enter", 4f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_idle", 4f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_800);
				AI::TASK_PERFORM_SEQUENCE(Global_105102, iLocal_800);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_800);
				return 1;
...
int func_170()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105101))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
		{
			iLocal_109 = OBJECT::CREATE_OBJECT(iLocal_108, ENTITY::GET_ENTITY_COORDS(Global_105101, true), true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_109, Global_105101, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_105101, "Chassis"), vLocal_824, vLocal_825, 0, 0, 0, 0, 2, 1);
			VEHICLE::SET_TAXI_LIGHTS(Global_105101, 0);
			if (!UI::IS_NAMED_RENDERTARGET_REGISTERED("taxi"))
			{
				UI::REGISTER_NAMED_RENDERTARGET("taxi", 0);
				UI::LINK_NAMED_RENDERTARGET(ENTITY::GET_ENTITY_MODEL(iLocal_109));
			}
			iLocal_93 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("taxi");
		}
	}
	return 0;
}
...
void func_172()
{
	...
	if (!CAM::DOES_CAM_EXIST(iLocal_68))
	{
		if (!func_180() && !func_179(8, -1))
		{
			...
			CAM::ATTACH_CAM_TO_ENTITY(iLocal_68, Global_105101, vLocal_822, 1);
			func_176();
...
void func_176()
{
	if (CAM::DOES_CAM_EXIST(iLocal_68))
	{
		func_177(Global_105101, &iLocal_68, vLocal_823);
...
void func_177(int iParam0, int iParam1, vector3 vParam2)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (CAM::DOES_CAM_EXIST(*iParam1))
		{
			...
			fVar3 = vVar0.y;
			vVar4 = { func_79(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_105101, vParam2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_105101, vLocal_822)) };
			func_178(vVar4, &fVar1, &fVar2, 1);
			CAM::SET_CAM_ROT(*iParam1, fVar1, fVar3, fVar2, 2);
		}
	}
}

void func_178(vector3 vParam0, var uParam1, var uParam2, int iParam3)
{
	float fVar0;
...
void func_181()
{
	...
	while (iVar0 < iLocal_91)
	{
		if (!UI::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
		{
		}
		else if (func_186(vLocal_806[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_126(UI::GET_BLIP_COORDS(vLocal_806[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar0);
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(UI::GET_BLIP_SPRITE(vLocal_806[iVar0 /*3*/]));
			UI::GET_HUD_COLOUR(UI::GET_BLIP_HUD_COLOUR(vLocal_806[iVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			...
			iVar6 = func_184(vLocal_806[iVar0 /*3*/]);
			if (iVar6 == -1)
			{
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("STRING");
				UI::ADD_TEXT_COMPONENT_SUBSTRING_BLIP_NAME(vLocal_806[iVar0 /*3*/]);
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			}
			else
			{
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("STRING");
				UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_182(iVar6));
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			}
			if (UI::GET_BLIP_INFO_ID_TYPE(vLocal_806[iVar0 /*3*/]) == 2)
			{
				if (!PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(UI::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/]))))
				{
					vVar5 = { ENTITY::GET_ENTITY_COORDS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(UI::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/])), true) };
				}
			}
			else if (UI::GET_BLIP_INFO_ID_TYPE(vLocal_806[iVar0 /*3*/]) == 1)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(UI::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/]), 0))
				{
					vVar5 = { ENTITY::GET_ENTITY_COORDS(UI::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/]), true) };
				}
			}
			else
			{
				vVar5 = { UI::GET_BLIP_COORDS(vLocal_806[iVar0 /*3*/]) };
			}
			...
			if (vLocal_806[iVar0 /*3*/].f_2 == 0)
			{
				if (vLocal_806[iVar0 /*3*/].f_1 != 0)
				{
					...
					UI::_ADD_TEXT_COMPONENT_SUBSTRING_LOCALIZED(vLocal_806[iVar0 /*3*/].f_1);
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				}
			}
			else
			{
				...
				UI::_ADD_TEXT_COMPONENT_SUBSTRING_LOCALIZED(vLocal_806[iVar0 /*3*/].f_1);
				UI::_ADD_TEXT_COMPONENT_SUBSTRING_LOCALIZED(vLocal_806[iVar0 /*3*/].f_2);
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			}
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			if (bLocal_60)
...
void func_187()
{
	...
	iLocal_91 = 0;
	func_204();
	func_191(iLocal_44, 0);
	func_191(iLocal_45, 0);
	func_191(32, 0);
	func_191(143, 0);
	func_191(144, 0);
	func_191(145, 0);
	...
	func_191(117, 1);
	iLocal_94 = func_188();
	iLocal_95 = UI::GET_NUMBER_OF_ACTIVE_BLIPS();
		...
		if (iLocal_94 == 0)
		{
			if (UI::DOES_BLIP_EXIST(Global_105105))
			{
				...
				while (iVar0 < 40)
				{
					if (UI::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
					{
						if (vLocal_806[iVar0 /*3*/] == Global_105105)
						{
							iLocal_92 = iVar0;
							iVar0 = 40;
						}
	...
	if (GAMEPLAY::GET_MISSION_FLAG())
	{
		if (!Global_105107 == -1)
		{
			...
			while (iVar0 < 40)
			{
				if (UI::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
				{
					if (func_186(vLocal_806[iVar0 /*3*/]) == Global_105107)
					{
						iLocal_92 = iVar0;
						iVar0 = 40;
					}
...
int func_188()
{
	...
	iVar0 = 0;
	iVar1 = UI::GET_FIRST_BLIP_INFO_ID(iLocal_44);
	while (UI::DOES_BLIP_EXIST(iVar1))
	{
		...
		iVar1 = UI::GET_NEXT_BLIP_INFO_ID(iLocal_44);
	}
	iVar1 = UI::GET_FIRST_BLIP_INFO_ID(iLocal_45);
	while (UI::DOES_BLIP_EXIST(iVar1))
	{
		if (func_190(iVar1))
		{
		...
		iVar1 = UI::GET_NEXT_BLIP_INFO_ID(iLocal_45);
	}
	return iVar0;
}
...
void func_191(int iParam0, bool bParam1)
{
	...
	iVar2 = UI::GET_FIRST_BLIP_INFO_ID(iParam0);
	iVar3 = 20;
	while (UI::DOES_BLIP_EXIST(iVar2))
	{
			...
			if (func_190(iVar2))
			{
				if (func_203(iVar2))
				{
					if (!func_201(&iVar2))
					{
						...
						{
							if (func_186(iVar2) == iLocal_44)
							{
								if (!Global_105104 == iVar2)
								{
									bVar1 = false;
								}
							}
						...
						if (bVar1)
						{
							...
							if (func_190(iVar2))
							{
								iVar4 = UI::GET_BLIP_INFO_ID_TYPE(iVar2);
		...
		iLocal_98++;
		iVar2 = UI::GET_NEXT_BLIP_INFO_ID(iParam0);
	}
}

void func_192(vector3 vParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 40)
	{
		if (func_186(vLocal_806[iVar0 /*3*/]) == func_186(vParam0.x))
		{
			iVar1 = iVar0;
			iVar0 = 40;
		}
	...
	while (iVar0 < 40)
	{
		...
		if (iVar0 < iLocal_91)
		{
			if (func_186(vLocal_806[iVar0 /*3*/]) == func_186(vParam0.x))
			{
				if (func_196(vParam0, vLocal_806[iVar0 /*3*/]))
				{
					if (bParam1)
					{
...
void func_193(vector3 vParam0, int iParam1)
{
	func_194(iParam1);
	vLocal_806[iParam1 /*3*/] = { vParam0 };
	if (func_186(vLocal_806[iParam1 /*3*/]) == UI::_GET_BLIP_INFO_ID_ITERATOR())
	{
		iLocal_97 = iParam1;
		vLocal_821 = { UI::GET_BLIP_COORDS(vLocal_806[iParam1 /*3*/]) };
	}
}
...
void func_195(vector3 vParam0, int iParam1)
{
	vLocal_806[iParam1 /*3*/] = { vParam0 };
	if (func_186(vLocal_806[iParam1 /*3*/]) == UI::_GET_BLIP_INFO_ID_ITERATOR())
	{
...
int func_196(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5)
{
	if (func_197(iParam0) < func_197(iParam3))
	{
		return 1;
	}
	return 0;
...
float func_197(int iParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (UI::DOES_BLIP_EXIST(iParam0))
		{
			vVar0 = { func_45(iParam0) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
		}
	}
...
int func_199(int iParam0)
{
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		iVar0 = UI::GET_BLIP_HUD_COLOUR(*iParam0);
...
int func_201(int iParam0)
{
	...
	if (func_202(UI::GET_BLIP_COORDS(*iParam0), 0f, 0f, 0f, 0))
	{
		return 1;
	}
...
int func_203(int iParam0)
{
	...
	if (!func_186(iParam0) == iLocal_44)
	{
		fVar0 = func_197(iParam0);
		if (fVar0 > 50f)
		{
			return 1;
		}
...
bool func_205()
{
	...
	bVar0 = false;
	if (!UI::DOES_BLIP_EXIST(vLocal_806[iLocal_92 /*3*/]))
	{
	...
	if (SYSTEM::TIMERB() > 250)
	{
		if (!bVar0)
		{
			if (iLocal_95 != UI::GET_NUMBER_OF_ACTIVE_BLIPS())
			{
				bVar0 = true;
			}
			iLocal_95 = UI::GET_NUMBER_OF_ACTIVE_BLIPS();
			if (iLocal_96 != func_206())
			{
				bVar0 = true;
			}
			iLocal_96 = func_206();
		...
		if (!bVar0)
		{
			if (iLocal_97 != -1)
			{
				if (UI::DOES_BLIP_EXIST(vLocal_806[iLocal_97 /*3*/]))
				{
					if (func_186(vLocal_806[iLocal_97 /*3*/]) == UI::_GET_BLIP_INFO_ID_ITERATOR())
					{
						vVar1 = { UI::GET_BLIP_COORDS(vLocal_806[iLocal_97 /*3*/]) };
				...
				{
					iVar2 = UI::GET_FIRST_BLIP_INFO_ID(UI::_GET_BLIP_INFO_ID_ITERATOR());
					if (UI::DOES_BLIP_EXIST(iVar2))
					{
						vVar1 = { UI::GET_BLIP_COORDS(iVar2) };
						if (!func_126(vVar1, vLocal_821, 1056964608, 0))
						{
							bVar0 = true;
						}
...
void func_207()
{
	if (iLocal_808 != 0)
	{
		UI::SET_TEXT_RENDER_ID(iLocal_93);
			...
			if (iLocal_808 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 179))
					{
						...
						if (!PED::IS_PED_INJURED(Global_105102))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_enter", 3))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_idle", 3))
								{
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_exit", 3))
									{
										AI::CLEAR_PED_TASKS(Global_105102);
									}
								}
...
void func_210()
{
	...
	if (UI::DOES_BLIP_EXIST(vLocal_806[iLocal_92 /*3*/]))
	{
		vVar0 = { UI::GET_BLIP_COORDS(vLocal_806[iLocal_92 /*3*/]) };
		if (!func_211(vVar0))
		{
			UI::LOCK_MINIMAP_POSITION(vVar0.x, vVar0.y);
		}
...
int func_223(int iParam0)
{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()) != iLocal_71)
	{
		return 1;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Global_105101))
	...
	if (iLocal_808 != 4)
	{
		...
		vVar0 = { ENTITY::GET_ENTITY_COORDS(Global_105101, false) };
		...
		if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar2, vVar3, 1))
		{
			return 1;
		}
	}
...
int func_225()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		iLocal_95 = UI::GET_NUMBER_OF_ACTIVE_BLIPS();
		if (func_229(&iVar0, func_231(), func_230()))
		{
			...
			if (func_227(&iVar0, &iVar1, 1))
			{
				vLocal_819 = { ENTITY::GET_ENTITY_COORDS(Global_105101, true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				vLocal_819.z = 0f;
				fLocal_72 = SYSTEM::VMAG(vLocal_819);
				iLocal_71 = func_56(PLAYER::PLAYER_PED_ID());
				func_226();
				iLocal_96 = func_206();
				iLocal_58 = 1;
				CONTROLS::DISABLE_CONTROL_ACTION(0, 75, 1);
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, 0))
		{
			if (!PED::IS_PED_INJURED(*iParam1))
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(*iParam1, *iParam0))
				{
					...
					if (bParam2)
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_105102, true, 1);
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_105101, true, 1);
					...
					else
					{
						...
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_105102, true, 0);
						}
						if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_105101))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_105101, true, 0);
							StringCopy(&Global_105132, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
						}
					}
					...
					VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_105101, false, 0);
...
void func_228()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105102))
	{
		if (!PED::IS_PED_INJURED(Global_105102))
		{
			PED::SET_PED_CONFIG_FLAG(Global_105102, 251, false);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105102, false);
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(Global_105102, Global_105101))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Global_105102, -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(Global_105102, -258271821) != 0)
								{
									...
									AI::TASK_PERFORM_SEQUENCE(Global_105102, iVar0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105102))
	{
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_105102))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_105102, 0))
			{
				if (!PED::IS_PED_INJURED(Global_105102))
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Global_105102, false, 1);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105102, false);
				}
		...
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_105101))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_105101, 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_105101, 0))
				{
					...
					VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_105101, true, 0);
...
void func_232(bool bParam0)
{
	...
	if (func_233(Global_105102))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_enter", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_105102, "leanover_enter", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_idle", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_105102, "leanover_idle", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_811, "leanover_exit", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_105102, "leanover_exit", &cLocal_811, -2f);
		}
		if (PED::IS_PED_HEADTRACKING_PED(Global_105102, PLAYER::PLAYER_PED_ID()))
		{
			AI::TASK_CLEAR_LOOK_AT(Global_105102);
