...
void __EntryFunction__()
{
	...
	GAMEPLAY::_SET_WEATHER_TYPE_OVER_TIME("EXTRASUNNY", 30f);
	func_268();
	if (!func_267())
	{
		iLocal_28 = 0;
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("M_ThePortOfLSHeistPrep2B", 0);
		func_266();
		func_260();
		func_259();
		func_258();
...
{
	func_6(&(Global_99633.f_2875), vParam0, fParam1);
}
...
{
	if (func_8(Global_71445, 0f, 0f, 0f, 0))
	{
...
void func_13(int iParam0)
{
	...
	if (Global_106070.f_9057 || func_27(0))
	{
		iVar0 = func_26();
		if (!func_14(iVar0))
		{
...
int func_14(int iParam0)
{
	...
	func_15(&(Global_106070.f_2355.f_539), iVar1);
...
void func_15(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_17(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
	...
	if (iLocal_54 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				...
				{
					AI::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
...
void func_31(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_27(0) && Global_71451.f_1 == 1) && func_32(Global_71451))
		{
		}
		else
		{
...
void func_36()
{
	...
	{
		case 2:
			GAMEPLAY::CLEAR_AREA(-1588.1f, 2794.9f, 17.2f, 20f, 1, 0, 0, false);
			func_108(-1720.5f, 2568.4f, 67.1f, -1523.2f, 3002f, -70f, 100f, -1155.06f, 2665.979f, 17.0939f, 219.2079f, 1, 0, 1, 0, 0);
			GAMEPLAY::CLEAR_AREA_OF_OBJECTS(-1588.1f, 2794.9f, 17.2f, 20f, 6);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				GAMEPLAY::CLEAR_AREA(vLocal_118, 10f, 1, 0, 0, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(-1866.446f, 3071.395f, 31.8104f, 10f, 1, 0, 0, false);
					...
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
		...
		case 5:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				GAMEPLAY::CLEAR_AREA(1749.61f, 3272.95f, 40.1533f, 5f, 1, 0, 0, false);
...
{
	return func_38(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
...
int func_70(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_8(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_8(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 1) < 10f)
					{
...
void func_96(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_101(var uParam0, int iParam1)
{
	...
	while (iVar0 < 16)
	{
		if (Global_68429[iVar0 /*2*/] == 0)
		{
			Global_68429[iVar0 /*2*/] = uParam0;
			Global_68429[iVar0 /*2*/].f_1 = iParam1;
			if (iVar0 == Global_68462)
			{
				Global_68462++;
			}
			return;
...
bool func_103()
{
	return func_97(&(Global_99633.f_2875));
}

void func_104()
{
	func_105(&(Global_99633.f_2875));
}
...
bool func_107()
{
	return func_98(&(Global_99633.f_2875));
}
...
void func_115()
{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_89824[0], 1))
		{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_89824[1], 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[1], 1, 1);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_89824[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_89824[2]))
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_89824[2], 1))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[2], 1, 1);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_89824[2]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
...
void func_116()
{
	if (UI::DOES_BLIP_EXIST(iLocal_45))
	{
		UI::REMOVE_BLIP(&iLocal_45);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_46))
	{
		UI::REMOVE_BLIP(&iLocal_46);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_48))
	{
		UI::REMOVE_BLIP(&iLocal_48);
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
			{
				...
				if (iLocal_107 == 1)
				{
					if (GAMEPLAY::GET_GAME_TIMER() < iLocal_68 + 7500)
					{
						UI::CLEAR_PRINTS();
					}
				}
				if (iLocal_28 == 4)
				{
					...
					if (iLocal_78 == 0)
					{
						...
						{
							if (!func_124() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
				...
				if (iLocal_28 == 3)
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_47[0]))
					{
			...
			else if (iLocal_28 != 5)
			{
				...
				if (iLocal_28 == 4)
				{
					if (iLocal_78 == 1)
					{
						if (GAMEPLAY::GET_GAME_TIMER() < iLocal_69 + 7500)
						{
							UI::CLEAR_PRINTS();
						}
					}
...
int func_120(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_121(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
		...
		if (iLocal_115 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
					{
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_118, 1) > 800f)
						{
...
void func_144(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_209(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_146(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_157(iParam1)];
...
int func_159(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_157(iParam1)];
...
void func_163(int iParam0, bool bParam1)
{
	...
	if (func_23(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_164(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_166(Var7.f_1)) && iVar9 < 50)
			{
...
int func_176(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_178() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_156(func_177(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
Vector3 func_181(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_192(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_191())
			{
				if (func_190(Global_1589591))
				{
					return func_183(2, 2);
				}
				else if (func_182(Global_1589591))
				{
...
int func_216(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_217(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_217(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_217(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_217(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_217(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_223()
{
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_119, 1) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	...
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_119, 1) > 550f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
			{
				VEHICLE::DELETE_VEHICLE(&(iLocal_36[0]));
...
void func_228()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_37) && ENTITY::IS_ENTITY_IN_AIR(iLocal_37))
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_48))
		{
			iLocal_48 = UI::ADD_BLIP_FOR_ENTITY(iLocal_37);
			UI::SET_BLIP_AS_FRIENDLY(iLocal_48, false);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_38) && ENTITY::IS_ENTITY_IN_AIR(iLocal_38))
	{
		...
		{
			iLocal_49 = UI::ADD_BLIP_FOR_ENTITY(iLocal_38);
			UI::SET_BLIP_AS_FRIENDLY(iLocal_49, false);
		}
	}
}
	...
	if (iLocal_28 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									...
									{
										if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, 1) > 1600f && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -2159f, 3067f, 33f, 1) < 1000f)
										{
											if (vLocal_121.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, 1) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
											...
											if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -2159f, 3067f, 33f, 1) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, 1) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_31[0], 1) < 200f)
							{
								...
								AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_31[0], 250f, 0);
								iLocal_81[0] = 1;
							}
						}
					}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							vLocal_120 = { ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true) };
							AI::CLEAR_PED_TASKS(iLocal_31[0]);
							AI::OPEN_SEQUENCE_TASK(&uLocal_367);
							if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
							{
								AI::TASK_ENTER_VEHICLE(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							AI::TASK_HELI_MISSION(0, iLocal_35[0], 0, 0, vLocal_120.x, vLocal_120.y, (vLocal_120.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1082130432, 0);
							AI::TASK_HELI_MISSION(0, iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1082130432, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_367);
							AI::TASK_PERFORM_SEQUENCE(iLocal_31[0], uLocal_367);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_367);
							iLocal_81[0] = 1;
						}
					}
				}
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_31[0]))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
						{
							if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_67 + 90000))
							{
								if (iLocal_104 == 0)
								{
							...
							else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_67 + 10000 && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0))
							{
								if (iLocal_104 == 0)
								{
									PED::SET_PED_ACCURACY(iLocal_31[0], 100);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1082130432, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1082130432, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1082130432, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_35[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_35[0], ENTITY::GET_ENTITY_COORDS(iLocal_35[0], true), 1, 1)), 100, -1082130432, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
								{
									if (!PED::IS_PED_INJURED(iLocal_31[0]))
									{
										AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1082130432, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1082130432, 0);
									iLocal_90[0] = 0;
								}
							}
						}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_31[0]))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
					{
						if (UI::DOES_BLIP_EXIST(uLocal_47[0]))
						{
							UI::SET_BLIP_SCALE(uLocal_47[0], 1f);
						}
					}
					if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_31[0], 1) > 600f)
					{
							...
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_34, 0) || iLocal_87 == 1)
								{
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										AI::CLEAR_PED_TASKS(iLocal_32[iLocal_55]);
										AI::OPEN_SEQUENCE_TASK(&uLocal_367);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_34, true), 2f, -1, 20f, 0, 40000f);
										AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
										AI::CLOSE_SEQUENCE_TASK(uLocal_367);
										AI::TASK_PERFORM_SEQUENCE(iLocal_32[iLocal_55], uLocal_367);
										AI::CLEAR_SEQUENCE_TASK(&uLocal_367);
										iLocal_93[iLocal_55] = 0;
										iLocal_94[iLocal_55] = 0;
								...
								else
								{
									...
									if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) > 41f && func_2(PLAYER::PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 400f)
									{
										...
										{
											iLocal_74 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 4);
											AI::CLEAR_PED_TASKS(iLocal_32[iLocal_55]);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_32[iLocal_55], ENTITY::GET_ENTITY_COORDS(iLocal_32[iLocal_55], true), 50f, 0, 0);
											AI::OPEN_SEQUENCE_TASK(&uLocal_367);
											if (iLocal_74 == 0)
											{
												AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 25f, 1073741824, 1073741824, 0);
											}
											else if (iLocal_74 == 1)
											{
											...
											{
												AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 25f, 3f, 1073741824, 0);
											}
											else if (iLocal_74 == 3)
											{
												AI::TASK_STAND_STILL(0, 500);
					...
					if (!PED::IS_PED_INJURED(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								...
								{
									AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_32[iLocal_72]);
								}
								else
								{
									AI::CLEAR_PED_TASKS(iLocal_32[iLocal_72]);
								}
								AI::TASK_AIM_GUN_AT_ENTITY(iLocal_32[iLocal_72], PLAYER::PLAYER_PED_ID(), -1, 0);
								iLocal_101[iLocal_72] = 1;
							}
							if (iLocal_110 == 1)
							{
								if (GAMEPLAY::GET_GAME_TIMER() > iLocal_70 + 20000)
								{
									iLocal_109 = 1;
								}
							}
...
void func_232()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_89824[2]))
		{
			...
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_89824[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[2], 1, 1);
					func_240(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_89824[2])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_89824[2]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_89824[2]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_89824[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[2], 1, 1);
	...
	if (iLocal_54 == 1)
	{
		if (AI::DOES_SCENARIO_GROUP_EXIST("ARMY_GUARD"))
		{
			if (AI::IS_SCENARIO_GROUP_ENABLED("ARMY_GUARD"))
			{
				AI::SET_SCENARIO_GROUP_ENABLED("ARMY_GUARD", false);
			}
		}
		func_99();
		if (iLocal_86 == 0)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_61 + 3000)
			{
				iLocal_63 = 0;
				while (iLocal_63 <= 12)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_63]))
					{
						if (!PED::IS_PED_INJURED(iLocal_32[iLocal_63]))
						{
							...
							{
								if (PED::_0x6CD5A433374D4CFB(iLocal_32[iLocal_63], PLAYER::PLAYER_PED_ID()))
								{
									...
									else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_237(0))
									{
										if (func_236(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
										{
											if (GAMEPLAY::GET_GAME_TIMER() > iLocal_73 + 3000)
											{
												AUDIO::START_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 0);
												AUDIO::SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 1, 1);
												iLocal_86 = 1;
...
{
	GAMEPLAY::CLEAR_BIT(&Global_89182, iParam0);
}
...
void func_240(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_249(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_246(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_241(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_242(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_198();
			}
...
void func_250()
{
	if (iLocal_54 == 0)
	{
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_44);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_44, -1533126372);
...
{
	GAMEPLAY::_0x9B2BD3773123EA2F(iParam0, !bParam1);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(iParam0, bParam1);
}
...
void func_258()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_28 == 4)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_118, 1) > 1000f)
			{
				PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
				PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
			}
...
void func_260()
{
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_32[iLocal_64]))
			{
				...
				{
					if (PED::_0x6CD5A433374D4CFB(iLocal_32[iLocal_64], PLAYER::PLAYER_PED_ID()))
					{
				...
				if (!PED::IS_PED_INJURED(iLocal_32[iLocal_71]))
				{
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_124())
						{
							if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								...
								{
									if (PED::_0x6CD5A433374D4CFB(iLocal_32[iLocal_71], PLAYER::PLAYER_PED_ID()))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_237(0))
										{
											if (func_236(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
					...
					if (iLocal_99 == 1 || iLocal_100 == 1)
					{
						if (iLocal_98 == 0 && iLocal_85 == 0)
						{
							if (iLocal_117 == 0)
							{
								if (GAMEPLAY::GET_GAME_TIMER() > iLocal_65 + 8000)
								{
									if (!func_124())
									{
										if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							...
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_66 + 8000)
							{
								if (!func_124())
								{
									if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_56 + 12000)
	{
		if (iLocal_85 == 1 || iLocal_98 == 1)
		{
			if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
			{
				if (!func_124())
				{
					if (func_264())
					{
						iLocal_60 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 6);
						if (iLocal_60 == 0)
						{
...
void func_266()
{
	if (AI::DOES_SCENARIO_GROUP_EXIST("ARMY_HELI"))
	{
		if (AI::IS_SCENARIO_GROUP_ENABLED("ARMY_HELI"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("ARMY_HELI", false);
		}
	}
}
...
{
	func_269(73);
	UI::REQUEST_ADDITIONAL_TEXT("DOCKP2B", 0);
	...
	GAMEPLAY::CLEAR_AREA(-1876.8f, 2806.1f, 32.3f, 8f, 1, 0, 0, false);
	GAMEPLAY::CLEAR_AREA(-1857.7f, 2797.9f, 32.4f, 8f, 1, 0, 0, false);
...
void func_270()
{
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("ARMY_GUARD"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("ARMY_GUARD"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("ARMY_GUARD", true);
		}
	}
	AUDIO::STOP_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 0, 0);
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("ARMY_HELI"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("ARMY_HELI"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("ARMY_HELI", true);
		}
	}
