...
void func_37()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_41() < 2)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_113[iVar2 /*4*/].f_1, 1))
			{
				func_38(PLAYER::INT_TO_PLAYERINDEX(iVar2));
				GAMEPLAY::SET_BIT(&(Local_112.f_1), 1);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_113[iVar2 /*4*/].f_1, 4))
			{
				func_38(func_11());
				GAMEPLAY::SET_BIT(&(Local_112.f_1), 7);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_113[iVar2 /*4*/].f_1, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_112.f_1), 0);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_113[iVar2 /*4*/].f_1, 2))
			{
				GAMEPLAY::SET_BIT(&(Local_112.f_1), 4);
			}
		}
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_113[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
	...
	if (((func_16(PLAYER::PLAYER_ID()) || (func_87() && func_86())) && !GAMEPLAY::IS_BIT_SET(Global_2524719.f_4577, 31)) && !bParam4)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (PED::IS_PED_A_PLAYER(iVar1))
			{
				...
				{
					if (func_9(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_73(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
void func_92()
{
	switch (func_609())
	{
		...
		case 1:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_110, 2))
			{
				func_589();
			}
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
			{
				func_385(0, func_10());
				func_303();
				func_93();
...
void func_93()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
			return;
		}
		if (func_302())
		{
		...
		{
			func_94(151, GAMEPLAY::IS_BIT_SET(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 1), &Var0, 0);
		}
		GAMEPLAY::SET_BIT(&(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
	}
}
...
void func_94(int iParam0, bool bParam1, var uParam2, bool bParam3)
{
	...
	if (iVar0 > 0)
	{
		...
		else if (iParam0 == 190)
		{
			...
			{
				func_129(-856006867, iVar0, &iVar16, 0, 1, 0);
		...
		else if (iParam0 == 230)
		{
			if (func_128())
			{
				if (!func_144())
				{
					iVar18 = func_123(uParam2->f_16, iVar5);
					iVar19 = iVar0;
					if (iVar18 > 0)
					{
		...
		else if (iParam0 == 237)
		{
			...
			{
				func_129(-856006867, iVar0, &iVar22, 0, 1, 0);
		...
		else if (iParam0 == 250)
		{
			if (func_144())
			{
				func_129(-961034881, iVar0, &iVar23, 0, 1, 0);
		...
		else if (((((iParam0 == 242 || iParam0 == 244) || iParam0 == 248) || iParam0 == 241) || iParam0 == 239) || iParam0 == 240)
		{
			if (func_144())
			{
				func_129(-634726636, iVar0, &iVar25, 0, 1, 0);
		...
		{
			func_129(-856006867, iVar0, &iVar26, 0, 1, 0);
...
int func_113(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_114(iParam1)];
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_138(struct<62> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
void func_153(vector3 vParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
float func_156(vector3 vParam0, var uParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_204(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_62(iParam1, -2, 1, 0, 0));
...
int func_230(struct<5> Param0, int iParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_143())
			{
				...
				iVar6 = func_263(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
...
void func_304(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
	Param0 = 713068249;
...
char* func_326()
{
	...
	if (iVar0 != func_10())
	{
		...
		sVar1 = func_327(&(Global_1625435[iVar0 /*560*/].f_11.f_99));
...
void func_387(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, char* sParam7)
{
	...
	{
		if (func_459(iParam1, iParam2, uParam3, Global_1574168, 0, func_501(), sParam7))
		{
			func_458(1);
			if ((!func_457() && !func_456()) || GAMEPLAY::IS_BIT_SET(Global_2524719.f_4574, 1))
			{
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 27)
						{
							...
							while (iVar17 < 32)
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar17), 0, 1))
								{
									...
									if (!func_18(iVar3, 0))
									{
										if ((func_451(iVar3) || Global_2423801[iVar3 /*413*/].f_236 != -1) || func_29(iVar3))
										{
											iVar9 = iVar3;
											if (func_28(iVar3))
											{
						...
						while (iVar17 < 32)
						{
							...
							if ((func_446(iVar3) && func_442(iVar3, iParam2)) && func_9(iVar3, 0, 1))
							{
								...
								*(uParam4[iVar17 /*13*/]) = { func_168(iVar3) };
								...
								if (func_423(iParam5))
								{
									func_422(iVar3, iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar8, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
								else
								{
									func_422(iVar3, iParam1, uParam3, iVar18, Var6, sVar4, iVar7, iVar8, iVar16, iVar15, fVar10, iVar11, iVar12, &Var22, (uParam0[iVar17 /*42*/])->f_40, iVar13, bParam6);
								}
						...
						{
							iVar3 = PLAYER::INT_TO_PLAYERINDEX(iVar17);
							if (func_9(iVar3, 0, 1) && !GAMEPLAY::IS_BIT_SET(iVar14, iVar3))
							{
								iVar3 = PLAYER::INT_TO_PLAYERINDEX(iVar17);
							}
							else
		...
		if (iVar2 != func_10())
		{
			if (func_9(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0 /*2*/].f_1 != -1)
				{
					...
					func_400(iParam1, uParam0->f_38[iVar0 /*2*/].f_1, iVar1, Global_1589747[iVar0 /*790*/].f_211.f_6);
				}
			}
		}
		iVar0++;
...
void func_422(int iParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, char* sParam16, int iParam17, int iParam18, bool bParam19)
{
	int iVar0;
	char* sVar1;
...
void func_435(int iParam0)
{
	...
	func_436(&(Global_1379953[iVar2 /*5*/]));
		...
		else
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(uParam2->f_33, 0))
			{
				...
				if (func_486(bVar3, iParam0, 0))
				{
					...
					sVar1 = func_483(iParam1, &(Global_4456448.f_130789), bParam4);
					Var0 = { func_481(iParam1) };
					if (bParam4)
					{
						func_478(iParam0, sVar1, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 26)
					{
						func_471(iParam0, func_475(uParam2), func_472(uParam2), -1);
					}
					else if (iParam1 == 27)
					{
						...
						func_465(iParam0, sVar5, func_466(), -1);
					}
					else if (func_408())
					{
						uParam2->f_34 = Global_1574169;
						func_478(iParam0, sVar1, &Var0, 1, -1, Global_1574169, 1);
					}
					else if (bVar2)
					{
						uParam2->f_34 = Global_1574169;
						func_478(iParam0, sVar1, "", 0, -1, Global_1574169, 1);
					}
					else
					{
						iVar6 = func_460(iParam1);
						func_478(iParam0, sVar1, &Var0, 1, iVar6, -1, 1);
					}
...
void func_478(int iParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
char* func_483(int iParam0, char* sParam1, bool bParam2)
{
	...
	if (iParam0 == 20 && (!func_408() || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam1)))
	{
		uVar0 = func_484();
		return uVar0;
	}
...
bool func_486(bool bParam0, int iParam1, bool bParam2)
{
	if (bParam0)
	{
...
void func_509()
{
	...
	{
		func_510(151, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(func_36()), true), &uLocal_111, 1140457472, 1144750080, 0);
	}
}

void func_510(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	...
	else
	{
		...
		if (*uParam2 && func_9(PLAYER::PLAYER_ID(), 1, 1))
		{
			*uParam2 = 0;
			...
			if (iParam5 && !func_417(PLAYER::PLAYER_ID()))
			{
...
void func_546(vector3 vParam0, int iParam1, int iParam2)
{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(Var0) && ENTITY::IS_ENTITY_A_PED(Var0)) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var0) == PLAYER::GET_PLAYER_PED(func_36()))
		{
			if (Var0.f_3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && ENTITY::IS_ENTITY_A_PED(Var0.f_1))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 1);
					}
				}
			}
		}
...
int func_564(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
bool func_579(char* sParam0, char* sParam1)
{
	if (!func_340())
	{
		return 0;
...
void func_589()
{
	...
	if (PLAYER::PLAYER_ID() != func_59())
	{
		...
		else
		{
			...
			GAMEPLAY::SET_BIT(&(Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(iLocal_110, 0))
	{
		if (!func_333())
		{
			sVar3 = "GBTER_BOSS";
...
void func_591(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
...
{
	Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 = iParam0;
}
...
int func_609()
{
	return Local_113[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2;
}
...
int func_616()
{
	...
	if (func_539() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_539()) == 0)
		{
			return 1;
		}
	}
...
bool func_649(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_660(int iParam0, bool bParam1)
{
	...
	func_252(func_661(iParam0), bParam1, -1, 1);
...
void func_663(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (func_672(iParam0, bParam2))
	{
		...
		iVar3 = func_670(PLAYER::PLAYER_ID(), iVar2);
...
void func_674(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam2)
	{
		func_252(15384, bParam1, -1, 1);
		return;
	}
	func_252(func_673(iParam0), bParam1, -1, 1);
}
...
void func_690()
{
	...
	if (func_697())
	{
		...
		{
			func_696(11);
			iVar0 = func_113(7226, -1, 0);
			GAMEPLAY::SET_BIT(&iVar0, 2);
			func_111(7226, iVar0, -1, 1, 0);
		}
	}
	if (func_695(48))
	{
...
void func_719(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_718();
