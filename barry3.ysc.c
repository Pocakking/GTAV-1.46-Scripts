...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_GRF", 0);
...
void func_6()
{
	...
	{
		func_8(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_82(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_74(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_74(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_82(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_65(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_82(iVar10, 14, uVar15[iVar1], -1) };
			func_50(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_65(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_51(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_74(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_74(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_52(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_52(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_52(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_52(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_68(iParam1)];
...
void func_84(int iParam0)
{
	...
	func_85(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_69(func_88(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_69(func_87(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_85(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_85(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_74(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_147(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_74(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_74(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_153()
{
	...
	{
		if (func_149(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_158(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_159(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_164()
{
	...
	{
		func_153();
		GRAPHICS::_0xBF59707B3E5ED531(func_165(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
	...
	switch (iLocal_42)
	{
		case 0:
			if (func_226())
			{
				...
				{
					func_212(1);
					AI::TASK_PERFORM_SEQUENCE(iLocal_45, uLocal_44);
					if (PED::IS_PED_HEADTRACKING_PED(iLocal_45, PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_CLEAR_LOOK_AT(iLocal_45);
					}
				}
...
void func_212(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			AI::OPEN_SEQUENCE_TASK(&uLocal_44);
			AI::TASK_PLAY_ANIM(0, sLocal_43, "barry_get_up", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_46, 0), 200f, -1, 0, 0);
			AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_44);
		}
		else
		{
			AI::OPEN_SEQUENCE_TASK(&uLocal_44);
...
int func_226()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_46) && STREAMING::HAS_MODEL_LOADED(iLocal_49)) && STREAMING::HAS_MODEL_LOADED(iLocal_50))
	{
		...
		WEAPON::GIVE_DELAYED_WEAPON_TO_PED(iLocal_47[0], joaat("weapon_pistol"), -1, 1);
		...
		WEAPON::GIVE_DELAYED_WEAPON_TO_PED(iLocal_47[1], joaat("weapon_pistol"), -1, 1);
		...
		AI::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_47[0], iLocal_46, vLocal_237, 20f, 1, iLocal_49, 786603, 5f, 5f);
		return 1;
	}
	return 0;
}

float func_227(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
void func_228()
{
	switch (iLocal_42)
	{
		case 0:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_COPS(ENTITY::GET_ENTITY_COORDS(iLocal_45, 1), 1000f, 0);
				iLocal_243 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_247, vLocal_248, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_243, 1);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
			}
		...
		case 1:
			if (!func_233())
			{
				...
				if (iLocal_58 < 3)
				{
					if (func_223(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1))
					{
						...
						{
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_66) > iLocal_232[iLocal_58])
							{
			...
			if (!iLocal_53)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_52) > 40000 || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) > 0)
				{
					iLocal_53 = 1;
					iLocal_42 = 2;
				}
...
void func_232()
{
	if (func_223(iLocal_45, PLAYER::PLAYER_PED_ID(), 7f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(iLocal_45, PLAYER::PLAYER_PED_ID()))
		{
			AI::TASK_LOOK_AT_ENTITY(iLocal_45, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
		}
	}
	...
	if (func_223(iLocal_45, PLAYER::PLAYER_PED_ID(), 6f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_45))
		{
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_45, -1, 0, 2);
		}
	}
		...
		case 0:
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_242))
			{
				if (func_338(iLocal_45))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_242, sLocal_43, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
				}
			}
			func_225(1);
			iLocal_64 = 0;
...
void func_239()
{
	...
	{
		case 0:
			GAMEPLAY::CLEAR_AREA_OF_COPS(417.78f, -765.71f, 29.39f, 40f, 0);
			PED::SET_CREATE_RANDOM_COPS(0);
...
void func_242(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_246(PLAYER::PLAYER_ID())) && !func_244(PLAYER::PLAYER_ID(), 0)) && !func_243()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_246(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_250()
{
	...
	{
		iLocal_48 = OBJECT::CREATE_OBJECT(iLocal_51, 416.3885f, -764.8415f, 28.3848f, 1, 1, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
	{
...
int func_273(int iParam0, var uParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_68(uParam1)];
...
void func_276()
{
	...
	if (iLocal_42 == 0)
	{
		...
		if (!func_449())
		{
			if (func_338(iLocal_45))
			{
				AI::TASK_PLAY_ANIM(iLocal_45, sLocal_43, "lead_in", 8f, -8f, -1, 2, 0f, 0, 0, 0);
				iLocal_42 = 1;
			}
		}
		else
		...
		if (func_241(iLocal_45))
		{
			...
			if (bLocal_57)
			{
				...
				if (func_223(PLAYER::PLAYER_PED_ID(), iLocal_45, 2.5f, 1))
				{
					...
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_45, 0);
				}
			}
...
void func_286()
{
	...
	if (iLocal_42 == 0)
	{
		...
		PED::SET_PED_CONFIG_FLAG(iLocal_45, 132, 1);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_45, 1);
		PED::SET_PED_CONFIG_FLAG(iLocal_45, 185, 1);
		...
		UI::REQUEST_ADDITIONAL_TEXT("BARY3", 0);
	...
	if (iLocal_42 == 1)
	{
		if ((UI::HAS_ADDITIONAL_TEXT_LOADED(0) && STREAMING::HAS_MODEL_LOADED(iLocal_51)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_43))
		{
			if (func_449())
			{
				switch (func_293())
				{
					case 0:
						...
						if (func_338(iLocal_45))
						{
							iLocal_243 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_247, vLocal_248, 2);
							PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_243, 1);
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
						}
						func_250();
...
int func_295()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_45))
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(iLocal_45, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_225(0);
...
void func_314()
{
	...
	{
		case 0:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_40, "DEFAULT"))
			{
				func_465(1);
			}
			else
		...
		case 1:
			...
			else if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_40))
			{
				if (func_241(iLocal_45))
				{
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_322(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_333(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_335(iParam0, Global_36117);
}
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_398(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_398(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_341(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_345(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_344(*iParam1);
				...
				func_342(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_342(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_348(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			...
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_354(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_355(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_371(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_351())
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_372(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_351())
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_373(int iParam0)
{
	if (iParam0 != func_351())
	{
		if (func_350(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_349(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_376(int iParam0, int iParam1)
{
	...
	func_377(iParam0, &(Global_106070.f_32605.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_378(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_404(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_405(iParam0, iParam1))
				{
...
void func_406(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_411(&(Global_70024.f_555[0 /*21*/]), iVar0))
		{
...
void func_407(int iParam0)
{
	...
	if (func_411(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_179(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_409(0, Global_70024.f_555[0 /*21*/].f_12) || !func_409(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_408(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_409(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_410(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_382(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_411(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_412(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_412(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_412(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_414(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_431(uParam0))
	{
		...
		if (func_430(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_416(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_416(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_418(iParam0, Global_70024.f_139[38], 0))
			{
				func_407(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_418(iParam0, Global_70024.f_139[43], 1))
			{
				func_407(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_412(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_419(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_378(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_378(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_378(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_422(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_421())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_378(iVar2 + 1)))
				{
...
bool func_432()
{
	return func_430(&(Global_99633.f_2875));
}

void func_433()
{
	func_434(&(Global_99633.f_2875));
}
...
int func_435(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_437(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_438()
{
	return func_431(&(Global_99633.f_2875));
}
...
int func_469()
{
	...
	iVar0 = func_470(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_473()
{
	...
	{
		if (func_468(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
