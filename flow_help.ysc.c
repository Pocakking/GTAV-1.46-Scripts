...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (Global_106070.f_20382.f_145 > 0 || Global_104710)
		{
				...
				if (!Global_104709)
				{
					if (Global_106070.f_20382.f_145 > 0)
					{
						if (func_19(&(Global_106070.f_20382[iLocal_21 /*16*/])))
						{
							if (func_17(func_18()))
							{
								if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20382[iLocal_21 /*16*/].f_11, func_12()))
								{
									if (Global_106070.f_20382[iLocal_21 /*16*/].f_12 == Global_106070.f_20382.f_146[func_12()])
									{
										if (GAMEPLAY::GET_GAME_TIMER() > Global_104712)
										{
											if (GAMEPLAY::GET_GAME_TIMER() > Global_106070.f_20382[iLocal_21 /*16*/].f_8)
											{
												if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_20382[iLocal_21 /*16*/].f_4), ""))
												{
			...
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_20382[iLocal_21 /*16*/]), &Local_20) && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_20382[iLocal_21 /*16*/]), ""))
			{
				if (Global_106070.f_20382[iLocal_21 /*16*/].f_10 != -1)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > Global_106070.f_20382[iLocal_21 /*16*/].f_10)
					{
						iVar2 = iLocal_21;
