...
void func_1()
{
	switch (iLocal_53)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_25();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_165))
			{
				func_23(sLocal_165);
			}
			else
...
bool func_88(char* sParam0, int iParam1, char* sParam2)
{
...
int func_95(int iParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, var uParam7, var uParam8, int iParam9, float fParam10)
{
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iParam0, vParam1, fParam10, fParam10, 2f, false, true, 2))
	{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - *uParam7) > 3000)
		{
			return 1;
		}
	}
	...
	switch (iParam0)
	{
				...
				if (!func_453())
				{
					...
					else if ((((func_118(2, Local_202.f_1, Local_202.f_4) && func_118(5, Local_200.f_1, Local_200.f_4)) && func_118(6, Local_201.f_1, Local_201.f_4)) && func_118(3, Local_197.f_1, Local_197.f_4)) && func_118(4, vLocal_175, 0))
					{
						...
						if (func_440(Local_197))
						{
							...
							{
								AI::TASK_PLAY_ANIM_ADVANCED(Local_197, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_200), 1000f, -1.5f, -1, 1, 0f, 2, 0);
						...
						if (UI::GET_BLIP_FROM_ENTITY(Local_202) != 0)
						{
							iVar0 = UI::GET_BLIP_FROM_ENTITY(Local_202);
		...
		case 1:
			if (bParam1)
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(Local_197.f_1, 100f, 1, 0, 0, false);
					func_109();
					if (func_440(Local_197))
					{
...
int func_118(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_166, 0);
			UI::REQUEST_ADDITIONAL_TEXT(cLocal_207, 6);
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[0]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_89824.f_9[0], 1))
				{
					...
					if (func_440(Local_197))
					{
						...
						PED::SET_PED_CAPSULE(Local_197, 0.1f);
						AUDIO::STOP_PED_SPEAKING(Local_197, 1);
						AI::SET_PED_PATHS_WIDTH_PLANT(Local_197, 0);
						return 1;
					}
				}
				else
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_97(func_65(), bParam7));
					}
					if (func_65() != 33)
					{
						func_128(iParam0);
...
int func_140(int iParam0, int iParam1)
{
	switch (iLocal_57[iParam0])
	{
		case 0:
			...
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_176, 4, 20f, 786469, 2f, 10f, 1);
				iLocal_57[iParam0] = 5;
			}
			break;
	...
	if (func_440(Local_197))
	{
		...
		switch (iLocal_57[iParam0])
		{
			case 0:
				...
				if (!GAMEPLAY::IS_POSITION_OCCUPIED(vVar0, 1.5f, 0, 0, 1, 0, 0, Local_197, 0))
				{
					if (!bLocal_195)
					{
						if (iParam0 == 0)
			...
			case 1:
				...
				{
					AI::TASK_STEALTH_KILL(iParam1, Local_197, GAMEPLAY::GET_HASH_KEY("AR_stealth_kill_a"), 1f, 0);
					AI::CLEAR_PED_TASKS(Local_197);
					iLocal_56 = 18;
					iLocal_57[iParam0] = 4;
				}
				break;
			...
			case 2:
				...
				{
					AI::TASK_STEALTH_KILL(iParam1, Local_197, GAMEPLAY::GET_HASH_KEY("AR_stealth_kill_knife"), 1f, 0);
					AI::CLEAR_PED_TASKS(Local_197);
					iLocal_56 = 18;
					iLocal_57[iParam0] = 4;
				}
...
void func_150()
{
	...
	if (func_440(Local_197))
	{
		...
		switch (iLocal_56)
		{
			...
			case 1:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(9000, 10000)
				{
					if (!func_221())
					{
						func_205(iLocal_56);
			...
			case 4:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1500, 2500)
				{
					if (func_89(Local_200, Local_200.f_1, 2f))
					{
						if (!func_221())
			...
			case 11:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 2000)
				{
					if (!func_221())
					{
						func_205(11);
			...
			case 13:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000)
				{
					if (!func_204(Local_197, PLAYER::PLAYER_PED_ID(), 10f, 1))
					{
						func_205(14);
			...
			case 15:
				...
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(7000, 10000)
				{
					func_205(15);
				}
				break;
				...
				if (func_6(Local_202))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
					{
						if (func_185(Local_202, &uLocal_180, &uLocal_181, &uLocal_182, &uLocal_183, 3, 2f))
						{
							...
							AI::TASK_PERFORM_SEQUENCE(Local_197, uVar0);
			...
			case 17:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_197.f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 12000)
				{
...
int func_162(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_170() || func_169(Global_4456448.f_152990)) || func_168())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_166(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (func_6(Local_200))
	{
		if (!func_115(Local_197, -2017877118))
		{
			if (!func_89(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 0.5f))
			{
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, vLocal_196), 1f, 60000, 0.3f, 512, -ENTITY::GET_ENTITY_HEADING(Local_200));
				}
			}
			else if (!func_115(Local_197, 1920390111))
			{
				AI::TASK_ACHIEVE_HEADING(Local_197, -ENTITY::GET_ENTITY_HEADING(Local_200), 0);
			}
		}
		PED::SET_PED_CAPSULE(Local_197, 0.1f);
	}
...
int func_203()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		else if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 10f)
		{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_185) > 6000)
			{
				return 1;
			}
		}
	...
	else if (func_204(Local_197, PLAYER::PLAYER_PED_ID(), 10f, 1))
	{
		if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 10f)
		{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_185) > 5500)
			{
				return 1;
			}
		}
...
void func_205(int iParam0)
{
	func_209(iParam0);
	func_206(iParam0);
	Local_197.f_14 = GAMEPLAY::GET_GAME_TIMER();
	iLocal_56 = iParam0;
}
	...
	switch (iParam0)
	{
		case 1:
			if (!func_115(Local_197, -2017877118))
			{
				if (func_6(Local_200))
				{
					AI::TASK_PLAY_ANIM(Local_197, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, -1, 1, 0f, 0, 0, 0);
				}
			}
			break;
		...
		case 3:
			if (!func_115(Local_197, -1794415470))
			{
				if (func_6(Local_202))
				{
					AI::TASK_ENTER_VEHICLE(Local_197, Local_202, 60000, -1, 2f, 524296, 0);
				}
			}
			break;
		...
		case 2:
			if (!func_115(Local_197, 713668775))
			{
				if (func_6(Local_202))
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_197, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200, -1f, 0.5f, 0f), 1f, 30000, 0.25f, 0, 141.2603f);
				}
			}
			break;
		...
		case 6:
			if (!func_115(Local_197, -1794415470))
			{
				if (func_6(Local_200))
				{
					...
					{
						AI::TASK_ENTER_VEHICLE(Local_197, Local_200, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 7:
			if (!func_115(Local_197, -1794415470))
			{
				if (func_6(Local_202))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
					{
						AI::TASK_ENTER_VEHICLE(Local_197, Local_202, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 8:
			if (func_115(Local_197, 242628503) || AI::GET_SCRIPT_TASK_STATUS(Local_197, 242628503) == 2)
			{
				AI::CLEAR_PED_TASKS(Local_197);
			}
			if (func_6(Local_201))
			{
				if (!func_115(Local_197, -1794415470))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_197, 0))
					{
						AI::TASK_ENTER_VEHICLE(Local_197, Local_201, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
			...
			if (!func_115(Local_197, -1273030092))
			{
				if (func_6(Local_201))
				{
					if (func_6(Local_200) && func_6(Local_202))
					{
						if (bLocal_177)
						{
							...
							{
								AI::TASK_VEHICLE_MISSION(Local_197, Local_201, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_208();
						...
						else if (iLocal_55 == 1)
						{
							if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_201))
							{
								AI::TASK_VEHICLE_MISSION(Local_197, Local_201, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_208();
				...
				else if (func_6(Local_200) && func_6(Local_202))
				{
					if (bLocal_177)
					{
						...
						{
							AI::TASK_VEHICLE_MISSION(Local_197, Local_202, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_208();
					...
					else if (iLocal_55 == 1)
					{
						...
						{
							AI::TASK_VEHICLE_MISSION(Local_197, Local_200, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_208();
		...
		case 11:
			...
			{
				AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_197, PLAYER::PLAYER_PED_ID(), 0);
			}
			break;
		...
		case 14:
			if (!func_115(Local_197, 1805844857))
			{
				...
				AI::TASK_SMART_FLEE_PED(Local_197, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
			}
			break;
		...
		case 15:
			...
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_203, 1862763509);
				AI::TASK_COMBAT_PED(Local_197, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
			break;
		...
		case 16:
			if (!func_115(Local_197, 242628503))
			{
				if (func_6(Local_202))
				{
					...
					if (!PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
					{
						AI::TASK_ENTER_VEHICLE(0, Local_202, 60000, -1, 2f, 1, 0);
					}
					AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_202, 30f, 786469);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::TASK_PERFORM_SEQUENCE(Local_197, uVar1);
...
void func_214(char* sParam0, int iParam1, int iParam2)
{
	...
	if (iLocal_56 != iParam1 && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		Var0 = { func_216() };
		if ((((!GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sParam0) && !AI::IS_PED_IN_WRITHE(Local_197)) && !PED::IS_PED_RAGDOLL(Local_197)) && !PED::IS_PED_BEING_STUNNED(Local_197, 0)) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_197))
		{
...
void func_217(char* sParam0, bool bParam1, int iParam2)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_184) > iParam2 && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		Var0 = { func_216() };
		if ((((!GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sParam0) && !AI::IS_PED_IN_WRITHE(Local_197)) && !PED::IS_PED_RAGDOLL(Local_197)) && !PED::IS_PED_BEING_STUNNED(Local_197, 0)) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_197))
		{
			...
			iLocal_184 = GAMEPLAY::GET_GAME_TIMER();
		}
	}
}
...
void func_224()
{
	...
	else
	{
		if (func_6(Local_202))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_197, Local_202, 0))
			{
				AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_202, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_200))
		{
			...
			{
				AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_200, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_201))
		{
			...
			{
				AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_197, Local_201, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
			}
		}
	}
...
void func_240()
{
	if (((iLocal_56 != 17 && iLocal_56 != 14) && iLocal_56 != 13) && iLocal_56 != 15)
	{
		if (fLocal_189 < 20f)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -414.4899f, -2181.967f, 11.93531f, -414.1714f, -2170.252f, 5.64993f, 12.63f, 0, true, 0))
			{
				fLocal_189 = (fLocal_189 + GAMEPLAY::GET_FRAME_TIME());
			}
		}
		else
		{
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_104(iLocal_52, 0))
			{
				...
				if (func_453())
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-399.8117f, -2172.942f, 9.3184f, 50f, 0, 0, 1, 1, false, 0);
...
void func_249(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
...
int func_266(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_316(iVar10, 14, uVar12[iVar1], -1) };
							func_286(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_308(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_276(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_276(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_276(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_308(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_316(iVar10, iVar0, func_275(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_316(iVar10, 14, uVar15[iVar1], -1) };
			func_286(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_308(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_276(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_276(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_276(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_267(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_380(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_274(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_380(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_286(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_287(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_288(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_276(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_293(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_276(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_288(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_288(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_288(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_288(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_312(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_311(iParam1)];
...
void func_318(int iParam0)
{
	...
	func_319(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_312(func_322(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_312(func_321(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_312(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_325(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_319(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_319(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_276(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_380(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_276(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_276(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_412(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
