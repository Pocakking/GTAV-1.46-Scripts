...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 1:
			if (func_50(uParam0))
			{
				uParam0->f_85.f_6 = GAMEPLAY::GET_GAME_TIMER();
				func_51(uParam0, 2);
			}
			break;
		...
		case 2:
			if (func_49(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_85.f_6) > 150)
					{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				uParam0->f_85.f_8.f_4 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_85.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_85.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_85.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!UI::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_85), 0)) && !func_8(&(uParam0->f_85), 4)) && !func_21()) && !func_19(1)) && uParam0->f_85.f_8.f_2 != 3)
			{
...
int func_42(var uParam0)
{
	...
	switch (uParam0->f_85.f_8)
	{
		...
		default:
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, func_14(uParam0->f_85.f_8));
	}
	return iVar0;
}
...
void func_53(var uParam0)
{
	...
	else if (uParam0->f_85.f_4 > 4)
	{
		...
		uParam0->f_85.f_7 = GAMEPLAY::GET_FRAME_COUNT();
	}
	...
	else if ((GAMEPLAY::GET_FRAME_COUNT() - uParam0->f_85.f_7) < 5)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_54(uParam0));
	}
}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_85), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_71()
{
	if (Global_1589596 != func_59())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1589596, 1, 0))
		{
			return 0;
		}
...
{
	if ((iParam1 == 0 || iParam1 == 1) && (AI::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_3") || AI::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_2")))
	{
		return 0;
	}
	return 1;
