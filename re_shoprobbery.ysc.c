								...
								else
								{
									...
									if (func_164())
									{
										...
										while (iVar0 < iLocal_66)
										{
											...
											{
												AI::TASK_COMBAT_PED(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
												if (!UI::DOES_BLIP_EXIST(uLocal_116[iVar0]))
												{
										...
										if (iLocal_47 == 2)
										{
											...
											while (iVar0 < iLocal_67)
											{
												...
												{
													AI::TASK_COWER(iLocal_67[iVar0], -1);
											...
											while (iVar0 < iLocal_68)
											{
												...
												{
													AI::TASK_COWER(iLocal_68[iVar0], -1);
									...
									if (func_162())
									{
										func_155(1);
										SYSTEM::SETTIMERA(0);
										DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(88, vLocal_123, 15000f);
										iLocal_44 = 1;
									}
								}
								break;
							...
							case 1:
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vLocal_123 - Vector(20f, 20f, 20f), vLocal_123 + Vector(20f, 20f, 20f), 0))
										{
											if (!PED::IS_PED_INJURED(iLocal_67[1]))
											{
												AI::TASK_SMART_FLEE_COORD(iLocal_67[1], vLocal_59, 150f, -1, 0, 0);
											...
											{
												AI::TASK_SMART_FLEE_COORD(iLocal_67[2], vLocal_59, 150f, -1, 0, 0);
											...
											while (iVar2 <= (iLocal_65 - 1))
											{
												if (!PED::IS_PED_INJURED(iLocal_68[iVar2]))
												{
													...
													AI::OPEN_SEQUENCE_TASK(&iLocal_87);
													if (iLocal_47 == 1)
													{
													...
													{
														AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 0.25f, 0, 40000f);
													}
													AI::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
													AI::CLOSE_SEQUENCE_TASK(iLocal_87);
													AI::TASK_PERFORM_SEQUENCE(iLocal_68[iVar2], iLocal_87);
													AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
											...
											if (!iLocal_99)
											{
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_66[0], 0))
												{
													...
													if (!PED::IS_PED_INJURED(iLocal_67[0]))
													{
														...
														AI::CLOSE_SEQUENCE_TASK(iLocal_87);
														AI::TASK_PERFORM_SEQUENCE(iLocal_67[0], iLocal_87);
														AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
										...
										if (iLocal_47 == 1)
										{
											...
											{
												if (UI::DOES_BLIP_EXIST(uLocal_116[0]))
												{
													UI::REMOVE_BLIP(&(uLocal_116[0]));
												}
												if (UI::DOES_BLIP_EXIST(uLocal_116[1]))
												{
													UI::REMOVE_BLIP(&(uLocal_116[1]));
												}
												...
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													...
													AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
											...
											if (iLocal_97 && !iLocal_143)
											{
												if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0) && !PED::IS_PED_INJURED(iLocal_115))
												{
													...
													{
														AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_143 = 1;
													}
												}
											}
												...
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0))
													{
														if (!iLocal_98)
														{
															...
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 6, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 1, true);
															AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_98 = 1;
														}
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														if (!PED::IS_PED_INJURED(iLocal_66[iVar3]))
														{
															...
															{
																AI::TASK_DRIVE_BY(iLocal_66[iVar3], PLAYER::PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_80[iVar3] = 1;
															}
															else if (!UI::DOES_BLIP_EXIST(iLocal_121))
															{
																AI::TASK_COMBAT_PED(iLocal_66[iVar3], PLAYER::PLAYER_PED_ID(), 0, 16);
																PED::SET_PED_KEEP_TASK(iLocal_66[iVar3], true);
																if (UI::DOES_BLIP_EXIST(iLocal_120))
																{
																	UI::REMOVE_BLIP(&iLocal_120);
																}
																if (!UI::DOES_BLIP_EXIST(uLocal_116[iVar3]))
																{
														...
														if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0))
														{
															if (!PED::IS_PED_INJURED(iLocal_66[iVar3]))
															{
																if ((PED::IS_PED_INJURED(iLocal_115) || VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_106, -1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_66[iVar3]))
																{
																	...
																	AI::CLOSE_SEQUENCE_TASK(iLocal_87);
																	AI::TASK_PERFORM_SEQUENCE(iLocal_66[iVar3], iLocal_87);
																	AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
																	PED::SET_PED_KEEP_TASK(iLocal_66[iVar3], true);
																	if (!PED::IS_PED_INJURED(iLocal_115))
																	{
																		...
																		AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
																		AI::CLOSE_SEQUENCE_TASK(iLocal_87);
																		AI::TASK_PERFORM_SEQUENCE(iLocal_115, iLocal_87);
																		AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
																		PED::SET_PED_KEEP_TASK(iLocal_115, true);
																	}
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_67[0]))
												{
													...
													AI::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
													if (!PED::IS_PED_INJURED(iLocal_67[1]))
													{
														AI::TASK_SMART_FLEE_COORD(iLocal_67[1], vLocal_59, 150f, -1, 0, 0);
														PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[1], false);
													...
													while (iVar4 <= (iLocal_65 - 1))
													{
														if (!PED::IS_PED_INJURED(iLocal_68[iVar4]))
														{
															...
															AI::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
															AI::CLOSE_SEQUENCE_TASK(iLocal_87);
															AI::TASK_PERFORM_SEQUENCE(iLocal_68[iVar4], iLocal_87);
															AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
											...
											if (!iLocal_95)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_67[0]))
												{
													...
													while (iVar5 <= (iLocal_65 - 1))
													{
														...
														{
															AI::TASK_SMART_FLEE_COORD(iLocal_68[iVar5], vLocal_59, 150f, -1, 0, 0);
									...
									case 13:
										if (!iLocal_144)
										{
											if (!PED::IS_PED_INJURED(iLocal_67[0]))
											{
												AI::CLEAR_PED_TASKS(iLocal_67[0]);
												if (iLocal_47 == 1)
												{
												...
												AI::TASK_USE_MOBILE_PHONE_TIMED(iLocal_67[0], 20000);
												PED::SET_PED_KEEP_TASK(iLocal_67[0], true);
...
void func_1()
{
	if (func_162())
	{
		...
		if (!iLocal_113)
		{
			if (!PED::IS_PED_INJURED(iLocal_67[0]))
			{
				...
				UI::CLEAR_HELP(1);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_67[0], true), 20f, 0);
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, sLocal_130, sLocal_131, 1000f, -2f, 5, 0, 1148846080, 0);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
			AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_67[0]);
			AI::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, sLocal_130, sLocal_132, 1000f, -2f, 4, 0, 1148846080, 0);
	...
	if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_135) > fLocal_136 && iLocal_114)
	{
		...
		PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 650, 0f, 1, 0);
		func_134(0, 1, 1, 0, 0);
...
void func_16(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_18() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_18() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_21(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_18() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_52()
{
	if (iLocal_47 == 1)
	{
		...
		GAMEPLAY::CLEAR_AREA(-823.1281f, -187.9591f, 36.6189f, 3f, 1, 0, 0, false);
	}
	else if (iLocal_47 == 2)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		...
		GAMEPLAY::CLEAR_AREA(-1201.017f, -777.5527f, 16.3398f, 8f, 1, 0, 0, false);
	}
}
...
void func_59()
{
	...
	{
		func_40(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_81(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84115[26 /*34*/].f_6) == 0)
			{
				Global_106070.f_7233[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106070.f_7233[iParam0], 1, 1);
			}
...
int func_84()
{
	...
	func_94(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_93(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_92(&uVar0, TIME::GET_CLOCK_HOURS());
	func_87(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_86(&uVar0, TIME::GET_CLOCK_MONTH());
	func_85(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_90(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_105()
{
	...
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_62))
	{
		GAMEPLAY::SET_BIT(&iLocal_60, 3);
		GAMEPLAY::SET_BIT(&iLocal_60, 4);
		GAMEPLAY::SET_BIT(&iLocal_60, 1);
		if (!bLocal_96)
		{
			if (ENTITY::IS_ENTITY_DEAD(iLocal_66[0], 0))
			{
			...
			{
				vLocal_61 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_66[0], true), 1067030938, 1069547520) };
			}
		}
		else if (ENTITY::DOES_ENTITY_EXIST(iLocal_106))
		{
			vLocal_61 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_106, false), 1067030938, 1069547520) };
		}
		...
		if (iLocal_47 == 1)
		{
			...
			while (iVar0 <= (iLocal_63 - 1))
			{
				if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
				{
					...
					AI::CLEAR_PED_TASKS(iLocal_66[iVar0]);
					AI::OPEN_SEQUENCE_TASK(&iLocal_87);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_87);
					AI::TASK_PERFORM_SEQUENCE(iLocal_66[iVar0], iLocal_87);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
					PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
				}
				iVar0++;
		...
		else if (iLocal_47 == 2)
		{
			if (!PED::IS_PED_INJURED(iLocal_66[0]))
			{
				AI::CLEAR_PED_SECONDARY_TASK(iLocal_66[0]);
				if (!AI::IS_PED_IN_WRITHE(iLocal_66[0]))
				{
					func_50();
					SYSTEM::WAIT(0);
...
int func_106(int iParam0)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_107(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return iVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
			{
				if (PED::IS_PED_BEING_JACKED(iLocal_66[iVar0]))
				{
					...
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar0], true, 1);
						AI::TASK_SMART_FLEE_PED(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
						SYSTEM::WAIT(0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_115))
	{
		if (!PED::IS_PED_INJURED(iLocal_115))
		{
			if (PED::IS_PED_BEING_JACKED(iLocal_115))
			{
				...
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_115, true, 1);
					AI::TASK_SMART_FLEE_PED(iLocal_115, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_115, true);
					SYSTEM::WAIT(0);
...
int func_112(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_107(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
	{
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				...
				{
					AI::TASK_SMART_FLEE_PED(iLocal_66[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				...
				{
					AI::TASK_SMART_FLEE_PED(iLocal_66[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_101 = 1;
				}
			}
		}
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
		{
			if (PED::IS_PED_INJURED(iLocal_66[iVar0]))
			{
				if (UI::DOES_BLIP_EXIST(uLocal_116[iVar0]))
				{
					UI::REMOVE_BLIP(&(uLocal_116[iVar0]));
				}
			}
		}
		iVar0++;
	...
	if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		if (!bLocal_79)
		{
			...
			while (iVar1 <= (iLocal_63 - 1))
			{
				...
				{
					AI::TASK_COMBAT_PED(iLocal_66[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
				iVar1++;
			}
			bLocal_79 = true;
		...
		if (!iLocal_77)
		{
			if (iLocal_47 == 1)
			{
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_66[0]))
						{
							AI::CLEAR_PED_TASKS(iLocal_66[0]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_87);
							AI::TASK_CLEAR_LOOK_AT(0);
							AI::TASK_ENTER_VEHICLE(0, iLocal_106, -1, 0, 2f, 1, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_87);
							AI::TASK_PERFORM_SEQUENCE(iLocal_66[0], iLocal_87);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
						}
						if (!PED::IS_PED_INJURED(iLocal_66[1]))
						{
							...
							AI::OPEN_SEQUENCE_TASK(&iLocal_87);
							AI::TASK_CLEAR_LOOK_AT(0);
							AI::TASK_ENTER_VEHICLE(0, iLocal_106, -1, 1, 2f, 1, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_87);
							AI::TASK_PERFORM_SEQUENCE(iLocal_66[1], iLocal_87);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
						}
						iLocal_45 = 2;
						iLocal_77 = 1;
					...
					else
					{
						if (!PED::IS_PED_INJURED(iLocal_66[0]))
						{
							...
							AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_66[0]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_87);
							AI::TASK_CLEAR_LOOK_AT(0);
						...
						if (!PED::IS_PED_INJURED(iLocal_66[1]))
						{
							...
							AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_66[1]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_87);
							AI::TASK_CLEAR_LOOK_AT(0);
							AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_87);
			...
			else if (iLocal_47 == 2)
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_135) > 0.453f)
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_66[0]);
						PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[0], 128, 1);
						PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[0], 1, 1);
					...
					if (!PED::IS_PED_INJURED(iLocal_66[1]))
					{
						PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[1], 128, 1);
						PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[1], 1, 1);
...
void func_148()
{
	switch (iLocal_146)
	{
		case 0:
			func_134(1, 1, 1, 0, 0);
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_149(PLAYER::PLAYER_ID()), 10f, 0);
			iLocal_145 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
			CAM::SET_CAM_ACTIVE(iLocal_145, 1);
			...
			CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
			iLocal_147 = GAMEPLAY::GET_GAME_TIMER() + 3500;
			iLocal_146++;
			break;
		
		case 1:
			if (iLocal_147 < GAMEPLAY::GET_GAME_TIMER())
			{
				if (iLocal_47 == 1)
				{
				...
				CAM::SET_CAM_ACTIVE(iLocal_145, 0);
	...
	if (!iLocal_75 && func_153(1, 0, 1))
	{
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				...
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
		...
		else if (iLocal_47 == 2)
		{
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_67[0]);
				AI::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, 0, 0, 0);
			}
			STREAMING::NEW_LOAD_SCENE_START_SPHERE(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_126, vLocal_128, 2);
			if (((!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1])) && !PED::IS_PED_INJURED(iLocal_67[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_102))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
			...
			if (!PED::IS_PED_INJURED(iLocal_66[1]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_135, 0.06f);
			...
			AI::CLOSE_SEQUENCE_TASK(iLocal_87);
			AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_87);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
		}
		iLocal_75 = 1;
...
void func_151()
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_115, 1, 0f);
...
int func_156()
{
	switch (func_157(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_164()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, false, true, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
		{
			...
			if (PED::_0x6CD5A433374D4CFB(iLocal_66[0], PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_66[1], PLAYER::PLAYER_PED_ID()))
			{
				...
				if (iLocal_69 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_69 + 1500)
				{
					return 1;
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
	{
		if (((PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true) - Vector(12f, 12f, 12f), ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true) + Vector(12f, 12f, 12f), 0, 1) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID())) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_66[0], true), 3f, 1)) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_66[1], true), 3f, 1))
		{
			return 1;
		}
	}
...
void func_170()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_66[iVar0], 1, 0f);
		...
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[iVar0], 128, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_66[iVar0], 8, 1);
		iVar0++;
	}
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_119, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, iLocal_119);
	if (func_43() == 0)
	{
	...
	if (iLocal_47 == 1)
	{
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_68[0], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_68[1], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_68[2], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		PED::SET_PED_KEEP_TASK(iLocal_68[2], true);
		AI::TASK_AIM_GUN_AT_ENTITY(iLocal_66[0], iLocal_67[0], -1, 0);
	...
	else if (iLocal_47 == 2)
	{
		...
		AI::TASK_PLAY_ANIM(iLocal_67[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_67[0], true);
		AI::TASK_PLAY_ANIM(iLocal_67[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_67[1], true);
		AI::TASK_COWER(iLocal_68[0], -1);
		PED::SET_PED_KEEP_TASK(iLocal_68[0], true);
		AI::TASK_PLAY_ANIM(iLocal_68[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_68[1], true);
		vLocal_126 = { -1192.01f, -768.929f, 16.358f };
		vLocal_128 = { 0f, 0f, -59.5f };
		iLocal_135 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_126, vLocal_128, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_135, true);
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		AI::TASK_PLAY_ANIM(iLocal_66[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, 0, 0, 0);
		func_174(14, 1);
		func_173(14);
		SYSTEM::WAIT(500);
		func_171(14, 0, 0);
...
void func_176()
{
	if (!iLocal_74)
	{
		...
		INTERIOR::_LOAD_INTERIOR(iLocal_88);
		iLocal_74 = 1;
	}
}
...
void func_177()
{
	...
	if ((((((((((STREAMING::HAS_MODEL_LOADED(iLocal_138) && STREAMING::HAS_MODEL_LOADED(iLocal_139)) && STREAMING::HAS_MODEL_LOADED(iLocal_140)) && STREAMING::HAS_MODEL_LOADED(iLocal_141)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_anim_cash_pile_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_duffel_01"))) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery2")) && STREAMING::HAS_ANIM_DICT_LOADED("random@robbery")) && STREAMING::HAS_ANIM_DICT_LOADED("random@shop_robbery")) && AUDIO::PREPARE_MUSIC_EVENT("RE51A_SHOP"))
	{
		iLocal_49 = 1;
	}
	else
...
int func_192()
{
	if ((Global_106059 == func_70() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_105117) || Global_25461) || func_217()) || func_124(8, -1)) || func_216()) || func_215()) || func_214()) || func_213()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_218()) || Global_25461) || func_217()) || func_124(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_105117) || Global_25461) || func_217()) || func_124(8, -1)) || func_216()) || func_215()) || func_213()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_218() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_124(8, -1)) || func_213()) || func_212()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_25461) || func_217()) || func_124(8, -1)) || func_215()) || func_214()) || func_213()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_218()) || func_215()) || Global_105117) || Global_25461) || func_217()) || Global_37271) || func_124(8, -1)) || func_214()) || func_212()) || func_213()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_105117) || Global_25461) || func_217()) || func_124(8, -1)) || func_214()) || func_212()) || func_216()) || func_215()) || func_213())
						{
							return 0;
						}
						break;
	...
	if (iLocal_142)
	{
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
			{
				...
				{
					AI::TASK_SMART_FLEE_COORD(iLocal_66[iVar0], vLocal_59, 150f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_65 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_68[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_68[iVar0]))
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_68[iVar0]);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 0.25f, 0, 40000f);
					}
					AI::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_87);
					AI::TASK_PERFORM_SEQUENCE(iLocal_68[iVar0], iLocal_87);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
					PED::SET_PED_KEEP_TASK(iLocal_68[iVar0], true);
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_67[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_67[iVar0]))
				{
					...
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							AI::CLEAR_PED_TASKS(iLocal_67[iVar0]);
							AI::TASK_SMART_FLEE_COORD(iLocal_67[iVar0], vLocal_59, 150f, -1, 0, 0);
						}
						else
						{
					...
					else
					{
						...
						AI::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_87);
						AI::TASK_PERFORM_SEQUENCE(iLocal_67[iVar0], iLocal_87);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
					}
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[iVar0], false);
...
Vector3 func_242()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_71, true);
		iLocal_70 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_72, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_72, true);
			iLocal_70 = 2;
		}
		if (iLocal_70 == 1)
		{
