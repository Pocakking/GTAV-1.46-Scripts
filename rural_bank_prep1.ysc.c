...
void func_8()
{
	...
	switch (iLocal_1295)
	{
		...
		case 1:
			if (func_40(&Local_234, vLocal_49, 0.1f, 0.1f, 2f, 1, Local_65[0 /*2*/], "RHP_RTN", "", "RHP_BK", 1, 0, 1, -1) || (UI::DOES_BLIP_EXIST(Local_234.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_65[0 /*2*/], 1359.476f, 3614.326f, 36.87141f, 1356.748f, 3621.605f, 33.72731f, 5f, 0, true, 0)))
			{
		...
		case 2:
			...
			while (iVar0 <= (9 - 1))
			{
				...
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 400f)
					{
						if (!PED::IS_PED_IN_COMBAT(Local_68[iVar0 /*14*/], 0))
						{
							AI::TASK_COMBAT_PED(Local_68[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
						}
						bLocal_280 = false;
					}
					else
	...
	switch (iLocal_1295)
	{
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], 0))
			{
				...
				if (UI::DOES_BLIP_EXIST(Local_65[0 /*2*/].f_1))
				{
					UI::REMOVE_BLIP(&(Local_65[0 /*2*/].f_1));
				}
				func_111(2);
				iLocal_1295 = 0;
			}
			else if (func_31(Local_65[0 /*2*/]) && !UI::DOES_BLIP_EXIST(Local_65[0 /*2*/].f_1))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_140(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_137(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
var func_115()
{
	...
	func_125(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_124(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_123(&uVar0, TIME::GET_CLOCK_HOURS());
	func_118(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_117(&uVar0, TIME::GET_CLOCK_MONTH());
	func_116(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_121(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_143()
{
	switch (iLocal_1295)
	{
		case 0:
			...
			if (func_31(Local_65[0 /*2*/]) && !UI::DOES_BLIP_EXIST(Local_65[0 /*2*/].f_1))
			{
				if (UI::GET_BLIP_FROM_ENTITY(Local_65[0 /*2*/]) != 0)
				{
					Local_65[0 /*2*/].f_1 = UI::GET_BLIP_FROM_ENTITY(Local_65[0 /*2*/]);
				}
				else
				{
					Local_65[0 /*2*/].f_1 = func_110(Local_65[0 /*2*/], 0, 0);
...
void func_145()
{
	...
	while (iLocal_270 <= (9 - 1))
	{
		...
		if ((((func_31(Local_68[iLocal_270 /*14*/]) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_278) > 8000) && bLocal_279) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_68[iLocal_270 /*14*/])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_68[iLocal_270 /*14*/], 0))
		{
			...
			else if (AI::IS_PED_RUNNING(Local_68[iLocal_270 /*14*/]))
			{
	...
	if (func_31(Local_65[0 /*2*/]) && func_31(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_1294 > 0)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 650f)
			{
				func_187(5);
			}
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 600f)
			{
				if (!iLocal_277)
				{
	...
	if (func_31(Local_65[0 /*2*/]))
	{
		...
		if (bVar0)
		{
			if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], 0) && !PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], -1, 2048, 1);
				}
			}
	...
	if (!iLocal_267)
	{
		...
		else if (iLocal_1294 == 1)
		{
			if (fLocal_264 < 5f)
			{
				fLocal_264 = (fLocal_264 + GAMEPLAY::GET_FRAME_TIME());
			}
		}
		if (fLocal_264 < 3f)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89824[iVar2]))
				{
					if (ENTITY::IS_ENTITY_DEAD(Global_89824[iVar2], 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Global_89824[iVar2], 0))
					{
						iVar4 = VEHICLE::GET_VEHICLE_CAUSE_OF_DESTRUCTION(Global_89824[iVar2]);
	...
	else if (iLocal_1294 >= 1)
	{
		if (AUDIO::IS_AUDIO_SCENE_ACTIVE("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar2 <= 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89824[iVar2]))
				{
					AUDIO::_0x18EB48CFC41F2EA0(Global_89824[iVar2], 0);
				}
				iVar2++;
			}
		}
...
void func_150()
{
	...
	if (iLocal_260 == 3 || iLocal_260 == 1)
	{
		...
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35240[20 /*31*/], fLocal_262, 0, 1);
		OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35240[20 /*31*/], 4, 0, 1);
	}
}
...
void func_154()
{
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			{
				AI::REQUEST_WAYPOINT_RECORDING(sLocal_305);
				...
				if (!bLocal_1301)
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 0)
					{
						AI::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), 1376.77f, 3605.09f, 33.88f, 30f, 786469, 2f);
					}
				}
				else if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_65[0 /*2*/]))
				{
					AI::REQUEST_WAYPOINT_RECORDING(sLocal_305);
					if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_305))
					{
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar1, Local_65[0 /*2*/], sLocal_305, 786469, 0, 8, -1, 10f, 0, 2f);
					}
				}
			}
			else if (func_157(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				if (func_31(Local_68[5 /*14*/]))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 0)
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), Local_68[5 /*14*/], 7, 15f, 786469, 15f, -1f, 1);
					}
				}
			}
			else
		...
		case 0:
			if (!bLocal_279)
			{
				...
				if (((((func_31(Local_68[4 /*14*/]) && func_31(Local_68[0 /*14*/])) && func_31(Local_68[5 /*14*/])) && func_31(Local_65[1 /*2*/])) && func_31(Local_65[2 /*2*/])) && func_31(Local_65[0 /*2*/]))
				{
					...
					{
						AI::SET_DRIVE_TASK_CRUISE_SPEED(Local_68[0 /*14*/], fVar2);
					}
				}
			}
			else
						...
						case 0:
							if (!func_182(Local_68[0 /*14*/], 242628503, 1))
							{
								if (iLocal_260 == 2 || (iLocal_260 == 3 && fLocal_262 > 0.8f))
								{
									...
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_65[1 /*2*/], -1785.46f, 3169.625f, 31.93f, 4, 10f, 786603, 3f, 3f, 1);
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_65[1 /*2*/], -1885.875f, 3006.152f, 31.81027f, 4, 10f, 786603, -1f, -1f, 1);
									AI::CLOSE_SEQUENCE_TASK(iVar4);
									AI::TASK_PERFORM_SEQUENCE(Local_68[0 /*14*/], iVar4);
									AI::CLEAR_SEQUENCE_TASK(&iVar4);
								}
							}
							if (!func_182(Local_68[4 /*14*/], -1273030092, 1))
							{
								AI::TASK_VEHICLE_ESCORT(Local_68[4 /*14*/], Local_65[0 /*2*/], Local_65[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
							if (!func_182(Local_68[5 /*14*/], -1273030092, 1))
							{
								AI::TASK_VEHICLE_ESCORT(Local_68[5 /*14*/], Local_65[2 /*2*/], Local_65[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
							if (ENTITY::IS_ENTITY_AT_COORD(Local_68[0 /*14*/], -1885.875f, 3006.152f, 31.81027f, 5f, 5f, 5f, false, true, 0))
							{
								...
								while (iVar0 <= (9 - 1))
								{
									if (func_31(Local_68[iVar0 /*14*/]))
									{
										...
										{
											AI::TASK_LEAVE_ANY_VEHICLE(Local_68[iVar0 /*14*/], 200, 65536);
										}
										else if ((iVar0 == 1 || iVar0 == 6) || iVar0 == 7)
										{
											AI::TASK_LEAVE_ANY_VEHICLE(Local_68[iVar0 /*14*/], 0, 65536);
										}
										else
										{
											AI::TASK_LEAVE_ANY_VEHICLE(Local_68[iVar0 /*14*/], 1000, 65536);
										}
			...
			switch (iLocal_258)
			{
					...
					switch (iLocal_259)
					{
						...
						case 1:
							if (func_31(Local_68[0 /*14*/]) && func_31(Local_65[1 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									if (ENTITY::GET_ENTITY_SPEED(Local_68[0 /*14*/]) > 5f)
									{
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 5, 1000);
									}
									else
									{
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 14, 1500);
									}
									AI::TASK_LEAVE_ANY_VEHICLE(0, 720, 65536);
									AI::CLOSE_SEQUENCE_TASK(iLocal_269);
									AI::TASK_PERFORM_SEQUENCE(Local_68[0 /*14*/], iLocal_269);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_269);
								}
							}
							if (func_31(Local_68[4 /*14*/]) && func_31(Local_65[0 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_68[4 /*14*/], Local_65[0 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[0 /*2*/], 4, 2500);
									}
									else
									{
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[0 /*2*/], 13, 1500);
									}
									AI::TASK_LEAVE_ANY_VEHICLE(0, 500, 65536);
									AI::CLOSE_SEQUENCE_TASK(iLocal_269);
									AI::TASK_PERFORM_SEQUENCE(Local_68[4 /*14*/], iLocal_269);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_269);
								}
							}
							if ((func_31(Local_68[5 /*14*/]) && func_31(Local_65[2 /*2*/])) && func_31(Local_65[1 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_68[5 /*14*/], Local_65[2 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_65[2 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_65[1 /*2*/], -3f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[2 /*2*/], 5, 1000);
									AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 65536);
									AI::CLOSE_SEQUENCE_TASK(iLocal_269);
									AI::TASK_PERFORM_SEQUENCE(Local_68[5 /*14*/], iLocal_269);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_269);
								}
							}
							iLocal_258 = 1;
						...
						case 2:
							if (func_31(Local_68[0 /*14*/]) && func_31(Local_65[1 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 5, 1500);
							...
							if (func_31(Local_68[4 /*14*/]) && func_31(Local_65[0 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[0 /*2*/], 5, 1000);
							...
							if ((func_31(Local_68[5 /*14*/]) && func_31(Local_65[2 /*2*/])) && func_31(Local_65[0 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_68[5 /*14*/], Local_65[2 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_65[2 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_65[0 /*2*/], -2f, 1f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
						...
						case 3:
							if ((func_31(Local_68[0 /*14*/]) && func_31(Local_65[1 /*2*/])) && func_31(Local_65[2 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 6, 500);
									if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_65[1 /*2*/], false), ENTITY::GET_ENTITY_COORDS(Local_65[2 /*2*/], false)) < 1000f)
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_65[1 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_65[2 /*2*/], 2f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 5, 1000);
							...
							if (func_31(Local_68[4 /*14*/]) && func_31(Local_65[0 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_68[4 /*14*/], Local_65[0 /*2*/], 0))
								{
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_269);
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[0 /*2*/], 5, 1500);
							...
							if (func_31(Local_68[5 /*14*/]) && func_31(Local_65[2 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_68[5 /*14*/], Local_65[2 /*2*/], 0))
								{
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_269);
										AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[2 /*2*/], 4, 1500);
						...
						case 4:
							if (func_31(Local_68[0 /*14*/]) && func_31(Local_65[1 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[1 /*2*/], 4, 1500);
							...
							if (func_31(Local_68[4 /*14*/]) && func_31(Local_65[0 /*2*/]))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_65[0 /*2*/], 4, 1500);
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_68[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if ((iVar0 != 0 && iVar0 != 4) && iVar0 != 5)
							{
								...
								AI::CLOSE_SEQUENCE_TASK(iLocal_269);
								AI::TASK_PERFORM_SEQUENCE(Local_68[iVar0 /*14*/], iLocal_269);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_269);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*14*/], 3, true);
							}
						}
				...
				case 2:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_68[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], false), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 75f)
							{
								if (!Local_68[iVar0 /*14*/].f_12 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_288) > iLocal_287)
								{
				...
				case 3:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_68[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], false), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 120f)
							{
								PED::SET_PED_COMBAT_MOVEMENT(Local_68[iVar0 /*14*/], 1);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*14*/], 51, false);
								Local_68[iVar0 /*14*/].f_12 = 0;
				...
				case 4:
					...
					while (iVar0 <= (9 - 1))
					{
						if ((func_31(PLAYER::PLAYER_PED_ID()) && func_31(Local_68[iVar0 /*14*/])) && func_31(Local_65[0 /*2*/]))
						{
							...
							else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], 0) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], false), ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], false), true) > (120f / 2f))
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*14*/], 1, true);
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], false), true) > (120f * 2f))
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(Local_68[iVar0 /*14*/], 0) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_68[iVar0 /*14*/]))
									{
										...
										if (func_31(iVar9))
										{
											...
											if (func_167(iVar9))
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_68[iVar0 /*14*/], -1794415470) != 1)
												{
													AI::TASK_ENTER_VEHICLE(Local_68[iVar0 /*14*/], iVar9, 1000, iVar8, 2f, 16, 0);
												}
								...
								else if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_68[iVar0 /*14*/]))
								{
									if (func_166(PLAYER::PLAYER_PED_ID(), Local_68[iVar0 /*14*/], 1) < 35f)
									{
										...
										{
											if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_290) > 40000)
											{
												if (bLocal_291)
												{
													bLocal_291 = false;
											...
											if (bLocal_291)
											{
												...
												{
													AI::TASK_VEHICLE_ESCORT(Local_68[iVar0 /*14*/], PED::GET_VEHICLE_PED_IS_IN(Local_68[iVar0 /*14*/], 0), Local_65[0 /*2*/], 1, 11f, 786468, -1f, 20, 0f);
												}
											}
											else if (!PED::IS_PED_IN_COMBAT(Local_68[iVar0 /*14*/], 0))
											{
...
void func_174()
{
	...
	while (iVar0 <= (9 - 1))
	{
		if (func_31(Local_68[iVar0 /*14*/]))
		{
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_289) > 800)
			{
			...
			if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(Local_68[iVar0 /*14*/], PLAYER::PLAYER_PED_ID()) && (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_68[iVar0 /*14*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68[iVar0 /*14*/])))
			{
				if (iLocal_282 != 0)
				{
					if (WEAPON::GET_WEAPONTYPE_GROUP(iLocal_282) != -728555052 && iLocal_282 != joaat("weapon_unarmed"))
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - Local_68[iVar0 /*14*/].f_11) > 800)
						{
							bLocal_279 = true;
						}
					}
			...
			{
				Local_68[iVar0 /*14*/].f_11 = GAMEPLAY::GET_GAME_TIMER();
			}
		}
		else
		{
...
bool func_175()
{
	return GAMEPLAY::IS_BIT_SET(Global_2524719.f_784, 2);
}
		...
		switch (iLocal_256)
		{
			case 0:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar2, vVar3, 9f, 0, true, 0))
				{
					...
					{
						fLocal_1300[1] = (fLocal_1300[1] + GAMEPLAY::GET_FRAME_TIME());
					}
					else if (fLocal_1300[1] > 0f)
					{
						fLocal_1300[1] = (fLocal_1300[1] - (GAMEPLAY::GET_FRAME_TIME() * 10f));
					}
				}
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, 9f, 0, true, 0))
				{
					...
					{
						fLocal_1300[0] = (fLocal_1300[0] + GAMEPLAY::GET_FRAME_TIME());
					}
					else if (fLocal_1300[0] > 0f)
					{
						fLocal_1300[0] = (fLocal_1300[0] - (GAMEPLAY::GET_FRAME_TIME() * 10f));
					}
				}
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar4, vVar5, 9f, 0, true, 0))
				{
					...
					{
						fLocal_1300[2] = (fLocal_1300[2] + GAMEPLAY::GET_FRAME_TIME());
					}
					else if (fLocal_1300[2] > 0f)
					{
						fLocal_1300[2] = (fLocal_1300[2] - (GAMEPLAY::GET_FRAME_TIME() * 10f));
					}
				}
				if (fLocal_1300[1] > 1.5f)
				{
					iLocal_295 = Local_68[0 /*14*/];
					AI::CLEAR_PED_TASKS(Local_68[4 /*14*/]);
					AI::CLEAR_PED_TASKS(Local_68[0 /*14*/]);
					AI::CLEAR_PED_TASKS(Local_68[5 /*14*/]);
					...
					AI::TASK_AIM_GUN_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1000, 0, 1);
					AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 3f, 1082130432, 1, 0, -957453492);
				...
				else
				{
					...
					{
						if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_65[1 /*2*/]))
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_68[0 /*14*/], Local_65[1 /*2*/], &cLocal_296, 786603, 0, 24, -1, 11f, 0, 1073741824);
						}
						if (AI::GET_SCRIPT_TASK_STATUS(Local_68[4 /*14*/], -1273030092) != 1)
						{
							AI::TASK_VEHICLE_ESCORT(Local_68[4 /*14*/], Local_65[0 /*2*/], Local_65[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
						}
						if (AI::GET_SCRIPT_TASK_STATUS(Local_68[5 /*14*/], -1273030092) != 1)
						{
							AI::TASK_VEHICLE_ESCORT(Local_68[5 /*14*/], Local_65[2 /*2*/], Local_65[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
						}
			...
			case 1:
				switch (iLocal_293)
				{
					...
					case 1:
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_294) > 8000 && !func_9())
						{
							if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_295, 0))
							{
								func_28(&uLocal_69, 1, iLocal_295, "Armyped", 0, 1);
					...
					case 3:
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_294) > 8000 && !func_9())
						{
							if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_295, 0))
							{
								...
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_269);
									AI::TASK_SHOOT_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0.5f, 0f, -1f), 1000, 1566631136);
									AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 4f, 1082130432, 1, 0, -957453492);
									AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
									AI::CLOSE_SEQUENCE_TASK(iLocal_269);
									AI::TASK_PERFORM_SEQUENCE(iLocal_295, iLocal_269);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_269);
									iLocal_294 = GAMEPLAY::GET_GAME_TIMER();
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_295, 1630799643) != 1)
					{
						AI::TASK_AIM_GUN_AT_ENTITY(iLocal_295, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
					if (SYSTEM::TIMERA() > 3000)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_295, 0))
						{
							...
							{
								AI::TASK_ENTER_VEHICLE(iLocal_295, Local_65[0 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_295 == Local_68[0 /*14*/])
							{
								AI::TASK_ENTER_VEHICLE(iLocal_295, Local_65[1 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_295 == Local_68[5 /*14*/])
							{
								AI::TASK_ENTER_VEHICLE(iLocal_295, Local_65[2 /*2*/], 20000, -1, 2f, 1, 0);
							}
						}
						iLocal_256 = 2;
					}
				...
				else
				{
					if (iLocal_293 == 4)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_294) > 9000 && !func_9())
						{
							bLocal_279 = true;
						}
					}
...
void func_204(vector3 vParam0, float fParam1)
{
	...
	AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
void func_208(vector3 vParam0, float fParam1)
{
	...
	AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
void func_211(vector3 vParam0, float fParam1)
{
	...
	AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
void func_232()
{
	switch (iLocal_1293)
	{
		...
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1297) > 2500)
			{
				iLocal_1297 = GAMEPLAY::GET_GAME_TIMER();
			}
			break;
	}
}
...
int func_241(char* sParam0)
{
	if (!func_242(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_234(sParam0)) || func_234("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_242(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_250() || func_249(Global_4456448.f_152990)) || func_248())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_246(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_243(int iParam0)
{
	if (iParam0 != func_245())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_244(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_264()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_307, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_307);
...
{
	func_269(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_287(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_289(Var7.f_1)) && iVar9 < 50)
			{
...
int func_299(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_301() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_279(func_300(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_303(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_318(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_304(iVar0, 0), true);
...
int func_332()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89824[0]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89824[0], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
			func_205(Local_65[0 /*2*/], 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89824[1]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89824[1], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89824[2]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89824[2], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[9]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_9[9], true, 1);
...
void func_336()
{
	...
	while (iLocal_270 <= (3 - 1))
	{
		if (func_31(Local_66[iLocal_270 /*2*/]))
		{
			...
			if (UI::DOES_BLIP_EXIST(Local_66[iLocal_270 /*2*/].f_1))
			{
				UI::REMOVE_BLIP(&(Local_66[iLocal_270 /*2*/].f_1));
			}
		}
		iLocal_270++;
	}
	...
	while (iLocal_270 <= (9 - 1))
	{
		if (func_31(Local_68[iLocal_270 /*14*/]))
		{
			...
			if (UI::DOES_BLIP_EXIST(Local_68[iLocal_270 /*14*/].f_1))
			{
				UI::REMOVE_BLIP(&(Local_68[iLocal_270 /*14*/].f_1));
			}
			func_230(&(Local_68[iLocal_270 /*14*/].f_2));
		}
		iLocal_270++;
	...
	while (iLocal_270 <= (3 - 1))
	{
		...
		if (UI::DOES_BLIP_EXIST(Local_65[iLocal_270 /*2*/].f_1))
		{
			UI::REMOVE_BLIP(&(Local_65[iLocal_270 /*2*/].f_1));
		}
		iLocal_270++;
	}
	func_338(0);
	...
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(10, true);
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(9, true);
	GAMEPLAY::_0xD9F692D349249528();
