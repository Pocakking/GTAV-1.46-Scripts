		...
		if (iVar5 == 1 && Global_17367.f_5726)
		{
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_4690)) != 0 && Global_17367.f_4764 != -1)
			{
				...
				if (Global_17367.f_4766 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4766), func_100(Global_17367.f_4766, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_4266986.f_21)) != 0 && Global_4266986.f_65 != -1)
			{
				...
				if (Global_4266986.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_103(Global_4266986.f_67), func_100(Global_4266986.f_67, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((UI::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
												...
												if (Global_17367.f_4433[(iVar22 + iVar28)] == 2 || Global_17367.f_4433[(iVar22 + iVar28)] == 48)
												{
													if (func_105(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														if (func_105(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[(iVar22 + iVar28)]), func_100(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[(iVar22 + iVar28)]), func_100(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
												...
												if (Global_17367.f_4433[(iVar22 + iVar14)] != 2 && Global_17367.f_4433[(iVar22 + iVar14)] != 48)
												{
													if (func_105(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														if (func_105(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[(iVar22 + iVar14)]), func_100(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (Global_17364 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[(iVar22 + iVar14)]), func_100(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[(iVar22 + iVar14)]), func_100(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
									...
									if (iVar5 == 1 && bVar33)
									{
										if (func_105(Global_17367.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_105(Global_17367.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_103(Global_17367.f_4433[iVar22]), func_100(Global_17367.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), (fVar36 * func_82(Global_17367.f_4433[iVar22])), (fVar37 * func_82(Global_17367.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
									bVar39 = true;
...
var func_100(int iParam0, bool bParam1)
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Global_17367.f_6863[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_102(PLAYER::PLAYER_ID()) };
		...
		if (func_139())
		{
			...
			if (func_60(iLocal_56[iVar0]))
			{
				if (bLocal_55)
				{
					...
					{
						AI::STOP_ANIM_TASK(iLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], -8f);
					}
					func_128(iVar0);
				}
			}
...
void func_127()
{
	if (iLocal_45 && GAMEPLAY::GET_GAME_TIMER() > iLocal_48)
	{
		UI::CLEAR_HELP(1);
		iLocal_45 = 0;
	}
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_56[iParam0], 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_77)
		{
			...
			case 1:
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_56[iParam0], iVar0);
				AI::CLEAR_SEQUENCE_TASK(&iVar0);
				iLocal_77 = 2;
				break;
			
			case 2:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_56[iParam0], 242628503) != 1 || PED::IS_PED_FACING_PED(iLocal_56[iParam0], PLAYER::PLAYER_PED_ID(), 20f))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_56[iParam0], PLAYER::PLAYER_PED_ID(), -1);
					if (!iLocal_79)
					{
			...
			case 3:
				...
				{
					func_133(&iLocal_80);
					AI::TASK_PLAY_ANIM(iLocal_56[iParam0], "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0f, 0, 0, 0);
					iLocal_77 = 4;
				}
				break;
...
float func_129(int iParam0)
{
	if (func_132(iParam0))
	{
		...
		{
			return (func_130(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_130(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_139()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (func_80(0) || SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) > 0)
				{
					func_127();
					return 0;
				}
...
int func_156()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_44, true) < IntToFloat(iVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
		{
			return 1;
		}
	}
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_57))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_71) && STREAMING::HAS_MODEL_LOADED(iLocal_71))
					{
						...
						if (PED::CAN_CREATE_RANDOM_PED(1) && PED::CAN_CREATE_RANDOM_DRIVER())
						{
							...
							AI::TASK_VEHICLE_TEMP_ACTION(iLocal_58, iLocal_57, 1, 99999999);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_73))
				{
					if (iLocal_75)
					{
						...
						while (iVar0 <= (iLocal_70 - 1))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_56[iVar0], 0) && !func_158(iLocal_56[iVar0], -2017877118))
								{
									AI::TASK_PLAY_ANIM(iLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], 1000f, -1000f, -1, 1, 0f, 0, 0, 0);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_73))
				{
					if (iLocal_75)
					{
						...
						while (iVar1 <= (iLocal_70 - 3))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_56[iVar1], 0) && !func_158(iLocal_56[iVar1], -2017877118))
								{
									ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_56[iVar1], vLocal_66[iVar1 /*3*/], 0, 0, 1);
									if (iVar1 != 2 && iVar1 != 3)
									{
										AI::TASK_PLAY_ANIM(iLocal_56[iVar1], cLocal_73, sLocal_74[iVar1], 1000f, -1000f, -1, 1, 0f, 0, 0, 0);
									}
									else
									{
										AI::TASK_PLAY_ANIM(iLocal_56[iVar1], cLocal_73, sLocal_74[iVar1], 1000f, -1000f, -1, 1, 0.5f, 0, 0, 0);
									}
						...
						{
							AI::TASK_LOOK_AT_ENTITY(iLocal_56[4], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
							iVar1 = 0;
...
int func_159()
{
	...
	if (func_60(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_160(PLAYER::PLAYER_PED_ID(), vLocal_59, 100f) || CAM::IS_SCREEN_FADED_OUT())
		{
			return 1;
		}
	}
...
int func_175()
{
	...
	if (func_60(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((func_14(iVar0) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0)) && !func_197(PLAYER::PLAYER_PED_ID(), iVar0, -1)) && ENTITY::GET_ENTITY_MODEL(iVar0) != joaat("taxi"))
		{
			return 0;
		}
	}
	...
	if (!func_161())
	{
		...
		while (iVar1 <= (iLocal_70 - 1))
		{
			if (func_60(iLocal_56[iVar1]))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_56[iVar1], iVar2);
			}
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 <= (iLocal_69 - 1))
		{
			if (func_60(iLocal_69[iVar1]))
			{
				...
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_68[iVar1], 30f, 786597);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				...
				AI::CLOSE_SEQUENCE_TASK(iVar2);
				AI::TASK_PERFORM_SEQUENCE(iLocal_69[iVar1], iVar2);
			}
			iVar1++;
		}
		if (func_60(iLocal_58))
		{
			...
			{
				AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_58, iLocal_57, 30f, 786597);
			}
			else
			{
	...
	if (func_177())
	{
		...
		while (iVar4 <= (iLocal_70 - 1))
		{
			if (func_60(iLocal_56[iVar4]))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_56[iVar4], iVar3);
			}
			iVar4++;
		}
		iVar4 = 0;
		while (iVar4 <= (iLocal_69 - 1))
		{
			...
			if (func_60(iLocal_69[iVar4]))
			{
				...
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_68[iVar4], 50f, 786468);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				...
				AI::CLOSE_SEQUENCE_TASK(iVar3);
				AI::TASK_PERFORM_SEQUENCE(iLocal_69[iVar4], iVar3);
				if ((iVar4 % 2) == 0)
				{
		...
		if (func_60(iLocal_58))
		{
			if (func_14(iLocal_57) && PED::IS_PED_IN_VEHICLE(iLocal_58, iLocal_57, 0))
			{
				AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_58, iLocal_57, 50f, 786468);
			}
			else
			{
				AI::TASK_SMART_FLEE_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
		}
		switch (Local_43)
		{
...
int func_177()
{
	...
	if (func_160(PLAYER::PLAYER_PED_ID(), vLocal_44, 50f) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	...
	if (func_15(PLAYER::PLAYER_PED_ID()) && func_15(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_191(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
bool func_181(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_40[iVar2 /*4*/].f_3) < iParam4);
}
...
void func_199()
{
	...
	if (Local_43 == 1)
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(374.0083f, 279.5919f, 102.3306f, 25f, 0, 0, 0, 0, false, 0);
	}
	if (Local_43.f_1 == 1 || Local_43.f_1 == 2)
	{
...
void func_210(bool bParam0)
{
	...
	while (iVar0 < 7)
	{
		...
		{
			AI::CLEAR_PED_TASKS(iLocal_56[iVar0]);
			AI::TASK_WANDER_STANDARD(iLocal_56[iVar0], 1193033728, 0);
	...
	if (func_15(iLocal_58))
	{
		if (func_15(iLocal_57))
		{
			...
			AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_58, iLocal_57, 15f, 786599);
			PED::SET_PED_KEEP_TASK(iLocal_58, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_58, false);
