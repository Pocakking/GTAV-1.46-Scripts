				...
				case 7:
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED"))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED", "front", 3))
						{
							...
							{
								AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "GET_UP@DIRECTIONAL@TRANSITION@PRONE_TO_SEATED@INJURED", "front", 8f, -8f, -1, 2, 0f, 0, 0, 0);
							}
						...
						{
							AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "get_up@directional@movement@from_seated@standard", "get_up_l_0", 8f, -8f, -1, 2, 0f, 0, 0, 0);
						}
...
int func_17()
{
	...
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("spawn_activities")) == 0)
		{
	...
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("spawn_activities")) == 0)
	{
		func_22();
		return 1;
	}
		...
		switch (Global_2409250)
		{
			...
			case 6:
				if (func_6(PLAYER::PLAYER_ID(), 0, 0))
				{
					...
					if (Global_2409250.f_1 == 1)
					{
						if (!func_96(Global_2409250) || NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_100) > 20000)
						{
							Global_2409250.f_16 = 1;
							func_95();
						}
...
void func_49()
{
	...
	if ((((((GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 5) || GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 6)) || GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 8)) || GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 7)) || GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 9)) || GAMEPLAY::IS_BIT_SET(Global_1589396.f_22, 20)) || func_94())
	{
		...
		{
			if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("am_mp_property_int")) <= 0 && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_MP_PROPERTY_INT", Global_1048576.f_1164, 1, 0))
			{
	...
	else if (((((!GAMEPLAY::IS_BIT_SET(Global_1048576.f_8, 0) && !GAMEPLAY::IS_BIT_SET(Global_2524719.f_382.f_5, 3)) && (!Global_2405069 || (Global_2405069 && Global_2449169.f_1.f_2826.f_13 > 0))) && !func_92()) && !func_87()) && !func_86())
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("am_mp_property_int")) <= 0 && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_MP_PROPERTY_INT", Global_1048576.f_1164, 1, 0))
		{
			...
			{
				if (!func_80(Global_1048576.f_1163) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), func_78(Global_1048576.f_1163), true) <= 30f)
				{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), func_62(2), true) <= 30f)
				{
					func_61(&Var1, 2);
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), func_62(6), true) <= 30f)
				{
					func_61(&Var1, 6);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var1, Var1.f_3, Var1.f_6, 0, true, 0))
					{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), func_62(10), true) <= 30f)
				{
					func_61(&Var1, 10);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var1, Var1.f_3, Var1.f_6, 0, true, 0))
					{
...
int func_76(var uParam0, int iParam1, float fParam2)
{
	...
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), uParam0->f_1742.f_150, true) <= 30f)
		{
	...
	else
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), uParam0->f_146.f_47, true) <= 40f)
		{
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, uParam0->f_146.f_1592, true) < (uParam0->f_146.f_1595 + fParam2) && (vVar0.z > uParam0->f_146.f_57[2 /*8*/].f_2 && vVar0.z < uParam0->f_146.f_57[2 /*8*/].f_3.f_2))
			{
				return 1;
			}
		}
...
Vector3 func_78(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 42:
		case 43:
			vVar1 = { Global_1049778[iParam0 /*1951*/].f_146.f_47 };
			break;
...
int func_81()
{
	...
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), Global_3934119[Global_1048576.f_1165 /*2012*/].f_146.f_47, true) <= 30f)
		{
...
int func_139()
{
	...
	if (func_140() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_140()) == 0)
		{
			return 1;
		}
	}
