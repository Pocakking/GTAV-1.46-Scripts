...
int func_22()
{
	...
	if (!iLocal_90)
	{
		...
		{
			if (UI::GET_BLIP_FROM_ENTITY(Local_1295) != 0)
			{
				Local_1295.f_1 = UI::GET_BLIP_FROM_ENTITY(Local_1295);
			}
			else
			{
		...
		else if (UI::GET_BLIP_FROM_ENTITY(Local_1295) != 0)
		{
			GAMEPLAY::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
			iVar3 = UI::GET_BLIP_FROM_ENTITY(Local_1295);
			UI::REMOVE_BLIP(&iVar3);
	...
	if (iLocal_90)
	{
		...
		switch (iLocal_89)
		{
			case 1:
				...
				{
					if (UI::DOES_BLIP_EXIST(Local_1295.f_1))
					{
						UNK1::_0x293220DA1B46CEBC(5f, 5f, 4);
						GAMEPLAY::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
						UI::REMOVE_BLIP(&(Local_1295.f_1));
						GAMEPLAY::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(0);
						func_96(705, 0);
					}
				...
				{
					func_97(&iLocal_1080, 1, 0);
					if (!UI::DOES_BLIP_EXIST(Local_1298[0 /*2*/].f_1))
					{
						UNK1::_0x293220DA1B46CEBC(5f, 5f, 4);
				...
				else if (iLocal_1282 == 0)
				{
					...
					if (UI::DOES_BLIP_EXIST(iLocal_1080) && UI::_0xDD2238F57B977751(iLocal_1080))
					{
						UI::SET_BLIP_ROUTE(iLocal_1080, false);
					}
				}
				break;
			...
			case 2:
				if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
				{
					...
					while (iVar2 < Local_1298)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1298[iVar2 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1298[iVar2 /*2*/]))
						{
							...
							if (!UI::DOES_BLIP_EXIST(Local_1298[iVar2 /*2*/].f_1))
							{
				...
				else
				{
					...
					while (iVar2 < Local_1298)
					{
						if (UI::DOES_BLIP_EXIST(Local_1298[iVar2 /*2*/].f_1))
						{
							UI::REMOVE_BLIP(&(Local_1298[iVar2 /*2*/].f_1));
						}
						iVar2++;
					}
					...
					if (bVar7)
					{
						...
						if (CONTROLS::IS_CONTROL_JUST_PRESSED(0, 51) && iVar6 == joaat("weapon_briefcase"))
						{
							if (func_12("JHP2A_HLP1"))
							{
								UI::CLEAR_HELP(1);
...
void func_23()
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90696[iVar0]))
		{
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Global_90696[iVar0], false, false, false, false, false, false, 0, false);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_60(iParam0, 1) && !func_59(iParam0)) && !GAMEPLAY::IS_BIT_SET(iParam0->f_13, 0))
					{
						if (bParam22)
						{
				...
				else
				{
					...
					else if (!func_53(vVar3, UI::GET_BLIP_COORDS(iParam0->f_5), 0.1f, 0))
					{
...
int func_45(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_46(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_46(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_47(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_48(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_48(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
						...
						if (func_64(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_82(uParam0->f_17[iVar0], uParam0->f_21))
									{
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar21))
						{
							...
							{
								if (func_76(iVar0, uParam0) || !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_71(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !AI::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], true);
...
void func_68(var uParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!GAMEPLAY::IS_STRING_NULL(sParam1))
		{
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(sParam1, ""))
			{
				func_69(sParam1, sParam2, 7500, 1);
			}
		}
	}
...
void func_69(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
int func_88(int iParam0)
{
	...
	vVar0 = { GAMEPLAY::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, vLocal_86), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, vLocal_87), 0) };
...
int func_109(int iParam0)
{
	if (iParam0 != func_111())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_110(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_185(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_182(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
var func_154()
{
	...
	func_164(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_163(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_162(&uVar0, TIME::GET_CLOCK_HOURS());
	func_157(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_156(&uVar0, TIME::GET_CLOCK_MONTH());
	func_155(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_177(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_187()
{
	...
	{
		if (func_189(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
		...
		else
		{
			...
			switch (iLocal_88)
			{
				case 0:
					...
					if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_90189, "jhp2a_main"))
					{
						while (!func_205(&iLocal_1293, 1395.851f, -1069.306f, 52.4779f, 118.1591f, 1))
						{
							SYSTEM::WAIT(0);
							GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1395.851f, -1069.306f, 52.4779f, 20f, 0, 0, 0, 0, false, 0);
						}
					}
					else
					{
						...
						{
							SYSTEM::WAIT(0);
							GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1256.913f, 556.8416f, 79.7013f, 20f, 0, 0, 0, 0, false, 0);
						}
					}
...
void func_246(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_177(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_249(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_248())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar2 + 1)))
				{
...
int func_257(int iParam0, var uParam1)
{
	...
	{
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GAMEPLAY::GET_HASH_KEY(&(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam0 /*98*/].f_27)) == GAMEPLAY::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	{
		if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GAMEPLAY::GET_HASH_KEY(&(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam0 /*98*/].f_27)) == GAMEPLAY::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
...
int func_261(bool bParam0)
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_84)) && STREAMING::HAS_MODEL_LOADED(iLocal_85))
	{
		...
		{
			func_270(&uLocal_94, iLocal_83);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_83) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_90189))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_90189, "jhp2a_main"))
				{
					AI::WAYPOINT_RECORDING_GET_COORD(&Global_90189, 23, &vVar1);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, false, 0);
					...
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1295, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_90189, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					AI::WAYPOINT_RECORDING_GET_COORD(&Global_90189, 29, &vVar1);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, false, 0);
					Local_1295 = VEHICLE::CREATE_VEHICLE(iLocal_83, vVar1, 134.0011f, true, true, false);
					vLocal_1285.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1295, 26, iLocal_82, -1, 1, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1295, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_90189, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1295))
...
void func_264()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1295))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1298[0 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1295, 0))
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_REGISTER(Local_1298[0 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1298[1 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_REGISTER(Local_1298[1 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1298[2 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::_SET_ENTITY_REGISTER(Local_1298[2 /*2*/], true);
			}
		}
	}
}
...
void func_280()
{
	...
	func_281();
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Global_90189))
	{
	}
		...
		else
		{
			switch (uParam0->f_1)
			{
				case 1:
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1306) > 150)
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1299, PLAYER::PLAYER_PED_ID(), 0))
							{
								...
								else
								{
									...
									iLocal_1306 = GAMEPLAY::GET_GAME_TIMER();
									iLocal_1305++;
									if (iLocal_1305 >= 3)
									{
										AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Destroyed", iLocal_1299, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
									else
									{
										AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Damage", iLocal_1299, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
								}
							}
						}
				...
				case 2:
					...
					{
						if (GAMEPLAY::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1295, 2)) > 0.5f && GAMEPLAY::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1295, 3)) > 0.5f)
						{
...
void func_293(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (bParam1)
		{
			vVar0 = { func_294(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3, 6)), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
			ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(iParam0, 1, vVar0 * FtoV(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.25f, 0.5f)), 0, 1, 1, 0);
			ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(iParam0, 5, IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), 0, 1, 1, 0);
		...
		else
		{
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					{
						if ((!iLocal_1302 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_1304) > 500) && fLocal_1303 >= 4f)
						{
							iLocal_1302 = 1;
							iLocal_1301++;
						}
					...
					{
						iLocal_1304 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_1302 = 0;
					}
			...
			switch (uParam0->f_1)
			{
				case 1:
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1295, 0))
						{
							if ((ENTITY::IS_ENTITY_STATIC(PLAYER::PLAYER_PED_ID()) || fLocal_1303 > 0.5f) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, 0f, 2f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1295, 0f, 10f, 2f), 4.5f, 0, true, 0))
							{
								if (!AUDIO::IS_HORN_ACTIVE(Local_1295))
								{
									if (iLocal_1318 == -1)
									{
										iLocal_1318 = GAMEPLAY::GET_GAME_TIMER();
									}
									else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1318) > 5000)
									{
						...
						if (!func_298(vLocal_1285.x, -235832601, 1))
						{
							...
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, &Global_90189, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
				...
				case 2:
					...
					else if (!func_298(vLocal_1285.x, -235832601, 1))
					{
						...
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1285.x, Local_1295, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
						}
					}
					break;
				...
				case 3:
					...
					else if (PED::IS_PED_IN_VEHICLE(vLocal_1285.x, Local_1295, 1))
					{
						...
						{
							AI::TASK_LEAVE_VEHICLE(vLocal_1285.x, Local_1295, 0);
						}
					}
					else
					{
						...
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_1283);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1093.486f, -2471.669f, 13.0716f, 1f, -1, 1048576000, 0, 1193033728);
							AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", -1, 1);
							AI::CLOSE_SEQUENCE_TASK(iLocal_1283);
							AI::TASK_PERFORM_SEQUENCE(vLocal_1285.x, iLocal_1283);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_1283);
						}
					}
					break;
				...
				case 4:
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1285.x, Local_1295, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
					}
					break;
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && !ENTITY::IS_ENTITY_DEAD(Local_1295, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(vLocal_1285.x, Local_1295, 0))
						{
							if (!func_81(Local_1295))
							{
								...
								{
									AI::CLEAR_PED_TASKS(vLocal_1285.x);
									AI::TASK_VEHICLE_TEMP_ACTION(vLocal_1285.x, Local_1295, 5, -1);
								}
							}
							else if (!func_298(vLocal_1285.x, 451360105, 1))
							{
								AI::TASK_LEAVE_VEHICLE(vLocal_1285.x, Local_1295, 256);
							}
						}
						else if (!func_298(vLocal_1285.x, 780511057, 1))
						{
							PED::SET_PED_CAN_BE_TARGETTED(vLocal_1285.x, true);
							AI::TASK_COMBAT_PED(vLocal_1285.x, PLAYER::PLAYER_PED_ID(), 0, 16);
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(Local_1295) && !ENTITY::IS_ENTITY_DEAD(Local_1295, 0))
					{
				...
				case 4:
					switch (iLocal_1307)
					{
						...
						case 2:
							if (func_36() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
								if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_1309))
								{
									fVar4 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_1285.x, true));
									if ((((((iLocal_1302 || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 122)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1285.x, 124)) || fVar4 < 49f) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_1308) > 5000) && fVar4 < 225f)
									{
								...
								if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_1309))
								{
									if (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_1309, "GENERIC_CURSE_HIGH"))
									{
						...
						case 3:
							...
							{
								iLocal_1308 = GAMEPLAY::GET_GAME_TIMER();
								StringCopy(&cLocal_1309, "", 24);
					...
					switch (iLocal_1307)
					{
						case 0:
							if (func_36() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1285.x))
							{
								if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_1309))
								{
									if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1308) > 5000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_1285.x, true)) < 400f)
									{
										if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
										{
								...
								if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_1309))
								{
									if (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_1309, "GENERIC_INSULT_HIGH"))
									{
