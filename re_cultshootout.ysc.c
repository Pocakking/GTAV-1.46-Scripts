...
void func_1()
{
	if (iLocal_54 && !iLocal_53)
	{
		...
		while (iLocal_71 < 6)
		{
			...
			{
				if (UI::DOES_BLIP_EXIST(uLocal_68[iLocal_71]))
				{
					UI::REMOVE_BLIP(&(uLocal_68[iLocal_71]));
				}
...
void func_24()
{
	...
	switch (iLocal_45)
	{
		case 0:
			...
			if (bLocal_61)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_76) > 6000)
				{
					if (!iLocal_62)
					{
		...
		else
		{
			...
			switch (iLocal_73)
			{
				case 0:
					...
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_63[iLocal_71])) || PED::_0x6CD5A433374D4CFB(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								...
								while (iVar0 < iLocal_63)
								{
									...
									AI::OPEN_SEQUENCE_TASK(&iLocal_70);
									...
									AI::CLOSE_SEQUENCE_TASK(iLocal_70);
									AI::TASK_PERFORM_SEQUENCE(iLocal_63[iVar0], iLocal_70);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
				...
				case 1:
					...
					while (iVar1 < iLocal_63)
					{
						if (!iLocal_56[iVar1])
						{
							...
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_70);
							AI::TASK_PERFORM_SEQUENCE(iLocal_63[iVar1], iLocal_70);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
					...
					if (!PED::IS_PED_INJURED(iLocal_63[iLocal_71]))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_76) > 12000)
						{
							if (!func_55())
							{
								func_85(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
					...
					if (iLocal_56[iLocal_71])
					{
						if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_76) > 18000 || (iLocal_75 - iLocal_74) > 5000) || PED::IS_PED_IN_COMBAT(iLocal_63[iLocal_71], 0))
						{
							...
							else
							{
								...
								{
									AI::CLEAR_PED_TASKS(iLocal_63[iLocal_71]);
									if (!PED::IS_PED_INJURED(iLocal_63[0]))
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_70);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2222.259f, 5613.22f, 53.5576f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
										AI::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_70);
										AI::TASK_PERFORM_SEQUENCE(iLocal_63[0], iLocal_70);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_70);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2205.466f, 5583.631f, 52.8682f, 8000);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2203.039f, 5567.408f, 52.7996f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2199.498f, 5560.702f, 52.8606f, 10000);
										AI::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_70);
										AI::TASK_PERFORM_SEQUENCE(iLocal_63[1], iLocal_70);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_70);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2199.679f, 5590.673f, 52.7784f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
										AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2232.761f, 5593.563f, 53.0542f, 1f, -1, 0.25f, 0, 40000f);
										AI::TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
										AI::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_70);
										AI::TASK_PERFORM_SEQUENCE(iLocal_63[2], iLocal_70);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_70);
										AI::TASK_GO_TO_ENTITY(0, iLocal_63[4], -1, 2f, 1f, 1073741824, 0);
										AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_63[4], 0);
										AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_70);
										AI::TASK_PERFORM_SEQUENCE(iLocal_63[3], iLocal_70);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
									...
									{
										AI::OPEN_SEQUENCE_TASK(&iLocal_70);
										AI::TASK_GO_TO_ENTITY(0, iLocal_63[3], -1, 2f, 1f, 1073741824, 0);
										AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_63[3], 0);
										AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_70);
										AI::TASK_PERFORM_SEQUENCE(iLocal_63[4], iLocal_70);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[4], false, -1, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[5]))
									{
										AI::TASK_GUARD_CURRENT_POSITION(iLocal_63[5], 0f, 3f, 1);
				...
				case 2:
					...
					while (iLocal_71 < 6)
					{
						if (!PED::IS_PED_INJURED(iLocal_63[iLocal_71]))
						{
							...
							{
								PED::_0xF1C03A5352243A30(iLocal_63[iLocal_71]);
								AI::TASK_COMBAT_PED(iLocal_63[iLocal_71], PLAYER::PLAYER_PED_ID(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_63[iLocal_71], true);
								if (!UI::DOES_BLIP_EXIST(uLocal_68[iLocal_71]))
								{
...
int func_89()
{
	...
	while (iVar0 < iLocal_63)
	{
		...
		{
			if (PED::_0x6CD5A433374D4CFB(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID()))
			{
			...
			if ((((((GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63[iVar0])) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
...
void func_90()
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_01")) && STREAMING::HAS_MODEL_LOADED(joaat("bobcatxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cash_case_01")))
	{
		...
		iLocal_65 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_47, -1.368082f, 0.230633f, 176.8749f, iVar0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_69, -1533126372);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, -1533126372, iLocal_69);
		...
		while (iLocal_71 < 6)
		{
			...
			iLocal_72 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
			if (iLocal_72 == 0)
			{
		...
		if (!PED::IS_PED_INJURED(iLocal_63[0]))
		{
			...
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2215.993f, 5613.299f, 53.6157f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
			AI::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
			AI::CLOSE_SEQUENCE_TASK(iLocal_70);
			AI::TASK_PERFORM_SEQUENCE(iLocal_63[0], iLocal_70);
		...
		{
			AI::OPEN_SEQUENCE_TASK(&iLocal_70);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2201.014f, 5589.357f, 52.9573f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2229.667f, 5598.368f, 53.2195f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
			AI::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
			AI::CLOSE_SEQUENCE_TASK(iLocal_70);
			AI::TASK_PERFORM_SEQUENCE(iLocal_63[2], iLocal_70);
		...
		UI::SET_BLIP_SPRITE(iLocal_66, 140);
...
int func_109(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_130(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
