		...
		case 1:
			switch (iLocal_54)
			{
				...
				case 4:
					...
					{
						AI::REQUEST_WAYPOINT_RECORDING(sLocal_49);
						iLocal_54++;
					}
					break;
				
				case 5:
					if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_49))
					{
						AI::REQUEST_WAYPOINT_RECORDING(sLocal_50);
						iLocal_54++;
					}
					break;
				
				case 6:
					if ((((((STREAMING::HAS_MODEL_LOADED(iLocal_60) && STREAMING::HAS_MODEL_LOADED(iLocal_59)) && STREAMING::HAS_MODEL_LOADED(iLocal_61)) && STREAMING::HAS_MODEL_LOADED(iLocal_63)) && STREAMING::HAS_MODEL_LOADED(iLocal_62)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_49)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_50))
					{
...
int func_38(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		{
			iVar0 = iParam0;
			if (iVar0 >= 7 && !UI::DOES_BLIP_EXIST(Local_47[iParam0 /*6*/].f_1))
			{
				return 1;
			}
		}
...
int func_48()
{
	switch (func_49(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_54(int iParam0, bool bParam1, vector3 vParam2, float fParam3)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*6*/]))
	{
		...
		PED::SET_PED_DIES_WHEN_INJURED(Local_47[iParam0 /*6*/], iVar27);
		...
		AUDIO::DISABLE_PED_PAIN_AUDIO(Local_47[iParam0 /*6*/], iVar58);
		AUDIO::STOP_PED_SPEAKING(Local_47[iParam0 /*6*/], iVar53);
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar68))
		{
			AI::TASK_START_SCENARIO_IN_PLACE(Local_47[iParam0 /*6*/], sVar68, -1, 0);
		}
		if (iVar11 > 0)
		{
...
{
	GAMEPLAY::SET_BIT(&(Local_47[iParam0 /*6*/].f_2), iParam1);
}
...
int func_63(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_48[iParam0 /*4*/]))
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar27))
		{
...
{
	GAMEPLAY::SET_BIT(&iLocal_55, iParam0);
}
...
void func_68()
{
	...
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(3070.882f, 2103.967f, -2.0883f, 5f, 0, 0, 0, 0, false, 0);
	}
...
void func_84()
{
	...
	while (iVar0 < 11)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_47[iVar0 /*6*/]) && UI::DOES_BLIP_EXIST(Local_47[iVar0 /*6*/].f_1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_47[iVar0 /*6*/], 0))
			{
				if (!func_88(iVar0, 0))
				{
					UI::SET_BLIP_SCALE(Local_47[iVar0 /*6*/].f_1, 1f);
					func_57(iVar0, 0);
				}
				if (func_87(Local_47[iVar0 /*6*/], 0) != -1)
				{
					if (func_86(iVar0))
					{
						if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1) > 0)
						{
							UI::SET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1, 0);
							UI::_0x54318C915D27E4CE(Local_47[iVar0 /*6*/].f_1, 1);
						}
					}
					else if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1) == 0)
					{
						UI::SET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1, 255);
						UI::_0x54318C915D27E4CE(Local_47[iVar0 /*6*/].f_1, 0);
					}
				}
			}
			else if (func_88(iVar0, 0))
			{
				UI::SET_BLIP_SCALE(Local_47[iVar0 /*6*/].f_1, 0.7f);
				func_85(iVar0, 0);
				if (UI::GET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1) == 0)
				{
					UI::SET_BLIP_ALPHA(Local_47[iVar0 /*6*/].f_1, 255);
	...
	while (iVar0 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_48[iVar0 /*4*/]) && UI::DOES_BLIP_EXIST(Local_48[iVar0 /*4*/].f_1))
		{
...
{
	GAMEPLAY::CLEAR_BIT(&(Local_47[iParam0 /*6*/].f_2), iParam1);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Local_47[iParam0 /*6*/].f_2, iParam1);
}
			...
			case 2:
				...
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							func_99(iParam0);
							AI::TASK_COMBAT_PED(Local_47[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					case 2:
						...
						AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iVar1);
						AI::WAYPOINT_RECORDING_GET_NUM_POINTS(sVar4, &iVar3);
						AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*6*/], true), &iVar2);
						...
						if (((((iParam0 == 0 && iLocal_57 != iVar1) && iVar1 > iVar2) || ((iParam0 == 2 && iLocal_58 != iVar1) && iVar1 > iVar2)) && func_198(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]))) && !PED::IS_PED_BEING_STUNNED(Local_47[iParam0 /*6*/], 0))
						{
							...
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_47[iParam0 /*6*/], PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]), sVar4, 786469, 0, iVar5, iVar1, -1f, 0, 6f);
						}
						if ((!func_97(Local_47[iParam0 /*6*/], -235832601, 1) && AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*6*/], -235832601) == 7) && !func_97(Local_47[iParam0 /*6*/], 538064912, 1))
						{
							AI::TASK_VEHICLE_SHOOT_AT_PED(Local_47[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 1101004800);
							if (func_198(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])) && unk_0x2467A2D807D37CA3(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])))
							{
						...
						if (!func_88(iParam0, 4))
						{
							...
							{
								func_57(iParam0, 4);
								AI::CLEAR_PED_TASKS(Local_47[iParam0 /*6*/]);
								if (!func_88(iParam0, 5) && unk_0x2467A2D807D37CA3(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])))
								{
									VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]), true);
								}
							}
						...
						if ((AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*6*/], -235832601) == 1 && !VEHICLE::IS_VEHICLE_STOPPED(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]))) && !AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_47[iParam0 /*6*/]))
						{
							AI::TASK_DRIVE_BY(Local_47[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, vLocal_51, 500f, 100, 1, -687903391);
						}
						AI::WAYPOINT_RECORDING_GET_COORD(sVar4, (iVar3 - 1), &vVar6);
						if (ENTITY::IS_ENTITY_AT_COORD(Local_47[iParam0 /*6*/], vVar6, 8f, 8f, 8f, false, true, 0))
						{
							...
							AI::TASK_BOAT_MISSION(Local_47[iParam0 /*6*/], PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]), 0, PLAYER::PLAYER_PED_ID(), vLocal_51, 7, 20f, 786469, 5f, 7);
							func_67(5);
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(Local_47[iParam0 /*6*/], 0) && func_198(PED::GET_VEHICLE_PED_IS_IN(Local_47[iParam0 /*6*/], 0)))
						{
							...
							{
								AI::_TASK_GET_OFF_BOAT(Local_47[iParam0 /*6*/], -1);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*6*/], true);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*6*/], 1, false);
								Local_47[iParam0 /*6*/].f_3++;
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*6*/], -1273030092) == 1 && !AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_47[iParam0 /*6*/]))
							{
								AI::TASK_DRIVE_BY(Local_47[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, vLocal_51, 500f, 100, 1, -687903391);
							}
						}
			...
			case 4:
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							func_99(iParam0);
							Local_47[iParam0 /*6*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1250, 1501));
							Local_47[iParam0 /*6*/].f_3++;
						}
						break;
					
					case 1:
						if (GAMEPLAY::GET_GAME_TIMER() >= Local_47[iParam0 /*6*/].f_4)
						{
							if ((iParam0 == 1 && func_198(Local_48[1 /*4*/])) && func_198(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_48[1 /*4*/], -1, 0)))
							{
								AI::CLEAR_PED_TASKS(Local_47[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[1 /*4*/], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*6*/], true);
							}
							if ((iParam0 == 3 && func_198(Local_48[2 /*4*/])) && func_198(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_48[2 /*4*/], -1, 0)))
							{
								AI::CLEAR_PED_TASKS(Local_47[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[2 /*4*/], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*6*/], true);
							}
							if ((iParam0 == 4 && func_198(Local_48[2 /*4*/])) && func_198(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_48[2 /*4*/], -1, 0)))
							{
								AI::CLEAR_PED_TASKS(Local_47[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[2 /*4*/], 20000, 1, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*6*/], true);
							}
							Local_47[iParam0 /*6*/].f_3++;
						}
					...
					case 2:
						...
						else if (!func_97(Local_47[iParam0 /*6*/], -1794415470, 1))
						{
							...
							{
								AI::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[iVar7 /*4*/], 20000, 0, 3f, 1, 0);
							}
							if (iParam0 == 4 && func_198(Local_48[iVar7 /*4*/]))
							{
								AI::TASK_ENTER_VEHICLE(Local_47[iParam0 /*6*/], Local_48[iVar7 /*4*/], 20000, 1, 3f, 1, 0);
							}
						}
						break;
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(Local_47[iParam0 /*6*/], 0) && func_198(PED::GET_VEHICLE_PED_IS_IN(Local_47[iParam0 /*6*/], 0)))
						{
							...
							if (Local_47[iParam0 /*6*/].f_3 == 3)
							{
								...
								{
									AI::_TASK_GET_OFF_BOAT(Local_47[iParam0 /*6*/], 20000);
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*6*/], true);
									PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*6*/], 1, false);
									Local_47[iParam0 /*6*/].f_3 = 5;
								}
			...
			case 10:
				...
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							Local_47[iParam0 /*6*/].f_1 = func_59(Local_47[iParam0 /*6*/], 1, 145);
							UI::SET_BLIP_ALPHA(Local_47[iParam0 /*6*/].f_1, 0);
							UI::_0x54318C915D27E4CE(Local_47[iParam0 /*6*/].f_1, 1);
							Local_47[iParam0 /*6*/].f_3++;
						}
						break;
...
int func_96(int iParam0, int iParam1)
{
	...
	if (func_198(Local_48[iVar0 /*4*/]))
	{
		...
		{
			Local_48[iVar0 /*4*/].f_3 = (Local_48[iVar0 /*4*/].f_3 + GAMEPLAY::GET_FRAME_TIME());
		}
		else
		{
...
void func_102(int iParam0)
{
	if (func_120(0))
	{
		AI::CLOSE_SEQUENCE_TASK(iLocal_244);
		func_103(0);
	}
	AI::TASK_PERFORM_SEQUENCE(iParam0, iLocal_244);
	AI::CLEAR_SEQUENCE_TASK(&iLocal_244);
}

void func_103(int iParam0)
{
	GAMEPLAY::CLEAR_BIT(&iLocal_55, iParam0);
}
...
void func_104()
{
	...
	{
		AI::CLEAR_SEQUENCE_TASK(&iLocal_244);
		AI::OPEN_SEQUENCE_TASK(&iLocal_244);
		func_67(0);
	}
}
...
{
	return GAMEPLAY::IS_BIT_SET(iLocal_55, iParam0);
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_137(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_140()
{
	...
	func_146(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_145(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_144(&uVar0, TIME::GET_CLOCK_HOURS());
	func_143(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_142(&uVar0, TIME::GET_CLOCK_MONTH());
	func_141(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_158()) || Global_25461) || func_157()) || func_156(8, -1)) || func_153()) || func_155()) || func_154()) || func_152()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_105117) || Global_25461) || func_157()) || func_156(8, -1)) || func_155()) || func_154()) || func_152()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_156(8, -1)) || func_152()) || func_151()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_25461) || func_157()) || func_156(8, -1)) || func_154()) || func_153()) || func_152()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_158()) || func_154()) || Global_105117) || Global_25461) || func_157()) || Global_37271) || func_156(8, -1)) || func_153()) || func_151()) || func_152()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_188()
{
	AI::REMOVE_WAYPOINT_RECORDING(sLocal_49);
	AI::REMOVE_WAYPOINT_RECORDING(sLocal_50);
}
