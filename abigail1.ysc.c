...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_DAS", 0);
	...
	switch (iLocal_87)
	{
		case 0:
			...
			if (func_297(iLocal_83))
			{
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
					CUTSCENE::REMOVE_CUTSCENE();
					func_296(1);
					CUTSCENE::_REQUEST_CUTSCENE_EX("ABIGAIL_MCS_1_CONCAT", 2, 8);
					iLocal_87 = 1;
				}
				else
				{
		...
		case 3:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0, 0, 0, 0, 0, 0);
				func_224(500, 0);
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_297(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 1048576000, 0, 1193033728);
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_297(iLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					AI::CLEAR_PED_TASKS(iLocal_83);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
				iLocal_86 = GAMEPLAY::GET_GAME_TIMER() + 10000;
				iLocal_87++;
			}
			break;
		
		case 5:
			if ((iLocal_89 == 0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4) && GAMEPLAY::GET_GAME_TIMER() > (iLocal_86 - 300))
			{
				GRAPHICS::_START_SCREEN_EFFECT("CamPushInNeutral", 0, 0);
				AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
				iLocal_89 = 1;
			}
			if (func_218(1000) || GAMEPLAY::GET_GAME_TIMER() > iLocal_86)
			{
				...
				{
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, 5000, 0, 2);
				}
				func_3();
			}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_71(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		iVar4 = 0;
		iVar5 = DLC1::_0xF3FBE2D50A6A8C28(uVar1, 0);
		iVar3 = 0;
		while (iVar3 < iVar5)
		{
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
int func_199(char* sParam0, int iParam1)
{
	...
	iVar2 = GAMEPLAY::GET_HASH_KEY(uParam0);
	iVar3 = 0;
	iVar3 = 0;
	while (iVar3 < 63)
	{
		...
		if (GAMEPLAY::GET_HASH_KEY(uVar1) == iVar2)
		{
			return iVar0;
		}
		iVar3++;
...
void func_208(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_212(PLAYER::PLAYER_ID())) && !func_210(PLAYER::PLAYER_ID(), 0)) && !func_209()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_212(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_225(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_226(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_227(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_275(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_272(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_228(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_229(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_259(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_248();
			}
...
void func_230(int iParam0, int iParam1)
{
	...
	func_267(iParam0, &(Global_106070.f_32605.f_5510));
}
...
var func_248()
{
	...
	func_258(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_257(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_256(&uVar0, TIME::GET_CLOCK_HOURS());
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_254(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_259(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_266(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_262(int iParam0, var uParam1, vector3 vParam2, var uParam3, int iParam4)
{
	if (func_259(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_264(iParam0);
			func_263(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
			if (GAMEPLAY::IS_BIT_SET(Global_70024.f_555[0 /*21*/].f_9, 11))
			{
				Global_106070.f_32605.f_1864[Global_70024.f_555[0 /*21*/].f_14 /*3*/] = { vParam2 };
				Global_106070.f_32605.f_1934[Global_70024.f_555[0 /*21*/].f_14] = uParam3;
			}
			else
			{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_268(iVar0 + 1));
			}
			iVar0++;
		}
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			if (bVar1)
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (bVar2)
					{
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam3, 5f, 0, 0, 0, 0, 0, 0);
...
int func_291(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		VEHICLE::_SET_VEHICLE_HALT(uParam0, fParam1, iParam2, iParam4);
	}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_307(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_318(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_320(iParam0, Global_36117);
}
...
int func_340()
{
	...
	iVar0 = func_341(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_344()
{
	...
	{
		if (func_339(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
