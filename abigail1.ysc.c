	...
	switch (iLocal_87)
	{
		case 0:
			...
			if (func_297(iLocal_83))
			{
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0f, 0, 0, 0);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_254(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
