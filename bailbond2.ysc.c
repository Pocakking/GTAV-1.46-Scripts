...
void __EntryFunction__()
{
	...
	if (func_514())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_99633.f_2875.f_12.f_66))
				{
...
void func_114(int iParam0)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_69[iParam0 /*20*/]);
		AI::CLEAR_PED_TASKS(Local_69[iParam0 /*20*/]);
		AI::TASK_CLEAR_LOOK_AT(Local_69[iParam0 /*20*/]);
		...
		PED::SET_PED_FLEE_ATTRIBUTES(Local_69[iParam0 /*20*/], 512, 1);
		PED::SET_PED_ACCURACY(Local_69[iParam0 /*20*/], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10, 20));
		PED::SET_PED_SHOOT_RATE(Local_69[iParam0 /*20*/], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(15, 20));
		...
		AI::TASK_LOOK_AT_ENTITY(Local_69[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		AI::TASK_COMBAT_PED(Local_69[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_177(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_174(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_126(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return func_186(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
...
int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_242(iVar10, 14, uVar12[iVar1], -1) };
							func_212(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_234(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_202(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_234(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_242(iVar10, iVar0, func_201(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_242(iVar10, 14, uVar15[iVar1], -1) };
			func_212(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_234(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_202(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_193(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_306(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_306(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_212(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_213(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_202(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_202(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_238(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_237(iParam1)];
...
void func_244(int iParam0)
{
	...
	func_245(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_238(func_248(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_238(func_247(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_238(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_245(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_245(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_202(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_306(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_202(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_202(iParam1)))
	{
		return 1;
	}
	return 0;
				...
				if (!iLocal_109)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_124, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_337, 30f))
									{
...
int func_332(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_340() || func_339(Global_4456448.f_152990)) || func_338())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_336(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
			...
			switch (Local_68.f_10)
			{
				...
				case 29:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, 1);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 512, 1);
						...
						AI::TASK_COMBAT_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_68.f_9, vLocal_338, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
						Local_68.f_10 = 30;
					}
					break;
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_123) > 7500)
						{
							func_383(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_123) > 10000)
						{
							func_383(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_337, 25f))
					{
						...
						{
							if (func_113(iLocal_125, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
								...
								{
									iLocal_125 = GAMEPLAY::GET_GAME_TIMER();
								}
							}
						}
						else
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_124, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_337, 20f))
							{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_110)
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_117))
						{
							if (iLocal_97)
							{
								uLocal_117 = func_389(vLocal_336, 5, 1);
							}
						}
						if (!iLocal_83)
						{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					{
						if (func_113(iLocal_124, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_105(Local_68.f_9, vLocal_337, 30f))
							{
								if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
			...
			switch (Local_69[iVar0 /*20*/].f_14)
			{
				...
				case 1:
					switch (iVar0)
					{
						...
						case 1:
							iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(750, 1250);
							break;
						
						case 2:
							iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1500, 2000);
							break;
						
						case 3:
							iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000);
							break;
						
						default:
							iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1500);
							break;
					}
...
void func_395(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*20*/]))
		{
			Local_69[iVar0 /*20*/].f_15 = GAMEPLAY::GET_GAME_TIMER();
	...
	if (!iLocal_92)
	{
		if (!func_61())
		{
			if (func_105(Local_68.f_9, vLocal_337, (22f + 5f)))
			{
				...
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_335))
				{
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_477(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_477(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_443(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_170(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_446(*iParam1);
				...
				func_444(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_444(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_448(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_452(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_453(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_469(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_470(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_335())
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_471(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_449(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_483(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_484(int iParam0)
{
	...
	if (func_157(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_70024.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_163(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_485(0, Global_70024.f_555[0 /*21*/].f_12) || !func_485(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
...
int func_485(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_486(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
{
	return func_488(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_167(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_509(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_511(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
void func_515()
{
	...
	GAMEPLAY::CLEAR_AREA(Local_63, 15f, 0, 0, 0, false);
...
void func_516()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		AI::OPEN_SEQUENCE_TASK(&uLocal_145);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_c", 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0f, 0, 0, 0);
	...
	while (iVar0 <= 5)
	{
		if (func_22(Local_69[iVar0 /*20*/]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_69[iVar0 /*20*/], Local_69[iVar0 /*20*/].f_5, -1, 1, 1);
			}
			PED::SET_PED_CONFIG_FLAG(Local_69[iVar0 /*20*/], 137, 1);
			...
			if (iVar0 == 0)
			{
				...
				AI::SET_SEQUENCE_TO_REPEAT(uLocal_145, 1);
				AI::CLOSE_SEQUENCE_TASK(uLocal_145);
				AI::TASK_PERFORM_SEQUENCE(Local_69[iVar0 /*20*/], uLocal_145);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_145);
				if (func_22(Local_69[iVar0 /*20*/]))
				{
	...
	if (iLocal_134 > 0)
	{
		...
		while (iVar2 <= (iLocal_134 - 1))
		{
			if (func_53(&(Local_69[iVar2 /*20*/]), Local_69[iVar2 /*20*/].f_19, Local_69[iVar2 /*20*/].f_1, Local_69[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				...
				{
					PED::SET_PED_CONFIG_FLAG(Local_69[iVar2 /*20*/], 132, 1);
					iVar0++;
					iVar1++;
				}
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105117) || Global_25461) || func_544()) || func_88(8, -1)) || func_543()) || func_542()) || func_536()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_538()) || Global_25461) || func_544()) || func_88(8, -1)) || func_536()) || func_543()) || func_542()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105117) || Global_25461) || func_544()) || func_88(8, -1)) || func_536()) || func_543()) || func_542()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_538()) || Global_105117) || Global_25461) || func_544()) || func_88(8, -1)) || func_543()) || func_542()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_538() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_537()) || func_541()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_538()) || Global_25461) || func_544()) || func_88(8, -1)) || func_542()) || func_536()) || func_537()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_538()) || Global_105117) || Global_25461) || func_544()) || func_88(8, -1)) || func_536()) || func_541()) || func_543()) || func_542()) || func_537())
						{
							return 0;
						}
						break;
...
{
	return func_546(iParam0, Global_36117);
}
...
int func_556()
{
	...
	iVar0 = func_557(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_560()
{
	...
	{
		if (func_550(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
