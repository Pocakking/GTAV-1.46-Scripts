...
int func_1()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("drunk")) > 0)
	{
		return 1;
	}
	if (Global_37031 > 0)
...
void func_2()
{
	...
	if (Global_37239 > iVar1 || Global_37239 == -1)
	{
		...
		if (Global_37242 != Global_37243)
		{
			...
			if (GAMEPLAY::ABSF((Global_37242 - Global_37243)) < 0.01f)
			{
		...
		{
			CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", ((Global_37242 * fVar3) * fVar5));
		}
		if ((GAMEPLAY::GET_GAME_TIMER() % 100) == 0)
		{
			...
			else
			{
				...
				CAM::SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(((Global_37242 * fVar3) * fVar5));
				CAM::_0x487A82C650EB7799(((Global_37241 * fVar3) * fVar5));
				fLocal_18 = fVar3;
			}
		}
		if (((Global_37241 * fVar3) * fVar5) < 1f)
		{
			CAM::_0x0225778816FDC28C(((Global_37241 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", (((Global_37242 * Global_37236) * fVar3) * fVar5));
		}
		CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE((((Global_37242 * Global_37236) * fVar3) * fVar5));
		if (CAM::DOES_CAM_EXIST(Global_37238))
		{
			if (CAM::IS_CAM_SHAKING(Global_37238))
			{
				CAM::SET_CAM_SHAKE_AMPLITUDE(Global_37238, ((Global_37242 * fVar3) * fVar5));
			}
		}
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Global_37265) && !GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Global_37249))
		{
			AUDIO::START_AUDIO_SCENE(&Global_37249);
		...
		if (Global_37244 > 0f)
		{
			if (fLocal_16 != Global_37244)
			{
				...
				{
					GRAPHICS::SET_TRANSITION_TIMECYCLE_MODIFIER(&Global_37245, 15f);
			...
			else
			{
				...
				if (iVar7 <= (Global_37240 / 2))
				{
					...
					else
					{
						...
						{
							GRAPHICS::_0x1CBA05AE7BD7EE05((SYSTEM::TO_FLOAT((Global_37240 / 2)) / 1000f));
						}
						fLocal_16 = -99f;
						Global_37244 = 0f;
...
float func_13()
{
	...
	if (iVar2 <= Global_37240)
	{
		if (Global_37239 != -1)
		{
			fVar1 = (SYSTEM::TO_FLOAT(iVar2) / SYSTEM::TO_FLOAT(Global_37240));
		}
	}
	return fVar1;
}
...
void func_15(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Global_37032[iParam0 /*5*/].f_1, 0))
	{
		func_18(iParam0);
		return;
	}
