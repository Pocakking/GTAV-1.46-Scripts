...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_75))
		{
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			vLocal_84[4 /*3*/] = { vLocal_84[0 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			vLocal_84[5 /*3*/] = { vLocal_84[1 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			break;
