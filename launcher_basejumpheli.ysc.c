...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_152(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
				...
				case 3:
					...
					else
					{
						...
						if (!func_130(3) && !Global_93266)
						{
							...
							{
								if ((!func_152(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_129())) && !Global_93266)
								{
									func_145(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_109(iLocal_54))
								{
									...
									else if (!func_152(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_107(&iLocal_60);
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_152(Global_104721, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_93269, 0);
...
void func_16(int iParam0, int iParam1)
{
	...
	if (CAM::DOES_CAM_EXIST(*iParam0) && CAM::IS_CAM_ACTIVE(*iParam0))
	{
		...
		fVar3 = GAMEPLAY::ATAN2((vVar1.z - vVar2.z), GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, vVar2, false));
		if (fVar3 > vVar0.x)
		{
...
void func_51()
{
	...
	if (func_100(Local_247.f_3, Local_247, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_3) && !PED::IS_PED_INJURED(Local_247.f_3))
		{
			...
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247, ENTITY::GET_ENTITY_COORDS(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::_0x53AF99BAA671CA47(Local_247), 262144, 50f, 50f, 1);
			}
			else
			{
				AI::TASK_SMART_FLEE_PED(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
	...
	if (fVar6 < 10000f)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_247.f_3))
		{
			if ((STREAMING::HAS_MODEL_LOADED(func_98(iLocal_81)) && ENTITY::DOES_ENTITY_EXIST(Local_247)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0))
			{
				...
				if (!PED::IS_PED_INJURED(Local_247.f_3))
				{
					...
					AI::TASK_STAND_STILL(Local_247.f_3, -1);
		...
		else
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(Local_247.f_169, 0))
			{
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!PED::IS_PED_INJURED(Local_247.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_247.f_3, true)) < 400f)
						{
							...
							AI::TASK_LOOK_AT_ENTITY(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 6000, 0, 2);
							GAMEPLAY::SET_BIT(&(Local_247.f_169), 0);
						}
					}
				}
			}
	...
	if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247, 1) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_75(Local_247.f_3, Local_247))
	{
		...
		if (vVar5.x < 0f || vVar5.y < 1f)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247, 0))
			{
				iVar0 = AI::GET_SCRIPT_TASK_STATUS(Local_247.f_3, -1273030092);
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_247.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_247, 0))
					{
						...
						AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247, ENTITY::GET_ENTITY_COORDS(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::_0x53AF99BAA671CA47(Local_247), 262144, 50f, 50f, 1);
						AI::CLOSE_SEQUENCE_TASK(iVar4);
						AI::TASK_PERFORM_SEQUENCE(Local_247.f_3, iVar4);
	...
	if (!bVar8)
	{
		...
		if ((!PED::IS_PED_INJURED(Local_247.f_3) && AI::GET_SCRIPT_TASK_STATUS(Local_247.f_3, -982327190) != 0) && AI::GET_SCRIPT_TASK_STATUS(Local_247.f_3, -982327190) != 1)
		{
			AI::TASK_STAND_STILL(Local_247.f_3, -1);
		}
	}
...
void func_66(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_71(PLAYER::PLAYER_ID())) && !func_68(PLAYER::PLAYER_ID(), 0)) && !func_67()) && !bParam4)
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_127()) || Global_105117) || Global_25461) || func_126()) || func_112(8, -1)) || func_125()) || func_124()) || func_123()) || func_114()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_127()) || Global_25461) || func_126()) || func_112(8, -1)) || func_123()) || func_125()) || func_124()) || func_114()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_127()) || Global_105117) || Global_25461) || func_126()) || func_112(8, -1)) || func_125()) || func_124()) || func_114()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_127() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_112(8, -1)) || func_114()) || func_122()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_127()) || Global_25461) || func_126()) || func_112(8, -1)) || func_124()) || func_123()) || func_114()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_127()) || func_124()) || Global_105117) || Global_25461) || func_126()) || Global_37271) || func_112(8, -1)) || func_123()) || func_122()) || func_114()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_127()) || Global_105117) || Global_25461) || func_126()) || func_112(8, -1)) || func_123()) || func_122()) || func_125()) || func_124()) || func_114())
						{
							return 0;
						}
						break;
...
void func_135(vector3 vParam0, float fParam1)
{
	...
	if (bVar1)
	{
		...
		GAMEPLAY::CLEAR_AREA(vParam0, 4f, 1, 0, 0, false);
		if (iLocal_81 == 0)
		{
		...
		iLocal_54 = Local_247;
		ENTITY::_SET_ENTITY_REGISTER(iLocal_54, true);
		if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vParam0, &uVar0, 0, 0))
		{
...
void func_153()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("bj")) > 0)
	{
	}
	else
	{
