...
void __EntryFunction__()
{
	...
	iLocal_91 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	sLocal_100 = "FINPRC";
	iLocal_104 = -1;
	iLocal_105 = -1;
	vLocal_107 = { 0f, 0f, 0f };
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_158(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_190(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 2:
			if (func_4(Global_89824[func_189()]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[func_189()], true, 1);
...
void func_244()
{
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				UNK1::_0x293220DA1B46CEBC(5f, 1073741824, 3);
