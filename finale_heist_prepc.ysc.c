...
void __EntryFunction__()
{
	...
	iLocal_85 = 49;
	iLocal_86 = 64;
	uLocal_90 = UI::_0x4A9923385BDB9DAD();
	uLocal_91 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	sLocal_100 = "FINPRC";
	iLocal_104 = -1;
	iLocal_105 = -1;
	vLocal_107 = { 0f, 0f, 0f };
...
void func_1()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_99))
			{
				func_16(sLocal_99);
			}
			else
...
void func_8(int iParam0)
{
	...
	if (Global_106070.f_9057 || func_448(0))
	{
		iVar0 = func_15();
		if (!func_9(iVar0))
		{
...
void func_10(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_12(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
void func_20()
{
	...
	switch (iLocal_93)
	{
		...
		case 1:
			...
			{
				VEHICLE::_0x02398B627547189C(iLocal_122, 0);
				VEHICLE::_0x79DF7E806202CE01(iLocal_122, 200);
...
void func_36(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_448(0) && Global_71451.f_1 == 1) && func_37(Global_71451))
		{
		}
		else
		{
...
void func_38(int iParam0)
{
	...
	{
		if (Global_56406[Global_68277[iVar0 /*9*/] /*13*/] == 12)
		{
...
int func_51(int iParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vParam1, fParam10, fParam10, 2f, false, true, 2))
			{
				...
				{
					UI::CLEAR_THIS_PRINT(func_61(func_41()));
				}
				*iParam5 = 1;
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iParam0, vParam1, fParam10, fParam10, 2f, false, true, 2))
	{
		...
		if (!*iParam8)
		{
			...
			*iParam7 = GAMEPLAY::GET_GAME_TIMER();
			*iParam8 = 1;
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0, 2);
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - *iParam7) > 3000)
		{
			return 1;
		}
	}
	else
	{
		...
		if (!*iParam6)
		{
			...
			{
				UI::CLEAR_THIS_PRINT(func_54(func_41(), 0));
			}
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_140(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_140(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_80(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_148(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_84(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_83(*iParam1);
				...
				func_81(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_81(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_87(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			...
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_93(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_94(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_110(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			...
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_111(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_90())
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_112(int iParam0)
{
	if (iParam0 != func_90())
	{
		if (func_89(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_88(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_115(int iParam0, int iParam1)
{
	...
	func_116(iParam0, &(Global_106070.f_32605.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_117(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_146(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_147(iParam0, iParam1))
				{
...
void func_150(int iParam0)
{
	...
	if (func_157(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_156(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_154(0, Global_70024.f_555[0 /*21*/].f_12) || !func_154(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_153(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_154(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_155(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_122(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_157(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_158(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_158(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_158(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_160(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_177(uParam0))
	{
		...
		if (func_176(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_162(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_162(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_164(iParam0, Global_70024.f_139[38], 0))
			{
				func_150(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_164(iParam0, Global_70024.f_139[43], 1))
			{
				func_150(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_158(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_165(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_117(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_117(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_117(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_168(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_167())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_117(iVar2 + 1)))
				{
...
bool func_178()
{
	return func_176(&(Global_99633.f_2875));
}

void func_179()
{
	func_180(&(Global_99633.f_2875));
}
...
int func_181(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_183(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_184()
{
	return func_177(&(Global_99633.f_2875));
}

void func_185(var uParam0, float fParam1)
{
	*uParam0 = { Global_96664.f_2869 };
	*fParam1 = Global_96664.f_2869.f_3;
}
...
int func_188()
{
	if (func_4(Global_89824[func_189()]))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_89824[func_189()], 0))
		{
...
int func_190(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_100, 0);
		...
		case 2:
			if (func_4(Global_89824[func_189()]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824[func_189()], 1, 1);
				Local_124 = Global_89824[func_189()];
				if (func_4(Local_124))
				{
					iLocal_122 = Local_124;
					func_77(Local_124, 0);
			...
			else if (Global_93232.f_12[0] != 1 || func_448(0))
			{
...
void func_194()
{
	if (func_56(PLAYER::PLAYER_PED_ID(), vLocal_109, 50f))
	{
		if (!iLocal_113)
		{
			AUDIO::_0x06C0023BED16DD6B(Local_96, 1);
			AUDIO::_0x06C0023BED16DD6B(Local_97, 1);
	...
	else if (!func_56(PLAYER::PLAYER_PED_ID(), vLocal_109, 70f))
	{
		if (iLocal_113)
		{
			AUDIO::_0x06C0023BED16DD6B(Local_96, 0);
			AUDIO::_0x06C0023BED16DD6B(Local_97, 0);
...
void func_197(var uParam0)
{
	if (OBJECT::_DOES_DOOR_EXIST(*uParam0))
	{
		if (uParam0->f_22 != 0)
		{
			...
			{
				GAMEPLAY::CLEAR_AREA(-442.9902f, -2168.623f, 9.3184f, 5f, 0, 0, 0, false);
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(*uParam0, 1, 1, 1);
				uParam0->f_1 = 0f;
				OBJECT::_SET_DOOR_AJAR_ANGLE(*uParam0, uParam0->f_1, 1, 1);
				uParam0->f_22 = 0;
...
int func_198(struct<16> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	if (func_4(iLocal_122))
	{
		if (GAMEPLAY::IS_AREA_OCCUPIED(Param0.f_15[0 /*3*/], Param0.f_15[1 /*3*/], 0, 1, 1, 0, 0, 0, 0))
		{
			return 1;
		}
	}
		...
		switch (*iParam2)
		{
			case 0:
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0))
				{
					...
					if (func_59(func_53(func_41()), 0, 0))
					{
						UI::CLEAR_THIS_PRINT(func_53(func_41()));
					}
					if (*iParam0 == iParam6)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_54(func_41(), bParam7));
					}
					if (func_41() != 33)
					{
						func_206(iParam0);
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				...
				iLocal_118 = 0;
				func_228(1);
				AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_LEANING", 0);
				if (!OBJECT::_DOES_DOOR_EXIST(Local_96))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_96, joaat("prop_com_gar_door_01"), -440.0606f, -2171.827f, 11.3672f, 1, 1, 0);
					OBJECT::_SET_DOOR_AJAR_ANGLE(Local_96, 0f, 1, 0);
...
int func_218(int iParam0)
{
	...
	return Global_90805[func_219(iParam0)];
}
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_225(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), vLocal_108, 4, 20f, 786469, 2f, 10f, 1);
				}
			}
			else
			{
...
int func_232(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_233(iParam1)];
	...
	if (!iLocal_126[iParam0])
	{
		if (func_239(iParam1))
		{
			if (func_191(&(uLocal_125[iParam0]), joaat("gauntlet"), vLocal_127[iParam0 /*3*/], fLocal_128[iParam0], 1))
			{
				...
				func_165(uLocal_125[iParam0], &(Global_106070.f_32605.f_4803[iParam0 /*78*/]), 0, 1);
...
void func_240()
{
	...
	switch (iLocal_93)
	{
		...
		case 2:
			UNK1::_0x293220DA1B46CEBC(0f, 6f, 4);
			func_19(&iLocal_102);
			func_46();
			func_211(0);
			break;
...
void func_244()
{
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				UNK1::_0x293220DA1B46CEBC(5f, 2f, 3);
				...
				UNK1::_0x293220DA1B46CEBC(6f, 10f, 4);
				func_228(1);
				iLocal_93 = 1;
			}
			break;
...
void func_247(bool bParam0)
{
	...
	func_253(1, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_LEANING", 1);
	func_18();
	func_252();
	func_251();
	func_250();
...
void func_257(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_258(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_259(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_307(iVar10, iParam1, iParam2, -1) };
		if (!func_306(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_307(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_307(iVar10, 14, uVar12[iVar1], -1) };
							func_279(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_301(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_269(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_269(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_269(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_301(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_307(iVar10, iVar0, func_268(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_307(iVar10, 14, uVar15[iVar1], -1) };
			func_279(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_301(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_269(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_269(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_269(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_260(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_372(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_307(iParam0, iParam1, iParam2, -1) };
...
int func_267(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_372(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_280(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_269(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_286(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_269(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_294(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_294(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_294(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_281(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_281(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_281(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_281(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_301(int iParam0)
{
	...
	{
		func_305(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_303(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_233(iParam2)];
	if (iVar0 != 0)
	{
...
void func_309(int iParam0)
{
	...
	func_310(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_232(func_313(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_232(func_312(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_232(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_317(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_310(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_310(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_310(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_310(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_269(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_372(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_307(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_372(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_372(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_307(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_372(iParam0, 14, iVar4))
										{
											if (!func_265(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_307(iVar0, iVar2, iVar1, -1) };
						if (!func_265(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_269(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_269(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_378(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_380();
			}
...
var func_380()
{
	...
	func_390(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_389(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_388(&uVar0, TIME::GET_CLOCK_HOURS());
	func_383(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_386(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_391(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_157(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_392(iParam0);
			func_153(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_414()
{
	...
	{
		case 80:
			UNK1::_0x208784099002BC30("M_TheBigScorePrepC1", 0);
			break;
		
		case 81:
			UNK1::_0x208784099002BC30("M_TheBigScorePrepC2", 0);
			break;
		
		case 82:
			UNK1::_0x208784099002BC30("M_TheBigScorePrepC3", 0);
			break;
	}
}
...
void func_415(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_416(Global_106070.f_28022[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_419(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_421() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_421() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_420(iParam0));
...
bool func_424(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_421() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_430(int iParam0, int iParam1)
{
	...
	if (func_440(&Global_4268566))
	{
		if (func_438(&Global_4268566, iParam0))
		{
			return 0;
		}
		if (func_431(&Global_4268566, iParam0))
		{
			return 1;
		}
	}
...
void func_434(var uParam0)
{
	...
	func_436(uParam0, (Global_4268565 - 0.5f));
}
...
void func_447()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_216(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_215(PLAYER::PLAYER_PED_ID());
			if (func_148(iVar0) && (!func_315(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_148(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_459(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	bVar0 = false;
	iVar1 = 0;
	while (iVar1 < Global_25470)
	{
		if (bParam2)
		{
			if (Global_25470[iVar1] == 0 && !bVar0)
			{
				Global_25470[iVar1] = iParam0;
				Global_25481[iVar1] = bParam1;
				Global_25492[iVar1] = (GAMEPLAY::GET_GAME_TIMER() + iParam3);
				Global_25503 = 1;
				bVar0 = true;
			}
			else if (Global_25470[iVar1] == iParam0)
			{
				Global_25470[iVar1] = iParam0;
				Global_25481[iVar1] = bParam1;
				Global_25492[iVar1] = (GAMEPLAY::GET_GAME_TIMER() + iParam3);
