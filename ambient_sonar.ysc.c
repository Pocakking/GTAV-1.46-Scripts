...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("ambient_sonar")) > 1)
	{
	...
	if (func_102(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			else if (func_102(iLocal_49))
			{
				...
				else if (!UI::DOES_BLIP_EXIST(iLocal_50))
				{
					iLocal_50 = func_2(iLocal_49, 0, 0);
					UI::SET_BLIP_SPRITE(iLocal_50, 308);
				}
			}
			else
			{
...
int func_70(var uParam0, int iParam1)
{
	...
	if (!Global_71465)
	{
		func_76(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 3, &iLocal_56, &uLocal_57, "SUBM_TITLE", "SUBM_COLLECT");
	}
...
void func_99(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
