	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
...
void func_182(int iParam0)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_58) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_126(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar4 != 0f)
				{
					fVar2 = GAMEPLAY::ATAN2(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
...
void func_184()
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_56, "SET_COLOUR");
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_56, "SET_DISTANCE");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(10f);
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	UI::SET_TEXT_RENDER_ID(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
...
int func_201(int iParam0, bool bParam1)
{
	...
	func_109(*iParam0, &Var0);
	if ((func_238(*iParam0) || func_236(*iParam0)) || Global_71450 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
{
	if ((func_237() && Global_93232.f_11 == 6) && iParam0 == func_165(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_240()
{
	...
	if (UI::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		iLocal_57 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
...
int func_242(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
