...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_29 == 0)
		{
			iLocal_31 = GAMEPLAY::GET_GAME_TIMER();
		...
		if (Global_14513.f_1 != 9)
		{
			...
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iLocal_23 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_106070.f_14113[iLocal_23 /*104*/].f_24 == 1)
	{
		if (Global_14491 == 0)
		{
			if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, Global_14484))
			{
				...
				UI::_REMOVE_NOTIFICATION(Global_106070.f_14113[iLocal_23 /*104*/].f_16);
				func_40(Global_14494, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_38();
				if (iLocal_21 > 0)
				{
			...
			else if (Global_15822 == 4 || Global_15822 == 3)
			{
				...
				else
				{
					...
					if (Global_106070.f_28022[Global_1698 /*29*/].f_24[Global_14513] == 0)
					{
						...
						func_13(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1698 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_40(Global_14494, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), &(Global_106070.f_28022[Global_1698 /*29*/].f_7), &cVar0, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), 0);
					}
				}
				func_40(Global_14494, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_13(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
		...
		if ((func_3(2, Global_14482, 0) || Global_106070.f_14023[Global_14513 /*20*/].f_17 == 1) || Global_16882 == 1)
		{
			...
			if (Global_106070.f_14113[iLocal_23 /*104*/].f_24 != 0)
			{
				...
				if (Global_106070.f_14113[iLocal_23 /*104*/].f_17 == 145)
				{
					...
					UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iLocal_23 /*104*/].f_50));
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				}
				else
				{
				...
				switch (Global_106070.f_14113[iLocal_23 /*104*/].f_32)
				{
					...
					case 1:
						GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&(Global_106070.f_14113[iLocal_23 /*104*/]));
						UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iLocal_23 /*104*/].f_33));
						if (Global_106070.f_14113[iLocal_23 /*104*/].f_66 == 1 && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67), "NULL"))
						{
							UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67));
						}
						if ((Global_106070.f_14113[iLocal_23 /*104*/].f_66 == 2 && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67), "NULL")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iLocal_23 /*104*/].f_83), "NULL"))
						{
							if (UI::DOES_TEXT_LABEL_EXIST(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67)))
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67));
							}
							else
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iLocal_23 /*104*/].f_67));
							}
							if (UI::DOES_TEXT_LABEL_EXIST(&(Global_106070.f_14113[iLocal_23 /*104*/].f_83)))
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106070.f_14113[iLocal_23 /*104*/].f_83));
							}
							else
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iLocal_23 /*104*/].f_83));
							}
						}
						GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
						break;
					...
					case 2:
						GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&(Global_106070.f_14113[iLocal_23 /*104*/]));
						UI::ADD_TEXT_COMPONENT_INTEGER(Global_106070.f_14113[iLocal_23 /*104*/].f_49);
						GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
						break;
				...
				{
					if (PED::IS_PEDHEADSHOT_VALID(Global_16891[iLocal_23]))
					{
						if (PED::IS_PEDHEADSHOT_READY(Global_16891[iLocal_23]))
						{
							sVar1 = PED::GET_PEDHEADSHOT_TXD_STRING(Global_16891[iLocal_23]);
						}
						else
						{
							sVar1 = "CHAR_DEFAULT";
					...
					GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("CELL_2000");
					UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sVar1);
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				}
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
				Global_16888 = 1;
...
void func_31()
{
	...
	if (Global_106070.f_14113[iLocal_23 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 165)
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iLocal_23 /*104*/]), &(Local_49[iVar0 /*6*/])))
			{
				if (iVar0 < 19)
				{
...
void func_37()
{
	if (Global_106070.f_14023[Global_14513 /*20*/].f_17 == 0)
	{
		...
		func_40(Global_14494, "DISPLAY_VIEW", 6f, SYSTEM::TO_FLOAT(iLocal_22), -1082130432, -1082130432, -1082130432);
		func_29(Global_14494, "SET_HEADER", "CELL_1", 0, 0, 0, 0);
		if (Global_14501)
		{
			if (iLocal_20 > 0)
	...
	while (iVar1 < 34)
	{
		...
		if (Global_106070.f_14113[iVar3 /*104*/].f_24 != 0)
		{
			if (Global_106070.f_14113[iVar3 /*104*/].f_99[Global_14513] == 1)
			{
				...
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(Global_106070.f_14113[iVar3 /*104*/].f_18.f_2);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(Global_106070.f_14113[iVar3 /*104*/].f_18.f_1);
				...
				if (Global_106070.f_14113[iVar3 /*104*/].f_17 == 145)
				{
					...
					UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iVar3 /*104*/].f_50));
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				}
				else
				{
				...
				switch (Global_106070.f_14113[iVar3 /*104*/].f_32)
				{
					...
					case 1:
						GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&(Global_106070.f_14113[iVar3 /*104*/]));
						UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iVar3 /*104*/].f_33));
						if (Global_106070.f_14113[iVar3 /*104*/].f_66 == 1 && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iVar3 /*104*/].f_67), "NULL"))
						{
							UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iVar3 /*104*/].f_67));
						}
						if ((Global_106070.f_14113[iVar3 /*104*/].f_66 == 2 && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iVar3 /*104*/].f_67), "NULL")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106070.f_14113[iVar3 /*104*/].f_83), "NULL"))
						{
							if (UI::DOES_TEXT_LABEL_EXIST(&(Global_106070.f_14113[iVar3 /*104*/].f_67)))
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106070.f_14113[iVar3 /*104*/].f_67));
							}
							else
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iVar3 /*104*/].f_67));
							}
							if (UI::DOES_TEXT_LABEL_EXIST(&(Global_106070.f_14113[iVar3 /*104*/].f_83)))
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106070.f_14113[iVar3 /*104*/].f_83));
							}
							else
							{
								UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106070.f_14113[iVar3 /*104*/].f_83));
							}
						}
						GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
						break;
					...
					case 2:
						GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&(Global_106070.f_14113[iVar3 /*104*/]));
						UI::ADD_TEXT_COMPONENT_INTEGER(Global_106070.f_14113[iVar3 /*104*/].f_49);
						GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
						break;
