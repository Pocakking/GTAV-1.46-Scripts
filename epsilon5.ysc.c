...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_BTT", 0);
		SYSTEM::WAIT(0);
...
void func_7()
{
	...
	{
		func_198(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_200(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_206(Global_37284[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_206(Global_37284[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_201(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_202(UI::_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, UI::_GET_LABEL_TEXT(func_203(iParam1)), 0));
		}
		else
		{
			func_202(UI::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_203(iParam1)), 0));
		}
		switch (Global_14513)
		{
			case 0:
...
void func_216(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_220(PLAYER::PLAYER_ID())) && !func_218(PLAYER::PLAYER_ID(), 0)) && !func_217()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_220(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_228(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_230(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
		...
		case 1:
			...
			if (iLocal_252 == 0)
			{
				if (func_266(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 1) <= 2.5f)
				{
					...
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 0);
					iLocal_252 = 1;
				}
			}
				...
				if (func_243(Local_84.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							...
							AI::TASK_LOOK_AT_ENTITY(Local_84.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 12, 2);
							AI::TASK_PLAY_ANIM(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0f, 0, 0, 0);
							iLocal_82 = 2;
						}
					}
				}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_276(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_287(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
