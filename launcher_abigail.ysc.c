	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_286(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
...
int func_186(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_191(int iParam0, var uParam1, char* sParam2)
{
	if (func_126(*uParam1) && func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			case 0:
				iParam0->f_166 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 2000));
				func_189(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0f, 0, 0, 0);
				*iParam0 = 1;
				break;
			
			case 1:
				if (GAMEPLAY::GET_GAME_TIMER() > iParam0->f_166)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0f, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				{
					AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_192(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_145())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_talk", 3))
					{
						...
						{
							iParam0->f_166 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(7000, 10000));
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0f, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								AI::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0f, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
