...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_305, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_303)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_304)
	{
				...
				if (func_35(vLocal_305, vVar0) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_305, 3f, joaat("prop_cs_remote_01"), 0))
				{
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && CONTROLS::IS_CONTROL_PRESSED(0, 51))
						{
							...
							GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_306, 3f, 0);
		...
		case 2:
			...
			{
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_311, sLocal_314, "enter_no_remote", 8f, -4f, 0, 0, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), iLocal_311, "enter_no_remote_remote", sLocal_314, 8f, -4f, 0, 1148846080);
			}
			else
			{
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_311, sLocal_314, "enter", 8f, -4f, 0, 0, 1148846080, 0);
		...
		case 3:
			...
			{
				iLocal_311 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_315, vLocal_316, 2);
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_311, sLocal_314, "base", 8f, -8f, 64, 0, 1148846080, 0);
		...
		case 5:
			...
			if (!func_8())
			{
				...
				{
					iLocal_311 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_315, vLocal_316, 2);
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_311, sLocal_314, "exit", 8f, -8f, 0, 0, 1148846080, 0);
				...
				{
					iLocal_311 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_315, vLocal_316, 2);
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_311, sLocal_314, "idle_a", 8f, -8f, 0, 0, 1148846080, 0);
