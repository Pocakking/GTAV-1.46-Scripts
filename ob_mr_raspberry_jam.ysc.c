...
void __EntryFunction__()
{
	...
	vLocal_274 = { 0f, 0f, 0f };
	vLocal_275 = { 0f, 0f, 0f };
	iLocal_280 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 4);
	func_70();
...
void func_1()
{
	...
	switch (iLocal_277)
	{
			...
			if (func_43(1, 0, 1))
			{
				if (func_46(vVar0, vVar1))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && CONTROLS::IS_CONTROL_PRESSED(2, 51))
					{
						...
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vVar0, 3f, 0);
		...
		case 2:
			...
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_278, func_29(), func_28(iLocal_280), 8f, -2f, 0, 0, 1148846080, 0);
			...
			iLocal_283 = 0;
			iLocal_284 = (GAMEPLAY::GET_GAME_TIMER() + func_23());
			iLocal_277 = 3;
			break;
		...
		case 3:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_278))
			{
				...
				if (!iLocal_283 && GAMEPLAY::GET_GAME_TIMER() > iLocal_284)
				{
...
char* func_25()
{
	...
	fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[0 /*3*/], true);
	fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[1 /*3*/], true);
	if (fVar2 < fVar3)
	{
...
void func_34(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_39(PLAYER::PLAYER_ID())) && !func_36(PLAYER::PLAYER_ID(), 0)) && !func_35()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_39(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_bong_01"):
			...
			if (func_10() == 0)
			{
				...
				if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("family5")) > 0)
				{
					return 0;
				}
				if (func_61())
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_106070.f_7233.f_227[145] == 1)
			{
				if (func_10() == 2)
				{
					if (((((Global_88333[13] != 127 && Global_88333[13] != 135) && Global_88349 != 127) && Global_88349 != 135) && !func_59()) && !func_61())
					{
						return 1;
					}
				}
...
{
	return func_67(iParam0, Global_36117);
}
