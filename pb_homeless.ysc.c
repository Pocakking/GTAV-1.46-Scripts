		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_47, 10f, 10f, 10f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_50, 0))
			{
				if (iLocal_44 == 0)
				{
					...
					AI::TASK_PLAY_ANIM(0, "amb@drug_dealer", "beckon_03", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_50, iLocal_51, 0);
					if (iLocal_46 == 0)
					{
					}
					AI::TASK_WANDER_STANDARD(iLocal_51, 1193033728, 0);
					iLocal_44 = 0;
				}
			}
		}
...
int func_3(int iParam0, vector3 vParam1, float fParam2, float fParam3, bool bParam4)
{
	...
	{
		if ((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vParam1), vVar1, false, true, 0) && PED::_0xFCF37A457CB96DC0(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iParam0, true), fParam2)) && func_5(bParam4)) && !PED::IS_PED_RAGDOLL(iParam0)) && !AI::IS_PED_GETTING_UP(iParam0))
		{
			func_4(iParam0, 1);
			return 1;
		}
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_47, 50f, 50f, 50f, false, true, 0))
	{
		...
		if (iLocal_44 == 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_50, 0))
			{
				...
				AI::TASK_PLAY_ANIM(0, "amb@drug_dealer", "beckon_01", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_53);
				AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_53);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_53);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0))
			{
				...
				AI::TASK_PLAY_ANIM(0, "amb@drug_dealer", "beckon_02", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_53);
				AI::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_53);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_53);
			}
		}
		iLocal_45 = 1;
