...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			if (!func_83() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_103())
				{
				}
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_46(Global_106015[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_55();
				bVar37 = func_56();
				func_45(Global_106015[iLocal_217]);
		...
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_72(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_71(iVar19))
				{
					if (!func_70(iVar19))
					{
...
void func_48()
{
	...
	func_51(Global_106015[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_49(Global_106015[iLocal_217]);
}
...
int func_100()
{
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[58 /*6*/], 0) && !GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_105()
{
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[60 /*6*/], 0) && !GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[60 /*6*/], 3))
	{
		return 0;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[61 /*6*/], 0) && !GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[61 /*6*/], 3))
	{
		return 0;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[62 /*6*/], 3))
	{
		return 0;
	}
	if ((GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[58 /*6*/], 2) || GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[59 /*6*/], 2)) || GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
