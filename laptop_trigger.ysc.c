...
void __EntryFunction__()
{
	...
	sVar1 = "tvscreen";
	bVar3 = true;
	vVar4 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_194, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iScriptParam_194) * Vector(0.6f, 0.6f, 0.6f) };
	vVar4.z = (vVar4.z + 0.5f);
	vLocal_190 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_194, vLocal_189) };
	Global_1668519 = 0;
	Global_1668628 = 0;
	while (bVar3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
		{
			...
			if (Global_1668519 && (func_217(PLAYER::PLAYER_ID()) || func_216(PLAYER::PLAYER_ID())))
			{
			...
			if (Global_1589601)
			{
				if (!bVar0)
				{
					iVar5 = ENTITY::GET_ENTITY_MODEL(iLocal_186);
					if (iVar5 == 1385417869)
					{
						ENTITY::CREATE_MODEL_HIDE(ENTITY::GET_ENTITY_COORDS(iScriptParam_194, true), 1f, 1385417869, 0);
						vVar6 = { ENTITY::GET_ENTITY_ROTATION(iLocal_186, 2) };
						iLocal_186 = OBJECT::CREATE_OBJECT(joaat("prop_laptop_lester2"), ENTITY::GET_ENTITY_COORDS(iLocal_186, true), false, true, false);
						ENTITY::SET_ENTITY_ROTATION(iLocal_186, vVar6, 2, 1);
						bVar0 = true;
					}
				}
			}
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(iLocal_186))
			{
				func_223();
				SCRIPT::TERMINATE_THIS_THREAD();
			}
		}
		if (((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_186)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_186))
			{
				bVar7 = false;
				...
				if (((func_208() || func_207(PLAYER::PLAYER_ID())) || func_216(PLAYER::PLAYER_ID())) || func_206())
				{
					vVar10 = { 1f, 1f, 0.9f };
				}
				else if (func_205())
				...
				bVar11 = func_204(PLAYER::PLAYER_ID());
				if (((((((((((((((!bVar7 && !Global_25726) && !func_203(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_202()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar4, vVar10, false, true, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_186)) && !GAMEPLAY::IS_BIT_SET(Global_2359302, 15)) && !func_201()) && !(Global_71205 && func_200())) && !(!Global_71205 && func_199())) && !((Global_71205 && GAMEPLAY::IS_BIT_SET(Global_4456448.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_71205 && func_198()) && func_197())) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) && !Global_70017) && (!func_205() || func_196(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_186), 90f)))
				{
					if ((!func_195(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24) && !func_194(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24, -1)) && !func_193(PLAYER::PLAYER_ID()))
					{
						if (iLocal_178 != bVar11)
						{
							if ((func_217(PLAYER::PLAYER_ID()) || func_192(PLAYER::PLAYER_ID())) || func_216(PLAYER::PLAYER_ID()))
							{
								if (iLocal_175 != -1)
								{
									func_191(&iLocal_175);
					...
					if (((iLocal_175 != -1 && func_167(iLocal_175, 1)) && !AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_166())
					{
						if (iLocal_175 != -1)
						{
							func_191(&iLocal_175);
						...
						if (!bVar0)
						{
							...
							while (bVar12)
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_186) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_186, true), 1.5f, 1.5f, 4f, false, true, 1))
								{
									Global_68497 = 1;
								}
								if (((func_165() || func_164()) || func_193(PLAYER::PLAYER_ID())) || func_163())
								{
				...
				else
				{
					...
					if (func_217(PLAYER::PLAYER_ID()) || func_192(PLAYER::PLAYER_ID()))
					{
						if (func_189())
						{
							UI::CLEAR_HELP(1);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_194))
					{
						if (!BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iScriptParam_194))
						{
							bVar3 = false;
						}
					}
...
void func_1()
{
	...
	if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1) && ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_2(2, &sVar0))
				{
					if (iLocal_187 != 0)
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_188))
						{
							PED::DETACH_SYNCHRONIZED_SCENE(iLocal_188);
							iLocal_188 = -1;
						}
						iLocal_188 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_190, ENTITY::GET_ENTITY_ROTATION(iLocal_186, 2), 2, false, false, 1065353216, 0, 1065353216);
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar0, "exit", 8f, -4f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
						STREAMING::REMOVE_ANIM_DICT(&sVar0);
					}
				}
			}
...
int func_2(int iParam0, char* sParam1)
{
	...
	if ((!func_217(PLAYER::PLAYER_ID()) && !func_216(PLAYER::PLAYER_ID())) && !func_3(PLAYER::PLAYER_ID()))
	{
		StringCopy(sParam1, "", 64);
		return 0;
	}
...
int func_26(int iParam0, bool bParam1, int iParam2)
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appsecuroserv")) > 0)
	{
		if (bVar0)
		{
		}
...
{
	if ((((!bParam1 && !func_156(PLAYER::PLAYER_ID(), 1)) && func_155() < func_154()) && !NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && !func_150(PLAYER::PLAYER_ID()))
	{
		func_28(1, iParam0);
	}
}
...
void func_28(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		...
		Var0.f_2 = -1926407637;
		Var0.f_3 = iParam1;
		if (func_83(PLAYER::PLAYER_ID()) && iParam1 == 0)
		{
			Var0.f_3 = 100;
		}
		func_81(Var0, func_82(0, 1));
		func_47();
		if (!func_83(PLAYER::PLAYER_ID()) && iParam1 != 1)
		{
...
int func_30(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14682)
	{
		if (Global_14513.f_1 == 6)
		{
			...
			func_31(1);
			func_34(Global_14494, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_32(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
void func_47()
{
	if ((!func_78() && func_62()) && func_59(PLAYER::PLAYER_ID()))
	{
		if (func_56())
		{
...
void func_49(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_55() || !NETWORK::NETWORK_IS_ACTIVITY_SESSION()) || !func_52(PLAYER::PLAYER_ID(), 0))
	{
		return;
	}
...
int func_59(int iParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_1589747[iParam0 /*790*/].f_142, 2) || GAMEPLAY::IS_BIT_SET(Global_1589747[iParam0 /*790*/].f_142, 5))
	{
		return 0;
	}
	if (func_60(iParam0))
...
int func_78()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_11[iVar0] == func_6())
		{
			StringCopy(&Var2, "", 64);
			Var2 = { func_79(func_80(iVar0)) };
			if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var2, &uVar1))
			{
				return 0;
			}
		}
...
void func_81(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
	Param0 = 713068249;
...
void func_85()
{
	...
	{
		StringCopy(&Var0, func_98(PLAYER::PLAYER_ID(), 0), 64);
	}
	func_89(&Var0, iVar1, 0);
	if ((!GAMEPLAY::IS_DURANGO_VERSION() && NETWORK::_0x595F028698072DD9(0, -1, 1)) || func_88())
	{
		func_87(28);
	}
	else
...
void func_89(char* sParam0, int iParam1, bool bParam2)
{
	...
	StringCopy(&(Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_99), sParam0, 64);
	Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_115 = unk_0xDD5EDF2E0AECDED0();
	if ((!GAMEPLAY::IS_DURANGO_VERSION() && NETWORK::_0x595F028698072DD9(0, -1, 1)) || func_88())
	{
		func_87(28);
	}
...
void func_90(char* sParam0, bool bParam1)
{
	...
	{
		bVar1 = true;
		if ((func_61(PLAYER::PLAYER_ID(), 28) || func_93(PLAYER::PLAYER_ID())) && !func_91(PLAYER::PLAYER_ID()))
		{
			bVar1 = false;
		}
		if (bVar1)
		{
			StringCopy(&(Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_326), sParam0, 64);
		}
	}
}
...
void func_94(char* sParam0, bool bParam1)
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		StringCopy(&(Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_342), sParam0, 64);
	}
	if ((!GAMEPLAY::IS_DURANGO_VERSION() && NETWORK::_0x595F028698072DD9(0, -1, 1)) || func_88())
	{
		func_87(28);
...
void func_95(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (func_97())
	{
		...
		if (iVar0 != 0 && iVar1 != 0)
		{
			StringCopy(&cVar2, "", 32);
			StringCopy(&cVar3, "", 32);
			iVar4 = UI::GET_LENGTH_OF_LITERAL_STRING(sParam2);
			if (iVar4 > 0)
			{
				iVar5 = 10;
				if (iVar4 < 10)
				...
				StringCopy(&cVar2, UI::_GET_TEXT_SUBSTRING_SAFE(sParam2, 0, iVar5, 31), 32);
				if (iVar4 > 10)
				{
					StringCopy(&cVar3, UI::_GET_TEXT_SUBSTRING_SAFE(sParam2, 10, iVar4, 31), 32);
				}
			}
...
void func_103(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11 != PLAYER::PLAYER_ID())
	{
		if (bParam1)
		{
			unk_0x3EBEAC6C3F81F6BD(iVar2);
			func_144(0);
			func_142(0);
			func_87(21);
			func_87(22);
			Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_447 = iVar2;
		}
		Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11 = PLAYER::PLAYER_ID();
		Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_409 = iParam2;
		Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_446 = iParam2;
		unk_0x6BC0ACD0673ACEBE(func_54(), &uVar3, &uVar4);
		func_141(uVar3, uVar4);
		...
		Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_24 = -1;
		Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_25 = -1;
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2524719.f_1725, 15))
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2524719.f_1725), 15);
		}
		if (func_120(15))
		{
			func_119(15);
		}
		if (!func_118() && !NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		{
			func_117();
			func_116(2);
		}
		...
		if (iParam2 != 1)
		{
			...
			{
				bVar7 = false;
				iVar8 = func_138(8525, -1, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar8, 11))
				{
					GAMEPLAY::SET_BIT(&iVar8, 11);
					func_115(8525, iVar8, -1, 1, 0);
					bVar7 = true;
				}
				func_109(82, 3, bVar7);
			}
		...
		if (iParam2 == 1)
		{
			unk_0x0B565B0AAE56A0E8(func_107(func_108()), func_106(func_108()), func_105(), func_104(), Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_410, 4, Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_448);
		}
	}
}
...
{
	GAMEPLAY::SET_BIT(&(Global_2391020.f_2), iParam0);
	if (Global_2391020)
	{
		return;
	}
...
void func_117()
{
	...
	while (iVar0 < 15)
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(Global_2390946.f_28[iVar0 /*2*/].f_1))
			{
				UI::SET_BLIP_AS_SHORT_RANGE(Global_2390946.f_28[iVar0 /*2*/].f_1, true);
			}
		}
		iVar0++;
	}
...
void func_130(int iParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_95, iParam0))
	{
		iVar0 = PLAYER::GET_PLAYER_PED(iParam0);
		PED::SET_PED_CAN_BE_TARGETTED_BY_PLAYER(iVar0, PLAYER::PLAYER_ID(), true);
		unk_0x55FCC0C390620314(PLAYER::PLAYER_ID(), iParam0, true);
		unk_0x55FCC0C390620314(iParam0, PLAYER::PLAYER_ID(), true);
		func_131(1, iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_95), iParam0);
	}
}
...
void func_135(int iParam0)
{
	...
	Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_1 = iParam0;
	if (func_138(8528, -1, 0) != func_136(PLAYER::PLAYER_ID()))
	{
		func_115(8528, func_136(PLAYER::PLAYER_ID()), -1, 1, 0);
	}
}
...
int func_138(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_96(iParam1)];
...
{
	Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_8[0] = uParam0;
	Global_1625435[PLAYER::PLAYER_ID() /*560*/].f_11.f_8[1] = uParam1;
}
...
void func_144(bool bParam0)
{
	...
	{
		if (func_61(PLAYER::PLAYER_ID(), 21))
		{
			func_87(21);
...
int func_151(int iParam0)
{
	...
	if (func_5(iParam0, 0, 1))
	{
		...
		iVar1 = ((iVar0 + func_152()) - NETWORK::_GET_POSIX_TIME());
		return iVar1;
	}
	return -1;
}
...
void func_157()
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
		vVar1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_186, 0.0328f, -0.8f, 0.3f) };
		bVar2 = false;
		func_214(&uLocal_182);
		if (func_2(0, &sVar0))
		{
			while (!bVar2)
			{
				...
				if (!func_162(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar1, 0.05f, 0) && !func_196(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_186), 5f))
				{
					if (!func_159(PLAYER::PLAYER_PED_ID(), 2106541073))
					{
						AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar1, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iLocal_186), 0.25f);
					}
				}
				else
				{
				...
				GRAPHICS::DRAW_DEBUG_LINE(vVar1, ENTITY::GET_ENTITY_COORDS(iLocal_186, true), 0, 255, 0, 255);
...
void func_158(int iParam0)
{
	...
	switch (iLocal_187)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
				{
					...
					iLocal_188 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_190, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
					STREAMING::REMOVE_ANIM_DICT(&sVar0);
					iLocal_187 = 1;
				}
		...
		case 1:
			...
			iVar5 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_188);
			if (!iLocal_179)
			{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar1) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar5) >= 0.96f))
			{
				...
				if ((((GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_191, "idle_a") && iVar6 == 0) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_191, "idle_b") && iVar6 == 1)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_191, "idle_c") && iVar6 == 2)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_191, "idle_d") && iVar6 == 3))
				{
					iVar6++;
					if (iVar6 >= iVar4)
					{
				...
				iLocal_188 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_190, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1065353216, 0, 1065353216);
				switch (iVar6)
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar1, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
						StringCopy(&cLocal_191, "idle_a", 16);
						iLocal_187 = 3;
						break;
					
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar1, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
						StringCopy(&cLocal_191, "idle_b", 16);
						iLocal_187 = 3;
						break;
					
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar1, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
						StringCopy(&cLocal_191, "idle_c", 16);
						iLocal_187 = 3;
						break;
					
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar1, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
						StringCopy(&cLocal_191, "idle_d", 16);
						iLocal_187 = 3;
						break;
					
					default:
						StringCopy(&cLocal_191, "idle_XXX", 16);
						break;
					}
			}
			break;
		...
		case 3:
			...
			iVar5 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_188);
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_188) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_188))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(iLocal_188);
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_188, &sVar1, sVar3, 4f, -2f, 5, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_188);
				iLocal_187 = 3;
				return;
			}
...
int func_162(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
bool func_163()
{
	return GAMEPLAY::IS_BIT_SET(Global_1668658.f_16, 30);
}
...
int func_164()
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1668658.f_16, 0) || GAMEPLAY::IS_BIT_SET(Global_1668658.f_16, 2))
		{
			return 1;
		}
	}
...
{
	if (((func_163() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_170()) && !Global_1668519)
	{
...
{
	if ((((func_193(PLAYER::PLAYER_ID()) && func_180(PLAYER::PLAYER_ID()) == func_179(PLAYER::PLAYER_ID())) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_170()) && !Global_1668519)
	{
		if (func_177())
		{
		...
		else if (!bParam0)
		{
			...
			else if (func_150(PLAYER::PLAYER_ID()))
			{
		...
		{
			if (func_172(PLAYER::PLAYER_ID()) || Global_1668519 == 1)
			{
				iLocal_177 = 1;
				if (!Global_1668519)
				{
...
{
	if (((((func_192(PLAYER::PLAYER_ID()) || func_164()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_170()) && !Global_1668519) && func_196(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_186), 90f))
	{
		...
		else if (func_57(PLAYER::PLAYER_ID()))
		{
			...
			{
				if (func_183(PLAYER::PLAYER_ID()) || Global_1668519 == 1)
				{
					iLocal_177 = 1;
					if (!Global_1668519)
					{
...
int func_185()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		if (func_216(PLAYER::PLAYER_ID()) || func_186(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
...
{
	if (((func_165() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_170()) && !Global_1668519)
	{
		if (func_177())
		{
			func_176("WHPRIVSESLAP");
		...
		{
			if (func_220(PLAYER::PLAYER_ID()) || Global_1668519 == 1)
			{
				iLocal_177 = 1;
				if (!Global_1668519)
				{
...
{
	if (func_194(Global_1589747[iParam0 /*790*/].f_273.f_24, -1) && !GAMEPLAY::IS_BIT_SET(Global_1589747[iParam0 /*790*/].f_273.f_22, 1))
	{
		return 1;
	}
	return 0;
...
int func_205()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186) && func_3(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_206()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186) && func_193(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_208()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		if (ENTITY::GET_ENTITY_MODEL(iLocal_186) == 743064848 || func_217(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
