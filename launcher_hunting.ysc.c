...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_270(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_258(&Var0, 1);
	}
	...
	GAMEPLAY::CLEAR_AREA(vVar1, 3f, 1, 0, 0, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_195(&Var0, 1))
		...
		if (func_167(&Var0, 0) && GAMEPLAY::ABSF((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_258(&Var0, 1);
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_195(int iParam0, bool bParam1)
{
	...
	func_109(*iParam0, &Var0);
	if ((func_232(*iParam0) || func_230(*iParam0)) || Global_71450 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_198(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
{
	if ((func_231() && Global_93232.f_11 == 6) && iParam0 == func_165(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
