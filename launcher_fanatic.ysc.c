	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_287(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_272(&Var0, 1);
	}
			...
			if (Var0 == 22)
			{
				if (CUTSCENE::_0xB56BBBCC2955D9CB())
				{
					if (func_196(Var0.f_28[1]))
					{
						...
						CUTSCENE::_0x2A56C06EBEF2B0D9("MaryAnnes_Friend", Var0.f_28[1], 0);
...
void func_185(int iParam0)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_57) >= 900)
	{
		if (func_196(iParam0->f_28[0]))
		{
			if (!func_144())
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && !func_144()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_189(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_205(var uParam0, bool bParam1)
{
	...
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_71450 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
{
	if ((func_241() && Global_93232.f_11 == 6) && iParam0 == func_164(&(Global_93232.f_3), 0))
	{
		return 1;
	}
	return 0;
