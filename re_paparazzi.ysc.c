...
void __EntryFunction__()
{
	...
	if (Global_3)
	{
		GAMEPLAY::CLEAR_AREA(246.1673f, 92.1704f, 93.8361f, 6f, 1, 0, 0, false);
	}
	...
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_225(&uLocal_74);
		...
		UNK1::_0x208784099002BC30("RE_EP", 0);
		iVar0 = 0;
		...
		if (!func_224())
		{
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_130)
				{
					...
					case 1:
						if ((func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
						{
		...
		if (iLocal_45 <= 0)
		{
			...
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, 0, true, 0) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_145) > 5000) && !PED::IS_PED_INJURED(Local_109[iVar1 /*18*/]))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_109[iVar1 /*18*/], true), vLocal_52) < (30.5f * 30.5f) && SYSTEM::VDIST2(vLocal_53, vLocal_52) > (22.5f * 22.5f))
					{
						if (func_224())
						{
							...
							else if (!iLocal_193)
							{
								...
								{
									iLocal_145 = GAMEPLAY::GET_GAME_TIMER();
									iLocal_193 = 1;
								}
							}
						...
						else
						{
							...
							StringIntConCat(&vVar2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 13), 24);
...
void func_25()
{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_pap_camera_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("cavalcade2"))) && STREAMING::HAS_MODEL_LOADED(joaat("vader"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_134)) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@pap_anims"))
			{
				...
				AI::TASK_PLAY_ANIM(func_56(0, 1), "random@paparazzi@pap_anims", "base_pap", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(1, 0), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(1, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(2, 1), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(3, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				iLocal_47 = 1;
			}
			break;
		...
		case 2:
			...
			switch (iLocal_165)
			{
				case 0:
					...
					{
						AI::CLEAR_PED_TASKS(func_56(1, 0));
					}
					if (!PED::IS_PED_INJURED(func_56(1, 1)))
					{
						AI::CLEAR_PED_TASKS(func_56(1, 1));
					}
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(2, 1), vLocal_156, 2f, -1, 0.25f, 0, 40000f);
					}
					if (!PED::IS_PED_INJURED(func_56(3, 1)))
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(3, 1), vLocal_157, 2f, -1, 0.25f, 0, 40000f);
					}
					...
					if (Global_3 || bLocal_56)
					{
						if (!PED::IS_PED_INJURED(func_56(1, 0)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 0), vLocal_158, 2f, 20000, 0.25f, 0, 40000f);
						}
						if (!PED::IS_PED_INJURED(func_56(1, 1)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 1), vLocal_159, 2f, 20000, 0.25f, 0, 40000f);
						}
						if (!PED::IS_PED_INJURED(func_56(0, 1)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(0, 1), vLocal_160, 2f, 20000, 0.25f, 0, 40000f);
						}
					}
					SYSTEM::SETTIMERB(0);
					iVar1 = 0;
					while (iVar1 < Local_109)
					{
						...
						{
							AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_109[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iVar1 = 0;
					while (iVar1 < Local_108)
					{
						...
						{
							AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_108[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iLocal_165++;
				...
				case 1:
					...
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[0 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(0, 0))) && !PED::IS_PED_INJURED(func_56(0, 1)))
					{
						...
						{
							iLocal_152[1] = 1;
							AI::TASK_VEHICLE_DRIVE_TO_COORD(func_56(0, 0), Local_108[0 /*18*/], vLocal_154, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
						}
					}
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[2 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(2, 0))) && !PED::IS_PED_INJURED(func_56(2, 1)))
					{
						if (!iLocal_152[0])
						{
							AI::TASK_VEHICLE_DRIVE_TO_COORD(func_56(2, 0), Local_108[2 /*18*/], vLocal_155, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
							iLocal_152[0] = 1;
						}
					}
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(iLocal_168, 3))
						{
							AI::CLEAR_PED_TASKS(Local_109[func_59(3) /*18*/]);
							GAMEPLAY::SET_BIT(&iLocal_168, 3);
						}
						if (!GAMEPLAY::IS_BIT_SET(iLocal_168, 2))
						{
							AI::CLEAR_PED_TASKS(Local_109[func_59(2) /*18*/]);
							GAMEPLAY::SET_BIT(&iLocal_168, 2);
						}
						if (!GAMEPLAY::IS_BIT_SET(iLocal_168, 0))
						{
							AI::CLEAR_PED_TASKS(Local_109[func_59(0) /*18*/]);
							GAMEPLAY::SET_BIT(&iLocal_168, 0);
						}
						if (Global_3 || bLocal_56)
						{
							func_45(iLocal_67, func_59(3));
		...
		case 3:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
			{
				...
				{
					fLocal_153 = (fLocal_153 + GAMEPLAY::GET_FRAME_TIME());
				}
			...
			while (iVar0 < Local_108)
			{
				...
				{
					if ((iVar0 < 2 && ((iVar0 != iLocal_163 || !ENTITY::DOES_ENTITY_EXIST(Local_108[0 /*18*/])) || !ENTITY::DOES_ENTITY_EXIST(Local_108[1 /*18*/]))) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_164) > 500)
					{
						if (SYSTEM::VDIST2(vLocal_52, vLocal_68) > 400f)
						{
							if (SYSTEM::VDIST2(vLocal_52, vLocal_68) < 62500f || (GAMEPLAY::GET_GAME_TIMER() - iLocal_131) < 30000)
							{
					...
					switch (Local_108[iVar0 /*18*/].f_17)
					{
						case 0:
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iVar0 /*18*/], 0))
							{
								if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_108[iVar0 /*18*/], 0))
								{
									if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]))
									{
										...
										{
											if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], -1794415470) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_108[iVar0 /*18*/], -1, 0))
											{
												AI::TASK_ENTER_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], -1, -1, 2f, 1, 0);
											}
										}
									}
									if (iVar3 != -1)
									{
										if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar3 /*18*/], -1794415470) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_108[iVar0 /*18*/], 0, 0))
												{
													AI::TASK_ENTER_VEHICLE(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], -1, 0, 2f, 1, 0);
												}
											}
										}
										if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]) && (iVar3 != -1 && !PED::IS_PED_INJURED(Local_109[iVar3 /*18*/])))
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], -1817882002) != 1)
												{
													...
													if (iVar0 == 0)
													{
														AI::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
													}
													else if (iVar0 == 1)
													{
														AI::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, 50f, 786470, 4f, 10f, 1);
													}
													else if (iVar0 == 2)
													{
														AI::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
												...
												AI::SET_DRIVE_TASK_CRUISE_SPEED(Local_109[iVar2 /*18*/], func_39((3f * GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_54, Local_108[iVar0 /*18*/].f_8, true)), 50f, 120f));
											}
										}
									}
							...
							else
							{
								if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]))
								{
									...
									{
										PED::SET_PED_FLEE_ATTRIBUTES(Local_109[iVar2 /*18*/], 2, 0);
										AI::TASK_SMART_FLEE_PED(Local_109[iVar2 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
									}
								}
								if (iVar3 != -1)
								{
									if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
									{
										...
										{
											PED::SET_PED_FLEE_ATTRIBUTES(Local_109[iVar3 /*18*/], 2, 0);
											AI::TASK_SMART_FLEE_PED(Local_109[iVar3 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
										}
									}
								}
							}
						...
						case 1:
							...
							{
								AI::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar2 /*18*/], 1, 256);
							}
							else
							{
							...
							if (iVar3 != -1)
							{
								if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
								{
									...
									{
										AI::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar3 /*18*/], 0, 256);
									}
									else
									{
				...
				while (iVar0 < Local_108)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iVar0 /*18*/], 0))
					{
						if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]))
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], -1794415470) != 1)
								{
									AI::TASK_ENTER_VEHICLE(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], -1, -1, 2f, 1, 0);
								}
							}
						}
						if (iVar6 != -1)
						{
							if (!PED::IS_PED_INJURED(Local_109[iVar6 /*18*/]))
							{
								...
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar6 /*18*/], -1794415470) != 1)
									{
										AI::TASK_ENTER_VEHICLE(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], -1, 0, 2f, 1, 0);
									}
								}
							}
							if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]) && (iVar6 != -1 && !PED::IS_PED_INJURED(Local_109[iVar6 /*18*/])))
							{
								...
								{
									fVar7 = func_39((70f - (SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_66)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (GAMEPLAY::GET_GAME_TIMER() - iLocal_66) > 4000)
									{
										AI::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_109[iVar5 /*18*/], fVar7);
										iVar8 = 0;
										while (iVar8 < Local_108)
										{
											...
											{
												AI::CLEAR_PED_TASKS(func_56(iVar8, 0));
												AI::TASK_VEHICLE_MISSION(func_56(iVar8, 0), Local_108[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_167 = 1;
									}
									else if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], -1817882002) != 1)
									{
										...
										if (iVar0 == 0)
										{
											AI::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
										}
										else if (iVar0 == 1)
										{
											AI::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, fVar7, 786470, 4f, 10f, 1);
										}
										else if (iVar0 == 2)
										{
											AI::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
					...
					else
					{
						if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]))
						{
							...
							{
								PED::SET_PED_FLEE_ATTRIBUTES(Local_109[iVar5 /*18*/], 2, 0);
								AI::TASK_SMART_FLEE_PED(Local_109[iVar5 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
							}
						}
						if (iVar6 != -1)
						{
							if (!PED::IS_PED_INJURED(Local_109[iVar6 /*18*/]))
							{
								...
								{
									PED::SET_PED_FLEE_ATTRIBUTES(Local_109[iVar6 /*18*/], 2, 0);
									AI::TASK_SMART_FLEE_PED(Local_109[iVar6 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
								}
							}
						}
					}
	...
	while (iVar0 < Local_109)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			if (iLocal_47 > 1)
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_134))
				{
					func_28(iVar0);
					if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/].f_2) && ENTITY::IS_ENTITY_ATTACHED(Local_109[iVar0 /*18*/].f_2))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
						{
							...
							{
								if (AI::IS_PED_GETTING_UP(Local_109[iVar0 /*18*/]))
								{
									ENTITY::SET_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2, false, 0);
								}
							}
							else if (!AI::IS_PED_GETTING_UP(Local_109[iVar0 /*18*/]))
							{
							...
							if (!ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar0 /*18*/]))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iVar0 /*18*/], sLocal_134, func_27(iVar0), 3))
								{
									if (!Local_109[iVar0 /*18*/].f_11)
									{
										...
										{
											AI::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 57, 0f, 0, 0, 0);
								...
								{
									AI::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 48, 0.99f, 0, 0, 0);
...
void func_28(int iParam0)
{
	...
	while (iVar0 < 15)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_109[iParam0 /*18*/].f_15, iVar0))
		{
			iVar1 = 5;
			...
			if (iVar3 < iVar1)
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_27(iParam0), 3))
				{
					...
					{
						GAMEPLAY::CLEAR_BIT(&(Local_109[iParam0 /*18*/].f_15), iVar0);
					}
				}
			}
			else if (iVar3 < iVar2)
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_108[iLocal_149 /*18*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iLocal_149 /*18*/], 0)) && ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/])) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			if (VEHICLE::IS_VEHICLE_MODEL(Local_108[iLocal_149 /*18*/], joaat("cavalcade2")))
			{
				if (SYSTEM::VDIST2(Local_109[iVar0 /*18*/].f_6, vLocal_53) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					...
					else if (!func_36(iVar0) && (GAMEPLAY::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_13) > 1000)
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iVar0 /*18*/], sLocal_135, "base", 3))
						{
							AI::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_135, "base", 8f, 1000f, -1, 16, 0f, 0, 0, 0);
						}
					}
				}
			}
			else if (!Local_109[iVar0 /*18*/].f_9)
			{
				if (SYSTEM::VDIST2(Local_109[iVar0 /*18*/].f_6, vLocal_53) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					AI::TASK_SWEEP_AIM_ENTITY(Local_109[iVar0 /*18*/], "random@paparazzi@pap_anims", "sweep_low", "sweep_med", "sweep_high", -1, iLocal_67, 1.57f, 0.25f);
					Local_109[iVar0 /*18*/].f_9 = 1;
					Local_109[iVar0 /*18*/].f_13 = GAMEPLAY::GET_GAME_TIMER();
				}
			}
			else if (Local_109[iVar0 /*18*/].f_9)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_13) > 2000)
				{
...
void func_31(int iParam0, int iParam1)
{
	if (iParam1 < 15)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_109[iParam0 /*18*/].f_15, iParam1))
		{
			if (func_33(iParam1))
			{
				AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[func_32(iParam1)], 4f, -4f, -1, 16, 0f, 0, 0, 0);
			}
			else if (iParam1 < 5)
			{
				AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_27(iParam0), 8f, -8f, -1, 0, 0f, 0, 0, 0);
			}
			else
			{
				AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 57, 0f, 0, 0, 0);
			}
			Local_109[iParam0 /*18*/].f_15 = 0;
			GAMEPLAY::SET_BIT(&(Local_109[iParam0 /*18*/].f_15), iParam1);
		}
	}
}
...
float func_34(vector3 vParam0, vector3 vParam1)
{
	...
	fVar0 = (GAMEPLAY::ATAN2(vParam1.y, vParam1.x) - GAMEPLAY::ATAN2(vParam0.y, vParam0.x));
	if (fVar0 > 180f)
	{
		fVar0 = (fVar0 - 360f);
	}
...
bool func_36(int iParam0)
{
	...
	bVar0 = false;
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_135))
	{
		iVar1 = 5;
		while (iVar1 <= 13)
		{
			if (!bVar0)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_109[iParam0 /*18*/].f_15, iVar1))
				{
					bVar0 = true;
				}
			}
...
void func_37(int iParam0)
{
	...
	if (UI::DOES_BLIP_EXIST(Local_108[iParam0 /*18*/].f_1))
	{
		UI::REMOVE_BLIP(&(Local_108[iParam0 /*18*/].f_1));
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar1 /*18*/]) && ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar1 /*18*/]))
		{
			...
			if (UI::DOES_BLIP_EXIST(Local_109[iVar1 /*18*/].f_1))
			{
				UI::REMOVE_BLIP(&(Local_109[iVar1 /*18*/].f_1));
			}
...
void func_40(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1)))
		{
			...
			{
				if ((func_42(iParam0, iParam1, 1) > fParam9 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, true), *uParam2, true) > 20f) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), *uParam2) > 100f)
				{
					if (!func_41(*uParam2))
					{
						if (!CAM::IS_SPHERE_VISIBLE(*uParam2, 6f))
						{
							GAMEPLAY::CLEAR_AREA_OF_PEDS(*uParam2, 6f, 0);
							GAMEPLAY::CLEAR_AREA_OF_VEHICLES(*uParam2, 6f, 0, 0, 0, 0, false, 0);
...
void func_44()
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_148) > 100)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - Local_109[iLocal_147 /*18*/].f_12) > 500)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_109[iLocal_147 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iLocal_147 /*18*/]))
			{
				...
				if (bVar0)
				{
					...
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_rcpap1_camera", Local_109[iLocal_147 /*18*/].f_2, 0.019f, -0.01f, 0.046f, 0f, 0f, -180f, 1f, 0, 0, 0);
						if ((iLocal_147 % 3) == 0)
						{
						...
						Local_109[iLocal_147 /*18*/].f_12 = GAMEPLAY::GET_GAME_TIMER();
					}
...
void func_45(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(Local_109[iParam1 /*18*/]) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], -875674219) != 1)
			{
				AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_109[iParam1 /*18*/], iParam0, 0);
			}
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - Local_109[iParam1 /*18*/].f_13) > 2000)
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_27(iParam1), 3))
			{
				AI::TASK_PLAY_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_27(iParam1), 4f, -4f, -1, 0, 0f, 0, 0, 0);
				Local_109[iParam1 /*18*/].f_13 = GAMEPLAY::GET_GAME_TIMER();
			}
		}
	}
}
...
void func_46(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(Local_109[iParam1 /*18*/]) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		switch (Local_109[iParam1 /*18*/].f_16)
		{
			...
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], 713668775) != 1 || SYSTEM::VDIST(vVar0, Local_109[iParam1 /*18*/].f_6) > 5f)
				{
					Local_109[iParam1 /*18*/].f_16++;
				}
				break;
			...
			case 3:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], 713668775) != 1)
				{
...
void func_47(vector3 vParam0, int iParam1, int iParam2)
{
	...
	fVar1 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
	Local_109[iParam1 /*18*/].f_3 = { vParam0 };
	AI::CLEAR_PED_TASKS(Local_109[iParam1 /*18*/]);
	if (SYSTEM::VDIST(vParam0, Local_109[iParam1 /*18*/].f_6) < 2f)
	{
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 1f, -1, 0.5f, 512, fVar1);
	}
	else
	{
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 2f, -1, 0.5f, 512, fVar1);
	}
}
...
void func_49()
{
	...
	while (iVar0 < Local_109)
	{
		if (UI::DOES_BLIP_EXIST(Local_109[iVar0 /*18*/].f_1))
		{
			if (PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
			{
				UI::REMOVE_BLIP(&(Local_109[iVar0 /*18*/].f_1));
			}
		...
		else if (!PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
		{
			...
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_109[iVar0 /*18*/].f_1, "EP_PAPBLIP");
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Local_108)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_108[iVar0 /*18*/], 0))
		{
			if (UI::DOES_BLIP_EXIST(Local_108[iVar0 /*18*/].f_1))
			{
				vVar1 = { UI::GET_BLIP_COORDS(Local_108[iVar0 /*18*/].f_1) };
				...
				UI::SET_BLIP_COORDS(Local_108[iVar0 /*18*/].f_1, vVar1);
				if (func_52(Local_108[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0))
				{
					UI::REMOVE_BLIP(&(Local_108[iVar0 /*18*/].f_1));
				}
			}
			else if (!func_52(Local_108[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0))
			{
				Local_108[iVar0 /*18*/].f_1 = func_50(Local_108[iVar0 /*18*/].f_8, 0);
				UI::SET_BLIP_COLOUR(Local_108[iVar0 /*18*/].f_1, 1);
				UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_108[iVar0 /*18*/].f_1, "EP_PAPBLIP");
				UI::SET_BLIP_PRIORITY(Local_108[iVar0 /*18*/].f_1, 9);
			}
		}
		else if (UI::DOES_BLIP_EXIST(Local_108[iVar0 /*18*/].f_1))
		{
			UI::REMOVE_BLIP(&(Local_108[iVar0 /*18*/].f_1));
		}
		iVar0++;
...
int func_50(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_51(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_54(int iParam0, vector3 vParam1, float fParam2, char* sParam3, char* sParam4, char* sParam5)
{
	if (!PED::IS_PED_INJURED(Local_109[iParam0 /*18*/]))
	{
		...
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iParam0 /*18*/], 713668775) != 1)
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam0 /*18*/], vParam1, 2f, -1, 0.25f, 0, fParam2);
			}
		}
		else if (GAMEPLAY::ABSF((func_55(ENTITY::GET_ENTITY_HEADING(Local_109[iParam0 /*18*/])) - func_55(fParam2))) > 10f)
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iParam0 /*18*/], 1920390111) != 1)
			{
				AI::TASK_ACHIEVE_HEADING(Local_109[iParam0 /*18*/], fParam2, 0);
			}
		}
		else
		{
			switch (Local_109[iParam0 /*18*/].f_16)
			{
				case 0:
					if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam5))
					{
						...
						{
							AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, -1, 1, 0f, 0, 0, 0);
						}
					}
					else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 3))
					{
						AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, -1, 0, 0f, 0, 0, 0);
					}
					else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iParam0 /*18*/], sParam3, sParam4) > 0.99f)
					{
						AI::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam5, 4f, -4f, -1, 0, 0f, 0, 0, 0);
...
void func_58(int iParam0, vector3 vParam1, float fParam2)
{
	...
	PED::SET_PED_FLEE_ATTRIBUTES(Local_109[iParam0 /*18*/], 2, 0);
	ENTITY::_SET_ENTITY_REGISTER(Local_109[iParam0 /*18*/], false);
...
int func_63()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
		{
			...
			{
				fLocal_151 = (fLocal_151 + GAMEPLAY::GET_FRAME_TIME());
			}
...
int func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (!bParam2)
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(vVar0, 5f, 1))
			{
				return 1;
			}
		}
...
void func_71()
{
	if (iLocal_45 != 11)
	{
		if (UI::DOES_BLIP_EXIST(iLocal_123))
		{
			UI::REMOVE_BLIP(&iLocal_123);
		}
...
{
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_197) > 5000)
	{
		if (!func_73())
		{
			if (func_5(&Local_139, cLocal_133, sParam0, 4, 0, 0, 0))
			{
				iLocal_197 = GAMEPLAY::GET_GAME_TIMER();
			}
		}
	}
}
...
bool func_74()
{
	...
	{
		if (!iLocal_111 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_113) > 5000)
		{
			if (iLocal_63 > 10)
			{
				iLocal_111 = 1;
		...
		if ((!iLocal_116 && !iLocal_111) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_117) > 4000)
		{
		...
		if (((!iLocal_114 && !iLocal_111) && !iLocal_116) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_115) > 15000)
		{
		...
		if (iLocal_116)
		{
			...
			{
				iLocal_117 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_116 = 0;
			}
		}
		if (iLocal_114)
...
void func_82()
{
	...
	{
		func_84(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_100()
{
	...
	switch (iLocal_130)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				AI::TASK_SMART_FLEE_PED(iLocal_67, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 < Local_109)
			{
...
void func_101(char* sParam0)
{
	...
	if (!iLocal_202)
	{
		...
		while (iVar0 < Local_109)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
			{
				AI::CLEAR_PED_TASKS(Local_109[iVar0 /*18*/]);
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]))
		{
			if (!PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_67))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0, 0);
					}
					else
					{
				...
				else if (AI::GET_SCRIPT_TASK_STATUS(Local_109[iVar0 /*18*/], -1146898486) != 1)
				{
					AI::TASK_WANDER_STANDARD(Local_109[iVar0 /*18*/], 1193033728, 0);
				}
			}
	...
	while (iVar0 < Local_108)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar0 /*18*/]))
		{
			if ((ENTITY::IS_ENTITY_OCCLUDED(Local_108[iVar0 /*18*/]) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_108[iVar0 /*18*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 2500f) && func_52(Local_108[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0))
			{
	...
	switch (iLocal_130)
	{
		...
		case 1:
			if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0) && PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0)) && !bLocal_129) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_70, -1, 0))
			{
				if (SYSTEM::VDIST(vLocal_53, vLocal_49) < 100f)
				{
					...
					AI::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_70, 0);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, vLocal_49, 20f, 0, joaat("serrano"), 786599, 10f, 10f);
					AI::TASK_VEHICLE_PARK(0, iLocal_70, vLocal_49, 288.7089f, 1, 50f, 0);
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_70, ENTITY::GET_ENTITY_COORDS(iLocal_70, true), 5, 10f, 262144, 2f, 2f, 1);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_70, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_50, 1f, -1, 0.25f, 512, fLocal_51);
					AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
					AI::CLOSE_SEQUENCE_TASK(iVar2);
					AI::TASK_PERFORM_SEQUENCE(iLocal_67, iVar2);
				...
				else
				{
					...
					AI::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_70, 0);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_70, 15f, 786468);
					AI::CLOSE_SEQUENCE_TASK(iVar3);
					AI::TASK_PERFORM_SEQUENCE(iLocal_67, iVar3);
			...
			else
			{
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_67, 0, 0);
				}
				iLocal_130++;
			}
			break;
		...
		case 2:
			if (iVar1 > 0)
			{
				AI::TASK_SMART_FLEE_PED(iLocal_67, PLAYER::PLAYER_PED_ID(), 3000f, -1, 1, 0);
				iLocal_130 = 1000;
			}
			else
			{
				if (SYSTEM::VDIST(vLocal_53, vLocal_49) < 100f)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(iLocal_67, iVar4);
					AI::CLEAR_SEQUENCE_TASK(&iVar4);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(iLocal_67, 1193033728, 0);
				}
				iLocal_130 = 1000;
			}
			break;
	...
	switch (iLocal_130)
	{
		case 0:
			...
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				AI::TASK_LEAVE_VEHICLE(0, iLocal_70, 0);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_50, 1f, 30000, 0.25f, 512, fLocal_51);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(iVar0);
				AI::TASK_PERFORM_SEQUENCE(iLocal_67, iVar0);
...
void func_111(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_113() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_113() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_112(iParam0));
...
bool func_115(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_113() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_136(bool bParam0)
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		switch (iLocal_170)
		{
			case 0:
				AI::CLEAR_PED_TASKS(iLocal_67);
				AI::TASK_LOOK_AT_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), -1, 16, 2);
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_67, iLocal_169);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_169);
				iLocal_170++;
				break;
			
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, 242628503) != 1)
				{
					iLocal_170++;
				}
				break;
				...
				if (bParam0)
				{
					switch (iLocal_171)
					{
						case 0:
							...
							{
								AI::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0f, 0, 0, 0);
							}
							else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_67, "random@paparazzi@wait", "wait_a") > 0.95f)
							{
								AI::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0f, 0, 0, 0);
								iLocal_171++;
							}
							break;
						...
						case 1:
							...
							{
								AI::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0f, 0, 0, 0);
								iLocal_171++;
							}
							break;
		...
		switch (iLocal_130)
		{
			case 0:
				if (!PED::IS_PED_INJURED(iLocal_67) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_67))
					{
						AI::TASK_LOOK_AT_COORD(iLocal_67, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_70, -10f, 5f, 0f), -1, 16, 4);
					}
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_70, 10f, 5f, 0f), 15000, 16, 4);
			...
			case 3:
				...
				{
					AI::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_70, 0);
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_70, 10000, 0, 3);
					iLocal_130++;
				}
				break;
...
void func_142(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_146(PLAYER::PLAYER_ID())) && !func_144(PLAYER::PLAYER_ID(), 0)) && !func_143()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_146(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_150()
{
	...
	if (bLocal_129 && !PED::IS_PED_INJURED(iLocal_67))
	{
		...
		{
			if ((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && func_170(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
			{
				iLocal_70 = 0;
		...
		if (UI::DOES_BLIP_EXIST(iLocal_124) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_67, 0))
		{
		...
		else if (iLocal_130 != 100)
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, -1794415470) != 1)
				{
					AI::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, -1, func_168(iLocal_70), 2f, 8388608, 0);
				}
			}
		}
	}
...
int func_155(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		if ((iLocal_58 && !iLocal_59) && bParam1)
		{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_62) > 500)
			{
				iLocal_62 = -1;
				iLocal_58 = 0;
				iLocal_59 = 0;
...
void func_165(bool bParam0)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0) && !PED::IS_PED_INJURED(iLocal_67))
	{
		...
		else
		{
			...
			else if (UI::DOES_BLIP_EXIST(iLocal_121))
			{
				UI::REMOVE_BLIP(&iLocal_121);
			}
		}
...
int func_167(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_51(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_67) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
	{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(func_65()) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), ENTITY::GET_ENTITY_COORDS(func_65(), true)) < 100f) && (ENTITY::GET_ENTITY_SPEED(iLocal_70) < 5f || !VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iLocal_70))))
		{
			if (bLocal_129)
			{
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0f, 0, 0, 0);
				}
			}
			...
			{
				AI::TASK_PLAY_ANIM(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0f, 0, 0, 0);
			}
		}
			...
			case 2:
				...
				else
				{
					switch (iLocal_200)
					{
						...
						case 2:
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_201) > 8000)
							{
								if (((!bLocal_198 && func_158()) && !func_74()) && !func_73())
								{
						...
						case 4:
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_201) > 6000)
							{
								if (func_19() == 0)
								{
...
int func_173()
{
	...
	iVar0 = func_24();
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_196) > 5000)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_70) && PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0))
		{
			...
			{
				if (iVar0 != -1 && (GAMEPLAY::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_12) < 3000)
				{
...
void func_174()
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_145) > iLocal_146)
	{
		if ((!PED::IS_PED_INJURED(iLocal_67) && ENTITY::DOES_ENTITY_EXIST(func_65())) && !PED::IS_PED_INJURED(func_65()))
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, ENTITY::GET_ENTITY_COORDS(func_65(), true), true) < 8f)
			{
				...
				switch (iVar0)
				{
					case 0:
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_139[4 /*10*/]) && !PED::IS_PED_INJURED(Local_139[4 /*10*/]))
						{
							...
							{
								iLocal_145 = GAMEPLAY::GET_GAME_TIMER();
								iLocal_146 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2000, 3000);
							}
						}
						break;
...
void func_175()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		if (UI::DOES_BLIP_EXIST(iLocal_121))
		{
			UI::_0x75A16C3DA34F1245(iLocal_121, iLocal_194);
		}
		switch (iLocal_130)
		{
			case 0:
				...
				if ((STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@peek") && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@trans")) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@wait"))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", "left_peek_a", 1000f, -8f, 1, 0, 1148846080, 0);
					AI::TASK_LOOK_AT_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), -1, 4, 4);
					sLocal_175[0] = "peek_a";
					sLocal_175[1] = "peek_b";
					sLocal_175[2] = "peek_c";
					PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.2f);
			...
			case 1:
				if (GAMEPLAY::IS_BIT_SET(iLocal_190, 0))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_190, 1))
					{
						GAMEPLAY::SET_BIT(&iLocal_190, 1);
					}
					else
					{
						iLocal_190 = 0;
				...
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_177, "right_"))
				{
					if (bVar1)
					{
						sLocal_177 = "left_";
				...
				if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_174) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_174) > 0.9f) || iVar2)
				{
					if (iLocal_190 == 0)
					{
						...
						iLocal_174 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_187, vLocal_188, 2);
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", &cVar3, 4f, -4f, 1, 0, 1148846080, 0);
						GAMEPLAY::SET_BIT(&iLocal_190, 0);
					}
				}
				if (bVar0 || bVar1)
				{
					if (fLocal_191 <= 20f)
					{
						fLocal_191 = (fLocal_191 + GAMEPLAY::GET_FRAME_TIME());
					}
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_173) > 5000 && iLocal_190 == 0)
					{
						if (SYSTEM::VDIST2(vLocal_52, vLocal_53) < (22.2f * 22.2f))
						{
							...
							if (func_5(&Local_139, cLocal_133, sVar4, 4, 0, 0, 0))
							{
								...
								if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 7f, 7f, 7f, 0, 1, 0))
								{
									...
									iLocal_174 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_187, vLocal_188, 2);
									AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", &cVar5, 4f, -4f, 1, 0, 1148846080, 0);
									GAMEPLAY::SET_BIT(&iLocal_190, 0);
								}
								iLocal_173 = GAMEPLAY::GET_GAME_TIMER();
							}
						}
					}
				}
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_184, vLocal_185, fLocal_186, 0, true, 0) && iLocal_190 == 0)
				{
					...
					if (bVar1)
					{
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@trans", "trans_left_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					else
					{
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@trans", "trans_right_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					GAMEPLAY::SET_BIT(&iLocal_190, 0);
					iLocal_130++;
				}
			...
			case 2:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_174) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_174) > 0.9f)
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_67);
						AI::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_c", 8f, -4f, -1, 0, 0f, 0, 0, 0);
						iLocal_170 = 2;
						SYSTEM::SETTIMERA(0);
					}
					iLocal_130++;
			...
			case 4:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					...
					{
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, 242628503) != 1 && !iLocal_189)
						{
							AI::OPEN_SEQUENCE_TASK(&iVar6);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 259.2552f, 122.2986f, 100.441f, 1f, 20000, 0.25f, 0, 40000f);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
							AI::CLOSE_SEQUENCE_TASK(iVar6);
							AI::TASK_PERFORM_SEQUENCE(iLocal_67, iVar6);
							PED::_0x2208438012482A1A(iLocal_67, 0, 0);
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, iLocal_67, Global_19, 0, 1, 0) && func_170(iLocal_70)) && (SYSTEM::TIMERA() > 6000 || !bLocal_129))
					{
						if (!iLocal_172)
						{
							func_102();
						...
						else
						{
							...
							AI::CLEAR_PED_TASKS(iLocal_67);
							AI::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, -1, func_168(iLocal_70), 1f, 8388608, 0);
						}
					}
				}
				break;
					...
					else
					{
						if (!Global_3 && !bLocal_56)
						{
							if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_70, 0) && !PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 1)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_70, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, 0, true, 0))
							{
								if (bLocal_129)
								{
									PED::SET_PED_FLEE_ATTRIBUTES(iLocal_67, 2, 1);
									sLocal_132 = "REPAP_GUP";
									func_178(6);
								}
								else
			...
			case 101:
				if (SYSTEM::VDIST2(vLocal_52, vLocal_53) < 49f && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					{
						fLocal_195 = (fLocal_195 + GAMEPLAY::GET_FRAME_TIME());
					}
					else
					{
						fLocal_195 = (fLocal_195 - (GAMEPLAY::GET_FRAME_TIME() * 2f));
					}
					if (fLocal_195 > 10f)
					{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_70, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_70, 0) && func_177())
					{
						bLocal_129 = true;
						iLocal_60 = 1;
						iLocal_70 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_176(vector3 vParam0, bool bParam1)
{
	...
	{
		if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, 713668775) != 1)
		{
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_67, vParam0, 1f, -1, 0.25f, 0, 40000f);
		}
	}
	else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, 713668775) != 1)
	{
		func_136(bParam1);
		AI::TASK_LOOK_AT_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), -1, 16, 2);
	}
...
void func_179(char* sParam0)
{
	...
	{
		if (!GAMEPLAY::ARE_STRINGS_EQUAL(iLocal_144[iVar0], sParam0))
		{
...
int func_184()
{
	switch (func_185(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_190()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_67, 2, 0);
		AI::TASK_SMART_FLEE_PED(iLocal_67, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
	}
	iVar0 = 0;
	while (iVar0 < Local_109)
	{
		if (!PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			AI::TASK_SMART_FLEE_PED(Local_109[iVar0 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
...
int func_191()
{
	...
	while (iVar1 < Local_109)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar1 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar1 /*18*/]))
		{
			...
			{
				if (((GAMEPLAY::IS_BULLET_IN_AREA(Local_109[iVar1 /*18*/].f_6, 5f, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_109[iVar1 /*18*/].f_6, 10f)) || PED::IS_PED_FLEEING(Local_109[iVar1 /*18*/])) || (iLocal_138[iVar1] > 10 && iLocal_45 == 0))
				{
					iVar0 = 1;
				}
			}
...
int func_192()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_203())
		{
			return 0;
		}
	}
...
void func_204()
{
	...
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_67, 128, 1);
	PED::SET_PED_KEEP_TASK(iLocal_67, true);
	...
	VEHICLE::_0x2B6747FAA9DB9D6B(iLocal_70, 1);
...
int func_205(vector3 vParam0)
{
	...
	iVar0 = UI::ADD_BLIP_FOR_COORD(vParam0);
	UI::SET_BLIP_ALPHA(iVar0, 0);
	UI::SET_BLIP_DISPLAY(iVar0, 0);
	return iVar0;
}
...
int func_213(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_210(func_211(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_224()
{
	if ((Global_106059 == func_97() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_245(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_248()
{
	...
	func_254(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_253(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_252(&uVar0, TIME::GET_CLOCK_HOURS());
	func_251(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_250(&uVar0, TIME::GET_CLOCK_MONTH());
	func_249(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_265()) || Global_105117) || Global_25461) || func_264()) || func_14(8, -1)) || func_263()) || func_262()) || func_261()) || func_260()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_265()) || Global_25461) || func_264()) || func_14(8, -1)) || func_261()) || func_263()) || func_262()) || func_260()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_265()) || Global_105117) || Global_25461) || func_264()) || func_14(8, -1)) || func_263()) || func_262()) || func_260()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_265() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_14(8, -1)) || func_260()) || func_259()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_265()) || Global_25461) || func_264()) || func_14(8, -1)) || func_262()) || func_261()) || func_260()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_265()) || func_262()) || Global_105117) || Global_25461) || func_264()) || Global_37271) || func_14(8, -1)) || func_261()) || func_259()) || func_260()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_265()) || Global_105117) || Global_25461) || func_264()) || func_14(8, -1)) || func_261()) || func_259()) || func_263()) || func_262()) || func_260())
						{
							return 0;
						}
						break;
...
void func_274()
{
	...
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", true);
