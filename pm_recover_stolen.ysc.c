...
void func_1()
{
	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				{
					iLocal_217 = Global_104780.f_222[0];
				...
				{
					iLocal_218 = Global_104780.f_225[0];
				...
				{
					iLocal_219 = Global_104780.f_225[1];
				...
				if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_218) || !PED::IS_PED_INJURED(iLocal_218)) && (!ENTITY::DOES_ENTITY_EXIST(iLocal_219) || !PED::IS_PED_INJURED(iLocal_219)))
				{
					...
					if (Local_37.f_19 != -1)
					{
						iLocal_40 = (GAMEPLAY::GET_GAME_TIMER() + Local_37.f_19);
					}
				}
				iLocal_36++;
			}
		...
		case 1:
			if (((((ENTITY::DOES_ENTITY_EXIST(iLocal_218) && PED::IS_PED_INJURED(iLocal_218)) || (ENTITY::DOES_ENTITY_EXIST(iLocal_219) && PED::IS_PED_INJURED(iLocal_219))) || ((Local_37.f_17 && VEHICLE::IS_THIS_MODEL_A_BIKE(Local_37.f_7)) && !PED::IS_PED_IN_VEHICLE(iLocal_218, iLocal_217, 0))) || ((Local_37.f_17 && VEHICLE::IS_THIS_MODEL_A_BIKE(Local_37.f_7)) && !PED::IS_PED_IN_VEHICLE(iLocal_219, iLocal_217, 0))) || ((Local_37.f_18 && !PED::IS_PED_IN_VEHICLE(iLocal_218, iLocal_217, 0)) && func_76(iLocal_218)))
			{
				...
				if (STREAMING::HAS_MODEL_LOADED(Local_37.f_10) && (Local_37.f_11 == 0 || STREAMING::HAS_MODEL_LOADED(Local_37.f_11)))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
					{
						...
						if (UI::DOES_BLIP_EXIST(iLocal_222))
						{
							UI::REMOVE_BLIP(&iLocal_222);
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_219) && Local_37.f_11 != 0)
					{
						...
						if (UI::DOES_BLIP_EXIST(iLocal_223))
						{
							UI::REMOVE_BLIP(&iLocal_223);
						}
			...
			else
			{
				...
				if (iLocal_40 != -1)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_40)
					{
						func_39();
					}
					else
					{
						iVar2 = func_38(GAMEPLAY::ABSI((iLocal_40 - GAMEPLAY::GET_GAME_TIMER())), 0, Local_37.f_19);
						if (iVar2 <= 10000)
						{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
				{
					...
					else if (UI::DOES_BLIP_EXIST(iLocal_222))
					{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
				{
					...
					else if (UI::DOES_BLIP_EXIST(iLocal_223))
					{
		...
		case 2:
			...
			if (!UI::DOES_BLIP_EXIST(iLocal_222) && !UI::DOES_BLIP_EXIST(iLocal_223))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_218) && !PED::IS_PED_INJURED(iLocal_218))
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_217) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_217, 0)) && !iLocal_41)
		{
			...
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_216);
				AI::TASK_VEHICLE_TEMP_ACTION(0, iLocal_217, 31, 10000);
				AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_217, PLAYER::PLAYER_PED_ID(), 8, 30f, Local_37.f_16, 1000f, 0f, 1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_216);
				AI::TASK_PERFORM_SEQUENCE(iLocal_218, iLocal_216);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_216);
				iLocal_41 = 1;
			}
		}
		else if (((func_27(iLocal_218, 242628503, 1) && AI::GET_SEQUENCE_PROGRESS(iLocal_218) < 1) && !iLocal_42) && (((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_37, Local_37.f_3, Local_37.f_6, 0, true, 0) || PED::HAS_PED_RECEIVED_EVENT(iLocal_218, 122)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_218, 123)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_218, 124)) || PED::HAS_PED_RECEIVED_EVENT(iLocal_218, 23)) || func_26(Global_104780.f_35, 134217728)))
		{
			AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_218, iLocal_217, PLAYER::PLAYER_PED_ID(), 8, 30f, Local_37.f_16, 1000f, 0f, 1);
			iLocal_42 = 1;
		}
		else if ((!func_27(iLocal_218, 242628503, 1) && !func_27(iLocal_218, -1273030092, 1)) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0))
		{
			...
			{
				AI::TASK_SMART_FLEE_PED(iLocal_218, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 1);
			}
		}
		else if (PED::IS_PED_IN_VEHICLE(iLocal_218, iLocal_217, 1) && (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_217, 0, 3000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_217, 1, 3000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_217, 2, 8000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_217, 3, 8000)))
		{
			...
			{
				AI::TASK_LEAVE_VEHICLE(iLocal_218, iLocal_217, 0);
			}
		}
		if (Local_37.f_20)
		{
			...
			if (bLocal_43)
			{
				if ((AI::GET_SCRIPT_TASK_STATUS(iLocal_218, 242628503) == 1 && AI::GET_SEQUENCE_PROGRESS(iLocal_218) == 1) || AI::GET_SCRIPT_TASK_STATUS(iLocal_218, -1273030092) == 1)
				{
					if (!AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_218))
					{
						WEAPON::SET_CURRENT_PED_VEHICLE_WEAPON(iLocal_218, joaat("weapon_microsmg"));
						AI::TASK_DRIVE_BY(iLocal_218, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
					}
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_217) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_217, 0))
		{
			if (!iLocal_45)
			{
				if ((func_27(iLocal_218, 242628503, 1) && AI::GET_SEQUENCE_PROGRESS(iLocal_218) == 1) || func_27(iLocal_218, -1273030092, 1))
				{
					if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("TAKINGS", false, -1))
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "TAKINGS_TIRES_PEELAWAY_master", iLocal_217, 0, 0, 0);
						iLocal_45 = 1;
					}
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_219) && !PED::IS_PED_INJURED(iLocal_219))
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(iLocal_219, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 1);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_218) && !PED::IS_PED_INJURED(iLocal_218))
	{
		...
		else if (func_33(PLAYER::PLAYER_PED_ID(), iLocal_218, 1) < 15f)
		{
			switch (iLocal_211)
			{
				...
				case 2:
					if (func_25() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_212) > 3500)
					{
						MemCopy(&Var0, {Local_37.f_12}, 8);
				...
				case 3:
					if (func_25() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_212) > 1500)
					{
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_218))
						{
							if (func_5() == 0)
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
	{
		...
		else if (Local_37.f_27)
		{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_225) > 2000)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
	{
		...
		else if (Local_37.f_27)
		{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_226) > 2000)
			{
...
int func_46(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_54() || func_53(Global_4456448.f_152990)) || func_52())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_50(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
{
	if (((((PED::HAS_PED_RECEIVED_EVENT(iParam0, 122) || PED::HAS_PED_RECEIVED_EVENT(iParam0, 123)) || PED::HAS_PED_RECEIVED_EVENT(iParam0, 124)) || PED::HAS_PED_RECEIVED_EVENT(iParam0, 41)) || (PED::_0x6CD5A433374D4CFB(iParam0, PLAYER::PLAYER_PED_ID()) && PED::HAS_PED_RECEIVED_EVENT(iParam0, 29))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
	{
		return 1;
	}
	else
