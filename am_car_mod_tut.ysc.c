		...
		switch (func_181(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 2:
				if (func_180() == 2)
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
					{
						func_8();
					}
				}
...
void func_3()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_137 == 0)
		{
			GAMEPLAY::CLEAR_BIT(&iLocal_140, 0);
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[iLocal_137 /*3*/].f_2, 0))
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_140, 1);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_1589747[iLocal_137 /*790*/].f_146, 4))
				{
				}
			}
		}
...
void func_8()
{
	...
	GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
	func_70(10, 0);
	func_69(0);
	func_30(1);
	func_23();
...
void func_74()
{
		...
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_140, 5))
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (GAMEPLAY::IS_BIT_SET(iLocal_140, 7))
								{
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 7);
								}
								if (GAMEPLAY::IS_BIT_SET(iLocal_140, 8))
								{
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 8);
								}
								if (GAMEPLAY::IS_BIT_SET(iLocal_140, 11))
								{
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 11);
								}
							...
							else
							{
								...
								if ((!func_148(iVar0, 0, &uVar1) || !func_147(iVar0)) || func_146(ENTITY::GET_ENTITY_MODEL(iVar0)))
								{
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
											{
												if (iLocal_148 > 0)
												{
													if (func_146(ENTITY::GET_ENTITY_MODEL(iVar0)))
													{
														...
														GAMEPLAY::SET_BIT(&iLocal_140, 11);
									...
									else if (GAMEPLAY::IS_BIT_SET(iLocal_140, 11))
									{
					...
					if (GAMEPLAY::IS_BIT_SET(iLocal_140, 3) || (func_134() && GAMEPLAY::IS_BIT_SET(iLocal_140, 10)))
					{
						if (func_134())
						{
						...
						else if (GAMEPLAY::IS_BIT_SET(iLocal_140, 9))
						{
							if (!func_110())
							{
								...
								{
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 9);
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 3);
									GAMEPLAY::CLEAR_BIT(&iLocal_140, 10);
									func_23();
									iLocal_139 = -1;
	...
	if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
	{
		if (func_76())
		{
			func_8();
...
int func_192()
{
	...
	if (func_193() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_193()) == 0)
		{
			return 1;
		}
	}
