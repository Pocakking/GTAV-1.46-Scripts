...
void __EntryFunction__()
{
	...
	if (func_69(PLAYER::PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((GAMEPLAY::GET_MISSION_FLAG() == 0 && func_65() == 0) && func_64(PLAYER::PLAYER_PED_ID(), vLocal_64, fLocal_65));
			func_62();
		}
	}
	func_61(65, 0);
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				fVar1 = GAMEPLAY::ACOS(func_51(vLocal_244, 0.73f, 0.683f, -0.013f));
...
void func_58(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				fVar1 = GAMEPLAY::ACOS(func_51(vLocal_244, -0.37f, -0.927f, -0.053f));
...
{
	func_69(PLAYER::PLAYER_PED_ID());
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("solomon1")) > 0)
	{
		func_1(30);
		func_61(65, 1);
		func_71();
