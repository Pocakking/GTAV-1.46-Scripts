...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_381))
	{
		...
		iLocal_312 = Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24;
		func_69(&Global_1293654, iLocal_312);
		vLocal_374 = { Global_1293654.f_146.f_82[5 /*102*/] };
		fLocal_375 = Global_1293654.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_375 < 0f)
		{
			fLocal_375 = (fLocal_375 + 360f);
		}
		vLocal_378 = { Global_1293654.f_146.f_82[5 /*102*/].f_16 };
		fLocal_379 = Global_1293654.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_376 = { Global_1293654.f_146.f_82[5 /*102*/].f_7 };
		vLocal_377 = { Global_1293654.f_146.f_82[5 /*102*/].f_10 };
	}
	...
	while (true)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_374, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
					...
					case 1:
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_57())
						{
							func_1();
						}
						else
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_374, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > (3f + 2f))
			{
				func_87();
			}
		}
...
void func_1()
{
	...
	{
		case 0:
			if (((func_52(vLocal_374, vVar0) && !func_51()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_375 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_375 + 45f))
			{
		...
		case 1:
			if (func_48(1, 0, 1))
			{
				if (((func_52(vLocal_374, vVar0) && !func_51()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_375 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_375 + 45f))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && CONTROLS::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						func_47();
						Global_1573336 = 13;
						func_39();
						...
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_374, 2.5f, 0);
						func_32(PLAYER::PLAYER_ID(), 0, 256);
						iLocal_36 = 1;
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
						func_23(1, 1, 1, 0, 0);
						AI::TASK_PED_SLIDE_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_374, fLocal_375, 1061158912);
						iLocal_308 = 2;
					}
				}
				else
		...
		case 3:
			...
			UI::HIDE_HUD_AND_RADAR_THIS_FRAME();
			func_19(1);
			iLocal_314 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_313);
		...
		case 7:
			...
			{
				if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 223))
				{
					if (func_50("SA_STRIP_MENU"))
					{
						UI::CLEAR_HELP(1);
		...
		case 11:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_314) > 0.5f)
			{
				...
				CAM::_0xC819F3CBB62BF692(0, 1f, 3, 0);
...
void func_2()
{
	...
	if (iVar0 > -1 && iVar0 != func_8())
	{
		...
		while (iVar1 < 21)
		{
			if (Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24 == Global_1589747[iVar0 /*790*/].f_273[iVar1])
			{
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1368245.f_241.f_136[func_13(9) /*33*/][iParam0], func_12(9));
}
...
void func_23(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_27(PLAYER::PLAYER_ID())) && !func_25(PLAYER::PLAYER_ID(), 0)) && !func_24()) && !bParam4)
			{
...
void func_39()
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_318))
	{
		if (func_41(2, 0, 1))
		{
			...
			{
				if (func_40(&iLocal_318, 5, iLocal_316, vLocal_378, fLocal_379, 1, 1, 1) && func_40(&iLocal_319, 5, iLocal_317, vLocal_378, fLocal_379, 1, 1, 1))
				{
...
int func_40(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam4, bool bParam5, int iParam6, bool bParam7)
{
	int iVar0;
	...
	while (iVar1 < iVar0)
	{
		if (!PED::IS_PED_INJURED(uVar2[iVar1]))
		{
			if (bLocal_35)
			{
				...
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uVar2[iVar1], true), true) < 3f)
					{
						return 1;
					}
				}
...
int func_57()
{
	...
	if (func_58() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_58()) == 0)
		{
			return 1;
		}
	}
...
void func_71(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	*uParam2 = { func_73(iParam1, 86) };
	...
	vVar1 = { func_72(vVar1, -Var0[0 /*6*/].f_3.f_2) };
	vVar1 = { func_72(vVar1, Var0[1 /*6*/].f_3.f_2) };
...
Vector3 func_72(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
void func_76(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 42:
		case 43:
			func_81(iParam1, 4, &vVar0, -1, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, -1, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 19f;
			func_81(iParam1, 276, &vVar0, -1, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, -1, 0);
		...
		case 64:
		case 65:
			func_81(iParam1, 4, &vVar0, 61, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 61, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 21f;
			func_81(iParam1, 276, &vVar0, 61, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 61, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 14.5f;
			break;
		...
		case 75:
		case 76:
			func_81(iParam1, 4, &vVar0, 73, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 73, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_81(iParam1, 276, &vVar0, 73, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 73, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 10.25f;
			func_81(iParam1, 483, &vVar0, 73, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_81(iParam1, 484, &vVar0, 73, 0);
		...
		case 81:
		case 82:
			func_81(iParam1, 4, &vVar0, 77, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 77, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_81(iParam1, 276, &vVar0, 77, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 77, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 5f;
			func_81(iParam1, 483, &vVar0, 77, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_81(iParam1, 484, &vVar0, 77, 0);
			(uParam0[2 /*8*/])->f_3 = { vVar0 };
		...
		case 84:
		case 85:
			func_81(iParam1, 4, &vVar0, 83, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 83, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 26.75f;
			func_81(iParam1, 276, &vVar0, 83, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 83, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 18.25f;
			break;
		
		case 86:
			func_81(iParam1, 4, &vVar0, 86, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 86, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 14.75f;
			func_81(iParam1, 276, &vVar0, 86, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 86, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 89:
		case 90:
			func_81(iParam1, 4, &vVar0, 88, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 88, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 27.25f;
			func_81(iParam1, 276, &vVar0, 88, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_81(iParam1, 277, &vVar0, 88, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 95:
		case 96:
			func_81(iParam1, 4, &vVar0, 91, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 91, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
		...
		case 101:
		case 102:
			func_81(iParam1, 4, &vVar0, 97, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_81(iParam1, 5, &vVar0, 97, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 22f;
			break;
	}
