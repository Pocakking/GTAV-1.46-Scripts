...
void __EntryFunction__()
{
	...
	if (func_431(Local_82.f_28[0]))
	{
		...
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_89, 1, 1);
	}
	func_430();
	if (func_441())
	{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_Dreyfuss", 0);
...
void func_15()
{
	...
	{
		func_17(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_91(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_83(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_83(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_91(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_83(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_74(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_91(iVar10, 14, uVar15[iVar1], -1) };
			func_59(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_74(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_83(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_60(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_83(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_83(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_78(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_77(iParam1)];
...
void func_93(int iParam0)
{
	...
	func_94(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_94(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_94(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_83(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_83(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_83(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	{
		if (func_158(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_173()
{
	...
	{
		func_162();
		GRAPHICS::_0xBF59707B3E5ED531(func_174(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_93232.f_20, 17))
	{
		return 0;
	}
...
void func_240()
{
	switch (iLocal_88)
	{
		case 0:
			...
			{
				UI::SET_BLIP_SCALE(iLocal_90, 0.7f);
			}
			if (func_431(iLocal_89))
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_93);
				...
				AI::CLOSE_SEQUENCE_TASK(uLocal_93);
				AI::TASK_PERFORM_SEQUENCE(iLocal_89, uLocal_93);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_93);
			}
			func_237();
			iLocal_297 = 0;
			iLocal_88 = 1;
		...
		case 1:
			...
			if (!func_431(iLocal_89))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18546.f_382, 0))
				{
					GAMEPLAY::SET_BIT(&(Global_106070.f_18546.f_382), 0);
				}
				func_290(4);
			}
			else if (func_288(PLAYER::PLAYER_PED_ID(), iLocal_89) > 250f)
			{
				UNK1::_0x293220DA1B46CEBC(6f, 2f, 4);
				func_290(4);
			}
			else
			{
				...
				func_241();
				AI::SET_PED_DESIRED_MOVE_BLEND_RATIO(iLocal_89, 1.8f);
			}
			break;
...
void func_242(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_297)
		{
			if (!*iParam0)
			{
				if ((func_243(iLocal_89) && !PED::IS_PED_RAGDOLL(iLocal_89)) && !AI::IS_PED_IN_WRITHE(iLocal_89))
				{
					if (func_253(PLAYER::PLAYER_PED_ID(), iLocal_89, fLocal_267, 1))
					{
						if (!func_236())
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_256(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_256(sParam2, 0, 0))
					{
...
int func_266(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_274() || func_273(Global_4456448.f_152990)) || func_272())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_270(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_267(int iParam0)
{
	if (iParam0 != func_269())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_268(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
		...
		case 1:
			...
			else
			{
				if (func_431(Local_82.f_35[0]))
				{
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_266 = 1;
					}
				}
				func_244(0);
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_265 = 1;
				}
				if (!func_299())
				{
...
int func_295()
{
	if (func_431(Local_82.f_35[0]))
	{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_296) > 3000)
			{
				func_297();
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_431(iLocal_89))
			{
				...
				if (func_3(Local_82.f_35[0]))
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_92);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1472.27f, 513.9628f, 116.898f, 3f, 20000, 0.25f, 1, 40000f);
					AI::TASK_ENTER_VEHICLE(0, Local_82.f_35[0], 20000, -1, 3f, 1, 0);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_82.f_35[0], 15f, 262144);
					AI::CLOSE_SEQUENCE_TASK(uLocal_92);
					AI::TASK_PERFORM_SEQUENCE(iLocal_89, uLocal_92);
					uLocal_263 = VEHICLE::_0x2CE544C68FB812A0(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], true), 100f, 10f, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(iLocal_89, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
			}
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_264)
				{
					if (func_431(iLocal_89))
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_91) > 3000)
						{
							PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_89, 3f);
						}
						else
				...
				if ((func_302(242628503) && AI::GET_SEQUENCE_PROGRESS(iLocal_89) > 0) && func_298())
				{
					func_290(3);
				}
			}
...
{
	if (AI::GET_SCRIPT_TASK_STATUS(iLocal_89, iParam0) == 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_89, iParam0) == 0)
	{
		return 1;
	}
	return 0;
...
int func_303()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_82.f_35[0]))
	{
		...
		{
			if (AI::GET_SEQUENCE_PROGRESS(iLocal_89) > 0)
			{
...
void func_305()
{
	if (func_243(iLocal_89) && func_3(Local_82.f_35[0]))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_89, Local_82.f_35[0]))
		{
			if (UI::DOES_BLIP_EXIST(iLocal_90))
			{
				UI::SET_BLIP_SCALE(iLocal_90, 1f);
			}
			iLocal_88 = 2;
		}
	}
			...
			switch (iLocal_318)
			{
				case 0:
					if (func_431(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_89, -1, 0, 2);
							iLocal_318++;
						}
					}
					break;
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, false, 0);
						func_306(500, 0);
						iLocal_318++;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_89, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 40000f);
						}
					}
					break;
			}
...
void func_313(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_317(PLAYER::PLAYER_ID())) && !func_315(PLAYER::PLAYER_ID(), 0)) && !func_314()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_317(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_321(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_322(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_371(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_325(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return func_379(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
	...
	if (iLocal_320 == 0)
	{
		if (func_431(iLocal_89))
		{
			if (func_289(PLAYER::PLAYER_PED_ID(), iLocal_89, 1) < 3f)
			{
				...
				AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_89, 0);
			}
		}
	}
}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_399(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_410(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
void func_413(int iParam0)
{
	...
	GAMEPLAY::CLEAR_AREA(-1462.177f, 485.6856f, 115.2016f, 200f, 1, 0, 0, false);
	if (!func_424())
	{
...
void func_416(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
...
void func_419()
{
	...
	if (func_431(iLocal_89))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_89, 1, 0f);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_89, 1, 1);
		AI::SET_PED_PATHS_WIDTH_PLANT(iLocal_89, 0);
...
void func_430()
{
	...
	func_426();
	GAMEPLAY::CLEAR_BIT(&(Global_106070.f_18546.f_382), 0);
	UI::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
...
int func_434(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 3:
			...
			if (func_431(uParam0->f_28[0]))
			{
				GAMEPLAY::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), 50f, 0);
			}
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1471.166f, 510.6191f, 115.8419f, 4f, 0, 0, 0, 0, false, 0);
			func_432(0);
			return 1;
			break;
	}
...
void func_453()
{
	...
	VEHICLE::_0x1033371FC8E842A7(uLocal_263);
}
