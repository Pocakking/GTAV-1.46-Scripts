...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&sVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
		...
		case 0:
			...
			if (func_431(iLocal_89))
			{
				...
				if (func_3(Local_82.f_35[0]))
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1472.27f, 513.9628f, 116.898f, 3f, 20000, 0.25f, 1, 1193033728);
			...
			switch (iLocal_318)
			{
				...
				case 3:
					...
					else
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_89, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
