...
int func_127(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_143(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_128(iVar0, 0), 1);
...
int func_220(int iParam0, int iParam1, float fParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Var0, 1) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
...
int func_227(float fParam0, bool bParam1)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		while (iVar6 < 63)
		{
			...
			{
				func_228(iVar1, &Var0);
				fVar4 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var0.f_6, 1);
				if (fVar4 < fVar3)
				{
					bVar7 = true;
					if (bParam1)
