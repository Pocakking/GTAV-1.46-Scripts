...
void __EntryFunction__()
{
	...
	Global_36668 = GAMEPLAY::GET_GAME_TIMER() + 20000;
	iVar0 = 0;
				...
				if (iLocal_90 == 1)
				{
					if (func_135(0))
					{
						if (func_134())
						{
							...
							if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 3))
							{
								if (func_129())
								{
									iLocal_90 = 2;
...
void func_11(int iParam0)
{
	...
	while (iVar1 < Global_106070.f_7660.f_198)
	{
		...
		{
			func_12(Global_106070.f_7660.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_26()
{
	...
	func_32(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_31(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_30(&uVar0, TIME::GET_CLOCK_HOURS());
	func_29(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_28(&uVar0, TIME::GET_CLOCK_MONTH());
	func_27(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_65(int iParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 3))
	{
		...
		if (iVar0 != -1)
		{
			if (func_66(PLAYER::PLAYER_PED_ID(), iVar0, (Global_36118[iVar0 /*5*/].f_3 * 0.35f)))
			{
				func_139(&iParam0, 0);
				func_123(0);
				iLocal_90 = 0;
...
int func_66(int iParam0, int iParam1, float fParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), Var0, 1) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
...
void func_67()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 1))
	{
		if (!func_48(26))
		{
			if (func_75())
...
int func_75()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2384, 23))
	{
		if (Global_15875 == 1)
		{
			return 1;
...
int func_81()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89161[iVar0]))
		{
			return 0;
		}
	}
...
int func_84()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_90805[2]))
	{
		return 0;
	}
	return 1;
...
int func_85()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_90805[1]))
	{
		return 0;
	}
	return 1;
...
int func_86()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_90805[0]))
	{
		return 0;
	}
	return 1;
...
bool func_95()
{
	return GAMEPLAY::IS_BIT_SET(Global_106070.f_18546[26 /*6*/], 3);
}
...
int func_97()
{
	...
	if (Global_88329 == -1)
	{
		Global_88329 = GAMEPLAY::GET_GAME_TIMER();
	}
	if ((GAMEPLAY::GET_GAME_TIMER() - Global_88329) > 240000)
	{
		Global_88329 = -1;
		return 1;
	}
...
int func_108()
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - Global_88329) > 30000)
	{
		Global_88329 = -1;
		return 1;
	}
...
void func_118(int iParam0)
{
	...
	if (Global_36664 != -1)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 1) && !Global_106070.f_7660.f_913)
		{
			func_139(iParam0, 0);
		}
		else
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 15))
			{
				switch (func_58())
				{
					case 0:
				...
				GAMEPLAY::CLEAR_BIT(&(Global_106070.f_7660[Global_36664 /*15*/].f_1), 15);
			}
			if (func_48(3))
			{
				if (!func_47(1))
...
void func_139(int iParam0, int iParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 1))
	{
		if (!Global_106070.f_7660.f_913)
		{
			GAMEPLAY::SET_BIT(&(Global_106070.f_7660[Global_36664 /*15*/].f_1), 10);
	...
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 10) || iParam1)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 8))
		{
			func_143(&(Global_106070.f_7660[Global_36664 /*15*/]));
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[Global_36664 /*15*/].f_1, 11))
	{
...
void func_145(int iParam0, int iParam1, bool bParam2)
{
	if (Global_117[iParam0 /*10*/].f_8 != 145)
	{
		...
		if (bParam2)
		{
			Global_2993[1 /*6*/] = { Global_106070.f_28022[iParam0 /*29*/].f_3 };
			Global_2993[1 /*6*/].f_5 = iParam1;
			GAMEPLAY::SET_BIT(&Global_2383, 0);
		}
	}
}
...
int func_150()
{
	...
	else
	{
		...
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 23);
		StringIntConCat(&Var0, iVar1, 16);
...
int func_165()
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 44);
	StringIntConCat(&Var0, iVar1, 16);
	StringCopy(&Var2, "CB_CHAR", 16);
	StringIntConCat(&Var2, iVar1, 16);
	func_161(&uLocal_91, 3, 0, &Var2, 0, 0);
...
void func_170(int iParam0)
{
	...
	while (iVar0 < Global_106070.f_7660.f_866 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_36668 || GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_765[iVar0 /*10*/].f_1, 21)) || iVar1)
		{
...
int func_172(var uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, func_186()) || bVar2)
	{
		iVar1 = 0;
		while (iVar1 < 3)
		{
...
void func_177(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_182(Global_37284[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_182(Global_37284[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
int func_188(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(iParam0, func_186()) && !GAMEPLAY::IS_BIT_SET(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(iParam0, func_186()))
		{
			return 0;
		}
	}
...
int func_191(float fParam0, bool bParam1)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		while (iVar6 < 63)
		{
			...
			{
				func_192(iVar1, &Var0);
				fVar4 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Var0.f_6, 1);
				if (fVar4 < fVar3)
				{
					bVar7 = true;
					if (bParam1)
...
void func_206(var uParam0)
{
	...
	switch (iLocal_83)
	{
		case 0:
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (func_229(48))
				{
					...
					{
						if ((((!ENTITY::DOES_ENTITY_EXIST(func_223(60)) && !ENTITY::DOES_ENTITY_EXIST(func_223(61))) && Global_71201 == -1) && !func_222()) && !func_221())
						{
							if (func_58() == 0)
							{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() > Global_36668)
			{
				iLocal_83++;
			}
			break;
...
int func_207()
{
	...
	while (iVar0 < 2)
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar4, vVar3[iVar0 /*3*/], 1) < fVar1)
		{
			fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar4, vVar3[iVar0 /*3*/], 1);
			iVar2 = iVar0;
		}
		iVar0++;
	}
...
void func_230(var uParam0)
{
	...
	while (iVar0 < Global_106070.f_7660.f_650)
	{
		...
		if (func_9(iVar1))
		{
			if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_199[iVar0 /*15*/].f_2, iVar1))
			{
					...
					if (*uParam0 >= Global_36669[Global_106070.f_7660.f_199[iVar0 /*15*/].f_6])
					{
						...
						if (!bVar2)
						{
							...
							if (iVar3 < 9)
							{
								...
								while (iVar4 < 3)
								{
									if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar3 /*15*/].f_2, iVar4))
									{
										func_8(iVar4);
									}
									iVar4++;
...
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		switch (func_58())
		{
			case 0:
				func_161(&Global_36499, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				break;
			
			case 1:
				func_161(&Global_36499, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				break;
			
			case 2:
				func_161(&Global_36499, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				break;
		}
	}
	switch (uParam0->f_6)
		...
		if (func_229(Global_106070.f_7660.f_137[iVar0 /*15*/].f_6))
		{
			if (*uParam0 >= Global_36669[Global_106070.f_7660.f_137[iVar0 /*15*/].f_6])
			{
				...
				if (iVar1 == -1)
				{
					...
					while (iVar2 < 3)
					{
						if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_137[iVar0 /*15*/].f_2, iVar2))
						{
							func_8(iVar2);
						}
						iVar2++;
	...
	if (func_9(func_58()))
	{
		if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, func_186()))
		{
			...
			if (func_64(*uParam0) == 1)
			{
				...
				if (func_241(&Global_36499, uParam0->f_6, &Var0, &(Var0.f_4), 12, &(Var0.f_8), &cVar1, &cVar2, 1, 0, 0, 0))
				{
			...
			else
			{
				...
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Var3.f_8)))
				{
					cVar4 = { Var3.f_4 };
				}
				else
				...
				if (func_232(&Global_36499, uParam0->f_6, &Var3, &cVar4, 12, 1, 0, 0, 0))
				{
					if (GAMEPLAY::IS_BIT_SET(uParam0->f_1, 13))
					{
						*uParam1 = 1;
...
void func_246(int iParam0)
{
	...
	while (iVar0 < Global_106070.f_7660.f_764 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_36668 || GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_651[iVar0 /*14*/].f_1, 21)) || iVar1)
		{
...
int func_249(var uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		if (func_262(uParam0->f_6, &Var3, iVar1, iVar0, 0, iVar2, 0, 1, 0, uParam0->f_13))
		{
			if (!GAMEPLAY::IS_BIT_SET(uParam0->f_1, 18))
			{
				...
				while (iVar6 < 3)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, iVar6) && iVar6 != func_186())
					{
						switch (iVar6)
						{
							case 0:
	...
	else if (!GAMEPLAY::IS_BIT_SET(uParam0->f_1, 18))
	{
		if (uParam0->f_12 >= 2 || GAMEPLAY::IS_BIT_SET(uParam0->f_1, 19))
		{
			...
			while (iVar8 < 3)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, iVar8))
				{
					switch (iVar8)
					{
						case 0:
...
int func_251(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14682)
	{
		if (Global_14513.f_1 == 6)
		{
			...
			func_252(1);
			func_255(Global_14494, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_253(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
void func_267(int iParam0)
{
	...
	while (iVar0 < Global_106070.f_7660.f_136 && !iLocal_78)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_1, 0))
		{
			iVar1 = 0;
			...
			if ((*iParam0 >= Global_36668 || GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_1, 21)) || iVar1)
			{
				if (Global_106070.f_7660[iVar0 /*15*/].f_3 == Global_106070.f_7660.f_919[func_58()] || !GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_2, func_186()))
				{
...
int func_268(var uParam0, var uParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_2, func_186()))
	{
		...
		if (func_64(*uParam0) == 1)
		{
			...
			{
				if (func_272(&Global_36499, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar3, &cVar4, 0, 0, 1))
				{
			...
			else if (func_271(&Global_36499, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar3, &cVar4, 0, 0, 1))
			{
				if (uParam0->f_3 == 5 || GAMEPLAY::IS_BIT_SET(uParam0->f_1, 12))
				{
					func_133(1);
		...
		else
		{
			...
			{
				if (func_270(&Global_36499, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
				{
					if (uParam0->f_3 == 5 || GAMEPLAY::IS_BIT_SET(uParam0->f_1, 12))
					{
						func_133(1);
			...
			{
				if (func_232(&Global_36499, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 1, 0, 0, 0))
				{
					if (uParam0->f_3 == 5 || GAMEPLAY::IS_BIT_SET(uParam0->f_1, 12))
					{
						func_133(1);
			...
			{
				if (func_269(&Global_36499, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
				{
					func_133(1);
					if (GAMEPLAY::IS_BIT_SET(uParam0->f_1, 13))
					{
			...
			else if (func_270(&Global_36499, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1))
			{
				if (GAMEPLAY::IS_BIT_SET(uParam0->f_1, 12))
				{
					func_133(1);
...
void func_274(int iParam0)
{
	...
	while (iVar0 < Global_106070.f_7660.f_136 && !iLocal_78)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_1, 0))
		{
			...
			if ((*iParam0 >= Global_36668 || iVar1) || GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_1, 21))
			{
				if (Global_106070.f_7660[iVar0 /*15*/].f_3 == Global_106070.f_7660.f_919[func_58()] || !GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar0 /*15*/].f_2, func_186()))
				{
