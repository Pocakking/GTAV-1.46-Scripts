...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_GRTD", 0);
...
void func_1()
{
	...
	{
		case 0:
			if (func_16(3) && (!func_15() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0))
			{
				func_12(3);
			}
			func_11(5, 0);
...
int func_2()
{
	if (func_410(iLocal_114) && func_410(Local_97.f_4))
	{
		if (func_3())
		{
			if (VEHICLE::_IS_CARGOBOB_HOOK_ACTIVE(iLocal_114) && VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(iLocal_114, Local_97.f_4))
			{
				bLocal_110 = true;
				return 1;
			}
...
void func_17()
{
	...
	else
	{
		...
		{
			if (!bLocal_297 && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 75))
			{
				bLocal_297 = true;
			}
			switch (iLocal_294)
			{
				...
				case 1:
					...
					else if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 71))
					{
						iLocal_294 = 2;
					}
					break;
				...
				case 2:
					AI::OPEN_SEQUENCE_TASK(&uLocal_300);
					AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_300);
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_300);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_300);
					iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 2000;
					iLocal_294 = 3;
					break;
				...
				case 3:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291)
					{
						...
						iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 2400;
						iLocal_294 = 4;
					}
					break;
				...
				case 7:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291 && !AI::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2))
					{
						AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						AI::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 0);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
					}
					break;
				}
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_410(iLocal_114))
			{
				...
				UI::SET_BLIP_ROUTE(iLocal_96, 1);
				if (bLocal_110)
				{
					func_12(7);
				}
				if ((!func_15() && iLocal_304) && !CONTROLS::IS_CONTROL_PRESSED(0, 74))
				{
					iLocal_301 = 0;
				}
				iLocal_95 = 1;
...
void func_29()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_32(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_30(iVar0) && (!func_33(14) || Global_105021))
			{
...
bool func_39(char* sParam0, int iParam1, char* sParam2)
{
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_410(iLocal_114))
			{
				...
				UI::SET_BLIP_ROUTE(iLocal_96, 1);
				if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_15())
				{
					if (func_3())
					{
						func_12(8);
...
{
	UI::CLEAR_THIS_PRINT(vLocal_308[iParam0 /*3*/].f_2);
}
...
void func_45()
{
	...
	switch (iLocal_95)
	{
		case 0:
			func_41(&iLocal_96);
			if (func_16(5) && (!func_15() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0))
			{
				func_12(5);
			}
			iLocal_95 = 1;
...
void func_47(int iParam0, bool bParam1)
{
	...
	{
		func_208(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_65(var uParam0)
{
	...
	*uParam0 = 145;
	...
	func_69(&(uParam0->f_2869));
	func_67(&(uParam0->f_2875));
	func_66(&(uParam0->f_2965));
}
...
int func_75(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_126(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_126(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_118(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_118(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_118(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_76(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_190(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_126(iVar10, iParam1, iParam2, -1) };
		if (!func_116(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_126(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_126(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_118(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_118(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_118(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_109(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_126(iVar10, iVar0, func_84(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_126(iVar10, 14, uVar15[iVar1], -1) };
			func_94(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_109(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_118(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_118(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_118(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_126(iParam0, iParam1, iParam2, -1) };
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_95(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_118(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_118(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_109(int iParam0)
{
	...
	{
		func_115(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_190(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_125(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_125(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_125(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_128(int iParam0)
{
	...
	func_129(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_113(func_132(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_113(func_131(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_113(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_129(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_129(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_129(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_129(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_118(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_190(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_190(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_190(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_126(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_190(iParam0, 14, iVar4))
										{
											if (!func_82(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_126(iVar0, iVar2, iVar1, -1) };
						if (!func_82(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_118(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_118(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_197(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_198(&sVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_203()
{
	...
	{
		func_29();
		GRAPHICS::_0xBF59707B3E5ED531(func_204(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_213(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_212();
...
void func_241(bool bParam0)
{
	if (bParam0)
	{
		...
		VEHICLE::_0x2B6747FAA9DB9D6B(Local_97.f_4, 1);
	}
	else
	{
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_97.f_4, 1, 0);
		VEHICLE::_0x2B6747FAA9DB9D6B(Local_97.f_4, 0);
	}
}
...
void func_243()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_292)
	{
...
void func_244(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_315(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_246(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_246(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_28();
	...
	if (iParam4 == 1)
	{
		func_248(&(uParam0->f_2875), uParam0, iParam5, 1, 1, 0);
	}
	func_247(&(uParam0->f_2965));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
int func_265(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_112(iParam1)];
...
void func_269(int iParam0, bool bParam1)
{
	...
	if (func_30(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_270(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_270(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_272(Var7.f_1)) && iVar9 < 50)
			{
...
int func_283(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_51() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_113(func_284(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_286(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_302(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_287(iVar0, 0), true);
...
Vector3 func_287(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_298(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_297())
			{
				if (func_296(Global_1589591))
				{
					return func_289(2, 2);
				}
				else if (func_288(Global_1589591))
				{
...
var func_304()
{
	...
	func_314(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_313(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_312(&uVar0, TIME::GET_CLOCK_HOURS());
	func_307(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_306(&uVar0, TIME::GET_CLOCK_MONTH());
	func_305(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_310(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_316(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_317(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_317(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_317(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_317(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_317(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
		...
		case 1:
			...
			else if (func_2())
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0))
				{
					...
					if (!iLocal_290)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_293) > 1000)
						{
		...
		case 2:
			...
			else if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_114, Local_97.f_4))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 1, 0))
				{
					...
					{
						iLocal_292 = GAMEPLAY::GET_GAME_TIMER() + 5000;
						iLocal_94 = 12;
					}
				}
				else
...
void func_326()
{
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
			{
				if (!func_15() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
				{
					func_12(1);
					iLocal_309 = 0;
				}
		...
		case 0:
			...
			if (iLocal_118)
			{
				...
				else
				{
					...
					if (!UI::DOES_BLIP_EXIST(iLocal_96))
					{
						iLocal_96 = func_40(Local_97.f_4, 1, 5);
					}
					iLocal_95 = 1;
...
void func_331()
{
	switch (iLocal_95)
	{
		case 0:
			...
			{
				func_17();
				if (!iLocal_286 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_292) > 8000)
				{
				...
				else if (!iLocal_287 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_292) > 120000)
				{
					if (!func_333())
					{
				...
				else if (!iLocal_288 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_292) > 160000)
				{
...
void func_335(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_362(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_336(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_304();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_257(iParam0, &(Global_106070.f_32605.f_5510));
}
...
void func_355(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_354(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_364()
{
	switch (iLocal_95)
	{
		...
		case 1:
			if (((!bLocal_297 && iLocal_294 != 0) && (iLocal_295 > 0 && iLocal_295 < 4)) && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 75))
			{
				bLocal_297 = true;
			}
			switch (iLocal_294)
			{
				...
				case 2:
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_97.f_4, -1, 0) == PLAYER::PLAYER_PED_ID() && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4))
					{
						if (iLocal_295 == 3)
						{
							AI::OPEN_SEQUENCE_TASK(&uLocal_300);
							AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0f, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_300);
							AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_300);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_300);
						...
						else if (iLocal_295 == 2)
						{
							if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_300);
								AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0f, 0, 0, 0);
								AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_295 * 250), 9, 0f, 0, 0, 0);
								AI::TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0f, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(uLocal_300);
								AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_300);
								AI::CLEAR_SEQUENCE_TASK(&uLocal_300);
				...
				case 3:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291)
					{
						if (iLocal_295 == 4)
						{
							...
							iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 9100;
						}
						else
						{
							AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
							AUDIO::SET_VARIABLE_ON_SOUND(iLocal_296, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_295 * 250)) / 1000f));
							iLocal_291 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_295 * 250) + 1200 + 766;
						}
						iLocal_294 = 4;
					}
					break;
				...
				case 4:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291)
					{
						...
						else
						{
							...
							if (iLocal_295 == 4)
							{
								AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_299, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0f, 0, 0, 0);
								iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 330;
								iLocal_294 = 5;
							}
							else
							{
				...
				case 5:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291)
					{
						VEHICLE::START_VEHICLE_HORN(Local_97.f_4, 500, GAMEPLAY::GET_HASH_KEY("NORMAL"), 0);
						iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 2000;
						iLocal_294 = 8;
					}
					break;
		...
		case 2:
			if (!func_15() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_291) > 2500)
			{
				iLocal_95 = 0;
				iLocal_94 = 2;
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_114))
	{
		...
		else if (iLocal_102 && iLocal_307 == 0)
		{
			if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_114))
			{
				if (iLocal_101)
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_105) > 7000)
					{
						if (func_3())
						{
...
void func_374()
{
	switch (iLocal_95)
	{
		case 0:
			func_41(&iLocal_96);
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_310))
			{
				sLocal_310 = "DEFAULT";
			}
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_310, "DEFAULT"))
			{
				func_460(1);
			}
			else
...
{
	if (((!func_407(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_409(iParam0, Global_36117);
}
...
bool func_428()
{
	return func_429(&(Global_99633.f_2875));
}
...
void func_431(bool bParam0)
{
	...
	{
		iLocal_307 = 0;
		iLocal_292 = GAMEPLAY::GET_GAME_TIMER() + 3000;
		iLocal_94 = 12;
	}
	iLocal_95 = 0;
	iLocal_120 = 0;
...
void func_432(bool bParam0)
{
	...
	if (bParam0)
	{
		...
		{
			VEHICLE::_SET_TOW_TRUCK_CRANE_HEIGHT(iLocal_114, 0f);
		}
		while (!UI::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
...
void func_435(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_439(PLAYER::PLAYER_ID())) && !func_437(PLAYER::PLAYER_ID(), 0)) && !func_436()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_439(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_446()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("BARR3C", 0);
...
int func_463()
{
	...
	iVar0 = func_318(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_465()
{
	...
	{
		if (func_315(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
