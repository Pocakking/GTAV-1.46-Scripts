...
void func_197(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_198(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
int func_286(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_302(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_287(iVar0, 0), 1);
...
void func_418(vector3 vParam0, float fParam1)
{
	...
	iLocal_106 = OBJECT::CREATE_OBJECT(iLocal_109, vParam0 + vLocal_107, 1, 1, 0);
