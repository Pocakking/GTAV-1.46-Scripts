...
void func_1()
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (UI::DOES_BLIP_EXIST(uLocal_84[0]))
		{
			UI::REMOVE_BLIP(&(uLocal_84[0]));
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
	...
	switch (iLocal_102)
	{
		...
		case 3:
			...
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				...
				iLocal_103 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_102++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_103 < GAMEPLAY::GET_GAME_TIMER())
			{
				...
				{
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
					iLocal_103 = GAMEPLAY::GET_GAME_TIMER() + 3000;
					iLocal_102++;
				}
			}
			break;
...
void func_111()
{
	...
	if (!func_150())
	{
		switch (iLocal_100)
		{
			...
			case 6:
				iLocal_101 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_100++;
				break;
			
			case 7:
				if (iLocal_101 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (func_53() == 0)
					{
			...
			case 13:
				iLocal_101 = GAMEPLAY::GET_GAME_TIMER() + 600;
				iLocal_100++;
				break;
			...
			case 17:
				iLocal_101 = GAMEPLAY::GET_GAME_TIMER() + 800;
				iLocal_100++;
				break;
...
int func_116(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_117(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_119(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_117(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_125())
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_54, 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_54, 1227113341) != 0)
				{
					AI::TASK_GO_TO_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_54, 0))
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_54, 0, 0);
				}
				if (!iLocal_73)
				{
					func_56(0);
	...
	switch (iLocal_61)
	{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_54) && ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_91[8], true) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_128(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_91[8], true)));
				AI::TASK_PLAY_ANIM(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_77);
				AI::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_77);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
				SYSTEM::SETTIMERB(0);
	...
	if (!iLocal_80)
	{
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), 12f, 12f, 5f, 0, 1, 0))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_77);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 15000, 0, 2);
				iLocal_80 = 1;
			}
		}
	}
...
void func_133()
{
	switch (iLocal_60)
	{
			...
			if (!PED::IS_PED_INJURED(iLocal_54) && !PED::IS_PED_INJURED(iLocal_53))
			{
				if (CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_53, true), 3f))
				{
					if (!func_150())
					{
						...
						{
							AI::TASK_PLAY_ANIM(iLocal_54, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							AI::TASK_PLAY_ANIM(iLocal_53, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							iLocal_60++;
						}
					}
				}
		...
		case 3:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "CLOTHES_THROWN", iLocal_91[8], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
		...
		case 7:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[9]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "CLOTHES_THROWN", iLocal_91[9], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
		...
		case 10:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[10]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "CLOTHES_THROWN", iLocal_91[10], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
		...
		case 11:
			if (!PED::IS_PED_INJURED(iLocal_53) && !PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_53, iLocal_54, 0);
					}
				}
			}
			if (!func_150() || func_132())
		...
		case 16:
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				...
				AI::TASK_TURN_PED_TO_FACE_COORD(0, vLocal_87, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_77);
				AI::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_77);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
				iLocal_60++;
		...
		case 17:
			...
			if (iLocal_75 < GAMEPLAY::GET_GAME_TIMER())
			{
				if (!func_150())
				{
					if (func_149(&uLocal_114, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_75 = GAMEPLAY::GET_GAME_TIMER() + 5000;
						iLocal_76++;
					}
				}
			}
		...
		else if (iLocal_60 > 7)
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 6f, 8f, 5f, 0, 1, 0))
				{
					if (UI::DOES_BLIP_EXIST(uLocal_84[0]))
					{
						UI::_0x75A16C3DA34F1245(uLocal_84[0], true);
					}
					AI::CLEAR_PED_TASKS(iLocal_54);
					func_134();
					if (iLocal_60 > 18)
	...
	if (bLocal_52)
	{
		if (iLocal_51 < GAMEPLAY::GET_GAME_TIMER())
		{
			func_57();
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_53))
			{
...
void func_134()
{
	...
	{
		AI::OPEN_SEQUENCE_TASK(&iLocal_77);
		AI::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_87, 1f, -1, 1193033728, 1056964608);
		AI::TASK_PLAY_ANIM(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0f, 0, 0, 0);
		AI::CLOSE_SEQUENCE_TASK(iLocal_77);
...
void func_144()
{
	...
	{
		uLocal_84[0] = func_118(iLocal_54, 0, 145);
		UI::_0x75A16C3DA34F1245(uLocal_84[0], false);
	}
}
...
void func_145()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	GAMEPLAY::CLEAR_AREA(vLocal_57, 2f, 1, 0, 0, false);
	GAMEPLAY::CLEAR_AREA(vLocal_56, 2f, 1, 0, 0, false);
	...
	AI::TASK_PLAY_ANIM(iLocal_54, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0f, 0, 0, 0);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_54, iLocal_111);
	func_148(iLocal_54, "GENERIC_WHATEVER", 24);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_79);
	AI::TASK_LOOK_AT_ENTITY(iLocal_54, iLocal_53, -1, 0, 2);
	AI::TASK_LOOK_AT_ENTITY(iLocal_53, iLocal_54, -1, 0, 2);
...
void func_151()
{
	if (!PED::IS_PED_INJURED(iLocal_54) && !PED::IS_PED_INJURED(iLocal_53))
	{
		...
		{
			if (PED::_0x6CD5A433374D4CFB(iLocal_54, PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_53, PLAYER::PLAYER_PED_ID()))
			{
			...
			if ((iLocal_94 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_94 + 500) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				func_158();
			}
		}
...
void func_156()
{
	...
	{
		AI::CLEAR_PED_TASKS(iLocal_54);
		AI::TASK_SMART_FLEE_COORD(iLocal_54, ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), true), 150f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_54, true);
	}
	iLocal_47 = 11;
}
