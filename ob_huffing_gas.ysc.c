...
void func_1()
{
	...
	if (iLocal_288)
	{
		if (!iLocal_290)
		{
			iLocal_291 = GAMEPLAY::GET_GAME_TIMER() + 50;
			iLocal_290 = 1;
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291)
		{
			if (fLocal_292 < fVar1)
			{
				...
				GAMEPLAY::SET_TIME_SCALE(fLocal_292);
			}
			if (fLocal_293 > fVar0)
			{
...
void func_4()
{
	...
	switch (iLocal_277)
	{
		...
		case 2:
			...
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_69(), func_39(0), 1000f, -8f, 0, 0, 1148846080, 0);
		...
		case 4:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_282 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 6);
				switch (iLocal_282)
				{
					case 0:
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_281))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_69(), sLocal_284, 1000f, -4f, 0, 0, 1148846080, 0);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_281))
				{
...
{
	iParam0->f_1 = (func_30(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_43(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_48(PLAYER::PLAYER_ID())) && !func_45(PLAYER::PLAYER_ID(), 0)) && !func_44()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_48(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
