	...
	while (true)
	{
		...
		if (bLocal_779 && !PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
		{
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(408.8376f, -1638.952f, 28.2928f, 8f, 0, 0, 0, 0, false, 0);
				...
				case 0:
					...
					else if (iLocal_170 == 3)
					{
						if ((iLocal_906 == 5 && iLocal_908 < 1) && !iLocal_764)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
							{
								...
								{
									iLocal_764 = 1;
									AI::CLEAR_PED_TASKS(Local_824[0 /*20*/]);
									AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 0);
								}
							}
						}
					}
					...
					if (!bLocal_779)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_816) && !ENTITY::IS_ENTITY_DEAD(iLocal_816, 0))
						{
							...
							{
								bLocal_776 = true;
								AI::TASK_SMART_FLEE_PED(iLocal_816, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (func_164())
							{
								bLocal_777 = true;
					...
					if (bLocal_190 && !bLocal_798)
					{
						if (func_166(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 1, 1, 0))
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
							{
								...
								AI::TASK_SMART_FLEE_PED(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
							{
								AI::CLEAR_PED_TASKS(Local_824[0 /*20*/].f_1);
								...
								if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
								{
									AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/].f_1, iLocal_171);
								}
								AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
								iLocal_875 = 18;
							}
						...
						if (func_166(Local_824[0 /*20*/].f_1, Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 0))
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
							{
								AI::CLEAR_PED_TASKS(Local_824[0 /*20*/].f_1);
								PED::SET_PED_KEEP_TASK(Local_824[0 /*20*/].f_1, true);
								AI::TASK_SMART_FLEE_PED(Local_824[0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
						}
					}
						...
						if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_900, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_900, 0))
						{
							if (!iLocal_216)
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/].f_6))
								{
									...
									{
										func_137(&uLocal_149, ENTITY::GET_ENTITY_COORDS(Local_824[0 /*20*/].f_6, true), 0, 0, 1, 1, 1);
									}
								}
							}
							else
...
int func_1(vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	if (bLocal_215)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_854) > 50000)
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
		...
		case 1:
			if ((SYSTEM::TIMERA() > 3000 && iLocal_216) && !func_37("TOWT_OBJ_04", 0, 0))
			{
				if (!func_41())
				{
					...
					if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya3")) == 1 || SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
					{
						if (iLocal_170 == 1)
						{
...
void func_32(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165)
{
	...
	{
		case 1:
			if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("towing")) == 0)
			{
				if (iLocal_170 == 1)
				{
					if (!iLocal_213)
			...
			else if (iLocal_170 == 1)
			{
				if (Global_106070.f_19945.f_5 == 0 || Global_106070.f_19945.f_5 == 1)
				{
					func_248(&Local_396, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
bool func_37(char* sParam0, int iParam1, char* sParam2)
{
...
int func_49()
{
	...
	switch (iLocal_906)
	{
		...
		case 4:
			...
			if (!UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_8))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/].f_6))
				{
					Local_824[0 /*20*/].f_8 = UI::ADD_BLIP_FOR_ENTITY(Local_824[0 /*20*/].f_6);
					UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_8, 3);
					UI::SET_BLIP_ROUTE(Local_824[0 /*20*/].f_8, true);
				}
			}
			break;
		...
		case 7:
			...
			if (func_96(sVar2, vLocal_469))
			{
				if (iLocal_170 == 1 && !PED::IS_PED_IN_VEHICLE(Local_824[0 /*20*/], iLocal_900, 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/]))
					{
						Local_824[0 /*20*/].f_9 = UI::ADD_BLIP_FOR_ENTITY(Local_824[0 /*20*/]);
						UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_9, 3);
						UI::SET_BLIP_SCALE(Local_824[0 /*20*/].f_9, 0.7f);
					}
					iLocal_906 = 5;
				}
				else
		...
		case 15:
			...
			if (bLocal_773)
			{
				if (UI::DOES_BLIP_EXIST(iLocal_817))
				{
					UI::REMOVE_BLIP(&iLocal_817);
				}
			}
			UI::CLEAR_HELP(1);
			...
			if (iLocal_218 != 0 && !bLocal_769)
			{
				if (bLocal_779)
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_218) < 12000)
					{
...
int func_50(int iParam0, int iParam1)
{
	...
	{
		if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 201) || iParam0->f_8)
		{
...
void func_91(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7)
{
...
int func_93(char* sParam0)
{
	...
	if (func_94(&uVar0, &uVar1, &uVar2))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_824[iLocal_839 /*20*/], 0) && PED::IS_PED_IN_VEHICLE(Local_824[iLocal_839 /*20*/], iLocal_900, 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_824[iLocal_839 /*20*/]) && !ENTITY::IS_ENTITY_DEAD(Local_824[iLocal_839 /*20*/], 0))
			{
				...
				AI::TASK_GOTO_ENTITY_OFFSET(0, Local_824[0 /*20*/].f_6, 20000, 2f, 0f, 1f, 0);
				...
				AI::CLOSE_SEQUENCE_TASK(iLocal_171);
				AI::TASK_PERFORM_SEQUENCE(Local_824[iLocal_839 /*20*/], iLocal_171);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
			...
			if ((Global_106070.f_19945.f_3 == 0 || Global_106070.f_19945.f_3 == 1) || Global_106070.f_19945.f_3 == 4)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_816) && !ENTITY::IS_ENTITY_DEAD(iLocal_816, 0))
				{
					...
					{
						AI::TASK_PERFORM_SEQUENCE(iLocal_816, iLocal_171);
		...
		iLocal_216 = 0;
		UI::REMOVE_BLIP(&(Local_824[iLocal_839 /*20*/].f_8));
		func_53(&iLocal_879);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[iLocal_839 /*20*/].f_6, 0))
	{
		if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[iLocal_839 /*20*/].f_6))
		{
			iLocal_216 = 0;
			func_136(&uLocal_149, 0, 0);
			UI::SET_BLIP_ROUTE(Local_824[iLocal_839 /*20*/].f_8, false);
			UI::REMOVE_BLIP(&(Local_824[iLocal_839 /*20*/].f_8));
			if (ENTITY::DOES_ENTITY_EXIST(Local_824[iLocal_839 /*20*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_824[iLocal_839 /*20*/].f_6, 0))
			{
				if (!UI::DOES_BLIP_EXIST(Local_824[iLocal_839 /*20*/].f_8))
				{
					Local_824[iLocal_839 /*20*/].f_8 = UI::ADD_BLIP_FOR_ENTITY(Local_824[iLocal_839 /*20*/].f_6);
					UI::SET_BLIP_COLOUR(Local_824[iLocal_839 /*20*/].f_8, 3);
				}
			}
			if (iLocal_170 == 1)
			{
...
int func_96(char* sParam0, vector3 vParam1)
{
	...
	while (iVar1 < 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_824[iVar1 /*20*/].f_6))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[iVar1 /*20*/].f_6) && func_102())
				{
					...
					{
						func_98(&iLocal_885);
						UI::SET_BLIP_ROUTE(Local_824[iVar1 /*20*/].f_8, false);
						iLocal_801 = 0;
						func_97(Local_824[iVar1 /*20*/].f_8);
						Local_824[iVar1 /*20*/].f_14 = func_4(&(Local_824[iVar1 /*20*/].f_11));
						if (iLocal_821 == 0)
						{
							Local_824[iVar1 /*20*/].f_8 = UI::ADD_BLIP_FOR_COORD(vParam1);
						...
						func_53(&iLocal_891);
						UI::SET_BLIP_COLOUR(Local_824[iVar1 /*20*/].f_8, 5);
						UI::SET_BLIP_ROUTE(Local_824[iVar1 /*20*/].f_8, true);
						...
						StringCopy(&cLocal_866, sParam0, 64);
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_468[0 /*3*/], 6f, 0, 0, 0, 0, false, 0);
						iLocal_839 = iVar1;
						return 1;
					}
				}
...
void func_103()
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6)) || (Global_106070.f_19945.f_3 == 0 || Global_106070.f_19945.f_3 > 2))
	{
		return;
	}
	switch (iLocal_852)
...
int func_106(int iParam0, int iParam1, char* sParam2)
{
	...
	switch (*iParam0)
	{
			...
			if (!bLocal_792)
			{
				if ((func_113(Local_824[iParam1 /*20*/].f_6, iLocal_900, &iLocal_449, 10, 150f, 4f, 1) || iLocal_787) || iLocal_216)
				{
					if (!bLocal_770)
					{
						iLocal_449 = 0;
						func_112(&iLocal_444);
						if (AI::GET_SCRIPT_TASK_STATUS(Local_824[iParam1 /*20*/], -875674219) != 1)
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[iParam1 /*20*/], PLAYER::PLAYER_PED_ID(), -1);
						}
						bLocal_770 = true;
					}
					if (bLocal_770)
					{
						if (ENTITY::IS_ENTITY_AT_COORD(iLocal_900, ENTITY::GET_ENTITY_COORDS(Local_824[iParam1 /*20*/], true), 25f, 25f, 25f, false, true, 0))
						{
							...
							{
								AI::STOP_ANIM_TASK(Local_824[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", -4f);
							}
							if (!func_111())
							{
								if (iLocal_170 == 1)
								{
									...
									AI::TASK_ENTER_VEHICLE(Local_824[iParam1 /*20*/], iLocal_900, 20000, 0, 2f, 1048577, 0);
								}
								else if (iLocal_170 == 3)
								{
									if (Global_106070.f_19945.f_7 == 0 || Global_106070.f_19945.f_7 == 1)
								...
								if (iLocal_787)
								{
									UI::REMOVE_BLIP(&(Local_824[iParam1 /*20*/].f_8));
									if (ENTITY::DOES_ENTITY_EXIST(Local_824[iParam1 /*20*/]))
									{
										Local_824[iParam1 /*20*/].f_8 = UI::ADD_BLIP_FOR_ENTITY(Local_824[iParam1 /*20*/]);
										UI::SET_BLIP_COLOUR(Local_824[iParam1 /*20*/].f_8, 3);
										UI::SET_BLIP_SCALE(Local_824[iParam1 /*20*/].f_8, 0.7f);
									}
								}
								SYSTEM::SETTIMERA(0);
								*iParam0 = 1;
		...
		case 1:
			...
			if (!UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_9))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_824[iParam1 /*20*/]))
				{
					Local_824[0 /*20*/].f_9 = UI::ADD_BLIP_FOR_ENTITY(Local_824[iParam1 /*20*/]);
					UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_9, 3);
					UI::SET_BLIP_SCALE(Local_824[0 /*20*/].f_9, 0.7f);
				}
			}
		...
		case 4:
			if (PED::IS_PED_IN_VEHICLE(Local_824[iParam1 /*20*/], iLocal_900, 0))
			{
				...
				if (!UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_8))
				{
					...
					{
						Local_824[0 /*20*/].f_8 = UI::ADD_BLIP_FOR_ENTITY(Local_824[iParam1 /*20*/].f_6);
						UI::SET_BLIP_COLOUR(Local_824[iParam1 /*20*/].f_8, 3);
					}
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
...
void func_110(int iParam0)
{
	...
	while (iVar0 < 1)
	{
		if (iVar0 != iParam0)
		{
			if (UI::DOES_BLIP_EXIST(Local_824[iVar0 /*20*/].f_8))
			{
				UI::REMOVE_BLIP(&(Local_824[iVar0 /*20*/].f_8));
			}
		}
		iVar0++;
	}
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam1, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_OCCLUDED(iParam0) && func_108(iParam0, 1) < fParam4)
			{
				*iParam2++;
			}
			else
			...
			if (((*iParam2 > iParam3 || func_108(iParam0, 1) < 8f) && ENTITY::GET_ENTITY_SPEED(iParam1) < fParam5) && !ENTITY::IS_ENTITY_OCCLUDED(iParam0))
			{
				*iParam2 = 0;
				return 1;
			}
...
int func_123(bool bParam0, int iParam1)
{
	...
	else if (Local_393[iLocal_450 /*23*/] == 4)
	{
		fLocal_864 = -1f;
		iLocal_784 = 1;
		iLocal_901 = VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_394[func_247() /*28*/].f_23, Local_394[func_247() /*28*/].f_26, true, true, false);
...
int func_125(vector3 vParam0, float fParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	*iParam2 = func_126(&Local_824);
	...
	if (!bLocal_792 && uParam4)
	{
		...
		{
			Local_824[*iParam2 /*20*/].f_8 = UI::ADD_BLIP_FOR_ENTITY(Local_824[*iParam2 /*20*/].f_6);
			UI::SET_BLIP_COLOUR(Local_824[*iParam2 /*20*/].f_8, 3);
		}
	}
	iLocal_840++;
...
int func_128(vector3 vParam0, float fParam1, var uParam2, int iParam3)
{
	...
	GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(Local_824[*uParam2 /*20*/].f_6), &vVar1, &vVar2);
	vVar3 = { vVar2 - vVar1 };
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar0, 30f, 0, 0, 0, 0, false, 0);
...
int func_129(var uParam0, float fParam1, var uParam2, var uParam3)
{
	...
	fVar4 = 0f;
	fVar5 = 0f;
	iVar6 = (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3999) / 1000);
	if (iVar6 == 0)
	{
		fVar4 = -GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
		fVar5 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-100f, 100f);
	}
	else if (iVar6 == 1)
	{
		fVar4 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
	...
	{
		fVar5 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
		fVar4 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-100f, 100f);
	}
	else
	{
		fVar5 = -GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
	...
	*uParam0 = { vVar3 };
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
	{
...
void func_132()
{
	...
	while (iVar0 < 12)
	{
		if (UI::DOES_BLIP_EXIST(vLocal_69[iVar0 /*3*/].f_1))
		{
			if (ENTITY::IS_ENTITY_DEAD(vLocal_69[iVar0 /*3*/], 0))
			{
				UI::REMOVE_BLIP(&(vLocal_69[iVar0 /*3*/].f_1));
			}
...
void func_133()
{
	if (!GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_63, ""))
	{
		if (!func_41())
		{
...
int func_143(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_151() || func_150(Global_4456448.f_152990)) || func_149())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_147(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_164()
{
	...
	if (SYSTEM::VDIST2(vVar0, vVar1) > 2500f)
	{
		if (!bLocal_802)
		{
			...
			bLocal_802 = true;
			if (!UI::DOES_BLIP_EXIST(iLocal_175))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_816, 0))
				{
					iLocal_175 = UI::ADD_BLIP_FOR_ENTITY(iLocal_816);
					UI::SET_BLIP_COLOUR(iLocal_175, 3);
					UI::SET_BLIP_SCALE(iLocal_175, 0.5f);
				}
			}
			if (UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_8))
			{
				UI::REMOVE_BLIP(&(Local_824[0 /*20*/].f_8));
			}
		}
	}
	else if (bLocal_802)
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_175))
		{
			UI::REMOVE_BLIP(&iLocal_175);
		}
		if (!UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_8))
		{
			Local_824[0 /*20*/].f_8 = UI::ADD_BLIP_FOR_COORD(vLocal_468[0 /*3*/]);
			if (iLocal_216)
			{
				UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_8, 5);
				UI::SET_BLIP_ROUTE(Local_824[0 /*20*/].f_8, true);
				UI::SET_BLIP_ROUTE_COLOUR(Local_824[0 /*20*/].f_8, 5);
			}
			else
			{
				UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_8, 3);
				UI::SET_BLIP_ROUTE(Local_824[0 /*20*/].f_8, true);
				UI::SET_BLIP_ROUTE_COLOUR(Local_824[0 /*20*/].f_8, 3);
			}
		}
	}
	if (SYSTEM::VDIST2(vVar0, vVar1) > 22500f)
...
int func_167(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_108(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_170(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(iParam0) || func_171(iVar1))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam1), iParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam1, iParam0, 17))
...
void func_174(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, char* sParam6, char* sParam7, var uParam8, bool bParam9, var uParam10)
{
	...
	switch (*uParam0)
	{
		...
		case 3:
			...
			if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (!iLocal_205)
				{
			...
			while (iVar0 < iParam5)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_171);
					AI::TASK_PLAY_ANIM(0, sParam6, (*sParam7)[iVar0], 4f, -4f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000), 0, 0f, 0, 0, 0);
					AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_171);
					AI::TASK_PERFORM_SEQUENCE((*uParam4)[iVar0], iLocal_171);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
				}
				iVar0++;
			}
...
int func_176(var uParam0, var uParam1, vector3 vParam2, var uParam3, var uParam4, var uParam5, float fParam6, char[4] cParam7, char* sParam8, int iParam9)
{
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar3, &uVar0, 0, 0) || func_9(*(uParam0[0 /*3*/]), 0) < 60f)
	{
		...
		while (iVar2 < iParam9)
		{
			...
			else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (iVar2 == 0)
				{
			...
			if (iLocal_170 == 3)
			{
				...
				AI::TASK_PLAY_ANIM(0, "oddjobs@towingcome_here", "come_here_idle_a", 4f, -4f, -1, 49, 0f, 0, 0, 0);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				AI::CLOSE_SEQUENCE_TASK(iVar4);
				if (!ENTITY::IS_ENTITY_DEAD(iVar1, 0))
				{
					AI::TASK_PERFORM_SEQUENCE(iVar1, iVar4);
				}
				AI::CLEAR_SEQUENCE_TASK(&iVar4);
			}
			iVar2++;
...
void func_178(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar0 == 0)
		{
			Local_438[iVar0 /*18*/].f_8 = { func_179(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0f) };
		}
		else
		{
...
int func_180()
{
	...
	{
		case 0:
			func_248(&Local_396, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_248(&Local_396, 3, Local_824[0 /*20*/], sLocal_467, 0, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_824[0 /*20*/], true);
			iLocal_843 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(35, 80);
			iLocal_911 = 1;
			break;
		
		case 1:
			AI::OPEN_SEQUENCE_TASK(&iLocal_171);
			AI::TASK_PLAY_ANIM(0, "oddjobs@towing", "Start_Engine_Loop", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(iLocal_171);
			...
			{
				AI::TASK_PLAY_ANIM(0, "oddjobs@towing", "Start_Engine_Exit", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				iLocal_911 = 2;
			}
			break;
		...
		case 2:
			if (!func_11(Local_393[iLocal_450 /*23*/].f_13))
			{
				...
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_824[0 /*20*/].f_6, Local_393[iLocal_450 /*23*/].f_13, Local_393[iLocal_450 /*23*/].f_16, Local_393[iLocal_450 /*23*/].f_19, 0, true, 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0))
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_171);
						AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_b", "idle_d", 4f, -4f, 10000, 16, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_171);
						AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
						iLocal_911 = 4;
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843 + 15))
			{
				...
				func_112(&iLocal_444);
				AI::TASK_LOOK_AT_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_7, -1, 2, 2);
				SYSTEM::SETTIMERB(0);
				iLocal_911 = 3;
			}
			break;
...
int func_181()
{
	if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
	{
		if (bLocal_177)
		{
			...
			{
				case 0:
					if (AI::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) == 1)
					{
						iLocal_855 = 1;
					}
					break;
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_824[0 /*20*/], "oddjobs@towing", "Start_Engine_Loop", 3))
		{
			...
			if (((fVar0 >= 0.19f && fVar0 <= 0.262f) || (fVar0 >= 0.4f && fVar0 <= 0.6f)) || (fVar0 >= 0.9f && fVar0 <= 1f))
			{
				...
				if (!iLocal_771)
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_444, "TOWING_ENGINE_TURNING_MASTER", Local_824[0 /*20*/].f_6, 0, 0, 0);
					iLocal_771 = 1;
				}
			}
			else
...
int func_187()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_10))
			{
				UI::REMOVE_BLIP(&(Local_824[0 /*20*/].f_10));
				func_112(&iLocal_444);
			}
		}
	...
	switch (iLocal_910)
	{
		case 0:
			if (func_9(Local_393[iLocal_450 /*23*/].f_1, 1) < 100f)
			{
				...
				{
					Local_824[0 /*20*/].f_10 = UI::ADD_BLIP_FOR_ENTITY(Local_824[0 /*20*/].f_7);
				}
...
int func_191()
{
	...
	switch (iLocal_909)
	{
		case 0:
			if (bLocal_799)
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
				{
					...
					AI::TASK_PLAY_ANIM(Local_824[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(Local_824[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0f, 0, 0, 0);
					if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_824[0 /*20*/].f_6, 10);
					}
			...
			else if (bLocal_800)
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
				{
					...
					AI::TASK_PLAY_ANIM(Local_824[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					bLocal_190 = true;
				}
			}
			else if (func_200())
		...
		case 1:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6) || func_199(iLocal_900, Local_824[0 /*20*/].f_6, !(bLocal_799 || bLocal_800)))
				{
			...
			if (func_7(&iLocal_894) && func_4(&iLocal_894) > 1f)
			{
				if (bLocal_799 && func_7(&iLocal_894))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
					{
						...
						AI::TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_b", "idle_d", -8f, 0.25f, -1, 1, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_171);
						AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
						AI::OPEN_SEQUENCE_TASK(&iLocal_171);
						AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_824[0 /*20*/], 0);
						AI::TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_a", "idle_c", 0.25f, 0.25f, 30000, 1, 0f, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(0, Local_824[0 /*20*/], 1000f, -1, 0, 0);
						AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_171);
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_1, 0))
						{
				...
				else if (bLocal_800)
				{
					if ((Global_106070.f_19945.f_4 % 2) == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_171);
							AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							AI::TASK_GO_TO_ENTITY(0, iLocal_900, 20000, 9f, 1f, 1073741824, 0);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
							AI::TASK_PLAY_ANIM(0, "oddjobs@towingangryidle_a", "idle_b", -8f, 0.25f, 7000, 0, 0f, 0, 0, 0);
							AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_171);
							AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
					...
					else
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/]))
							{
								iLocal_818 = UI::ADD_BLIP_FOR_ENTITY(Local_824[0 /*20*/]);
								UI::SET_BLIP_COLOUR(iLocal_818, 1);
								UI::SET_BLIP_SCALE(iLocal_818, 0.7f);
				...
				else if (bLocal_798)
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_171);
						AI::TASK_GO_TO_ENTITY(0, iLocal_900, 20000, 15f, 3f, 1073741824, 0);
						AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::CLOSE_SEQUENCE_TASK(iLocal_171);
						AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
			...
			if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0))
				{
					if (bLocal_800)
					{
						if (!func_41())
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], 242628503) == 1)
							{
								if (AI::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) == 2)
								{
									if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
									{
					...
					{
						if (func_195() || (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6) && !bLocal_813))
						{
							func_163();
							iLocal_909 = 5;
						}
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
			{
				if (func_109(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1) < 12f)
				{
					AI::CLEAR_PED_TASKS(Local_824[0 /*20*/]);
					if (bLocal_798)
					{
						AI::TASK_COMBAT_PED(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
					else if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_171);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
						AI::TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_a", "idle_c", -8f, 0.25f, 5000, 0, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_171);
						AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iLocal_171);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_171);
					}
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_824[0 /*20*/]))
			{
				...
				if (bLocal_798)
				{
					UI::SET_BLIP_COLOUR(Local_824[0 /*20*/].f_9, 1);
					UI::SET_BLIP_SCALE(Local_824[0 /*20*/].f_9, 0.7f);
				}
				else
				{
		...
		case 5:
			if (!func_41())
			{
				...
				if ((!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0) && !ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
				{
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
					}
					else
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/].f_6, 0))
						...
						AI::TASK_ENTER_VEHICLE(0, Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
						AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_824[0 /*20*/].f_6, 5f, 786597);
						AI::CLOSE_SEQUENCE_TASK(iVar0);
						if (!ENTITY::IS_ENTITY_DEAD(Local_824[0 /*20*/], 0))
						{
							AI::TASK_PERFORM_SEQUENCE(Local_824[0 /*20*/], iVar0);
						}
						AI::CLEAR_SEQUENCE_TASK(&iVar0);
						bLocal_928 = true;
					}
					...
					if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						if (bLocal_799)
						{
							if (SYSTEM::TIMERB() > 8000)
							{
								...
								{
									VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_824[0 /*20*/].f_6, 1);
									AI::TASK_ENTER_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
								}
								iLocal_909 = 7;
							}
						}
							...
							if (!bLocal_798)
							{
								if (PED::IS_PED_IN_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
								{
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
									{
										...
										{
											if (AI::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -258271821) != 1)
											{
												AI::TASK_VEHICLE_DRIVE_WANDER(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 2f, 786597);
											}
										}
										else
										{
								...
								else if (!ENTITY::IS_ENTITY_DEAD(iLocal_900, 0))
								{
									...
									{
										if (AI::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -1794415470) != 1)
										{
											if (VEHICLE::IS_VEHICLE_SEAT_FREE(Local_824[0 /*20*/].f_6, -1, 0))
											{
												AI::TASK_ENTER_VEHICLE(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, -1, -1, 2f, 1, 0);
											}
										}
									}
									else if (AI::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], 1056466932) != 1)
									{
										AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
									}
								}
		...
		case 7:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_824[0 /*20*/], 0) && !VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_900, Local_824[0 /*20*/].f_6))
			{
				...
				bLocal_791 = false;
				AI::TASK_VEHICLE_DRIVE_WANDER(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 5f, 786597);
				iLocal_909 = 8;
				return 1;
			}
			break;
		...
		case 8:
			...
			if (UI::DOES_BLIP_EXIST(Local_824[0 /*20*/].f_9))
			{
				UI::REMOVE_BLIP(&(Local_824[0 /*20*/].f_9));
			}
			break;
	}
	return 0;
...
int func_195()
{
	...
	{
		case 0:
			if (AI::GET_SEQUENCE_PROGRESS(Local_824[0 /*20*/]) >= 1 && !UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				iLocal_912 = 1;
			}
			break;
		...
		case 1:
			if (bLocal_807 && !iLocal_808)
			{
				if (!func_41())
				{
					...
					if (iLocal_809 && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (AI::GET_SCRIPT_TASK_STATUS(Local_824[0 /*20*/], -875674219) != 1)
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_824[0 /*20*/], Local_824[0 /*20*/].f_1, 0);
						}
						iLocal_808 = 1;
						iLocal_912 = 2;
					}
...
int func_196(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		if (vLocal_69[iVar0 /*3*/] == iParam0 && !UI::DOES_BLIP_EXIST(vLocal_69[iVar0 /*3*/].f_1))
		{
		}
		iVar0++;
	}
...
int func_199(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	if (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::GET_PLAYER_INDEX()) && func_108(iParam1, 1) < 40f)
	{
		iVar0 = 1;
	}
	...
	if (!iLocal_780)
	{
		...
		if (bLocal_799)
		{
			if (SYSTEM::VDIST2(vVar0, vVar1) < 25f)
			{
				...
				if (!func_41())
				{
					AI::TASK_LOOK_AT_ENTITY(Local_824[0 /*20*/], PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
					func_248(&Local_396, 5, Local_824[0 /*20*/], "TOWSEXMANLYGUY", 0, 1);
...
int func_202(int iParam0, int iParam1)
{
	...
	if (func_3(&iLocal_184, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_181, fLocal_182)))
	{
		func_53(&iLocal_184);
		...
		switch (iLocal_447)
		{
			...
			case 6:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Param2, Param2.f_3, Param2.f_6, 0, false, 0))
				{
					...
					if (UI::DOES_BLIP_EXIST(*iParam16))
					{
						UI::SET_BLIP_ROUTE(*iParam16, false);
						UI::REMOVE_BLIP(iParam16);
					}
					StringCopy(sParam18, "TOW_TUT_04A", 64);
					*(uParam17[0 /*3*/]) = { Param2.f_14 };
					fLocal_180 = func_9(Param2.f_14, 0);
					*iParam16 = UI::ADD_BLIP_FOR_COORD(Param2.f_14);
					SYSTEM::SETTIMERB(0);
					iLocal_447 = 7;
				}
				break;
			...
			case 9:
				...
				if (!func_41())
				{
					...
					{
						iLocal_218 = GAMEPLAY::GET_GAME_TIMER();
						if (bLocal_192)
						{
							UI::SET_BLIP_ROUTE(*iParam16, false);
							UI::REMOVE_BLIP(iParam16);
...
void func_214(int iParam0, int iParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)
{
	...
	else if (!UI::DOES_BLIP_EXIST(*iParam1) && bLocal_215)
	{
		*iParam1 = UI::ADD_BLIP_FOR_ENTITY(*iParam0);
		UI::SET_BLIP_COLOUR(*iParam1, 3);
		UI::SET_BLIP_ROUTE(*iParam1, true);
	}
	if (!bParam9)
	{
		if (!bLocal_215)
			...
			if (!func_215(iParam0))
			{
				...
				*uParam5 = GAMEPLAY::GET_GAME_TIMER();
				...
				while (iVar0 < 1)
				{
					...
					{
						UI::SET_BLIP_ROUTE((uParam2[iVar0 /*20*/])->f_8, false);
		...
		else if (func_215(iParam0))
		{
			...
			if (!func_11(*(uParam3[0 /*3*/])) && iParam12 == 9)
			{
				if (!UI::DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_8))
				{
					...
					UI::SET_BLIP_ROUTE((uParam2[0 /*20*/])->f_8, true);
				}
			}
			else if (bParam7)
			{
				...
				else
				{
					...
					if (!UI::DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_8))
					{
						(uParam2[0 /*20*/])->f_8 = UI::ADD_BLIP_FOR_COORD(Local_393[iLocal_450 /*23*/].f_1);
				...
				while (iVar0 < 1)
				{
					if (!ENTITY::IS_ENTITY_DEAD((uParam2[iVar0 /*20*/])->f_6, 0))
					{
						if (!UI::DOES_BLIP_EXIST((uParam2[iVar0 /*20*/])->f_8))
						{
							...
							UI::SET_BLIP_ROUTE((uParam2[iVar0 /*20*/])->f_8, true);
						}
					}
					else
					{
...
void func_222(var uParam0)
{
	...
	while (!func_227(&uLocal_472) || !VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_819[0]))
	{
		func_217(&uLocal_490);
		SYSTEM::WAIT(0);
	}
...
int func_253(float fParam0, int iParam1, int iParam2)
{
	...
	if (iVar4 > 1)
	{
		iVar1 = iVar3[GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, (iVar4 - 1))];
	}
	else if (iVar4 == 1)
	{
		iVar1 = iVar3[0];
