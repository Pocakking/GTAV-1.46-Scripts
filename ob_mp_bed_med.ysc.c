...
void __EntryFunction__()
{
	...
	if ((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18) || func_78()) || Global_2524719.f_1839)
	{
		func_77();
	}
	...
	{
		SYSTEM::WAIT(0);
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_68() == 5)) && !func_57())
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_322)
				{
					case 0:
					...
					case 1:
						...
						{
							func_2();
							if (GAMEPLAY::IS_BIT_SET(iLocal_321, 0))
							{
								func_1();
							}
						}
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 6f)
			{
				func_77();
			}
		}
...
void func_1()
{
	iLocal_328 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_327);
	switch (iLocal_323)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_323)
	{
		case 0:
			...
			if (func_68() == 5)
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_321, 0);
			...
			{
				if ((((func_46(vLocal_334, vVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_336, vLocal_337, 2f, 0, true, 0)) && func_45()) && !func_42(PLAYER::PLAYER_ID()))
				{
					if (iLocal_329 == -1)
					{
						func_41(&iLocal_329, 3, "SA_BED_IN", 0, 0, 0, 0);
					}
					iLocal_323 = 1;
				}
			}
		...
		case 1:
			...
			if (func_40(1, 0, 1))
			{
				if ((((((func_46(vLocal_334, vVar0) && vLocal_340.z < (vLocal_334.z + 1f)) && func_50(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_336, vLocal_337, 2f, 0, true, 0)) && func_45()) && !func_42(PLAYER::PLAYER_ID()))
				{
					if (func_38(iLocal_329, 1))
					{
						func_36(&iLocal_329);
						func_35();
						...
						func_33();
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_334, 3f, 0);
						Global_1573336 = 9;
		...
		case 6:
			...
			if (!func_42(PLAYER::PLAYER_ID()) && CONTROLS::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				if (func_34("SA_BED_OUT"))
				{
					UI::CLEAR_HELP(1);
		...
		case 7:
			...
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_334)) && !func_8()) && !func_6()) && Global_1312466.f_8 == 0)
			{
				bLocal_325 = true;
				GAMEPLAY::CLEAR_BIT(&iLocal_321, 0);
				iLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_338, vLocal_339, 2, false, false, 1065353216, 0, 1065353216);
...
void func_17(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_22(PLAYER::PLAYER_ID())) && !func_19(PLAYER::PLAYER_ID(), 0)) && !func_18()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_22(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1368245.f_241.f_136[func_44(9) /*33*/][iParam0], func_43(9));
}
...
{
	if ((((((GAMEPLAY::IS_BIT_SET(Global_1573335, iParam0) || Global_1573336 != -1) || func_55()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_54()) || func_51(iParam0))
	{
		return 0;
	}
	return 1;
