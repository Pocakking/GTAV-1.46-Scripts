...
int func_1()
{
	...
	switch (Local_137.f_1)
	{
		case 0:
			...
			{
				GAMEPLAY::SET_BIT(&(Local_137.f_2), 4);
				func_18(2);
			}
			...
			if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1))
			{
				func_18(2);
			}
			if (func_12(Local_137.f_5) || func_10(Local_137.f_5, 1, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_137.f_2), 2);
				func_18(2);
			}
			break;
			...
			else
			{
				if (!func_21(&(Local_137.f_16)))
				{
					if (!func_13(Global_262145.f_12381, &uVar0, 1123024896, 0))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_137.f_2), 6);
					}
				}
				...
				else
				{
					...
					GAMEPLAY::CLEAR_BIT(&(Local_137.f_2), 6);
				}
				...
				if (func_19(&(Local_137.f_12), Global_262145.f_12377, 0) || bVar1)
				{
					...
					if (!bVar1)
					{
						GAMEPLAY::SET_BIT(&(Local_137.f_2), 0);
					}
					else
					{
						func_2();
...
void func_2()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_137.f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 3))
		{
			Var0 = 713068249;
			...
			Var0.f_10 = func_6();
			func_3(Var0, func_4());
			GAMEPLAY::SET_BIT(&(Local_137.f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 0))
		{
			Var1 = 713068249;
		...
		else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 2) || GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1))
		{
			Var2 = 713068249;
...
int func_4()
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_5(iVar2, 0, 0))
		{
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[iVar1 /*3*/].f_2, 0))
			{
...
int func_7()
{
	if ((((GAMEPLAY::IS_BIT_SET(Local_137.f_2, 0) || GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1)) || GAMEPLAY::IS_BIT_SET(Local_137.f_2, 2)) || GAMEPLAY::IS_BIT_SET(Local_137.f_2, 3)) || GAMEPLAY::IS_BIT_SET(Local_137.f_2, 4))
	{
		return 1;
	}
	return 0;
...
void func_22()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_137.f_2), 1);
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1) && !GAMEPLAY::IS_BIT_SET(Local_137.f_2, 2))
	{
		iVar0 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(func_16());
		if (iVar0 >= 0 && iVar0 < 32)
		{
			if (GAMEPLAY::IS_BIT_SET(vLocal_138[iVar0 /*3*/].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(Local_137.f_2), 2);
				if (Local_137.f_1 == 0)
				{
...
int func_23()
{
	...
	STATS::_0x6DEE77AFF8C21BD1(&(Local_137.f_20), &(Local_137.f_21));
	...
	switch (vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		...
		case 1:
			if (func_654())
			{
				...
				if (bLocal_126)
				{
					if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 8))
					{
						func_613();
						GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 8);
					}
				}
				...
				if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 6))
				{
					func_647(4);
				}
			}
			else if (bLocal_126)
			{
				...
				{
					func_615(0);
					if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
					{
						func_647(8);
					}
					else
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 7))
			{
				func_550(-1, 0, 0, -1, 0, 0);
				GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 7);
			}
		...
		case 2:
			...
			if (func_654())
			{
				...
				if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 11))
				{
					func_832();
					return;
				}
			...
			func_86();
			func_317();
			if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 0))
			{
				if (func_654())
				{
					func_615(10);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 1))
			{
				if (func_610(NETWORK::PARTICIPANT_ID_TO_INT()))
				{
					if (!func_645(PLAYER::PLAYER_ID(), Local_137.f_5, 1))
					{
						func_615(7);
					}
				}
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 2))
			{
				if (func_654())
				{
					func_615(12);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 3))
			{
				if (func_654())
				{
					if (func_81())
				...
				else if (Local_137.f_6 == PLAYER::PLAYER_ID())
				{
					if (func_645(PLAYER::PLAYER_ID(), func_16(), 0))
					{
						func_615(15);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 4))
			{
				if (func_654())
				{
					func_615(16);
...
{
	if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 6))
	{
		if (iParam0 != func_11())
		{
			func_83(0, iParam0);
		...
		GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 6);
	}
}
...
void func_86()
{
	...
	Var0.f_18 = -1;
	Var0.f_19 = -1;
	if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 3))
		{
			...
			GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_137.f_2, 0))
		{
			if (func_645(PLAYER::PLAYER_ID(), func_16(), 1))
...
int func_196(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_205(iParam1, -2, 1, 0, 0));
	...
	if (((func_229(PLAYER::PLAYER_ID()) || (func_228() && func_227())) && !GAMEPLAY::IS_BIT_SET(Global_2524719.f_4577, 31)) && !bParam4)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (PED::IS_PED_A_PLAYER(iVar1))
			{
				...
				{
					if (func_5(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_215(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_130())
			{
				...
				iVar6 = func_283(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
...
void func_317()
{
	if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 7))
	{
		...
		GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 7);
	}
}
			...
			if ((!func_495() && !func_493()) || GAMEPLAY::IS_BIT_SET(Global_2524719.f_4574, 1))
			{
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						{
							iVar3 = PLAYER::INT_TO_PLAYERINDEX(iVar17);
							if (func_5(iVar3, 0, 1) && !GAMEPLAY::IS_BIT_SET(iVar14, iVar3))
							{
								iVar3 = PLAYER::INT_TO_PLAYERINDEX(iVar17);
							}
							else
...
void func_607()
{
	...
	if (fVar2 < 25f)
	{
		...
		CONTROLS::SET_PAD_SHAKE(0, 1000, SYSTEM::ROUND(fVar4));
	}
}
...
int func_610(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(vLocal_138[iParam0 /*3*/].f_2, 0))
	{
		return 0;
	}
	return 1;
...
int func_612(int iParam0, int iParam1)
{
	if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MPBitset", 3))
	{
		if (DECORATOR::DECOR_EXIST_ON(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(iParam0), "MPBitset"))
		{
			if (GAMEPLAY::IS_BIT_SET(DECORATOR::DECOR_GET_INT(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(iParam0), "MPBitset"), iParam1))
			{
				return 1;
			}
		}
...
void func_615(int iParam0)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_121, iParam0))
			{
				if (func_644())
				{
					func_639();
					func_637(86, "GB_HTB_BMT0", "GB_HTB_BMS0", func_638(func_16()), iLocal_111, 0, -1, -1, -1, 2, -1);
					GAMEPLAY::SET_BIT(&iLocal_121, iParam0);
				}
			}
			break;
...
int func_640(char* sParam0, char* sParam1, int iParam2)
{
	UI::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	if (!iParam2 == 0)
	{
...
int func_641(char* sParam0, char* sParam1, int iParam2, char* sParam3, int iParam4)
{
	UI::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	if (!iParam2 == 0)
	{
...
void func_647(int iParam0)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_122, iParam0))
			{
				if (func_653(0))
				{
					func_652("GB_HTB_HB0", "GB_HTB_BLP", func_643(func_16()), -1);
					func_49(1);
					GAMEPLAY::SET_BIT(&iLocal_122, iParam0);
				}
			}
			break;
...
void func_651(char* sParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	UI::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	if (!iParam2 == 0)
	{
...
void func_655()
{
	...
	if (func_661(PLAYER::PLAYER_ID(), Global_262145.f_12381, &uVar1, func_663(&iLocal_135, 13, -1), 1123024896, 0))
	{
	...
	switch (func_658(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		...
		case 1:
			...
			{
				iLocal_136 = NETWORK::GET_NETWORK_TIME();
			}
			if (iVar0 && !func_663(&iLocal_135, 3, -1))
			{
				if (!func_663(&iLocal_135, 1, -1))
				{
					...
					if (AUDIO::PREPARE_MUSIC_EVENT(sVar2) && func_663(&iLocal_135, 11, -1))
					{
	...
	if (func_663(&iLocal_135, 6, -1) && (func_663(&iLocal_135, 5, -1) || func_658(NETWORK::PARTICIPANT_ID_TO_INT()) == 2))
	{
	...
	if (func_21(&(Local_137.f_16)) && func_664(Local_137.f_16, 10000, 0))
	{
		if (!func_663(&iLocal_135, 10, -1))
		{
			...
			AUDIO::PLAY_SOUND_FRONTEND(iLocal_134, "10s", "MP_MISSION_COUNTDOWN_SOUNDSET", false);
...
void func_665()
{
	switch (vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 1:
			if (func_654())
			{
				if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 3))
				{
					if (func_666(82, "GB_INTTXT_HBB", 2, 0, 0, 0, 0, 1, 0, 1))
					{
						GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 3);
					}
				}
			}
			else if (func_645(PLAYER::PLAYER_ID(), func_16(), 0))
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_669(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_709()
{
	...
	switch (vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!func_17(Local_137.f_7))
			{
				if (func_645(PLAYER::PLAYER_ID(), func_16(), 1))
				{
					...
					{
						iLocal_120 = UI::ADD_BLIP_FOR_COORD(Local_137.f_7);
						UI::_0x75A16C3DA34F1245(iLocal_120, true);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_120, "GB_HTB_BLIP1");
						UI::SET_BLIP_FLASHES(iLocal_120, 1);
						UI::SET_BLIP_FLASH_TIMER(iLocal_120, 7000);
						UI::SET_BLIP_SPRITE(iLocal_120, 458);
						UI::SET_BLIP_PRIORITY(iLocal_120, 12);
						UI::SET_BLIP_SCALE(iLocal_120, Global_262145.f_12242);
						func_725(&iLocal_120, iLocal_111);
					}
					if (!UI::DOES_BLIP_EXIST(iLocal_119))
					{
						iLocal_119 = UI::ADD_BLIP_FOR_RADIUS(Local_137.f_7, SYSTEM::TO_FLOAT((Global_262145.f_12381 - 1)));
						func_725(&iLocal_119, iLocal_111);
						UI::_0x75A16C3DA34F1245(iLocal_119, true);
						UI::_0xC4278F70131BAA6D(iLocal_119, 1);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_119, "GB_HTB_BLIP0");
					}
					if (func_724(Local_137.f_5) != iLocal_123)
					{
						iLocal_123 = func_724(Local_137.f_5);
						UI::SET_BLIP_ALPHA(iLocal_119, iLocal_123);
					}
				}
			}
			break;
		...
		case 1:
			...
			{
				func_722();
				if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
				{
					if (!func_21(&(Local_137.f_16)) && !func_21(&(Local_137.f_18)))
					{
						if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 2))
						{
							func_721(1, 0);
							GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 2);
						}
					}
					else if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 2))
					{
						func_721(0, 0);
						GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 2);
					}
				}
			}
			else
			{
				...
				if (!func_645(PLAYER::PLAYER_ID(), func_16(), 0))
				{
					if (bLocal_126)
					{
						if (vLocal_138[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_137.f_5) /*3*/].f_1 == 1 && !GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_137.f_5) /*3*/].f_2, 2))
						{
							if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 10))
							{
								...
								GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 10);
							}
						}
						else if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 10))
						{
							...
							GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 10);
						}
					}
				}
			}
			if (!func_17(Local_137.f_7))
			{
				...
				if (!UI::DOES_BLIP_EXIST(iLocal_119))
				{
					...
					UI::_0xC4278F70131BAA6D(iLocal_119, 1);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_119, "GB_HTB_BLIP0");
					UI::SET_BLIP_ALPHA(iLocal_119, Global_262145.f_12126);
				}
...
void func_720()
{
	if (GAMEPLAY::IS_BIT_SET(vLocal_138[func_16() /*3*/].f_2, 4))
	{
		if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 9))
		{
			if (func_16() != func_134())
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Boss_Blipped", "GTAO_Magnate_Hunt_Boss_SoundSet", false);
				GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 9);
			}
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 9))
	{
		GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 9);
	}
}
...
void func_722()
{
	...
	{
		vLocal_128 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	...
	else if (func_21(&uLocal_132))
	{
		...
		if (func_19(&uLocal_132, SYSTEM::ROUND(Global_262145.f_12380), 0))
		{
			func_8(&uLocal_132);
			GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 4);
	...
	{
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_128) > IntToFloat(Global_262145.f_12378))
		{
			func_8(&uLocal_130);
			if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
			{
		...
		else if (IntToFloat(func_708(&uLocal_130, 0, 0)) > Global_262145.f_12379)
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 4))
			{
				GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 4);
			}
		}
		iLocal_129++;
	}
...
void func_729(int iParam0)
{
	...
	if (iVar2 == func_16())
	{
		if (ENTITY::DOES_ENTITY_EXIST(Var4.f_1))
		{
			if (ENTITY::IS_ENTITY_A_PED(Var4.f_1))
			{
				...
				if (PED::IS_PED_A_PLAYER(iVar1))
				{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar3) /*3*/].f_2, 0))
						{
							if (iVar3 != func_11())
							{
								if (func_5(iVar3, 0, 0))
		...
		else
		{
			...
			{
				Local_137.f_6 = iVar3;
				GAMEPLAY::SET_BIT(&(Local_137.f_2), 3);
				func_18(2);
			}
		}
	}
...
void func_732()
{
	...
	if (func_654())
	{
		if (func_747())
		{
			if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 11);
			}
		}
	}
	switch (func_658(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		case 1:
			...
			if (bLocal_127)
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				{
					GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					if (func_654())
					{
						func_736(0, 0);
						func_735(2);
			...
			else if (func_726(PLAYER::PLAYER_ID(), 500, &uVar0, 1123024896, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				{
					GAMEPLAY::SET_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					if (func_654())
					{
						func_736(1, 0);
						func_735(2);
			...
			else if (GAMEPLAY::IS_BIT_SET(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				GAMEPLAY::CLEAR_BIT(&(vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
				if (func_654())
				{
...
{
	vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = iParam0;
}
...
{
	vLocal_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = iParam0;
}
...
int func_824()
{
	...
	if (func_714() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_714()) == 0)
		{
			return 1;
		}
	}
...
void func_861(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (func_869(iParam0, bParam2))
	{
		...
		iVar3 = func_406(PLAYER::PLAYER_ID(), iVar2);
