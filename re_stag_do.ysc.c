			...
			switch (iLocal_46)
			{
				...
				case 1:
					...
					else
					{
						...
						if (iLocal_47 == 3)
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_67, true) < 100f)
							{
								...
								if (CUTSCENE::IS_CUTSCENE_ACTIVE())
								{
									if (CUTSCENE::_0xB56BBBCC2955D9CB())
									{
										...
										{
											CUTSCENE::_0x2A56C06EBEF2B0D9("Groom", iLocal_51, 0);
											CUTSCENE::_0x2A56C06EBEF2B0D9("Groomsman", iLocal_53, 0);
											CUTSCENE::_0x2A56C06EBEF2B0D9("Bride", iLocal_52, 0);
											CUTSCENE::_0x2A56C06EBEF2B0D9("Father_of_the_bride", iLocal_54, 0);
										}
									}
								}
							}
							...
							else if (!PED::IS_PED_INJURED(iLocal_53))
							{
								...
								{
									if (UI::DOES_BLIP_EXIST(iLocal_286))
									{
										UI::REMOVE_BLIP(&iLocal_286);
										if (UI::DOES_BLIP_EXIST(iLocal_284))
										{
											UI::REMOVE_BLIP(&iLocal_284);
										}
										if (!UI::DOES_BLIP_EXIST(iLocal_284))
										{
						...
						if (func_3())
						{
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								AI::TASK_SMART_FLEE_PED(iLocal_51, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_53))
							{
								AI::TASK_SMART_FLEE_PED(iLocal_53, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_52))
							{
								AI::TASK_SMART_FLEE_PED(iLocal_52, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_54))
							{
								AI::TASK_SMART_FLEE_PED(iLocal_54, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							func_2();
						}
					}
...
void func_61()
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_51, 0))
	{
		if (!iLocal_81)
		{
			...
			{
				iLocal_81 = 1;
				if (UI::DOES_BLIP_EXIST(iLocal_283))
				{
					UI::REMOVE_BLIP(&iLocal_283);
				}
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_55, 0))
			{
				if (!PED::IS_PED_IN_VEHICLE(iLocal_51, iLocal_55, 0))
				{
					...
					if (!UI::DOES_BLIP_EXIST(iLocal_283))
					{
						...
						UI::SET_BLIP_AS_FRIENDLY(iLocal_283, true);
					}
					iLocal_81 = 0;
					iLocal_83 = 1;
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_51))
	{
		if (!PED::IS_PED_INJURED(iLocal_51))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
			{
				...
				{
					if (UI::DOES_BLIP_EXIST(iLocal_285))
					{
						UI::REMOVE_BLIP(&iLocal_285);
						if (!UI::DOES_BLIP_EXIST(iLocal_284))
						{
							iLocal_284 = func_23(vLocal_59, 1);
						}
				...
				else if (UI::DOES_BLIP_EXIST(iLocal_284))
				{
					UI::REMOVE_BLIP(&iLocal_284);
					if (!UI::DOES_BLIP_EXIST(iLocal_285))
					{
	...
	if (!PED::IS_PED_INJURED(iLocal_51))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_71())
			{
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_51, 0, 0);
				}
				if (!iLocal_89)
				{
					if (!func_65())
			...
			if (!PED::IS_PED_INJURED(iLocal_51))
			{
				if (!iLocal_93 && bLocal_82)
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_51, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, 0, true, 0) || SYSTEM::TIMERA() > 5000)
					{
						...
						CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_71, 10f, 0, 0, 0, 0, false, 0);
				...
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_67, 5f, 0, 0, 0, 0, false, 0);
				}
			}
			if (!bLocal_87)
			{
			...
			if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_60, vLocal_61, fLocal_62, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_51, vLocal_60, vLocal_61, fLocal_62, 0, true, 0)) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_51, vLocal_59, 0f, 0f, 2f, true, true, 0) && func_60(1, 0, 1))) || bLocal_82)
			{
				switch (iLocal_47)
				{
						...
						if (!bLocal_82)
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
							{
								...
								if (iVar2 != 0)
								{
									...
									if (iVar3 == 4)
									{
										AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 5000, 0, 2);
									}
									else
									{
										AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 5000, 2052, 4);
								...
								if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_51))
								{
									...
									if (SYSTEM::TIMERA() > 15000)
									{
										if (!PED::IS_PED_INJURED(iLocal_51))
										{
											...
											AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, -1, 2048, 4);
											if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
											{
												AI::OPEN_SEQUENCE_TASK(&iLocal_77);
												AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
												AI::TASK_ENTER_VEHICLE(0, iLocal_55, -1, 0, 2f, 1, 0);
												AI::CLOSE_SEQUENCE_TASK(iLocal_77);
												AI::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_77);
												AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
											}
						...
						if (!PED::IS_PED_INJURED(iLocal_51) && !ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
						{
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_51, 0))
							{
								...
								else
								{
									...
									if (iLocal_272 != 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_272 + 6000)
									{
					...
					case 2:
							...
							if (func_4(&uLocal_100, "stagdau", "stagd_hairc", 4, 0, 0, 0))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_53) && !PED::IS_PED_INJURED(iLocal_51))
								{
									if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_51, 0))
									{
										...
										AI::OPEN_SEQUENCE_TASK(&iLocal_77);
										AI::TASK_ENTER_VEHICLE(0, iLocal_96, -1, 2, 1f, 1, 0);
										AI::TASK_CLEAR_LOOK_AT(0);
										AI::CLOSE_SEQUENCE_TASK(iLocal_77);
										AI::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_77);
									...
									{
										AI::TASK_GO_TO_ENTITY(iLocal_53, iLocal_51, -1, 8f, 1073741824, 1073741824, 0);
									}
									if (!UI::DOES_BLIP_EXIST(iLocal_286))
									{
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) == 7 || SYSTEM::TIMERA() > 12000)
							{
								vLocal_59 = { vLocal_63 };
								vLocal_60 = { vLocal_64 };
								vLocal_61 = { vLocal_65 };
								...
								if (((STREAMING::HAS_MODEL_LOADED(joaat("ig_bride")) && STREAMING::HAS_MODEL_LOADED(joaat("washington"))) && STREAMING::HAS_MODEL_LOADED(joaat("baller2"))) && STREAMING::HAS_MODEL_LOADED(joaat("primo")))
								{
									...
									AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
									AI::CLOSE_SEQUENCE_TASK(iLocal_77);
									AI::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_77);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
									...
									AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1);
									...
									VEHICLE::SET_VEHICLE_COLOURS(iLocal_56[0], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									VEHICLE::SET_VEHICLE_COLOURS(iLocal_56[1], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									VEHICLE::SET_VEHICLE_COLOURS(iLocal_56[2], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									VEHICLE::SET_VEHICLE_COLOURS(iLocal_56[3], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									iLocal_47 = 3;
									bLocal_82 = false;
									iLocal_94 = 0;
								}
...
void func_91()
{
	...
	if (iLocal_271 == func_74(func_75()))
	{
		...
		if (!func_65())
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_52))
			{
				AI::TASK_SMART_FLEE_PED(iLocal_52, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				AI::TASK_SMART_FLEE_PED(iLocal_54, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			SYSTEM::WAIT(8500);
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_51);
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 5000, 2048, 2);
				AI::TASK_LOOK_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 5000, 2048, 2);
				AI::TASK_LEAVE_ANY_VEHICLE(iLocal_51, 0, 0);
				PED::REMOVE_PED_FROM_GROUP(iLocal_51);
			}
			...
			{
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 5000, 0, 2);
				AI::TASK_LEAVE_ANY_VEHICLE(iLocal_53, 500, 0);
			}
			SYSTEM::WAIT(1000);
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
			{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					AI::TASK_ENTER_VEHICLE(0, iLocal_55, -1, -1, 1f, 8, 0);
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_55, PLAYER::PLAYER_PED_ID(), 8, 15f, 786469, 10f, 10f, 1);
				}
				else
				{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_51))
	{
		if (!iLocal_79)
		{
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 130f, 60f, 50f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_51)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 10f, 10f, 10f, 0, 1, 0))
			{
				...
				{
					iLocal_285 = func_64(iLocal_51, 0, 145);
					UI::_0x75A16C3DA34F1245(iLocal_285, false);
					AI::TASK_LOOK_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
				}
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 10f, 10f, 10f, 0, 1, 0))
				{
					if (UI::DOES_BLIP_EXIST(iLocal_285))
					{
						UI::_0x75A16C3DA34F1245(iLocal_285, true);
					}
					SYSTEM::SETTIMERB(0);
					func_92();
					while (func_65())
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_51))
			{
				if ((!func_143() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, 0, true, 0)) && UI::DOES_BLIP_EXIST(iLocal_285))
				{
					if (!func_65())
					{
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_60(1, 0, 1))
					{
						if (!iLocal_275)
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_51, true), 5f, 1, 0, 0, false);
							...
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								...
								AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_51);
								AI::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_282, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
...
void func_121()
{
	...
	AI::TASK_SET_DECISION_MAKER(iLocal_51, -1143637011);
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(iLocal_51, true), 10f, 0);
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0))
	{
		AI::OPEN_SEQUENCE_TASK(&iLocal_77);
		AI::TASK_PLAY_ANIM(0, "re@stag_do@idle_a", "idle_a_ped", 8f, -8f, -1, 9, 0f, 0, 0, 0);
		AI::CLOSE_SEQUENCE_TASK(iLocal_77);
		AI::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_77);
		AI::CLEAR_SEQUENCE_TASK(&iLocal_77);
		PED::SET_PED_KEEP_TASK(iLocal_51, true);
