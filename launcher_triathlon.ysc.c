...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_117(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_97.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_99(3) && !Global_93266)
						{
							if (func_117(uLocal_58, 2097152))
							{
								if ((!func_117(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_98())) && !Global_93266)
								{
									func_110(10);
									break;
								}
						...
						if ((!func_89(6) || Global_105117) || func_88())
						{
							bVar3 = false;
						}
						if (func_117(uLocal_58, 1))
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_77(uLocal_54))
								{
									...
									else if (!func_117(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_60);
				...
				case 6:
					...
					if (func_117(Global_104721, 262144))
					{
						func_121(&Global_104721, 262144);
						func_36();
					}
					if (func_117(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_117(Global_104721, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_93269, 0);
								func_28(func_39(iLocal_63), 0, Global_93269, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_93269, 0);
								func_28(func_39(iLocal_63), 0, Global_93269, 0, 0);
							}
						}
						func_4();
						func_121(&Global_104721, 0);
...
void func_7()
{
	if (func_117(Global_106070.f_19983.f_9, 1))
	{
		func_121(&(Global_106070.f_19983.f_9), 1);
		if (iLocal_91 == Global_106070.f_19983.f_8)
		{
			if (Global_106070.f_19983.f_8 != 2)
			{
				Global_106070.f_19983.f_8++;
				if (Global_106070.f_19983.f_8 == 1)
				{
					func_111(108, 1, 0);
					func_20(114, 1, 0, 1, 0);
				}
				else if (Global_106070.f_19983.f_8 == 2)
				{
					func_111(109, 1, 0);
					func_20(115, 1, 0, 1, 0);
				}
				if (iLocal_88 && Global_106070.f_19983.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20382.f_150[iVar1]), iVar0);
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20382.f_150[iVar1]), iVar0);
	}
}
...
void func_28(char[4] cParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
float func_32(int iParam0)
{
	if (func_35(iParam0))
	{
		...
		{
			return (func_33(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_33(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_60()
{
	...
	else if ((PED::IS_PED_INJURED(iLocal_85) || DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(89, ENTITY::GET_ENTITY_COORDS(iLocal_85, true), 40f)) || DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(116, ENTITY::GET_ENTITY_COORDS(iLocal_85, true), 40f))
	{
		func_78("TRI_DEATH", -1);
		iVar0 = iLocal_69;
		func_72(iLocal_69);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_85, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_85, 150319005) != 1)
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_85, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				}
			}
			else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_85, 150319005) == 1)
			{
...
void func_61()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_90 && fLocal_57 < (30f * 30f))
	{
		iLocal_90 = GAMEPLAY::GET_GAME_TIMER() + 10000;
		if (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) <= 0.5f)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar4) && !PED::IS_PED_INJURED(iVar4))
			{
				...
				StringIntConCat(&Var6, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 5), 32);
...
void func_65()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_68(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_66(iVar0) && (!func_101(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_66(Global_106070.f_2355.f_539.f_4301))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105117) || Global_25461) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_96()) || Global_25461) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105117) || Global_25461) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_105117) || Global_25461) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_25461) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_96()) || func_93()) || Global_105117) || Global_25461) || func_95()) || Global_37271) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_105117) || Global_25461) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_87)
	{
		GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_78, 25f, 0);
		if (AI::DOES_SCENARIO_GROUP_EXIST("Triathlon_1_Start") && iLocal_91 == 1)
		{
			AI::SET_SCENARIO_GROUP_ENABLED("Triathlon_1_Start", true);
		}
		if (AI::DOES_SCENARIO_GROUP_EXIST("Triathlon_2_Start") && iLocal_91 == 0)
		{
			AI::SET_SCENARIO_GROUP_ENABLED("Triathlon_2_Start", true);
		}
		if (AI::DOES_SCENARIO_GROUP_EXIST("Triathlon_3_Start") && iLocal_91 == 2)
		{
			AI::SET_SCENARIO_GROUP_ENABLED("Triathlon_3_Start", true);
		}
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_83))
		{
			...
			ROPE::ACTIVATE_PHYSICS(iLocal_83);
		...
		{
			if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_79, 3f, 1))
			{
				AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_85, vLocal_79, 2f, 0);
			}
			else
			{
				switch (iLocal_91)
				...
				AI::TASK_START_SCENARIO_AT_POSITION(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", vVar3, fVar4, -1, 0, 1);
			}
		}
		iVar8 = 0;
...
{
	return func_116(iParam0, Global_36117);
}
...
void func_118()
{
	...
	if (Global_106070.f_19983.f_8 == -1)
	{
		Global_106070.f_19983.f_8 = 0;
	}
	if (Global_106070.f_19983.f_8 < iLocal_91)
	{
		func_85(&uLocal_58, 8388608);
	}
}
...
void func_126(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		func_127(&(Global_17367.f_5658[iVar0 /*10*/]));
