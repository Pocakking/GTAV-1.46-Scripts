...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_EC", 0);
		SYSTEM::WAIT(0);
	...
	switch (iLocal_83)
	{
		...
		case 1:
			if (iLocal_92 == 1)
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_93) >= 500)
				{
					func_221(1, 1, 1);
					iLocal_92 = 0;
				}
			...
			if (!iLocal_94)
			{
				if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (func_281(Local_81.f_28[0]))
					{
						AI::CLEAR_PED_TASKS(Local_81.f_28[0]);
		...
		case 2:
			...
			if (func_281(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_84);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 1048576000, 0, 1193033728);
					AI::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_84);
				}
				else
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_84);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 1, 1193033728);
					AI::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_84);
				}
				AI::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], iLocal_84);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_84);
...
void func_224(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_228(PLAYER::PLAYER_ID())) && !func_226(PLAYER::PLAYER_ID(), 0)) && !func_225()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_228(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_233()
{
	...
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		...
		if (func_281(Local_81.f_28[0]))
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9("Josh", Local_81.f_28[0], 0);
		}
	}
	switch (iLocal_83)
	{
		case 0:
			if (func_249(1, 1093140480, 0))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0);
				...
				func_247();
				UNK1::_0x293220DA1B46CEBC(8f, 0f, 0);
		...
		case 1:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				UNK1::_0x293220DA1B46CEBC(0f, 8f, 0);
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						AI::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						AI::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
...
void func_235(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_236(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
		...
		case 0:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout"))
				{
					...
					iLocal_85 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
					func_237(1);
					CUTSCENE::_REQUEST_CUTSCENE_EX("JOSH_1_INT_CONCAT", 14, 8);
					iLocal_83 = 1;
				}
			}
			else
				...
				if (!bLocal_90)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_282(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
						{
							...
							AI::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], -1, 0, 2);
							AI::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
					...
					else
					{
						if (!func_5(0) && !bLocal_90)
						{
							...
							CUTSCENE::_REQUEST_CUTSCENE_EX("JOSH_1_INT_CONCAT", 13, 8);
						}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_267(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_278(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_280(iParam0, Global_36117);
}
...
int func_315()
{
	...
	iVar0 = func_316(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_319()
{
	...
	{
		if (func_314(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
