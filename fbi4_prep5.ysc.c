...
void __EntryFunction__()
{
	...
	Global_106070.f_2355.f_539.f_2383[0] = -99;
	Global_106070.f_2355.f_539.f_2383[1] = -99;
	Global_106070.f_2355.f_539.f_2383[2] = -99;
	while (true)
	{
		UNK1::_0x208784099002BC30("M_BS", 0);
...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_20();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_189))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((GAMEPLAY::GET_GAME_TIMER() - iLocal_373) < 2000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)
{
	...
	if (Global_106070.f_9057 || func_267(0))
	{
		iVar0 = func_17();
		if (!func_5(iVar0))
		{
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_8(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
void func_40(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_267(0) && Global_71451.f_1 == 1) && func_41(Global_71451))
		{
		}
		else
		{
...
int func_58(int iParam0)
{
	...
	return Global_90805[func_59(iParam0)];
}
...
int func_82(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_86() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_83(func_85(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_83(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_84(iParam1)];
...
int func_90(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_190, 0);
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_202, 6);
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_89(iLocal_81, bLocal_28))
			{
				...
				{
					UI::SET_BLIP_COLOUR(iLocal_197, 2);
					UI::SET_BLIP_ROUTE_COLOUR(iLocal_197, 2);
				}
		...
		case 2:
			...
			while (iVar0 < 3)
			{
				...
				{
					case 0:
						switch (Global_106070.f_2355.f_539.f_2383[0])
						{
							case 20:
								if (Global_106070.f_2355.f_539.f_2383[1] == 13 || Global_106070.f_2355.f_539.f_2383[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 21:
								if (Global_106070.f_2355.f_539.f_2383[1] == 14 || Global_106070.f_2355.f_539.f_2383[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 22:
								if (Global_106070.f_2355.f_539.f_2383[1] == 15 || Global_106070.f_2355.f_539.f_2383[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 1:
						switch (Global_106070.f_2355.f_539.f_2383[1])
						{
							case 13:
								if (Global_106070.f_2355.f_539.f_2383[0] == 20 || Global_106070.f_2355.f_539.f_2383[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 14:
								if (Global_106070.f_2355.f_539.f_2383[0] == 21 || Global_106070.f_2355.f_539.f_2383[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 15:
								if (Global_106070.f_2355.f_539.f_2383[0] == 22 || Global_106070.f_2355.f_539.f_2383[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 2:
						switch (Global_106070.f_2355.f_539.f_2383[2])
						{
							case 17:
								if (Global_106070.f_2355.f_539.f_2383[0] == 20 || Global_106070.f_2355.f_539.f_2383[1] == 13)
								{
									bVar1 = false;
								}
								break;
							...
							case 18:
								if (Global_106070.f_2355.f_539.f_2383[0] == 21 || Global_106070.f_2355.f_539.f_2383[1] == 14)
								{
									bVar1 = false;
								}
								break;
							...
							case 19:
								if (Global_106070.f_2355.f_539.f_2383[0] == 22 || Global_106070.f_2355.f_539.f_2383[1] == 15)
								{
									bVar1 = false;
								}
								break;
		...
		case 3:
			Global_106070.f_2355.f_539.f_2383[0] = 20;
			Global_106070.f_2355.f_539.f_2383[1] = 13;
			Global_106070.f_2355.f_539.f_2383[2] = 17;
			func_23(1, 1, 1);
			iLocal_82 = 1;
			break;
	}
...
void func_102(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!UI::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_103(vParam1, 5, bParam2);
		if (bParam3)
		{
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(*iParam0, sParam4);
		}
	}
}
		...
		case 0:
			if (func_89(iLocal_81, 0))
			{
				if (func_274())
				{
					...
					while (!func_106(28) && (GAMEPLAY::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_24(500, 1);
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_172(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_172(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_112(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_116(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_115(*iParam1);
				...
				func_113(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_113(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_119(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			...
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_125(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_126(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_142(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_122())
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_143(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_122())
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_144(int iParam0)
{
	if (iParam0 != func_122())
	{
		if (func_121(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_120(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_147(int iParam0, int iParam1)
{
	...
	func_148(iParam0, &(Global_106070.f_32605.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_149(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_178(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_179(iParam0, iParam1))
				{
...
void func_180(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_188(&(Global_70024.f_555[0 /*21*/]), iVar0))
		{
...
void func_181(int iParam0)
{
	...
	if (func_188(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_187(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_185(0, Global_70024.f_555[0 /*21*/].f_12) || !func_185(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_184(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_185(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_186(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_154(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_188(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_189(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_189(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_189(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_191(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_207(uParam0))
	{
		...
		if (func_206(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_193(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_193(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_194(iParam0, Global_70024.f_139[38], 0))
			{
				func_181(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_194(iParam0, Global_70024.f_139[43], 1))
			{
				func_181(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_189(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 1) < 10f)
					{
...
void func_195(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_149(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_149(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_149(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_198(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_197())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_149(iVar2 + 1)))
				{
...
bool func_208()
{
	return func_206(&(Global_99633.f_2875));
}

void func_209()
{
	func_210(&(Global_99633.f_2875));
}
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_213(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_214()
{
	return func_207(&(Global_99633.f_2875));
}

bool func_215(vector3 vParam0, int iParam1)
{
	return func_216(Global_99633.f_2875.f_12.f_66, vParam0, iParam1);
}
...
void func_227()
{
	if (func_229())
	{
		...
		{
			case 0:
				if (Global_106070.f_2355.f_539.f_2383[0] == -99)
				{
					func_228(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
				}
				else if (Global_106070.f_2355.f_539.f_2383[1] == -99)
				{
					func_228(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
				}
				else if (Global_106070.f_2355.f_539.f_2383[2] == -99)
				{
			...
			case 1:
				if (Global_106070.f_2355.f_539.f_2383[1] == -99)
				{
					func_228(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
				}
				else if (Global_106070.f_2355.f_539.f_2383[0] == -99)
				{
					func_228(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
				}
				else if (Global_106070.f_2355.f_539.f_2383[2] == -99)
			...
			case 2:
				if (Global_106070.f_2355.f_539.f_2383[2] == -99)
				{
					func_228(sLocal_80[2], sLocal_80[1], sLocal_80[0]);
				}
				else if (Global_106070.f_2355.f_539.f_2383[0] == -99)
...
int func_230()
{
	...
	while (iVar1 <= 2)
	{
		if (Global_106070.f_2355.f_539.f_2383[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_233(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_234(Global_106070.f_28022[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_237(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_239() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_239() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_238(iParam0));
...
bool func_242(int iParam0)
{
	if (iParam0 == 8)
	{
		return func_243(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_243(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_243(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_243(137, -1, -1);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_239() /*12745*/].f_8178.f_10, iParam0);
}
...
{
	if (func_13(14) && !func_259(iParam0))
	{
		return 0;
	}
	...
	if (func_258(&Global_4268566))
	{
		if (func_256(&Global_4268566, iParam0))
		{
			return 0;
		}
		if (func_249(&Global_4268566, iParam0))
		{
			return 1;
		}
	}
...
int func_249(var uParam0, int iParam1)
{
	...
	if (func_13(14) && !func_259(iParam1))
	{
		return 0;
	}
...
void func_252(var uParam0)
{
	...
	func_254(uParam0, (Global_4268565 - 0.5f));
}
...
{
	return func_257(uParam0, iParam1) != -1;
}
...
void func_264(int iParam0)
{
	...
	{
		func_265(iParam0, 10, 1);
		func_265(iParam0, 19, 1);
	}
}
...
void func_265(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_86() == 0)
		{
			...
			func_266(func_85(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_266(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_84(iParam2)];
	if (iVar0 != 0)
	{
...
{
	Global_71017[1 /*14*/] = { func_278(iParam0, iParam1, iParam2, -1) };
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0) && !GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_277(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 0, Global_71017[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_277(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 0, Global_71017[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_280(int iParam0)
{
	...
	func_281(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_284(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_83(func_283(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_281(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_289(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
