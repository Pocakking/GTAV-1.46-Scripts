		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			switch (iLocal_43)
			{
				...
				case 2:
					...
					{
						if (GAMEPLAY::CREATE_INCIDENT_WITH_ENTITY(7, PLAYER::PLAYER_PED_ID(), 2, 3f, &uLocal_47, 0, 0))
						{
							iLocal_46 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_43 = 5;
						}
					}
					else if (GAMEPLAY::CREATE_INCIDENT(7, vLocal_45, 2, 3f, &uLocal_47, 0, 0))
					{
						iLocal_46 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_43 = 5;
					}
				...
				case 3:
					...
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
						...
						else if (GAMEPLAY::CREATE_INCIDENT_WITH_ENTITY(5, PLAYER::PLAYER_PED_ID(), 2, 3f, &uLocal_47, 0, 0))
						{
							iLocal_46 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_43 = 5;
						}
					}
					else if (GAMEPLAY::CREATE_INCIDENT(5, vLocal_45, 2, 3f, &uLocal_47, 0, 0))
					{
						iLocal_46 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_43 = 5;
					}
				...
				case 4:
					...
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
						if (GAMEPLAY::CREATE_INCIDENT_WITH_ENTITY(3, PLAYER::PLAYER_PED_ID(), 4, 3f, &uLocal_47, 0, 0))
						{
							iLocal_46 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_43 = 5;
						}
					}
					else if (GAMEPLAY::CREATE_INCIDENT(3, vLocal_45, 4, 3f, &uLocal_47, 0, 0))
					{
						if (Global_89824.f_358 == GAMEPLAY::GET_HASH_KEY("AGENCY_PREP_1") || (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY("agency_prep1")) > 0 && func_3(0)))
						{
				...
				case 5:
					if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_46 + 60000) || !GAMEPLAY::IS_INCIDENT_VALID(uLocal_47))
					{
						func_1();
					}
					else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						...
						{
							if (GAMEPLAY::IS_INCIDENT_VALID(uLocal_47))
							{
								GAMEPLAY::DELETE_INCIDENT(uLocal_47);
							}
						}
					}
					break;
...
void func_8()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_46 + 30000)
	{
		iLocal_43 = 5;
	}
}
	...
	while (iVar13 < 2)
	{
		switch (iVar13)
		{
			case 0:
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), -3044.66f, 596.43f, 6.58f, true) < 25f)
				{
				...
				fVar8 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar6.x, vVar6.y);
				fVar9 = (fVar10 + 180f);
				if (fVar9 > 360f)
				{
					fVar9 = (fVar9 - 360f);
				...
				else
				{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 294f, -895f, 28f, true) < 25f || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), -713.01f, -819.64f, 22.63f, true) < 25f)
					{
						fVar11 = (fVar11 + 5f);
					}
					else
				...
				*uParam1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam1, *uParam2, fVar11, 0f, 0f) };
				iVar14 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(*uParam1 + FtoV((uParam1->f_2 + 4.5f)), *uParam1 + Vector(4.5f, 0.5f, 0.5f), 2.5f, 1, 0, 4);
				iVar13++;
				break;
			...
			case 1:
				if (iVar0 <= 2)
				{
					if (WORLDPROBE::GET_SHAPE_TEST_RESULT(iVar14, &iVar15, &vVar17, &uVar16, &uVar18) == 2)
					{
						if (iVar15 != 0)
						{
