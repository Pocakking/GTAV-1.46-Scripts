...
void __EntryFunction__()
{
	...
	sLocal_96 = "";
	GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(190.2424f, -956.379f, 28.63f, 6f, 0);
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_GRT", 0);
		func_567(Local_94.f_9, 0, 0, 0, 0, 0);
		iLocal_118 = 0;
		iLocal_513 = 0;
		fLocal_297 = (fLocal_297 + GAMEPLAY::GET_FRAME_TIME());
		func_566();
		...
		if (func_31())
		{
			...
			{
				AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_248, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(GAMEPLAY::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
			func_26();
			func_1();
		}
...
void func_1()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_309)
	{
		return;
	}
	if (!bLocal_306)
	...
	{
		iLocal_309 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
		if ((iLocal_308 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_308 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
bool func_25(char* sParam0, int iParam1, char* sParam2)
{
...
void func_26()
{
	if (bLocal_114)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_111[0 /*3*/], Local_111[1 /*3*/], Local_111.f_7, 0, 1, 0))
		{
			...
			func_29(&uLocal_116);
			uLocal_116 = func_28(vLocal_105, 5, 1);
			iLocal_115 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			bLocal_114 = false;
		}
	}
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_115)
		{
		}
		func_27("B2_FAIL2");
	}
...
int func_28(vector3 vParam0, int iParam1, int iParam2)
{
	...
	UI::SET_BLIP_PRIORITY(iVar0, iParam1);
	UI::SET_BLIP_SCALE(iVar0, 1f);
	UI::SET_BLIP_ROUTE(iVar0, iParam2);
	return iVar0;
}
...
void func_32(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_96))
			{
				func_624(1);
			}
			else
		...
		case 2:
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_96, "B2_FAIL2"))
			{
...
int func_33(int iParam0)
{
	...
	switch (iLocal_98)
	{
		...
		case 1:
			...
			{
				CAM::SET_CAM_ACTIVE(iVar2, 1);
			}
			iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 6000;
			func_19(&uLocal_335, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_98 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_2(&uLocal_335, "BARY2AU", "BARY2_PREOUT", 8, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_95)
				{
					if (GAMEPLAY::GET_GAME_TIMER() < iLocal_95)
					{
					}
					iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 5000;
					bVar1 = true;
				}
			}
			else
			{
				iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				bVar1 = true;
			}
			if (bVar1 == 1)
			{
		...
		case 3:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_43();
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_245, 0, 0);
					iLocal_95 = GAMEPLAY::GET_GAME_TIMER() + 3500;
					bVar1 = true;
				}
			}
			else
		...
		case 4:
			if (iParam0 == 1)
			{
				bVar1 = GAMEPLAY::GET_GAME_TIMER() > iLocal_95;
			}
			else
			{
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_95)
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_95)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_107, 200f, 0, 0, 0, 0, false, 0);
	...
	while (func_40(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_40(iVar2, iVar6)))
			{
				...
				{
					uVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_40(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	}
	uVar1 = WEAPON::CREATE_WEAPON_OBJECT(iVar2, iVar3, vVar5, iVar0, 1065353216, uVar7, iParam7, iParam8);
	while (func_40(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_40(iVar2, iVar6)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_40(iVar2, iVar6));
				func_37(uVar1, func_40(iVar2, iVar6));
			}
		}
		iVar6++;
	}
...
void func_43()
{
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_243))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_243);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_244))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_244);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_245))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_245);
	}
}
...
void func_47(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_52(PLAYER::PLAYER_ID())) && !func_49(PLAYER::PLAYER_ID(), 0)) && !func_48()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_52(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
{
	func_60(&(Global_99633.f_2875), vParam0, fParam1);
}
...
{
	if (func_62(Global_71445, 0f, 0f, 0f, 0))
	{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_250)
		{
			if (func_72(&(Local_250[iVar0 /*19*/])))
			{
				...
				AI::TASK_SMART_FLEE_COORD(Local_250[iVar0 /*19*/].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_302(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_296();
				iLocal_249 = 0;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_107, 250f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_107, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_107, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_107, 500f);
		...
		case 2:
			...
			else
			{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
				{
					...
					PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 750, 0f, 1, 0);
					iLocal_249 = 1;
				}
...
void func_77(int iParam0, bool bParam1)
{
	...
	{
		func_237(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_94(var uParam0)
{
	...
	*uParam0 = 145;
	...
	func_98(&(uParam0->f_2869));
	func_96(&(uParam0->f_2875));
	func_95(&(uParam0->f_2965));
}
...
int func_104(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_155(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_155(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_147(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_147(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_105(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_219(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_155(iVar10, iParam1, iParam2, -1) };
		if (!func_145(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_155(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_155(iVar10, 14, uVar12[iVar1], -1) };
							func_123(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_138(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_147(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_138(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_155(iVar10, iVar0, func_113(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_155(iVar10, 14, uVar15[iVar1], -1) };
			func_123(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_138(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_147(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_155(iParam0, iParam1, iParam2, -1) };
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_124(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_147(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_147(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_138(int iParam0)
{
	...
	{
		func_144(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_141(iParam2)];
	if (iVar0 != 0)
	{
...
int func_142(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_141(iParam1)];
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_219(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_154(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_154(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_154(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_157(int iParam0)
{
	...
	func_158(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_142(func_161(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_142(func_160(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_142(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_158(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_158(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_158(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_158(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_147(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_219(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_219(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_219(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_155(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_219(iParam0, 14, iVar4))
										{
											if (!func_111(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_155(iVar0, iVar2, iVar1, -1) };
						if (!func_111(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_147(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_147(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_226(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar1, {func_223(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar1, 0, Global_93269, 0);
		func_227(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_232()
{
	...
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_233(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_242(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_241();
...
void func_269(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_270(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			UI::_0x72C1056D678BB7D8(Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0]);
			if (bParam2)
			{
				if (iVar1 == Global_106070.f_2355.f_539.f_1748 || (Global_106070.f_2355.f_539.f_1748 == -1 && iVar1 == 4))
				{
					if (Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0] != 0 && Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0] != joaat("weapon_molotov"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0], 0))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_106070.f_2355.f_539.f_1715[iVar1 /*4*/][iVar0], 1);
						}
					}
				}
			}
...
void func_270(int iParam0, var uParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			iVar15 = DLC1::GET_NUM_DLC_WEAPONS();
			iVar8 = 0;
			while (iVar8 < iVar15)
			{
				if (iVar8 < 50)
				{
					if (DLC1::GET_DLC_WEAPON_DATA(iVar8, &Var9))
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_275(Var9.f_1))
						{
							if (iVar7 == 0)
							{
			...
			if (iVar1 != 0 && iVar1 != 1993361168)
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						while (iVar4 != 0)
						{
							if (GAMEPLAY::IS_BIT_SET((uParam1[iVar5 /*5*/])->f_2, iVar6))
							{
								if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, iVar4))
								{
									...
									if (func_273(iVar4))
									{
										unk_0x9FE5633880ECD8ED(iParam0, iVar3, iVar4, (uParam1[iVar5 /*5*/])->f_4);
		...
		while (iVar11 < uParam1->f_221)
		{
			...
			if ((iVar8 != -1 && iVar8 < 50) && !func_275(Var9.f_1))
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var9) || func_275(Var9.f_1))
				{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						iVar12 = 0;
						iVar6 = 0;
						while (iVar6 < DLC1::GET_NUM_DLC_WEAPON_COMPONENTS(iVar8))
						{
							if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var10))
							{
								if (!func_41(Var10.f_3))
								{
									if (GAMEPLAY::IS_BIT_SET(uParam1->f_221[iVar11 /*5*/].f_2, iVar12))
									{
										if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var10.f_3))
										{
											...
											{
												unk_0x9FE5633880ECD8ED(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
...
void func_272(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
bool func_276(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_hatchet"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_277() && !Global_262145.f_19620)
				{
					return 0;
				}
			}
	...
	while (iVar0 < DLC1::GET_NUM_DLC_WEAPONS())
	{
		if (DLC1::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var1) || func_275(Var1.f_1))
				{
					return 0;
				}
			}
...
void func_281(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		Global_106070.f_2355.f_539.f_294[iVar0] = uParam0->f_17[iVar0];
		iVar1 = 0;
		while (iVar1 < 44)
		{
			Global_106070.f_2355.f_539.f_298[iVar0 /*472*/][iVar1 /*5*/] = { uParam0->f_812[iVar0 /*472*/][iVar1 /*5*/] };
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 50)
		{
			Global_106070.f_2355.f_539.f_298[iVar0 /*472*/].f_221[iVar1 /*5*/] = { uParam0->f_812[iVar0 /*472*/].f_221[iVar1 /*5*/] };
			iVar1++;
		}
		iVar0++;
	}
...
void func_282(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			case 0:
				STATS::STAT_SET_INT(joaat("sp0_weap_purch_0"), uParam0->f_2229[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_purch_1"), uParam0->f_2229[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_5"), uParam0->f_2229[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_6"), uParam0->f_2229[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_7"), uParam0->f_2229[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_8"), uParam0->f_2229[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_9"), uParam0->f_2229[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_10"), uParam0->f_2229[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_11"), uParam0->f_2229[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 1:
				STATS::STAT_SET_INT(joaat("sp1_weap_purch_0"), uParam0->f_2229[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_purch_1"), uParam0->f_2229[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_5"), uParam0->f_2229[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_6"), uParam0->f_2229[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_7"), uParam0->f_2229[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_8"), uParam0->f_2229[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_9"), uParam0->f_2229[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_10"), uParam0->f_2229[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_11"), uParam0->f_2229[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 2:
				STATS::STAT_SET_INT(joaat("sp2_weap_purch_0"), uParam0->f_2229[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_purch_1"), uParam0->f_2229[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_0"), uParam0->f_2229[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_1"), uParam0->f_2229[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_2"), uParam0->f_2229[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_3"), uParam0->f_2229[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_4"), uParam0->f_2229[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_5"), uParam0->f_2229[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_6"), uParam0->f_2229[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_7"), uParam0->f_2229[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_8"), uParam0->f_2229[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_9"), uParam0->f_2229[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_10"), uParam0->f_2229[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_11"), uParam0->f_2229[iVar0 /*32*/].f_16[11], 1);
				break;
		}
		iVar0++;
	}
...
void func_293(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_294(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_297()
{
	...
	{
		CAM::SET_CAM_ACTIVE(iLocal_510, 0);
...
void func_299(var uParam0)
{
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(uParam0->f_3, 0, 0f);
...
void func_311(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_376(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_313(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_313(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_9();
	...
	if (iParam4 == 1)
	{
		func_315(&(uParam0->f_2875), uParam0, iParam5, 1, 1, 0);
	}
	func_314(&(uParam0->f_2965));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_325(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_332(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_141(iParam1)];
...
void func_336(int iParam0, bool bParam1)
{
	...
	if (func_11(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_337(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_337(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_275(Var7.f_1)) && iVar9 < 50)
			{
...
int func_344(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_81() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_142(func_345(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_347(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_363(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_348(iVar0, 0), 1);
...
Vector3 func_348(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_359(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_358())
			{
				if (func_357(Global_1589591))
				{
					return func_350(2, 2);
				}
				else if (func_349(Global_1589591))
				{
...
var func_365()
{
	...
	func_375(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_374(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_373(&uVar0, TIME::GET_CLOCK_HOURS());
	func_368(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_367(&uVar0, TIME::GET_CLOCK_MONTH());
	func_366(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_371(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_377(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_378(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_378(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_378(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_378(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_378(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_382(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
	
	uVar0 = STREAMING::FORMAT_FOCUS_HEADING(vParam0, fParam1, iParam2, 127);
	...
	if (!*bParam0)
	{
		if (iLocal_289 == 1)
		{
			...
			if (iVar0 != -1)
			{
				...
				Local_250[iVar0 /*19*/].f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_304, (iLocal_304 + iLocal_303)));
...
void func_387(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1)
	{
		...
		else
		{
			...
			PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_PED(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(20f, 40f), 0);
		}
...
float func_394(var uParam0)
{
	if (func_397(uParam0))
	{
		...
		{
			return (func_395(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_395(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_402(var uParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	if (iLocal_97 != 9)
	{
		if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vParam1, &uVar1, 0, 0))
		{
			vParam1.z = uVar1;
		}
		if (vParam1.z < 28f)
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(uParam0->f_3, 1, 0f);
	...
	*uParam0 = 1;
	...
	PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_PED(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(12f, 50f), 0);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_3, 1);
	...
	uParam0->f_12 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(125, 1000));
	func_403(uParam0->f_3, &uLocal_256, 0);
	StringCopy(&(uParam0->f_7), "clown_idle_", 16);
	StringIntConCat(&(uParam0->f_7), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
	AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -2f, -1, 0, 0f, 0, 0, 0);
	uParam0->f_13 = GAMEPLAY::GET_GAME_TIMER() + 30000;
	iLocal_284++;
	return 1;
}
...
void func_403(int iParam0, var uParam1, bool bParam2)
{
	...
	PED::SET_PED_SHOOT_RATE(iParam0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(uParam1->f_16, uParam1->f_17));
	PED::SET_PED_FIRING_PATTERN(iParam0, *uParam1);
	PED::SET_COMBAT_FLOAT(iParam0, 3, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_12, uParam1->f_13));
	PED::SET_COMBAT_FLOAT(iParam0, 4, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_10, uParam1->f_11));
	PED::SET_COMBAT_FLOAT(iParam0, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_14, uParam1->f_15));
	if (bParam2)
	{
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 13, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_20);
	PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 42, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_8);
	PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 11, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_9);
	if (uParam1->f_19 != -1)
	{
		iVar0 = uParam1->f_19;
	}
...
void func_411(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_398(&iLocal_531);
			fLocal_534 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
			*iParam0 = 2;
			break;
		...
		case 2:
			if (!iLocal_503)
			{
				...
				{
					func_412(2, 5, 5, 0);
					fLocal_534 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(20f, 30f);
					func_398(&iLocal_531);
				}
			}
			if (iLocal_284 >= 5)
...
void func_412(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iParam1, iParam2);
...
int func_414(int iParam0)
{
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_522[iParam0 /*11*/].f_2, &uVar0, 0, 0))
	{
	...
	AUDIO::STOP_PED_SPEAKING(Local_522[iParam0 /*11*/], 1);
	PED::SET_PED_DIES_WHEN_INJURED(Local_522[iParam0 /*11*/], 1);
...
int func_418(int iParam0, var uParam1, bool bParam2)
{
	...
	{
		*uParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar1);
		return 1;
	}
	return 0;
}
...
int func_423(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam1, 5f, 0, 0, 0, 0, false, 0);
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vParam1 + Vector(0.23f, 0f, 0f), &fVar0, 0, 0))
	{
		vParam1.z = fVar0;
	}
	...
	*uParam0 = 1;
	uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + iParam4);
	uParam0->f_7 = 0;
	uParam0->f_2 = 1;
	uParam0->f_10 = 0;
...
void func_425(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_289 > 1)
			{
				if (func_422(&iLocal_531, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_412(1, 5, 5, 0);
				}
			}
...
{
	func_19(&uLocal_335, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	iLocal_309 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 30000);
	iLocal_308 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000);
	bLocal_306 = false;
}
...
void func_434()
{
	iLocal_34 = GAMEPLAY::GET_GAME_TIMER();
}
...
int func_447()
{
	...
	if (!iLocal_509)
	{
		if (iLocal_523 == 9 && GAMEPLAY::GET_GAME_TIMER() > iLocal_307)
		{
			func_19(&uLocal_335, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	...
	switch (iLocal_523)
	{
		...
		case 8:
			...
			{
				iLocal_307 = GAMEPLAY::GET_GAME_TIMER() + 1500;
				iLocal_523 = 9;
			}
			break;
...
int func_448(var uParam0)
{
	...
	if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 780511057) > 1)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_303, iLocal_304));
			uParam0->f_2 = 12;
			AI::TASK_COMBAT_PED(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 134217728, 16);
			return 1;
		}
	}
	else
...
void func_449()
{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_255, 0))
		{
			WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_255, -1, 1, 1);
		}
		else if (!WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1) || iVar0 != iLocal_255)
		{
			WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_255, 1);
		}
...
int func_450(var uParam0)
{
	...
	if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 1630799643) > 1)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_303, iLocal_304));
			AI::TASK_AIM_GUN_AT_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), -1, 1);
			return 1;
		}
	}
	else
...
int func_454(var uParam0, char* sParam1, float fParam2)
{
	if (uParam0->f_2 == 0)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, sParam1, 3))
		{
			...
			AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, fParam2, 0, 0, 0);
		}
		else
		{
			return 1;
...
bool func_456(var uParam0)
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_116 || uParam0->f_116 == 0)
	{
		...
		uParam0->f_116 = GAMEPLAY::GET_GAME_TIMER() + 32;
	}
	iVar0 = 0;
	while (iVar0 < *uParam0)
	{
...
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
	}
	...
	if (!GAMEPLAY::IS_BIT_SET(uParam0->f_113, iParam1))
	{
		return 0;
	}
	if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iParam1 /*7*/])->f_6)
	{
		uParam0->f_117 = 1;
		return 1;
	}
	switch ((*uParam0)[iParam1 /*7*/])
	{
		...
		case 8:
			if (!UI::HAS_ADDITIONAL_TEXT_LOADED((uParam0[iParam1 /*7*/])->f_5))
			{
				return 0;
			}
			break;
		...
		case 11:
			if (!AI::GET_IS_WAYPOINT_RECORDING_LOADED((uParam0[iParam1 /*7*/])->f_3))
			{
				return 0;
			}
			break;
	...
	GAMEPLAY::SET_BIT(&(uParam0->f_114), iParam1);
	switch ((*uParam0)[iParam1 /*7*/])
	{
		case 6:
			break;
...
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_113, iParam1) || GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
	}
	switch ((*uParam0)[iParam1 /*7*/])
	{
		...
		case 8:
			UI::REQUEST_ADDITIONAL_TEXT((uParam0[iParam1 /*7*/])->f_3, (uParam0[iParam1 /*7*/])->f_5);
			break;
		...
		case 11:
			AI::REQUEST_WAYPOINT_RECORDING((uParam0[iParam1 /*7*/])->f_3);
			break;
	...
	uParam0->f_117 = 0;
	(uParam0[iParam1 /*7*/])->f_6 = GAMEPLAY::GET_GAME_TIMER() + 10000;
	GAMEPLAY::SET_BIT(&(uParam0->f_113), iParam1);
	return 1;
}
...
void func_466(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (!CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				GAMEPLAY::SET_TIME_SCALE(fLocal_109);
			...
			else
			{
				...
				if (iLocal_119 == 0)
				{
					if (iVar0 >= 54000)
					{
						...
						GRAPHICS::_START_SCREEN_EFFECT(sVar1, 0, 1);
						AUDIO::TRIGGER_MUSIC_EVENT("RC18B_START");
					}
				}
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					if (CAM::DOES_CAM_EXIST(iLocal_510))
					{
						CAM::SET_CAM_ACTIVE(iLocal_510, 1);
		...
		case 3:
			...
			if (iLocal_119 == 0)
			{
				...
				if (!GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_244))
				{
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_244, 0, 1);
				}
			}
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			if (CAM::DOES_CAM_EXIST(iLocal_510))
...
int func_475(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_113, iParam1) || GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
	...
	switch (iParam2)
	{
		...
		case 11:
			AI::REQUEST_WAYPOINT_RECORDING(sParam3);
			break;
...
{
	return func_479(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
...
void func_481(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_507(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_504(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_482(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_483(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_499(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_365();
			}
...
void func_484(int iParam0, int iParam1)
{
	...
	func_324(iParam0, &(Global_106070.f_32605.f_5510));
}
...
void func_500(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_499(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_502(iParam0);
			func_501(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_515(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_44(PLAYER::PLAYER_PED_ID()))
	{
		if (iParam2 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0);
		}
		if (iParam3 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0, 0, 0, 0, false, 0);
		}
	}
}
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_56(Local_94.f_28[0]))
			{
				...
				if (func_56(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_94.f_28[0], -1, 0, 2);
				}
			}
			break;
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_247) && !func_23())
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_247, "lead_in", 8f, -4f, -1, 2, 0f, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(Local_94.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_298 = GAMEPLAY::GET_GAME_TIMER() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_56(Local_94.f_28[0]))
			{
				if (!func_23() || GAMEPLAY::GET_GAME_TIMER() > iLocal_298)
				{
					if (func_56(PLAYER::PLAYER_PED_ID()))
					{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 189.1399f, -955.8049f, 29.09192f, 187.5274f, -955.0106f, 31.09192f, 2.5f, 0, 1, 0))
			{
				...
				if (func_56(Local_94.f_28[0]))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_94.f_28[0], 0);
				}
			}
		}
	}
...
void func_523()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_277)
	{
		return;
	}
	if (!func_408(&iVar0))
	...
	if (func_402(&(Local_250[iVar0 /*19*/]), vVar1, 0, 0, 0))
	{
		if (iLocal_97 == 9)
		{
			iLocal_277 = GAMEPLAY::GET_GAME_TIMER() + 25;
			iLocal_535++;
		}
		else
		{
			iLocal_277 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_278, iLocal_279));
		}
	}
}
...
int func_524(var uParam0)
{
	...
	if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar0, &uVar1, 0, 0))
	{
		return 0;
	}
	vVar0.z = uVar1;
	if (iLocal_97 != 9)
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_105, 1) > fLocal_106)
		{
			return 0;
		}
	}
...
{
	return GAMEPLAY::IS_POSITION_OCCUPIED(vParam0, fParam1, 0, 0, 1, 0, 0, iParam2, iParam3);
}

float func_526(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
Vector3 func_527(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_528(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
int func_530(var uParam0)
{
	...
	if (uParam0->f_9 == 0)
	{
		...
		{
			uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + iVar4);
			uParam0->f_9 = 1;
		}
	}
	if (bLocal_117)
	...
	switch (uParam0->f_2)
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() >= uParam0->f_6)
			{
				...
				if (uParam0->f_7 == 0)
				{
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(uParam0->f_3, "BARRY_02_VEHICLE_SETTING", 0);
					uParam0->f_7 = 1;
				}
		...
		case 2:
			uParam0->f_5 = (uParam0->f_5 + (GAMEPLAY::GET_FRAME_TIME() * 1024f));
			if (uParam0->f_5 > 255f)
			{
				uParam0->f_5 = 255f;
			}
			...
			if (GAMEPLAY::GET_GAME_TIMER() >= uParam0->f_6 || uParam0->f_5 >= 255f)
			{
				ENTITY::SET_ENTITY_VISIBLE(uParam0->f_3, true, 0);
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(uParam0->f_3, 1, 1, 0);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(uParam0->f_3, fLocal_305);
				uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_280, iLocal_281));
				if (uParam0->f_13 != 0)
				{
					uParam0->f_2 = 10;
				}
		...
		case 10:
			...
			if (func_408(&iVar0))
			{
				...
				if (func_535(&(Local_250[uParam0->f_14 /*19*/]), uParam0->f_3, 1))
				{
					...
					AI::CLEAR_PED_TASKS(Local_250[uParam0->f_14 /*19*/].f_3);
					AI::OPEN_SEQUENCE_TASK(&uVar2);
					AI::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 32, uParam0->f_11);
					if (uParam0->f_13 == 1)
					{
						AI::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 5, uParam0->f_12);
					}
					else if (uParam0->f_13 == -1)
					{
						AI::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 4, uParam0->f_12);
					}
					AI::CLOSE_SEQUENCE_TASK(uVar2);
					AI::TASK_PERFORM_SEQUENCE(Local_250[uParam0->f_14 /*19*/].f_3, uVar2);
		...
		case 11:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(Local_250[uParam0->f_14 /*19*/].f_3, 242628503) == 7)
				{
					AI::OPEN_SEQUENCE_TASK(&uVar5);
					AI::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 0);
					AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					AI::CLOSE_SEQUENCE_TASK(uVar5);
					AI::TASK_PERFORM_SEQUENCE(Local_250[uParam0->f_14 /*19*/].f_3, uVar5);
			...
			{
				AI::TASK_EVERYONE_LEAVE_VEHICLE(uParam0->f_3);
				uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + iVar4);
				uParam0->f_2 = 12;
			}
			break;
		...
		case 12:
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_302 && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_3))
				{
			...
			if (func_408(&iVar0))
			{
				if (func_535(&(Local_250[iVar0 /*19*/]), uParam0->f_3, 0))
				{
					...
					vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_3, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-6.5f, -10f), -0.7f) };
					AI::OPEN_SEQUENCE_TASK(&uVar7);
					AI::TASK_SWAP_WEAPON(0, 1);
					AI::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 256);
					AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar6, PLAYER::PLAYER_PED_ID(), 1f, 1, 1.5f, 2f, 1, 0, 0, -957453492, 20000);
					AI::CLOSE_SEQUENCE_TASK(uVar7);
					AI::TASK_PERFORM_SEQUENCE(Local_250[iVar0 /*19*/].f_3, uVar7);
					AI::CLEAR_SEQUENCE_TASK(&uVar7);
					if (uParam0->f_9 == 0)
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_280 * 4, iLocal_281 * 4));
					}
					else
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_280 + 500, iLocal_281));
					}
					if (uParam0->f_10 > 5)
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_280 * 4, iLocal_281 * 4));
					...
					if (!iLocal_529)
					{
						iLocal_302 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_281 + 500);
						iLocal_529 = 1;
					}
				}
			}
		...
		case 15:
			...
			uParam0->f_2 = 16;
			uParam0->f_6 = GAMEPLAY::GET_GAME_TIMER() + 1500;
			uParam0->f_5 = 255f;
			if (!bLocal_301)
			{
				if (iLocal_529)
		...
		case 16:
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_6)
			{
				...
				uParam0->f_6 = GAMEPLAY::GET_GAME_TIMER() + 400;
				uParam0->f_2 = 17;
			}
			break;
		...
		case 17:
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_6)
			{
				uParam0->f_5 = (uParam0->f_5 - (GAMEPLAY::GET_FRAME_TIME() * 512f));
				if (uParam0->f_5 < 0f)
				{
					uParam0->f_5 = 0f;
				}
				...
				if (uParam0->f_5 <= 0f)
				{
					...
					UNK1::_0x293220DA1B46CEBC(4f, 2f, 3);
					func_461(uParam0);
					return 0;
				}
			}
...
int func_535(var uParam0, int iParam1, int iParam2)
{
	...
	*uParam0 = 1;
	...
	uParam0->f_2 = 0;
	func_405(uParam0, 0);
	uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(SYSTEM::ROUND((IntToFloat(iLocal_303) * 1.5f)), iLocal_304));
	PED::SET_PED_CAN_COWER_IN_COVER(uParam0->f_3, 0);
	PED::SET_PED_CAN_PEEK_IN_COVER(uParam0->f_3, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 1, false);
	PED::SET_PED_AS_ENEMY(uParam0->f_3, 1);
	...
	uParam0->f_13 = (GAMEPLAY::GET_GAME_TIMER() + (30000 + SYSTEM::ROUND((30000f * 0.5f))));
	iLocal_284++;
	return 1;
}
...
float func_540(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_545(var uParam0)
{
	...
	if (!func_556(uParam0))
	{
		if ((ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0) || PED::IS_PED_INJURED(uParam0->f_3)) || PED::IS_PED_DEAD_OR_DYING(uParam0->f_3, 0))
		{
			...
			uParam0->f_2 = 15;
			uParam0->f_12 = (GAMEPLAY::GET_GAME_TIMER() + iVar2);
			func_69(&(uParam0->f_5));
	...
	switch (uParam0->f_2)
	{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_12)
			{
				ENTITY::SET_ENTITY_VISIBLE(uParam0->f_3, true, 0);
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_3, false);
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_3, 0);
		...
		case 3:
			...
			uParam0->f_12 = GAMEPLAY::GET_GAME_TIMER() + 125;
			uParam0->f_2 = 4;
			break;
		...
		case 12:
			...
			if (func_554(uParam0) == 4 && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) <= 1)
			{
				return;
			}
			...
			if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 780511057) > 1)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_13)
				{
			...
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_11)
			{
				...
				{
					uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_303, (iLocal_304 / 2)));
				}
			}
			vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1) };
			if (vVar0.z < 27.7f)
		...
		case 9:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(&(uParam0->f_7), sLocal_520))
			{
				sVar3 = sLocal_519;
				fVar4 = 0.802f;
				fVar5 = 0.815f;
		...
		case 14:
			uParam0->f_6 = (uParam0->f_6 + (GAMEPLAY::GET_FRAME_TIME() * 512f));
			if (uParam0->f_6 < 2f)
			{
				ENTITY::SET_ENTITY_VISIBLE(uParam0->f_3, false, 0);
			}
			...
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_12)
			{
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0) || PED::IS_PED_INJURED(uParam0->f_3))
				{
					...
					if (!ENTITY::IS_ENTITY_IN_AIR(uParam0->f_3))
					{
						...
						if (iLocal_97 == 9)
						{
							uParam0->f_12 = GAMEPLAY::GET_GAME_TIMER() + 100;
						}
						else
						{
							uParam0->f_12 = GAMEPLAY::GET_GAME_TIMER() + 500;
						}
						uParam0->f_6 = 255f;
						func_29(&(uParam0->f_4));
					}
...
void func_548(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 0)
	{
		...
		AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_519, &(uParam0->f_7), 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
	}
	else
	{
		StringCopy(&(uParam0->f_7), "clown_idle_", 16);
		StringIntConCat(&(uParam0->f_7), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
		AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, 0f, 0, 0, 0);
	}
}
...
void func_549(var uParam0)
{
	...
	if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1)
	{
		AI::OPEN_SEQUENCE_TASK(&uVar0);
		if (func_540(uParam0->f_3, uParam0->f_15, 0) <= 5f)
		{
			AI::TASK_AIM_GUN_AT_ENTITY(0, uParam0->f_15, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500), 0);
			AI::TASK_SHOOT_AT_ENTITY(0, uParam0->f_15, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500), -957453492);
		}
		AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, uParam0->f_15, uParam0->f_15, 2f, 1, 3f, 4.5f, 1, 0, -957453492);
		AI::TASK_COMBAT_PED(0, uParam0->f_15, 67108864, 16);
...
void func_553()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_308)
	{
		return;
	}
	if (!bLocal_306)
	...
	{
		iLocal_308 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000));
		if ((iLocal_309 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_309 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
void func_558(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Local_522[iParam0 /*11*/], 0) || PED::IS_PED_DEAD_OR_DYING(Local_522[iParam0 /*11*/], 1))
	{
		if (Local_522[iParam0 /*11*/].f_6 < 5)
		{
			...
			func_69(&iLocal_514);
			Local_522[iParam0 /*11*/].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
	...
	{
		case 0:
			Local_522[iParam0 /*11*/].f_9 = (Local_522[iParam0 /*11*/].f_9 + (GAMEPLAY::GET_FRAME_TIME() * 512f));
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID()))
			{
				if (func_56(Local_522[iParam0 /*11*/]))
				{
					...
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_522[iParam0 /*11*/], vVar0), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::CLEAR_PED_TASKS(Local_522[iParam0 /*11*/]);
					AI::TASK_PERFORM_SEQUENCE(Local_522[iParam0 /*11*/], uVar1);
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_522[iParam0 /*11*/].f_8)
			{
		...
		case 6:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_522[iParam0 /*11*/].f_8)
			{
				Local_522[iParam0 /*11*/].f_9 = (Local_522[iParam0 /*11*/].f_9 - (GAMEPLAY::GET_FRAME_TIME() * 1024f));
...
void func_559(int iParam0)
{
	if (Local_522[iParam0 /*11*/].f_1 == iLocal_511)
	{
		...
		{
			AI::TASK_PLAY_ANIM(Local_522[iParam0 /*11*/], sLocal_517, sLocal_518, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 3))
	{
		AI::TASK_PLAY_ANIM(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
	}
}
...
int func_560(int iParam0)
{
	...
	if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(vVar0, (5f - 1f), 1, 1))
	{
		return 1;
	}
	iVar1 = 0;
	while (iVar1 < Local_522)
	{
		if (iVar1 != iParam0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_522[iVar1 /*11*/]))
			{
				...
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, ENTITY::GET_ENTITY_COORDS(Local_522[iVar1 /*11*/], 0), 0) < 20f)
					{
						return 1;
					}
				}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_569(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_580(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_582(iParam0, Global_36117);
}
...
void func_588(int iParam0)
{
	...
	CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
	GRAPHICS::_START_SCREEN_EFFECT(sLocal_243, 0, 1);
}
...
int func_595(var uParam0)
{
	...
	switch (iLocal_80)
	{
		...
		case 2:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(189.5964f, -956.0344f, 29.09179f, 2f, 0);
		...
		case 3:
			if (func_56(uParam0->f_28[0]))
			{
				...
				AI::TASK_PLAY_ANIM(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0f, 0, 0, 0);
...
{
	if (!GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1) || (*uParam0)[iParam1 /*7*/] == 0)
	{
		return 1;
	}
	switch ((*uParam0)[iParam1 /*7*/])
	{
		...
		case 8:
			if (UI::HAS_ADDITIONAL_TEXT_LOADED((uParam0[iParam1 /*7*/])->f_5))
			{
				UI::CLEAR_ADDITIONAL_TEXT((uParam0[iParam1 /*7*/])->f_5, false);
			}
			break;
		...
		case 11:
			if (AI::GET_IS_WAYPOINT_RECORDING_LOADED((uParam0[iParam1 /*7*/])->f_3))
			{
				AI::REMOVE_WAYPOINT_RECORDING((uParam0[iParam1 /*7*/])->f_3);
			}
			break;
...
int func_627()
{
	...
	iVar0 = func_379(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_629()
{
	...
	{
		if (func_376(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
