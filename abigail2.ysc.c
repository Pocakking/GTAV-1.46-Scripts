	...
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else
			{
				...
				else if (((((iLocal_238 < 15 && !func_223()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_235) > 10000) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_210(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_229()
{
	if (func_456(iLocal_61))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_242) > 1000)
		{
...
int func_238(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_246() || func_245(Global_4456448.f_152990)) || func_244())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_242(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_239(int iParam0)
{
	if (iParam0 != func_241())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_240(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_260()
{
	if (!UI::DOES_BLIP_EXIST(iLocal_62) && func_456(iLocal_61))
	{
		iLocal_62 = func_261(iLocal_61, 1, 0, 5);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_62) && UI::GET_BLIP_COLOUR(iLocal_62) != 1)
	{
		UI::SET_BLIP_AS_FRIENDLY(iLocal_62, 0);
		UI::SET_BLIP_COLOUR(iLocal_62, 1);
	}
}
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_456(iLocal_61))
			{
				...
				if (func_3(iLocal_56))
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_62))
					{
						iLocal_62 = func_261(iLocal_61, 1, 0, 5);
					}
					func_289(&iLocal_62, "", "", &iLocal_63, &iLocal_64, 1, 0);
					AI::OPEN_SEQUENCE_TASK(&uLocal_236);
					if (!PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 0))
					{
						...
						AI::TASK_ENTER_VEHICLE(0, iLocal_56, 20000, -1, 1f, 1, 0);
					}
					AI::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_56, vLocal_239, 20f, 786469, 10f);
					AI::TASK_VEHICLE_PARK(0, iLocal_56, vLocal_239, 49.567f, 3, 1092616192, 0);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_56, 256);
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_236);
					AI::TASK_PERFORM_SEQUENCE(iLocal_61, uLocal_236);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(iLocal_61, 1193033728, 0);
				}
			}
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_231 == 0)
				{
					...
					if (((((iLocal_237 < 7 && !func_223()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_234) > 10000) && func_222(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_210(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_237++;
					}
	...
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *iParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*uParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_266(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_266(sParam2, 0, 0))
					{
...
void func_292()
{
	...
	if (func_456(iLocal_56))
	{
		...
		VEHICLE::_0x2B6747FAA9DB9D6B(iLocal_56, 1);
	}
}
			...
			switch (iLocal_241)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						}
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_456(iLocal_61))
							{
								AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_61);
...
void func_298(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_300() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_300() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_299(iParam0));
...
bool func_302(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_300() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_325(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_329(PLAYER::PLAYER_ID())) && !func_327(PLAYER::PLAYER_ID(), 0)) && !func_326()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_329(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_335(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_336(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_354()
{
	...
	if ((!func_223() && UI::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_55))
	{
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_363(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_374(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
int func_388(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	...
	if (func_159(iParam1))
	{
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, uParam3, 0, 0, 0);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_424(iVar0 + 1));
			}
			iVar0++;
		}
