		...
		if (!func_159(14))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					{
						func_115(0);
						iLocal_56 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_61);
					}
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_57)
					{
						...
						iLocal_57 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_62);
					}
				}
			}
...
void func_2()
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2524719.f_2212.f_18, 1))
		{
			func_126(41, 1);
		}
	}
...
bool func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return GAMEPLAY::IS_BIT_SET(iVar0, func_75(iVar1));
}
...
void func_87(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_88(Var7.f_1)) && iVar9 < 50)
			{
...
float func_91(var uParam0)
{
	if (func_94(uParam0))
	{
		...
		{
			return (func_92(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_105(var uParam0)
{
	...
	uParam0->f_80 = (uParam0->f_80 + GAMEPLAY::GET_FRAME_TIME());
	if (!func_104(uParam0))
	{
		return;
	}
...
int func_113()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || Global_71205)
	{
		return 0;
	}
...
int func_121()
{
	...
	while (iVar0 < 4)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24948.f_1, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_122()
{
	...
	while (iVar0 < 5)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24951.f_2, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_144(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return !GAMEPLAY::IS_BIT_SET(Global_84115[iParam0 /*34*/].f_15, 5);
			break;
...
void func_151(var uParam0)
{
	if (func_94(uParam0))
	{
		if (!func_93(uParam0))
		{
			uParam0->f_2 = (func_92(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
...
int func_155()
{
	...
	iVar0 = 0;
	iVar1 = func_157(2);
	if (func_156(iVar1, 0) || GAMEPLAY::IS_BIT_SET(Global_89178, 2))
	{
		iVar0++;
	}
	iVar1 = func_157(1);
	if (func_156(iVar1, 0) || GAMEPLAY::IS_BIT_SET(Global_89178, 1))
	{
		iVar0++;
	}
	iVar1 = func_157(0);
	if (func_156(iVar1, 0) || GAMEPLAY::IS_BIT_SET(Global_89178, 0))
	{
		iVar0++;
	}
	return iVar0;
...
{
	uParam0->f_1 = (func_92(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
