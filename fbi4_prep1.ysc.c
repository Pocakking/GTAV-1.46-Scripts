...
void func_1()
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_179))
			{
				func_33(sLocal_179);
			}
			else
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 30f, 1, 0, 0, false);
				func_369();
			}
			break;
	}
		...
		case 0:
			...
			else if (func_143(1, vLocal_185, 0))
			{
				...
				else if (((func_143(2, Local_199.f_1, Local_199.f_4) && func_143(3, Local_197.f_1, Local_197.f_4)) && func_143(4, Local_198.f_1, Local_198.f_4)) && func_135(0))
				{
					...
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), true);
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("s_m_y_garbage"), true);
					if (UI::GET_BLIP_FROM_ENTITY(Local_199) != 0)
					{
						iVar0 = UI::GET_BLIP_FROM_ENTITY(Local_199);
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(Local_45[0 /*11*/], 1, 0f);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(Local_45[1 /*11*/], 1, 0f);
...
void func_123()
{
	...
	{
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_45[0 /*11*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(1)), 1f, -1, 0.25f, 0, 40000f);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
void func_124(bool bParam0)
{
	if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_43, 0, 0))
	{
		...
		if (iLocal_48 != (iLocal_41 - 1))
		{
			if (iLocal_48 == 4)
			{
				AI::TASK_VEHICLE_GOTO_NAVMESH(Local_45[0 /*11*/], iLocal_43, Local_46[iLocal_48 /*25*/], 15f, 2883755, Local_46[iLocal_48 /*25*/].f_6);
			}
			else
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_45[0 /*11*/], iLocal_43, Local_46[iLocal_48 /*25*/], 15f, 0, 0, 2883755, Local_46[iLocal_48 /*25*/].f_6, Local_46[iLocal_48 /*25*/].f_7);
			}
		...
		{
			AI::TASK_VEHICLE_DRIVE_WANDER(Local_45[0 /*11*/], iLocal_43, 15f, 786599);
			Local_45[0 /*11*/].f_8 = Local_45[0 /*11*/].f_7;
...
int func_126()
{
	...
	if (func_36(iLocal_43))
	{
		...
		{
			fVar5 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, Local_46[iVar2 /*25*/], 1);
...
int func_129()
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, (iLocal_41 - 1));
...
int func_143(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_180, 0);
		...
		case 2:
			if (func_36(Global_89824[0]))
			{
				...
				if (func_36(Local_199))
				{
					...
					ENTITY::_SET_ENTITY_REGISTER(Local_199, 1);
					return 1;
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[1]))
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_89824.f_9[1], 1))
				{
					...
					if (func_335(Local_198))
					{
						...
						PED::SET_PED_FLEE_ATTRIBUTES(Local_198, 65536, 1);
...
void func_152(int iParam0)
{
	...
	{
		case 5:
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				if (func_178(*iParam0, 780511057))
				{
					AI::CLEAR_PED_TASKS(*iParam0);
				}
				AI::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 30f, -1, 0, 0);
				iParam0->f_6 = 6;
		...
		case 21:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				{
					AI::TASK_PUT_PED_DIRECTLY_INTO_MELEE(*iParam0, PLAYER::PLAYER_PED_ID(), 8f, -1f, 10f, 0);
				}
				else
				{
				...
				if (!UI::DOES_BLIP_EXIST(iParam0->f_4))
				{
		...
		case 3:
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				AI::TASK_USE_MOBILE_PHONE(*iParam0, 1, 1);
				AI::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 1);
				iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
				iParam0->f_6 = 4;
				iParam0->f_5 = 1;
			}
		...
		case 11:
			func_166(iParam0);
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				if (!func_178(*iParam0, 713668775))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_45[func_165(iParam0->f_10) /*11*/]))
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_54, 1f, -1, 2f, 0, 40000f);
					}
				}
				iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
				iParam0->f_6 = 23;
		...
		case 18:
			if (!func_178(*iParam0, -2017877118))
			{
				...
				{
					AI::TASK_TURN_PED_TO_FACE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 0);
				}
		...
		case 19:
			...
			if (!func_178(*iParam0, -2017877118))
			{
				AI::TASK_START_SCENARIO_IN_PLACE(*iParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				iParam0->f_5 = 1;
				iParam0->f_6 = 20;
				iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
			}
		...
		case 2:
			if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(*iParam0) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > 3000)
			{
				func_162(iParam0);
			}
			break;
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > 8000)
			{
				...
				AI::TASK_USE_MOBILE_PHONE(*iParam0, 0, 1);
				iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
				iParam0->f_6 = 8;
			}
		...
		case 6:
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_2)
			{
		...
		case 9:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_2 || !func_178(*iParam0, 2104565373))
			{
				func_157(iParam0);
			}
			break;
		...
		case 16:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_55) >= 9000)
			{
				if (!func_155(iParam0))
				{
					func_157(iParam0);
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_55) >= 5000 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_55) <= 5500)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(*iParam0, 0))
				{
					if (AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(*iParam0))
					{
						AI::CLEAR_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(*iParam0);
					}
				}
			}
			break;
		...
		case 20:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iParam0->f_1) >= 6000)
			{
		...
		case 3:
			if (!func_178(*iParam0, 242628503))
			{
				...
				if (!PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
				{
					if (iParam0->f_10 == 0)
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(1)), 1f, -1, 0.25f, 0, 40000f);
						iParam0->f_7 = 1;
					}
					else
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(0)), 1f, -1, 0.25f, 0, 40000f);
						iParam0->f_7 = 1;
					}
				}
			}
...
void func_158(var uParam0)
{
	if (!func_178(*uParam0, -71340211))
	{
		if (Local_46[iLocal_48 /*25*/].f_23 != 0)
		{
			if (func_10(Local_46[iLocal_48 /*25*/].f_17))
			{
				AI::TASK_GOTO_ENTITY_OFFSET(*uParam0, Local_46[iLocal_48 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, 0, func_159(Local_46[iLocal_48 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, true), 1));
		}
		if (func_36(iLocal_43))
		{
	...
	if (uParam0->f_7 == 9)
	{
		if (uParam0->f_9 >= 2)
		{
			if (!PED::IS_PED_INJURED(*uParam0))
			{
				...
				AI::TASK_PLAY_ANIM(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 8f, -8f, -1, 56, 0f, 0, 0, 0);
			}
		}
	}
}
	...
	switch (uParam0->f_9)
	{
		case 1:
			if (!func_178(*uParam0, -2015108952))
			{
				...
				{
					AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_46[iLocal_48 /*25*/].f_19, 0);
				}
				AI::TASK_PLAY_ANIM(0, "missfbi4prepp1", "_bag_pickup_garbage_man", 8f, -16f, -1, 528384, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar0);
		...
		case 2:
			...
			else if (!func_178(*uParam0, 713668775))
			{
				if (func_36(iLocal_43))
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -4.8f, 0f), 1f, -1, 0.25f, 0, ENTITY::GET_ENTITY_HEADING(iLocal_43));
				}
				uParam0->f_9 = 3;
			}
			PED::SET_PED_CAPSULE(*uParam0, 0.2f);
				...
				if (!func_185(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), iLocal_43, 1.9f, 1.9f, 8f))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						if (!func_178(*uParam0, 713668775))
						{
							...
							{
								AI::TASK_ACHIEVE_HEADING(0, ENTITY::GET_ENTITY_HEADING(iLocal_43), 0);
							}
							AI::TASK_PLAY_ANIM(0, "missfbi4prepp1", "_bag_throw_garbage_man", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(uVar1);
...
void func_187(var uParam0, int iParam1)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(uParam0->f_2, uParam0->f_5, 511, iParam1, 7);
			break;
		...
		case 4:
			*uParam0 = WORLDPROBE::START_SHAPE_TEST_BOX(uParam0->f_2, uParam0->f_8, uParam0->f_11, uParam0->f_14, 6, iParam1, 4);
			break;
...
void func_188(var uParam0)
{
	...
	{
		AI::OPEN_SEQUENCE_TASK(&uVar0);
		AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_43, Local_46[iLocal_48 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		AI::TASK_VEHICLE_PARK(0, iLocal_43, Local_46[iLocal_48 /*25*/].f_3, Local_46[iLocal_48 /*25*/].f_8, Local_46[iLocal_48 /*25*/].f_10, 5f, 1);
		AI::CLOSE_SEQUENCE_TASK(uVar0);
		AI::TASK_PERFORM_SEQUENCE(*uParam0, uVar0);
		AI::CLEAR_SEQUENCE_TASK(&uVar0);
		uParam0->f_7 = 6;
...
void func_190(var uParam0, bool bParam1)
{
	...
	else if (func_101(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(bParam1)), 5f))
	{
		...
		AI::TASK_ENTER_VEHICLE(*uParam0, iLocal_43, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
...
void func_196(int iParam0, int iParam1, int iParam2)
{
	if (iParam0->f_5 != 1 || iParam2)
	{
		...
		if (iParam0->f_10 == 0 && iParam0->f_7 == 4)
		{
			if (func_155(iParam0))
			{
				if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
				{
					AI::TASK_DRIVE_BY(*iParam0, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 10f, 100, 1, -957453492);
				...
				if (func_36(iLocal_43))
				{
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(*iParam0, iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
								iParam0->f_6 = 7;
								AI::TASK_COWER(Local_45[func_165(iParam1) /*11*/], -1);
								Local_45[func_165(iParam1) /*11*/].f_6 = 10;
								Local_45[func_165(iParam1) /*11*/].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
								Local_45[func_165(iParam1) /*11*/].f_1 = GAMEPLAY::GET_GAME_TIMER();
							}
							else
							{
								AI::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[func_165(iParam1) /*11*/], iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
	...
	if (iParam0->f_5 != 1)
	{
		if (func_335(Local_45[func_165(iParam1) /*11*/]))
		{
			...
			{
				func_163(iParam0);
				AI::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
				iParam0->f_1 = GAMEPLAY::GET_GAME_TIMER();
				iParam0->f_6 = 7;
				iParam0->f_5 = 1;
			}
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_109(func_76(), bParam7));
					}
					if (func_76() != 33)
					{
						func_211(iParam0);
			...
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, 1))
			{
				if (func_225(iVar2))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
					{
						...
						{
							AI::TASK_VEHICLE_DRIVE_TO_COORD(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), vLocal_186, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_223(iVar2))
				{
					if (func_36(Local_199))
					{
						if (!func_151(iVar2, Local_199, 17f, 1))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
							{
								AI::TASK_VEHICLE_MISSION(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_199, 3, 20f, 786468, 2f, 0.5f, 1);
							}
						}
					}
				}
...
void func_226(int iParam0)
{
	if (iLocal_68 > 1)
	{
		if (iLocal_70 > 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 0) && iLocal_71 == 1)
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_230(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						GAMEPLAY::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((GAMEPLAY::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 0) && !GAMEPLAY::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 1)) && iLocal_71 == 1)
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_230(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						GAMEPLAY::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), 1);
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, 5))
			{
				if (func_229(iLocal_200, vLocal_186, 1) < 15f && iLocal_71 == 1)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), 5);
						}
					}
				}
			}
...
{
	if (!GAMEPLAY::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, iParam1))
	{
		if (iLocal_375 != -1)
		{
			if (!UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), iParam1);
				}
			}
		}
...
{
	if ((GAMEPLAY::IS_BIT_SET(Local_73[0 /*8*/].f_7, iParam0) || GAMEPLAY::IS_BIT_SET(Local_73[1 /*8*/].f_7, iParam0)) || GAMEPLAY::IS_BIT_SET(Local_73[2 /*8*/].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_306(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
