...
void func_162()
{
	if (GAMEPLAY::IS_BIT_SET(iLocal_49, 0) && GAMEPLAY::IS_BIT_SET(iLocal_49, 1))
	{
...
void func_163()
{
	if ((GAMEPLAY::IS_BIT_SET(iLocal_49, 0) && Global_36117 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_49, 1))
			{
				if (!func_74(PLAYER::PLAYER_PED_ID(), vLocal_50, 5f))
				{
					if (GAMEPLAY::IS_BIT_SET(iLocal_49, 20) || func_129())
					{
						if ((func_236(PLAYER::PLAYER_PED_ID()) && !GAMEPLAY::IS_BIT_SET(uLocal_47[0], 17)) && !GAMEPLAY::IS_BIT_SET(uLocal_47[1], 18))
						{
							if (PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (GAMEPLAY::IS_BIT_SET(iLocal_49, 0))
								{
									...
									if (GAMEPLAY::IS_BIT_SET(iLocal_49, 20))
									{
										func_1(46, 0);
										GAMEPLAY::CLEAR_BIT(&iLocal_49, 20);
										iLocal_245 = -1;
									}
									vLocal_50 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
								}
					...
					{
						if ((PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !GAMEPLAY::IS_BIT_SET(iLocal_49, 20))
						{
							if (iLocal_245 != -1)
							{
								if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_245) > 1000)
								{
									GAMEPLAY::SET_BIT(&iLocal_49, 20);
								}
							}
							else
							{
...
int func_169(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_83(iParam0))
		{
			GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &vVar1, &vVar2);
			vVar1 = { vVar1 + Vector(-1f, -1f, -2f) };
			vVar2 = { vVar2 + Vector(1f, 1f, 2f) };
			if (!GAMEPLAY::IS_AREA_OCCUPIED(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar2), 0, 1, 0, 0, 0, iParam0, 0))
			{
				iVar0++;
			}
			else if (func_12())
...
int func_175(vector3 vParam0, bool bParam1)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam1 || GAMEPLAY::IS_BIT_SET(Global_106070.f_7201.f_17[iVar0], 0))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88466[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_179(vector3 vParam0, vector3 vParam1)
{
	...
	fVar0 = GAMEPLAY::ABSF((vParam0.z - vParam1.z));
	if (fVar0 <= 5f)
	{
		return 1;
	}
...
int func_184()
{
	...
	while (iVar0 <= (4 - 1))
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_68[iVar0 /*261*/].f_258, iVar1))
			{
...
int func_186(char* sParam0)
{
	...
	while (iVar0 <= 12)
	{
		if (!GAMEPLAY::IS_STRING_NULL(sLocal_69[iVar0]))
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_69[iVar0], sParam0))
			{
				return 1;
			}
		}
...
int func_188()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_88365[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_12())
		{
...
void func_195()
{
	...
	if ((Global_36117 == 15 && iLocal_38 == 0) && !func_194())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_49, 0))
			...
			else if (func_83(iLocal_51))
			{
				if (!func_18(PLAYER::PLAYER_PED_ID(), iLocal_51, 80f, 1))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(uLocal_47[func_5(5)]), 5);
						GAMEPLAY::SET_BIT(&iLocal_49, 8);
					}
					else
					{
...
void func_208()
{
	switch (iLocal_67)
	{
		case 0:
			if (GAMEPLAY::IS_BIT_SET(iLocal_49, 0))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_73) > 500)
				{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_68[iLocal_72 /*261*/].f_259) > 500)
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_70) && !GAMEPLAY::IS_STRING_NULL_OR_EMPTY(Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
				{
					if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_70, Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
					{
						GAMEPLAY::SET_BIT(&(Local_68[iLocal_72 /*261*/].f_258), iLocal_71);
					}
					else
					{
						GAMEPLAY::CLEAR_BIT(&(Local_68[iLocal_72 /*261*/].f_258), iLocal_71);
					}
				}
				else
				{
				...
				{
					iLocal_71 = 0;
					Local_68[iLocal_72 /*261*/].f_259 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_72++;
					if (iLocal_72 >= 4)
					{
						iLocal_72 = 0;
...
void func_209()
{
	...
	if (((((((Global_36117 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(iLocal_49, 5)) && !func_194()) && Global_71202 == -1) && !func_219()) && !func_82(9)) || func_101(35))
	{
		func_218();
		func_216();
		switch (iLocal_39)
	...
	else if (((((((Global_36117 != 15 || Global_36117 != 0) || Global_36117 != 2) || Global_36117 != 4) || Global_36117 != 17) || func_194()) || Global_71202 == -1) || Global_105125)
	{
		iVar1 = 0;
		if (func_128())
		{
...
void func_210(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_213(func_87())) && !func_212())
			{
...
int func_227()
{
	if (((((Global_36117 == 15 && !func_194()) && Global_71202 == -1) && !func_128()) && !func_228(1112014848)) && !Global_105125)
	{
		return 1;
	}
	return 0;
...
int func_232(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_94() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_233(func_235(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_233(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_234(iParam1)];
