...
void __EntryFunction__()
{
	...
	iLocal_43 = 64;
	fLocal_45 = -1f;
	iLocal_53 = UI::_0x4A9923385BDB9DAD();
	uLocal_54 = UI::_GET_BLIP_INFO_ID_ITERATOR();
								...
								switch (iLocal_57)
								{
									...
									case 9:
										if (!PED::IS_PED_INJURED(iLocal_71))
										{
											...
											{
												AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_71, vLocal_77, 1f, -1, 0.25f, 0, 40000f);
											}
											else
											{
												AI::TASK_WANDER_STANDARD(iLocal_71, 1193033728, 0);
											}
							...
							case 1:
								...
								else if (iLocal_58 == 3)
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_72))
									{
										...
										AI::TASK_SMART_FLEE_PED(iLocal_72, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								...
								if (!PED::IS_PED_INJURED(iLocal_71))
								{
									AI::CLEAR_PED_TASKS(iLocal_71);
									AI::TASK_SMART_FLEE_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(iLocal_71, true);
									func_53();
								}
								break;
		...
		if (iLocal_57 > 0 && iLocal_57 < 8)
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				else if (!PED::IS_PED_RAGDOLL(iLocal_71))
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_71);
						AI::TASK_SMART_FLEE_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
						func_53();
					}
				}
			}
...
void func_57()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_72) && !PED::IS_PED_INJURED(iLocal_71))
	{
		...
		{
			AI::CLEAR_PED_TASKS(iLocal_72);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_72, vLocal_77, 1f, -1, 0.25f, 0, 40000f);
			func_18();
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_72))
	...
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		...
		{
			AI::CLEAR_PED_SECONDARY_TASK(iLocal_71);
		}
	...
	{
		AI::TASK_COMBAT_PED(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 16);
		func_53();
	}
	else
	{
	...
	switch (iLocal_127)
	{
			...
			if (!iLocal_136)
			{
				if (!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(iLocal_72))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0) && PED::IS_PED_IN_MELEE_COMBAT(iLocal_72))
					{
						if (!iLocal_137)
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_75);
							AI::TASK_LOOK_AT_ENTITY(0, iLocal_72, -1, 2052, 2);
							AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0f, 0, 0, 0);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
							AI::CLOSE_SEQUENCE_TASK(iLocal_75);
							AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
							iLocal_137 = 1;
						}
					}
				}
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				AI::TASK_LEAVE_ANY_VEHICLE(iLocal_71, 0, 0);
				SYSTEM::SETTIMERB(0);
				iLocal_127 = 0;
			}
			break;
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_71) && ENTITY::DOES_ENTITY_EXIST(iLocal_72))
				{
					...
					AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0f, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(0, iLocal_72, -1, 2052, 4);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_72, false), 1f, -1, 3f, 0, 40000f);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
					AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 1, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0f, 0, 0, 0);
...
void func_62()
{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_70))
	{
		UI::REMOVE_BLIP(&iLocal_70);
	}
	if (iLocal_58 == 1)
	{
		...
		if (!iLocal_102)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				func_81(198, 0);
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 8000, 2052, 4);
				AI::OPEN_SEQUENCE_TASK(&iLocal_75);
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1055.515f, -2533.221f, 19.3049f, 2f, -1, 0.25f, 1, 40000f);
	...
	else if (iLocal_58 == 2)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_71))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3323.43f, 5166.832f, 17.406f, 1f, -1, 0.25f, 0, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3320.684f, 5186.017f, 17.4016f, 1f, -1, 0.25f, 0, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3303.612f, 5185.269f, 18.7155f, 1f, -1, 0.25f, 0, 40000f);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_75);
				AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
				PED::SET_PED_KEEP_TASK(iLocal_71, true);
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 5000, 2052, 2);
				PED::REMOVE_PED_FROM_GROUP(iLocal_71);
				SYSTEM::WAIT(1000);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
				if (func_8() == 0)
		...
		if (SYSTEM::TIMERA() > 1000)
		{
			if (func_1(&uLocal_161, cLocal_146, "REHH3_JB", 4, 0, 0, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_72))
				{
					...
					if (!UI::DOES_BLIP_EXIST(iLocal_99))
					{
						UI::REMOVE_BLIP(&iLocal_99);
					}
					if (!UI::DOES_BLIP_EXIST(iLocal_100))
					{
					...
					AI::CLOSE_SEQUENCE_TASK(iLocal_75);
					AI::TASK_PERFORM_SEQUENCE(iLocal_72, iLocal_75);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
					PED::SET_PED_KEEP_TASK(iLocal_72, true);
					...
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(4, -1533126372, iLocal_160);
	...
	else if (iLocal_58 == 5)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			...
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -346.029f, 632.2272f, 171.2525f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -346.6342f, 627.3992f, 170.3573f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -355.2473f, 622.1964f, 170.3572f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -355.6499f, 615.3431f, 170.3572f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -350.163f, 605.0463f, 170.7292f, 1f, -1, 0.25f, 0, 40000f);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -333.177f, 594.991f, 170.7553f, 1f, -1, 0.25f, 0, 40000f);
...
int func_64(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_65(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_65(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_117())
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 1227113341) != 0)
				{
					AI::TASK_GO_TO_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
...
void func_120()
{
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		...
		else if (!UI::DOES_BLIP_EXIST(iLocal_99))
		{
			iLocal_99 = func_63(iLocal_71, 0, 145);
		}
...
void func_122()
{
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		...
		{
			AI::TASK_USE_MOBILE_PHONE(iLocal_71, 1, 1);
		}
		if (func_123("REHH3_CHT6_5"))
		{
			AI::TASK_USE_MOBILE_PHONE(iLocal_71, 0, 1);
		}
	...
	if (!func_54())
	{
		switch (iLocal_86)
		{
			case 0:
				...
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				}
				else if (iLocal_58 == 5)
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER();
			...
			case 1:
				if (iLocal_88 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_58 == 1)
					{
			...
			case 3:
				...
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER() + 500;
				}
				else if (iLocal_58 == 5)
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER();
			...
			case 17:
				if (iLocal_58 == 3)
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER() + 700;
				}
				iLocal_86++;
				break;
			...
			case 20:
				if (iLocal_58 == 3)
				{
					iLocal_88 = GAMEPLAY::GET_GAME_TIMER() + 300;
				}
				iLocal_86++;
				break;
			...
			case 22:
				if (!PED::IS_PED_INJURED(iLocal_71))
				{
					AI::TASK_PLAY_ANIM(iLocal_71, "facials@gen_female@base", "mood_sleeping_1", 2f, -2f, -1, 33, 0f, 0, 0, 0);
				}
				iLocal_86++;
				break;
			}
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 805.501f, 1269.926f, 361.4025f, 25f, 30f, 2f, false, true, 0) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_71, 824.8886f, 1275.671f, 359.4312f, Global_19, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(iLocal_72))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
					{
						...
						AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "come_here_idle_c", 2f, -2f, -1, 48, 0f, 0, 0, 0);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
						AI::CLOSE_SEQUENCE_TASK(iLocal_75);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_72))
		{
			...
			else
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_72))
				{
					...
					{
						if (iLocal_87 < GAMEPLAY::GET_GAME_TIMER())
						{
							if (!func_54())
							{
								if (func_58())
								...
								iLocal_87 = GAMEPLAY::GET_GAME_TIMER() + 8000;
							}
						}
						if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
						{
...
void func_135(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_140(iParam0))
		{
			...
			{
				if (func_137(iParam0, iParam1, 1) > fParam9 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_136(*uParam2))
					{
...
void func_144()
{
	if (!bLocal_90)
	{
		if (iLocal_58 == 3)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_84, 200f, 200f, 200f, false, true, 0))
			{
				...
				if (STREAMING::HAS_MODEL_LOADED(iLocal_81) && STREAMING::HAS_CLIP_SET_LOADED("move_m@brave"))
				{
					...
					PED::SET_PED_DIES_WHEN_INJURED(iLocal_72, 1);
					...
					AI::TASK_PLAY_ANIM(iLocal_72, "random@hitch_lift", "idle_a", 2f, -2f, -1, 1, 0f, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
		...
		else if (iLocal_58 == 5)
		{
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_67, true) > 320f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_71, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
					{
						if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 5), &vLocal_62, 1, 3f, 0f))
						{
							if (!CAM::IS_SPHERE_VISIBLE(vLocal_62, 7f) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_62) < 110f)
							{
								...
								if (STREAMING::HAS_MODEL_LOADED(iLocal_81))
								{
									...
									if (func_147(&uLocal_161, cLocal_146, "REHH5_CHS", "REHH5_CHS_1", 4, 0, 0) && !PED::IS_PED_INJURED(iLocal_71))
									{
										...
										AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_72, iLocal_139, iLocal_71, 6, 60f, 786468, -1f, -1f, 1);
										AI::TASK_COMBAT_PED(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_KEEP_TASK(iLocal_72, true);
										STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_81);
	...
	if (bLocal_143)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
			{
				...
				AI::TASK_LEAVE_ANY_VEHICLE(iLocal_71, 1, 0);
				PED::REMOVE_PED_FROM_GROUP(iLocal_71);
				if (UI::DOES_BLIP_EXIST(iLocal_69))
				{
					UI::REMOVE_BLIP(&iLocal_69);
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && PED::IS_PED_IN_VEHICLE(iLocal_71, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				if (((func_8() == 2 && !func_51()) && iLocal_58 != 1) && iLocal_58 != 4)
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_70))
					{
						...
						UI::SET_BLIP_SPRITE(iLocal_70, 269);
						func_168();
					}
				}
				if (iLocal_58 == 1)
...
void func_170()
{
	...
	switch (iLocal_108)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				if (iLocal_88 < GAMEPLAY::GET_GAME_TIMER())
				{
					...
					iLocal_88 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4500, 6500));
				}
				if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 90f))
				{
					if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 24f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
					{
						...
						AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, fLocal_152, 2f, 1073741824, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_75);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
						iLocal_108++;
		...
		case 1:
			if (UI::DOES_BLIP_EXIST(iLocal_99))
			{
				UI::_0x75A16C3DA34F1245(iLocal_99, true);
			}
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 5000, 2052, 2);
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
					{
						if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 25f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
						{
							if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								{
									AI::TASK_OPEN_VEHICLE_DOOR(0, iLocal_73, -1, 0, 2f);
								}
				...
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 7000, 2052, 2);
					...
					if (func_117())
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
							{
								...
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_71, 1);
								PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_71, 0);
								AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								AI::TASK_ENTER_VEHICLE(iLocal_71, PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1, 0, 2f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				if (func_117())
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
					{
						AI::TASK_CLEAR_LOOK_AT(iLocal_71);
						iLocal_89 = 1;
						iLocal_57 = 3;
					}
		...
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				else if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 8f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&iLocal_75);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
					AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, fLocal_152, 1f, 1073741824, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_75);
					AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
					iLocal_108++;
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
					{
						if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 10f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
						{
							if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_73, 0, 0))
								{
									AI::TASK_OPEN_VEHICLE_DOOR(0, iLocal_73, -1, 0, 1f);
								}
								AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_75);
								AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
					...
					if (func_117())
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
							{
								...
								PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_71, 0);
								AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								AI::TASK_ENTER_VEHICLE(iLocal_71, PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1, 0, 1f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				if (func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 12f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_75);
							AI::TASK_LOOK_AT_ENTITY(0, iLocal_73, 30000, 2054, 2);
							AI::TASK_PLAY_ANIM(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0f, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_75);
							AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
						}
					...
					if (ENTITY::GET_ENTITY_SPEED(iLocal_73) < 10f)
					{
						if (!PED::IS_PED_INJURED(iLocal_71))
						{
							if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								AI::OPEN_SEQUENCE_TASK(&iLocal_75);
								AI::TASK_LOOK_AT_ENTITY(0, iLocal_73, 10000, 2054, 2);
								if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_73, 0, 0))
								{
									AI::TASK_OPEN_VEHICLE_DOOR(0, iLocal_73, -1, 0, 1f);
								}
							...
							{
								AI::TASK_LOOK_AT_ENTITY(iLocal_71, iLocal_73, 10000, 2054, 2);
								iLocal_108++;
							}
						}
					}
...
void func_176()
{
	...
	if (iLocal_140 != 0)
	{
				...
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_140, 0))
				{
					if (iLocal_58 == 1)
					{
						if (func_1(&uLocal_161, cLocal_146, "REHH1_STO", 4, 0, 0, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_71))
							{
								AI::TASK_LOOK_AT_ENTITY(iLocal_71, iLocal_140, 3000, 2052, 2);
							}
						}
						iLocal_150 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_124 = 0;
					}
					else if (iLocal_58 == 2)
					{
		...
		{
			iLocal_151 = GAMEPLAY::GET_GAME_TIMER();
...
void func_178()
{
	...
	else if (iLocal_58 == 2)
	{
		if (!iLocal_135)
		{
			...
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_75);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 178.993f, 4413.097f, 73.6132f, 1f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 159.6669f, 4413.197f, 74.8915f, 1f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 142.7866f, 4415.111f, 74.3799f, 1f, -1, 0.25f, 1, 40000f);
				AI::CLOSE_SEQUENCE_TASK(iLocal_75);
				AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
				iLocal_135 = 1;
	...
	else if (iLocal_58 == 5)
	{
		if (!iLocal_135)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_76, 200f, 200f, 200f, false, true, 0) && !PED::IS_PED_INJURED(iLocal_71))
			{
				...
				AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0f, 0, 0, 0);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -337.3163f, 2828.018f, 55.2198f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -343.4485f, 2826.222f, 54.5089f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -356.4033f, 2811.062f, 51.5931f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -365.6846f, 2809.158f, 48.7646f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -382.4106f, 2818.384f, 44.078f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -370.3838f, 2866.677f, 41.0979f, 2f, -1, 0.25f, 1, 40000f);
				AI::TASK_PLAY_ANIM(0, "random@hitch_lift", "carjack_mainloop_female", 2f, -2f, -1, 33, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_75);
				AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_75);
				iLocal_135 = 1;
...
void func_179()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_99))
		{
			...
			{
				iLocal_99 = func_63(iLocal_71, 0, 145);
				UI::_0x75A16C3DA34F1245(iLocal_99, false);
			}
		}
		if (!func_212())
		{
...
void func_180()
{
	...
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_71, 1024, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_71, 65536, 1);
...
int func_196()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_71, 0))
	{
		...
		if (!bLocal_92)
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_71, true), 10f, 1) || GAMEPLAY::IS_PROJECTILE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_71, true) - Vector(10f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_71, true) + Vector(10f, 10f, 10f), 0))
			{
				return 1;
			}
		}
	...
	if (iLocal_111)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
		{
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 1805844857) != 0)
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_71, false);
				}
...
Vector3 func_267()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_64, true);
		iLocal_63 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_65, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_65, true);
			iLocal_63 = 2;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_66, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_66, true);
			iLocal_63 = 3;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_67, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_67, true);
			iLocal_63 = 5;
		}
		if (iLocal_63 == 1)
		{
