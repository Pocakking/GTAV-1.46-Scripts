...
void __EntryFunction__()
{
	...
	while (iVar0 != 7)
	{
			...
			if (PED::IS_COP_PED_IN_AREA_3D(func_179(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_179(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(func_179(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_179(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)))
			{
				if ((((!PED::IS_PED_INJURED(iLocal_258[0]) && !PED::IS_PED_INJURED(iLocal_258[1])) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)) && PED::IS_PED_IN_VEHICLE(iLocal_258[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)) && PED::IS_PED_IN_VEHICLE(iLocal_258[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 0.2f)
					{
						if (iLocal_228 == -1)
						{
							iLocal_228 = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else
					{
					...
					if (iLocal_228 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_228 + 1000)
					{
						if (!func_178())
						{
							func_169(&uLocal_53, "REGETAU", "REAWA_LOSE", 4, 0, 0, 0);
						}
						if (iLocal_228 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_228 + 10000)
						{
							func_167();
							SYSTEM::WAIT(0);
							...
							if (!PED::IS_PED_INJURED(iLocal_258[0]))
							{
								...
								AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
		...
		if ((iVar2 > 1 && iVar2 < 7) && !iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_257))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_258[0]))
					{
						AI::TASK_SMART_FLEE_PED(iLocal_258[0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
					if (!PED::IS_PED_INJURED(iLocal_258[1]))
					{
						AI::TASK_SMART_FLEE_PED(iLocal_258[1], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
					iVar8 = 0;
					iVar0 = 7;
					func_239(Var1, &iLocal_258, bVar4);
			...
			if (iLocal_253)
			{
				...
				if (!bLocal_249)
				{
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						...
						{
							AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "hands_up_2_idle", 4f, -4f, -1, 0, 0f, 0, 0, 0);
						}
						...
						AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "gesture_nod_yes_soft", 8f, -8f, -1, 48, 0f, 0, 0, 0);
						...
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_257, iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
				...
				if (!PED::IS_PED_INJURED(iLocal_260[0]))
				{
					if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_260[0], PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
						{
							if (!func_178())
							{
								AI::TASK_LOOK_AT_ENTITY(iLocal_260[0], PLAYER::PLAYER_PED_ID(), 1000, 2052, 4);
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_260[0]);
						func_167();
						SYSTEM::WAIT(0);
						iVar8 = 0;
						iVar0 = 7;
			...
			if (bLocal_249)
			{
				if (!PED::IS_PED_INJURED(iLocal_257))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
					{
						if (!func_178())
						{
							AI::TASK_LOOK_AT_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 3000, 2048, 2);
		...
		switch (iVar0)
		{
			...
			case 4:
				iVar8 = 0;
				GAMEPLAY::SET_BIT(&uVar3, 4);
				GAMEPLAY::SET_BIT(&uVar3, 1);
				GAMEPLAY::SET_BIT(&uVar3, 5);
						...
						if (!iLocal_252)
						{
							if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Vector(28.4601f, -1565.293f, 61.5891f) - Vector(30f, 30f, 30f), Vector(28.4601f, -1565.293f, 61.5891f) + Vector(30f, 30f, 30f), 0, 1))
							{
								...
								while (iVar9 < iLocal_259)
								{
									...
									{
										AI::TASK_SMART_FLEE_PED(iLocal_259[iVar9], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								...
								if (!PED::IS_PED_INJURED(iLocal_257))
								{
									AI::TASK_SMART_FLEE_PED(iLocal_257, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(iLocal_257, true);
								}
								iLocal_252 = 1;
							}
	...
	switch (*iParam0)
	{
		...
		case 1:
			*iParam7 = 0;
			...
			if (func_114() == 0)
			{
				func_113(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (func_114() == 1)
			{
				func_113(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (func_114() == 2)
			{
				func_113(&uLocal_53, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
			...
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_266, -1533126372);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_268, iLocal_266);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, iLocal_266);
			...
			AI::TASK_START_SCENARIO_IN_PLACE(iLocal_259[2], "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 0, 0);
		...
		case 2:
			if (((((!ENTITY::IS_ENTITY_DEAD(iLocal_257, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[0], 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[2], 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[3], 0)) && !ENTITY::IS_ENTITY_DEAD((*uParam6)[0], 0)) && !ENTITY::IS_ENTITY_DEAD((*uParam6)[1], 0))
			{
				if (((((PED::_0x7350823473013C02(iLocal_257) && PED::_0x7350823473013C02(iLocal_259[0])) && PED::_0x7350823473013C02(iLocal_259[2])) && PED::_0x7350823473013C02(iLocal_259[3])) && PED::_0x7350823473013C02((*uParam6)[0])) && PED::_0x7350823473013C02((*uParam6)[1]))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						AI::TASK_HANDS_UP(iLocal_257, -1, 0, -1, 0);
						if (!PED::IS_PED_INJURED((*uParam6)[0]))
						{
							AI::TASK_PLAY_ANIM((*uParam6)[0], "random@getawaydriver@thugs", "base_a", 4f, -2f, -1, 1, 0f, 0, 0, 0);
							AI::TASK_LOOK_AT_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
						if (!PED::IS_PED_INJURED((*uParam6)[1]))
						{
							AI::TASK_PLAY_ANIM((*uParam6)[1], "random@getawaydriver@thugs", "base_b", 4f, -2f, -1, 1, 0f, 0, 0, 0);
							AI::TASK_LOOK_AT_ENTITY((*uParam6)[1], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
					}
					SYSTEM::SETTIMERA(0);
					*iParam0 = 3;
		...
		case 3:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 81.71976f, -1530.834f, 28.17651f, 26.78526f, -1595.693f, 58.29443f, 32.875f, 0, true, 0))
			{
				if (!iLocal_252)
				{
					if (!PED::IS_PED_INJURED(iLocal_259[0]))
					{
						AI::TASK_SMART_FLEE_COORD(iLocal_259[0], vLocal_232, 200f, -1, 0, 0);
					}
					if (!PED::IS_PED_INJURED(iLocal_259[2]))
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_265);
						AI::TASK_PAUSE(0, 250);
						AI::TASK_SMART_FLEE_COORD(0, vLocal_232, 200f, -1, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_259[2], iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
					if (!PED::IS_PED_INJURED(iLocal_259[3]))
					{
						...
						AI::TASK_SMART_FLEE_COORD(0, vLocal_232, 200f, -1, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_259[3], iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
					iLocal_252 = 1;
				}
			...
			if (PED::IS_COP_PED_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)))
			{
				...
				{
					AI::TASK_SMART_FLEE_PED((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					AI::TASK_SMART_FLEE_PED((*uParam6)[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					func_167();
					SYSTEM::WAIT(0);
			...
			if (!func_178())
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_257))
				{
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						...
						AI::TASK_LOOK_AT_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
						AI::OPEN_SEQUENCE_TASK(&iLocal_265);
						AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_257, iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
					}
		...
		case 5:
			if (PED::IS_PED_INJURED(iLocal_257))
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]) && !PED::IS_PED_INJURED((*uParam6)[1]))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), -1);
					AI::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[1], PLAYER::PLAYER_PED_ID(), -1);
				}
			}
			else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_257, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_257, 242628503) != 0)
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_265);
				AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, 0, 0, 0);
						...
						if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 0.1f)
						{
							...
							else if (!iLocal_250)
							{
								if (!func_178())
								{
									...
									AI::TASK_LOOK_AT_ENTITY(iLocal_258[1], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
									iLocal_250 = 1;
								}
							}
						}
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_COP_PED_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]) && !PED::IS_PED_INJURED((*uParam6)[1]))
				{
					AI::TASK_SMART_FLEE_PED((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					AI::TASK_SMART_FLEE_PED((*uParam6)[1], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					func_167();
					SYSTEM::WAIT(0);
					func_169(&uLocal_53, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
							{
								if (func_126() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_258[0]) && !PED::IS_PED_INJURED(iLocal_258[1]))
									{
										...
										{
											AI::CLEAR_PED_TASKS(iLocal_258[0]);
											AI::CLEAR_PED_TASKS(iLocal_258[1]);
											AI::TASK_LOOK_AT_ENTITY(iLocal_258[1], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[0], func_70());
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[1], func_70());
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[1], 0);
			...
			if (!PED::IS_PED_INJURED(iLocal_258[0]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_258[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							if ((AI::GET_SCRIPT_TASK_STATUS(iLocal_258[0], 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_258[0], 242628503) != 0) || AI::GET_SCRIPT_TASK_STATUS(iLocal_258[0], 242628503) == 7)
							{
								PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[0], func_70());
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_258[0], 1);
							}
				...
				else
				{
					...
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_258[0], -875674219) == 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_258[0], -875674219) == 0)
					{
					}
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_258[1]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_258[1]))
				{
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							if ((AI::GET_SCRIPT_TASK_STATUS(iLocal_258[1], 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_258[1], 242628503) != 0) || AI::GET_SCRIPT_TASK_STATUS(iLocal_258[1], 242628503) == 7)
							{
								PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[1], func_70());
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_258[1], 1);
							}
				...
				else
				{
					...
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_258[1], -875674219) == 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_258[1], -875674219) == 0)
					{
					}
				}
			}
		...
		case 9:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_266);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_266, -1533126372);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
			...
			while (iVar8 < *uParam6)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && !PED::IS_PED_INJURED((*uParam6)[iVar8]))
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_255[iVar8]))
						{
		...
		case 10:
			...
			else
			{
				...
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_256))
					{
						iLocal_256 = func_57(vLocal_244, 0);
						UI::SET_BLIP_SPRITE(iLocal_256, 269);
						func_54();
					}
				}
				iLocal_222 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 11:
			*iParam7 = 0;
			...
			if (iLocal_228 != -1 && GAMEPLAY::GET_GAME_TIMER() > (iLocal_228 + 60000))
			{
				func_167();
				SYSTEM::WAIT(0);
				func_169(&uLocal_53, "REGETAU", "REAWA_COPS", 4, 0, 0, 0);
		...
		case 12:
			...
			if (bLocal_248)
			{
				...
				if (!PED::IS_PED_INJURED((*uParam6)[0]))
				{
					...
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_265);
					AI::TASK_PERFORM_SEQUENCE((*uParam6)[0], iLocal_265);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
				...
				if (!PED::IS_PED_INJURED((*uParam6)[1]))
				{
					...
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_265);
					AI::TASK_PERFORM_SEQUENCE((*uParam6)[1], iLocal_265);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
		...
		case 13:
			if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 5f)
			{
				...
				while (iVar8 <= (*uParam6 - 1))
				{
					if (!PED::IS_PED_INJURED((*uParam6)[iVar8]))
					{
						if (AI::GET_SCRIPT_TASK_STATUS((*uParam6)[iVar8], 242628503) != 1 || AI::GET_SCRIPT_TASK_STATUS((*uParam6)[iVar8], 242628503) != 0)
						{
							if (!PED::IS_PED_INJURED((*uParam6)[iVar8]))
							{
								iVar0 = 0;
		...
		case 14:
			...
			while (iVar8 < *uParam6)
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]))
				{
					...
					AI::TASK_LOOK_AT_ENTITY((*uParam6)[iVar8], PLAYER::PLAYER_PED_ID(), 4000, 2052, 2);
					func_167();
					SYSTEM::WAIT(0);
					if (iLocal_226 > 0)
					{
		...
		case 18:
			...
			while (iVar16 < iLocal_258)
			{
				...
				{
					if (UI::DOES_BLIP_EXIST(uLocal_255[iVar16]))
					{
						UI::REMOVE_BLIP(&(uLocal_255[iVar16]));
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_258[iVar16], 0))
						{
							AI::TASK_LEAVE_ANY_VEHICLE(iLocal_258[iVar16], 0, 0);
						}
						...
						AI::TASK_COMBAT_PED(iLocal_258[iVar16], PLAYER::PLAYER_PED_ID(), 0, 16);
			...
			if (!bLocal_249)
			{
				if (!PED::IS_PED_INJURED(iLocal_257))
				{
					...
					AI::TASK_PLAY_ANIM(iLocal_257, "random@getawaydriver", "base", 4f, -4f, -1, 1, 0f, 0, 0, 0);
				}
			}
			iVar16 = 0;
			while (iVar16 < iLocal_259)
			{
				...
				{
					AI::TASK_SMART_FLEE_PED(iLocal_259[iVar16], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
int func_52(vector3 vParam0)
{
	if (func_114() == 2)
	{
		if (func_51() && !Global_25697)
		{
			...
			if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0) > (fLocal_50 + 200f) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(-1014.154f, 4881.411f, 245.0001f, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), false), true) < 400f)
			{
				Global_25697 = 1;
				return 1;
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_258[iVar0]))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!func_126())
				{
					...
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) != 0)
					{
						AI::TASK_GO_TO_ENTITY(iLocal_258[iVar0], PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_258[iVar0], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_258[iVar0], 0, 0);
					}
					if (!iLocal_251)
					{
						if (!func_178())
				...
				else
				{
					...
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 0)
					{
						AI::CLEAR_PED_TASKS(iLocal_258[iVar0]);
					}
					if (!PED::IS_PED_INJURED(iLocal_258[0]) && !PED::IS_PED_INJURED(iLocal_258[1]))
					{
						PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
...
void func_69(var uParam0, float fParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (PED::IS_PED_INJURED((*uParam0)[iVar0]))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_255[iVar0]))
			{
				UI::REMOVE_BLIP(&(uLocal_255[iVar0]));
			}
		}
		else
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
				{
					...
					else if (!UI::DOES_BLIP_EXIST(uLocal_255[iVar0]))
					{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_258[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_258[iVar0]))
			{
				if (!PED::IS_PED_IN_GROUP(iLocal_258[iVar0]))
				{
					...
					if (!iLocal_254)
					{
						if (iLocal_227 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_227 + 1000)
						{
							func_167();
							SYSTEM::WAIT(0);
					...
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_258[iVar0], PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_258[iVar0]) < 190) || (iLocal_227 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_227 + 5000))
					{
						return 1;
					}
				}
				...
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 121.8366f, -1503.006f, 28.0999f, 0.1367f, -1649.705f, 48.1608f, 125.8125f, 0, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*uParam0)[iVar0])) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, 0, true, 0))
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_255[iVar0]))
					{
						if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
						{
							...
							uLocal_255[iVar0] = func_62((*uParam0)[iVar0], 0, 145);
							UI::_0x75A16C3DA34F1245(uLocal_255[iVar0], false);
							func_65(iLocal_52);
						}
					}
					if (!func_178())
					{
						if (iLocal_230 < GAMEPLAY::GET_GAME_TIMER())
						{
							func_169(&uLocal_53, "REGETAU", "REAWA_SHOUT", 4, 0, 0, 0);
							iLocal_230 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 4000));
						}
					}
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, 0, true, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
						{
							if (!func_178())
							{
								...
								if (UI::DOES_BLIP_EXIST(uLocal_255[0]))
								{
									UI::_0x75A16C3DA34F1245(uLocal_255[0], true);
								}
								if (UI::DOES_BLIP_EXIST(uLocal_255[1]))
								{
									UI::_0x75A16C3DA34F1245(uLocal_255[1], true);
								}
								if (!PED::IS_PED_INJURED((*uParam0)[1]) && !PED::IS_PED_INJURED(iLocal_257))
								{
									PED::SET_PED_RESET_FLAG((*uParam0)[1], 156, true);
									AI::OPEN_SEQUENCE_TASK(&iLocal_265);
									AI::TASK_PLAY_ANIM(0, "misslamar1ig_20", "stretch_call_hurry_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
									AI::TASK_PLAY_ANIM(0, "combat@gestures@pistol@halt", "180", 2f, -2f, -1, 0, 0f, 0, 0, 0);
									AI::TASK_AIM_GUN_AT_ENTITY(0, iLocal_257, -1, 0);
									AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
									AI::CLOSE_SEQUENCE_TASK(iLocal_265);
									AI::TASK_PERFORM_SEQUENCE((*uParam0)[1], iLocal_265);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
								}
...
void func_165()
{
	if (!bLocal_248)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_179(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 15), &vLocal_235, 1, 3f, 0f);
			...
			if (bLocal_247)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_260[0]))
				{
					...
					if (func_60())
					{
						...
						AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_260[0], 50f, 0);
					...
					else
					{
						...
						AI::TASK_PLAY_ANIM(0, "random@getawaydriver", "gesture_nod_yes_hard", 8f, -8f, -1, 48, 0f, 0, 0, 0);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
						AI::TASK_STAND_STILL(0, 3000);
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_260[0], iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
						PED::SET_PED_KEEP_TASK(iLocal_260[0], true);
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_260[1]))
				{
					...
					if (func_60())
					{
						...
						AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_260[1], 50f, 0);
						PED::SET_PED_KEEP_TASK(iLocal_260[1], true);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_260[1], true);
						AI::TASK_GO_TO_COORD_ANY_MEANS(iLocal_260[1], 68.7217f, -1569.83f, 28.6027f, 3f, 0, 0, 786603, -1082130432);
						PED::SET_PED_KEEP_TASK(iLocal_260[1], true);
					}
				}
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_262))
				{
					...
					ENTITY::SET_ENTITY_HEADING(iLocal_262, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vLocal_234.x, vLocal_234.y));
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_260[2]))
				{
					...
					if (func_60())
					{
						...
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_260[2], iLocal_262, iLocal_258[1], 6, 15f, 2, -1f, -1f, 1);
					...
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_260[2], true);
						AI::OPEN_SEQUENCE_TASK(&iLocal_265);
						AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_262, 40.2328f, -1555.753f, 28.2128f, 10f, 0, joaat("police"), 786469, 1f, -1f);
						AI::TASK_STAND_STILL(0, 5000);
						AI::CLOSE_SEQUENCE_TASK(iLocal_265);
						AI::TASK_PERFORM_SEQUENCE(iLocal_260[2], iLocal_265);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
						PED::SET_PED_KEEP_TASK(iLocal_260[2], true);
					}
				}
	...
	if (iLocal_269)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_257))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_257, "random@getawaydriver", "idle_a", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_257, "random@getawaydriver", "idle_2_hands_up", 3))
			{
				...
				{
					AI::TASK_SMART_FLEE_PED(0, (*iParam1)[0], 150f, -1, 0, 0);
				}
				else if (!PED::IS_PED_INJURED((*iParam1)[1]))
				{
					AI::TASK_SMART_FLEE_PED(0, (*iParam1)[1], 150f, -1, 0, 0);
				}
				AI::CLOSE_SEQUENCE_TASK(iLocal_265);
				AI::TASK_PERFORM_SEQUENCE(iLocal_257, iLocal_265);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_265);
			...
			AI::CLEAR_PED_SECONDARY_TASK(iLocal_257);
		...
		if (!bParam2)
		{
			if (!PED::IS_PED_INJURED((*iParam1)[0]))
			{
				AI::TASK_SMART_FLEE_COORD((*iParam1)[0], func_179(PLAYER::PLAYER_ID()), 200f, -1, 0, 0);
			}
			if (!PED::IS_PED_INJURED((*iParam1)[1]))
			{
				AI::TASK_SMART_FLEE_COORD((*iParam1)[1], func_179(PLAYER::PLAYER_ID()), 200f, -1, 0, 0);
			}
		}
		if (!iLocal_218)
		{
