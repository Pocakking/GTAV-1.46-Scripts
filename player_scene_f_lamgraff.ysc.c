...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(Global_93018))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_93018, &sLocal_271, &cLocal_303, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_93018))
				{
					AI::STOP_ANIM_PLAYBACK(Global_93018, 0, 0);
					AI::CLEAR_PED_TASKS(Global_93018);
					return 0;
				}
...
int func_20()
{
	...
	if (!PED::IS_PED_INJURED(Global_93018))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_267))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_93018, &sLocal_271, &cLocal_287, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_93018))
				{
					AI::STOP_ANIM_PLAYBACK(Global_93018, 0, 0);
				...
				else
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Global_93018, iLocal_312, &sLocal_271, &cLocal_303, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					AI::CLEAR_PED_TASKS(Global_93018);
					PED::_RESET_PED_RAGDOLL_BLOCKING_FLAGS(Global_93018, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_312))
					{
						iLocal_312 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_269, 0f, 0f, fLocal_270, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_312, true);
...
int func_23(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_24(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_31()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_93018) || !STREAMING::HAS_MODEL_LOADED(iLocal_268))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93018))
	{
		if (!PED::IS_PED_INJURED(Global_93018))
		{
			AI::TASK_STAND_STILL(Global_93018, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_93018, 1862763509);
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_93018, true, 1);
	PED::SET_PED_CONFIG_FLAG(Global_93018, 132, true);
	PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(Global_93018, 16);
	func_33(&Global_93018, Global_88331);
	func_32(&uLocal_100, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_267 = OBJECT::CREATE_OBJECT(iLocal_268, ENTITY::GET_ENTITY_COORDS(Global_93018, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_267, Global_93018, PED::GET_PED_BONE_INDEX(Global_93018, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
...
int func_37(struct<109> Param0, var uParam1)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam1 = { Global_91408[0 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_39(uParam1);
			uParam1->f_118 = Global_92996[0];
			return 1;
			break;
		
		case 3:
			*uParam1 = { Global_91408[1 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_39(uParam1);
			uParam1->f_118 = Global_92996[1];
			return 1;
			break;
		
		case 4:
			*uParam1 = { Global_91408[2 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_39(uParam1);
			uParam1->f_118 = Global_92996[2];
			return 1;
			break;
		...
		case 5:
			*uParam1 = { Param0 };
			...
			uParam1->f_110 = -982327190;
			func_39(uParam1);
			uParam1->f_118 = Global_92996[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_38(uParam1, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_47(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_47(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_47(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
