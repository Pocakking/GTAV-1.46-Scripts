...
void func_1()
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, sLocal_381))
			{
				func_503(1);
			}
			else
...
void func_17()
{
	switch (Local_43.f_1)
	{
		case 0:
			if (func_463(Local_48.f_2))
			{
				...
				if (func_220(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", 8, 0, 0, 0))
				{
					...
					iLocal_189 = GAMEPLAY::GET_GAME_TIMER() + 5000;
					Local_43.f_1 = 1;
				}
			}
			else
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_189 && !func_18()) || !func_463(Local_48.f_2))
			{
				func_19();
			}
			break;
...
void func_24()
{
	...
	{
		func_26(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_233()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			func_8(0);
			func_2(1);
			iLocal_411 = GAMEPLAY::GET_GAME_TIMER() + 500;
			iLocal_412 = 1;
			iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			GAMEPLAY::CLEAR_AREA(vLocal_386, 200f, 1, 0, 0, false);
	...
	if (Local_43.f_1 == 1)
	{
		...
		if (func_463(Local_48.f_2))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Orleans", 0))
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0f, 0, 1, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0f, 0, 1, 0);
				AI::CLOSE_SEQUENCE_TASK(iVar1);
				AI::TASK_PERFORM_SEQUENCE(Local_48.f_2, iVar1);
				...
				{
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_48.f_2, -1, 2050, 4);
					AI::TASK_LOOK_AT_ENTITY(Local_48.f_2, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_411)
				{
...
void func_237(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_241(PLAYER::PLAYER_ID())) && !func_239(PLAYER::PLAYER_ID(), 0)) && !func_238()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_241(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_246()
{
	...
	UI::SET_BLIP_SCALE(Local_48.f_3, 1f);
...
void func_247(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_318(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_249(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_268(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2566070[iParam0 /*3*/][func_86(iParam1)];
...
void func_272(int iParam0, bool bParam1)
{
	...
	if (func_168(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_273(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_286(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_87(func_287(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_289(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_305(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_290(iVar0, 0), true);
...
var func_307()
{
	...
	func_317(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_316(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_315(&uVar0, TIME::GET_CLOCK_HOURS());
	func_310(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_309(&uVar0, TIME::GET_CLOCK_MONTH());
	func_308(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_313(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_319(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_320(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_320(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_320(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_320(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_320(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_339(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_340(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_371()
{
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if (!func_463(Local_48.f_2))
		{
			...
			else
			{
				func_245(4);
				func_397();
				iLocal_364 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				Local_43.f_1 = 3;
				func_11(&(Local_48.f_3));
			}
		}
		...
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_186)
			{
				iLocal_185++;
				iLocal_186 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				func_396(807, 1, 0);
			}
		...
		else
		{
			...
			if (iLocal_170 == 0)
			{
				...
				iLocal_170 = 1;
				iLocal_184 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			}
			else if (iLocal_183 == 0)
			{
				if (iLocal_184 < GAMEPLAY::GET_GAME_TIMER())
				{
					func_377("SAS1_H0", -1);
					iLocal_183 = 1;
				}
			...
			if (iLocal_168 == 0)
			{
				if (!func_373(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					...
					iLocal_168 = 1;
					iLocal_172 = GAMEPLAY::GET_GAME_TIMER() + 30000;
				}
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_172)
			{
				if (func_373(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					iLocal_168 = 0;
	...
	if (Local_43.f_1 == 3)
	{
		if (Local_43.f_8 == 4)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_364)
			{
				func_372();
			}
		}
...
void func_374()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(Local_59[iVar0 /*16*/], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
bool func_376(int iParam0, int iParam1)
{
	...
	return (GAMEPLAY::GET_GAME_TIMER() - Local_42[iParam0 /*13*/].f_4) < iParam1;
}
...
void func_380()
{
	if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, true), 1.5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			func_381();
	...
	else if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, true), 5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			if (!func_18())
...
void func_381()
{
	...
	{
		AUDIO::STOP_SOUND(Local_48.f_6);
		AUDIO::PLAY_SOUND_FROM_ENTITY(Local_48.f_6, "WOUNDED", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
		Local_48.f_10 = 1;
	}
}
	...
	switch (Local_48)
	{
		case 1:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					Local_48.f_4 = (GAMEPLAY::GET_GAME_TIMER() + iVar1);
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					else if (GAMEPLAY::GET_GAME_TIMER() > Local_48.f_4)
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					Local_48.f_12 = (GAMEPLAY::GET_GAME_TIMER() + 60000);
					Local_48.f_4 = 0;
					Local_48.f_1 = 1;
				}
				...
				else if (UI::DOES_BLIP_EXIST(Local_48.f_3))
				{
					iVar2 = (UI::GET_BLIP_ALPHA(Local_48.f_3) - 5);
					if (iVar2 > 0)
					{
						UI::SET_BLIP_ALPHA(Local_48.f_3, iVar2);
					}
					else
					{
						func_11(&(Local_48.f_3));
				...
				else if (GAMEPLAY::GET_GAME_TIMER() > Local_48.f_12)
				{
					Local_48.f_11 = 1;
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > Local_48.f_4)
				{
					...
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(Local_48.f_5, "ALERT", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						UI::_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, true), 30f, 6);
					}
					Local_48.f_4 = GAMEPLAY::GET_GAME_TIMER() + 7500;
				}
		...
		case 3:
			if (func_463(Local_48.f_2))
			{
				...
				{
					func_363(Local_48.f_2, 1);
					AI::TASK_GO_STRAIGHT_TO_COORD(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 1056964608);
					if ((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7))
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					}
					Local_48.f_10 = 0;
					if (!UI::DOES_BLIP_EXIST(Local_48.f_3))
					{
						Local_48.f_3 = func_324(Local_48.f_2, 1, 0, 5);
						UI::SET_BLIP_SCALE(Local_48.f_3, 1f);
					}
					...
					{
						UI::SET_BLIP_ALPHA(Local_48.f_3, 255);
					}
					if (Local_47.f_352 == (Local_47.f_353 - 1))
					{
				...
				else if (Local_48.f_1 == 1)
				{
					...
					{
						AI::TASK_PLAY_ANIM(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0f, 0, 0, 0);
						Local_48.f_1 = 2;
					}
				...
				{
					AI::CLEAR_PED_TASKS(Local_48.f_2);
					if (Local_47.f_352 < (Local_47.f_353 - 1))
					{
						if ((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7))
						{
							AUDIO::PLAY_SOUND_FROM_ENTITY(Local_48.f_7, "COUGH", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						}
						Local_48 = 4;
						Local_48.f_1 = 0;
					}
		...
		case 4:
			...
			if (func_463(Local_48.f_2))
			{
				if (UI::DOES_BLIP_EXIST(Local_48.f_3))
				{
					...
					iVar4 = (UI::GET_BLIP_ALPHA(Local_48.f_3) - iVar5);
					if (iVar4 > 0)
					{
						UI::SET_BLIP_ALPHA(Local_48.f_3, iVar4);
					}
					else
					{
						func_11(&(Local_48.f_3));
		...
		case 5:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(Local_48.f_2, iVar6);
					func_374();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					{
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_367)
						{
							if (func_390(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", sLocal_365[iLocal_366], 7, 0, 0))
							{
								iLocal_367 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
								iLocal_366 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 4);
							}
						}
					}
					func_389();
		...
		case 6:
			if (func_463(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					iLocal_171 = 1;
					AI::TASK_COMBAT_PED(Local_48.f_2, PLAYER::PLAYER_PED_ID(), 0, 16);
					func_374();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
void func_391()
{
	if (iLocal_191 < 0)
	{
		iLocal_191 = GAMEPLAY::GET_GAME_TIMER() + 7000;
		iLocal_192 = -1;
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_191)
	{
...
void func_392()
{
	if (iLocal_192 < 0)
	{
		iLocal_192 = GAMEPLAY::GET_GAME_TIMER() + 7000;
		iLocal_191 = -1;
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_192)
	{
		if ((!func_18() && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
		{
...
int func_393(var uParam0)
{
	...
	if ((vVar0.x * vVar1.x) + (vVar0.y * vVar1.y)) < SYSTEM::COS(SYSTEM::TO_FLOAT(uParam0->f_11))
	{
		...
		return !GAMEPLAY::IS_AREA_OCCUPIED(vVar2, vVar3, 0, 1, 0, 0, 0, 0, 0);
	}
	return 0;
}
...
void func_405()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_187 && iLocal_187 > 0)
	{
		if (func_236(PLAYER::PLAYER_PED_ID()))
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_442())
		{
			...
			iLocal_61 = UI::ADD_BLIP_FOR_RADIUS(vLocal_390, 75f);
			UI::SET_BLIP_COLOUR(iLocal_61, 5);
			UI::SET_BLIP_ALPHA(iLocal_61, 128);
			UI::_0x75A16C3DA34F1245(iLocal_61, false);
			GAMEPLAY::CLEAR_AREA(vLocal_404, 100f, 1, 0, 0, false);
			GAMEPLAY::CLEAR_AREA(vLocal_405, 100f, 1, 0, 0, false);
			GAMEPLAY::CLEAR_AREA(vLocal_406, 100f, 1, 0, 0, false);
			GAMEPLAY::CLEAR_AREA(vLocal_407, 100f, 1, 0, 0, false);
			iLocal_167 = 0;
			iLocal_168 = 0;
			iLocal_169 = 0;
			iLocal_174 = 0;
			...
			iLocal_181 = 1;
			iLocal_182 = 1;
			iLocal_196 = (GAMEPLAY::GET_GAME_TIMER() + 40000);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_426(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_379(Local_45, vLocal_397, 1.5f)) || PED::IS_PED_RAGDOLL(Local_45))
		{
			...
			AI::TASK_COMBAT_PED(Local_45, PLAYER::PLAYER_PED_ID(), 0, 16);
			func_397();
			func_245(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
			...
			else
			{
				...
				if (iLocal_176 == 0)
				{
					if (func_379(PLAYER::PLAYER_PED_ID(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_364())
						{
							...
							UI::_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, true), 30f, 6);
							AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_406();
						}
				...
				else if (iLocal_177 == 0)
				{
					if (!func_18())
					{
						if (iLocal_190 < 0)
						{
							iLocal_190 = GAMEPLAY::GET_GAME_TIMER() + 2000;
						}
						else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_190)
						{
							func_232(&uLocal_199, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_406()
{
	...
	GAMEPLAY::CLEAR_AREA(vLocal_404, 50f, 1, 0, 0, false);
	GAMEPLAY::CLEAR_AREA(vLocal_405, 50f, 1, 0, 0, false);
	GAMEPLAY::CLEAR_AREA(vLocal_406, 50f, 1, 0, 0, false);
	GAMEPLAY::CLEAR_AREA(vLocal_407, 20f, 1, 0, 0, false);
	iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
				{
					...
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(iVar0, 1);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
					AI::TASK_PERFORM_SEQUENCE(Local_45, iVar0);
...
void func_434()
{
	...
	while (iVar0 < Local_42)
	{
		if (!(Local_42[iVar0 /*13*/].f_11 == 3 && GAMEPLAY::GET_GAME_TIMER() < Local_42[iVar0 /*13*/].f_10))
		{
...
int func_435(var uParam0)
{
	...
	if (!func_236(uParam0->f_1) || !func_236(uParam0->f_2))
	{
		if (uParam0->f_5 != 0)
		{
			iVar5 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
			uParam0->f_5 = 0;
		}
	...
	if (uParam0->f_5 == 0)
	{
		...
		uParam0->f_7 = { vVar8 + ENTITY::GET_ENTITY_VELOCITY(uParam0->f_2) * FtoV(GAMEPLAY::GET_FRAME_TIME()) };
		vVar0 = { uParam0->f_7 - vVar7 * Vector(1.25f, 1.25f, 1.25f) + vVar7 };
		uParam0->f_5 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar7, vVar0, 511, 0, 7);
		return 2;
	}
	bVar12 = false;
	iVar5 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
	...
	{
		fVar13 = GAMEPLAY::ABSF((ENTITY::GET_ENTITY_SPEED(uParam0->f_1) * GAMEPLAY::GET_FRAME_TIME()));
		fVar13 = 0f;
		fVar11 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_7, vVar2, false);
		...
		if (bVar12 && GAMEPLAY::ABSF((uParam0->f_7.f_2 - vVar2.z)) > 1f)
		{
			bVar12 = false;
		}
		uParam0->f_6 = bVar12;
	...
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			...
			if (func_441(Local_45, 1862763509, iLocal_368))
			{
				if (func_463(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_45, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
				}
			}
		}
		func_440();
...
void func_452()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HIKER", false);
			AI::SET_SCENARIO_TYPE_ENABLED("WORLD_MOUNTAIN_LION_WANDER", false);
			func_453();
			CUTSCENE::START_CUTSCENE(0);
			SYSTEM::WAIT(0);
			UNK1::_0x208784099002BC30("SF_TheLastOne", 0);
			...
			GAMEPLAY::CLEAR_AREA(-1561.793f, 4668.806f, 48.04337f, 218.9074f, 1, 0, 0, false);
			func_443();
			if (func_236(PLAYER::PLAYER_PED_ID()))
			{
		...
		if (func_463(Local_44.f_28[0]))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Hunter", 0))
			{
				...
				if (func_441(Local_45, 1862763509, iLocal_368))
				{
					if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
					{
						AI::TASK_PLAY_ANIM(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0f, 0, 0, 0);
					}
				}
			}
		}
	...
	if (Local_43.f_1 == 3)
	{
		if (CUTSCENE::HAS_CUTSCENE_FINISHED())
		{
			...
			func_494(&Local_44, 0, 1);
			func_5(&iLocal_62);
			iLocal_187 = GAMEPLAY::GET_GAME_TIMER() + 500;
			func_245(2);
			func_234();
		}
	}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_467(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_478(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_480(iParam0, Global_36117);
}
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			if (func_463(uParam0->f_28[0]))
			{
				...
				AI::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmlastone1", "idle_action_01", 8f, -8f, -1, 1, 0f, 0, 0, 0);
...
void func_500()
{
	...
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HIKER", true);
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_MOUNTAIN_LION_WANDER", true);
...
int func_508()
{
	...
	{
		if (func_318(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
