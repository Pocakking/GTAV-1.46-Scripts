...
void __EntryFunction__()
{
	...
	iLocal_252 = 1;
	iLocal_243 = 1;
	iLocal_270 = GAMEPLAY::GET_GAME_TIMER();
	AUDIO::REGISTER_SCRIPT_WITH_AUDIO(0);
	GAMEPLAY::CLEAR_BIT(&(Global_106070.f_18546.f_382), 4);
	func_507();
	iVar0 = 0;
	...
	while (true)
	{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_270) > 2000)
			{
				if (!iLocal_269)
				{
...
void func_2()
{
	...
	switch (iLocal_67)
	{
		...
		case 4:
			...
			if (func_5(Local_317))
			{
				if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317))
				{
					AI::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_317);
				}
...
int func_9(int iParam0)
{
	...
	if (iParam0 == 0)
	{
		...
		if (((!AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DTRANS") || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DGOLF")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DGOLF2")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DCRASH"))
		{
			return 0;
		}
	}
...
void func_41()
{
	...
	{
		func_43(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_64(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_115(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_115(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_107(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_107(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_65(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_180(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_115(iVar10, iParam1, iParam2, -1) };
		if (!func_105(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_115(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_115(iVar10, 14, uVar12[iVar1], -1) };
							func_83(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_98(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_107(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_98(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_115(iVar10, iVar0, func_73(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_115(iVar10, 14, uVar15[iVar1], -1) };
			func_83(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_98(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_107(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_107(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_115(iParam0, iParam1, iParam2, -1) };
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_84(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_107(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_107(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_85(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_98(int iParam0)
{
	...
	{
		func_104(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_101(iParam2)];
	if (iVar0 != 0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_101(iParam1)];
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_180(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_114(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_114(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_114(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_117(int iParam0)
{
	...
	func_118(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_102(func_121(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_102(func_120(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_102(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_118(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_118(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_118(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_118(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_107(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_180(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_180(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_180(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_115(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_115(iVar0, iVar2, iVar1, -1) };
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_107(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_107(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_184()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_235(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_181(PLAYER::PLAYER_PED_ID());
			if (func_185(iVar0) && (!func_123(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_185(Global_106070.f_2355.f_539.f_4301))
				{
...
int func_233(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0) && !GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 1, Global_71017[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
		...
		{
			func_104(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 1, Global_71017[1 /*14*/].f_1, 0, 1);
		}
...
int func_234(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0) && !GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 0, Global_71017[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_104(iParam1, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 0, Global_71017[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_248()
{
		...
		switch (iLocal_68)
		{
			case 0:
					...
					if (!func_14())
					{
						...
						if (func_5(Local_317))
						{
							if (func_6(Local_293))
							{
								if (!PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
								{
									AI::TASK_ENTER_VEHICLE(Local_293, Local_317, -1, -1, 2f, 1, 0);
								}
							}
						}
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
				{
					...
					{
						iLocal_286 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_279 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_68 = 1;
					}
				}
				break;
			...
			case 1:
				...
				else
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&iLocal_322);
						AI::TASK_ACHIEVE_HEADING(0, 112f, 0);
						AI::TASK_PLAY_ANIM(0, "rcmnigel1d", "swing_a_mark", 8f, -2f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "rcmnigel1d", "swing_b_mark", 8f, -2f, -1, 0, 0f, 0, 0, 0);
						AI::SET_SEQUENCE_TO_REPEAT(iLocal_322, 1);
						AI::CLOSE_SEQUENCE_TASK(iLocal_322);
						AI::TASK_PERFORM_SEQUENCE(Local_293, iLocal_322);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_322);
						if (func_506(Local_298))
						{
							AI::TASK_CLEAR_LOOK_AT(Local_298);
						}
						iLocal_248 = 1;
						iVar0 = 0;
						while (iVar0 <= 2)
					...
					else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_279) >= 2500)
					{
					...
					if ((func_5(Local_317) && func_5(Local_316[5 /*6*/])) && func_506(PLAYER::PLAYER_PED_ID()))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[5 /*6*/], 0))
						{
							...
							iLocal_285 = GAMEPLAY::GET_GAME_TIMER();
							func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
							func_287(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_263(&uLocal_72, "NIG1DAU", "NIG1D_BANK", "NIG1D_BANK_1", 7, 0, 0);
							AI::OPEN_SEQUENCE_TASK(&iLocal_322);
							AI::TASK_PLAY_ANIM(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					...
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_286) >= 15000)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
						{
							func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
			...
			case 2:
				...
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
				{
					...
					AI::TASK_PLAY_ANIM(0, "mini@golf", "iron_idle_high_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "mini@golf", "iron_swing_intro_high", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "mini@golf", "iron_swing_action_high", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "mini@golf", "swing_outro", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "mini@golf", "swing_react_bad_02", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(iLocal_322, 1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_322);
					AI::TASK_PERFORM_SEQUENCE(Local_293, iLocal_322);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_322);
				...
				if (((func_5(Local_317) && func_256(Local_293, Local_317, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_317))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_293, Local_317))
					{
						...
						if (func_6(Local_293))
						{
							if (!func_254())
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293, Local_317, "NIGEL1DGOLF", 786468, 0, 12, -1, -1f, 0, 1073741824);
							}
							else
							{
								iLocal_261 = 1;
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293, Local_317, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1f, 0, 1073741824);
							}
						}
						iLocal_68 = 4;
					}
			...
			case 4:
				...
				if (func_5(Local_317))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
					{
						if (iLocal_67 != 4)
						{
							if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_317) >= 200)
							{
	...
	else
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18546.f_382, 4))
		{
			GAMEPLAY::SET_BIT(&(Global_106070.f_18546.f_382), 4);
		}
	}
}
...
int func_249()
{
	if (ENTITY::GET_ENTITY_SPEED(Local_317) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
	{
		...
		if (iLocal_276 > 30)
		{
			...
			{
				VEHICLE::_SET_VEHICLE_HALT(Local_317, 2f, 3, 0);
				if (PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
				{
					AI::CLEAR_PED_TASKS(Local_293);
					if (func_14())
					{
						func_12();
					}
...
void func_250()
{
	if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_293, true), 20f, 1))
	{
		if (!UI::IS_MESSAGE_BEING_DISPLAYED())
		{
			if (!func_14())
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_283) >= 3000)
				{
					switch (iLocal_277)
					{
						case 0:
	...
	if (iLocal_67 == 4 || iLocal_67 == 5)
	{
		if (iLocal_278 < 5)
		{
			if (!UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (!func_14())
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_284) > 15000)
					{
						if (func_6(Local_293))
						{
...
void func_258()
{
	...
	if (iLocal_255 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_506(Local_303[iVar0 /*13*/]))
			{
				AI::CLEAR_PED_TASKS(Local_303[iVar0 /*13*/]);
				AI::OPEN_SEQUENCE_TASK(&iLocal_321);
				AI::TASK_PAUSE(0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 600));
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				AI::CLOSE_SEQUENCE_TASK(iLocal_321);
				AI::TASK_PERFORM_SEQUENCE(Local_303[iVar0 /*13*/], iLocal_321);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_321);
				...
				AI::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_303[iVar0 /*13*/], 1);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_320, 1862763509);
				iLocal_307[iVar0] = 4;
				if (!UI::DOES_BLIP_EXIST(Local_303[iVar0 /*13*/].f_11))
				{
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317, 0))
			{
				if (func_6(Local_293))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
					{
						...
						AI::TASK_ENTER_VEHICLE(0, Local_317, -1, -1, 2f, 1, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_321);
						AI::TASK_PERFORM_SEQUENCE(Local_293, iLocal_321);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_321);
...
bool func_269(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_47[iVar2 /*4*/].f_3) < iParam4);
}
...
void func_285()
{
	switch (iLocal_315)
	{
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_279) > 4500)
			{
				iLocal_315 = 0;
			}
			break;
...
void func_290(int iParam0, int iParam1)
{
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			AI::CLOSE_SEQUENCE_TASK(iLocal_322);
			AI::TASK_PERFORM_SEQUENCE(iParam0, iLocal_322);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_322);
			PED::SET_PED_KEEP_TASK(iParam0, true);
		}
	}
				...
				if (func_506(Local_293))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(Local_293, Local_306[iParam0 /*13*/], 62f, 62f, 62f, 0, 1, 0))
						{
							...
							{
								AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_306[iParam0 /*13*/], Local_293, -1);
								iLocal_309[iParam0] = 1;
							}
						}
						else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_306[iParam0 /*13*/], true), 15f, 1))
						{
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_293, Local_306[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_306[iParam0 /*13*/]))
				{
					...
					AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_306[iParam0 /*13*/]);
					AI::TASK_GO_STRAIGHT_TO_COORD(Local_306[iParam0 /*13*/], Local_306[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 1056964608);
	...
	if (iLocal_243 == 0)
	{
		if (func_8(0))
		{
			...
			while (iVar0 <= 2)
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_303[iVar0 /*13*/], iLocal_320);
				PED::SET_PED_DIES_WHEN_INJURED(Local_303[iVar0 /*13*/], 1);
...
void func_303()
{
	...
	while (iVar0 <= 2)
	{
		...
		else
		{
			if (UI::DOES_BLIP_EXIST(Local_303[iVar0 /*13*/].f_11))
			{
				UI::REMOVE_BLIP(&(Local_303[iVar0 /*13*/].f_11));
			}
...
void func_304(int iParam0)
{
	...
	if (func_506(PLAYER::PLAYER_PED_ID()) && func_506(Local_303[iParam0 /*13*/]))
	{
		if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 20f)
		{
			...
			{
				AI::TASK_LOOK_AT_ENTITY(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1000, 0, 2);
			}
		}
	}
	switch (iLocal_307[iParam0])
	{
							...
							if (iLocal_247 == 0)
							{
								...
								if (!UI::IS_MESSAGE_BEING_DISPLAYED() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
								{
									if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										...
										AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
										AI::CLOSE_SEQUENCE_TASK(iLocal_321);
										AI::TASK_PERFORM_SEQUENCE(Local_303[iParam0 /*13*/], iLocal_321);
										AI::CLEAR_SEQUENCE_TASK(&iLocal_321);
										iLocal_285 = GAMEPLAY::GET_GAME_TIMER();
										iLocal_247 = 1;
					...
					else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
					{
						if (iLocal_247 == 0)
						{
							if (!func_14() && iLocal_257 == 0)
							{
								...
								{
									AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
								}
								if (func_6(Local_298))
								{
									AI::TASK_LOOK_AT_ENTITY(Local_298, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								}
								if (func_6(Local_293))
								{
									AI::TASK_LOOK_AT_ENTITY(Local_293, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									AI::OPEN_SEQUENCE_TASK(&iLocal_322);
									AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
									AI::TASK_PLAY_ANIM(0, "rcmnigel1d", "idle_c", 2f, -4f, -1, 1, 0f, 0, 0, 0);
									AI::CLOSE_SEQUENCE_TASK(iLocal_322);
									AI::TASK_PERFORM_SEQUENCE(Local_293, iLocal_322);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_322);
								}
		...
		case 1:
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_285) >= 8000)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					...
					if (func_263(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						...
						AI::TASK_PLAY_ANIM(0, "rcmnigel1d", "thanks_male_05", 4f, -4f, -1, 0, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_321);
						AI::TASK_PERFORM_SEQUENCE(Local_303[iParam0 /*13*/], iLocal_321);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_321);
						iLocal_285 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 2:
			...
			else if (!func_180(PLAYER::PLAYER_PED_ID(), 12, 4))
			{
				...
				else
				{
					...
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_285) >= 7000)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
						{
							func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						...
						{
							AI::TASK_ACHIEVE_HEADING(Local_303[iParam0 /*13*/], Local_303[iParam0 /*13*/].f_7, 0);
							AI::TASK_CLEAR_LOOK_AT(Local_303[iParam0 /*13*/]);
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
			{
				if (iLocal_247 == 0)
				{
					if (!func_14() && iLocal_257 == 0)
					{
						...
						if (func_6(Local_293))
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_293, PLAYER::PLAYER_PED_ID(), -1);
						}
						func_287(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_287(&uLocal_72, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
		...
		case 3:
			if (!func_308())
			{
				if (func_268(Local_303[iParam0 /*13*/], 1126825984))
				{
					if (func_256(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) < 80f)
					{
						...
						{
							AI::CLEAR_PED_TASKS(Local_303[iParam0 /*13*/]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_321);
							...
							AI::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_303[iParam0 /*13*/], 1);
							PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_320, 1862763509);
							iLocal_307[iParam0] = 4;
							if (!UI::DOES_BLIP_EXIST(Local_303[iParam0 /*13*/].f_11))
							{
			...
			{
				if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_303[iParam0 /*13*/], true), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
				...
				else
				{
					...
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_285) >= 10000)
					{
						if (func_506(Local_293))
						{
							if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_303[iParam0 /*13*/]))
								{
									AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_303[iParam0 /*13*/]);
									AI::TASK_GO_STRAIGHT_TO_COORD(Local_303[iParam0 /*13*/], Local_303[iParam0 /*13*/].f_1, 3f, -1, Local_303[iParam0 /*13*/].f_7, 1056964608);
								}
								iLocal_249 = 1;
								iLocal_307[iParam0] = 0;
							}
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_285) >= 12000)
								{
									if (func_14())
									{
										func_12();
		...
		case 4:
			if (func_256(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_293, 0) || func_506(Local_293)))
			{
				if (UI::DOES_BLIP_EXIST(Local_303[iParam0 /*13*/].f_11))
				{
					UI::REMOVE_BLIP(&(Local_303[iParam0 /*13*/].f_11));
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_293))
	{
		if (iLocal_67 < 3 || func_256(PLAYER::PLAYER_PED_ID(), Local_293, 1) > 100f)
		{
			...
			while (iVar0 <= 2)
			{
				if (func_6(Local_303[iVar0 /*13*/]))
				{
					...
					if (iVar0 == 1)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_293))
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_303[iVar0 /*13*/], Local_293, 0);
							AI::TASK_GO_TO_ENTITY(Local_303[iVar0 /*13*/], Local_293, 20000, 6f, 1073741824, 1073741824, 0);
						}
					}
					else
					{
						AI::TASK_LOOK_AT_ENTITY(Local_303[iVar0 /*13*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					}
			...
			if (func_506(Local_293))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_293);
					AI::TASK_COWER(Local_293, -1);
				}
			}
			if (func_506(Local_298))
			{
				AI::CLEAR_PED_TASKS(Local_298);
				if (ENTITY::IS_ENTITY_ATTACHED(Local_332))
				{
					ENTITY::DETACH_ENTITY(Local_332, 1, true);
				}
				AI::TASK_SMART_FLEE_PED(Local_298, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
	...
	switch (iLocal_69)
	{
		case 0:
			...
			while (iVar0 <= 2)
			{
				if (UI::DOES_BLIP_EXIST(Local_303[iVar0 /*13*/].f_11))
				{
					UI::SET_BLIP_SCALE(Local_303[iVar0 /*13*/].f_11, 0.7f);
				}
				iVar0++;
			}
			...
			if (func_506(Local_328.f_1))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_328.f_1, 0.8f, 0.8f, 2f, 0, 1, 1))
				{
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_OBJECT(Local_328.f_1))
					{
						...
						AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_287, "COLLECT_IN_BAG", Local_328.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
					else
					{
						func_519("Golf club NOT attached to bag - correct?");
						AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_287, "COLLECT_OUT_BAG", Local_328.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
...
void func_323()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_328.f_1))
	{
		iLocal_237 = UI::ADD_BLIP_FOR_ENTITY(Local_328.f_1);
		UI::SET_BLIP_COLOUR(iLocal_237, 2);
	}
}
...
void func_326()
{
	if (func_506(Local_293))
	{
		...
		{
			AI::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_293, 0.3f);
		}
		else
		{
			AI::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_293, 0f);
		}
	}
}
...
int func_336(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_344() || func_343(Global_4456448.f_152990)) || func_342())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_341(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_340(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_337(int iParam0)
{
	if (iParam0 != func_339())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_338(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_360()
{
	switch (iLocal_69)
	{
		case 0:
			...
			iLocal_283 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_284 = GAMEPLAY::GET_GAME_TIMER();
			UI::SET_BLIP_SCALE(iLocal_237, 1f);
		...
		case 1:
			...
			else
			{
				...
				if (AI::GET_VEHICLE_WAYPOINT_TARGET_POINT(Local_317) >= 200)
				{
					iLocal_69 = 2;
				}
			}
...
void func_362()
{
	if (!UI::IS_MESSAGE_BEING_DISPLAYED() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
	{
		if (!func_14())
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_282) >= 6000)
			{
				func_287(&uLocal_72, 6, Local_293, "FOSTENBURG", 0, 1);
			...
			if (func_5(Local_317))
			{
				if (PED::IS_PED_IN_VEHICLE(Local_293, Local_317, 0))
				{
					if (iLocal_261 == 0)
					{
						if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317))
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293, Local_317, "NIGEL1DGOLF", 786468, 0, 8, -1, -1f, 0, 1073741824);
						}
					}
					else if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317))
					{
						iLocal_261 = 0;
					}
				}
	...
	if (iLocal_245 == 0)
	{
		if (func_371(0))
		{
			...
			while (iVar0 <= 1)
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_305[iVar0 /*13*/], "rcmnigel1d", Local_305[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0f, 0, 0, 0);
				}
				iVar0++;
			}
			iVar0 = 2;
			while (iVar0 <= 3)
			{
				if (func_6(Local_305[iVar0 /*13*/]))
				{
					AI::TASK_PLAY_ANIM(Local_305[iVar0 /*13*/], "mini@golf", Local_305[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0f, 0, 0, 0);
				}
				iVar0++;
			}
			iLocal_245 = 1;
...
void func_365(int iParam0)
{
	switch (iLocal_308[iParam0])
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, 0))
				{
					func_261(iParam0);
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_266(Local_305[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						...
						else
						{
							...
							AI::TASK_COMBAT_PED(Local_305[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							if (ENTITY::DOES_ENTITY_EXIST(Local_331[iParam0 /*6*/]))
							{
								if (ENTITY::IS_ENTITY_ATTACHED(Local_331[iParam0 /*6*/]))
								{
			...
			else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], true), 50f, 1))
			{
				func_290(Local_305[iParam0 /*13*/], 1);
				func_367(iParam0);
				if (!func_14() && !UI::IS_MESSAGE_BEING_DISPLAYED())
	...
	while (iVar0 <= 5)
	{
		if (func_506(Local_305[iVar0 /*13*/]))
		{
			if (Local_305[iVar0 /*13*/].f_10 == 0)
			{
				...
				{
					PED::SET_PED_CAN_BE_TARGETTED(Local_305[iVar0 /*13*/], true);
					AI::TASK_COMBAT_PED(Local_305[iVar0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
	...
	switch (iLocal_312)
	{
		...
		case 1:
			...
			if (!CAM::DOES_CAM_EXIST(iLocal_239))
			{
				...
				CAM::_0x0A9F2A468B328E74(iLocal_239, iLocal_241, 1500, 3);
			...
			if (func_506(PLAYER::PLAYER_PED_ID()))
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1368.33f, 56.4194f, 52.4637f, 1f, 20000, 0.25f, 0, 40000f);
			}
			iLocal_312 = 2;
			break;
		...
		case 3:
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1368.33f, 56.4194f, 52.4637f, 2f, 2f, 2f, false, true, 1))
			{
				...
				if (func_506(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1373.09f, 55.61f, 52.71f, 1f, 20000, 0.25f, 0, 40000f);
				}
				SYSTEM::WAIT(500);
				iLocal_312 = 4;
			}
		...
		case 4:
			if (!CAM::DOES_CAM_EXIST(iLocal_240))
			{
				...
				CAM::_0x0A9F2A468B328E74(iLocal_240, iLocal_239, 1500, 3);
			...
			{
				CAM::RENDER_SCRIPT_CAMS(true, true, 3000, 1, 0, 0);
				CAM::SET_CAM_ACTIVE(iLocal_240, 1);
				SYSTEM::WAIT(3500);
				iLocal_312 = 5;
			}
			if (CAM::IS_CAM_ACTIVE(iLocal_241))
			{
				CAM::SET_CAM_ACTIVE(iLocal_241, 0);
			}
			if (CAM::IS_CAM_ACTIVE(iLocal_239))
			{
				CAM::SET_CAM_ACTIVE(iLocal_239, 0);
			}
			break;
...
void func_377(int iParam0)
{
	...
	Global_106070.f_2355.f_539.f_2312[iParam0] = 1;
}
...
void func_381(int iParam0)
{
	switch (iLocal_311[iParam0])
	{
		case 0:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(Local_292[iParam0 /*13*/], 150319005) != 1)
				{
					AI::TASK_LOOK_AT_ENTITY(Local_292[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 500, 12, 2);
				}
			}
			...
			else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_292[iParam0 /*13*/], true), 30f, 1))
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
				{
					if (!func_14())
...
void func_383()
{
	if (func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_319(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				UI::SET_BLIP_FLASHES(iLocal_237, 1);
			}
		}
		else if (!UI::DOES_BLIP_EXIST(iLocal_237))
		{
		...
		{
			UI::SET_BLIP_FLASHES(iLocal_237, 0);
		}
	}
}
...
void func_386(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_455(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_388(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_388(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_244();
	...
	if (iParam4 == 1)
	{
		func_390(&(uParam0->f_2875), uParam0, iParam5, 1, 1, 0);
	}
	func_389(&(uParam0->f_2965));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_400(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_407(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_101(iParam1)];
...
void func_411(int iParam0, bool bParam1)
{
	...
	if (func_185(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_412(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_412(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_414(Var7.f_1)) && iVar9 < 50)
			{
...
int func_424(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_42() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_102(func_425(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_427(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_442(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_428(iVar0, 0), true);
...
Vector3 func_428(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_438(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_339())
			{
				if (func_437(Global_1589591))
				{
					return func_430(2, 2);
				}
				else if (func_429(Global_1589591))
				{
...
var func_444()
{
	...
	func_454(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_453(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_452(&uVar0, TIME::GET_CLOCK_HOURS());
	func_447(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_446(&uVar0, TIME::GET_CLOCK_MONTH());
	func_445(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_450(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_456(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_457(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_457(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_457(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_457(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_457(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_462(int iParam0)
{
	...
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_238))
		{
			iLocal_238 = func_463(-1377.18f, 55.39f, 53.7f, 0);
			UI::SET_BLIP_SPRITE(iLocal_238, 109);
		}
		iLocal_312 = 0;
	}
}
...
int func_463(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_464(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_465()
{
	while (iLocal_252 == 0)
	{
		if (func_466(0))
		{
			...
			AI::TASK_PLAY_ANIM(Local_298, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_298, true);
			PED::SET_PED_CAN_BE_TARGETTED(Local_298, false);
			if (func_506(Local_293))
			{
				Local_328.f_3 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(Local_293, true), 1067030938, 1069547520) };
			}
			...
			if (AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1D_SCENE"))
			{
				if (func_5(Local_317))
				{
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_317, "NIGEL_1D_GOLF_CART_A", 0);
				}
			}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_479(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_490(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_492(iParam0, Global_36117);
}
...
void func_497(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_498(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_507()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_320, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_320);
	...
	while (((((((!UI::HAS_ADDITIONAL_TEXT_LOADED(0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmnigel1d")) || !STREAMING::HAS_ANIM_DICT_LOADED("mini@golf")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DTRANS")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DGOLF")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DGOLF2")) || !AI::GET_IS_WAYPOINT_RECORDING_LOADED("NIGEL1DCRASH")) || !STREAMING::HAS_MODEL_LOADED(joaat("caddy")))
	{
		SYSTEM::WAIT(0);
	}
...
int func_521(var uParam0, var uParam1)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			AI::TASK_PLAY_ANIM(0, uParam0->f_48, "swing_a_mark", 8f, -2f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, uParam0->f_48, "swing_b_mark", 8f, -2f, -1, 0, 0f, 0, 0, 0);
			AI::SET_SEQUENCE_TO_REPEAT(iVar3, 1);
			AI::CLOSE_SEQUENCE_TASK(iVar3);
			AI::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], iVar3);
			AI::CLEAR_SEQUENCE_TASK(&iVar3);
			uParam0->f_28[1] = PED::CREATE_PED(26, iVar0[4], -1096.258f, 69.723f, 53.0107f, 163f, 1, true);
			AI::TASK_PLAY_ANIM(uParam0->f_28[1], uParam0->f_48, "idle_a_friend_watching", 8f, -8f, -1, 1, 0f, 0, 0, 0);
	...
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				...
				GAMEPLAY::CLEAR_AREA(-554.17f, 307.68f, 82.84f, 2f, 1, 0, 0, false);
		...
		case 39:
			if (bParam1)
			{
				...
				GAMEPLAY::CLEAR_AREA(-1035.73f, 365.44f, 68.91f, 35f, 1, 0, 0, false);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1035.73f, 365.44f, 68.91f, 27f, 0, 0, 0, 0, false, 0);
		...
		case 41:
			if (bParam1)
			{
				...
				GAMEPLAY::CLEAR_AREA(-1096.855f, 67.6858f, 52.952f, 15f, 1, 0, 0, false);
			}
			else
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_65, 0);
...
void func_523(bool bParam0)
{
	...
	if (!bParam0)
	{
		...
		GAMEPLAY::CLEAR_AREA(-1100.5f, 789.8f, 164.34f, 40f, 1, 0, 0, false);
	}
}
...
int func_542()
{
	...
	iVar0 = func_458(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
