...
void __EntryFunction__()
{
	...
	if ((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(16) || func_77()) || Global_2524719.f_1839)
	{
		func_76();
	}
	if (func_73(9) || (func_72() && !func_71()))
	{
		func_76();
	}
	...
	{
		SYSTEM::WAIT(0);
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_67() == 5)) && !func_56())
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_335, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_321)
				{
					case 0:
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_335, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > (3f + 2f))
			{
				func_76();
			}
		}
...
void func_1()
{
	...
	switch (iLocal_322)
	{
		case 0:
			...
			{
				if ((((func_45(vLocal_335, vVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_335)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_333, vLocal_334, 2f, 0, true, 0)) && func_44()) && !func_41(PLAYER::PLAYER_ID()))
				{
					if (iLocal_328 == -1)
					{
						func_40(&iLocal_328, 3, "SA_BED_IN", 0, 0, 0, 0);
					}
					iLocal_322 = 1;
				}
			}
		...
		case 1:
			if (func_39(1, 0, 1))
			{
				if (((((func_45(vLocal_335, vVar0) && func_49(8)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_335)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_333, vLocal_334, 2f, 0, true, 0)) && func_44()) && !func_41(PLAYER::PLAYER_ID()))
				{
					if (func_37(iLocal_328, 1))
					{
						func_35(&iLocal_328);
						func_34();
						Global_1573336 = 8;
						...
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_335, 3f, 0);
						func_27(PLAYER::PLAYER_ID(), 0, 256);
						iLocal_36 = 1;
						func_26();
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
						func_16(1, 1, 1, 0, 0);
						vLocal_335 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_329, sLocal_330, vLocal_337, vLocal_338, 0, 2) };
						vVar1 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_329, sLocal_330, vLocal_337, vLocal_338, 0, 2) };
						fLocal_336 = vVar1.z;
						AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_335, 1f, 5000, fLocal_336, 0.05f);
		...
		case 3:
			...
			func_11(1);
			UI::HIDE_HUD_AND_RADAR_THIS_FRAME();
			iLocal_327 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_326);
		...
		case 6:
			...
			if (!func_41(PLAYER::PLAYER_ID()) && CONTROLS::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				if (func_33("SA_BED_OUT"))
				{
					UI::CLEAR_HELP(1);
		...
		case 7:
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_335)) && !func_7()) && !func_5()) && Global_1312466.f_8 == 0)
			{
				bLocal_324 = true;
				iLocal_326 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_337, vLocal_338, 2, false, false, 1065353216, 0, 1065353216);
...
void func_3(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2409250.f_3 = NETWORK::GET_NETWORK_TIME();
	}
}
...
void func_16(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_21(PLAYER::PLAYER_ID())) && !func_18(PLAYER::PLAYER_ID(), 0)) && !func_17()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_21(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1368245.f_241.f_136[func_43(9) /*33*/][iParam0], func_42(9));
}
...
int func_45(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			...
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_38(0)) && !func_48())
				{
					if ((Global_90255 && Global_90256) || func_47())
					{
						return 0;
					}
					if (func_46(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_46(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
{
	if ((((((GAMEPLAY::IS_BIT_SET(Global_1573335, iParam0) || Global_1573336 != -1) || func_54()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_53()) || func_50(iParam0))
	{
		return 0;
	}
	return 1;
...
int func_56()
{
	...
	if (func_57() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_57()) == 0)
		{
			return 1;
		}
	}
