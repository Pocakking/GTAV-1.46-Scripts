...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_201(&Global_1654506);
		switch (func_200(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_199() == 2)
				{
			...
			case 2:
				if (func_199() == 2)
				{
					...
					else if (UI::DOES_BLIP_EXIST(Global_1654506))
					{
						func_12();
						UI::SET_BLIP_ROUTE(Global_1654506, 0);
						UI::REMOVE_BLIP(&Global_1654506);
						if (GAMEPLAY::IS_BIT_SET(iLocal_353, 3))
						{
							CUTSCENE::REMOVE_CUTSCENE();
						}
						GAMEPLAY::SET_BIT(&(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
...
void func_3()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_179 == 0)
		{
			GAMEPLAY::CLEAR_BIT(&iLocal_353, 0);
			GAMEPLAY::SET_BIT(&iLocal_353, 1);
			if (Local_103.f_2 != -1)
			{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_180[iLocal_179 /*3*/].f_2, 0))
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_353, 1);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_180[iLocal_179 /*3*/].f_2, 1))
				{
					GAMEPLAY::SET_BIT(&iLocal_353, 12);
					if (Local_103.f_2 == -1)
					{
		...
		if (iLocal_179 == 32)
		{
			if (GAMEPLAY::IS_BIT_SET(iLocal_353, 1))
			{
				GAMEPLAY::SET_BIT(&(Local_103.f_1), 0);
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 12))
			{
				if (Local_103.f_2 != -1)
				{
					Local_103.f_2 = -1;
...
void func_19()
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 2))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 5))
				{
					if (!func_197())
					{
						if (!func_196())
			...
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 5))
			{
				if (((((func_190(PLAYER::PLAYER_ID(), 1) || func_189()) || func_188() > 0) || func_187()) || func_185()) || func_184())
				{
					GAMEPLAY::SET_BIT(&iLocal_353, 5);
					func_12();
					if (UI::DOES_BLIP_EXIST(Global_1654506))
					{
						UI::SET_BLIP_ROUTE(Global_1654506, 0);
						UI::REMOVE_BLIP(&Global_1654506);
					}
				...
				else
				{
					if (UI::DOES_BLIP_EXIST(Global_1654506))
					{
						if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 14))
						{
							if (Local_103.f_2 != -1)
							{
								if (Local_103.f_2 != NETWORK::PARTICIPANT_ID_TO_INT())
								{
									UI::SET_BLIP_COLOUR(Global_1654506, 39);
									UI::SET_BLIP_SCALE(Global_1654506, 0.7f);
									GAMEPLAY::SET_BIT(&iLocal_353, 14);
								}
							}
						}
						else if (Local_103.f_2 == -1 || Local_103.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
						{
							UI::SET_BLIP_COLOUR(Global_1654506, 0);
							UI::SET_BLIP_SCALE(Global_1654506, 1f);
							GAMEPLAY::CLEAR_BIT(&iLocal_353, 14);
						}
					}
					if (GAMEPLAY::IS_BIT_SET(iLocal_353, 8))
					{
						GAMEPLAY::CLEAR_BIT(&iLocal_353, 8);
					}
					if (func_183())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							{
								if (!GAMEPLAY::IS_BIT_SET(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									GAMEPLAY::SET_BIT(&(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								}
								if (GAMEPLAY::IS_BIT_SET(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (Local_103.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										GAMEPLAY::SET_BIT(&iLocal_353, 25);
										GAMEPLAY::CLEAR_AREA(1274.854f, -1721.154f, 53.6808f, 2f, 1, 0, 0, true);
										if (bLocal_352)
										{
											func_179();
											uLocal_361 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
										}
										vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 1;
									}
									else if (Local_103.f_2 != -1)
									{
										if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 13))
										{
											if (func_174(1, 1, 1, 1))
											{
												func_173("FM_LCUT_LRB", -1);
												GAMEPLAY::SET_BIT(&iLocal_353, 13);
											}
										}
									}
								}
						...
						{
							if (!func_172("FM_LCUT_LCP"))
							{
								func_173("FM_LCUT_LCP", -1);
							}
						}
					}
					else
					{
						if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 9))
						{
							if (func_174(0, 1, 1, 1))
							{
								if (!func_187())
								{
									func_173("FM_LCUT_LBLP", -1);
									if (!UI::DOES_BLIP_EXIST(Global_1654506))
									{
										Global_1654506 = UI::ADD_BLIP_FOR_COORD(Global_1654507);
										UI::SET_BLIP_SPRITE(Global_1654506, 77);
										UI::SET_BLIP_FLASHES(Global_1654506, 1);
										UI::SET_BLIP_FLASH_TIMER(Global_1654506, 7000);
									}
									GAMEPLAY::SET_BIT(&iLocal_353, 2);
									GAMEPLAY::SET_BIT(&iLocal_353, 9);
								}
							}
						}
						if (GAMEPLAY::IS_BIT_SET(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
						{
							GAMEPLAY::CLEAR_BIT(&(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
						}
						if (GAMEPLAY::IS_BIT_SET(iLocal_353, 13))
						{
							GAMEPLAY::CLEAR_BIT(&iLocal_353, 13);
						}
					}
				}
			}
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					...
					{
						if ((((!func_190(PLAYER::PLAYER_ID(), 1) && !func_189()) && func_188() == 0) && !func_187()) && !func_185())
						{
							if (!func_171(&uLocal_356))
							{
								func_7(&uLocal_356, 0, 0);
							}
							else if (func_170(&uLocal_356, 10, 0))
							{
								GAMEPLAY::CLEAR_BIT(&iLocal_353, 5);
								GAMEPLAY::CLEAR_BIT(&iLocal_353, 2);
								GAMEPLAY::CLEAR_BIT(&iLocal_353, 3);
								GAMEPLAY::CLEAR_BIT(&iLocal_353, 8);
								func_169(&uLocal_356);
								if (!UI::DOES_BLIP_EXIST(Global_1654506))
								{
		...
		case 3:
			if (!GAMEPLAY::IS_BIT_SET(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				GAMEPLAY::SET_BIT(&(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			}
			break;
	...
	if (func_82())
	{
		...
		func_12();
		iVar0 = Global_1378933[func_81(-1)];
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_81(iParam2)];
	if (iVar0 != 0)
	{
...
int func_25(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_81(iParam1)];
...
int func_32(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_27() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_25(func_26(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_33(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_34())
	{
		iVar0 = Global_2566070[iParam0 /*3*/][func_81(iParam2)];
		if (iVar0 != 0)
		{
...
int func_39(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_81(iParam1)];
...
int func_68(int iParam0)
{
	if (Global_1312466.f_9 == 0)
	{
		if (iParam0 > -1)
		{
			...
			{
				return Global_1378945[func_81(-1)];
			}
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 787:
			Global_1378885[func_81(iParam2)] = iParam1;
			break;
		
		case 788:
			Global_1378891[func_81(iParam2)] = iParam1;
			break;
		
		case 789:
			Global_1378897[func_81(iParam2)] = iParam1;
			break;
		
		case 790:
			Global_1378903[func_81(iParam2)] = iParam1;
			break;
		
		case 777:
			Global_1378861[func_81(iParam2)] = iParam1;
			break;
		
		case 778:
			Global_1378867[func_81(iParam2)] = iParam1;
			break;
		
		case 779:
			Global_1378873[func_81(iParam2)] = iParam1;
			break;
		
		case 780:
			Global_1378879[func_81(iParam2)] = iParam1;
			break;
		
		case 767:
			Global_1378837[func_81(iParam2)] = iParam1;
			break;
		
		case 768:
			Global_1378843[func_81(iParam2)] = iParam1;
			break;
		
		case 769:
			Global_1378849[func_81(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_1378855[func_81(iParam2)] = iParam1;
			break;
		
		case 757:
			Global_1378909[func_81(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_1378915[func_81(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_1378921[func_81(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_1378927[func_81(iParam2)] = iParam1;
			break;
		
		case 1303:
			Global_1378933[func_81(iParam2)] = iParam1;
			break;
		
		case 7233:
			Global_1378939[func_81(iParam2)] = iParam1;
			break;
		
		case 639:
			Global_1378945[func_81(iParam2)] = iParam1;
			break;
		
		case 1278:
			Global_1378951[func_81(iParam2)] = iParam1;
			break;
		
		case 1876:
			Global_2568104[0 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 2267:
			Global_2568104[1 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 2929:
			Global_2568104[2 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3058:
			Global_2568104[3 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 8527:
			Global_2568229[func_81(iParam2)] = iParam1;
			break;
		
		case 764:
			Global_1378957[func_81(iParam2)] = iParam1;
			break;
		
		case 765:
			Global_1378963[func_81(iParam2)] = iParam1;
			break;
		
		case 766:
			Global_1378969[func_81(iParam2)] = iParam1;
			break;
		
		case 1236:
			Global_1378975[func_81(iParam2)] = iParam1;
			break;
		
		case 3053:
			Global_2568165[0 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3054:
			Global_2568165[1 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3055:
			Global_2568165[2 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3056:
			Global_2568165[3 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3057:
			Global_2568165[4 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3636:
			Global_2568232[0 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3637:
			Global_2568232[1 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3638:
			Global_2568232[2 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3639:
			Global_2568232[3 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3640:
			Global_2568232[4 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3641:
			Global_2568248[0 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3642:
			Global_2568248[1 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3643:
			Global_2568248[2 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3644:
			Global_2568248[3 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3645:
			Global_2568248[4 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3221:
			Global_2568165[5 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3227:
			Global_2568104[4 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3663:
			Global_2568264[func_81(iParam2)] = iParam1;
			break;
		
		case 3664:
			Global_2568273[func_81(iParam2)] = iParam1;
			break;
		
		case 3665:
			Global_2568267[func_81(iParam2)] = iParam1;
			break;
		
		case 3666:
			Global_2568276[func_81(iParam2)] = iParam1;
			break;
		
		case 3667:
			Global_2568270[func_81(iParam2)] = iParam1;
			break;
		
		case 3668:
			Global_2568279[func_81(iParam2)] = iParam1;
			break;
		
		case 3689:
			Global_2568282[func_81(iParam2)] = iParam1;
			break;
		
		case 3229:
			Global_2568165[6 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3230:
			Global_2568104[5 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3234:
			Global_2568165[7 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 3232:
			Global_2568104[6 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4019:
			Global_2568165[8 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4020:
			Global_2568104[7 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4022:
			Global_2568165[9 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4023:
			Global_2568104[8 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4025:
			Global_2568165[10 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4026:
			Global_2568104[9 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4028:
			Global_2568165[11 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 4029:
			Global_2568104[10 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6109:
			Global_2568165[12 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6110:
			Global_2568104[11 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6167:
			Global_2568165[13 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6168:
			Global_2568104[12 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6545:
			Global_2568165[14 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6546:
			Global_2568104[13 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6558:
			Global_2568165[15 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6559:
			Global_2568104[14 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6561:
			Global_2568165[16 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6562:
			Global_2568104[15 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6564:
			Global_2568165[17 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 6565:
			Global_2568104[16 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 7283:
			Global_2568104[17 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 7285:
			Global_2568104[18 /*3*/][func_81(iParam2)] = iParam1;
			break;
		
		case 7287:
			Global_2568104[19 /*3*/][func_81(iParam2)] = iParam1;
			break;
...
int func_83()
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 18))
			{
				if (!PED::IS_PED_INJURED(iLocal_182))
				{
					iLocal_355 = UI::ADD_BLIP_FOR_ENTITY(iLocal_182);
					UI::SET_BLIP_AS_FRIENDLY(iLocal_355, true);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_355, "FM_LEST_BLP");
					func_126("FM_LEST_GTL", 0);
					GAMEPLAY::SET_BIT(&iLocal_353, 18);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 20))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(iLocal_182))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1272.747f, -1715.223f, 53.45897f, 1273.732f, -1717.427f, 55.70897f, 2f, 0, 1, 0))
						{
							...
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_182, iLocal_185, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
							...
							GAMEPLAY::SET_BIT(&iLocal_353, 20);
						}
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 3))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_353, 3);
			}
			else if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 10))
			{
				if (CUTSCENE::_0xB56BBBCC2955D9CB())
				{
					CUTSCENE::_0x4C61C75BEE8184C2("MP_1", 0, 1);
					GAMEPLAY::SET_BIT(&iLocal_353, 10);
				}
			}
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (GAMEPLAY::IS_BIT_SET(iLocal_353, 10))
					{
						iLocal_181++;
					}
				}
		...
		case 1:
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				...
				func_120(PLAYER::PLAYER_ID(), 0, 32772);
				func_117(0);
				iLocal_181++;
			}
			break;
		...
		case 4:
			...
			else if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (GAMEPLAY::IS_BIT_SET(iLocal_353, 25))
				{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 11))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MP_1", 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_353, 11);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 26))
	{
		if (iLocal_181 > 2)
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					GAMEPLAY::SET_BIT(&iLocal_353, 26);
				}
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 19))
	{
...
void func_86(bool bParam0, int iParam1)
{
	...
	func_125(0);
	if (((((func_187() == 0 && func_97() == 0) && iParam1) && !func_95(PLAYER::PLAYER_ID())) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()) && func_93())
	{
		func_120(PLAYER::PLAYER_ID(), 1, 0);
	}
...
void func_87()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_171(&Global_2533115))
	{
		if (!func_170(&Global_2533115, 3500, 1) || NETWORK::_0x631DC5DFF4B110E3(PLAYER::PLAYER_ID()))
		{
			if (!func_92())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_91(&Global_2533115, 1, 0);
				}
...
void func_88(int iParam0)
{
	...
	{
		if (!func_170(&(Global_2533120[iParam0 /*2*/]), 3500, 1) || NETWORK::_0x631DC5DFF4B110E3(iParam0))
		{
			if (!func_92())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_91(&(Global_2533120[iParam0 /*2*/]), 1, 0);
				}
		...
		else
		{
			...
			func_169(&(Global_2533120[iParam0 /*2*/]));
...
void func_102(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_95(PLAYER::PLAYER_ID())) && !func_89(PLAYER::PLAYER_ID(), 0)) && !func_103()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_95(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_114()
{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_355))
	{
		UI::REMOVE_BLIP(&iLocal_355);
	}
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && PLAYER::IS_PLAYER_PLAYING(iParam0))
		{
			...
			else
			{
				if (!func_124(iVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar25))
				{
					...
					if (func_121(Global_4456448.f_152990))
					{
...
int func_132()
{
	switch (iLocal_360)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_361) && func_179())
			{
				func_161();
				func_160();
				func_157(0, 0, 1, 0, 1, 1, 0);
				func_120(PLAYER::PLAYER_ID(), 0, 8196);
				...
				{
					GAMEPLAY::CLEAR_AREA(1273.885f, -1718.004f, 53.7715f, 3f, 1, 0, 0, false);
					AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_183);
				...
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uLocal_361, "SET_DETAILS");
				func_153("FM_LEST_CAM");
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uLocal_361, "SET_LOCATION");
				func_153("FM_LEST_CAM2");
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
				if (GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() == -1)
				{
					GRAPHICS::SET_TIMECYCLE_MODIFIER("scanline_cam");
				}
				GAMEPLAY::SET_BIT(&iLocal_353, 15);
				...
				GAMEPLAY::SET_BIT(&iLocal_353, 23);
				if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 17))
				{
					if (OBJECT::_DOES_DOOR_EXIST(208246292))
					{
						OBJECT::_SET_DOOR_ACCELERATION_LIMIT(208246292, 0, 0, 0);
						GAMEPLAY::SET_BIT(&iLocal_353, 17);
					}
				}
				iLocal_360 = 1;
			}
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_183))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_353, 21))
				{
					if (func_170(&uLocal_363, 1000, 0))
					{
						AI::TASK_LOOK_AT_COORD(iLocal_183, 1276.409f, -1719.918f, 56.1054f, -1, 0, 2);
						GAMEPLAY::SET_BIT(&iLocal_353, 21);
					}
				}
			}
			if (func_170(&uLocal_363, 1500, 0))
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_353, 17))
				{
					if (!PED::IS_PED_INJURED(iLocal_183))
					{
						if (!PED::IS_PED_INJURED(iLocal_182))
						{
							if (func_138(&uLocal_186, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0))
							{
								func_169(&uLocal_363);
								func_7(&uLocal_363, 0, 0);
								iLocal_360++;
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_183))
			{
				if (!func_197())
				{
					...
					GAMEPLAY::SET_BIT(&iLocal_353, 22);
					AI::TASK_CLEAR_LOOK_AT(iLocal_183);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_183, 1273.576f, -1718.459f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					func_169(&uLocal_363);
					func_7(&uLocal_363, 0, 0);
					iLocal_360++;
				}
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_183))
			{
				if (func_170(&uLocal_363, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_183, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
					...
					func_137();
					func_86(1, 1);
					GAMEPLAY::CLEAR_BIT(&iLocal_353, 22);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					func_120(PLAYER::PLAYER_ID(), 1, 0);
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), 1);
					GAMEPLAY::SET_BIT(&iLocal_353, 25);
					NETWORK::_0xA2F952104FC6DD4B(0);
					GAMEPLAY::SET_BIT(&iLocal_353, 24);
					iLocal_360 = 99;
				}
			}
			break;
		...
		case 99:
			if (OBJECT::_DOES_DOOR_EXIST(208246292))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_353, 19);
				iLocal_360 = 100;
			}
			break;
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 15))
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_361))
		{
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uLocal_361, "SET_TIME");
			if (TIME::GET_CLOCK_HOURS() >= 0 && TIME::GET_CLOCK_HOURS() <= 12)
			{
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(TIME::GET_CLOCK_HOURS());
			}
			else
			{
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT((TIME::GET_CLOCK_HOURS() - 12));
			}
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(TIME::GET_CLOCK_MINUTES());
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 22))
	{
		if (!PED::IS_PED_INJURED(iLocal_183))
		{
			PED::SET_PED_CONFIG_FLAG(iLocal_183, 104, true);
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 23))
	{
		if (func_133())
		{
			GAMEPLAY::CLEAR_BIT(&iLocal_353, 23);
		}
	}
	return 0;
}
...
int func_133()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_182))
	{
		...
		{
			if (func_135(&iLocal_182, 12, 1276.39f, -1712.845f, 54.372f, 338.0729f, 1))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_182, 1);
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_182, true);
				func_134(&uLocal_186, 8, iLocal_182, "Lester", 0, 1);
	...
	{
		iLocal_185 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_182, iLocal_185, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
...
int func_135(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_137()
{
	...
	GAMEPLAY::CLEAR_BIT(&iLocal_353, 15);
...
bool func_138(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_145()
{
	...
	{
		if (func_147(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_146(PLAYER::PLAYER_PED_ID());
			if (func_116(iVar0) && (!func_148(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_116(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_152(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_157(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	int iVar0;
	...
	func_120(PLAYER::PLAYER_ID(), 0, iVar0);
	if (bParam5)
	{
...
void func_162()
{
	if ((!func_164() && !func_163()) && Global_2449168)
	{
...
void func_201(var uParam0)
{
	if (func_203(1))
	{
		if (UI::DOES_BLIP_EXIST(*uParam0) && !UI::IS_BLIP_SHORT_RANGE(*uParam0))
		{
			UI::SET_BLIP_AS_SHORT_RANGE(*uParam0, 1);
			unk_0xB552929B85FC27EC(*uParam0, 0);
			UI::SET_BLIP_PRIORITY(*uParam0, 5);
		}
	}
	else if (UI::DOES_BLIP_EXIST(*uParam0) && (UI::IS_BLIP_SHORT_RANGE(*uParam0) && !func_202()))
	{
		UI::SET_BLIP_AS_SHORT_RANGE(*uParam0, 0);
		unk_0xB552929B85FC27EC(*uParam0, 1);
	}
}
...
bool func_204(int iParam0, bool bParam1)
{
	...
	return Global_1625435[iParam0 /*560*/].f_11 != func_205();
}
...
int func_206(int iParam0)
{
	if (iParam0 != func_205())
	{
		if (Global_1625435[iParam0 /*560*/].f_11 != func_205())
		{
...
void func_207()
{
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 19))
	{
		...
		CONTROLS::ENABLE_CONTROL_ACTION(0, 14, 1);
		CONTROLS::ENABLE_CONTROL_ACTION(0, 15, 1);
	}
	if (func_210())
	{
		func_209();
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_353, 24))
	{
...
int func_211()
{
	...
	if (func_212() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_212()) == 0)
		{
			return 1;
		}
	}
...
{
	func_225(func_226(Param0), Param0);
	func_223(0, -1, 0);
