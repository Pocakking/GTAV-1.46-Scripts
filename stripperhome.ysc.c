...
void __EntryFunction__()
{
	...
	PLAYER::SET_HUD_ANIM_STOP_LEVEL(PLAYER::PLAYER_ID(), 1);
	...
	while (true)
	{
		...
		{
			func_243();
			iLocal_302 = (iLocal_302 - SYSTEM::ROUND((GAMEPLAY::GET_FRAME_TIME() * 1000f)));
		}
		switch (iLocal_72)
		{
			case -1:
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_271[0], 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar2) && !ENTITY::IS_ENTITY_DEAD(iVar2, 0))
			{
				if (iLocal_305)
				{
					...
					{
						func_57();
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_271[0], 0, 16777216);
						func_38();
					}
				}
...
void func_60(vector3 vParam0)
{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_277))
	{
		UI::REMOVE_BLIP(&iLocal_277);
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		return;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0, 0))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_271[0], 0))
		{
			...
			{
				if (!UI::DOES_BLIP_EXIST(iLocal_276))
				{
...
int func_61(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_62(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_66(char* sParam0, int iParam1, bool bParam2)
{
	...
	MemCopy(&sVar0, {func_70(iParam1)}, 6);
	if (!func_69(sParam0, &sVar0))
	{
		if (!bParam2)
		{
			func_68(sParam0, &sVar0, -1);
		}
		else
		{
			func_67(sParam0, &sVar0);
		}
	}
}
...
void func_68(char* sParam0, char* sParam1, int iParam2)
{
	UI::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
...
int func_69(char* sParam0, char* sParam1)
{
...
void func_82(char* sParam0, int iParam1)
{
	...
	MemCopy(&sVar0, {func_70(iParam1)}, 6);
	func_83(sParam0, &sVar0, 7500, 1);
}

void func_83(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
void func_85()
{
	...
	while (iVar0 < 1)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_278[iVar0]))
		{
			UI::REMOVE_BLIP(&(uLocal_278[iVar0]));
		}
		iVar0++;
	}
}
...
void func_92(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		AI::TASK_PLAY_ANIM(0, sVar2, func_93(0, bParam2, bParam1, bVar1), 8f, -8f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_93(1, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_93(2, bParam2, bParam1, bVar1), 8f, -4f, iParam3, 1, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_93(3, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_93(4, bParam2, bParam1, bVar1), 4f, -2f, -1, 0, 0f, 0, 0, 0);
				...
				if (func_138(iLocal_297, 0, sLocal_273, "", &Local_280, (func_188(&iLocal_252) * 0.2f), 0))
				{
					if (!func_164())
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_307))
						{
							if (ENTITY::GET_ENTITY_MODEL(iLocal_307) != joaat("blimp2"))
							{
								GAMEPLAY::CLEAR_AREA(vLocal_286, 20f, 1, 0, 0, false);
							}
						}
						else
						{
...
void func_135()
{
	...
	else
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_289, 1f, -1, 0.25f, 0, fLocal_293);
		if (iVar0 < 15000)
		{
			AI::TASK_PLAY_ANIM(0, sLocal_272, "fidget_rub_hands", 1.5f, -1f, -1, 8320, 0f, 0, 0, 0);
		}
		else if (iVar0 >= 15000 && iVar0 < 35000)
		{
			AI::TASK_PLAY_ANIM(0, sLocal_272, "fidget_rub_chin", 1.5f, -1f, -1, 8320, 0f, 0, 0, 0);
		}
		else
		{
			AI::TASK_PLAY_ANIM(0, sLocal_272, "fidget_arm_swing", 1.5f, -1f, -1, 8320, 0f, 0, 0, 0);
		}
		...
		case 2:
			if (fParam5 >= 0.5f)
			{
				if (uParam4->f_3 == 1)
				{
					...
					{
						GAMEPLAY::_SET_WEATHER_TYPE_OVER_TIME(sParam2, 1f);
					}
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1)
		{
			...
			if (iParam0 == PLAYER::PLAYER_PED_ID())
			{
				...
				if (fVar1 < fVar0)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_271[0], 0);
				}
			...
			if (iParam0 != PLAYER::PLAYER_PED_ID())
			{
				...
				if (func_25(iParam0, vParam1, 1) > 5f)
				{
					...
					AI::TASK_PLAY_ANIM(0, "gestures@f@standing@casual", "gesture_come_here_soft", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					...
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::TASK_PLAY_ANIM(0, "gestures@f@standing@casual", "gesture_come_here_soft", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "mini@strip_club@idles@stripper", "stripper_idle_01", 8f, -4f, -1, 0, 0f, 0, 0, 0);
				}
			}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		AI::TASK_VEHICLE_PARK(iParam0, iParam1, vLocal_287, fLocal_294, 3, 1092616192, 0);
	}
}
	...
	switch (iLocal_75)
	{
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_271[0], true), 3f, 3f, 3f, false, true, 0) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_307, 0) && func_226(iLocal_307, iLocal_271[0], 1) <= 10f))
			{
				...
				{
					UI::CLEAR_HELP(1);
					AI::CLEAR_PED_TASKS(iLocal_271[0]);
					func_224();
		...
		case 3:
			...
			if (!func_164())
			{
				if (func_180())
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_287, 10f, 0, 0, 0, 0, false, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_287, 10f, 0);
		...
		case 6:
			...
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_271[0]);
				func_212();
				UI::CLEAR_HELP(1);
			}
			break;
		...
		case 7:
			iLocal_76 = 7;
			if ((!func_164() && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !func_254(uLocal_300, 2048))
			{
				Var0 = { func_70(uLocal_74[0]) };
...
void func_204()
{
	...
	else if (func_254(uLocal_300, 4))
	{
		...
		bVar4 = AI::GET_SCRIPT_TASK_STATUS(iLocal_271[0], 242628503) == 7;
		...
		if ((((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || func_4(&iLocal_252) > 35f) || SYSTEM::VDIST(vLocal_287, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < 75f) || bVar3) || bVar6)
		{
			if (!bVar4 && !bVar2)
			{
				AI::TASK_PLAY_ANIM(iLocal_271[0], sVar0, func_93(4, 1, 1, func_96(iLocal_307)), 8f, -8f, -1, 0, 0f, 0, 0, 0);
			}
			if (bVar3)
			{
				iLocal_302 = 2000;
...
void func_209(float fParam0, vector3 vParam1)
{
	...
	if (!func_254(uLocal_298, 1) && !func_254(uLocal_298, 128))
	{
		if (SYSTEM::VDIST(vParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < 75f)
		{
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_287, 5f, 0, 0, 0, 0, false, 0);
		}
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_211(int iParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(108, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 10f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iParam0, PLAYER::PLAYER_PED_ID()))
		{
			return 1;
		}
	}
...
void func_238(int iParam0)
{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_278[iParam0]))
	{
		UI::REMOVE_BLIP(&(uLocal_278[iParam0]));
	}
	uLocal_278[iParam0] = func_239(iLocal_271[iParam0], 0, 145);
	Var0 = { func_70(uLocal_74[iParam0]) };
	UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_278[iParam0], &Var0);
}
...
int func_240(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_62(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_241(int iParam0, int iParam1)
{
	...
	{
		fVar3 = GAMEPLAY::ABSF((vVar0.z - vVar1.z));
		if (fVar3 > 8f)
		{
			return 1;
		}
...
void func_246(bool bParam0)
{
	...
	{
		iLocal_71 = func_162();
		func_152(&iLocal_71, 0, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 7), 0, 0, 0);
	}
	else if (bParam0)
	{
...
void func_265(int iParam0)
{
	...
	{
		func_268(iParam0, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3));
		func_267(iParam0, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3));
...
void func_290()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_271[0]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_271[0], 0))
		{
			if (!func_254(uLocal_300, 8192))
			{
				AI::TASK_WANDER_STANDARD(iLocal_271[0], 1193033728, 0);
			}
			PED::SET_PED_KEEP_TASK(iLocal_271[0], true);
			if (!unk_0xCC6E3B6BB69501F1(iLocal_70))
			{
	...
	PLAYER::SET_HUD_ANIM_STOP_LEVEL(PLAYER::PLAYER_ID(), 0);
