...
void func_6(int iParam0)
{
	...
	if (Global_1624079.f_7[iParam0 /*8*/].f_1 == 1 && iLocal_123 == iVar0)
	{
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_20(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_48()
{
	...
	bVar0 = false;
	iVar3 = func_28(iLocal_122, 0);
	iLocal_123 = Global_1624079.f_7[iVar3 /*8*/].f_2;
	...
	if (func_45(iVar4, 0, 1))
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_74(iVar4));
	...
	if (Global_1624079.f_7[iVar3 /*8*/] == 0)
	{
		if (Global_262145.f_14833)
		{
			...
			while (iVar8 < 3)
			{
				if (iVar9 < 3)
				{
					if (Global_1625435[iVar4 /*560*/].f_11.f_11[iVar8] != func_13())
					{
						if (func_45(Global_1625435[iVar4 /*560*/].f_11.f_11[iVar8], 0, 1))
						{
							uVar6[iVar9] = Global_1625435[iVar4 /*560*/].f_11.f_11[iVar8];
							iVar9++;
						}
					}
				}
			...
			else
			{
				...
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&cVar10);
				iVar8 = 0;
				while (iVar8 < iVar9)
				{
					Var11 = { func_80(uVar6[iVar8]) };
					UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&Var11);
					iVar8++;
				}
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			}
		...
		else
		{
			...
			GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(&cVar12);
	...
	else if (Global_1624079.f_7[iVar3 /*8*/] == 1)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_74(Global_1624079.f_7[iVar3 /*8*/].f_2));
...
void func_58(int iParam0)
{
	...
	func_59(&(Global_1379953[iVar2 /*5*/]));
...
char* func_60(int iParam0)
{
	...
	{
		sVar0 = func_71(&(Global_1625435[iParam0 /*560*/].f_11.f_99));
		return sVar0;
	}
	...
	if (iVar1 != func_13())
	{
		sVar0 = func_71(&(Global_1625435[iVar1 /*560*/].f_11.f_99));
...
int func_86(int iParam0, int iParam1)
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(-1);
	iVar1 = 1;
	iVar2 = func_77(Global_1624079.f_7[iParam0 /*8*/].f_2);
	if (iVar2 != -1)
	{
		iVar1 = func_75(iVar2);
	}
...
int func_88(int iParam0, int iParam1)
{
	...
	Var0 = { func_80(Global_1624079.f_7[iParam0 /*8*/].f_2) };
	func_87(&Var0);
	bVar1 = func_73(Global_1624079.f_7[iParam0 /*8*/].f_2);
	iVar2 = func_72(Global_1624079.f_7[iParam0 /*8*/].f_2);
	if (iVar2 == 0)
	{
		if (bVar1)
		{
	...
	else if (iVar2 == 1)
	{
		...
		UI::ADD_TEXT_COMPONENT_INTEGER(iVar2);
		GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
	}
	else
	{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(-1);
	iVar3 = 1;
	iVar4 = func_77(Global_1624079.f_7[iParam0 /*8*/].f_2);
	if (iVar4 != -1)
	{
		iVar3 = func_75(iVar4);
	}
...
void func_89()
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
	GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("STRING");
	UI::_SET_NOTIFACTION_COLOR_NEXT(func_74(PLAYER::PLAYER_ID()));
...
char* func_90()
{
	...
	if (iVar0 != func_13())
	{
		...
		sVar1 = func_71(&(Global_1625435[iVar0 /*560*/].f_11.f_99));
