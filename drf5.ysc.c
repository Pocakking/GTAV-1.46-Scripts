...
void __EntryFunction__()
{
	...
	iLocal_404 = func_264(func_265(), 0, 1);
	iLocal_405 = func_264(func_265(), 0, 1);
	iLocal_406 = func_264(func_265(), 0, 1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		...
		func_245(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
	}
	iLocal_62 = func_244();
	func_243(&Local_61, iLocal_62);
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				func_237(&uLocal_48, iLocal_55, iLocal_56, iLocal_57, iLocal_58, iLocal_59, func_244());
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 0.25f, 0, 40000f);
			...
			case 1:
				if (!bVar4)
				{
					if (func_233(&uLocal_48))
					{
						func_225(&iLocal_379, iLocal_55, vLocal_395, fLocal_397, iLocal_404, iLocal_405, iLocal_406);
						func_215(&Local_61, func_244());
						func_235(&iLocal_228);
						bVar4 = true;
					}
				}
				if (bVar4)
				{
					if (!bVar5)
					{
						if (CUTSCENE::_0xB56BBBCC2955D9CB())
						{
							...
							{
								func_128(&vLocal_387, PLAYER::PLAYER_PED_ID(), 0, 2);
							}
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_379, 0))
							{
								func_128(&vLocal_391, iLocal_379, 0, 2);
							}
							bVar5 = true;
						}
					}
				}
				if (func_126(&iVar6) > 6f && func_125())
				{
			...
			case 2:
				...
				{
					func_123(iLocal_379, 1, 0);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_391, 0))
				{
					func_123(iLocal_379, 0, 1);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					func_122(iLocal_379, &iLocal_381, &iLocal_382, &iLocal_384, &uLocal_63, vLocal_396, fLocal_399, iLocal_57);
					func_120(func_244());
					func_235(&iLocal_231);
					func_119(&iLocal_255, 0, 0, 0, 1);
					func_118(&iLocal_255, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_118(&iLocal_255, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					bVar5 = false;
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					iLocal_60 = 3;
			...
			case 3:
				...
				if (CAM::IS_SCREEN_FADED_OUT() || bVar14)
				{
					...
					func_111(&iLocal_231);
					while (func_126(&iLocal_231) < 0.4f)
					{
						SYSTEM::WAIT(0);
						func_112();
					}
				...
				if (!bVar2)
				{
					...
					{
						Local_61.f_20 = 0;
						func_99(&(Local_61.f_12), &Local_61, func_244());
						bLocal_407 = true;
					}
					if (func_89(&iLocal_231, &iLocal_255, &bVar1))
					{
						if (bVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_126(&iLocal_231) >= 14f)
					{
						Local_61.f_20 = 2;
						bVar2 = true;
						UI::CLEAR_HELP(1);
					}
					else if (!bVar3 && func_126(&iLocal_231) >= 7f)
					{
						StringCopy(&cVar11, "DRF_PROMPT", 16);
						func_88(&uLocal_63, &cVar10, &cVar11, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if ((func_126(&iLocal_231) > 5f && func_125()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_126(&iLocal_231) > fVar12) || func_85(iLocal_62, iLocal_379, &iLocal_384))))
				{
					func_82();
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
			...
			case 14:
				...
				if (((func_81() && CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_SCREEN_FADING_OUT()) && !CAM::IS_SCREEN_FADED_OUT())
				{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), true, 0);
							ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
							func_78(PLAYER::PLAYER_PED_ID(), -1902.609f, -559.9267f, 10.7916f);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382))
							{
								...
								{
									ENTITY::SET_ENTITY_COORDS(iLocal_382, func_69(iLocal_382), 1, 0, 0, 1);
							...
							if (CAM::IS_SCREEN_FADED_OUT())
							{
								if (!iLocal_408)
								{
									STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_68(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_408 = 1;
									SYSTEM::WAIT(0);
								}
								if (!iLocal_409)
				...
				else
				{
					if (!iLocal_408)
					{
						if (CUTSCENE::GET_CUTSCENE_TIME() > 60000)
						{
							if (iLocal_62 == 4)
							{
								STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_68(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_68(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_409)
					{
						if (CUTSCENE::_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_126(&iVar7) > func_66(func_244()))
							{
								if (func_244() == 4)
								{
									...
									PED::SET_PED_MONEY(iLocal_380, (2000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 301)));
									ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_380, 1, 1);
									func_65(&uLocal_63, 1, iLocal_380, "FRIEDLANDER", 0, 1);
								}
								iLocal_409 = 1;
							}
						}
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
				{
					func_262(80, 1);
					STATS::STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), 1, 1);
					func_88(&uLocal_63, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (UI::DOES_BLIP_EXIST(iLocal_383))
					{
						UI::SET_BLIP_COLOUR(iLocal_383, 1);
					}
					iLocal_60 = 17;
				}
				else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_380) || func_64(iLocal_380, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					func_88(&uLocal_63, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (UI::DOES_BLIP_EXIST(iLocal_383))
					{
						UI::SET_BLIP_COLOUR(iLocal_383, 3);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_380))
					{
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_380, true), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					...
					if (func_67(&iLocal_246))
					{
						if (func_126(&iLocal_246) > 2.5f)
						{
							PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 1000, 0f, 1, 0);
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
							func_124(&iLocal_246);
						}
					}
					if (!iLocal_411)
					{
						...
						if (func_126(&iLocal_243) > 2f)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_382) && !ENTITY::IS_ENTITY_DEAD(iLocal_382, 0))
							{
								...
								ENTITY::SET_ENTITY_INVINCIBLE(iLocal_382, 0);
					...
					{
						if (func_126(&iLocal_243) >= 2.66f)
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(func_51(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 2, -16f, 0f));
					...
					if (iLocal_410 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_49(&iLocal_237, 0.5f))
						{
							...
							if (!UI::DOES_BLIP_EXIST(iLocal_383))
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_380, 0))
								{
									iLocal_383 = UI::ADD_BLIP_FOR_ENTITY(iLocal_380);
									UI::SET_BLIP_COLOUR(iLocal_383, 1);
									func_111(&iLocal_237);
								}
							}
							else if (UI::GET_BLIP_COLOUR(iLocal_383) != 3)
							{
								UI::SET_BLIP_COLOUR(iLocal_383, 3);
								if (func_67(&iLocal_240))
								{
									if (func_126(&iLocal_240) < (7500f / 1000f))
									{
										func_48("SHRINK_KILL_B", 7500, 1);
									}
									else
									{
			...
			case 16:
				if (!func_67(&iLocal_234))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_235(&iLocal_234);
				}
				else if (func_126(&iLocal_234) > 2f)
				{
					func_2(func_36(), 24, func_35(iLocal_62));
					func_263();
					func_260(0, 0);
					func_245(&iLocal_379, &iLocal_382, iLocal_384, iLocal_60);
				}
			...
			case 17:
				...
				if (func_126(&iLocal_234) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
					UI::REMOVE_BLIP(&iLocal_383);
					if (CAM::DOES_CAM_EXIST(iLocal_384))
					{
						CAM::DESTROY_CAM(iLocal_384, 0);
					}
...
int func_2(int iParam0, int iParam1, int iParam2)
{
	...
	return func_3(Global_106070.f_28022[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_8() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_8() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_7(iParam0));
...
bool func_12(int iParam0)
{
	if (iParam0 == 8)
	{
		return func_13(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_13(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_13(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_13(137, -1, -1);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_8() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_13(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_15(iParam0, iParam1);
	uVar2 = func_14(iParam0);
	if (0 != iVar1)
	{
...
int func_18(int iParam0, int iParam1)
{
	...
	if (func_28(&Global_4268566))
	{
		if (func_26(&Global_4268566, iParam0))
		{
			return 0;
		}
		if (func_19(&Global_4268566, iParam0))
		{
			return 1;
		}
	}
...
void func_22(var uParam0)
{
	...
	func_24(uParam0, (Global_4268565 - 0.5f));
}
...
void func_37()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_40(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(iVar0) && (!func_30(14) || Global_105021))
			{
...
int func_41(int iParam0)
{
	...
	if ((func_44(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_42(iParam0))
	{
		...
		if (func_42(iVar0))
		{
			...
			{
				if (VEHICLE::_IS_CARGOBOB_HOOK_ACTIVE(iVar0))
				{
...
void func_46(int iParam0, float fParam1)
{
...
void func_52()
{
	...
	if (!func_67(&iLocal_249))
	{
		func_235(&iLocal_249);
	}
	if (!func_67(&iLocal_252))
	{
		func_235(&iLocal_252);
	}
	...
	if (iLocal_401 < 7)
	{
		if (iLocal_401 <= 0)
		{
			if (func_126(&iLocal_249) > 0.2f)
			{
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 7);
				GAMEPLAY::SET_BIT(&iLocal_400, iVar1);
				StringCopy(&Var0, "DRF_RUNOFF_", 16);
				StringIntConCat(&Var0, iVar1 + 1, 16);
				func_53(&uLocal_63, "DrfAud", "DRF_RUNOFF", &Var0, 8, 0, 0);
				iLocal_401 = 1;
				func_111(&iLocal_249);
			}
		}
		else if (func_126(&iLocal_249) > 12f)
		{
			if (fVar3 <= 144f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
			{
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, (7 - iLocal_401));
				while (iVar2 >= 0 && iVar2 < 7)
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_400, iVar2))
					{
						if (iVar1 == 0)
						{
							GAMEPLAY::SET_BIT(&iLocal_400, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
	...
	if (iLocal_403 < 8)
	{
		if (iLocal_403 <= 0)
		{
			if (func_126(&iLocal_252) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 8);
				GAMEPLAY::SET_BIT(&iLocal_402, iVar1);
				StringCopy(&Var0, "DRF_CHASE_", 16);
				StringIntConCat(&Var0, iVar1 + 1, 16);
				func_53(&uLocal_63, "DrfAud", "DRF_CHASE", &Var0, 8, 0, 0);
				iLocal_403 = 1;
				func_111(&iLocal_252);
			}
		}
		else if (func_126(&iLocal_252) > 10.3f)
		{
			if (fVar3 <= 2500f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, (8 - iLocal_403));
				iVar2 = 0;
				while (iVar2 >= 0)
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_402, iVar2))
					{
						if (iVar1 == 0)
						{
							GAMEPLAY::SET_BIT(&iLocal_402, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
			...
			{
				func_46(&iLocal_252, 5f);
			}
		}
	}
	if (((!iLocal_410 && iLocal_401 >= 1) && iLocal_403 >= 1) && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		iLocal_410 = 1;
	}
}

int func_53(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_63(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
		if (iParam4 < 12)
		{
...
void func_65(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
Vector3 func_69(int iParam0)
{
	...
	GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &uVar4, &Var5);
...
void func_70(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !func_72(PLAYER::PLAYER_ID(), 0)) && !func_71()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
Vector3 func_78(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_80()
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_381, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_381, 0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_382))
		{
			...
			{
				VEHICLE::SET_VEHICLE_FIXED(iLocal_382);
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_382, 1);
		...
		else
		{
			...
			AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_380);
			AI::TASK_STAND_STILL(iLocal_380, -1);
		}
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			if (!iLocal_408)
			{
				STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_68(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_408 = 1;
				SYSTEM::WAIT(0);
			}
		...
		{
			AI::OPEN_SEQUENCE_TASK(&uLocal_386);
			AI::TASK_ENTER_VEHICLE(0, iLocal_381, -1, -1, fVar0, 1, 0);
			AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_381, -1783.73f, -629.1945f, 9.89f, 20f, 0, ENTITY::GET_ENTITY_MODEL(iLocal_381), 786484, 10f, 12f);
			AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_381, 19f, 786484);
			AI::CLOSE_SEQUENCE_TASK(uLocal_386);
			AI::TASK_PERFORM_SEQUENCE(iLocal_380, uLocal_386);
	...
	GAMEPLAY::CLEAR_AREA(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, false);
...
int func_85(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_86())
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iParam1))
		{
			...
			{
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar1, &Var3, 2f, -1000f, -1, iVar0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(iParam1, &cVar1, &cVar4, 2f, -1000f, -1, iVar0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar2, &cVar5, 2f, -1000f, -1, 32 | iVar0, 0f, 0, 4, 0);
				AI::TASK_PLAY_ANIM(iParam1, &cVar2, &cVar6, 2f, -1000f, -1, 32 | iVar0, 0f, 0, 0, 0);
...
int func_89(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_67(iParam0) && func_126(iParam0) > 1.3f)
	{
		bVar0 = CONTROLS::IS_CONTROL_JUST_PRESSED(2, 201);
		bVar1 = CONTROLS::IS_CONTROL_JUST_PRESSED(2, 202);
		if (bVar0 || bVar1)
		{
			if (bVar0)
			{
	...
	func_90(iParam1, 1128792064, 1, 0, 1, 1065353216);
	return 0;
}

void func_90(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_95(iParam0->f_1, 256) || (func_95(iParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(func_95(iParam0->f_1, 4096));
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		}
		iVar5 = 0;
		iVar6 = 0;
		while (iVar6 < iParam0->f_123)
		{
			...
			if (bVar4)
			{
				if (GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(*iParam0, "SET_DATA_SLOT"))
				{
					...
					while (iVar7 < iParam0->f_2[iVar6 /*15*/].f_14)
					{
						...
						bVar2 = GAMEPLAY::IS_BIT_SET(iParam0->f_2[iVar6 /*15*/].f_13, iVar7);
					...
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(iParam0->f_2[iVar6 /*15*/]))
					{
						func_93(iParam0->f_2[iVar6 /*15*/]);
					}
					if (GAMEPLAY::IS_PC_VERSION())
					{
						if (func_95(iParam0->f_1, 4096))
						{
							if (iParam0->f_2[iVar6 /*15*/].f_1)
							{
								GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
								GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iParam0->f_2[iVar6 /*15*/].f_3[0 /*2*/].f_1);
							}
							else
							{
		...
		fVar8 = func_51(bParam4, func_51(func_95(iParam0->f_1, 32), 1f, 0f), -1f);
...
void func_99(char* sParam0, var uParam1, int iParam2)
{
	...
	iVar0 = func_110(uParam1->f_20);
	iVar0 |= 4;
	iVar0 = (iVar0 || func_100(uParam1, iParam2));
	iVar0 |= 98304;
	CUTSCENE::_REQUEST_CUTSCENE_EX(sParam0, iVar0, 8);
}
...
int func_100(var uParam0, int iParam1)
{
	...
	Var1 = { func_101(uParam0, &uVar0, iParam1, 1) };
	if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX01"))
	{
		return 8;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX02"))
	{
		return 16;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX03"))
	{
		return 32;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX04"))
	{
		return 64;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX05"))
	{
		return 128;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX06"))
	{
		return 256;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX07"))
	{
		return 512;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX08"))
	{
		return 1024;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX09"))
	{
		return 2048;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX10"))
	{
		return 4096;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX11"))
	{
		return 8192;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTSX12"))
	{
		return 16384;
	}
	return 8;
...
struct<4> func_101(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	struct<4> Var0;
	int iVar1;
	...
	if (func_109() <= 0)
	{
		if (!func_108())
		{
			iVar1 = func_105(1, 2, 3, 4, 12);
		}
		else if (func_104() >= 1)
		{
			iVar1 = func_105(5, 6, 7, 0, 0);
		}
		else
		{
			iVar1 = func_105(5, 7, 0, 0, 0);
		}
	}
	else if (func_109() >= 2)
	{
		iVar1 = func_105(10, 11, 0, 0, 0);
	}
	else if (!func_108())
	{
		if (iParam2 != 4)
		{
			iVar1 = func_105(8, 9, 0, 0, 0);
		}
		else
		{
			iVar1 = 9;
	...
	{
		iVar1 = func_105(8, 9, 10, 0, 0);
	}
	else
	{
		iVar1 = func_105(9, 10, 0, 0, 0);
	}
	func_103(uParam0, iVar1);
	if (bParam3)
	{
		func_102(&(Global_106070.f_19933), iVar1, 1);
	}
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_107(&(Global_106070.f_19933), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_107(&(Global_106070.f_19933), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_107(&(Global_106070.f_19933), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_107(&(Global_106070.f_19933), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_107(&(Global_106070.f_19933), iParam4))
	{
		iVar2[iParam4] = 0;
	}
	iVar1 = func_106(&iVar2, 13, 1, 13);
	if (iVar1 > 0)
	{
		return iVar1;
	}
...
void func_112()
{
	...
	{
		CONTROLS::DISABLE_CONTROL_ACTION(2, 200, 0);
	}
}
...
int func_118(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_119(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (*uParam0 == 0)
	{
	...
	if (GAMEPLAY::IS_PC_VERSION())
	{
		if (bParam3)
		{
			func_92(&(uParam0->f_1), 4096);
		}
	}
	if (bParam4)
	{
		func_92(&(uParam0->f_1), 8192);
	}
}
...
void func_122(int iParam0, var uParam1, int iParam2, int iParam3, var uParam4, vector3 vParam5, float fParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	*iParam2 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*iParam2, 1, 0);
		}
	}
	func_65(uParam4, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_65(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
...
void func_123(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar1, &cVar3, 1000f, -2f, -1, iVar0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar2, &cVar5, 1000f, -2f, -1, 32 | iVar0, 0f, 0, 4, 0);
		PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	}
	if (iParam2 && !PED::IS_PED_INJURED(iParam0))
	{
		...
		AI::TASK_PLAY_ANIM(iParam0, &cVar1, &cVar4, 1000f, -2f, -1, iVar0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(iParam0, &cVar2, &cVar6, 1000f, -2f, -1, 32 | iVar0, 0f, 0, 0, 0);
...
void func_129(int iParam0, var uParam1, int iParam2)
{
	...
	func_211(iParam0, &Var2, 0, -1);
	func_211(iParam0, uParam1, iParam2, -1);
	iVar5 = 0;
	iVar6 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
	{
		...
		{
			if (func_208(iVar4, func_210(iVar0), func_209(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_210(iVar0)), &uVar1))
			{
				Var3 = { func_140(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_138(iVar4, func_210(iVar0), func_209(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_210(iVar0)), &uVar1))
			{
				Var3 = { func_140(iVar4, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_208(iVar4, 14, func_131(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_140(iVar4, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_138(iVar4, 14, func_131(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_140(iVar4, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_209(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar8 = func_209(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar9 = func_130(iVar4, iVar8, iVar7);
		if (iVar9 != -99)
		{
			Var3 = { func_140(iVar4, 0, iVar9, -1) };
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_133(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_133(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
	...
	while (iVar4 <= (iVar2 - 1))
	{
		...
		else
		{
			...
			while (iVar5 <= (iVar6 - 1))
			{
				...
				{
					iVar3 = (iVar3 + func_132(iParam0, iParam3));
					return iVar3;
				}
				else
				{
	...
	else
	{
		...
		while (iVar5 < iVar7)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var4))
			{
				if (iParam1 == Var4.f_1)
				{
					return (func_134(iParam0, func_135(iParam2)) + iVar6);
				}
				iVar6++;
			}
			iVar5++;
...
struct<14> func_140(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_207();
...
void func_142(int iParam0)
{
	...
	func_143(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_143(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_146(func_148(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_146(func_145(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_144(iParam1, uParam0->f_2, &iVar1))
			{
...
int func_146(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_147(iParam1)];
...
void func_153(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_143(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_143(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_143(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_143(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_208(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
...
void func_211(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_214(iParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_213(iParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_38(iVar0))
		{
		...
		{
			if (func_212(161, iParam3))
			{
				uParam1->f_59 = func_146(2051, iParam3, 0);
			}
			else
			{
				uParam1->f_59 = func_146(752, iParam3, 0);
			}
			uParam1->f_60 = func_146(753, iParam3, 0);
			uParam1->f_61 = func_146(754, iParam3, 0);
		}
...
int func_212(int iParam0, var uParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_147(uParam1)];
...
void func_213(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_214(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_215(char* sParam0, int iParam1)
{
	...
	iVar1 = 15;
	iVar1 = (iVar1 || func_223(iParam1, 1));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(64, iVar0));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(func_216(iParam1), iVar0));
	CUTSCENE::_REQUEST_CUTSCENE_EX(sParam0, iVar1, 8);
}
...
int func_216(int iParam0)
{
	...
	Var1 = { func_217(iParam0, 1, 1, &uVar0) };
	if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW01"))
	{
		return 128;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW02"))
	{
		return 256;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW03"))
	{
		return 512;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW04"))
	{
		return 1024;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW05"))
	{
		return 2048;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW06"))
	{
		return 4096;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW07"))
	{
		return 8192;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW08"))
	{
		return 16384;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW09"))
	{
		return 32768;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW10"))
	{
		return 65536;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var1, "OBTOW11"))
	{
		return 131072;
	}
	return 128;
...
struct<4> func_217(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	struct<4> Var0;
	int iVar1;
	int iVar2;
	...
	if ((((!func_222(&(Global_106070.f_19933), 8) && iParam1) && iParam0 != 4) && func_220(3) > 0) && GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_222(&(Global_106070.f_19933), 1) && func_220(5) > 0)
		{
			GAMEPLAY::SET_BIT(&iVar2, 1);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 2) && func_220(7) >= 2)
		{
			GAMEPLAY::SET_BIT(&iVar2, 2);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 3) && ((((func_220(8) > 0 || func_220(9) > 0) && func_220(7) > 0) && iParam1) && iParam0 != 4))
		{
			GAMEPLAY::SET_BIT(&iVar2, 3);
			iVar3++;
		}
		if ((!func_222(&(Global_106070.f_19933), 4) && func_220(1) > 0) && func_220(1) < 3)
		{
			GAMEPLAY::SET_BIT(&iVar2, 4);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 5) && func_220(1) >= 3)
		{
			GAMEPLAY::SET_BIT(&iVar2, 5);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 6) && func_220(0) > 0)
		{
			GAMEPLAY::SET_BIT(&iVar2, 6);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 7))
		{
			GAMEPLAY::SET_BIT(&iVar2, 7);
			iVar3++;
		}
		if (((!func_222(&(Global_106070.f_19933), 8) && iParam1) && func_220(3) > 0) && iParam0 != 4)
		{
			GAMEPLAY::SET_BIT(&iVar2, 8);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 9))
		{
			GAMEPLAY::SET_BIT(&iVar2, 9);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 10))
		{
			GAMEPLAY::SET_BIT(&iVar2, 10);
			iVar3++;
		}
		if (!func_222(&(Global_106070.f_19933), 11))
		{
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar1 = func_219(7, 9, 10, 11, 0);
			}
			else
			{
				iVar1 = func_219(7, 9, 10, 0, 0);
			}
		}
		else
		{
			iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, iVar3 + 1);
			iVar5 = 1;
			while (iVar4 > 0)
			{
				if (GAMEPLAY::IS_BIT_SET(iVar2, iVar5))
				{
					iVar4 = (iVar4 - 1);
					if (iVar4 == 0)
					{
	...
	if (bParam2)
	{
		func_218(&(Global_106070.f_19933), iVar1, 1);
	}
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_222(&(Global_106070.f_19933), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar3 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_222(&(Global_106070.f_19933), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar3 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_222(&(Global_106070.f_19933), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar3 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_222(&(Global_106070.f_19933), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar3 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_222(&(Global_106070.f_19933), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar3 = true;
	}
...
int func_220(int iParam0)
{
	...
	{
		case 0:
			return func_221(&Global_89795, 1);
			break;
		
		case 1:
			return func_221(&Global_89797, 3);
			break;
		
		case 2:
			return func_221(&Global_89801, 1);
			break;
		
		case 3:
			return func_221(&Global_89803, 1);
			break;
		
		case 4:
			return func_221(&Global_89805, 1);
			break;
		
		case 5:
			return func_221(&Global_89807, 1);
			break;
		
		case 6:
			return func_221(&Global_89809, 1);
			break;
		
		case 7:
			return func_221(&Global_89811, 2);
			break;
		
		case 8:
			return func_221(&Global_89814, 1);
			break;
		
		case 9:
			return func_221(&Global_89816, 1);
			break;
	}
	return 0;
}
...
int func_223(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 1:
			if (func_224(20) && !func_224(59))
			{
				if ((!func_224(21) || func_224(72)) || func_224(73))
				{
					if (func_224(21))
					{
						return 64;
		...
		case 4:
			if ((func_224(48) && func_224(61)) && func_224(22))
			{
				if (func_224(27))
				{
					return 64;
				...
				else if (!func_224(84) && !func_224(85))
				{
					return 16;
				}
			}
...
void func_225(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
struct<6> func_232(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_247()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_248(&Global_89795, 1);
				break;
			
			case 1:
				func_248(&Global_89797, 3);
				break;
			
			case 2:
				func_248(&Global_89801, 1);
				break;
			
			case 3:
				func_248(&Global_89803, 1);
				break;
			
			case 4:
				func_248(&Global_89805, 1);
				break;
			
			case 5:
				func_248(&Global_89807, 1);
				break;
			
			case 6:
				func_248(&Global_89809, 1);
				break;
			
			case 7:
				func_248(&Global_89811, 2);
				break;
			
			case 8:
				func_248(&Global_89814, 1);
				break;
			
			case 9:
				func_248(&Global_89816, 1);
				break;
		}
		iVar1++;
	}
...
void func_250()
{
	...
	if (Global_106070.f_9057 || func_259(0))
	{
		if (!func_258())
		{
			iVar0 = func_257();
...
int func_252(int iParam0)
{
	...
	func_253(&(Global_106070.f_2355.f_539), iVar1);
...
void func_253(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_255(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
				Global_106070.f_18505[iVar0] = 318;
				func_254(&(uParam0->f_2276[iVar0]));
...
int func_255(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_255(8, uParam1, fParam2);
			break;
...
void func_260(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_259(0) && Global_71451.f_1 == 1) && func_261(Global_71451))
		{
		}
		else
		{
...
int func_264(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
