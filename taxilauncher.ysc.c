...
void func_1()
{
	if (!func_3())
	{
		...
		else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY(&Global_105126)) == 0)
		{
			func_2(0);
		}
	}
...
void func_5()
{
	...
	{
		UI::SET_BLIP_ROUTE(iLocal_63, false);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105102))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_240, "Aknowledge_R", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_105102, "Aknowledge_R", &cLocal_240, -4f);
			}
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_105102, &cLocal_240, "Aknowledge_L", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_105102, "Aknowledge_L", &cLocal_240, -4f);
			}
		}
	}
	if (iLocal_54 == 0)
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_56))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_56, 0))
								{
									if (PED::IS_PED_SITTING_IN_VEHICLE(Local_56.f_1, Local_56))
									{
										...
										AI::CLOSE_SEQUENCE_TASK(iVar0);
										AI::TASK_PERFORM_SEQUENCE(Local_56.f_1, iVar0);
										AI::CLEAR_SEQUENCE_TASK(&iVar0);
									}
									else
									{
...
void func_16()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (!PED::IS_PED_INJURED(iVar0))
		{
			...
			{
				AI::TASK_SMART_FLEE_PED(iVar0, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
			}
		}
	}
}
...
void func_31()
{
	if (func_41(&Global_105101, &Global_105102, iLocal_70, iLocal_69))
	{
		if (!func_35())
		{
			...
			if (UI::DOES_BLIP_EXIST(iLocal_63))
			{
				UI::SET_BLIP_FLASH_TIMER(iLocal_63, 10000);
			}
		}
		else
		{
	...
	else if (func_40(iLocal_67, 3000))
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
		{
			if (func_43())
			{
				...
				{
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FORGET_IT", 4f, -2f, -1, 48, 0f, 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FUCK_U", 4f, -2f, -1, 48, 0f, 0, 0, 0);
				}
			}
	...
	if (func_41(&Global_105101, &Global_105102, iLocal_70, iLocal_69))
	{
		...
		if (bVar0)
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
			{
				...
				{
					AI::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_R", 8f, -4f, -1, 16785456, 0f, 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_L", 8f, -4f, -1, 16785456, 0f, 0, 0, 0);
				}
				...
				AI::TASK_PERFORM_SEQUENCE(Global_105102, iVar2);
...
void func_49()
{
	...
	if (func_38(Global_105101))
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_63))
		{
			iLocal_63 = UI::ADD_BLIP_FOR_ENTITY(Global_105101);
			UI::SET_BLIP_SPRITE(iLocal_63, 198);
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_63, "TXM_BLIP");
			UI::SET_BLIP_FLASHES(iLocal_63, true);
			UI::SET_BLIP_FLASH_TIMER(iLocal_63, 10000);
		}
	}
}
...
int func_50(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		vVar3 = { vVar1 - vVar0 };
		vVar4 = { vVar2 - vVar0 };
		if (GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(vVar3.x, vVar3.y, vVar4.x, vVar4.y) < 90f)
		{
			return 1;
		}
	}
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
				{
					if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FORGET_IT", 3))
					{
						...
						if (func_60(iLocal_65, 1))
						{
							...
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_245, 5000, 0, 2);
							func_59();
							func_58();
							iLocal_67 = GAMEPLAY::GET_GAME_TIMER();
							func_8(&iLocal_65);
...
void func_59()
{
	...
	if (!Global_37270)
	{
		...
		if (CAM::_0xEE778F8C7E1142E2(CAM::_0x19CAFA3C87F7C2FF()) == 4)
		{
			...
			Var3.f_3 = 0f;
			Var3.f_4 = 1f;
			Var3.f_16 = GAMEPLAY::GET_HASH_KEY("UpperbodyAndIk_filter");
			iVar4 += 16;
			iVar4 += 32;
			iVar4 += 8192;
			Var3.f_20 = iVar4;
		...
		else
		{
			...
			Var3.f_3 = 0f;
			Var3.f_4 = 1f;
			Var3.f_16 = GAMEPLAY::GET_HASH_KEY("BONEMASK_HEAD_NECK_AND_L_ARM");
			iVar4 += 32;
			iVar4 += 8192;
			Var3.f_20 = iVar4;
		}
		WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar5, 1);
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 7) || (GAMEPLAY::ARE_STRINGS_EQUAL(Var3.f_2, "FP_HAIL_TAXI") && iVar5 == joaat("weapon_petrolcan")))
		{
			if (iVar5 != joaat("weapon_petrolcan") || !GAMEPLAY::ARE_STRINGS_EQUAL(Var3.f_2, "FP_HAIL_TAXI"))
			{
				PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 113, true);
			}
			AI::OPEN_SEQUENCE_TASK(&iVar0);
			AI::TASK_SWAP_WEAPON(0, 0);
			AI::TASK_SCRIPTED_ANIMATION(0, &Var3, &Var2, &Var2, 0.25f, 0.25f);
			AI::CLOSE_SEQUENCE_TASK(iVar0);
			AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar0);
			AI::CLEAR_SEQUENCE_TASK(&iVar0);
		}
		else
		{
			AI::TASK_SCRIPTED_ANIMATION(PLAYER::PLAYER_PED_ID(), &Var3, &Var2, &Var2, 0.25f, 0.25f);
		}
	}
	else
	{
		...
		if (!Local_56.f_3)
		{
			if (func_67(vVar0, Local_56.f_14, Local_56.f_6, &(Local_56.f_17), &(Local_56.f_6)))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_56.f_1, 0))
				{
					...
					if (Local_56.f_4)
					{
						AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56, Local_56.f_17, 10f, 0, ENTITY::GET_ENTITY_MODEL(Local_56), Local_56.f_29, 5f, GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, Local_56.f_17, true));
						Local_56.f_4 = 0;
					}
					else
					{
				...
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, *uParam3, uParam1, fParam2, &uVar4, iVar9, fVar0, fVar1))
				{
					...
					if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar5))
					{
						...
						if (func_77(vParam0, *uParam1) || fVar2 < 0.5f)
						{
							...
							if (!GAMEPLAY::IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(*uParam1, 3f, 3f, 3f, iVar3))
							{
								bVar8 = true;
							}
						}
		...
		if (func_40(Local_56.f_9, 10000))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_70))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_69))
				{
					...
					{
						GAMEPLAY::CLEAR_AREA(vVar0, 5f, 1, 0, 0, false);
			...
			*uParam0 = VEHICLE::CREATE_VEHICLE(func_143(), vParam2, fParam3, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0))
				{
					...
					ENTITY::_SET_ENTITY_REGISTER(*uParam0, true);
