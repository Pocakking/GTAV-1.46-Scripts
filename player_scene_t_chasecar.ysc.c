...
int func_2()
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_464))
	{
...
int func_40(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_48() || func_47(Global_4456448.f_152990)) || func_46())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_44(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_64(int iParam0, int iParam1)
{
	...
	switch (iLocal_480[iParam0])
	{
		...
		case 1:
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_450[iParam0]))
			{
				...
				if (!VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(iLocal_450[iParam0]))
				{
					if (!PED::GET_PED_TYPE(iLocal_447[iParam0]) == 6)
					{
						if (GAMEPLAY::IS_AREA_OCCUPIED(ENTITY::GET_ENTITY_COORDS(iLocal_450[iParam0], true) - Vector(1f, 1f, 1f), ENTITY::GET_ENTITY_COORDS(iLocal_450[iParam0], true) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0))
						{
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_447[iParam0]);
				if (!PED::GET_PED_TYPE(iLocal_447[iParam0]) == 6)
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				...
				{
					AI::TASK_COMBAT_PED(iLocal_447[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		case 2:
			...
			if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_447[iParam0], -258271821) != 1)
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				}
				else
				{
					AI::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_447[iParam0], fLocal_265);
				}
			}
			else
			{
		...
		case 4:
			...
			if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				...
				{
					AI::TASK_ENTER_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0], 20000, -1, 2f, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!PED::IS_PED_INJURED(iLocal_447[iParam0]))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_447[iParam0], 1805844857) != 1)
				{
					PED::SET_PED_CONFIG_FLAG(iLocal_447[iParam0], 29, true);
					AI::TASK_SMART_FLEE_PED(iLocal_447[iParam0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
				}
			}
			else
			{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				...
				{
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_458) && iLocal_461[iVar1] > 0)
					{
						...
						AI::TASK_VEHICLE_MISSION(iLocal_447[iVar1], iLocal_450[iVar1], 0, 15, 20f, iLocal_266, 0.5f, 2f, 1);
...
void func_84()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 4)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_458) && iLocal_461[iVar0] > 0)
			{
	...
	while (iVar0 < 4)
	{
		if (iLocal_451[iVar0] != 0)
		{
			GAMEPLAY::CLEAR_AREA(vLocal_456 + vLocal_452[iVar0 /*3*/], 20f, 1, 0, 0, false);
			...
			ENTITY::_SET_ENTITY_REGISTER(iLocal_450[iVar0], true);
		}
		if (iLocal_448[iVar0] != 0)
		{
...
void func_85()
{
	...
	switch (iLocal_268)
	{
		...
		case 275:
			...
			fLocal_453[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_453[2] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_453[3] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
		...
		case 277:
			...
			fLocal_453[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_453[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_453[2] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_453[3] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			iLocal_448[0] = joaat("s_m_y_ranger_01");
		...
		default:
			fVar5 = ((fLocal_457 + 90f) + GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			vLocal_452[0 /*3*/] = { Vector(0f, SYSTEM::COS(fVar5), SYSTEM::SIN(fVar5)) * FtoV(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(15f, 25f)) };
			fLocal_453[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			iLocal_454 = 0;
			iLocal_448[0] = joaat("a_m_y_genstreet_01");
			iLocal_448[1] = 0;
