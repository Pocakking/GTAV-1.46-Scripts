	...
	while (true)
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (iLocal_79 == 1)
			{
				...
				SOCIALCLUB::_0x040ADDCBAFA1018A(0, 1);
				iLocal_79 = 2;
			}
			if (iLocal_79 == 2)
			{
...
void func_1()
{
	iLocal_54 = GRAPHICS::_RETURN_TWO(Global_16861);
	switch (iLocal_54)
	{
		case 0:
			Global_16857 = 4;
...
void func_3()
{
	...
	{
		iLocal_51 = GAMEPLAY::GET_GAME_TIMER();
...
int func_15()
{
	...
	if ((func_21(2, Global_14480, 0) && !UI::IS_HUD_COMPONENT_ACTIVE(19)) && !GAMEPLAY::IS_STUNT_JUMP_IN_PROGRESS())
	{
		...
		if (UI::_GET_CURRENT_NOTIFICATION() == Global_16879 && UI::_GET_CURRENT_NOTIFICATION() != -1)
		{
			...
			iLocal_60 = 0;
			iLocal_61 = 0;
			while (((func_19(2, Global_14480) && iLocal_60 < 250) && Global_14689 == 0) && !UI::IS_HUD_COMPONENT_ACTIVE(19))
			{
				if (Global_3087 > 0)
				{
					func_16();
			...
			else if (Global_15822 == 4 || Global_15822 == 3)
			{
				...
				else
				{
					...
					if (Global_106070.f_28022[Global_1698 /*29*/].f_24[Global_14513] == 0)
					{
						...
						func_27(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1698 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_30(Global_14494, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_27(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), &(Global_106070.f_28022[Global_1698 /*29*/].f_7), &cVar0, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), 0);
					}
				}
				func_30(Global_14494, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_27(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
	...
	if (func_15() || GAMEPLAY::IS_BIT_SET(Global_2383, 8))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!PED::IS_PED_SWIMMING_UNDER_WATER(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("cellphone_flashhand")) == 0)
				{
					if (GAMEPLAY::IS_BIT_SET(Global_2384, 21))
					{
						GAMEPLAY::CLEAR_BIT(&Global_2384, 21);
...
void func_45()
{
	...
	if (((((((Global_4267065[Global_4268314 /*104*/].f_32 == 4 || Global_4267065[Global_4268314 /*104*/].f_32 == 5) || Global_4267065[Global_4268314 /*104*/].f_32 == 6) || Global_4267065[Global_4268314 /*104*/].f_32 == 7) || Global_4267065[Global_4268314 /*104*/].f_32 == 8) || Global_4267065[Global_4268314 /*104*/].f_32 == 9) || Global_4267065[Global_4268314 /*104*/].f_32 == 10) || Global_4267065[Global_4268314 /*104*/].f_32 == 11)
	{
		...
		while (iVar1 < Global_4267065[Global_4268314 /*104*/].f_49)
		{
			...
			{
				case 4:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2524719.f_1651[iVar1 /*4*/]));
					break;
				
				case 5:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654554[iVar1 /*4*/]));
					break;
				
				case 6:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654595[iVar1 /*4*/]));
					break;
				
				case 7:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654616[iVar1 /*4*/]));
					break;
				
				case 8:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654633[iVar1 /*4*/]));
					break;
				
				case 9:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654646[iVar1 /*4*/]));
					break;
				
				case 10:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654659[iVar1 /*4*/]));
					break;
				
				case 11:
					UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1654672[iVar1 /*4*/]));
					break;
			}
			iVar1++;
		}
		StringCopy(&cVar2, UI::_GET_LABEL_TEXT(&(Global_106070.f_28022[Global_4267065[Global_4268314 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar2, 0);
	...
	else
	{
		...
		if (Global_4267065[Global_4268314 /*104*/].f_17 == 145)
		{
			...
			uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar3, 0);
			GAMEPLAY::SET_BIT(&Global_4268330, 1);
			Global_16880 = 1;
			Global_16879 = uLocal_48;
		}
		...
		{
			StringCopy(&cVar4, UI::_GET_LABEL_TEXT(&(Global_106070.f_28022[Global_4267065[Global_4268314 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_4267065[Global_4268314 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar5, 0);
			}
			else
			{
				uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar4, 0);
			}
			GAMEPLAY::SET_BIT(&Global_4268330, 1);
			Global_16880 = 1;
			Global_16879 = uLocal_48;
...
void func_47()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2383, 1))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_45[Global_14513] = NETWORK::GET_NETWORK_TIME();
			iLocal_43[Global_14513] = 1;
		}
		else if (!GAMEPLAY::IS_BIT_SET(Global_2383, 10))
		{
			iLocal_44[Global_14513] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_43[Global_14513] = 1;
		}
		else
		{
			iLocal_44[0] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_44[2] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_44[1] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_43[0] = 1;
			iLocal_43[2] = 1;
			iLocal_43[1] = 1;
		}
...
void func_50()
{
	...
	if (((((((Global_106070.f_14113[Global_16889 /*104*/].f_32 == 4 || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 5) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 6) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 7) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 8) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 9) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 10) || Global_106070.f_14113[Global_16889 /*104*/].f_32 == 11)
	{
		...
		StringCopy(&cVar2, UI::_GET_LABEL_TEXT(&(Global_106070.f_28022[Global_106070.f_14113[Global_16889 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar2, 0);
		Global_16880 = 3;
		Global_16879 = uLocal_48;
		Global_16883 = 0;
	}
	else
	{
		...
		if (Global_106070.f_14113[Global_16889 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar3, &Global_3071, 64);
			StringConCat(&cVar3, "</C>", 64);
			uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar3, 0);
			Global_16880 = 3;
			Global_16879 = uLocal_48;
		}
		else
		{
			StringCopy(&cVar4, UI::_GET_LABEL_TEXT(&(Global_106070.f_28022[Global_106070.f_14113[Global_16889 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_106070.f_14113[Global_16889 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar5, 0);
			}
			else
			{
				uLocal_48 = UI::_SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar4, 0);
			}
			Global_16880 = 3;
			Global_16879 = uLocal_48;
			Global_16883 = 0;
...
void func_52()
{
	if (iLocal_43[Global_14513] == 1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_47 = NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_45[Global_14513]);
		}
		else
		{
			iLocal_46[Global_14513] = GAMEPLAY::GET_GAME_TIMER();
