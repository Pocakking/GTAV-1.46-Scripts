...
void __EntryFunction__()
{
	...
	if (Global_2621550)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-43879923) == 0)
		{
	...
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(1179280373) == 0)
		{
		...
		case 1:
			switch (ScriptParam_30.f_1)
			{
				...
				case 52:
					...
					{
						UI::_0x0CF54F20DE43879C(ScriptParam_30.f_3);
					}
					break;
				...
				case 76:
					if (Global_71471 != -1)
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								Global_71456 = { ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) };
							}
						}
...
void func_1(int iParam0, int iParam1)
{
	...
	GAMEPLAY::SET_BIT(&Global_71453, 0);
}
...
void func_35()
{
	...
	{
		case 1:
			Global_71455 = func_36(&Local_29, 1, 0, 1);
			break;
		
		case 7:
			Global_71455 = func_36(&Local_29, 0, 1, 1);
			break;
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	if (iParam5 == 0)
	{
		GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("PM_RP_STATD");
...
void func_66()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_69(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
