...
void __EntryFunction__()
{
	...
	iLocal_68 = 49;
	iLocal_69 = 64;
	iLocal_73 = UI::_0x4A9923385BDB9DAD();
	...
	while (true)
	{
		...
		if (iLocal_249 > GAMEPLAY::GET_GAME_TIMER())
		{
...
void func_5()
{
	...
	if (iLocal_223 == 0)
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_297))
		{
			UI::REMOVE_BLIP(&iLocal_297);
		}
	...
	if (iLocal_223 == 1)
	{
		...
		if (iLocal_426 == 1)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_235 + 3500)
				{
					if (AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_3_LOSE_COPS_PLANE"))
					{
						AUDIO::STOP_AUDIO_SCENE("SOL_3_LOSE_COPS_PLANE");
			...
			if (!PED::IS_PED_INJURED(iLocal_268[iLocal_231]))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_268[iLocal_231], 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_268[iLocal_231]);
							ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_268[iLocal_231]));
						}
						else if (func_13(PLAYER::PLAYER_PED_ID(), iLocal_268[iLocal_231]) > 20f)
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_268[iLocal_231], -1207174364) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_268[iLocal_231], -1207174364) != 0)
							{
								AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_268[iLocal_231], PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 1, 15f, 20f, 0, 0, -687903391);
							}
						}
						else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_268[iLocal_231], 780511057) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_268[iLocal_231], 780511057) != 0)
						{
							AI::TASK_COMBAT_PED(iLocal_268[iLocal_231], PLAYER::PLAYER_PED_ID(), 0, 16);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_286[0], 0))
				{
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_268[6]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_268[6], false);
								AI::CLEAR_PED_TASKS(iLocal_268[6]);
								AI::OPEN_SEQUENCE_TASK(&iLocal_304);
								AI::TASK_LEAVE_VEHICLE(0, iLocal_286[0], 256);
								AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								AI::CLOSE_SEQUENCE_TASK(iLocal_304);
								AI::TASK_PERFORM_SEQUENCE(iLocal_268[6], iLocal_304);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_268[7]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_268[7], false);
								AI::CLEAR_PED_TASKS(iLocal_268[7]);
								AI::OPEN_SEQUENCE_TASK(&iLocal_304);
								AI::TASK_LEAVE_VEHICLE(0, iLocal_286[0], 256);
								AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								AI::CLOSE_SEQUENCE_TASK(iLocal_304);
								AI::TASK_PERFORM_SEQUENCE(iLocal_268[7], iLocal_304);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						iLocal_344 = 1;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_286[1], 0))
				{
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_268[8]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_268[8], false);
								AI::CLEAR_PED_TASKS(iLocal_268[8]);
								AI::OPEN_SEQUENCE_TASK(&iLocal_304);
								AI::TASK_LEAVE_VEHICLE(0, iLocal_286[1], 256);
								AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								AI::CLOSE_SEQUENCE_TASK(iLocal_304);
								AI::TASK_PERFORM_SEQUENCE(iLocal_268[8], iLocal_304);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_268[9]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_268[9], false);
								AI::CLEAR_PED_TASKS(iLocal_268[9]);
								AI::OPEN_SEQUENCE_TASK(&iLocal_304);
								AI::TASK_LEAVE_VEHICLE(0, iLocal_286[1], 256);
								AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								AI::CLOSE_SEQUENCE_TASK(iLocal_304);
								AI::TASK_PERFORM_SEQUENCE(iLocal_268[9], iLocal_304);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
							}
						}
						iLocal_345 = 1;
			...
			if (!PED::IS_PED_INJURED(iLocal_268[10]))
			{
				...
				else if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -923.2303f, -2948.004f, 12.9451f, 2f, 2f, 2f, false, true, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_268[10]))
						{
							AI::CLEAR_PED_TASKS(iLocal_268[10]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_304);
							AI::TASK_PLAY_ANIM(0, "misssolomon_3", "plyr_roll_left", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(iLocal_304);
							AI::TASK_PERFORM_SEQUENCE(iLocal_268[10], iLocal_304);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
							iLocal_346 = 1;
						}
					}
...
void func_25(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_107(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
int func_53(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2566070[iParam0 /*3*/][func_51(iParam1)];
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_62(Var7.f_1)) && iVar9 < 50)
			{
...
int func_77(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_93(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_78(iVar0, 0), true);
...
void func_121()
{
	switch (iLocal_222)
	{
		case 2:
			...
			PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
			GAMEPLAY::CLEAR_AREA(-1026.8f, -492.1f, 36f, 18f, 1, 0, 0, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_279))
			{
				GAMEPLAY::CLEAR_AREA(vLocal_306, 5f, 1, 0, 0, false);
				...
				ENTITY::_SET_ENTITY_REGISTER(iLocal_279, true);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_290))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(-1037.398f, -491.6539f, 35.5545f, 5f, 1, 0, 0, false);
		...
		case 3:
			...
			PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
			func_184();
			GAMEPLAY::CLEAR_AREA(vLocal_307, 200f, 1, 0, 0, false);
		...
		case 5:
			iLocal_350 = 0;
			GAMEPLAY::CLEAR_AREA(-973.3f, -2967.7f, 13.5f, 100f, 1, 0, 0, false);
			SYSTEM::SETTIMERA(0);
		...
		case 8:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_284))
			{
				...
				ENTITY::SET_ENTITY_PROOFS(iLocal_284, true, true, true, true, true, false, 0, false);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
				iLocal_672 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_damage", iLocal_284, -11.956f, 10.528f, -7.657f, 0f, 2f, 0f, 1065353216, 0, 0, 0);
				ENTITY::SET_ENTITY_LOD_DIST(iLocal_284, 500);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_266))
			{
				...
				AI::TASK_SMART_FLEE_PED(iLocal_266, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
void func_124()
{
	if (iLocal_337 == 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_268[0]))
		{
			...
			AI::TASK_AIM_GUN_AT_ENTITY(iLocal_268[0], PLAYER::PLAYER_PED_ID(), -1, 1);
...
{
	return func_143(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
...
int func_160(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_161(iParam0, Global_70024.f_139[38], 0))
			{
				func_154(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_161(iParam0, Global_70024.f_139[43], 1))
			{
				func_154(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_70(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_164(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_172(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_171())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
{
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_185))
	{
		iLocal_91 = 0;
		func_208();
...
void func_215()
{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_298))
	{
		UI::REMOVE_BLIP(&iLocal_298);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_299))
	{
		UI::REMOVE_BLIP(&iLocal_299);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_300))
	{
		UI::REMOVE_BLIP(&iLocal_300);
	}
}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_266))
			{
				if (!PED::IS_PED_INJURED(iLocal_266))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
					{
						...
						{
							if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
							{
								if (AI::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 18)
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_296))
									{
									...
									AI::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_action", 1000f, -1000f, 4, 0, 1148846080, 0);
									AI::TASK_LOOK_AT_ENTITY(iLocal_266, PLAYER::PLAYER_PED_ID(), 9000, 1024, 3);
									iLocal_456 = 1;
									iLocal_457 = 0;
								}
							}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_266))
			{
				if (!PED::IS_PED_INJURED(iLocal_266))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_252))
					{
						...
						{
							iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_react_to_death", 1000f, -1.5f, 3, 16, 1148846080, 0);
							iLocal_458 = 1;
						}
					}
				}
		...
		if (iLocal_458 == 1 && iLocal_461 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_266))
			{
				if (!PED::IS_PED_INJURED(iLocal_266))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_252))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_266, GAMEPLAY::GET_HASH_KEY("ENDS_IN_RUN")))
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_304);
							...
							AI::CLOSE_SEQUENCE_TASK(iLocal_304);
							AI::TASK_PERFORM_SEQUENCE(iLocal_266, iLocal_304);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
...
void func_228()
{
	...
	if (iLocal_223 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
		{
			if (!PED::IS_PED_INJURED(iLocal_264))
			{
				if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
				{
					AI::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_264, 3f, 1);
				}
			}
		}
		if (!CAM::IS_SCREEN_FADED_IN())
	...
	if (iLocal_223 == 1)
	{
		...
		if (iLocal_420 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
			{
				if (!PED::IS_PED_INJURED(iLocal_264))
				{
					if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
					{
						if (AI::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 20)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
		...
		if (iLocal_443 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
			{
				if (!PED::IS_PED_INJURED(iLocal_264))
				{
					if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
					{
						if (AI::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 23)
						{
							AI::CLEAR_PED_TASKS(iLocal_264);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(iLocal_264, iLocal_251, "MISSSOLOMON_3", "molly_death", 1.5f, -8f, 4, 0, 1148846080, 0);
				...
				if (!PED::IS_PED_INJURED(iLocal_264))
				{
					if (iLocal_443 == 1)
					{
						...
						if (vLocal_318.y < -2965f)
						{
							...
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_264, 0);
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_264, 4000, 48, 4);
							iLocal_444 = 1;
						}
					}
				}
		...
		else if (iLocal_445 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_264))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_268[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_268[0]))
					{
						AI::CLEAR_PED_TASKS(iLocal_268[0]);
		...
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 574)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_294))
				{
					if (STREAMING::HAS_MODEL_LOADED(joaat("prop_jet_bloodsplat_01")))
			...
			if (iLocal_447[0] == 0)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 300)
				{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 700)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 1000)
				{
					if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_673))
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_673, 0);
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 1400)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_284))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_284, 0))
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_234 + 3500)
				{
					if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_673))
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_673, 0);
		...
		if (iLocal_459 == 0)
		{
			if (iLocal_422 == 1)
			{
				if (iLocal_460 == 0)
				{
					...
					{
						iLocal_244 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_460 = 1;
					}
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_244 + 2000)
				{
...
int func_231(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_232(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_232(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_233(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
	{
		...
		vVar4 = { 180f, 0f, 0f };
		iLocal_668 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar0, vVar4, 1065353216, 0, 0, 0);
		iLocal_669 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar1, vVar4, 1065353216, 0, 0, 0);
		iLocal_670 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar2, vVar4, 1065353216, 0, 0, 0);
		iLocal_671 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar3, vVar4, 1065353216, 0, 0, 0);
	}
}
...
void func_234()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_264))
	{
		if (!PED::IS_PED_INJURED(iLocal_264))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
			{
				...
				{
					AI::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_264, 2f, 1);
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -921.7f, -2946.4f, 13.4f, true) > 8f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_264))
				{
					if (func_16(PLAYER::PLAYER_PED_ID(), iLocal_264, 1) > 22f)
					{
						AI::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_264, 1f, 1);
					}
				}
	...
	if (iLocal_223 > 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_266))
		{
			...
			if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_airworker")) && STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3")) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_clipboard_01")))
			{
				...
				iLocal_252 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_266, iLocal_252, "misssolomon_3", "_start_loop", 1000f, -8f, 68, 0, 1148846080, 0);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
	...
	if (iLocal_223 == 0)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_264))
		{
			if (!UI::DOES_BLIP_EXIST(iLocal_297))
			{
				iLocal_297 = UI::ADD_BLIP_FOR_ENTITY(iLocal_264);
				UI::SET_BLIP_AS_FRIENDLY(iLocal_297, true);
			}
		}
	...
	if (iLocal_223 == 2)
	{
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -932.1196f, -2934.317f, 12.9448f, 2f, 2f, 2f, false, true, 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_264))
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_264, "BB_MOLLY_2", 10, 4, -1);
					AI::TASK_PLAY_ANIM(iLocal_264, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0f, 0, 0, 0);
				}
			}
			SYSTEM::SETTIMERA(0);
			iLocal_223 = 3;
	...
	if (iLocal_223 == 3)
	{
		if (!PED::IS_PED_INJURED(iLocal_264))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_264))
			{
				if (AI::GET_PED_WAYPOINT_PROGRESS(iLocal_264) > 18 && iLocal_405 == 0)
				{
					iLocal_350 = 0;
					AI::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_264, 3f, 1);
					iLocal_223 = 0;
		...
		if (SYSTEM::TIMERA() > 50000)
		{
			if (!PED::IS_PED_INJURED(iLocal_264))
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_264);
				ENTITY::SET_ENTITY_COORDS(iLocal_264, -932.5f, -2964.1f, 13.4f, 1, false, 0, 1);
				AI::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_264, "BB_MOLLY_2", 18, 4, -1);
				AI::TASK_PLAY_ANIM(iLocal_264, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0f, 0, 0, 0);
				iLocal_350 = 0;
				iLocal_223 = 0;
				iLocal_222 = 6;
...
void func_235(char* sParam0)
{
	if (iLocal_405 == 0)
	{
		...
		{
			func_225(0, 1, 1, 0);
			CAM::SET_CAM_ACTIVE(iLocal_301, 0);
...
void func_239(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_241(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
		...
		switch (iLocal_224)
		{
			case 0:
				if (iLocal_487[0] == 0)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 44255f && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -1187.3f, -2847.8f, 13.6f, true) < 100f)
							{
								UNK1::_0x293220DA1B46CEBC(10f, 2f, 3);
								iLocal_487[0] = 1;
							}
				...
				if (iLocal_487[1] == 0)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 52875f && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -1349f, -2720f, 14f, true) < 50f)
							{
				...
				if (iLocal_487[2] == 0)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
						{
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 87085f && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -1507f, -2520f, 14f, true) < 70f)
							{
								UNK1::_0x293220DA1B46CEBC(10f, 2f, 3);
								iLocal_487[2] = 1;
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_278))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
							{
								...
								{
									if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(-1149.6f, -2323.7f, 22.5f, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 130f)
									{
						...
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_280[1]))
						{
							...
							if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_280[1]) > 20000f)
							{
								if (func_16(PLAYER::PLAYER_PED_ID(), iLocal_280[1], 1) > 200f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_280[1]))
								{
									...
									VEHICLE::DELETE_VEHICLE(&(iLocal_280[1]));
									iLocal_249 = GAMEPLAY::GET_GAME_TIMER() + 1000;
								}
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_280[1]))
							{
								...
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 58000f)
								{
									if (!PED::IS_PED_INJURED(iLocal_270))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											...
											{
												AI::TASK_PLAY_ANIM(iLocal_270, "misstrevor4", "dive_clear_goon1", 8f, -8f, -1, 0, 0f, 0, 0, 0);
											}
										}
									}
									if (!PED::IS_PED_INJURED(iLocal_271))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											...
											{
												AI::TASK_PLAY_ANIM(iLocal_271, "misstrevor4", "dive_clear_goon2", 8f, -8f, -1, 0, 0f, 0, 0, 0);
											}
										}
									}
									iLocal_392 = 1;
							...
							if (iLocal_463 == 0)
							{
								if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_204[12]))
								{
									if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_204[12]) > 22216f && func_16(iLocal_279, iLocal_204[12], 1) < 90f)
									{
										...
										iLocal_245 = GAMEPLAY::GET_GAME_TIMER();
										iLocal_463 = 1;
									}
								}
							}
				...
				if (iLocal_462 == 0 && iLocal_463 == 1)
				{
					...
					vLocal_318 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_245 + 1579 || vLocal_318.y < vLocal_317.y)
					{
						GAMEPLAY::SET_TIME_SCALE(1f);
						CAM::STOP_GAMEPLAY_HINT(0);
						iLocal_462 = 1;
								...
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
								{
									if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
									{
										if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 108830f)
										{
											...
											ENTITY::_SET_ENTITY_REGISTER(iLocal_204[13], false);
											SYSTEM::SETTIMERA(0);
											iLocal_431 = 1;
										}
									}
			...
			case 1:
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_275[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_275[0]))
					{
						AI::CLEAR_PED_TASKS(iLocal_275[0]);
			...
			case 2:
				...
				if (iLocal_405 == 0)
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_318, -930.7f, -2916.9f, 13.4f, true) < 45f)
					{
						iLocal_224 = 3;
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_278))
					...
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_236 + 5000 && iLocal_439 == 1)
					{
						iLocal_224 = 3;
					}
				}
								...
								if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
								{
									if (!PED::IS_PED_INJURED(iLocal_264))
									{
										...
										if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											AI::TASK_SYNCHRONIZED_SCENE(iLocal_264, iLocal_250, "misssolomon_3", "molly_escapes_car_mol", 1000f, -1000f, 5, 0, 1148846080, 0);
					...
					if (iLocal_415 == 1)
					{
						if (!PED::IS_PED_INJURED(iLocal_264))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_264, -937.6656f, -2927.864f, 12.77007f, -934.8479f, -2929.484f, 14.46523f, 1.5f, 0, true, 0))
							{
								...
								AI::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_264, "BB_MOLLY_2", 1, 4, -1);
					...
					if (iLocal_425 == 0)
					{
						if (iLocal_424 == 0)
						{
							if (!PED::IS_PED_INJURED(iLocal_264))
							{
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
								{
									if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_250) > 0.18f || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -930.7f, -2916.9f, 13.4f, true) < 10f)
									{
										iLocal_225 = 0;
										iLocal_424 = 1;
									}
							...
							switch (iLocal_225)
							{
									...
									if (!PED::IS_PED_INJURED(iLocal_264))
									{
										if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_250) > 0.5f)
											{
												...
												CAM::SET_CAM_ACTIVE_WITH_INTERP(iLocal_302, iLocal_303, 4000, 1, 1);
												iLocal_248 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_225++;
											}
										}
									}
								...
								case 2:
									if (!PED::IS_PED_INJURED(iLocal_264))
									{
										if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_264, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											if ((iLocal_248 != -1 && CAM::_0xEE778F8C7E1142E2(0) == 4) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_248) >= 2230)
											{
											...
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_250) > 0.85f)
											{
												...
												iLocal_237 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_424 = 0;
												iLocal_425 = 1;
												iLocal_225++;
											}
	...
	else if (iLocal_400 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_272))
		{
			if (!PED::IS_PED_INJURED(iLocal_272))
			{
				...
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				AI::CLOSE_SEQUENCE_TASK(iLocal_304);
				AI::TASK_PERFORM_SEQUENCE(iLocal_272, iLocal_304);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_304);
				iLocal_400 = 1;
			}
		}
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
			{
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 55000f)
				{
					...
					if ((STREAMING::HAS_MODEL_LOADED(1938952078) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_fireman_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("missheist_agency3aig_lift_waitped_a"))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_282))
						{
							GAMEPLAY::CLEAR_AREA(-1129.566f, -2319.888f, 12.9445f, 10f, 0, 0, 0, false);
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_265[0]))
						{
							...
							AI::TASK_VEHICLE_SHOOT_AT_COORD(iLocal_265[0], -1147.07f, -2320.65f, 18.93f, 1101004800);
						}
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_265[1]))
						{
							iLocal_265[1] = PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), -1138.313f, -2313.277f, 12.9445f, 155.4271f, 1, true);
							AI::TASK_PLAY_ANIM(iLocal_265[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 8f, -8f, -1, 9, 0f, 0, 0, 0);
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_265[2]))
						{
							...
							AI::TASK_PLAY_ANIM(iLocal_265[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 8f, -8f, -1, 9, 0f, 0, 0, 0);
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_265[3]))
						{
							...
							AI::TASK_PLAY_ANIM(iLocal_265[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 8f, -8f, -1, 9, 0f, 0, 0, 0);
...
void func_265()
{
	...
	if (iLocal_402 == 1)
	{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_288[0], 0))
				{
					...
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_275[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_275[0]))
						{
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								AI::TASK_VEHICLE_CHASE(iLocal_275[0], PLAYER::PLAYER_PED_ID());
								PED::SET_PED_KEEP_TASK(iLocal_275[0], true);
							}
							else
							{
								AI::TASK_COMBAT_PED(iLocal_275[0], PLAYER::PLAYER_PED_ID(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_275[0], true);
							}
							VEHICLE::REMOVE_VEHICLE_RECORDING(1, "BB_AIChase");
							iLocal_238 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_429[0] = 1;
						}
					}
				}
		...
		if (iLocal_430[0] == 0)
		{
			if (iLocal_429[0] == 1)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_238 + 500)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_275[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_275[0]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								AI::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(iLocal_275[0], 16, 1);
								AI::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(iLocal_275[0], 1, 1);
								iLocal_430[0] = 1;
							}
							else
							{
...
void func_266()
{
	if (!iLocal_333)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[20], 0))
		{
			...
			CAM::SET_CAM_ACTIVE(iLocal_301, 1);
			iLocal_334 = 0;
			iLocal_333 = 1;
		}
	}
	else if (func_281(&uLocal_28, 1, 0, 0) && iLocal_405 == 0)
	{
		...
		if (iLocal_353 == 0)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(0f);
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			iLocal_243 = (GAMEPLAY::GET_GAME_TIMER() - 5000);
			iLocal_353 = 1;
		}
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_243 + 5000)
		{
			func_270();
			iLocal_243 = GAMEPLAY::GET_GAME_TIMER();
		}
		if (iLocal_354 == 0)
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
		...
		UI::SET_TEXT_RENDER_ID(iLocal_226);
	...
	if (!bLocal_88)
	{
		if (bLocal_87)
		{
			...
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				GAMEPLAY::CLEAR_AREA(vVar1, 1000f, 1, 0, 0, false);
			}
			bLocal_88 = true;
		}
	}
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam0))
			{
				...
				if (bLocal_85)
				{
					...
					{
						iLocal_172 = 0;
						fLocal_135 = (fLocal_135 + (GAMEPLAY::GET_FRAME_TIME() * 1000f));
					}
				}
			}
		}
		...
		while (iVar0 < 35)
		{
			if (iLocal_153[iVar0] != 99)
			{
					...
					if (iLocal_152[iVar0] > 0)
					{
						if (!iLocal_75)
						{
							if (fLocal_130 > (fLocal_122[iVar0] - (7000f * fParam1)))
							{
								...
								{
									GAMEPLAY::SET_BIT(&(iLocal_154[iVar0]), 0);
								}
								else if (VEHICLE::IS_THIS_MODEL_A_BIKE(iLocal_197[iVar0]))
								{
									GAMEPLAY::SET_BIT(&(iLocal_154[iVar0]), 2);
								}
								GAMEPLAY::CLEAR_BIT(&(iLocal_154[iVar0]), 1);
								iLocal_153[iVar0]++;
								iLocal_164++;
							}
						}
				...
				else if (iLocal_153[iVar0] == 1)
				{
					...
					if (GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 0))
					{
						STREAMING::REQUEST_MODEL(func_204());
						bVar8 = STREAMING::HAS_MODEL_LOADED(func_204());
					}
					else if (!bLocal_102 && ((!GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 2) && bVar10) || (GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 2) && uVar11)))
					{
						bVar8 = true;
					}
					else
							...
							if (STREAMING::HAS_MODEL_LOADED(iLocal_197[iVar0]) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_152[iVar0], &cLocal_185))
							{
								if (fLocal_130 >= (fLocal_122[iVar0] - (fLocal_143 * fParam1)))
								{
									if ((iLocal_89 || bParam2) || (!bLocal_106 && !func_321(vLocal_175[iVar0 /*3*/], vVar5, 5f, fLocal_141)))
									{
										...
										if (uLocal_98 && !GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 0))
										{
											func_319(iLocal_204[iVar0]);
										}
										if (GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 3))
										{
											ENTITY::_SET_ENTITY_REGISTER(iLocal_204[iVar0], true);
										}
				...
				{
					VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_152[iVar0], &cLocal_185);
					if (!GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 1))
					{
						bVar8 = false;
						if (GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 0))
						{
							...
							if (!bLocal_106 && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_204[iVar0], -1, 0))
							{
								if (bVar8)
								{
									if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_204[iVar0], true), vVar5) < 10000f || bParam2) || iLocal_89)
									{
										...
										GAMEPLAY::SET_BIT(&(iLocal_154[iVar0]), 1);
									}
								}
							}
						}
							...
							if (14 > iLocal_157)
							{
								...
								if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_152[iVar0], &cLocal_185))
								{
									if (fVar6 < VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(iLocal_152[iVar0], &cLocal_185))
									{
										...
										else if (((!bLocal_106 || GAMEPLAY::IS_BIT_SET(iLocal_154[iVar0], 1)) || iLocal_89) || bParam2)
										{
									...
									if (((!bLocal_79 && !iLocal_76) && !bLocal_95) && (((!bLocal_104 && !bLocal_103) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_204[iVar0])) || func_316(iLocal_204[iVar0])))
									{
										if (ENTITY::DOES_ENTITY_EXIST(iVar2))
										{
											...
											else
											{
												...
												else if (GAMEPLAY::ABSF((fVar7 - ENTITY::GET_ENTITY_SPEED(iLocal_204[iVar0]))) > 15f)
												{
													bVar8 = true;
												}
				...
				else if (iLocal_153[iVar0] == 5)
				{
					if (!iLocal_204[iVar0] == iLocal_208)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_204[iVar0], 0))
						{
							...
							if (!PED::IS_PED_INJURED(iVar1))
							{
								iVar14 = AI::GET_SCRIPT_TASK_STATUS(iVar1, 242628503);
								if (iVar14 == 7)
								{
									...
									AI::SET_DRIVE_TASK_CRUISE_SPEED(iVar1, fVar7);
								}
							}
						}
						if (!bLocal_87 && !bLocal_100)
...
int func_315(int iParam0, int iParam1, float fParam2)
{
	...
	fVar2 = GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(vVar0.x, vVar0.y, vVar1.x, vVar1.y);
	if (!fVar2 < fParam2)
	{
		return 0;
	}
...
void func_320(vector3 vParam0, vector3 vParam1, float fParam2)
{
	...
	if (!bLocal_88)
	{
		if (!func_321(vParam0, vParam1, fParam2, 200f))
		{
			...
			if (bVar0)
			{
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam0, fParam2, 0, 0, 0, 0, false, 0);
			}
		}
	}
}
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_203[iVar0]))
						{
							...
							if (STREAMING::HAS_MODEL_LOADED(iLocal_196[iVar0]))
							{
								if ((iLocal_75 || iLocal_89) || (!bLocal_106 && !func_321(vLocal_174[iVar0 /*3*/], vVar1, 5f, fLocal_141)))
								{
									...
									ENTITY::_SET_ENTITY_REGISTER(iLocal_203[iVar0], true);
		...
		while (iVar0 < 175 && !bVar17)
		{
			if (iLocal_150[iVar0] != 99)
			{
						...
						if (!iLocal_75)
						{
							if (fLocal_130 < (fLocal_113[iVar0] + 20000f))
							{
								if (fLocal_130 >= (fLocal_113[iVar0] - (7000f * fParam1)))
								{
									...
									{
										GAMEPLAY::SET_BIT(&(iLocal_151[iVar0]), 0);
									}
									else if (VEHICLE::IS_THIS_MODEL_A_BIKE(iLocal_195[iVar0]))
									{
										GAMEPLAY::SET_BIT(&(iLocal_151[iVar0]), 2);
									}
									GAMEPLAY::CLEAR_BIT(&(iLocal_151[iVar0]), 1);
									iLocal_165++;
									iLocal_150[iVar0]++;
								}
								else if (iVar1 > 2)
				...
				else if (iLocal_150[iVar0] == 1)
				{
					...
					bVar11 = false;
					if (GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 0))
					{
						STREAMING::REQUEST_MODEL(func_204());
					...
					else if (!bLocal_102 && ((!GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 2) && bVar13) || (GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 2) && uVar14)))
					{
						bVar11 = true;
					}
					else
						...
						if ((STREAMING::HAS_MODEL_LOADED(iLocal_195[iVar0]) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_149[iVar0], &cLocal_185)) && bVar11)
						{
							if (fLocal_130 >= (fLocal_113[iVar0] - (fLocal_143 * fParam1)))
							{
								if ((iLocal_89 || iParam2) || (!bLocal_106 && !func_321(vLocal_173[iVar0 /*3*/], vVar8, 5f, fLocal_141)))
								{
									...
									if (uLocal_98 && !GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 0))
									{
									...
									if (GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 3))
									{
										ENTITY::_SET_ENTITY_REGISTER(iLocal_201[iVar0], true);
									}
									if (!GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 0))
									{
				...
				else if (iLocal_150[iVar0] == 2)
				{
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 1))
						{
							if (GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 0))
							{
								STREAMING::REQUEST_MODEL(func_204());
								...
								if (!bLocal_106 && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_201[iVar0], -1, 0))
								{
									if (bVar11)
									{
										if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_201[iVar0], true), vVar8) < 10000f || iParam2) || iLocal_89)
										{
											...
											GAMEPLAY::SET_BIT(&(iLocal_151[iVar0]), 1);
										}
									}
								}
							}
								...
								if (12 > iLocal_156)
								{
									...
									if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_149[iVar0], &cLocal_185))
									{
										if (fVar9 < VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(iLocal_149[iVar0], &cLocal_185))
										{
											...
											else if (((!bLocal_106 || GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 1)) || iLocal_89) || iParam2)
											{
							...
							if (!PED::IS_PED_INJURED(iVar4))
							{
								if (bVar12)
								{
									...
									if (!bLocal_84)
									{
										...
										else if (((!bLocal_99 && !GAMEPLAY::IS_BIT_SET(iLocal_151[iVar0], 4)) && iVar2 < 3) && (iVar0 > iLocal_170 || iLocal_170 == 0))
										{
											vVar19 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iParam0, ENTITY::GET_ENTITY_COORDS(iLocal_201[iVar0], true)) };
											if (vVar19.y < 0f)
											{
												if (GAMEPLAY::ABSF(vVar19.y) > GAMEPLAY::ABSF(vVar19.x))
												{
													bVar18 = true;
												}
											}
...
void func_327(int iParam0, float fParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_201[iParam0], 0))
	{
		...
		if (!PED::IS_PED_INJURED(iVar0) && iVar0 != PLAYER::PLAYER_PED_ID())
		{
			...
			AI::TASK_VEHICLE_MISSION(iVar0, iLocal_201[iParam0], 0, 1, fParam1, 786603, 5f, 5f, 1);
			PED::SET_PED_FLEE_ATTRIBUTES(iVar0, 8192, 1);
			if (bLocal_108)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(iVar0, 65536, 1);
...
float func_335(int iParam0, int iParam1)
{
	...
	fVar4 = GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(Var0, Var0.f_1, vVar3.x, vVar3.y);
	return fVar4;
}
...
float func_337(int iParam0, int iParam1)
{
	...
	vVar1 = { vVar3 - vVar2 };
	fVar4 = GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(vVar1.x, vVar1.y, Var0, Var0.f_1);
	fVar4 = (fVar4 + -90f);
	if (fVar4 < 0f)
	{
		fVar4 = (fVar4 * -1f);
			...
			if (ENTITY::IS_ENTITY_A_VEHICLE(iParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iParam1), 0))
				{
					...
					if (fVar1 >= fVar2 || iParam4)
					{
						...
						UI::SET_BLIP_FLASHES(iParam0, true);
						UI::SET_BLIP_ALPHA(iParam0, (255 - iVar0));
					}
					else
					{
						UI::SET_BLIP_FLASHES(iParam0, false);
...
void func_342()
{
	if (iLocal_223 == 0)
	{
		...
		bLocal_95 = true;
		func_280();
		iLocal_226 = UI::GET_DEFAULT_SCRIPT_RENDERTARGET_RENDER_ID();
		GAMEPLAY::CLEAR_AREA(-823.71f, -2548.2f, 13.75f, 20f, 1, 0, 0, false);
...
void func_344(char* sParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (bParam2)
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar0, 500f, 0, 0, 0, 0, false, 0);
		}
	}
...
void func_345()
{
	...
	if (iLocal_223 == 1)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_308, true) < 800f)
			{
				iLocal_229 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2);
				if (iLocal_229 == 0)
				{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_308, true) < 600f)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_278))
			{
				STREAMING::REQUEST_MODEL(joaat("cogcabrio"));
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_308, true) < 500f)
		{
			if (iLocal_360 == 0)
			{
				iLocal_305 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("BREAKING_NEWS");
		...
		if (iLocal_372 == 0)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_230 + 135000))
			{
				UI::CLEAR_PRINTS();
			...
			switch (iLocal_225)
			{
				...
				case 1:
					...
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
					{
						...
						PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 3000, 0f, 1, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_365(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_362(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_357(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
int func_368(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (uParam0->f_2 == 1)
	{
		if (bParam2)
		{
			...
			if (bParam3)
			{
				GAMEPLAY::CLEAR_AREA(uParam1->f_2, 5000f, 1, 1, 0, false);
			}
		...
		else if (!uParam0->f_5)
		{
			...
			if (bParam3)
			{
				GAMEPLAY::CLEAR_AREA(uParam1->f_2, 5000f, 0, 1, 0, false);
			}
			func_390(&(uParam0->f_1), 0, 0, 0, TIME::GET_CLOCK_DAY_OF_MONTH(), TIME::GET_CLOCK_MONTH(), TIME::GET_CLOCK_YEAR());
			func_354(uParam0, 1, 0, 2000, 1, 1, 0, 1);
			uParam0->f_2 = 2;
...
{
	iParam0->f_1 = (func_381(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_397()
{
	if (iLocal_223 == 0)
	{
		GAMEPLAY::CLEAR_AREA(-920.0547f, -2744.662f, 12.8434f, 20f, 1, 0, 0, false);
		PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
		PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
		iLocal_223++;
	}
		...
		case 2:
			if (iLocal_223 > 0)
			{
				...
				if (iLocal_227 == 1)
				{
					if (iLocal_362 == 0)
					{
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_318, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 2f)
						{
							if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
					...
					if (iLocal_449 == 0)
					{
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_318, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 100f)
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
		...
		case 4:
			if (iLocal_223 >= 0)
			{
				if (iLocal_227 == 0)
				{
					...
					iLocal_477 = 0;
					iLocal_478 = 0;
					iLocal_241 = GAMEPLAY::GET_GAME_TIMER();
					func_17(&uLocal_490, 0, PLAYER::PLAYER_PED_ID(), "Michael", 0, 1);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_278))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
						{
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
							{
								...
								if (((VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 105500f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 119000f) && GAMEPLAY::GET_GAME_TIMER() > iLocal_241 + 7000) && iLocal_477 == 0)
								{
									if (!func_257())
									{
										if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (((VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 105500f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) < 119000f) && GAMEPLAY::GET_GAME_TIMER() > iLocal_241 + 7000) && iLocal_476 == 1)
								{
									if (!func_257())
									{
										if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
			...
			if (iLocal_223 > 0)
			{
				...
				if (iLocal_227 == 1)
				{
					...
					if (iLocal_480 == 1)
					{
							...
							if (!func_257())
							{
								if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								{
									if (func_258(&uLocal_490, "T1M4AUD", "SOL3_RUNS", 7, 0, 0, 0))
									{
										...
										iLocal_242 = GAMEPLAY::GET_GAME_TIMER();
										iLocal_452 = 1;
										iLocal_479 = 1;
										iLocal_480 = 0;
									}
						...
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_242 + 5000)
						{
							if (!func_257())
							{
								if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
					...
					if (iLocal_479 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_246 + 4000)
					{
						if (!func_257())
						{
							if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
		...
		case 8:
			if (iLocal_223 > 0)
			{
				...
				if (iLocal_227 == 1)
				{
					...
					if (iLocal_483 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_247 + 5000)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_277 = func_402(PLAYER::PLAYER_PED_ID(), -1533126372, 0, 0, 28);
...
void func_408()
{
	if (iLocal_349 == 1)
	{
		...
		if (iLocal_222 == 4)
		{
			if (iLocal_224 == 2)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_236 + 7000 && iLocal_439 == 0)
				{
					func_235("TRV4_FAIL1");
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_278))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_278))
					{
						...
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -1219f, -2570f, 13f, true) < 210f)
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (ENTITY::GET_ENTITY_HEADING(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 200f && ENTITY::GET_ENTITY_HEADING(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) > 125f)
									{
										...
										if (iLocal_438 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_239 + 4000)
										{
											func_235("TRV4_FAIL1");
										}
									}
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -928.9f, -2935f, 13f, true) < 5f && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				func_235("TRV4_FAIL1");
			}
		}
		...
		if (iLocal_222 == 4)
		{
			...
			if (iLocal_224 == 3)
			{
				if (iLocal_425 == 1)
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -934.4f, -2927.2f, 13.2f, true) > 25f || GAMEPLAY::GET_GAME_TIMER() > iLocal_237 + 12000)
					{
						func_235("TRV4_FAIL1");
					}
				}
					...
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_278) > 122000f)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (ENTITY::IS_ENTITY_UPSIDEDOWN(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
							{
								...
								if (iLocal_440 == 1)
								{
									if (GAMEPLAY::GET_GAME_TIMER() > iLocal_240 + 4000)
									{
										func_235("TRV4_FAIL1");
									}
								}
