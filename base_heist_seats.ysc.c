...
void func_11()
{
	...
	if (Global_1589596 == PLAYER::PLAYER_ID() && !GAMEPLAY::IS_BIT_SET(Global_1683625[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_64 == 0 && !GAMEPLAY::IS_BIT_SET(Global_1683625[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3)) && !func_16()) && !UI::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	{
		GAMEPLAY::SET_BIT(&iLocal_64, 0);
	}
	if (func_16())
	{
		GAMEPLAY::SET_BIT(&iLocal_64, 1);
	}
	if (UI::IS_PAUSE_MENU_ACTIVE())
	{
		GAMEPLAY::SET_BIT(&iLocal_64, 2);
	}
	if (func_14())
	{
		GAMEPLAY::SET_BIT(&iLocal_64, 4);
	}
	if (func_15(0))
	{
		GAMEPLAY::SET_BIT(&iLocal_64, 3);
	}
}
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_44(iParam0), func_43(iParam0), 0, 2) };
				iVar5 = vVar4.z;
...
int func_65()
{
	...
	if (func_66() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_66()) == 0)
		{
			return 1;
		}
	}
...
bool func_79(var uParam0, int iParam1)
{
	...
	if (func_82(PLAYER::PLAYER_ID()) || GAMEPLAY::IS_BIT_SET(iLocal_64, 0))
	{
		return 0;
	}
	vVar0 = { uParam0->f_1 };
...
void func_83(int iParam0, vector3 vParam1, float fParam2, vector3 vParam3, vector3 vParam4)
{
