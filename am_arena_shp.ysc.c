...
void func_1()
{
	...
	if (((func_13() && Local_22.f_61.f_2 == 1) && Local_22.f_61.f_13) && !Local_22.f_61.f_12)
	{
		if (GAMEPLAY::GET_FRAME_COUNT() - Local_22.f_61.f_14) >= func_12(Local_22.f_61.f_5)
		{
			...
			else if (Local_22.f_61.f_5 != 1 && !UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&(Local_22.f_61), Local_22.f_61.f_6, Local_22.f_61.f_4, Local_22.f_61.f_7, Local_22.f_61.f_1, Local_22.f_61.f_10))
			{
				iVar1 = 3;
			}
			else if (!UNK3::_NETWORK_SHOP_CHECKOUT_START(Local_22.f_61))
			{
				iVar1 = 4;
			}
			else
...
void func_17(int iParam0)
{
	...
	if (iVar1 || SCRIPT::GET_EVENT_DATA(1, iParam0, &Var0, 7))
	{
		...
		if (iVar3 != -1)
		{
			...
			{
				Global_4262927[iVar3 /*80*/].f_61.f_18 = GAMEPLAY::GET_FRAME_COUNT();
			}
		}
		bVar5 = true;
		if (iVar3 != -1)
							...
							else if (Global_4262927[iVar3 /*80*/].f_61.f_11 & 2 != 0)
							{
								...
								if (func_23(Global_4263480) && func_13())
								{
									if (!func_22(Global_4262927[iVar3 /*80*/].f_61))
									{
										...
										Global_4263408[iVar7 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
									}
								}
								else
								{
						...
						else if (Global_4262927[iVar3 /*80*/].f_61.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4263480) && func_13())
							{
								if (!func_22(Global_4262927[iVar3 /*80*/].f_61))
								{
									...
									Global_4263408[iVar8 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
								}
							}
							else
							{
					...
					else if (Global_4262927[iVar3 /*80*/].f_61.f_11 & 2 != 0)
					{
						...
						if ((func_23(Global_4263480) && func_13()) && func_31(Var0.f_2))
						{
							if (!func_22(Global_4262927[iVar3 /*80*/].f_61))
							{
								...
								Global_4263408[iVar9 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
							}
						}
						else
						{
...
int func_20(int iParam0)
{
	...
	if ((bVar0 || iVar1) || UNK3::_NETWORK_SHOP_CHECKOUT_START(Global_4262927[*iParam0 /*80*/].f_61))
	{
		if (iVar1 && !bVar0)
		{
		}
...
void func_32(int iParam0, bool bParam1)
{
	...
	{
		case 631654431:
			unk_0xE7DF4E0545DFB56E(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case -180141073:
			NETWORKCASH::NETWORK_SPENT_BUY_WANTEDLEVEL(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13), bVar1, iVar0);
			break;
		
		case 68030260:
			NETWORKCASH::NETWORK_SPENT_PAY_VEHICLE_INSURANCE_PREMIUM(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], &(Global_4262927[iParam0 /*80*/].f_13), bVar1, iVar0);
			break;
		
		case -982394051:
			NETWORKCASH::NETWORK_SPENT_CINEMA(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/].f_1, bVar1, iVar0);
			break;
		
		case 454359403:
			NETWORKCASH::NETWORK_SPENT_IN_STRIPCLUB(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, Global_4262927[iParam0 /*80*/].f_2, iVar0);
			break;
		
		case -1586170317:
			NETWORKCASH::_0x6816FB4416760775(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13.f_26), &(Global_4262927[iParam0 /*80*/].f_13.f_34));
			break;
		
		case 650665123:
			NETWORKCASH::NETWORK_SPENT_TELESCOPE(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case 1654961868:
			NETWORKCASH::NETWORK_SPENT_CALL_PLAYER(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13), bVar1, iVar0);
			break;
		
		case 1182673174:
			NETWORKCASH::NETWORK_SPENT_CARWASH(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], Global_4262927[iParam0 /*80*/].f_1, bVar1, iVar0);
			break;
		...
		case 1940862352:
			NETWORKCASH::_NETWORK_PAY_TAXES(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13.f_26), bVar1, iVar0);
			break;
		...
		case -516219046:
			NETWORKCASH::NETWORK_BUY_HEALTHCARE(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case 2043854386:
			NETWORKCASH::NETWORK_SPENT_CASH_DROP(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case 277665518:
			NETWORKCASH::NETWORK_SPENT_ARREST_BAIL(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case -96593501:
			NETWORKCASH::NETWORK_SPENT_BOUNTY(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case 634375935:
			unk_0xFC4EE00A7B3BFB76(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case 291576838:
			NETWORKCASH::NETWORK_BUY_ITEM(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], 14, 1, bVar1, &(Global_4262927[iParam0 /*80*/].f_13.f_26), 0, 0, 0, iVar0);
			break;
		
		case 1612072658:
			NETWORKCASH::NETWORK_SPENT_BUY_PASSIVE_MODE(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case -1186079845:
			NETWORKCASH::_NETWORK_EARN_FROM_CRATE_DROP(Global_4262927[iParam0 /*80*/].f_61.f_1);
			break;
		...
		case -1645229221:
			NETWORKCASH::NETWORK_PAY_EMPLOYEE_WAGE(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case -585718395:
			NETWORKCASH::NETWORK_PAY_UTILITY_BILL(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case 763367758:
			unk_0x5182A339A3474510(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		...
		case -2129781826:
			unk_0xB49ECA122467D05F(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], bVar1, iVar0);
			break;
		
		case 1941570214:
			unk_0x0FE8E1FCD2B86B33(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], bVar1, iVar0);
			break;
		
		case 1869490922:
			unk_0xD7CCCBA28C4ECAF0(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], Global_4262927[iParam0 /*80*/].f_1, bVar1, iVar0);
			break;
		...
		case -664597565:
		case -1100963799:
			NETWORKCASH::NETWORK_REFUND_CASH(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13.f_40), &(Global_4262927[iParam0 /*80*/].f_13.f_44), bVar1);
			break;
		...
		case 1643659499:
			NETWORKCASH::_NETWORK_SPENT_BUY_FERRISWHEEL_OR_ROLLERCOASTER(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/].f_1, bVar1, iVar0);
			break;
		
		case 1839532116:
			NETWORKCASH::_NETWORK_SPENT_MUGGED(Global_4262927[iParam0 /*80*/].f_61.f_1, 0, 0);
			break;
		...
		case 1948102096:
			NETWORKCASH::NETWORK_SPENT_REQUEST_JOB(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case -1834046564:
			NETWORKCASH::NETWORK_SPENT_TAXI(Global_4262927[iParam0 /*80*/].f_61.f_1, bVar1, iVar0);
			break;
		
		case 393059668:
			NETWORKCASH::NETWORK_EARN_FROM_MISSION_H(Global_4262927[iParam0 /*80*/].f_61.f_1, &(Global_4262927[iParam0 /*80*/].f_13.f_26));
			break;
		...
		case 1564537328:
			NETWORKCASH::_NETWORK_PAY_TAXES(Global_4262927[iParam0 /*80*/].f_61.f_1, "RaceToPoint", false, 0);
			break;
		...
		case 283351220:
			NETWORKCASH::NETWORK_BUY_ITEM(Global_4262927[iParam0 /*80*/].f_61.f_1, Global_4262927[iParam0 /*80*/], Global_4262927[iParam0 /*80*/].f_5, 1, bVar1, &(Global_4262927[iParam0 /*80*/].f_13.f_40), 0, 0, 0, iVar0);
			break;
		...
		case 1347433368:
			NETWORKCASH::_0xA03D4ACE0A3284CE(Global_4262927[iParam0 /*80*/].f_61.f_1);
			break;
