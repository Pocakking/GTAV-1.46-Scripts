...
void func_1()
{
	if (func_58(PLAYER::PLAYER_PED_ID()) && func_58(iLocal_50))
	{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_77) > 10000)
		{
			func_56(8);
			func_20();
		}
...
int func_24(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_30(&iVar2);
		iVar3 = func_29(Var1, Global_106070.f_7660.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_27(Global_106070.f_7660.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_25(Global_106070.f_7660.f_765[iVar2 /*10*/]))
				{
					Global_106070.f_7660.f_765[iVar2 /*10*/] = { Var1 };
					func_26(&Var1);
					return 1;
...
void func_59()
{
	if (func_58(iLocal_50) && func_67(iLocal_51))
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51, 0))
		{
			func_66(&uLocal_288);
			func_65(&iLocal_80);
			if (iLocal_78 == 0 && !UI::DOES_BLIP_EXIST(iLocal_79))
			{
		...
		{
			func_65(&iLocal_79);
			if (!UI::DOES_BLIP_EXIST(iLocal_80))
			{
...
void func_68()
{
	...
	if (func_58(iLocal_50) && func_67(iLocal_51))
	{
		...
		if (iLocal_256 == 0)
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_50, 40f, 40f, 40f, 0, 1, 0))
			{
				...
				if (iLocal_259 == 0)
				{
					...
					{
						if (((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51, 0) && PED::IS_PED_FACING_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 30f)) && func_75(iLocal_50, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7)) && !PED::IS_PED_RAGDOLL(iLocal_50)) && !AI::IS_PED_GETTING_UP(iLocal_50)) && func_2(&uLocal_82, "REBTHAU", "REBTH_APEBIK", 4, 0, 0, 0))
						{
							AI::TASK_PLAY_ANIM(iLocal_50, sLocal_269, "RETURNING_FRONT_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
		...
		else if (((!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, iLocal_50, 35f, 35f, 35f, 0, 1, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51, 0)) && !func_74()) && func_2(&uLocal_82, "REBTHAU", "REBTH_PLASTE", 4, 0, 0, 0))
		{
			...
			AI::TASK_COMBAT_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, iLocal_50, 20f, 20f, 20f, 0, 1, 0))
		{
			if (func_71())
			{
				if (!func_69(iLocal_50, 242628503))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&iLocal_53);
					if (iLocal_256 == 0)
					{
						AI::TASK_ENTER_VEHICLE(0, iLocal_51, 20000, -1, 2f, 8, 0);
					}
					else
					{
						AI::TASK_ENTER_VEHICLE(0, iLocal_51, 20000, -1, 2f, 262152, 0);
					}
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_51, fLocal_62, 786485);
					AI::CLOSE_SEQUENCE_TASK(iLocal_53);
					AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_53);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_53);
					PED::SET_PED_KEEP_TASK(iLocal_50, true);
				}
			}
			else
			{
				...
				{
					case 0:
						if ((((iLocal_259 == 1 && !func_69(iLocal_50, -2017877118)) && !PED::IS_PED_RAGDOLL(iLocal_50)) && !AI::IS_PED_GETTING_UP(iLocal_50)) && func_2(&uLocal_82, "REBTHAU", "REBTH_THANKS", 4, 0, 0, 0))
						{
							if (PED::IS_PED_FACING_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 30f) && AI::GET_SCRIPT_TASK_STATUS(iLocal_50, -875674219) == 7)
							{
								AI::TASK_PLAY_ANIM(iLocal_50, sLocal_269, "RETURNING_FRONT_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							}
							iLocal_257 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_256++;
						}
						else
						{
					...
					case 1:
						if (((((GAMEPLAY::GET_GAME_TIMER() - iLocal_257) > 10000 && !func_69(iLocal_50, -2017877118)) && !PED::IS_PED_RAGDOLL(iLocal_50)) && !AI::IS_PED_GETTING_UP(iLocal_50)) && func_2(&uLocal_82, "REBTHAU", sLocal_253, 4, 0, 0, 0))
						{
							if (PED::IS_PED_FACING_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 30f))
							{
								func_72(0);
								AI::TASK_PLAY_ANIM(iLocal_50, sLocal_270, "THANKS_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							}
							iLocal_257 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_256++;
						}
					...
					case 2:
						if (((((GAMEPLAY::GET_GAME_TIMER() - iLocal_257) > 10000 && !func_69(iLocal_50, -2017877118)) && !PED::IS_PED_RAGDOLL(iLocal_50)) && !AI::IS_PED_GETTING_UP(iLocal_50)) && func_2(&uLocal_82, "REBTHAU", sLocal_254, 4, 0, 0, 0))
						{
							if (PED::IS_PED_FACING_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 30f))
							{
								func_72(0);
								AI::TASK_PLAY_ANIM(iLocal_50, sLocal_268, "BIKE_BACK_NOW_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							}
							iLocal_256++;
						}
						else
	...
	if (func_58(iLocal_50))
	{
		if (iParam0 == 1)
		{
			if (!PED::IS_PED_IN_GROUP(iLocal_50) && func_58(PLAYER::PLAYER_PED_ID()))
			{
				...
				AI::TASK_LOOK_AT_ENTITY(iLocal_50, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
		}
...
bool func_75(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_44[iVar2 /*4*/].f_3) < iParam4);
}
...
void func_84()
{
	if (iLocal_78 == 0 && func_58(iLocal_50))
	{
		if (func_69(iLocal_50, 242628503))
		{
			AI::CLEAR_PED_TASKS(iLocal_50);
		}
		if ((((!func_69(iLocal_50, -2017877118) && !PED::IS_PED_FACING_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 20f)) && AI::GET_SCRIPT_TASK_STATUS(iLocal_50, -875674219) == 7) && !PED::IS_PED_RAGDOLL(iLocal_50)) && !AI::IS_PED_GETTING_UP(iLocal_50))
		{
			AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_50, PLAYER::PLAYER_PED_ID(), 0);
			AI::TASK_LOOK_AT_ENTITY(iLocal_50, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
		}
	}
}
...
void func_86()
{
	if (func_58(iLocal_49))
	{
		if (iLocal_68 == 0)
		{
			...
			AI::TASK_SMART_FLEE_PED(iLocal_49, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
			iLocal_68 = 1;
		}
		else
		{
...
void func_88()
{
	if ((func_58(iLocal_49) && func_58(iLocal_50)) && func_67(iLocal_51))
	{
		if (func_95())
		{
			...
			AI::TASK_START_SCENARIO_IN_PLACE(iLocal_50, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			func_90();
		}
		else
		{
...
void func_97()
{
	if (func_98())
	{
		...
		if (func_58(iLocal_50))
		{
			AI::TASK_CLEAR_LOOK_AT(iLocal_50);
		}
	...
	{
		if (((bLocal_272 == 0 && UI::DOES_BLIP_EXIST(iLocal_79)) && func_58(PLAYER::PLAYER_PED_ID())) && func_58(iLocal_49))
		{
			if (func_57(PLAYER::PLAYER_PED_ID(), iLocal_49, 1) < 30f || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_49, true), 10f, 1))
			{
				bLocal_272 = true;
				UI::_0x75A16C3DA34F1245(iLocal_79, bLocal_272);
			}
		}
		if (((iLocal_263 == 2 && func_58(iLocal_49)) && func_67(iLocal_51)) && PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_51, 0))
		{
			...
			else if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_51) || func_220(iLocal_51, vLocal_261, 1) < 5f)
			{
				...
				AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_49, iLocal_51, PLAYER::PLAYER_PED_ID(), 8, fLocal_62, 786468, 10f, 1f, 0);
			}
		}
	}
}
...
void func_99()
{
	if ((func_58(iLocal_49) && func_67(iLocal_51)) && PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_51, 0))
	{
		if (iLocal_67)
		{
			...
			{
				fLocal_62 = fLocal_64;
				AI::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_49, fLocal_62);
				AI::TASK_LOOK_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 20000, 16, 2);
				iLocal_67 = 0;
			}
		}
...
void func_100()
{
	if (((((((((iLocal_73 < 5 && !func_19()) && func_58(iLocal_49)) && func_58(iLocal_50)) && func_67(iLocal_51)) && PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_51, 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 13f, 13f, 13f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50, iLocal_49, 13f, 13f, 13f, 0, 1, 0)) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_74) > 15000) && func_2(&uLocal_82, "REBTHAU", sLocal_252, 4, 0, 0, 0))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(iLocal_49, -1273030092) == 1 && !AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_49))
		{
			AI::TASK_DRIVE_BY(iLocal_49, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 15f, 50, 1, -753768974);
		}
...
void func_101()
{
	if ((((iLocal_258 == 0 && func_58(iLocal_50)) && func_58(iLocal_49)) && func_67(iLocal_51)) && PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_51, 0))
	{
		if (iLocal_273 == 0)
		{
			...
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_50);
				AI::OPEN_SEQUENCE_TASK(&iLocal_53);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_49, -1, 2048, 2);
				AI::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_57, 2f, 20000, 1193033728, 1056964608);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_51, 1000);
				AI::TASK_PLAY_ANIM(0, sLocal_265, sLocal_266, 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_C", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_267, "IDLE_C", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_53);
				AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_53);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_53);
				iLocal_74 = GAMEPLAY::GET_GAME_TIMER();
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_49))
	{
		...
		else if (func_148())
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0) && !PED::IS_PED_INJURED(iLocal_49))
			{
				if (iLocal_263 == 2)
				{
					AI::TASK_ENTER_VEHICLE(iLocal_49, iLocal_51, 20000, -1, 2f, 1, 0);
				}
				else
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_53);
					AI::TASK_ENTER_VEHICLE(0, iLocal_51, 20000, -1, 2f, 1, 0);
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_51, PLAYER::PLAYER_PED_ID(), 8, fLocal_62, 786468, 10f, 1f, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_53);
					AI::TASK_PERFORM_SEQUENCE(iLocal_49, iLocal_53);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_53);
					PED::SET_PED_KEEP_TASK(iLocal_49, true);
				}
			}
...
int func_149()
{
	...
	if (func_58(iLocal_50))
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_50, 31086, 0f, 0f, 0f), 3f, 1))
		{
			return 1;
		}
...
void func_150()
{
	if (iLocal_66 == 0)
	{
		...
		GAMEPLAY::CLEAR_AREA(vLocal_56, 20f, 1, 0, 0, false);
		iLocal_66 = 1;
	}
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_strpunk_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beachvesp_01"))) && STREAMING::HAS_MODEL_LOADED(iLocal_48)) && func_152()) && func_151())
	{
		...
		AI::TASK_PLAY_ANIM(iLocal_49, sLocal_264, "base", 8f, -8f, -1, 1, 0f, 0, 0, 0);
...
void func_153()
{
	if (!PED::IS_PED_INJURED(iLocal_50))
	{
		...
		PED::SET_PED_KEEP_TASK(iLocal_50, true);
		AI::TASK_SMART_FLEE_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
	if (!PED::IS_PED_INJURED(iLocal_49))
	{
		PED::SET_PED_KEEP_TASK(iLocal_49, true);
		AI::TASK_SMART_FLEE_PED(iLocal_49, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 1);
	}
}
...
void func_221()
{
	...
	{
		AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_50, iLocal_51, fLocal_62, 786485);
		PED::SET_PED_KEEP_TASK(iLocal_50, true);
	}
	func_87(&iLocal_49, 1, 0, 1);
