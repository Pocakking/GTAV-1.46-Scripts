...
void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_25720 + 10000 && !func_100())
	{
		func_107(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_336.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_333)
					{
						Global_106015[iLocal_217] = uLocal_332;
					}
					else
					{
...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_277) && !ENTITY::IS_ENTITY_DEAD(iLocal_277, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_208, 0))
	{
		if (!iLocal_278)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_208, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 15f)
			{
				AI::TASK_FLUSH_ROUTE();
				...
				AI::TASK_FOLLOW_POINT_ROUTE(iLocal_277, 1f, 0);
				iLocal_278 = 1;
			}
		}
		else
		{
			...
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_277, true), 377.4565f, 154.6708f, 102.0838f, true) > 25f)
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_277);
				iLocal_279 = 1;
			}
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_277, true), ENTITY::GET_ENTITY_COORDS(iLocal_208, true), true) < 3f && iLocal_280 == 0)
			{
				iLocal_280 = 1;
			}
		}
...
void func_98()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_208, 0))
	{
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_208, "MAG_2_PAM_PED_GROUP", 0);
	}
}
...
void func_107(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&uVar0, &Local_331))
		{
			func_13();
		}
		if (iParam0 == 1)
