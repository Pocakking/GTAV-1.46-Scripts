		...
		if (func_35(Local_227.f_1.f_3[0 /*2*/].f_1))
		{
			if (!func_12(Local_227.f_1))
			{
				if (func_34(&(Local_227.f_1), Local_227.f_1.f_1, Local_227.f_1.f_10, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					ROPE::ACTIVATE_PHYSICS(NETWORK::NET_TO_VEH(Local_227.f_1));
					ENTITY::SET_ENTITY_DYNAMIC(NETWORK::NET_TO_VEH(Local_227.f_1), 1);
					func_33(NETWORK::NET_TO_VEH(Local_227.f_1), 4);
					Global_2437022.f_3983 = NETWORK::NET_TO_VEH(Local_227.f_1);
					if (func_32(&(Local_227.f_1.f_3[0 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[0 /*2*/].f_1, -1, 1, 1, 1))
					{
						...
						Global_2437022.f_3984[0] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]);
						if (func_32(&(Local_227.f_1.f_3[1 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							Global_2437022.f_3984[1] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]);
							if (func_32(&(Local_227.f_1.f_3[2 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[2 /*2*/].f_1, 2, 1, 1, 1))
							{
								...
								Global_2437022.f_3984[2] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]);
								return 1;
							}
						}
					}
...
int func_36()
{
	...
	if (func_55(Local_227.f_1.f_10))
	{
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				vVar0 = { func_53(func_54(PLAYER::PLAYER_ID()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_227.f_1.f_15) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_227.f_1.f_15) * 30f))), 0f) };
...
int func_37(vector3 vParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, int iParam16)
{
...
int func_38(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_45(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_43(PLAYER::PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_40(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_39(iVar1) || !bParam8) && !Global_2423801[iVar1 /*413*/].f_259)
					{
						fVar2 = fParam4;
						if (fParam7 > 0f)
						{
						...
						if (!bParam5)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_43(iVar1), vParam0, 1) <= (fVar2 + fParam1))
								{
...
int func_46(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_45(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_39(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && uParam7) && bParam4) && func_47(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_54(iVar1), vParam0, 1) < fParam1)
								{
									return 1;
								}
							}
...
int func_52(int iParam0, int iParam1)
{
	...
	{
		Global_2503649 = { func_51(iParam0) };
		Global_2503662 = { func_51(iParam1) };
...
Vector3 func_53(vector3 vParam0, float fParam1, struct<2> Param2, float fParam3)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	switch (Local_227.f_1.f_2)
	{
		...
		case 2:
			if (func_12(Local_227.f_1))
			{
				...
				{
					iLocal_47 = UI::ADD_BLIP_FOR_ENTITY(iVar1);
					UI::SET_BLIP_SPRITE(iLocal_47, 422);
					UI::_0x75A16C3DA34F1245(iLocal_47, 0);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_47, "MPCT_MERRY3");
					func_79(&iLocal_47, 1);
				}
				...
				if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_227.f_1.f_3[0 /*2*/]))
				{
					...
					{
						iVar2 = AI::GET_ACTIVE_VEHICLE_MISSION_TYPE(iVar1);
							...
							if (func_78(Local_227.f_1))
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_227.f_1.f_3[0 /*2*/]))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
									{
										if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
										{
											AI::TASK_HELI_MISSION(iVar0, iVar1, 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 23, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_61[0]), 10, -1f, 0);
										}
									}
								}
							}
						...
						if (!iLocal_50)
						{
							if (SYSTEM::VDIST(func_54(PLAYER::PLAYER_ID()), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_227.f_1), 1)) <= 50f)
							{
					...
					if (iLocal_53 == 0)
					{
						if (func_78(Local_227.f_1))
						{
							if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_227.f_1.f_3[0 /*2*/]))
							{
								...
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar0, Global_1574981);
								if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
								{
									if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
									{
										AI::TASK_HELI_MISSION(iVar0, iVar1, 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 20f, 500f, -1f, 40, 10, -1f, 0);
...
void func_68()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_71(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_82()
{
	if (!iLocal_49)
	{
		if (!func_11(Local_227.f_1.f_3[0 /*2*/]))
		{
			func_83(&uLocal_62, 3, NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]), "FM_HBACK", 1, 1);
			iLocal_49 = 1;
		}
	}
}
...
void func_86()
{
	...
	if (bVar0)
	{
		vVar1 = { func_54(PLAYER::PLAYER_ID()) };
...
int func_93()
{
	...
	if (func_94() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_94()) == 0)
		{
			return 1;
		}
	}
...
void func_110(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_90();
