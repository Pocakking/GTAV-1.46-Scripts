#region Local Var
	...
	struct<4> Local_202 = { 1, -1, -1, 0 } ;
	struct<2> Local_203[32];
#endregion
...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY("ob_jukebox")) > 1)
	{
		func_175(0);
	}
	iLocal_181 = Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24;
	func_173();
	func_166();
	...
	func_165(PLAYER::PLAYER_ID(), &Var0);
	if (func_164(Var0))
	{
		if (NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&Var0))
		{
			iLocal_177 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&Var0);
		}
	}
	...
	{
		func_161(Local_202.f_2);
		func_159(func_157());
	}
	while (true)
	{
		func_173();
		if (iLocal_176 != 0 && !func_156(vLocal_201, 0f, 0f, 0f, 0))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_155();
		...
		else if (iLocal_181 != -1 && iLocal_181 <= 124)
		{
			...
			iLocal_176 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_199, 2f, 598033448, 1, 0, 0);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_176))
			{
				vLocal_200 = { ENTITY::GET_ENTITY_COORDS(iLocal_176, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_176) * Vector(0.6f, 0.6f, 0.6f) };
				vLocal_200.z = (vLocal_200.z + 0.5f);
				vLocal_201 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_176, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
void func_5()
{
	if (iLocal_177 == PLAYER::PLAYER_ID() && func_157())
	{
...
void func_7(int iParam0)
{
	...
	iVar1 = (NETWORK::_GET_POSIX_TIME() - iLocal_187);
	func_10(func_14(iParam0), (iVar0 + iVar1), -1, 1, 0);
	if (iLocal_188 < (iVar0 + iVar1))
	{
		func_8(func_9());
	}
	iLocal_187 = NETWORK::_GET_POSIX_TIME();
}

void func_8(var uParam0)
{
	Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_340 = uParam0;
}
...
int func_13(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_11(iParam1)];
...
void func_18()
{
	...
	bVar0 = func_157();
	if (Local_202.f_2 != iLocal_178)
	{
		func_161(Local_202.f_2);
		if (iLocal_177 == PLAYER::PLAYER_ID() && Local_202.f_3)
		{
			func_19(9355, iLocal_178, -1, 1);
			Global_1589747[iLocal_177 /*790*/].f_273.f_339 = iLocal_178;
		}
	}
	if (GAMEPLAY::IS_BIT_SET(iLocal_186, 6) != bVar0)
	{
		func_159(bVar0);
		if ((iLocal_177 == PLAYER::PLAYER_ID() && Local_202.f_3) && !bVar0)
		{
			func_19(9355, 4, -1, 1);
	...
	switch (iLocal_192)
	{
		case 0:
			if (func_149() && func_148())
			{
				...
				else if ((iLocal_183 != -1 && func_144(iLocal_183, 1)) && !AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					func_143(2);
					func_141(&iLocal_183);
					GAMEPLAY::SET_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 0);
					GAMEPLAY::SET_BIT(&Global_2503845, 4);
				}
				GAMEPLAY::SET_BIT(&Global_2503845, 3);
			}
			else if (iLocal_183 != -1)
			{
				func_141(&iLocal_183);
				GAMEPLAY::CLEAR_BIT(&Global_2503845, 3);
			}
		...
		case 2:
			if (Local_202.f_1 == PLAYER::PLAYER_ID() && func_138())
			{
				iLocal_184 = 0;
				func_143(1);
				GAMEPLAY::CLEAR_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 0);
				GAMEPLAY::SET_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 1);
				func_132(PLAYER::PLAYER_ID(), 0, 256);
				func_131(&uLocal_195);
			}
			else if (Local_202.f_1 != -1 || !func_138())
			{
				func_143(0);
				GAMEPLAY::CLEAR_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 0);
				GAMEPLAY::CLEAR_BIT(&Global_2503845, 4);
			}
			break;
		...
		case 3:
			if (GAMEPLAY::IS_BIT_SET(iLocal_186, 4))
			{
				if (func_124())
				{
					GAMEPLAY::CLEAR_BIT(&iLocal_186, 4);
				}
			}
			func_38();
			break;
		...
		case 4:
			if (GAMEPLAY::IS_BIT_SET(iLocal_186, 3))
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_186, 3);
				func_35(1, -1);
			}
			iVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_185);
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "EXIT", 3))
			{
				func_27(GAMEPLAY::IS_BIT_SET(iLocal_186, 5));
				if (iLocal_179 != -1)
				{
					if ((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "INSERT_COINS", 3) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.82f) || !GAMEPLAY::IS_BIT_SET(iLocal_186, 5))
					{
						func_26(iLocal_179);
					}
				}
			...
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_186, 5);
				GAMEPLAY::CLEAR_BIT(&iLocal_186, 4);
				GAMEPLAY::CLEAR_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 1);
				GAMEPLAY::CLEAR_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 2);
				func_132(PLAYER::PLAYER_ID(), 1, 0);
				GAMEPLAY::CLEAR_BIT(&Global_2503845, 4);
				iLocal_191 = 0;
				iLocal_189 = Global_1589747[iLocal_177 /*790*/].f_273.f_339;
				unk_0x8989CBD7B4E82534(func_24(func_25()), func_23(func_25()), func_22(), func_21(), 4, iLocal_189, 0);
				func_143(0);
			}
			break;
	}
...
{
	Local_203[PLAYER::PLAYER_ID() /*2*/].f_1 = iParam0;
	GAMEPLAY::SET_BIT(&(Local_203[PLAYER::PLAYER_ID() /*2*/]), 2);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_184)
		{
			...
			case 1:
				...
				{
					STREAMING::REMOVE_ANIM_DICT(sLocal_190);
					iLocal_184 = 0;
					return 1;
				}
				break;
...
int func_34(char* sParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_185);
	STREAMING::REQUEST_ANIM_DICT(sLocal_190);
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_190))
	{
		if ((!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar0) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f) || bParam1)
		{
			...
			{
				PED::DETACH_SYNCHRONIZED_SCENE(iLocal_185);
				iLocal_185 = -1;
			}
			iLocal_185 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_201, ENTITY::GET_ENTITY_ROTATION(iLocal_176, 2), 2, false, bParam2, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_185, sLocal_190, sParam0, 4f, -2f, 5, 0, 1148846080, 0);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_185);
			return 1;
		}
	}
	return 0;
...
void func_38()
{
	if (!func_123())
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(iLocal_186, 1))
			{
				func_78();
				GAMEPLAY::CLEAR_BIT(&iLocal_186, 1);
			}
			else
			{
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17367.f_5726)
		{
			...
			else
			{
				if (Global_17367)
				{
					StringCopy(&cVar64, func_65(29), 64);
					StringCopy(&cVar65, func_62(29, 1), 64);
					if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_6863[29 /*16*/])) == -1487683087)
					{
						func_61(Global_17364, Global_17365, fParam5, (fVar56 - 0f), 0, 0, 0, 255);
				...
				func_61(Global_17364, (Global_17365 + fVar56), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
				...
				if (Global_17367.f_5729 > Global_17367.f_5223)
				{
					...
					{
						func_60();
						func_58((((Global_17364 + fParam5) - 0.00390625f) - func_59("CM_ITEM_COUNT", Global_17367.f_5732, Global_17367.f_5731)), ((Global_17365 + fVar56) + 0.00416664f), "CM_ITEM_COUNT", Global_17367.f_5732, Global_17367.f_5731);
					}
				}
			}
			...
			if (Global_17367.f_5729 > Global_17367.f_5223)
			{
				...
				func_61(Global_17364, (fVar49 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_4690)) != 0 && Global_17367.f_4764 != -1)
			{
				...
				func_61(Global_17364, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_67(Global_17367.f_4766, 1, 1, &fVar36, &fVar37, bParam7);
					func_56(Global_17367.f_4766, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4766), func_62(Global_17367.f_4766, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_4266986.f_21)) != 0 && Global_4266986.f_65 != -1)
			{
				...
				{
					func_67(Global_4266986.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_56(Global_4266986.f_67, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_65(Global_4266986.f_67), func_62(Global_4266986.f_67, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((UI::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
			...
			func_49(iVar59, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
			GRAPHICS::_SET_SCREEN_DRAW_POSITION(76, 84);
			GRAPHICS::_SCREEN_DRAW_POSITION_RATIO(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17367.f_5726)
							...
							switch (Global_17367.f_5054[iVar8])
							{
									...
									if (iVar5 == 1 && bVar33)
									{
										if (!Global_17367.f_5727)
										{
											...
											if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_73[iVar24 /*6*/])) != 0)
											{
												...
												func_47(bVar32, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, iVar74, bVar51, bVar50);
										...
										if (bVar52)
										{
											if (func_67(26, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												if (func_67(26, 1, 1, &fVar36, &fVar37, bParam7))
												{
													...
													GRAPHICS::DRAW_SPRITE(func_65(26), func_62(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
											if (func_67(27, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												if (func_67(27, 1, 1, &fVar36, &fVar37, bParam7))
												{
													...
													GRAPHICS::DRAW_SPRITE(func_65(27), func_62(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
										iVar25 = 0;
										...
										if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_73[iVar24 /*6*/])) != 0)
										{
											...
											func_47(bVar32, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, 0, bVar51, bVar50);
											...
											else if (Global_17367.f_2124[iVar24 /*5*/][iVar14] == 4)
											{
												if (Global_17367.f_4433[(iVar22 + iVar28)] == 2 || Global_17367.f_4433[(iVar22 + iVar28)] == 48)
												{
													if (func_67(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_56(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
															if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[(iVar22 + iVar28)]), func_62(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[(iVar22 + iVar28)]), func_62(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
										...
										if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_73[iVar24 /*6*/])) != 0)
										{
											...
											else
											{
												...
												if (func_45() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
												{
													if (iVar8 == 0)
													{
														func_47(0, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, 0, bVar51, bVar50);
											...
											while (iVar14 < iVar28)
											{
												if (Global_17367.f_4433[(iVar22 + iVar14)] != 2 && Global_17367.f_4433[(iVar22 + iVar14)] != 48)
												{
													if (func_67(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_56(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
															if (Global_17367.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[(iVar22 + iVar14)]), func_62(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (Global_17364 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[(iVar22 + iVar14)]), func_62(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[(iVar22 + iVar14)]), func_62(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
								...
								case 2:
									if (iVar5 == 1 && bVar33)
									{
										if (!Global_17367.f_5727)
										{
											func_47(bVar32, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, 0, 0, 0);
											if (Global_17367.f_8087 && Global_17367.f_8088 == iVar6)
											{
												func_46(bVar32);
											}
										...
										func_47(bVar32, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, 0, 0, 0);
										func_44((fVar34 + fVar40), fVar35, "NUMBER", Global_17367.f_3918[iVar20], 0);
									}
									bVar39 = true;
									iVar20++;
									break;
								...
								case 3:
									if (iVar5 == 1 && bVar33)
									{
										...
										func_47(bVar32, Global_17367.f_1610[iVar24], Global_17367.f_1867[iVar24], bVar54, 0, 0, 0);
										func_43((fVar34 + fVar40), fVar35, "NUMBER", Global_17367.f_4175[iVar21], Global_17367.f_4304[iVar21]);
									}
									bVar39 = true;
									iVar21++;
									break;
								...
								case 4:
									if (iVar5 == 1 && bVar33)
									{
										if (func_67(Global_17367.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_56(Global_17367.f_4433[iVar22], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
												GRAPHICS::DRAW_SPRITE(func_65(Global_17367.f_4433[iVar22]), func_62(Global_17367.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), (fVar36 * func_42(Global_17367.f_4433[iVar22])), (fVar37 * func_42(Global_17367.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
									bVar39 = true;
...
int func_69(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_71(8, -1) && func_70() != 64)) || (UI::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::SET_STORE_ENABLED()) || Global_71465) || Global_17367.f_8090) || UI::IS_WARNING_MESSAGE_ACTIVE()) || Global_93284.f_1393)
	{
		return 0;
	}
	return 1;
...
void func_75()
{
	...
	if (iLocal_180 == Local_202.f_2 && func_157())
	{
...
void func_90()
{
	...
	while (iVar0 < 4)
	{
		...
		bVar2 = iVar0 != Local_202.f_2;
		if (!func_157())
		{
			bVar2 = true;
		}
		StringIntConCat(&Var1, iVar0, 16);
		func_81(iVar0, &Var1, 0, bVar2, 0, 0);
		if (bVar2)
		{
			func_81(iVar0, "JBOX_CHARGE", 0, bVar2, 0, 0);
		}
		iVar0++;
	}
	if (func_157())
...
void func_94()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_186, 0))
	{
		if (CONTROLS::_IS_INPUT_JUST_DISABLED(2))
		{
		...
		if (bVar2 || bVar3)
		{
			...
			GAMEPLAY::SET_BIT(&iLocal_186, 0);
		}
	}
	else if (func_15(&uLocal_193, iVar1, 0))
	{
		func_131(&uLocal_193);
		GAMEPLAY::CLEAR_BIT(&iLocal_186, 0);
	}
	if (bVar3)
	{
		iLocal_180++;
...
void func_95(int iParam0)
{
	...
	if (func_4(iLocal_181, -1))
	{
		iVar0 = GAMEPLAY::GET_HASH_KEY(func_109(iParam0));
	}
	if (NETWORKCASH::NETWORK_CAN_SPEND_MONEY(1, false, false, 1, -1))
	{
		if (func_108())
		{
			func_96(1976384368, 1, &iVar1, 0, 0, 1);
			Global_4262927[iVar1 /*80*/] = iVar0;
		}
		else
		{
			unk_0x5BCDE0F640C773D2(1, iVar0, 0, 0);
		}
	}
}
...
void func_105(struct<62> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	vector3 vVar0;
	int iVar1;
...
void func_111(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (GAMEPLAY::IS_PC_VERSION() && !NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE())
	{
		...
		if (func_113(0, 0, 0) || CONTROLS::IS_CONTROL_PRESSED(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_112(0, 0, 0) || CONTROLS::IS_CONTROL_PRESSED(2, 187))
		{
			*uParam1 = 1;
		}
	}
...
int func_125()
{
	...
	switch (iLocal_184)
	{
		case 0:
			func_28(0);
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_176, 0.06f, -0.8958f, 0.2f) };
			...
			if (!func_130(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar0, 0.55f, 0) || !func_129(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_176), 15f))
			{
				if (!func_126(PLAYER::PLAYER_PED_ID(), 2106541073))
				{
					AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar0, 1f, 4000, ENTITY::GET_ENTITY_HEADING(iLocal_176), 0.125f);
				}
			}
			else
			{
...
void func_146()
{
	if (UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_147("JBOX_NO_MONEY"))
	{
		UI::CLEAR_HELP(1);
	}
}
...
int func_149()
{
	if (((((((((!GAMEPLAY::IS_BIT_SET(Global_2503845, 5) && !func_153()) && !func_32(0)) && !func_152()) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_176)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_200, 0.55f, 0.8f, 1.5f, false, true, 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "EXIT", 3)) && !func_151(PLAYER::PLAYER_ID())) && !func_150())
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	if (func_150())
	{
		if (GAMEPLAY::IS_BIT_SET(Local_203[Local_202.f_1 /*2*/], 2))
		{
			if (Local_203[Local_202.f_1 /*2*/].f_1 == 4)
			{
				if (func_157())
				{
					Local_202 = 0;
					Local_202.f_2 = 4;
					if (iLocal_177 == Local_202.f_1)
					{
						Local_202.f_3 = 1;
					}
				}
			}
			else if (Local_202.f_2 != Local_203[Local_202.f_1 /*2*/].f_1)
			{
				Local_202.f_2 = Local_203[Local_202.f_1 /*2*/].f_1;
				if (iLocal_177 == Local_202.f_1)
				{
					Local_202.f_3 = 1;
				}
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_203[Local_202.f_1 /*2*/], 1) && !GAMEPLAY::IS_BIT_SET(Local_203[Local_202.f_1 /*2*/], 0))
		{
			Local_202.f_1 = -1;
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Local_203[iLocal_182 /*2*/], 0))
	{
		if (!func_150())
		{
			Local_202.f_1 = iLocal_182;
		}
	}
	if (!func_150())
	{
		if (Global_1589747[iLocal_177 /*790*/].f_273.f_339 == Local_202.f_2 && (!func_157() && Global_1589747[iLocal_177 /*790*/].f_273.f_339 == 4))
		{
			Local_202.f_3 = 0;
		}
	}
...
bool func_156(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_159(bool bParam0)
{
	if (bParam0)
	{
		GAMEPLAY::SET_BIT(&iLocal_186, 6);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&iLocal_186, 6);
	}
	if (func_4(iLocal_181, -1))
	{
...
void func_161(int iParam0)
{
	if (func_4(iLocal_181, -1))
	{
		...
		{
			if (iLocal_177 == PLAYER::PLAYER_ID() && iLocal_187 != 0)
			{
				func_7(iLocal_178);
			}
...
void func_166()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !GAMEPLAY::IS_BIT_SET(iLocal_186, 2))
	{
		iVar0 = Global_1048576.f_1164;
		GAMEPLAY::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, iVar0);
		func_170(0, -1, 0);
		GAMEPLAY::SET_THIS_SCRIPT_CAN_BE_PAUSED(0);
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_202, 4);
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_203, 65);
		if (!func_167())
		{
			func_175(0);
		}
		GAMEPLAY::SET_BIT(&iLocal_186, 2);
	}
}
...
void func_173()
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_2503845, 1))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2503845, 1);
		func_175(0);
	}
	else if (func_174())
	{
	...
	else if (iLocal_181 != Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_273.f_24)
	{
		func_175(0);
	}
}
...
void func_175(bool bParam0)
{
	...
	GAMEPLAY::SET_BIT(&Global_2503845, 2);
	if (iLocal_183 != -1)
	{
		func_141(&iLocal_183);
	}
	if (iLocal_177 == PLAYER::PLAYER_ID())
	{
		func_7(iLocal_178);
	}
	if (UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_147("JBOX_NO_MONEY"))
...
void func_176()
{
	...
	{
		if (((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "IDLE", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "EXIT", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "INSERT_COINS", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_190, "SELECT_TRACK", 3))
		{
