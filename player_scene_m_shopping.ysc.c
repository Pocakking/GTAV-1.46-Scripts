	...
	if (!PED::IS_PED_INJURED(*iParam0))
	{
		...
		if (iLocal_290 >= 0)
		{
			if (FIRE::IS_ENTITY_ON_FIRE(*iParam0))
			{
				...
				{
					AI::STOP_ANIM_PLAYBACK(*iParam0, 0, 0);
				}
		...
		switch (iLocal_290)
		{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_318, 2))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
				...
				{
					AI::CLEAR_PED_TASKS(*iParam0);
					if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_327))
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 1193033728);
						PED::FORCE_PED_MOTION_STATE(*iParam0, -668482597, false, 0, 0);
						PED::_RESET_PED_RAGDOLL_BLOCKING_FLAGS(*iParam0, 2);
					...
					{
						AI::TASK_START_SCENARIO_AT_POSITION(*iParam0, &cLocal_327, vLocal_296 + vLocal_336, (fLocal_297 + fLocal_337), 0, 0, 1);
			...
			case 3:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(*iParam0, 713668775) != 1)
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
					{
						...
						AI::TASK_WANDER_IN_AREA(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 1077936128, 1086324736);
						func_121(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
				{
					if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_296 + vLocal_298, fLocal_299, 1))
					{
						AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 0);
			...
			case 5:
				...
				else
				{
					...
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar4, 0, &vVar5, 14))
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar5, 1f, -1, 1048576000, 0, 1193033728);
...
Vector3 func_5(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_6(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
void func_7(int iParam0)
{
		...
		if (!iLocal_342 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_102(75, ENTITY::GET_ENTITY_COORDS(iParam0, false), 250f, -1);
						if (func_40(Global_89061, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_342 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_340 > 0)
		{
			if (iLocal_341 == 0)
			{
				if (iLocal_340 + 15000 < GAMEPLAY::GET_GAME_TIMER())
				{
			...
			else if (iLocal_340 + 10000 < GAMEPLAY::GET_GAME_TIMER())
			{
...
void func_38()
{
	...
	{
		if (func_34(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_39(PLAYER::PLAYER_PED_ID());
			if (func_35(iVar0) && (!func_23(14) || Global_105021))
			{
...
int func_42(int iParam0, int iParam1, int iParam2)
{
	...
	return func_43(Global_106070.f_28022[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_46(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_48() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_48() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_47(iParam0));
...
bool func_52(int iParam0)
{
	...
	if (iParam0 == 9)
	{
		return func_53(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_53(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_53(137, -1, -1);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_48() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_58(int iParam0, int iParam1)
{
	...
	if (func_68(&Global_4268566))
	{
		if (func_66(&Global_4268566, iParam0))
		{
			return 0;
		}
...
void func_62(var uParam0)
{
	...
	func_64(uParam0, (Global_4268565 - 0.5f));
}
...
int func_79(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_80(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_14682)
	{
		...
		{
			func_84(Global_14494, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_81(1);
			func_84(Global_14494, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_82(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
void func_82(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_84(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iParam0, sParam1);
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_88()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_89(Global_106070.f_14113[iVar2 /*104*/].f_18, Global_106070.f_14113[Global_16889 /*104*/].f_18))
		{
			Global_16889 = iVar2;
		}
		iVar2++;
...
int func_89(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_92(char* sParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<14> Var0;
...
int func_99(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	struct<4> Var0[2];
	int iVar1;
...
void func_102(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	if (iParam0 == iParam3)
	{
		return;
...
int func_104(int iParam0, int iParam1)
{
	...
	bVar1 = false;
	if (GAMEPLAY::IS_BIT_SET(Var0.f_2, func_105()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_106070.f_7660.f_919[func_105()])
		{
			return 5;
		}
	}
...
struct<10> func_106(int iParam0)
{
	int iVar0;
	struct<10> Var1;
...
struct<14> func_108(int iParam0)
{
	int iVar0;
	struct<14> Var1;
...
struct<15> func_110(int iParam0)
{
	int iVar0;
	struct<15> Var1;
...
int func_113(vector3 vParam0, bool bParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_119(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_120(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
...
int func_122()
{
	if (!func_124())
	{
		...
		switch (func_33(Global_93018))
		{
			case 0:
				func_30(&uLocal_100, 1, Global_93018, func_123(0), 0, 1);
				break;
			
			case 1:
				func_30(&uLocal_100, 2, Global_93018, func_123(1), 0, 1);
				break;
			
			case 2:
				func_30(&uLocal_100, 3, Global_93018, func_123(2), 0, 1);
				break;
...
int func_125(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_126(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_133()
{
	...
	func_134(&Global_93018, Global_88330);
...
void func_135()
{
	...
	switch (iLocal_99)
	{
		...
		default:
			vLocal_298 = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_299 = (SYSTEM::VMAG(vLocal_298) * 0.75f);
			break;
	}
...
void func_137(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
...
int func_140(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_141(Global_92701[iParam0 /*98*/], 0))
	{
		func_139(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_157(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_157(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_157(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
