			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_318, 2))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, -1, (fLocal_299 * 0.1f), 0, 40000f);
			...
			case 5:
				...
				else
				{
					...
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar4, 0, &vVar5, 14))
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar5, 1f, -1, 0.25f, 0, 40000f);
