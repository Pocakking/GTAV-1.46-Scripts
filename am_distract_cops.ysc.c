	...
	if (Local_103 == 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_112)))
		{
			...
			if (func_265(iVar0, 1, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_103.f_1, 0))
				{
					if (GAMEPLAY::IS_BIT_SET(Local_105[iLocal_112 /*4*/].f_1, 0))
					{
						iLocal_113 = 1;
...
void func_14()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 1))
	{
		if ((GAMEPLAY::IS_BIT_SET(Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) >= (Local_103.f_16 - 1)) && Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 < 10)
		{
			Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2++;
		}
		if (Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 * Global_262145.f_7988);
			...
			if (iVar0 > 0)
			{
				...
				if (func_96())
				{
					func_84(-2043695058, iVar0, &uVar2, 0, 0, 0);
				}
				else
				{
			...
			if (GAMEPLAY::IS_BIT_SET(iLocal_106, 4))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		GAMEPLAY::SET_BIT(&iLocal_106, 1);
	}
}
...
void func_16(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2567520[iParam0 /*3*/][func_18(iParam2)];
...
int func_17(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2567520[iParam0 /*3*/][func_18(iParam1)];
	...
	if (((func_64(PLAYER::PLAYER_ID()) || (func_63() && func_62())) && !GAMEPLAY::IS_BIT_SET(Global_2524719.f_4577, 31)) && !bParam4)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (PED::IS_PED_A_PLAYER(iVar1))
			{
				...
				{
					if (func_265(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_47(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
int func_105(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_36(iParam1, -2, 1, 0, 0));
...
void func_106(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	int iVar0;
...
void func_122()
{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_107))
	{
		...
		{
			UI::SET_BLIP_DISPLAY(iLocal_107, 0);
		}
		else
		{
			UI::SET_BLIP_DISPLAY(iLocal_107, 4);
		}
	}
	switch (Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3)
	{
		case 0:
			...
			{
				func_209();
				GAMEPLAY::SET_BIT(&(Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
...
void func_139(vector3 vParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
var func_143(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
int func_144(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_167(int iParam0, int iParam1)
{
	if (NETWORK::_NETWORK_PLAYER_IS_IN_CLAN())
	{
		Global_2503649 = { func_154(iParam0) };
...
void func_188()
{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 0) && GAMEPLAY::IS_BIT_SET(iLocal_106, 3))
		{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 3))
		{
...
void func_191()
{
	...
	func_5(&uLocal_110);
	func_192();
	GAMEPLAY::CLEAR_BIT(&(Local_105[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
	GAMEPLAY::CLEAR_BIT(&iLocal_106, 3);
	GAMEPLAY::SET_BIT(&(Global_2524719.f_4578), 0);
	if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 5))
	{
		GAMEPLAY::SET_BIT(&iLocal_106, 5);
...
void func_192()
{
	if (GAMEPLAY::IS_BIT_SET(iLocal_106, 2))
	{
		func_193(1, 1, 0);
		GAMEPLAY::CLEAR_BIT(&iLocal_106, 2);
	}
}
...
void func_209()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 2))
	{
		...
		GAMEPLAY::SET_BIT(&iLocal_106, 2);
	}
}

void func_210(vector3 vParam0, int iParam1, int iParam2)
{
...
void func_211(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	func_212(vParam0, 0f, 0f, 0f, uParam1, 0, iParam2, iParam3);
}

void func_212(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3, int iParam4, var uParam5)
{
	struct<12> Var0;
	
	if (func_221(PLAYER::PLAYER_ID()) || uParam5)
	{
		if (Var0.f_10 == 1)
		{
...
void func_213(struct<12> Param0, int iParam1)
{
...
int func_215(struct<12> Param0)
{
	...
	while (iVar1 < 4)
	{
		...
		{
			if (!func_216(Global_2405070.f_44[iVar1 /*12*/], &Var0))
			{
				return 0;
			}
		}
...
int func_216(vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10)
{
	int iVar0;
...
bool func_217(vector3 vParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_218(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3)
{
...
int func_219(vector3 vParam0, float fParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
...
void func_228(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	func_229(vParam0, 0f, 0f, 0f, fParam1, 0, iParam2, iParam4, iParam3, iParam5);
}

void func_229(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7)
{
	struct<12> Var0;
...
void func_230(struct<12> Param0, int iParam1)
{
...
bool func_233(int iParam0)
{
	...
	iVar0 = func_186(2480, -1, 0);
	return GAMEPLAY::IS_BIT_SET(iVar0, iParam0);
}

void func_234()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_106, 6))
	{
...
void func_236()
{
	...
	{
		iLocal_107 = UI::ADD_BLIP_FOR_RADIUS(Local_103.f_2, Local_103.f_5);
		UI::SET_BLIP_COLOUR(iLocal_107, 50);
		UI::SET_BLIP_ALPHA(iLocal_107, 220);
		UI::_0x75A16C3DA34F1245(iLocal_107, 0);
		UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_107, "DCP_BLIPN");
		if (func_232())
		{
			UI::SET_BLIP_DISPLAY(iLocal_107, 0);
		}
...
int func_243()
{
	...
	if (func_244() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_244()) == 0)
		{
			return 1;
		}
	}
...
void func_263(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_255();
