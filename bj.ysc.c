...
void __EntryFunction__()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18939.f_1, iVar77))
	{
		fVar65 = 0.1f;
	}
	iVar13 = iVar77;
		...
		switch (iVar7)
		{
			case 0:
				...
				else if (iVar13 == 4)
				{
					...
					GAMEPLAY::CLEAR_AREA(-74.9632f, -827.4467f, 324.9521f, 25f, 1, 0, 0, false);
				}
				else if (iVar13 == 8)
				{
					func_470(-74.9632f, -827.4467f, 324.9521f, 25f, 1);
					GAMEPLAY::CLEAR_AREA(-807.073f, 330.8846f, 232.6766f, 25f, 1, 0, 0, false);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar33))
				{
					func_469(&iVar23);
				...
				if ((iVar13 == 6 || iVar13 == 12) || iVar13 == 5)
				{
					...
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_548.f_2, 1, 1);
				...
				if (CAM::IS_SCREEN_FADED_OUT() || (((iVar13 == 5 || iVar13 == 6) || iVar13 == 12) && !bVar93))
				{
					if (!bVar93)
					{
						if ((iVar13 != 5 && iVar13 != 6) && iVar13 != 12)
						{
							...
							vVar57 = { func_458(SYSTEM::COS(vVar57.z), SYSTEM::SIN(vVar57.z), GAMEPLAY::TAN(vVar57.x)) };
							if (func_457(iVar13))
							{
					...
					if (((bVar93 || iVar13 == 4) || iVar13 == 8) || iVar13 == 3)
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_456(iVar13), 0, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_447(&Var3));
			...
			case 3:
				...
				{
					if (func_448(func_449(iVar13)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3))
					{
					}
					else if (bVar93)
					{
					...
					else
					{
						...
						if (!func_414(func_415(iVar13)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_415(iVar13), 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_413(func_415(iVar13), func_456(iVar13)));
							PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
							if (func_411() == 0)
							{
							...
							AI::OPEN_SEQUENCE_TASK(&uVar48);
							if (func_410(iVar13) > 0)
							{
								AI::TASK_STAND_STILL(0, func_410(iVar13));
							}
							AI::TASK_GO_STRAIGHT_TO_COORD(0, func_456(iVar13), 1f, -1, func_447(&Var3), 1056964608);
							AI::CLOSE_SEQUENCE_TASK(uVar48);
							AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar48);
							AI::CLEAR_SEQUENCE_TASK(&uVar48);
						}
						if (!func_448(func_449(iVar13)))
						{
			...
			case 5:
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					if (bVar93 && bVar103)
					{
						TIME::SET_CLOCK_TIME(func_362(iVar15), func_361(iVar15), func_360(iVar15));
					}
					SYSTEM::WAIT(2000);
					if (bVar93)
					{
				...
				{
					iVar45 = UI::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar34, func_358(&Var3)));
					UI::SET_BLIP_COLOUR(iVar45, 5);
					UI::_0x75A16C3DA34F1245(iVar45, 1);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_TGT");
				}
				else
				{
					iVar45 = UI::ADD_BLIP_FOR_COORD(func_357(&Var3, 0));
					UI::SET_BLIP_COLOUR(iVar45, 5);
					if (iVar72 == 1)
					{
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_TGT");
					...
					{
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar45, "BJ_BLIP_CHK");
					}
				}
				UI::SET_BLIP_SCALE(iVar45, 1.2f);
				if (iVar72 > 1)
				{
					iVar46 = UI::ADD_BLIP_FOR_COORD(func_357(&Var3, 1));
					UI::SET_BLIP_COLOUR(iVar46, 5);
					UI::_0x75A16C3DA34F1245(iVar45, 1);
					UI::SET_BLIP_SCALE(iVar46, 0.7f);
					if (iVar72 == 2)
					{
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar46, "BJ_BLIP_TGT");
					}
					else
					{
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar46, "BJ_BLIP_CHK");
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0))
				{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_106070.f_18939.f_1, (func_354(&Var3) - 125)))
				{
				...
				if (!func_366(&Var3))
				{
					...
					else
					{
						...
						else if (iVar13 == 4 && !func_348())
						{
							...
							CAM::SET_CAM_ACTIVE(func_416(&uVar5, 0), 1);
						}
						else
						{
							if (CAM::IS_SCRIPT_GLOBAL_SHAKING())
			...
			case 6:
				...
				else
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(iVar78, 0))
					{
						if (UI::IS_MESSAGE_BEING_DISPLAYED() || !func_445(&iVar31))
						{
							func_359(&iVar31);
						}
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							if (!GAMEPLAY::IS_BIT_SET(iVar78, 1))
							{
								if (!func_445(&iVar24))
								{
									func_469(&iVar24);
								...
								else if (func_444(&iVar24) > 0.15f)
								{
									...
									func_441(&iVar24);
									GAMEPLAY::SET_BIT(&iVar78, 1);
								}
							}
						}
						else
						{
							GAMEPLAY::CLEAR_BIT(&iVar78, 1);
					...
					if (func_320(&Var3, &uVar5, &uVar4, &iVar18, &vVar56, &uVar60, vVar61, vVar62) || bVar98)
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iVar33) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0))
							{
								...
								AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar81, "oddjobs@basejump@", "Heli_jump", 4f, -4f, 7, 0, 1148846080, 0);
			...
			case 8:
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar81))
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uVar47);
						AI::TASK_FORCE_MOTION_STATE(0, -1161760501, 0);
						AI::TASK_PARACHUTE(0, 1, 0);
						AI::CLOSE_SEQUENCE_TASK(uVar47);
						AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar47);
						AI::CLEAR_SEQUENCE_TASK(&uVar47);
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar33))
				{
			...
			case 9:
				...
				else
				{
					...
					{
						vVar58 = { func_357(&Var3, (iVar72 - 1)) };
						func_265(PLAYER::PLAYER_PED_ID(), vVar58);
						bVar98 = false;
					}
					func_346(&iVar19);
					if (func_355(func_356(&Var3)))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iVar34) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_357(&Var3, 0), 0) <= 200f)
						{
					...
					else if ((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !func_414(func_357(&Var3, 0)))
					{
						...
						if (func_264(PLAYER::PLAYER_PED_ID(), iVar34, 0) <= 325f)
						{
							if (iVar13 == 5)
							{
							...
							if (AI::GET_SCRIPT_TASK_STATUS(iVar43, -1273030092) != 1)
							{
								if (iVar13 == 5)
								{
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, vVar115, 4, 5f, 16785408, 5f, 10f, 1);
								}
								else
								{
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar43, iVar34, vVar115, 4, 5f, 16777216, 4f, -1f, 1);
								}
							}
							else
							{
					...
					if (iVar8 == 1 || iVar8 >= 2)
					{
						...
						while (iVar116 < iVar44)
						{
							...
							{
								AI::CLEAR_PED_TASKS(iVar44[iVar116]);
								iVar44[iVar116] = 0;
							}
							iVar116++;
						}
			...
			case 10:
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iVar43, -982327190) != 0 && AI::GET_SCRIPT_TASK_STATUS(iVar43, -982327190) != 1)
					{
						AI::CLEAR_PED_TASKS(iVar43);
						AI::TASK_STAND_STILL(iVar43, -1);
					}
				}
				if ((!bVar96 && !bVar97) && !bVar99)
				{
					if (!func_445(&iVar21))
					{
						...
						if (UI::DOES_BLIP_EXIST(iVar45))
						{
							UI::REMOVE_BLIP(&iVar45);
						}
						if (UI::DOES_BLIP_EXIST(iVar46))
						{
							UI::REMOVE_BLIP(&iVar46);
						}
						if (iVar73 > -1)
						{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, vVar59, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_357(&Var3, iVar71), vVar59, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							bVar117 = false;
				...
				if (((bVar96 || bVar97) || bVar99) || (func_445(&iVar21) && func_444(&iVar21) > 0.25f))
				{
					...
					if (bVar96 || iVar8 == 1)
					{
						...
						{
							iVar79 = 125;
							GAMEPLAY::SET_BIT(&(Global_106070.f_18939.f_1), (func_354(&Var3) - iVar79));
							...
							while (iVar83 < 13)
							{
								if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18939.f_1, iVar83))
								{
			...
			case 11:
				...
				else if (!CAM::IS_SCREEN_FADING_OUT() && (!func_72() || func_444(&iVar25) >= 2f))
				{
					...
					if (func_445(&iVar18))
					{
						if ((iVar9 == 1 || func_444(&iVar18) >= 60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar108 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))))
						{
							if (!bVar113)
							{
								func_71(&(Var6.f_26));
...
void func_18(int iParam0, int iParam1)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_41, 1) || iParam1)
		{
...
void func_19(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_41, 2) || iParam2)
		{
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				GAMEPLAY::SET_TIME_SCALE(1f);
...
void func_20(int iParam0, int iParam1)
{
	...
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_41, 0) || iParam1)
		{
	...
	else
	{
		...
		GAMEPLAY::CLEAR_BIT(&iLocal_41, 0);
	}
}
...
int func_24()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_41, 0) && !GAMEPLAY::IS_BIT_SET(iLocal_41, 1))
	{
		SYSTEM::SETTIMERA(0);
		func_20(1, 0);
	}
...
void func_25(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		...
		else if (GAMEPLAY::IS_BIT_SET(iLocal_41, 3))
		{
...
{
	iParam0->f_1 = (func_41(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_103(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, bool bParam16, bool bParam17)
{
	...
	switch (Param0.f_29[iParam14])
	{
		...
		case 8:
			...
			{
				GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM(func_105(func_108(iParam15), 0));
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			}
			else
			{
...
void func_204(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	uParam0->f_3[6] = 358;
	uParam0->f_3[7] = 358;
	uParam0->f_12[0] = func_205(iParam2 != 358, CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam2, true), "");
	uParam0->f_12[1] = func_205(iParam4 != 358, CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam4, true), "");
	uParam0->f_12[2] = func_205(iParam6 != 358, CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam6, true), "");
	uParam0->f_12[3] = func_205(iParam8 != 358, CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, iParam8, true), "");
	uParam0->f_12[4] = 0;
	uParam0->f_12[5] = 0;
	uParam0->f_12[6] = 0;
	uParam0->f_12[7] = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
			{
				...
				else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iVar0))
				{
					...
					vVar5.x = func_255((GAMEPLAY::ABSF(vVar5.x) - 1.305f), 0f);
					if (vVar5.y >= 0f)
					{
...
void func_259(int iParam0)
{
	...
	vVar4 = { vVar1 - vVar2 };
	vVar4.z = 0f;
	fVar9 = GAMEPLAY::ABSF(func_263(vVar4, vVar3));
	if (func_262(*iParam0))
	{
	...
	{
		AI::SET_DRIVE_TASK_MAX_CRUISE_SPEED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam0, -1, 0), uVar10);
	}
}
					...
					if (vVar2.z * vVar2.z) > (3f * fVar3)
					{
						...
						while (iVar6 < *uParam1)
						{
							if (!ENTITY::DOES_ENTITY_EXIST((*uParam1)[iVar6]) || PED::IS_PED_INJURED((*uParam1)[iVar6]))
							{
								...
								AI::TASK_PLAY_ANIM(0, "oddjobs@basejump@", "ped_a_intro", 8f, -8f, -1, 0, 0f, 0, 0, 0);
								AI::TASK_PLAY_ANIM(0, "oddjobs@basejump@", "ped_a_loop", 8f, -8f, -1, 1, 0f, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(uVar1);
								AI::TASK_PERFORM_SEQUENCE(uVar0[iVar5], uVar1);
...
void func_268(var uParam0)
{
	...
	AI::TASK_PLAY_ANIM(*uParam0, "oddjobs@basejump@", "ped_a_exit", 8f, -8f, -1, 0, 0f, 0, 0, 0);
	*uParam0 = 0;
}
...
void func_270(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, var uParam11, var uParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, bool bParam30, bool bParam31, bool bParam32, bool bParam33, bool bParam34, int iParam35, var uParam36)
{
	...
	*bParam30 = 0;
	...
	{
		if (!func_314(*iParam9) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam9, -1, 0)))
		{
...
int func_336(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21)
{
	...
	if (bVar15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1) && !ENTITY::IS_ENTITY_DEAD(iParam1, 0))
		{
			...
			if (bParam20)
			{
				...
				{
					UI::SET_BLIP_COORDS(*iParam11, vVar9);
				}
				else
				{
					*iParam11 = UI::ADD_BLIP_FOR_COORD(vVar9);
	...
	{
		UI::GET_HUD_COLOUR(134, &uVar17, &uVar18, &uVar19, &uVar20);
		vVar6 = { vVar3 - vVar4 };
		...
		if (*iParam7 != *iParam6)
		{
			...
			*uParam4 = GRAPHICS::CREATE_CHECKPOINT(15, vVar4, vVar5, 9f, uVar17, uVar18, uVar19, func_345(vVar9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			if (*iParam6 < (iParam9 - 2))
			{
				*uParam5 = GRAPHICS::CREATE_CHECKPOINT(15, vVar5, func_357(uParam0, *iParam6 + 2), (9f * 0.5f), uVar17, uVar18, uVar19, func_345(vVar9, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
			}
			*iParam7 = *iParam6;
		}
		...
		if (*uParam4 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, uVar17, uVar18, uVar19, func_345(vVar4, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
		if (*uParam5 != 0)
		{
			GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, uVar17, uVar18, uVar19, func_345(vVar5, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
		}
	}
	if (!bParam19)
	{
		...
		if (bVar16)
		{
			*iParam6++;
			...
			if (*iParam6 < (iParam9 - 1))
			{
				if (!UI::DOES_BLIP_EXIST(*iParam12))
				{
					*iParam12 = UI::ADD_BLIP_FOR_COORD(func_357(uParam0, *iParam6 + 1));
...
float func_341(int iParam0)
{
	if (func_445(iParam0))
	{
		...
		{
			return (func_41(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return 0f;
}
...
void func_343(vector3 vParam0, var uParam1, var uParam2, var uParam3)
{
	...
	if (fVar2 != 0f && fVar3 != 0f)
	{
		...
		if ((fVar4 != *uParam3 || (*uParam1 == 0f && *uParam2 == 0f)) || (GAMEPLAY::ABSF((fVar2 - *uParam1)) < 0.04f && GAMEPLAY::ABSF((fVar3 - *uParam2)) < 0.04f))
		{
...
int func_347(var uParam0, int iParam1, var uParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		else if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, 1), &fVar3, 0, 0))
		{
			return 0;
		}
	...
	else if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar1, &fVar3, 0, 0))
	{
		return 0;
	}
	else if (vVar1.z >= (fVar3 + 1.5f))
...
void func_350(int iParam0, bool bParam1)
{
	...
	AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, vVar2 + Vector(5f, 5f, 5f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) + Vector(20f, 0f, 0f), 4, (0.3f * fVar4), 786469, 5f, 10f, 1);
	vVar3 = { Vector(1000f, 1000f, 1000f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) };
	vVar3.z = 200f;
	AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, *iParam0, vVar2 + vVar3, 4, fVar4, 262144, 15f, 10f, 1);
...
int func_367(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, var uParam11, var uParam12)
{
	...
	if (func_445(iParam8))
	{
		...
		else if (func_444(iParam8) > func_409(iParam1, iParam9))
		{
			...
			{
				case 0:
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "amb@world_human_hiker_standing@male@idle_a", "idle_a", 8f, -1.4f, -1, 48, 0f, 0, 0, 0);
					break;
...
void func_418(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	...
	{
		GAMEPLAY::CLEAR_AREA(func_357(uParam0, 0), 100f, 1, 0, 0, false);
...
void func_450(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		GAMEPLAY::CLEAR_AREA(func_456(iParam1), 5000f, 1, 0, 0, false);
	}
...
void func_470(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_494(var uParam0)
{
	...
	func_501(&uVar1, &uVar2, &iVar3, &iVar4, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), CONTROLS::_IS_INPUT_DISABLED(2));
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_509(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
