...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_TP", 0);
...
void func_1()
{
	switch (iLocal_257)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_7();
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_352))
			{
				func_531(1);
			}
			else
...
void func_10(int iParam0, bool bParam1)
{
	...
	{
		func_177(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_14()
{
	...
	{
		func_16(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_90(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_90(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_155(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_90(iVar10, iParam1, iParam2, -1) };
		if (!func_80(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_90(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_90(iVar10, 14, uVar12[iVar1], -1) };
							func_58(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_73(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_90(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_90(iVar10, 14, uVar15[iVar1], -1) };
			func_58(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_73(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_90(iParam0, iParam1, iParam2, -1) };
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_59(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_73(int iParam0)
{
	...
	{
		func_79(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_155(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_89(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_89(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_89(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_77(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_93(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_82(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_155(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_155(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_90(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_155(iParam0, 14, iVar4))
										{
											if (!func_46(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_90(iVar0, iVar2, iVar1, -1) };
						if (!func_46(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_161()
{
	...
	{
		if (func_157(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_156(PLAYER::PLAYER_PED_ID());
			if (func_158(iVar0) && (!func_98(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_158(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_172()
{
	...
	{
		func_161();
		GRAPHICS::_0xBF59707B3E5ED531(func_173(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_182(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_181();
...
void func_218()
{
	if (iLocal_274)
	{
		...
		WEAPON::SET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), 1285032059, iLocal_337);
	}
	else
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (func_302(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_348, -1, 0, 2);
					}
					func_222(1);
					func_220(0);
				}
...
void func_225(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_296(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_227(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_239(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_246(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_76(iParam1)];
...
void func_250(int iParam0, bool bParam1)
{
	...
	if (func_158(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_251(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_251(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_253(Var7.f_1)) && iVar9 < 50)
			{
...
int func_264(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_15() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_77(func_265(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_267(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_283(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_268(iVar0, 0), true);
...
Vector3 func_268(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_279(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_278())
			{
				if (func_277(Global_1589591))
				{
					return func_270(2, 2);
				}
				else if (func_269(Global_1589591))
				{
...
var func_285()
{
	...
	func_295(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_294(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_293(&uVar0, TIME::GET_CLOCK_HOURS());
	func_288(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_287(&uVar0, TIME::GET_CLOCK_MONTH());
	func_286(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_291(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_297(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_298(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_298(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_298(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_298(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_298(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0))
			{
				...
				if (iLocal_301[17])
				{
					if (!func_217() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
					{
						if (!iLocal_286)
						{
							if (iLocal_338 == 0)
...
{
	if (!UI::DOES_BLIP_EXIST(iLocal_263))
	{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_263))
	{
		if (!bParam0)
		{
			UI::SET_BLIP_SCALE(iLocal_263, 0.75f);
		}
		UI::SET_BLIP_FLASHES(iLocal_263, iParam1);
	}
}
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				...
				else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						if (!Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_1)
						{
							...
							{
								AI::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, vLocal_421[iVar0 /*3*/], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_317(int iParam0, int iParam1)
{
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			...
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 8000));
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 8);
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
					}
					...
					{
						AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_320(iParam0), false, false, 0))
				{
					...
					while (iVar1 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							AI::CLEAR_PED_TASKS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
							AI::TASK_WANDER_IN_AREA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					AI::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					...
					{
						AI::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_335(int iParam0, int iParam1)
{
	...
	{
		if (!UI::DOES_BLIP_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/] = func_309(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (UI::DOES_BLIP_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
			{
				UI::SET_BLIP_SCALE(Local_260[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
...
void func_336(int iParam0, int iParam1)
{
	...
	if (!func_302(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = PED::CREATE_PED(26, iLocal_341, vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, true);
		if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
...
void func_337(int iParam0, int iParam1)
{
	if (!func_302(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
...
void func_338(int iParam0, int iParam1)
{
	if (func_339())
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_BARK_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_CRY_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
...
void func_346()
{
	...
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(Local_258[iVar0 /*10*/].f_9))
		{
			UI::REMOVE_BLIP(&(Local_258[iVar0 /*10*/].f_9));
		}
...
void func_354()
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_259[iVar0 /*29*/].f_7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 5);
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_259[iVar0 /*29*/].f_28, 0))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_11))
							{
								...
								AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_319++;
			...
			case 4:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && func_367(Local_259[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
						...
						{
							if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, true), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
					...
					{
						AI::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, false);
						AI::TASK_VEHICLE_DRIVE_WANDER(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
			...
			case 5:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && func_367(Local_259[iVar0 /*29*/].f_28))
				{
					...
					{
						AI::TASK_VEHICLE_PARK(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, vVar1, ENTITY::GET_ENTITY_HEADING(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_339())
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_224(Local_259[iVar0 /*29*/].f_28) && func_302(Local_259[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(Local_259[iVar0 /*29*/].f_28))
					{
						...
						{
							AI::TASK_LEAVE_VEHICLE(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_359(iVar0);
			...
			case 8:
				if ((func_302(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_367(Local_259[iVar0 /*29*/].f_28))
				{
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar2, 3f, 1))
						{
							...
							AI::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_259[iVar0 /*29*/].f_6);
				...
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, false, false, 1))
						{
							AI::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						Local_259[iVar0 /*29*/].f_15 = AI::GET_SCRIPT_TASK_STATUS(Local_259[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						AI::OPEN_SEQUENCE_TASK(&(Local_259[iVar0 /*29*/].f_14));
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter", 8f, -8f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "exit", 8f, -8f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter_call", 8f, -8f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a_call", 8f, -8f, -1, 1, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(Local_259[iVar0 /*29*/].f_14);
						AI::TASK_PERFORM_SEQUENCE(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_14);
						AI::CLEAR_SEQUENCE_TASK(&(Local_259[iVar0 /*29*/].f_14));
						Local_259[iVar0 /*29*/].f_8 = GAMEPLAY::GET_GAME_TIMER() + 20000;
			...
			case 12:
				if (func_302(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar2, 3f, 1))
					{
						if (GAMEPLAY::GET_GAME_TIMER() > Local_259[iVar0 /*29*/].f_8)
						{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, false), ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, true), false) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_376, ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, true), true) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_357(int iParam0)
{
	...
	if (func_302(iVar0))
	{
		if (func_367(Local_259[iParam0 /*29*/].f_28))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&(Local_259[iParam0 /*29*/].f_14));
			AI::TASK_ENTER_VEHICLE(0, Local_259[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_259[iParam0 /*29*/].f_28, 60f, 786468);
			AI::CLOSE_SEQUENCE_TASK(Local_259[iParam0 /*29*/].f_14);
			AI::TASK_PERFORM_SEQUENCE(iVar0, Local_259[iParam0 /*29*/].f_14);
			PED::SET_PED_KEEP_TASK(iVar0, true);
			AI::CLEAR_SEQUENCE_TASK(&(Local_259[iParam0 /*29*/].f_14));
		}
...
void func_359(int iParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(Local_259[iParam0 /*29*/].f_12);
		...
		if (func_367(Local_259[iParam0 /*29*/].f_28))
		{
			...
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, Local_259[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_259[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				AI::TASK_SMART_FLEE_COORD(Local_259[iParam0 /*29*/].f_12, vLocal_358, 10000f, -1, 0, 0);
...
void func_360()
{
	if (!iLocal_278)
	{
		if (func_339())
		{
			iLocal_318 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			iLocal_278 = 1;
		}
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_318)
	{
...
int func_362()
{
	...
	if (func_302(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_302(iLocal_348))
		{
			...
			if (func_363(PLAYER::PLAYER_PED_ID(), iLocal_348, 0) <= 10f && GAMEPLAY::ABSF((vVar0.z - vVar1.z)) < 1.5f)
			{
				return 1;
			}
		}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_255 = 13;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_376, 50f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_374, 50f, 0, 0, 0, 0, false, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_375, 50f, 0, 0, 0, 0, false, 0);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_370();
				func_344();
				func_343();
...
void func_385()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_412, 5f, 0);
}
...
bool func_388(char* sParam0, int iParam1, char* sParam2)
{
		...
		if (!UI::DOES_BLIP_EXIST(Local_258[iVar0 /*10*/].f_9))
		{
			if (func_224(Local_258[iVar0 /*10*/]))
			{
				if (!Local_258[iVar0 /*10*/].f_7)
				{
					...
					UI::SET_BLIP_COLOUR(Local_258[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
...
int func_392(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_393(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_393(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_397()
{
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_403, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_404, vLocal_405);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_406, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_407, vLocal_408);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_409, 3f, 0);
...
int func_398()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_258[iVar0 /*10*/].f_1, 2f, 0);
...
int func_399()
{
	iLocal_335 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
...
void func_401()
{
	...
	else
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_263))
		{
			if (!UI::IS_BLIP_FLASHING(iLocal_263))
			{
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_222(1);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_379, 2f, 0, 0, 0, 0, false, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
				...
				case 0:
					if (func_430(1, 1093140480, 0))
					{
						...
						if (func_224(iLocal_348))
						{
							...
							CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_355, PLAYER::PLAYER_PED_ID(), 0);
...
{
	if ((GAMEPLAY::GET_PROFILE_SETTING(203) != 0 && *uParam0 != 1) && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		*uParam0 = 1;
	}
}
...
void func_406(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_410(PLAYER::PLAYER_ID())) && !func_408(PLAYER::PLAYER_ID(), 0)) && !func_407()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_410(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_414(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_416(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_436()
{
	...
	{
		iLocal_325 = GAMEPLAY::GET_GAME_TIMER() + 2000;
		if (func_302(iLocal_348))
		{
			if (func_302(PLAYER::PLAYER_PED_ID()))
			{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_325 || func_363(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) <= 3f)
		{
...
void func_440()
{
	...
	{
		iLocal_274 = 1;
		iLocal_337 = WEAPON::GET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), 1285032059);
	}
}
...
void func_443()
{
	UI::REQUEST_ADDITIONAL_TEXT("HUNT1", 0);
	UI::REQUEST_ADDITIONAL_TEXT("HUNT1AU", 6);
		...
		switch (iLocal_255)
		{
			...
			case 2:
				if (func_302(iLocal_348))
				{
					...
					{
						bLocal_276 = true;
						iLocal_334 = GAMEPLAY::GET_GAME_TIMER() + 5000;
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("weapon_sniperrifle"));
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0))
					{
						AI::CLEAR_PED_TASKS(iLocal_348);
						AI::TASK_LOOK_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
			...
			case 5:
				if (!PED::IS_PED_INJURED(iLocal_348))
				{
					...
					if (func_478())
					{
						...
						func_343();
						func_8(&iLocal_263);
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
			...
			case 12:
				if (func_361(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					...
					iLocal_328 = 0;
					AI::TASK_LOOK_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_369, 1f, 60000, 0.25f, 512, fLocal_305);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					...
					if (func_475())
					{
						...
						else if (iLocal_338 == 3)
						{
							...
							{
								UNK1::_0x293220DA1B46CEBC(3f, 4f, 4);
								iLocal_301[14] = 1;
								func_480(0);
								iLocal_255 = 16;
							}
			...
			case 17:
				...
				if (!iLocal_301[15])
				{
					if (func_362())
					{
						if (!func_217())
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_358, true) > 10f)
							{
				...
				switch (iLocal_331)
				{
					...
					case 3:
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_348, vLocal_413, vLocal_414, 3.5f, 0, true, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 18:
				if (func_302(PLAYER::PLAYER_PED_ID()))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || vVar0.z > 41f)
					{
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_348);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 21;
						}
					}
					else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_348, -875674219) != 1)
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_365, vLocal_366, 20f, 0, true, 0))
				{
					...
					{
						func_310();
						iLocal_322 = GAMEPLAY::GET_GAME_TIMER() + 2000;
						bLocal_279 = true;
					}
					if (func_475())
					{
				...
				if (bLocal_279)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_322)
					{
						func_310();
			...
			case 24:
				if (func_302(iLocal_348))
				{
					...
					AI::TASK_LOOK_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				...
				if (!func_217())
				{
					...
					else if (!func_217())
					{
						if (func_302(iLocal_348))
						{
							...
							AI::CLEAR_SEQUENCE_TASK(&iLocal_351);
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::_0xDCCA191DF9980FD7(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						func_2();
						iLocal_324 = GAMEPLAY::GET_GAME_TIMER() + 2400;
						iLocal_280 = 1;
					}
				}
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_324)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_348))
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_348);
						AI::TASK_SMART_FLEE_PED(iLocal_348, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_348, true);
						func_312(2);
					}
					else
...
void func_453()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_433)
		{
			iLocal_434 = GAMEPLAY::GET_GAME_TIMER() + 3000;
			iLocal_433 = 1;
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_434)
		{
			if (func_362())
			{
...
void func_454()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!iLocal_291)
			{
				iLocal_317 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				iLocal_291 = 1;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_317)
			{
				if (!func_217())
				{
					if (!iLocal_301[8])
					{
						...
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_428))
							{
								Local_428 = { func_455() };
							}
							else
		...
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 7f, 0, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!iLocal_297)
				{
					...
					{
						iLocal_332 = GAMEPLAY::GET_GAME_TIMER() + 20000;
						iLocal_297 = 1;
					}
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_332)
				{
...
void func_464()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!iLocal_429)
		{
			...
			{
				iLocal_430 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				iLocal_429 = 1;
			}
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_430)
		{
			if (!func_217() && func_362())
			{
				if (!iLocal_301[4])
...
void func_465()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_361, vLocal_362, 16f, 0, true, 0))
	{
		if ((iLocal_302[1] && !func_388("HT_NXTLOC", 0, 0)) && !func_217())
		{
			if (!iLocal_296)
			{
				iLocal_316 = GAMEPLAY::GET_GAME_TIMER() + 15000;
				iLocal_296 = 1;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_316)
			{
...
void func_468()
{
	...
	while (iVar0 < 3)
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_217())
			{
				if (!func_388("HT_SHDISH", 0, 0) || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_258[iVar0 /*10*/].f_7)
					{
	...
	if (GAMEPLAY::IS_BULLET_IN_AREA(1793.305f, 3804.426f, 32.6374f, 10f, 1))
	{
		if (!func_217())
		{
			if (!func_388("HT_SHDISH", 0, 0) || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
...
void func_470(int iParam0)
{
	...
	if (((iLocal_338 < 3 && !func_388("HT_SHDISH", 0, 0)) && !func_388("HT_SHTYRE", 0, 0)) && !func_388("HT_SHCOY", 0, 0))
	{
		if (iLocal_277)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_326)
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "HUNT1_DIIN"))
				{
				...
				else if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "HUNT_TYIN"))
				{
		...
		{
			iLocal_327 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 15000);
			iLocal_326 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_327);
			iLocal_277 = 1;
		}
	}
}
				...
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) != 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) != 7)
								{
									iLocal_328 = 1;
								}
							}
	...
	if (!bParam1 || iLocal_269)
	{
		if (func_478())
		{
			...
			if (func_302(iLocal_348))
			{
				...
				if (bParam1)
				{
					AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_258[iLocal_335 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
					AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "point_fwd", 8f, -8f, -1, 16, 0f, 0, 0, 0);
				}
				AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "binoculars_intro", 8f, -8f, -1, 16, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 8f, -8f, -1, 17, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iVar0);
				AI::TASK_PERFORM_SEQUENCE(iLocal_348, iVar0);
...
int func_475()
{
	if (func_302(PLAYER::PLAYER_PED_ID()))
	{
		if (WEAPON::GET_WEAPONTYPE_GROUP(func_476(PLAYER::PLAYER_PED_ID())) == -1212426201)
		{
			return 1;
		}
	}
...
void func_477(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 3:
			if (!UI::IS_MESSAGE_BEING_DISPLAYED() && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				*sParam3 = { func_463() };
				*sParam4 = { func_455() };
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sParam4, "") || GAMEPLAY::ARE_STRINGS_EQUAL(sParam4, "NULL"))
...
void func_480(bool bParam0)
{
	...
	if (func_302(iLocal_348))
	{
		...
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_348, true);
			AI::TASK_CLEAR_LOOK_AT(iLocal_348);
			AI::OPEN_SEQUENCE_TASK(&iVar0);
			AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 8f, -8f, -1, 48, 0f, 0, 0, 0);
			if (bParam0)
			{
				AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				PED::SET_PED_KEEP_TASK(iLocal_348, true);
...
void func_482()
{
	if (!PED::IS_PED_INJURED(iLocal_348))
	{
		if (((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, false) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_348, false), 10f))
		{
		...
		else if (AI::IS_PED_GETTING_UP(iLocal_348))
		{
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, true);
			bLocal_298 = false;
		}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_488(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_500(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_502(iParam0, Global_36117);
}
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, false, 0);
			}
			if (bVar2)
			{
				iLocal_77 = 3;
		...
		case 3:
			if (func_224(uParam0->f_28[0]))
			{
				...
				{
					AI::TASK_PLAY_ANIM(uParam0->f_28[0], "special_ped@cletus@base", "cletus_base", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				}
			}
			GAMEPLAY::CLEAR_AREA_OF_PEDS(1801.159f, 3919.606f, 33.0662f, 5f, 0);
			PED::SET_PED_NON_CREATION_AREA(1803.603f, 3920.191f, 32.9855f, 1798.416f, 3918.291f, 35.0579f);
			GAMEPLAY::CLEAR_AREA_OF_PEDS(1797.286f, 3927.359f, 33.0176f, 4f, 0);
			PED::SET_PED_NON_CREATION_AREA(1793.765f, 3926.749f, 35.1276f, 1799.73f, 3927.815f, 32.9875f);
			if (AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HANG_OUT_STREET"))
			{
				AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HANG_OUT_STREET", 0);
			}
			if (AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_DRINKING"))
			{
				AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_DRINKING", 0);
			}
			if (AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_SMOKING"))
			{
				AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_SMOKING", 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_519()
{
	...
	if (!AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HANG_OUT_STREET"))
	{
		AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HANG_OUT_STREET", 1);
	}
	if (!AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_DRINKING"))
	{
		AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_DRINKING", 1);
	}
	if (!AI::IS_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_SMOKING"))
	{
		AI::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_SMOKING", 1);
	}
	if (func_302(iLocal_348))
	{
		if (PED::IS_PED_GROUP_MEMBER(iLocal_348, func_221()))
	...
	UI::CLEAR_ADDITIONAL_TEXT(6, true);
}
...
int func_534()
{
	...
	iVar0 = func_299(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_536()
{
	...
	{
		if (func_296(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
