...
void __EntryFunction__()
{
	...
	iLocal_143 = 100;
	iLocal_144 = 3;
	uLocal_734 = UI::_0x4A9923385BDB9DAD();
	uLocal_735 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	iLocal_980 = 1;
	iLocal_1327 = -1;
	fLocal_1329 = 1f;
	...
	iLocal_1391 = 1;
	iLocal_1413 = -1;
	iLocal_1416 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 15);
	iLocal_1421 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 10);
	iLocal_1426 = 1000;
	fLocal_1434 = 0.5f;
	fLocal_1438 = 15f;
	...
	iLocal_1495 = func_521(Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
	iLocal_1496 = func_521(Vector(28.5672f, -1067.149f, 355.6028f) + Vector(2f, 2f, 2f), Vector(28.5672f, -1067.149f, 355.6028f) - Vector(2f, 2f, 2f));
	func_520();
	iLocal_1328 = 3;
	Local_1154 = { func_518(iLocal_1328) };
	func_535(&uLocal_120, 8);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.2f);
	if (func_523())
	{
		bLocal_136 = true;
		iLocal_1432 = func_517();
		if (Global_87504)
		{
		...
		if (iLocal_1432 == 0)
		{
			if (bLocal_1400)
			{
				...
				iVar0 = func_484(vLocal_1451, fLocal_1452);
	...
	{
		SYSTEM::WAIT(0);
		func_480(&uLocal_1624);
		UNK1::_0x208784099002BC30("M_ASS4", 0);
		if (func_479(&uScriptParam_1911))
		{
			if (func_478())
			{
				func_534();
				func_477(&Local_983);
				func_476(iLocal_1495, Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
				func_476(iLocal_1496, Vector(28.3097f, -764.507f, 305.0073f) + Vector(2f, 2f, 2f), Vector(28.3097f, -764.507f, 305.0073f) - Vector(2f, 2f, 2f));
				func_475();
				...
				func_474(&uLocal_1899, 0, 0);
				UI::CLEAR_HELP(1);
				GRAPHICS::_SET_FAR_SHADOWS_SUPPRESSED(1);
				func_531();
				PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
				func_473(&uLocal_1624);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (func_163(&uScriptParam_1911, &Local_983))
			{
				Global_106070.f_19935.f_8 = func_159(&iLocal_976);
				fLocal_132 = Global_106070.f_19935.f_8;
				func_158();
				func_108();
	...
	switch (iLocal_982)
	{
		case 0:
			if (!iLocal_137)
			{
				...
				fLocal_132 = func_159(&iLocal_976);
				func_100();
				iLocal_137 = 1;
				iLocal_982 = 1;
			}
		...
		case 1:
			...
			if (func_96(&uLocal_148, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
				func_95(uParam1, 0, 0, 0, 1);
				func_94(uParam1, &(Local_725.f_60), 2, 215, 1, 1, 0);
		...
		case 2:
			if (func_61(&uLocal_148, 0, 1065353216, 0, 0, 0))
			{
				bLocal_970 = true;
			}
			if (!bLocal_970)
...
void func_100()
{
	...
	if (!iLocal_137)
	{
		func_106(&uLocal_148, &Local_725, &Global_56196, 0);
		fLocal_132 = (fLocal_132 * 1000f);
		if (Global_87504)
		{
			func_105(&uLocal_148, 6, &(Local_725.f_12), "MTPHPERSKI", SYSTEM::FLOOR(fLocal_132), 0, 3, 0);
			func_105(&uLocal_148, 6, &(Local_725.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_105(&uLocal_148, 6, &(Local_725.f_30), "MTPHPERSKI", SYSTEM::ROUND((fLocal_134 + fLocal_133)), 0, 3, 0);
			func_104();
		}
		else
		{
			if (bLocal_136)
			{
				func_105(&uLocal_148, 6, &(Local_725.f_12), "MTPHPERRET", SYSTEM::FLOOR(fLocal_132), 0, 3, 0);
			}
			else
			{
				func_105(&uLocal_148, 9, &(Local_725.f_12), "", SYSTEM::FLOOR(fLocal_132), 0, 0, 0);
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_725.f_18)))
			{
				if (bLocal_135)
				{
					func_105(&uLocal_148, 6, &(Local_725.f_24), "", 0, 0, 2, 0);
					func_105(&uLocal_148, 3, &(Local_725.f_30), "", SYSTEM::ROUND((fLocal_134 + fLocal_133)), 0, 2, 0);
				}
				else
				{
					func_105(&uLocal_148, 6, &(Local_725.f_24), "", 0, 0, 1, 0);
					func_105(&uLocal_148, 3, &(Local_725.f_30), "", SYSTEM::ROUND(fLocal_133), 0, 0, 0);
				}
			}
			else
			{
		...
		if (iVar0 == 1)
		{
			iLocal_143 = 50;
			iLocal_144 = 1;
			func_103(&uLocal_148, 1, &(Local_725.f_48), iLocal_143, 0, 0, 1, 0);
		}
		else if (bLocal_135)
		{
			if (bLocal_136)
			{
				iLocal_143 = 75;
				iLocal_144 = 2;
				func_103(&uLocal_148, 1, &(Local_725.f_42), iLocal_143, 0, 0, 2, 0);
			}
			else
			{
				iLocal_143 = 100;
				iLocal_144 = 3;
				func_103(&uLocal_148, 1, &(Local_725.f_36), iLocal_143, 0, 0, 3, 0);
			}
		}
...
void func_101()
{
	...
	{
		func_102(38, SYSTEM::FLOOR(fLocal_132), 1);
		if (bLocal_135)
		{
			func_102(39, 1, 1);
		}
		...
		if (bLocal_135)
		{
			func_102(40, SYSTEM::ROUND((fLocal_134 + fLocal_133)), 1);
		}
		else
		{
			func_102(40, SYSTEM::ROUND(fLocal_133), 1);
		}
		func_102(41, iLocal_143, 1);
		func_102(42, iLocal_144, 1);
	}
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_multi")) == 1)
	{
		func_102(52, SYSTEM::FLOOR(fLocal_132), 1);
		if (bLocal_135)
		{
			func_102(53, 1, 1);
		}
		...
		if (bLocal_135)
		{
			func_102(56, SYSTEM::ROUND((fLocal_134 + fLocal_133)), 1);
		}
		else
		{
			func_102(56, SYSTEM::ROUND(fLocal_133), 1);
		}
		func_102(54, iLocal_143, 1);
		func_102(55, iLocal_144, 1);
	}
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_hooker")) == 1)
	{
		func_102(66, SYSTEM::FLOOR(fLocal_132), 1);
		if (bLocal_135)
		{
			func_102(67, 1, 1);
		}
		...
		if (bLocal_135)
		{
			func_102(68, SYSTEM::ROUND((fLocal_134 + fLocal_133)), 1);
		}
		else
		{
			func_102(68, SYSTEM::ROUND(fLocal_133), 1);
		}
		func_102(69, iLocal_143, 1);
		func_102(70, iLocal_144, 1);
	}
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_bus")) == 1)
	{
		func_102(81, SYSTEM::FLOOR(fLocal_132), 1);
		if (bLocal_135)
		{
			func_102(82, 1, 1);
		}
		...
		if (bLocal_135)
		{
			func_102(83, SYSTEM::ROUND((fLocal_134 + fLocal_133)), 1);
		}
		else
		{
			func_102(83, SYSTEM::ROUND(fLocal_133), 1);
		}
		func_102(84, iLocal_143, 1);
		func_102(85, iLocal_144, 1);
	}
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_construction")) == 1)
	{
		func_102(97, SYSTEM::FLOOR(fLocal_132), 1);
		if (bLocal_135)
		{
			func_102(98, 1, 1);
		}
		...
		if (bLocal_135)
		{
			func_102(99, SYSTEM::ROUND((fLocal_134 + fLocal_133)), 1);
		}
		else
		{
			func_102(99, SYSTEM::ROUND(fLocal_133), 1);
		}
		func_102(100, iLocal_143, 1);
		func_102(101, iLocal_144, 1);
	}
}
...
void func_108()
{
	...
	{
		func_109(iLocal_1463, -25.2554f, -1438.239f, 29.6542f, 2.31f, 24, 0);
	}
}

void func_109(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (func_151(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_144(iParam3, &Var0, vParam1, fParam2, func_150(iParam0));
		func_110(iParam3, iParam0, 0);
	}
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_127(iParam0, 0, 0)) || func_127(iParam0, 1, 0)) || func_127(iParam0, 2, 0)) || func_150(iParam0) != 145) || func_126(iParam0)) || func_125(iParam0)) || func_124(iParam0)) || func_123(iParam0)) || !func_113(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_125(iParam0))
		{
		}
...
var func_130()
{
	...
	func_140(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_139(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_138(&uVar0, TIME::GET_CLOCK_HOURS());
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_136(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_144(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_141(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
...
bool func_151(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_153(iVar0 + 1));
			}
			iVar0++;
		}
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!PED::IS_PED_INJURED(Local_1898[iVar0 /*30*/].f_14[iVar1]) && PED::IS_PED_IN_ANY_VEHICLE(Local_1898[iVar0 /*30*/].f_14[iVar1], 0))
			{
				...
				PED::SET_PED_FLEE_ATTRIBUTES(Local_1898[iVar0 /*30*/].f_14[iVar1], 2, 0);
...
float func_159(int iParam0)
{
	if (func_162(iParam0))
	{
		...
		{
			return (func_160(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_163(var uParam0, int iParam1)
{
	...
	switch (iLocal_980)
	{
		...
		case 4:
			func_458(uParam0);
			func_453(uParam0, &uLocal_1624, 0);
			func_452();
			PED::SET_PED_MODEL_IS_SUPPRESSED(*uParam0, 1);
			func_449(uParam0, &Local_983);
			func_448(uParam0);
			if (bLocal_1389)
			{
				if (Global_106070.f_19935.f_8 != 0f)
				{
					func_447(&iLocal_976, Global_106070.f_19935.f_8);
				}
				if (iLocal_1432 == 0)
				{
		...
		case 5:
			if (func_427(uParam0, &uLocal_1624, 0))
			{
				iLocal_980 = 6;
			}
			break;
		...
		case 6:
			if (!CAM::IS_SCREEN_FADING_IN())
			{
				...
				func_425(&(iParam1->f_2), 388.7943f, -681.7061f, 28.149f, 272.5919f);
				func_375(0, "assassin_bus_enter_bus", 0, 0, 0, 1);
				func_369(iLocal_1462);
				iLocal_980 = 7;
			}
			break;
		...
		case 7:
			...
			{
				func_364();
				if (func_362(uParam0->f_6, fLocal_1438) && PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()))
				{
					if (UI::DOES_BLIP_EXIST(iParam1->f_2))
					{
						UI::REMOVE_BLIP(&(iParam1->f_2));
				...
				{
					func_361(iParam1->f_2, "ASS_BS_COPS");
			...
			func_357(iParam1);
			func_356();
			if ((((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && func_355(iParam1->f_1, 1) < fLocal_1438) || !func_354(iParam1->f_1)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, uParam0->f_9, 25f)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1->f_1, PLAYER::PLAYER_PED_ID(), 1))
			{
				func_344(Local_1346, uParam0, 2);
			}
			break;
		...
		case 10:
			...
			if (func_342(&Local_983, uParam0))
			{
				...
				func_340(&iLocal_1405, &(iParam1->f_16), "OJASAUD", "OJAS_BUCOM", 9, 1, 0, 0);
				func_339(iParam1, 1);
				iLocal_980 = 11;
			}
			else
			{
				func_198(uParam0, &Local_983);
				func_197(iParam1);
			}
			break;
		...
		case 12:
			...
			if (func_193(iParam1))
			{
				...
				else if (!iLocal_968)
				{
					...
					func_426("ASS_BS_COPS", 7500, 1);
					func_179(&iLocal_1483);
					func_179(&iLocal_1477);
					iLocal_968 = 1;
				}
				else
				{
...
int func_168(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_172() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_169(func_171(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_175()
{
	if (!iLocal_1408)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			if (!func_162(&iLocal_1492))
			{
				func_179(&iLocal_1492);
			}
			else if (func_176(&iLocal_1492, 10f))
			{
...
int func_180(int iParam0)
{
	...
	{
		func_92(0);
		func_192(&(iParam0->f_16), 3, 0, "LESTER", 0, 1);
		if (func_182(&(iParam0->f_16), 12, "OJASAUD", "OJAS_BUS_C", 14, 1, 0, 0, 0))
		{
			iLocal_1403 = 1;
		}
	}
	if (iLocal_1403 && func_181())
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_1433)
	{
		...
		case 2:
			...
			if (SYSTEM::VDIST2(vVar1, vVar0) > 2500f)
			{
				...
				{
					UI::CLEAR_THIS_PRINT("ASS_BS_EXIT");
				}
				return 1;
			}
			break;
...
bool func_194(char* sParam0, int iParam1, char* sParam2)
{
...
void func_195(int iParam0, bool bParam1)
{
	...
	if (!func_162(&iLocal_1489))
	{
		func_179(&iLocal_1489);
	}
	if (func_159(&iLocal_1489) > fLocal_1439)
	{
		...
		fLocal_1439 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
		func_179(&iLocal_1489);
	}
}
...
void func_196()
{
	if (CAM::DOES_CAM_EXIST(iLocal_140))
	{
		...
		{
			CAM::SET_CAM_ACTIVE(iLocal_140, 0);
...
void func_198(var uParam0, int iParam1)
{
	...
	switch (iLocal_1345)
	{
		case 0:
			...
			if (!UI::DOES_BLIP_EXIST(iParam1->f_2))
			{
				iParam1->f_2 = func_337(iParam1->f_1, 1, 0);
			}
		...
		case 3:
			func_299(iParam1, uParam0);
			func_297(iParam1, 0);
			break;
		
		case 4:
			func_273(iParam1, iParam1);
			break;
		...
		case 5:
			...
			func_272();
			func_271();
			func_267(*iParam1, iParam1->f_8, iParam1);
			func_237(&uLocal_1899, *iParam1, 0, 0, 1, 1, 1);
			func_339(iParam1, 1);
			break;
...
void func_200(int iParam0)
{
	...
	if (!func_212())
	{
		if (func_162(&iLocal_1483))
		{
			if (func_159(&iLocal_1483) > 5f)
			{
				if (iLocal_1382)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam0->f_1, 0))
						{
							...
							if (fVar0 > 10f)
							{
								...
								{
									if (func_159(&iLocal_1474) >= IntToFloat(iLocal_1416) && func_355(*iParam0, 1) <= 50f)
									{
										if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_8, 0))
										{
											...
											{
												func_210(&(iParam0->f_16), "OJASAUD", "OJASbs_FOOT", "OJASbs_FOOT_1", 9, 0, 0);
												func_209(3, 12);
												iLocal_1380 = 1;
											}
										}
									}
									else if (func_159(&iLocal_1477) >= IntToFloat(iLocal_1421))
									{
										func_207(iParam0);
									}
								}
	...
	if (iLocal_1424 > 0)
	{
		switch (iLocal_1419)
		{
			case 0:
				...
				if (iVar0 == 0)
				{
					if (func_204(uParam0, iLocal_1453))
					{
						func_192(&(uParam0->f_16), 4, iLocal_1453, "BusPed1", 0, 1);
						func_203(&(uParam0->f_16), "OJASAUD", "OJASbs_DMG", 9, 0, 0, 0);
						iLocal_1425 = iLocal_1424;
						iLocal_1419++;
					}
				}
				else if (func_204(uParam0, iLocal_1455))
				{
					func_192(&(uParam0->f_16), 6, iLocal_1455, "BusPed3", 0, 1);
			...
			case 1:
				...
				{
					if (func_204(uParam0, iLocal_1454))
					{
						func_192(&(uParam0->f_16), 5, iLocal_1454, "BusPed2", 0, 1);
	...
	switch (iLocal_1427)
	{
		...
		case 3:
			if (!func_212())
			{
				...
				{
					if (func_204(uParam0, iLocal_1455))
					{
						func_192(&(uParam0->f_16), 6, iLocal_1455, "BusPed3", 0, 1);
...
void func_206(var uParam0)
{
	...
	else if (!PED::IS_PED_INJURED(*uParam0))
	{
		...
		{
			if (func_159(&iLocal_1474) >= IntToFloat(iLocal_1416))
			{
...
void func_207(var uParam0)
{
	if (func_162(&iLocal_1477))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, 0))
			{
				if (func_159(&iLocal_1477) >= IntToFloat(iLocal_1421))
				{
					switch (iLocal_1417)
					{
						case 0:
						...
						case 3:
							if (func_204(uParam0, iLocal_1453))
							{
								func_192(&(uParam0->f_16), 6, iLocal_1453, "BusPed3", 0, 1);
...
{
	iLocal_1421 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_179(&iLocal_1477);
	func_179(&iLocal_1483);
	iLocal_1417++;
}
...
{
	iLocal_1416 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_179(&iLocal_1474);
	func_179(&iLocal_1483);
	iLocal_1415++;
}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam1->f_1, 0))
					{
						if (bLocal_1378 == 1)
						{
							...
							if (!func_162(&iLocal_1471))
							{
								func_434(&iLocal_1471);
							}
							else
							{
								func_179(&iLocal_1471);
							}
							if (!iLocal_1379)
							{
...
void func_214(int iParam0)
{
	if (func_162(iParam0))
	{
		if (!func_161(iParam0))
		{
			iParam0->f_2 = (func_160(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
...
void func_215()
{
	UI::REMOVE_BLIP(&(Local_1898[0 /*30*/].f_9));
	UI::REMOVE_BLIP(&(Local_1898[1 /*30*/].f_9));
	UI::REMOVE_BLIP(&(Local_1898[2 /*30*/].f_9));
	UI::REMOVE_BLIP(&(Local_1898[3 /*30*/].f_9));
}
...
void func_217(var uParam0, int iParam1)
{
	if (!iLocal_1377 == 1)
	{
		if (iLocal_1345 < 4)
		{
			if (((((func_226(*iParam1, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_224(&uLocal_1414)) || iLocal_1424 >= 2) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0)) || func_223(*iParam1, iParam1->f_8, 1097859072))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
				{
				}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(*iParam1))
					{
						if (!PED::IS_PED_INJURED(*iParam1))
						{
							if (func_355(*iParam1, 1) < 30f || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*iParam1, PLAYER::PLAYER_PED_ID(), 1))
							{
								func_215();
								if (UI::DOES_BLIP_EXIST(iParam1->f_2))
								{
								...
								iLocal_1381 = 1;
								if ((func_221(iParam1) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam1->f_1)) && !ENTITY::IS_ENTITY_ON_SCREEN(*iParam1))
								{
									PED::SET_PED_INTO_VEHICLE(*iParam1, iParam1->f_8, -1);
									func_219(iParam1, &(iParam1->f_8));
									iLocal_1345 = 5;
								}
								else
								{
									bLocal_1383 = true;
									func_203(&(iParam1->f_16), "OJASAUD", "OJASbs_FOOT3", 9, 0, 0, 0);
									iLocal_1382 = 1;
									iLocal_1345 = 6;
								}
							}
...
void func_219(var uParam0, var uParam1)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		if (!PED::IS_PED_INJURED(*uParam0))
		{
			...
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(*uParam1))
				{
...
{
	AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iParam0, iParam1, "OJASbs_102", 52, 0, 20, -1, -1f, 0, 1073741824);
	vLocal_1440 = { -455.2892f, -326.1364f, 41.22218f };
	AI::WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &iLocal_1430);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iParam0, 1, 1);
	fLocal_1435 = VEHICLE::_0x53AF99BAA671CA47(iParam1);
...
int func_221(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1, 0) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_8, 0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
		{
			...
			{
				if (func_222(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_5, 1) > 5f || ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0->f_1, uParam0->f_8))
				{
					return 0;
				}
			}
...
float func_222(int iParam0, vector3 vParam1, int iParam2)
{
...
int func_224(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		{
			if (func_226(iVar0, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_225())
			{
				return 1;
			}
		}
...
int func_227(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_355(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_230(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(iParam0) || func_231(iVar1))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam1), iParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam1, iParam0, 17))
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
				{
					...
					{
						if (func_232(PLAYER::PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
...
void func_234(int iParam0)
{
	if (!PED::IS_PED_INJURED(*iParam0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((AI::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(*iParam0, -1824940423) != 1) && AI::GET_SCRIPT_TASK_STATUS(*iParam0, 242628503) != 1)
			{
				AI::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			PED::SET_PED_MAX_MOVE_BLEND_RATIO(*iParam0, 2f);
		}
		else if (((AI::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) != 0) && AI::GET_SCRIPT_TASK_STATUS(*iParam0, 242628503) != 1) && AI::GET_SCRIPT_TASK_STATUS(*iParam0, 242628503) != 0)
		{
			AI::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		}
	}
	...
	if (!UI::DOES_BLIP_EXIST(uParam0->f_2))
	{
		if (!PED::IS_PED_INJURED(*uParam0))
		{
			if (iParam1 || !func_212())
			{
				...
				uParam0->f_2 = UI::ADD_BLIP_FOR_ENTITY(*uParam0);
...
void func_239(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_240(uParam0, iParam1, vParam2, sParam3, iParam4, bParam5, uParam6, bParam7);
}
...
void func_240(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_264(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
		...
		{
			if (func_259(uParam0, bParam5, bParam7, 0))
			{
				func_256(uParam0, iParam1, vParam2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_245(char* sParam0)
{
	if (!func_246(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_266(sParam0)) || func_266("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_246(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_254() || func_253(Global_4456448.f_152990)) || func_252())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_250(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_247(int iParam0)
{
	if (iParam0 != func_249())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_248(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_256(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_151(vParam2, 0f, 0f, 0f, 0))
	{
		if (ENTITY::IS_ENTITY_A_PED(iParam1))
		{
...
int func_259(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_262(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_260(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_267(int iParam0, int iParam1, var uParam2)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam1))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 451360105) != 1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, 451360105) != 0)
					{
						AI::TASK_LEAVE_VEHICLE(iParam0, iParam1, 0);
					}
				}
				else
				{
			...
			else if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, -1794415470) != 1)
			{
				func_268(iParam0);
			}
		}
...
void func_268(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		{
			if (func_222(iParam0, vLocal_1440, 1) <= 50f)
			{
				AI::CLEAR_SEQUENCE_TASK(&uVar0);
				AI::OPEN_SEQUENCE_TASK(&uVar0);
				AI::TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1440, 2f, 0, 0, 786603, -1082130432);
...
void func_270(int iParam0, int iParam1)
{
	...
	if (!func_162(&iLocal_1486))
	{
		func_434(&iLocal_1486);
	}
	if (func_159(&iLocal_1486) > 1f)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam1))
			{
				...
				iVar1 = AI::GET_VEHICLE_WAYPOINT_PROGRESS(iParam1);
				...
				if (fLocal_1436 != 0f)
				{
					AI::SET_DRIVE_TASK_CRUISE_SPEED(iParam0, fLocal_1436);
				}
			}
		}
	}
	else if (func_159(&iLocal_1486) >= 2f)
	{
		func_179(&iLocal_1486);
	}
}
...
void func_271()
{
	if (!iLocal_1396)
	{
		...
		{
			AI::CLEAR_PED_TASKS(iLocal_1498);
			AI::TASK_PLAY_ANIM(iLocal_1498, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			AUDIO::PLAY_PAIN(iLocal_1498, 6, 0, 0);
			iLocal_1396 = 1;
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_1498))
	{
		if (func_226(iLocal_1498, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iLocal_1498, 1805844857) != 1)
			{
				AI::CLEAR_PED_TASKS(iLocal_1498);
				AI::TASK_SMART_FLEE_PED(iLocal_1498, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
		}
		if (func_355(iLocal_1498, 1) > 100f)
		{
	...
	switch (iLocal_1412)
	{
		...
		case 1:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				{
					CAM::SET_CAM_ACTIVE(iLocal_1464, 0);
				...
				if ((ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(uParam1->f_8, 0))
				{
					...
					{
						AI::TASK_ENTER_VEHICLE(*uParam0, uParam1->f_8, 20000, -1, 2f, 1, 0);
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!PED::IS_PED_INJURED(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(Local_1898[iParam1 /*30*/].f_14[iVar0]);
				AI::OPEN_SEQUENCE_TASK(&uVar1);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iParam0, 0);
				AI::TASK_PLAY_ANIM(0, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar1);
				AI::TASK_PERFORM_SEQUENCE(Local_1898[iParam1 /*30*/].f_14[iVar0], uVar1);
...
void func_278(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_282(PLAYER::PLAYER_ID())) && !func_280(PLAYER::PLAYER_ID(), 0)) && !func_279()) && !bParam4)
			{
...
void func_286(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_1499 != 0 && iLocal_1499 != joaat("object")) && iLocal_1499 != joaat("gadget_parachute"))
		{
			...
			{
				WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_1499, 0);
			}
		}
	}
}

void func_287(vector3 vParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_288(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_151(vParam0, 0f, 0f, 0f, 0) && !func_151(vParam1, 0f, 0f, 0f, 0))
			{
				fParam2 = fParam2;
			}
		}
...
int func_292(int iParam0, float fParam1)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_295(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
		{
			iVar0 = 0;
		}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, 0))
		{
			...
			if (func_259(&uLocal_1899, 1, 0, 0))
			{
				...
				if (!CAM::IS_CAM_ACTIVE(iLocal_140))
				{
					CAM::SET_CAM_ACTIVE(iLocal_140, 1);
...
void func_298(var uParam0)
{
	...
	if (func_162(&iLocal_1480))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, 0))
			{
				if (func_159(&iLocal_1480) >= 7f || iLocal_1394)
				{
					switch (iLocal_1418)
					{
						case 0:
...
void func_299(var uParam0, var uParam1)
{
	...
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_1898[iVar0 /*30*/].f_1, 15f, 0, 0, 0, 0, false, 0);
	}
	if (iLocal_1391)
	{
		fVar1 = ((ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) / 5f) + 6f);
		if (func_162(&iLocal_1468))
		{
			func_177(&iLocal_1468);
		}
	}
	if (bLocal_1386)
	{
	...
	if (bLocal_1387)
	{
		...
		{
			if (func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1) >= 10f)
			{
				bLocal_1387 = false;
			}
			else
			{
				fVar2 = func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1);
			}
		}
	}
	if (iLocal_1391)
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1))
		{
			if (Local_1898[iVar0 /*30*/])
			{
				...
				if ((((GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar3, Local_1898[iVar0 /*30*/].f_21, 1) <= fVar1 && PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) && STREAMING::_0x7D41E9D2D17C5B2D(uLocal_1497)) && !func_326(iVar0)) && !bLocal_1387)
				{
					iLocal_1391 = 0;
				}
				if (iLocal_1429 > 0)
				{
					...
					if (!iLocal_1404)
					{
						fLocal_1450 = func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1);
						iLocal_1404 = 1;
					}
					if (func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1) > (fLocal_1450 + 100f) && func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1) < (fLocal_1450 + 200f))
					{
						func_324(uParam0);
					}
					else if (func_222(uParam0->f_1, Local_1898[iVar0 /*30*/].f_1, 1) > (fLocal_1450 + 200f))
					{
						func_344(Local_1346, uParam1, 4);
					}
				}
			}
			if (!iLocal_1391)
	...
	switch (iLocal_1411)
	{
		case 0:
			if (Local_1898[iParam2 /*30*/])
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, 0f, 0f, 0f, 1) > 0.23f)
				{
					bLocal_1388 = true;
				...
				CAM::SET_CAM_ACTIVE(iLocal_1464, 1);
				if (!bLocal_1384)
				{
				...
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				...
				else
				{
					...
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar3, 5000, 0, 2);
				}
				func_290(uParam0->f_1);
				UI::CLEAR_HELP(1);
				if (!func_162(&iLocal_1468))
				{
					func_434(&iLocal_1468);
				}
				else
				{
					func_179(&iLocal_1468);
				}
				iLocal_1397 = 0;
				iLocal_1411++;
			}
		...
		case 1:
			...
			if (!iLocal_1397)
			{
				...
				else if (func_162(&iLocal_1468))
				{
					if (func_159(&iLocal_1468) > 4f)
					{
						func_317(uParam0, iParam2);
						iLocal_1397 = 1;
					}
			...
			if (func_162(&iLocal_1468))
			{
				if (func_159(&iLocal_1468) > fLocal_1437)
				{
					...
					func_315(uParam0);
					iVar1 = func_314(vLocal_1441, iParam2);
					if (iParam2 == 0)
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(iVar1, uParam0->f_1, 20000, 0, 2f, 258, 0);
		...
		case 2:
			...
			if ((func_159(&iLocal_1468) > 1.5f && !bLocal_1388) || (bLocal_1388 && !func_212()))
			{
				func_309(uParam0, iParam2);
				func_179(&iLocal_1468);
				UI::REMOVE_BLIP(&(Local_1898[iParam2 /*30*/].f_9));
				Local_1898[iParam2 /*30*/] = 0;
				func_304(uParam1, uParam0, iLocal_1428[iLocal_1429], 1);
			}
			break;
	}
	if (iLocal_1411 == 1)
	{
		if (func_302(iLocal_142))
		{
			...
			if (iParam2 == iLocal_1413)
			{
				...
				GAMEPLAY::CLEAR_AREA(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0, 0, 0, false);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0);
				func_275(*uParam0, iLocal_1413);
				func_301(uParam0);
				func_235(uParam0, 1);
...
{
	if (func_303() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_304(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (iParam2 == iLocal_1413)
	{
		func_306(uParam0, uParam1, iLocal_1413);
		func_305(uParam1);
		uParam1->f_182 = 1;
	}
	if (bParam3)
...
void func_306(var uParam0, var uParam1, int iParam2)
{
	...
	{
		AI::TASK_PLAY_ANIM(*uParam1, "oddjobs@assassinate@bus@", "base", 8f, -16f, -1, 1, 0f, 0, 0, 0);
	}
}
...
void func_308(var uParam0, int iParam1)
{
	...
	GAMEPLAY::CLEAR_AREA(Local_1898[iParam1 /*30*/].f_1, 10f, 0, 0, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[0]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[0], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[1]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[1], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[1], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[2]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[2], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[2], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0);
	}
	if (iParam1 == 3)
	{
...
var func_314(vector3 vParam0, int iParam1)
{
	var uVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar3 <= 2)
	{
		...
		{
			fVar1 = func_222(Local_1898[iParam1 /*30*/].f_14[iVar3], vParam0, 1);
			if (fVar1 < fVar2)
			{
...
void func_316(var uParam0, int iParam1)
{
	...
	{
		iVar1 = func_314(vLocal_1441, iParam1);
	}
	if (!PED::IS_PED_INJURED(iVar1))
	{
		AI::CLEAR_PED_TASKS_IMMEDIATELY(iVar1);
...
void func_317(var uParam0, int iParam1)
{
	...
	{
		iVar0 = func_314(vLocal_1441, iParam1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0, 0))
	{
		...
		if (iParam1 == 0)
		{
			...
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iVar0, 305.2689f, -768.1415f, 28.17335f, 1f, 20000, 0.25f, 0, 40000f);
			PED::FORCE_PED_MOTION_STATE(iVar0, -668482597, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			PED::SET_PED_MOVEMENT_CLIPSET(iVar0, "move_m@casual@d", 1048576000);
			AI::TASK_GO_STRAIGHT_TO_COORD(iVar0, 358.6953f, -1065.935f, 28.39328f, 1f, 20000, 1193033728, 1056964608);
		}
		else if (iParam1 == 3)
		{
			AI::TASK_GO_STRAIGHT_TO_COORD(iVar0, 111.6832f, -781.5098f, 30.26971f, 1f, 20000, 1193033728, 1056964608);
		}
		else
		{
			AI::TASK_ENTER_VEHICLE(iVar0, uParam0->f_1, 20000, 0, 1f, 256, 0);
		}
	}
}
...
void func_318(var uParam0, int iParam1)
{
	switch (iLocal_1431)
	{
		case 0:
			...
			{
				case 0:
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(PLAYER::PLAYER_PED_ID(), uParam0->f_1, "OJASbs01", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_203(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNG", 9, 0, 0, 0);
					break;
				
				case 1:
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(PLAYER::PLAYER_PED_ID(), uParam0->f_1, "OJASbs02", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_203(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGa", 9, 0, 0, 0);
					break;
				
				case 2:
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(PLAYER::PLAYER_PED_ID(), uParam0->f_1, "OJASbs03", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_203(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGb", 9, 0, 0, 0);
					break;
				
				case 3:
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(PLAYER::PLAYER_PED_ID(), uParam0->f_1, "OJASbs04", 786603, 0, 16, -1, 3f, 0, 1073741824);
...
void func_319(var uParam0, int iParam1, bool bParam2)
{
	...
	vVar1 = { 0f, -3f, 0f };
	AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
	if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uParam0->f_1))
	{
		AI::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(uParam0->f_1);
	}
	if (iParam1 == 0)
	{
	...
	GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_1442, &uVar0, 0, 0);
	...
	if (bParam2)
	{
		AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_1441, 5000, 0, 2);
	}
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_1, 0))
	{
		...
		while (iVar1 < 8)
		{
			if (!VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_1, iVar1, 0))
			{
				...
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar0[iVar1], 1, 0);
...
void func_321(int iParam0)
{
	...
	if (!bLocal_1386)
	{
		if (func_322(vVar2, vVar3) < 0f && func_322(vVar5, vVar6) > 0f)
		{
			bLocal_1385 = true;
			bLocal_1384 = false;
		}
...
void func_324(var uParam0)
{
	...
	switch (iLocal_1420)
	{
		case 0:
			...
			else if (func_204(uParam0, iLocal_1453))
			{
				if (!func_212())
				{
					func_192(&(uParam0->f_16), 4, iLocal_1453, "BusPed1", 0, 1);
...
int func_326(int iParam0)
{
	...
	fVar0 = ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID());
	fVar1 = (Local_1898[iParam0 /*30*/].f_4 - 180f);
	if (SYSTEM::COS(GAMEPLAY::ABSF((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1386 = false;
		iVar2 = 0;
	}
	else
	{
		...
		{
			UI::CLEAR_THIS_PRINT("ASS_BS_BOARD");
		}
...
void func_327(int iParam0)
{
	if (!iLocal_1406)
	{
		if (func_360(Local_1898[iParam0 /*30*/].f_1, 1) <= 100f)
		{
			if (!func_328(Local_1898[iParam0 /*30*/].f_24))
			{
	...
	else if (func_360(Local_1898[iParam0 /*30*/].f_1, 1) > 120f)
	{
		func_291();
...
void func_329()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!UI::DOES_BLIP_EXIST(Local_1898[iVar0 /*30*/].f_9))
			{
				vVar1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1898[iVar0 /*30*/].f_1, Local_1898[iVar0 /*30*/].f_4, 0f, 3f, 0f) };
				Local_1898[iVar0 /*30*/].f_9 = func_330(vVar1, 1);
				UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_1898[iVar0 /*30*/].f_9, &(Local_1898[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
var func_330(vector3 vParam0, int iParam1)
{
	var uVar0;
...
void func_333(var uParam0, var uParam1)
{
	...
	func_304(uParam0, uParam1, iLocal_1428[0], 0);
}
					...
					while (iVar0 < 9)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, iVar0, 0) != 0)
							{
								...
								func_192(&(uParam0->f_16), 7, iLocal_1457, "BusPed7", 0, 1);
								iLocal_1395 = 1;
							}
						}
						iVar0++;
					}
					if (func_204(uParam0, iLocal_1457))
					{
			...
			while (iVar0 < 9)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, iVar0, 0) != 0)
					{
						...
						if (!bParam1)
						{
							if ((GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 65535) % 3) < 1)
							{
						...
						if (bParam1)
						{
							if ((iVar0 % 2) == 0)
							{
								AI::TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
							}
							else
							{
								AI::TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
							}
						}
					}
				}
	...
	if (CAM::IS_SCREEN_FADED_IN())
	{
		...
		else if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (PED::IS_PED_INJURED(*uParam0))
			{
				...
				else if (func_162(&iLocal_973) && func_159(&iLocal_973) < 3f)
				{
					iLocal_965 = 1;
				}
				UNK1::_0x293220DA1B46CEBC(3f, 2f, 3);
...
void func_344(struct<182> Param0, var uParam1, var uParam2, int iParam3)
{
	struct<2> Var0;
...
void func_347(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_349(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
{
	return func_232(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, iParam1);
}
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					...
					{
						iLocal_1463 = iVar0;
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1463, 1, 1);
						VEHICLE::_0x02398B627547189C(iLocal_1463, 0);
					}
				}
			}
		}
...
void func_358()
{
	if (!func_44(uLocal_120, 2))
	{
		func_535(&uLocal_120, 2);
	}
}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1458[3]))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(uParam0->f_16) && STREAMING::HAS_MODEL_LOADED(uParam0->f_14)) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_eastsa_01")))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1458[0]))
			{
				...
				if (AI::DOES_SCENARIO_EXIST_IN_AREA(435.0773f, -650.2194f, 27.74271f, 2f, 1))
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(iLocal_1458[0], 1193033728, 0);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1458[1]))
			{
				iLocal_1458[1] = PED::CREATE_PED(4, uParam0->f_16, 436.3171f, -642.8832f, 27.73943f, 32.8396f, 1, true);
				if (AI::DOES_SCENARIO_EXIST_IN_AREA(436.3171f, -642.8832f, 27.73943f, 2f, 1))
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(iLocal_1458[1], 1193033728, 0);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1458[2]))
			{
				iLocal_1458[2] = PED::CREATE_PED(4, uParam0->f_14, 435.6569f, -645.5588f, 27.73775f, 343.8998f, 1, true);
				if (AI::DOES_SCENARIO_EXIST_IN_AREA(435.6569f, -645.5588f, 27.73775f, 2f, 1))
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(iLocal_1458[2], 1193033728, 0);
				}
			}
			...
			if (AI::DOES_SCENARIO_EXIST_IN_AREA(436.6802f, -629.7325f, 27.71444f, 2f, 1))
			{
				AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				AI::TASK_WANDER_STANDARD(iLocal_1458[3], 1193033728, 0);
			}
			return 1;
		}
	}
...
float func_360(vector3 vParam0, int iParam1)
{
	return func_222(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), vParam0, iParam1);
}
...
int func_362(vector3 vParam0, float fParam1)
{
	if (func_360(vParam0, 1) <= fParam1 && !func_363())
	{
		return 1;
	}
	return 0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			if (Global_90658[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_142(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_375(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_416(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_106070.f_18546[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_415(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_93269, iParam0);
			}
			else
			{
				iVar6 = func_414(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_377(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_387(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_392(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_389(Var7.f_1)) && iVar9 < 50)
			{
...
int func_395(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_397(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_174())
		{
			*uParam0 = func_399(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_399(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_173(iVar0))
		{
			if (!bParam3 || func_413(iVar0))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_400(iVar0, 0), 1);
...
void func_418(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_425(var uParam0, vector3 vParam1, float fParam2)
{
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_427(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) && !func_433(&(uParam0->f_34))) && !func_428(uParam1))
	{
		func_480(uParam1);
		return 0;
	}
...
void func_440(var uParam0, var uParam1)
{
	...
	iLocal_1392 = 0;
	AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(*uParam1, uParam1->f_8, "OJASbs_102", 52, 0, 20, -1, -1f, 0, 1073741824);
	vLocal_1440 = { -455.2892f, -326.1364f, 41.22218f };
	AI::WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &iLocal_1430);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(*uParam1, 1, 1);
	fLocal_1435 = VEHICLE::_0x53AF99BAA671CA47(uParam1->f_8);
...
void func_444(var uParam0, var uParam1)
{
	...
	bLocal_1383 = false;
	iLocal_1405 = 0;
	func_304(uParam0, uParam1, iLocal_1428[iLocal_1413], 0);
	if (ENTITY::DOES_ENTITY_EXIST(Local_1898[3 /*30*/].f_19))
	{
		uParam1->f_8 = Local_1898[3 /*30*/].f_19;
	}
...
{
	GAMEPLAY::CLEAR_AREA(vLocal_1446, 50f, 1, 0, 0, false);
...
{
	iParam0->f_1 = (func_160(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_449(var uParam0, var uParam1)
{
	...
	func_192(&(uParam1->f_16), 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_274 == 1)
	{
		UI::SET_BLIP_NAME_FROM_TEXT_FILE(uParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam1->f_7))
		{
			...
			if (uParam0->f_274 == 1)
			{
				AI::TASK_PLAY_ANIM(uParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0f, 0, 0, 0);
	...
	if (uParam0->f_15 != 0)
	{
		...
		if (uParam0->f_274 == 1)
		{
			...
			func_192(&(Local_983.f_16), 5, iLocal_967, "KerbCrawler", 0, 1);
		}
	}
	if (uParam0->f_274 == 2)
	{
	...
	else if (uParam0->f_274 == 0)
	{
		uParam1->f_2 = UI::ADD_BLIP_FOR_COORD(uParam0->f_6);
		UI::SET_BLIP_ROUTE(uParam1->f_2, 1);
		UI::SET_BLIP_ROUTE_COLOUR(uParam1->f_2, 3);
		UI::SET_BLIP_COLOUR(uParam1->f_2, 3);
		UI::SET_BLIP_NAME_FROM_TEXT_FILE(uParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		uParam1->f_2 = UI::ADD_BLIP_FOR_COORD(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			uParam1->f_11[iVar0] = OBJECT::CREATE_OBJECT(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], 1, 1, 0);
...
void func_453(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) || !func_433(&(uParam0->f_34))) || !func_428(uParam1))
	{
		func_480(uParam1);
		SYSTEM::WAIT(0);
	}
...
void func_463(var uParam0)
{
	switch (iLocal_1347)
	{
		case 0:
			...
			if (bLocal_1370)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1348))
				{
					...
					GAMEPLAY::CLEAR_AREA(-26.48f, -110.66f, 56.0227f, 3f, 1, 0, 0, false);
					if (!func_162(&iLocal_1365))
					{
						func_434(&iLocal_1365);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_1348))
					{
						...
						iLocal_1349 = OBJECT::CREATE_OBJECT(-1559354806, -26.48f, -110.66f, 56.0227f, 1, 1, 0);
					...
					func_278(1, 1, 1, 0, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_1353, 5f, 0);
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
					...
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_1373, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					...
					{
						uLocal_1351 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1358, vLocal_1359, 36f, 1, 2);
						iLocal_1350 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1360, vLocal_1361, 36f, 0, 2);
						CAM::SET_CAM_ACTIVE_WITH_INTERP(iLocal_1350, uLocal_1351, 2500, 1, 1);
						CAM::RENDER_SCRIPT_CAMS(true, 0, 3000, 1, 0, 0);
						CAM::SHAKE_CAM(iLocal_1350, "HAND_SHAKE", 0.2f);
					}
					func_192(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_192(&(uParam0->f_16), 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					UI::DISPLAY_RADAR(0);
					UI::DISPLAY_HUD(0);
				...
				else
				{
					...
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1348))
					{
						iLocal_1348 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_1352, 5f, 1281992692, 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			func_465();
			if (func_162(&iLocal_1362))
			{
				if (func_159(&iLocal_1362) > 1f)
				{
					if (func_303())
					{
						bLocal_1368 = true;
			...
			if (func_162(&iLocal_1362))
			{
				if ((func_159(&iLocal_1362) > fLocal_1355 || (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_1373) >= 0.962f)) || bLocal_1368)
				{
					iLocal_1347 = 3;
				}
			}
...
void func_465()
{
	...
	{
		case 0:
			if (func_466(&iLocal_1350, 4f, -24.8539f, -110.49f, 57.5606f, -1.6505f, 0.0546f, 82.1926f, 35f, 1, 0.2f))
			{
				iLocal_1374 = 1;
			}
			break;
		...
		case 1:
			if (func_466(&iLocal_1350, 11f, -27.3634f, -109.3758f, 57.7306f, -6.4572f, 0.0825f, -115.486f, 40f, 1, 0.3f))
			{
				iLocal_1374 = 2;
			}
			break;
		...
		case 2:
			if (func_466(&iLocal_1350, 19f, -24.5192f, -111.0343f, 57.4342f, 0.7037f, -0.0769f, 66.6607f, 28.6009f, 1, 0.3f))
			{
				iLocal_1374 = 3;
			}
			break;
		...
		case 3:
			if (func_466(&iLocal_1350, 27f, -28.7803f, -108.8278f, 57.6104f, -3.9667f, -0.0497f, -116.5466f, 35.122f, 1, 0.2f))
			{
				iLocal_1374 = 4;
			}
			break;
...
int func_466(int iParam0, float fParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5, float fParam6)
{
	if (CAM::DOES_CAM_EXIST(*iParam0))
	{
		if (func_162(&iLocal_1365))
		{
			if (func_159(&iLocal_1365) >= fParam1)
			{
...
void func_467(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_468(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_468(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_469(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_469(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_471(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_470(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_470(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_470(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_470(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_470(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_470(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_470(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_470(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_470(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_470(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_470(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_470(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_470(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_470(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_470(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_470(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
int func_470(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_475()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1461))
	{
		...
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1461, 1, 0);
		VEHICLE::DELETE_VEHICLE(&iLocal_1461);
	}
}

void func_476(int iParam0, vector3 vParam1, vector3 vParam2)
{
...
{
	func_482(iParam0, &(iParam0->f_2), iParam0->f_1);
}
...
void func_483(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_523())
	{
...
int func_484(vector3 vParam0, float fParam1)
{
	return func_485(&(Global_99633.f_2875), vParam0, fParam1, 0);
}

int func_485(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_513(uParam0))
	{
		...
		if (func_512(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_490(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_151(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_494(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_142(iParam0, iParam1))
				{
...
void func_495(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_153(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_153(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_153(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_503(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_502())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_153(iVar2 + 1)))
				{
...
int func_496(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_500(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_499(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_499(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_498(iParam0);
	if (func_497(*iParam0))
	{
...
void func_511(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_521(vector3 vParam0, vector3 vParam1)
{
...
void func_524(var uParam0)
{
	...
	VEHICLE::_0x1033371FC8E842A7(uLocal_966);
