...
void func_22(vector3 vParam0, int iParam1)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		...
		{
			AI::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 3f);
		}
		iLocal_74 = 1;
	}
}
...
void func_23(vector3 vParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 16000);
			iLocal_60[iVar0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000);
			iLocal_62[iVar0] = 0;
		}
		iVar0++;
	}
...
void func_24()
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_81))
	{
		...
		func_26();
		iVar8 = SYSTEM::FLOOR((CONTROLS::_0x5B84D09CEC5209C5(2, 218) * 127f));
		iVar9 = SYSTEM::FLOOR((CONTROLS::_0x5B84D09CEC5209C5(2, 219) * 127f));
		iVar10 = SYSTEM::FLOOR((CONTROLS::_0x5B84D09CEC5209C5(2, 220) * 127f));
		iVar11 = SYSTEM::FLOOR((CONTROLS::_0x5B84D09CEC5209C5(2, 221) * 127f));
		...
		if ((iVar9 > 28 || iVar9 < -28) || CONTROLS::_IS_INPUT_DISABLED(2))
		{
		...
		if ((iVar8 > 28 || iVar8 < -28) || CONTROLS::_IS_INPUT_DISABLED(2))
		{
...
void func_26()
{
	...
	{
		if (AI::GET_SCRIPT_TASK_STATUS(uLocal_59[2], -880529684) == 7)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_89 + 8000)
			{
				PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_59[2], 0);
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_59[2], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) };
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 6000);
				AI::TASK_LOOK_AT_COORD(uLocal_59[2], vVar0, iVar1, 2049, 2);
...
void func_27()
{
	...
	if (iVar0 < 14)
	{
		if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 223) || iLocal_73 == 1)
		{
...
void func_28()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_57))
		{
			AI::CLEAR_PED_TASKS(iLocal_57);
			AI::OPEN_SEQUENCE_TASK(&iLocal_79);
			AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, 120.8878f, 239.3244f, 106.5131f, 3f, 0, joaat("tourbus"), iLocal_264, 5f, 15f);
			AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, Local_51.f_1, 3f, 0, joaat("tourbus"), iLocal_264, 3f, 15f);
			AI::CLOSE_SEQUENCE_TASK(iLocal_79);
			AI::TASK_PERFORM_SEQUENCE(iLocal_57, iLocal_79);
...
void func_30(vector3 vParam0, float fParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam0.x, vParam0.y, vParam0.z, 5f, 0, 0, 0, 0, false, 0);
		...
		AI::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, ENTITY::GET_ENTITY_COORDS(iLocal_63, true), 0f, 0, joaat("tourbus"), iLocal_264, 5f, 15f);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		...
		if (iVar0 < 13)
		{
			if (!PED::IS_PED_INJURED(iLocal_57))
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_50[iVar0 /*15*/].f_1, Local_50[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_264, 5f, 15f);
			}
		}
		else if (!PED::IS_PED_INJURED(iLocal_57))
		{
			AI::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_51.f_1, Local_50[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_264, 5f, 15f);
		}
		...
		switch (iLocal_48)
		{
			...
			case 1:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
				{
					...
					if (PATHFIND::_0xF7B79A50B905A30D(vLocal_77.x, vLocal_77.y, vLocal_78.x, vLocal_78.y))
					{
							...
							if (func_77(&uLocal_96, "BUSTOAU", Local_50[iLocal_52 /*15*/], 4, 0, 0, 0))
							{
								if (iVar1 <= 13)
								{
									if (iVar1 == 11)
									{
										...
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, -100.461f, -206.1412f, 44.4215f, Local_50[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_264, 4f, 15f);
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, Local_50[iVar1 /*15*/].f_1, Local_50[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_264, 4f, 15f);
										AI::CLOSE_SEQUENCE_TASK(iVar2);
										AI::TASK_PERFORM_SEQUENCE(iLocal_57, iVar2);
										AI::CLEAR_SEQUENCE_TASK(&iVar2);
									}
									else
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_50[iVar1 /*15*/].f_1, Local_50[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_264, 4f, 15f);
									}
								}
								iLocal_71 = GAMEPLAY::GET_GAME_TIMER();
				...
				if ((iLocal_70 - iLocal_71) > 5000)
				{
					if (!func_83())
					{
						...
						else
						{
							if (!PED::IS_PED_INJURED(iLocal_57))
							{
								AI::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 15f);
							}
							iLocal_48 = 0;
						}
					}
...
void func_41(vector3 vParam0)
{
	...
	while (iVar0 < 5)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_61) > iLocal_60[iVar0] && iLocal_62[iVar0] == 0)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_59[iVar0], 0))
			{
				AI::TASK_LOOK_AT_COORD(uLocal_59[iVar0], vParam0, 20000, 2050, 4);
			}
			iLocal_62[iVar0] = 1;
		}
		iVar0++;
...
int func_42()
{
	...
	switch (iLocal_86)
	{
		case 0:
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_57);
				AI::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 0f);
				AI::OPEN_SEQUENCE_TASK(&iLocal_79);
				AI::TASK_VEHICLE_TEMP_ACTION(0, iLocal_63, 24, 10000);
				AI::CLOSE_SEQUENCE_TASK(iLocal_79);
				AI::TASK_PERFORM_SEQUENCE(iLocal_57, iLocal_79);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_79);
			}
			...
			if ((iLocal_70 - iLocal_71) > 3000)
			{
				...
				while (iLocal_88 < 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_59[iLocal_88]))
					{
						...
						{
							AI::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_59[iLocal_88]);
							...
							AI::TASK_WANDER_STANDARD(uLocal_59[iLocal_88], 1193033728, 0);
						}
					}
					iLocal_88++;
				}
...
void func_67(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_71(PLAYER::PLAYER_ID())) && !func_69(PLAYER::PLAYER_ID(), 0)) && !func_68()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_71(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
			...
			if (iLocal_270)
			{
				...
				if ((iLocal_70 - iLocal_71) > iLocal_273)
				{
					if (func_80(uLocal_59[iLocal_271]))
					{
						...
						iLocal_273 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(9000, 14000);
						iLocal_71 = GAMEPLAY::GET_GAME_TIMER();
					}
					iLocal_271++;
					if (iLocal_271 == 5)
...
int func_81()
{
	if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 222) && !iLocal_269)
	{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_63, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_57))
						{
							AI::TASK_VEHICLE_TEMP_ACTION(iLocal_57, iLocal_63, 24, 5000);
							...
							AI::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_63, 0);
						}
					}
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_57))
	{
		switch (iLocal_49)
		{
			case 0:
				...
				AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_63, "RE_BUS_TOUR_BUS_VEHICLE", 0);
				PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(PLAYER::PLAYER_PED_ID(), 0);
				func_67(1, 1, 1, 0, 0);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(Local_51.f_1, 30f, 0);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
				{
					...
					iLocal_275 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_49 = 1;
				}
			...
			case 1:
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_275) > 5000 && !iLocal_274)
				{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_275) > 6200)
				{
					if (iLocal_76 == 1)
					{
						if (iLocal_276 == 0)
...
void func_116()
{
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		...
		AI::TASK_ENTER_VEHICLE(iLocal_58, iLocal_63, 10000, 0, 2f, 262144, 0);
...
void func_117()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_115("TX_H02"))
			{
				if (func_146())
				{
					if (!iLocal_266)
					...
					{
						AI::TASK_ENTER_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_63, -1, 2, 1f, 8, 0);
					}
					if (!UI::DOES_BLIP_EXIST(iLocal_67))
					{
						if (UI::DOES_BLIP_EXIST(iLocal_68))
						{
							UI::REMOVE_BLIP(&iLocal_68);
						}
						iLocal_67 = UI::ADD_BLIP_FOR_ENTITY(iLocal_63);
						UI::SET_BLIP_AS_FRIENDLY(iLocal_67, true);
						UI::SET_BLIP_SCALE(iLocal_67, Global_25505);
						if (!PED::IS_PED_INJURED(iLocal_58))
						{
		...
		if (!PED::IS_PED_INJURED(*uParam0))
		{
			if (func_120(*uParam0))
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam0))
				{
					...
					sVar0 = func_119(PED::IS_PED_MALE(*uParam0));
...
int func_122()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_63, 0))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID()) == iLocal_63)
				{
					return 1;
				}
			}
...
int func_127()
{
	switch (func_128(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_145()
{
	if ((Global_106059 == func_65() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_156()) || Global_25461) || func_155()) || func_17(8, -1)) || func_152()) || func_154()) || func_153()) || func_151()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_156()) || Global_105117) || Global_25461) || func_155()) || func_17(8, -1)) || func_154()) || func_153()) || func_151()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_156() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_17(8, -1)) || func_151()) || func_150()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_156()) || Global_25461) || func_155()) || func_17(8, -1)) || func_153()) || func_152()) || func_151()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_156()) || func_153()) || Global_105117) || Global_25461) || func_155()) || Global_37271) || func_17(8, -1)) || func_152()) || func_150()) || func_151()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_156()) || Global_105117) || Global_25461) || func_155()) || func_17(8, -1)) || func_152()) || func_150()) || func_154()) || func_153()) || func_151())
						{
							return 0;
						}
						break;
...
int func_157()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_57))
	{
		if (((func_162(iLocal_57) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_57, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_57)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_57))
		{
			func_158(iLocal_58);
			return 1;
		}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_161(iParam2), 1);
}
...
{
	if (func_163(iParam0, &uLocal_90, &uLocal_87, iLocal_85, bLocal_91, 1077936128, 0) || PED::IS_PED_RAGDOLL(iParam0))
	{
		func_158(iParam0);
		return 1;
	}
					...
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0))
					{
						if (fVar5 < fVar0)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 17))
							{
								...
								func_168("\n");
								func_164("		time since not LockedOn = ", (GAMEPLAY::GET_GAME_TIMER() - iLocal_43));
								func_168("\n");
								bVar2 = true;
...
void func_175()
{
	...
	else
	{
		...
		if ((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_262)) && STREAMING::HAS_MODEL_LOADED(joaat("tourbus"))) && UI::HAS_ADDITIONAL_TEXT_LOADED(2))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&iLocal_80);
			AI::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_C", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::SET_SEQUENCE_TO_REPEAT(iLocal_80, 1);
			AI::CLOSE_SEQUENCE_TASK(iLocal_80);
			AI::TASK_PERFORM_SEQUENCE(iLocal_58, iLocal_80);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_80);
			func_177(&uLocal_96, 3, iLocal_58, "TOURGUIDE", 0, 1);
			if (!UI::DOES_BLIP_EXIST(iLocal_68))
			{
				iLocal_68 = UI::ADD_BLIP_FOR_ENTITY(iLocal_63);
				UI::SET_BLIP_SPRITE(iLocal_68, 85);
			}
			func_176();
			iLocal_46 = 1;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_200(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_203()
{
	...
	func_209(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_208(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_207(&uVar0, TIME::GET_CLOCK_HOURS());
	func_206(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_205(&uVar0, TIME::GET_CLOCK_MONTH());
	func_204(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_232()
{
	func_223(30000);
	func_231(&Global_25518);
	Global_25506 = GAMEPLAY::GET_GAME_TIMER();
}
