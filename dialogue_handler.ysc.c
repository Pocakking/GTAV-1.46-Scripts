			...
			else if (Global_15822 == 4 || Global_15822 == 3)
			{
				...
				else
				{
					...
					if (Global_106070.f_28022[Global_1698 /*29*/].f_24[Global_14513] == 0)
					{
						...
						func_108(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1698 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_46(Global_14494, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_108(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), &(Global_106070.f_28022[Global_1698 /*29*/].f_7), &cVar0, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), 0);
					}
				}
				func_46(Global_14494, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_108(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_68()
{
	...
	while (iLocal_75 < Global_15818)
	{
		...
		while (iVar2 < 70 && iLocal_29 == 0)
		{
			...
			{
				StringCopy(&cLocal_46, UI::_GET_LABEL_TEXT(&cLocal_38), 64);
				...
				{
					if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_14690[iVar2 /*6*/]), &(Global_15441.f_187[iLocal_75 /*6*/])))
					{
						if (iVar3 > 36 || iVar4 > 36)
						{
						}
						AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_46, &(Global_14690[iVar2 /*6*/]), iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
					}
				}
				iVar1 = (iVar1 + iVar0);
			}
			else if (UI::DOES_TEXT_LABEL_EXIST(&cLocal_42))
			{
				StringCopy(&cLocal_46, UI::_GET_LABEL_TEXT(&cLocal_42), 64);
				iVar3 = func_82(0);
				iVar4 = func_81(0);
				uVar5 = func_79(0);
				uLocal_67 = func_78();
				...
				uVar10 = func_70(0);
				uVar11 = func_69(0);
				AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_46, &(Global_15441.f_6[iLocal_75 /*6*/]), iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
	...
	if (Global_15828 == 0)
	{
		...
		AUDIO::START_SCRIPT_CONVERSATION(Global_15441.f_368, Global_15441.f_369, Global_15441.f_370, uLocal_67);
		Global_15822 = 4;
	}
}
...
int func_69(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 6, iParam0 * 7 + 7);
...
int func_70(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_71(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_72(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 1;
	}
...
int func_73(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_74(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_75(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_70), iParam0 * 7, iParam0 * 7 + 1);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_76()
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 2, 3);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_77()
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 1, 2);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_78()
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 0, 1);
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, "0"))
	{
		return 0;
	}
...
int func_79(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_55), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
int func_81(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_55), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_80(sVar0);
}
...
int func_82(int iParam0)
{
	...
	sVar0 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_55), iParam0 * 3, iParam0 * 3 + 1);
	return func_80(sVar0);
}
...
void func_83()
{
	...
	if (UI::DOES_TEXT_LABEL_EXIST(&cLocal_70))
	{
		sLocal_74 = UI::_GET_LABEL_TEXT(&cLocal_70);
		if (GAMEPLAY::IS_STRING_NULL(sLocal_74))
		{
		}
	}
}
...
void func_84()
{
	...
	if (UI::DOES_TEXT_LABEL_EXIST(&cLocal_60))
	{
		sLocal_64 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 0, 1);
		if (GAMEPLAY::IS_STRING_NULL(sLocal_64))
		{
		}
		sLocal_65 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 1, 2);
		if (GAMEPLAY::IS_STRING_NULL(sLocal_65))
		{
		}
		sLocal_66 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cLocal_60), 2, 3);
		if (GAMEPLAY::IS_STRING_NULL(sLocal_66))
		{
		}
	}
}
...
void func_85()
{
	...
	if (UI::DOES_TEXT_LABEL_EXIST(&cLocal_55))
	{
		sLocal_59 = UI::_GET_LABEL_TEXT(&cLocal_55);
		if (GAMEPLAY::IS_STRING_NULL(sLocal_59))
		{
		}
	}
}
...
void func_86()
{
	...
	if (Global_16814)
	{
		AUDIO::PRELOAD_SCRIPT_CONVERSATION(Global_15441.f_368, Global_15441.f_369, Global_15441.f_370, uLocal_67);
...
void func_87()
{
	...
	while (iVar2 < 70 && iLocal_29 == 0)
	{
		...
		{
			if (UI::DOES_TEXT_LABEL_EXIST(&cLocal_42))
			{
				StringCopy(&cLocal_46, UI::_GET_LABEL_TEXT(&cLocal_42), 64);
				iVar3 = func_82(iVar2);
				iVar4 = func_81(iVar2);
				...
				uVar10 = func_70(iVar2);
				uVar11 = func_69(iVar2);
				AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_46, &Global_15441, iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
			}
			iLocal_29 = 1;
		}
		iVar2++;
...
void func_97()
{
	while (Global_14496 == 1 && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("cellphone_flashhand")) > 0)
	{
		SYSTEM::WAIT(0);
	}
	Global_14496 = 0;
...
float func_100(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_102((SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
