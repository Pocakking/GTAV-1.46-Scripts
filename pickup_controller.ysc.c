...
void func_14()
{
	switch (Global_25700)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_20[Global_25702]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_20[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_22[Global_25702]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_22[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_23[Global_25702]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_23[Global_25702]))
					{
						Global_25703 = 0;
					}
					else
