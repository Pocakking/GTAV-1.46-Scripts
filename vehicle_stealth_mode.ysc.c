...
void func_1()
{
	...
	func_3();
	unk_0xEE4EBDD2593BA844(PLAYER::PLAYER_ID(), 0);
	func_2();
}
...
void func_3()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766), 3);
}
...
{
	if ((!SCRIPT::IS_THREAD_ACTIVE(Global_2415861.f_1474) || Global_2415861.f_1474 == SCRIPT::GET_ID_OF_THIS_THREAD()) || bParam2)
	{
		if (bParam0)
		{
			Global_2415861.f_1474 = SCRIPT::GET_ID_OF_THIS_THREAD();
			Global_2415861.f_1475 = NETWORK::GET_NETWORK_TIME();
		}
		else
		{
...
void func_13()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766), 1);
}
...
void func_14(int iParam0)
{
	...
	if (func_43(iParam0))
	{
		unk_0xEE4EBDD2593BA844(PLAYER::PLAYER_ID(), 1);
		func_42();
		func_41(iParam0);
	}
	...
	func_3();
	GAMEPLAY::CLEAR_BIT(&(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766), 4);
}
...
void func_15(int iParam0)
{
	...
	if (((((((!func_9(&(iParam0->f_6), 0) && !func_9(&(iParam0->f_6), 2)) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_31(iParam0)) && !func_30(0)) && !func_29()) && func_27()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, -1, 0)))
	{
		func_21(iParam0, 1);
...
bool func_27()
{
	return (!GAMEPLAY::IS_BIT_SET(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766, 4) && !func_28());
}
...
int func_33(int iParam0)
{
	...
	{
		case 1:
			if ((CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 114) || CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 99)) || CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 100))
			{
				return 1;
			}
			break;
		...
		case 0:
			if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 114))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 92))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 68))
			{
				return 1;
			}
			break;
...
void func_37(int iParam0)
{
	...
	if (((((((!func_9(&(iParam0->f_6), 0) && !func_9(&(iParam0->f_6), 1)) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_9(&(iParam0->f_6), 3)) && !func_30(0)) && !func_29()) && func_27()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, -1, 0)))
	{
		iVar0 = func_19(iParam0->f_6.f_2, 3333, 10000);
		iParam0->f_6.f_2 = 0;
...
void func_42()
{
	GAMEPLAY::SET_BIT(&(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766), 1);
}
...
bool func_46()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766, 3);
}
...
void func_51(int iParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766), 2);
}
...
bool func_53()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766, 2);
}
...
int func_55(int iParam0)
{
	if (iParam0 > -1)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2423801[iParam0 /*413*/].f_195, 4))
		{
			return 1;
		}
	}
	...
	if (func_35(iParam0))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (func_63(iParam0))
			{
				...
				if (AI::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2))
				{
					func_20(iParam0, 2);
				}
			}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_3) && func_66(NETWORK::_NETWORK_GET_PED_PLAYER(iParam0->f_3)))
	{
		func_20(iParam0, 0);
	}
	else
...
{
	return (iParam0 != -1 && GAMEPLAY::IS_BIT_SET(Global_1589747[iParam0 /*790*/].f_766, 1));
}
...
void func_68(var uParam0)
{
	...
	uParam0->f_6.f_1 = GAMEPLAY::GET_GAME_TIMER();
}

bool func_69(var uParam0)
{
	return (GAMEPLAY::GET_GAME_TIMER() - uParam0->f_6.f_1) >= 200;
}
...
bool func_72()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589747[PLAYER::PLAYER_ID() /*790*/].f_766, 1);
}
...
int func_77()
{
	...
	if (func_78() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_78()) == 0)
		{
			return 1;
		}
	}
