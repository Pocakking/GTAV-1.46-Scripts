...
void func_181(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_182(&sVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_275()
{
	...
	PED::SET_PED_CAN_BE_TARGETTED(Local_62, false);
	AI::OPEN_SEQUENCE_TASK(&uLocal_125);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
	AI::CLOSE_SEQUENCE_TASK(uLocal_125);
		...
		case 5:
			if (!bLocal_80)
			{
				if (!func_467(Local_61))
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_125);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
...
int func_327(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_343(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_328(iVar0, 0), true);
...
void func_398()
{
	...
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), true);
	}
	if (fVar0 < 50f)
	{
		fLocal_118 = 100f;
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), true) > fLocal_118)
	{
		if (!iLocal_84)
		{
		...
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), true) > fLocal_119)
		{
			iLocal_128 = 2;
			iLocal_70 = 0;
			iLocal_69 = 6;
		...
		case 1:
			...
			if (func_233())
			{
				...
				else
				{
					...
					func_16(&(Local_60.f_3));
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 80f)
					{
						if (func_415(vLocal_54.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 150f)
							{
								if (func_408())
								{
									bLocal_101 = true;
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 250f)
						{
							if (func_408())
							{
								bLocal_101 = true;
			...
			if (iLocal_74 == 0)
			{
				if (func_468(Local_62))
				{
					if (func_415(Local_62, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 1048576000, 0, 1193033728);
		...
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_467(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_125);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_628, 1f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uLocal_125);
					AI::TASK_PERFORM_SEQUENCE(Local_62, uLocal_125);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_125);
					iLocal_75 = 2;
	...
	if (func_467(Local_62))
	{
		switch (iLocal_76)
		{
			...
			case 1:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_62, vLocal_78[iLocal_77 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			if (func_233())
			{
				...
				else
				{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 80f)
					{
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 120f)
						{
							if (func_408())
							{
								bLocal_101 = true;
...
void func_442()
{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 50f)
			{
				if (!iLocal_84)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				...
				else
				{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), true) > 100f)
					{
						iLocal_128 = 1;
						iLocal_70 = 0;
						iLocal_69 = 6;
