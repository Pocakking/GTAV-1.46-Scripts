...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_Epsilon6", 0);
		SYSTEM::WAIT(0);
		func_443(Local_53.f_9, 0, 0, 0, 0, 0);
		if (AI::DOES_SCENARIO_GROUP_EXIST("SANDY_PLANES"))
		{
			if (AI::IS_SCENARIO_GROUP_ENABLED("SANDY_PLANES"))
			{
				AI::SET_SCENARIO_GROUP_ENABLED("SANDY_PLANES", false);
...
{
	func_9(&(Global_99633.f_2875), vParam0, fParam1);
}
...
void func_23()
{
	switch (iLocal_70)
	{
		case 0:
			...
			iLocal_117 = (GAMEPLAY::GET_GAME_TIMER() - 6000);
		...
		case 1:
			...
			else
			{
				...
				if (func_233())
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_125);
						AI::TASK_PLANE_MISSION(0, vLocal_54.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
						AI::TASK_PLANE_MISSION(0, vLocal_54.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
						AI::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
						AI::CLOSE_SEQUENCE_TASK(uLocal_125);
						AI::TASK_PERFORM_SEQUENCE(Local_61, uLocal_125);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_125);
						iLocal_70 = 2;
					}
					if (((((!func_22() && !PED::IS_PED_FLEEING(Local_61)) && !PED::IS_PED_RAGDOLL(Local_61)) && !PED::IS_PED_PRONE(Local_61)) && !PED::IS_PED_INJURED(Local_61)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_61, 0))
					{
						...
						{
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_117) > 8000)
							{
					...
					switch (iLocal_111)
					{
						...
						case 2:
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
							{
								...
								if (iLocal_113 == 0)
								{
									if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_112) > 23000)
									{
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_105(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_97(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_97(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_105(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_105(iVar10, 14, uVar15[iVar1], -1) };
			func_73(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_88(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_74(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_97(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_97(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_92(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_91(iParam1)];
...
void func_107(int iParam0)
{
	...
	func_108(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_92(func_111(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_108(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_108(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_97(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_170(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_97(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_97(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_176()
{
	...
	{
		if (func_172(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_181(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_182(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_187()
{
	...
	{
		func_176();
		GRAPHICS::_0xBF59707B3E5ED531(func_188(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
void func_234()
{
	...
	{
		if (func_238(Local_61, 0, 1116471296, 1126825984, 1, 0, 0, 0) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61, true), 3f, 1))
		{
		...
		else if ((func_235(PLAYER::PLAYER_PED_ID(), Local_61, 1) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61, true), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_61))
		{
			if (iLocal_69 != 5 && iLocal_69 != 3)
			{
				bLocal_101 = true;
...
void func_236()
{
	if (func_467(Local_61))
	{
		AI::CLEAR_PED_TASKS(Local_61);
		PED::SET_PED_KEEP_TASK(Local_61, true);
		AI::TASK_SMART_FLEE_PED(Local_61, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
}
...
int func_260()
{
	if (func_233())
	{
		if (GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(vLocal_54.x, false), joaat("weapon_stickybomb"), 10f, 0))
		{
...
void func_267(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (func_467(Local_62))
			{
				...
				AUDIO::STOP_PED_SPEAKING(Local_62, 1);
				PED::SET_PED_DIES_WHEN_INJURED(Local_62, 1);
...
void func_275()
{
	...
	PED::SET_PED_CAN_SWITCH_WEAPON(Local_62, 0);
	AUDIO::STOP_PED_SPEAKING(Local_62, 1);
	PED::SET_PED_DIES_WHEN_INJURED(Local_62, 1);
	PED::SET_PED_CAN_BE_TARGETTED(Local_62, false);
	AI::OPEN_SEQUENCE_TASK(&uLocal_125);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
	AI::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
	AI::CLOSE_SEQUENCE_TASK(uLocal_125);
	AI::TASK_PERFORM_SEQUENCE(Local_62, uLocal_125);
}
	...
	switch (iLocal_69)
	{
		...
		case 4:
			if (!func_467(Local_61))
			{
				...
				AI::TASK_PLAY_ANIM(Local_61, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0f, 0, 0, 0);
			}
			else
			{
		...
		case 5:
			if (!bLocal_80)
			{
				if (!func_467(Local_61))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_61, iLocal_624);
					PED::SET_PED_CONFIG_FLAG(Local_61, 132, true);
					if (!UI::DOES_BLIP_EXIST(Local_61.f_1))
					{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_125);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 40000f);
						AI::TASK_ENTER_VEHICLE(0, vLocal_54.x, 20000, -1, 2f, 1, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_125);
						AI::TASK_PERFORM_SEQUENCE(Local_61, uLocal_125);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_125);
					}
...
void func_286(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_356(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_288(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_312(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_314(Var7.f_1)) && iVar9 < 50)
			{
...
int func_324(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_92(func_325(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_327(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_343(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_328(iVar0, 0), 1);
...
var func_345()
{
	...
	func_355(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_354(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_353(&uVar0, TIME::GET_CLOCK_HOURS());
	func_348(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_347(&uVar0, TIME::GET_CLOCK_MONTH());
	func_346(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_351(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_364(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_368(PLAYER::PLAYER_ID())) && !func_366(PLAYER::PLAYER_ID(), 0)) && !func_365()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_368(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
int func_374()
{
	if (func_467(PLAYER::PLAYER_PED_ID()))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			...
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_61, -1, 0, 2);
...
void func_377(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_378(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_394()
{
	switch (iLocal_70)
	{
		case 0:
			...
			iLocal_109 = (GAMEPLAY::GET_GAME_TIMER() - 10000);
			iLocal_84 = 0;
			...
			if (func_233())
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (func_395(PLAYER::PLAYER_PED_ID(), Local_61, 13f, 1))
					{
						...
						{
							VEHICLE::_SET_VEHICLE_HALT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 2f, -1, 0);
						}
						else
						{
							AI::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
...
void func_398()
{
	...
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), 1);
	}
	if (fVar0 < 50f)
	{
		fLocal_118 = 100f;
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), 1) > fLocal_118)
	{
		if (!iLocal_84)
		{
		...
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_61, true), 1) > fLocal_119)
		{
			iLocal_128 = 2;
			iLocal_70 = 0;
			iLocal_69 = 6;
...
void func_400()
{
	if (func_467(Local_61))
	{
		if (func_232(PLAYER::PLAYER_PED_ID(), Local_61, 1) <= 15f)
		{
			if (!PED::IS_PED_HEADTRACKING_PED(Local_61, PLAYER::PLAYER_PED_ID()))
			{
				...
				AI::TASK_LOOK_AT_ENTITY(Local_61, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
			}
		}
		...
		else if (PED::IS_PED_HEADTRACKING_PED(Local_61, PLAYER::PLAYER_PED_ID()) && !func_22())
		{
			...
			AI::TASK_CLEAR_LOOK_AT(Local_61);
		}
	}
	if (!func_22() && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_467(Local_61) && func_467(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_109) > 15000)
				{
...
void func_403()
{
	switch (iLocal_70)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(1727.442f, 3288.315f, 39.406f, 1706.909f, 3280.669f, 45.13256f, 14.25f, 0, 0, 0, 0, 0, 0);
			if (func_476())
			{
				if (func_262())
				{
		...
		case 1:
			...
			if (func_233())
			{
				...
				{
					if (!UI::DOES_BLIP_EXIST(vLocal_54.z))
					{
					...
					func_16(&(Local_60.f_3));
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 80f)
					{
						if (func_415(vLocal_54.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 150f)
							{
								if (func_408())
								{
									bLocal_101 = true;
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 250f)
						{
							if (func_408())
							{
								bLocal_101 = true;
			...
			if (func_470(vLocal_54.x))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(vLocal_54.x, vLocal_121, vLocal_122, 33.25f, 0, true, 2))
				{
					...
					if (VEHICLE::GET_LANDING_GEAR_STATE(vLocal_54.x) == 0 || VEHICLE::GET_LANDING_GEAR_STATE(vLocal_54.x) == 3)
					{
						...
						if (!iLocal_95)
						{
							UNK1::_0x293220DA1B46CEBC(15f, 5f, 1);
...
void func_412()
{
	if (func_467(Local_61))
	{
		if (func_232(Local_61, vLocal_54.x, 1) < 17f)
		{
			if (!bLocal_92)
			{
				if (!func_22())
				{
					if (func_221(&uLocal_459, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						...
						AI::CLEAR_PED_TASKS(Local_61);
						AI::TASK_LOOK_AT_ENTITY(Local_61, PLAYER::PLAYER_PED_ID(), 10000, 48, 2);
			...
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_110) > 10000)
				{
					bLocal_92 = false;
				}
			}
...
void func_413()
{
	...
	else
	{
		...
		if (!UI::DOES_BLIP_EXIST(Local_60.f_3))
		{
...
float func_415(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	...
	switch (iLocal_73)
	{
		case 0:
			...
			else if (iLocal_74 == 1)
			{
				...
				switch (iLocal_106)
				{
					...
					case 2:
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_115) > 12000)
						{
							iLocal_106 = 0;
						}
						break;
		...
		case 1:
			if (iLocal_74 == 0)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_62);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), 0);
		...
		case 2:
			if (iLocal_74 == 0)
			{
				if (func_467(Local_62))
				{
					...
					if (UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_62, -1, 0, 2);
						AI::TASK_LOOK_AT_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			...
			else if (iLocal_74 == 1)
			{
				...
				else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_116) > 1000 || iLocal_116 == 0)
				{
					if (!func_22())
					{
		...
		case 3:
			if (iLocal_74 == 0)
			{
				...
				if (iLocal_102 == 0)
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_62);
						AI::TASK_HANDS_UP(Local_62, -1, PLAYER::PLAYER_PED_ID(), -1, 1);
					}
					iLocal_107 = -1;
					iLocal_74 = 1;
				}
			...
			else if (iLocal_74 == 1)
			{
				if (!func_239(Local_62, 1126825984))
				{
					...
					else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_107) > 1200)
					{
						AI::CLEAR_PED_TASKS(Local_62);
						AI::TASK_LOOK_AT_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), 0);
		...
		case 5:
			if (iLocal_74 == 0)
			{
				...
				AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), -1);
				iLocal_74 = 1;
			}
			else if (iLocal_74 == 1)
			{
				if (iLocal_81 == 0)
				{
					if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vLocal_54.x, 1))
					{
						UNK1::_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			if (iLocal_74 == 0)
			{
				if (func_468(Local_62))
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_62);
						AI::TASK_CLEAR_LOOK_AT(Local_62);
						AI::OPEN_SEQUENCE_TASK(&uLocal_125);
						AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", "gesture_bye_soft", 8f, -8f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 0.25f, 0, 40000f);
...
void func_419()
{
	...
	if (func_468(Local_62))
	{
		...
		AI::TASK_SMART_FLEE_PED(Local_62, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		func_16(&(Local_62.f_1));
	}
}
		...
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_467(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_125);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_628, 1f, 20000, 0.25f, 0, 40000f);
					AI::CLOSE_SEQUENCE_TASK(uLocal_125);
					AI::TASK_PERFORM_SEQUENCE(Local_62, uLocal_125);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_125);
					iLocal_75 = 2;
			...
			case 2:
				if (func_467(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
				{
					if (func_232(Local_62, PLAYER::PLAYER_PED_ID(), 1) < 5f || AI::GET_SCRIPT_TASK_STATUS(Local_62, 242628503) == 7)
					{
						AI::CLEAR_PED_TASKS(Local_62);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_62, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_75 = 0;
	...
	if (func_467(Local_62))
	{
		switch (iLocal_76)
		{
			case 0:
				...
				{
					AI::TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0f, 0, 0, 0);
					iLocal_76 = 1;
			...
			case 1:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_62, vLocal_78[iLocal_77 /*3*/], 1f, 20000, 0.25f, 0, 40000f);
			...
			case 3:
				AI::CLEAR_PED_TASKS(Local_62);
				AI::TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0f, 0, 0, 0);
			...
			case 4:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_62, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						AI::TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0f, 0, 0, 0);
						PED::_0x2208438012482A1A(Local_62, 0, 0);
						iLocal_76 = 1;
...
void func_436()
{
	if (bLocal_100 == 0)
	{
		if (func_468(Local_62) && func_467(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (AI::IS_PED_GETTING_UP(Local_62) || PED::IS_PED_ON_FOOT(Local_62))
				{
					if (!func_22() && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
...
int func_438()
{
	if (((((((((CONTROLS::IS_CONTROL_PRESSED(0, 59) || CONTROLS::IS_CONTROL_PRESSED(0, 60)) || CONTROLS::IS_CONTROL_PRESSED(0, 107)) || CONTROLS::IS_CONTROL_PRESSED(0, 110)) || CONTROLS::IS_CONTROL_PRESSED(0, 113)) || CONTROLS::IS_CONTROL_PRESSED(0, 114)) || CONTROLS::IS_CONTROL_PRESSED(0, 88)) || CONTROLS::IS_CONTROL_PRESSED(0, 87)) || CONTROLS::IS_CONTROL_PRESSED(0, 89)) || CONTROLS::IS_CONTROL_PRESSED(0, 90))
	{
			...
			if (func_233())
			{
				...
				else
				{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 80f)
					{
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 120f)
						{
							if (func_408())
							{
								bLocal_101 = true;
...
void func_440()
{
	...
	switch (iLocal_71)
	{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_108) > 12000)
			{
				iLocal_71 = 2;
			}
			break;
...
void func_442()
{
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (!UI::DOES_BLIP_EXIST(Local_62.f_1))
			{
		...
		case 1:
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 50f)
			{
				if (!iLocal_84)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						...
						func_20();
						iLocal_85 = 1;
						iLocal_87 = (GAMEPLAY::GET_GAME_TIMER() - 7500);
					}
					func_399("EPS6_BACKPL", 7500, 1);
					iLocal_84 = 1;
				}
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_87) > 7500 && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_54.x, true), 1) > 100f)
					{
						iLocal_128 = 1;
						iLocal_70 = 0;
						iLocal_69 = 6;
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_445(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_456(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
void func_464()
{
	...
	func_465(60, 0, 0);
	func_465(55, 0, 0);
	UI::REQUEST_ADDITIONAL_TEXT("EPS6", 0);
...
void func_477()
{
	...
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(1, true);
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("SANDY_PLANES"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("SANDY_PLANES"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("SANDY_PLANES", true);
		}
	}
