	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		switch (iLocal_70[iParam1])
		{
			...
			case 1:
				...
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_71[iParam1 /*4*/])))
				{
...
int func_7(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_8(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_71[iVar0 /*4*/])))
			{
...
void func_21()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45.5004f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1416.54f, -1428.501f)) - vLocal_72 };
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_23(uParam1, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
