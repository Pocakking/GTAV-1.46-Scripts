...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_130(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
				...
				case 3:
					...
					else
					{
						...
						if (!func_110(3) && !Global_93266)
						{
							...
							{
								if ((!func_130(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_109())) && !Global_93266)
								{
									func_123(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_89(uLocal_54))
								{
									...
									else if (!func_130(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_87(&iLocal_60);
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_130(Global_104721, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_18(iLocal_63), 0, Global_93269, 0);
...
void func_25(bool bParam0)
{
	...
	vVar6 = { func_67(SYSTEM::COS(vVar6.z), SYSTEM::SIN(vVar6.z), GAMEPLAY::TAN(vVar6.x)) };
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_255))
		{
			...
			if (fVar7 > 0.8f)
			{
				...
				{
					AI::TASK_GO_STRAIGHT_TO_COORD(0, vVar5, 1f, -1, func_63(vVar5, ENTITY::GET_ENTITY_COORDS(iLocal_255, false)), 1056964608);
				}
			}
			else if (fVar7 > 0.15f)
			{
				AI::TASK_ACHIEVE_HEADING(0, func_63(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_255, false)), 0);
			}
			AI::TASK_PLAY_ANIM(0, "pickup_object", "pickup_low", 8f, -8f, -1, 0, 0f, 0, 0, 0);
...
void func_40()
{
	...
	{
		AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar3, "oddjobs@basejump@ig_15", "puton_parachute", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
