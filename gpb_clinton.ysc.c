...
void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_25720 + 10000 && !func_101())
	{
		func_108(0);
	}
	...
	Global_25720 = GAMEPLAY::GET_GAME_TIMER();
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_210, 0.5f, 0);
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_330)
		{
			...
			StringIntConCat(&cVar13, Global_106015[iLocal_217], 64);
			...
			StringIntConCat(&cVar13, iLocal_221[Global_106015[iLocal_217]], 64);
		...
		if (((ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_208) && !iLocal_216 == 25) && !iLocal_216 == 5) && !iLocal_216 == 6)
		{
			...
			{
				func_86();
				AI::TASK_PLAY_ANIM(iLocal_208, &cLocal_234, &Local_203, 2f, -2f, -1, 0, 0f, 0, 0, 0);
				iLocal_216 = 25;
			}
			else
			{
				...
				func_86();
				iLocal_216 = 5;
				iVar10 = GAMEPLAY::GET_GAME_TIMER();
			}
			AUDIO::_PLAY_AMBIENT_SPEECH1(iLocal_208, "GENERIC_CURSE_MED", "SPEECH_PARAMS_FORCE", 1);
		}
		if (((func_103() || GAMEPLAY::GET_MISSION_FLAG()) || func_102()) || !func_104())
		{
			if (!func_84() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_103())
				{
				}
		...
		if (((((PED::IS_PED_INJURED(iLocal_208) || GAMEPLAY::IS_BULLET_IN_AREA(vVar15, 50f, 1)) || GAMEPLAY::IS_BULLET_IN_AREA(vVar15, 50f, 0)) || GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar15, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar15, 50f)) || GRAPHICS::_0x2F09F7976C512404(vVar15, 1f))
		{
			if (!func_84())
			{
				func_86();
		...
		{
			if (!UI::DOES_BLIP_EXIST(iLocal_214))
			{
				func_75(&iLocal_214, &iLocal_208, 0);
			}
		}
		else if (UI::DOES_BLIP_EXIST(iLocal_214))
		{
			func_74(&iLocal_214);
		}
		if (!bLocal_268)
		{
			if (!PED::IS_PED_INJURED(iLocal_208) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					iVar16 = GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iVar10) > 1)
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_332.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 6:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 0)
				{
					GRAPHICS::DRAW_DEBUG_TEXT_2D("WAIT_MOVE_BACK_TO_INITIAL_POSITION TASK_PLAY_ANIM", 0.02f, 0.26f, 0f, 0, 0, 255, 255);
					AI::TASK_PLAY_ANIM(iLocal_208, &cLocal_243, "idle_intro", 4f, -4f, -1, 0, 0f, 0, 0, 0);
			...
			case 8:
				...
				else if (!func_57())
				{
					...
					if (iLocal_223 < iLocal_221[Global_106015[iLocal_217]] && iVar8)
					{
						func_58();
						iLocal_216 = 7;
					}
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_47(Global_106015[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_56();
				bVar37 = func_57();
				func_46(Global_106015[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_329)
					{
						Global_106015[iLocal_217] = uLocal_328;
					}
					else
					{
						Global_106015[iLocal_217]++;
					}
					if (!Global_106015[iLocal_217] < iLocal_218)
					{
						Global_106015[iLocal_217] = 0;
					}
					func_96(0, 1);
					iLocal_216 = 0;
				}
			...
			case 11:
				...
				{
					func_17(&sVar4);
					AI::TASK_PLAY_ANIM(iLocal_208, &Local_255, &sVar4, 2f, -2f, -1, 0, 0f, 0, 0, 0);
					iLocal_216 = 12;
				}
				else
				{
			...
			case 15:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&Local_255))
				{
					...
					if (!func_57())
					{
						...
						func_17(&sVar4);
						AI::TASK_PLAY_ANIM(iLocal_208, &Local_255, &sVar4, 1000f, -1000f, -1, 0, 0f, 0, 0, 0);
						PED::_0x2208438012482A1A(iLocal_208, 0, 0);
						iLocal_216 = 12;
					}
				}
		...
		bVar18 = SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("context_controller")) > 0;
		if (!bVar18)
		{
		}
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_79(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_73(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_72(iVar19))
				{
					if (!func_71(iVar19))
					{
						func_62(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), 0);
					}
				}
				func_2(&iLocal_224);
			}
	...
	while (true)
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) && !bVar20)
		{
			...
			AI::CLEAR_PED_TASKS(iLocal_208);
			AI::TASK_SMART_FLEE_PED(iLocal_208, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
void func_8()
{
	...
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_208, false);
		AI::TASK_WANDER_STANDARD(iLocal_208, 1193033728, 0);
		PED::SET_PED_KEEP_TASK(iLocal_208, true);
	}
}
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_25(14) || Global_105021))
			{
...
void func_30()
{
	iLocal_220 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iLocal_219);
}
...
void func_49()
{
	...
	func_52(Global_106015[iLocal_217] + 1, &sVar0, &Var1);
	StringConCat(&Var1, "_", 64);
	StringIntConCat(&Var1, iLocal_223, 64);
	Local_252 = { Var1 };
	Local_253 = { Local_254 };
	func_51(&Local_252);
	AI::TASK_PLAY_ANIM(iLocal_208, &Local_254, &Var1, 1000f, -8f, -1, 0, 0f, 0, 0, 0);
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_50(Global_106015[iLocal_217]);
}
...
int func_53()
{
	...
	Var0 = { Local_230 };
	StringIntConCat(&Var0, Global_106015[iLocal_217] + 1, 16);
	func_44(&uLocal_37, 3, iLocal_208, &Local_205, 0, 1);
	if (bLocal_266)
	{
		iVar1 = 1;
...
int func_57()
{
	if (AI::GET_SCRIPT_TASK_STATUS(iLocal_208, -2017877118) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_208, -2017877118) != 0)
	{
		return 0;
	}
	return 1;
...
void func_61(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_106015[iLocal_217] + 1, 16);
}
...
void func_63(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_72(iParam0))
		{
			if (!func_70(iParam0))
			{
				GAMEPLAY::SET_BIT(&(Global_106070.f_26406.f_2), iVar0);
				if (!bParam1)
				{
...
int func_70(int iParam0)
{
	if (func_72(iParam0))
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_26406.f_2, iParam0);
	}
	return 0;
}
...
int func_71(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_26406.f_2, iVar0);
	}
	return 0;
}
...
int func_77(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_78(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_78(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_92(int iParam0)
{
	...
	func_95(&(Global_106070.f_20089), iParam0);
...
void func_96(int iParam0, bool bParam1)
{
	...
	{
		AI::TASK_PLAY_ANIM(iLocal_208, &cLocal_234, &Local_203, 1000f, 1000f, -1, 0, 0f, 0, 0, 0);
	}
	Local_252 = { Local_203 };
	if (bParam1)
	{
...
{
	return func_106(Global_106070.f_20089, uParam0);
}
...
void func_108(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&uVar0, &Local_327))
		{
			func_13();
		}
		if (iParam0 == 1)
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_255))
	{
		STREAMING::REMOVE_ANIM_DICT(&Local_255);
	}
	if (iLocal_215 == 1)
	{
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_234))
		{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_243))
		{
