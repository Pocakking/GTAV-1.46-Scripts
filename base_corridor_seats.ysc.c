...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_57), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_71()
{
	if (Global_1589596 != func_59())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1589596, 1, 0))
		{
			return 0;
		}
...
void func_72()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_73(5, &uLocal_153, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_73(6, &uLocal_153, &iVar0);
}
...
void func_73(int iParam0, var uParam1, int iParam2)
{
	...
	func_80(iParam0, &vVar0, &fVar1);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		(*uParam1)[(*iParam2)[iVar2] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8 = { func_76(func_77(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 174f) };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1 = { func_76(func_75(iVar2), fVar1) + vVar0 };
		(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3 = { func_76(func_74(iVar2), fVar1) + vVar0 };
...
Vector3 func_76(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0)
{
	...
	{
		case 0:
			return Vector(-59.42f, 4832.75f, 391.558f) - func_78();
		
		case 1:
			return Vector(-59.42f, 4832.75f, 392.858f) - func_78();
...
Vector3 func_78()
{
	return func_79() + Vector(0f, -8.946f, 47.215f);
}
