	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_334.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_106015[iLocal_217] = uLocal_330;
					}
					else
					{
...
int func_8()
{
	if (Global_106015[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_105021))
			{
...
void func_108(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&uVar0, &Local_329))
		{
			func_14();
		}
		if (iParam0 == 1)
