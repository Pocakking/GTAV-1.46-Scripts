...
void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_25720 + 10000 && !func_103())
	{
		func_110(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		if (((func_105() || GAMEPLAY::GET_MISSION_FLAG()) || func_104()) || !func_106())
		{
			if (!func_86() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_105())
				{
				}
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_333.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_50(Global_106015[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_330)
					{
						Global_106015[iLocal_217] = uLocal_329;
					}
					else
					{
		...
		if (((((((((((((iLocal_216 == 0 || iLocal_216 == 1) || iLocal_216 == 3) || iLocal_216 == 8) || iLocal_216 == 9) || iLocal_216 == 7) && func_81(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6 == 0) && bLocal_268 == 1) && !Global_3) && func_7()) && bVar18)
		{
			...
			if (func_4(iLocal_224, 1))
			{
				...
				iLocal_216 = 13;
				iVar5 = 0;
				iVar19 = func_75(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_74(iVar19))
				{
					if (!func_73(iVar19))
					{
						func_65(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), 0);
					}
				}
				func_2(&iLocal_224);
			}
...
void func_52()
{
	...
	func_55(Global_106015[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_53(Global_106015[iLocal_217]);
}
...
int func_79(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_80(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_80(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_94(int iParam0)
{
	...
	func_97(&(Global_106070.f_20089), iParam0);
...
{
	return func_108(Global_106070.f_20089, uParam0);
}
...
void func_110(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&uVar0, &Local_328))
		{
			func_17();
		}
		if (iParam0 == 1)
