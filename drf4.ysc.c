...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
void func_17(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_19() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_19() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_23(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_19() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_57(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::SET_BIT(&Global_2383, 24);
	}
	else
	{
...
float func_61(var uParam0)
{
	if (func_64(uParam0))
	{
		...
		{
			return (func_62(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_62(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_70(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	GAMEPLAY::SET_BIT(&Global_2384, 9);
...
void func_84(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	func_117(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_117(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	func_116(uParam1, uParam2, iParam3, iParam11);
	Var1 = { func_112(iParam11, &uVar2, &uVar3, 1) };
	iVar0 = func_111(&Var1);
	...
	while (iVar4 < 47)
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
void func_85(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	...
	func_86(uParam0, uParam1, uParam4, &Var0, iVar1, iVar2, 0);
	func_86(uParam2, uParam3, uParam5, &Var0, iVar1, iVar2, 0);
}
...
void func_88(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7)
{
	...
	func_86(uParam0, uParam1, uParam4, "DRF_SEX", iVar1, 1, 0);
	func_86(uParam2, uParam3, uParam5, "DRF_SEX", iVar1, 1, 0);
	Var0 = { func_89(uParam6, &iVar2, iParam7, 1) };
	func_86(uParam0, uParam1, uParam4, &Var0, 0, iVar2, 0);
	func_86(uParam2, uParam3, uParam5, &Var0, 0, iVar2, 0);
}
...
struct<4> func_89(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_97() <= 0)
	{
		if (!func_96())
		{
			iVar1 = func_93(1, 2, 3, 4, 12);
		}
		else if (func_92() >= 1)
		{
			iVar1 = func_93(5, 6, 7, 0, 0);
		}
		else
		{
			iVar1 = func_93(5, 7, 0, 0, 0);
		}
	}
	else if (func_97() >= 2)
	{
		iVar1 = func_93(10, 11, 0, 0, 0);
	}
	else if (!func_96())
	{
		if (iParam2 != 4)
		{
			iVar1 = func_93(8, 9, 0, 0, 0);
		}
		else
		{
			iVar1 = 9;
	...
	{
		iVar1 = func_93(8, 9, 10, 0, 0);
	}
	else
	{
		iVar1 = func_93(9, 10, 0, 0, 0);
	}
	func_91(uParam0, iVar1);
	if (bParam3)
	{
		func_90(&(Global_106070.f_19933), iVar1, 1);
	}
...
void func_99(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_86(uParam0, uParam1, uParam2, "DRF_OPW", iVar1, 1, 0);
	Var0 = { func_100(iParam3, 0, 1, &iVar2) };
	func_86(uParam0, uParam1, uParam2, &Var0, 0, iVar2, 0);
}
...
struct<4> func_100(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_105(&(Global_106070.f_19933), 8) && iParam1) && iParam0 != 4) && func_103(3) > 0) && GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	else
	{
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar1 = func_102(7, 9, 10, 11, 0);
			}
			else
			{
				iVar1 = func_102(7, 9, 10, 0, 0);
			}
		}
		else
		{
	...
	if (bParam2)
	{
		func_101(&(Global_106070.f_19933), iVar1, 1);
	}
...
void func_106(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	Var0 = { func_112(iParam3, &iVar1, &iVar2, 1) };
	func_86(uParam0, uParam1, uParam2, &Var0, iVar1, iVar2, 0);
}
...
void func_107(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_86(uParam0, uParam1, uParam2, "DRF_OVG", GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_86(uParam0, uParam1, uParam2, "DRF_TMG", func_109(func_110(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_86(uParam0, uParam1, uParam2, "DRF_OVO", GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
...
void func_116(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_86(uParam0, uParam1, uParam2, &Var0, 0, iVar1, 0);
	switch (iParam3)
	{
		case 2:
...
{
	if (Global_89788 != 0 && (GAMEPLAY::GET_GAME_TIMER() - Global_89788) < 1800000)
	{
		return 0;
	}
	UI::REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
	...
	func_117(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_117(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_89788 = GAMEPLAY::GET_GAME_TIMER();
	return 1;
}
