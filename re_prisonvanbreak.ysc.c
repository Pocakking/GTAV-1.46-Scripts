...
void func_2()
{
	...
	if (!bLocal_234)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) || PED::IS_PED_INJURED(iLocal_218)) || PED::IS_PED_HURT(iLocal_218))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				...
				if (!UI::DOES_BLIP_EXIST(uLocal_268[0]))
				{
	...
	if (!bLocal_235)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_219, 0) || PED::IS_PED_INJURED(iLocal_219)) || PED::IS_PED_HURT(iLocal_219))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				...
				if (!UI::DOES_BLIP_EXIST(uLocal_268[1]))
				{
	...
	else if (!iLocal_240 && !bLocal_47)
	{
		...
		if (((ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_219, 0)) && STREAMING::HAS_MODEL_LOADED(joaat("ambulance"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			...
			{
				if (UI::DOES_BLIP_EXIST(iLocal_267[iVar0]))
				{
					UI::REMOVE_BLIP(&(iLocal_267[iVar0]));
				}
				iVar0++;
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
			{
				...
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_227, 307.1379f, 2640.042f, 43.4639f, 18f, 0, joaat("ambulance"), 786475, 5f, 5f);
				AI::TASK_GO_TO_ENTITY(0, iLocal_218, -1, 2f, 1f, 10f, 0);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_218, -1, 2052, 2);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_218, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_243);
				AI::TASK_PERFORM_SEQUENCE(iLocal_220, iLocal_243);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
			{
				...
				AI::TASK_GO_TO_ENTITY(0, iLocal_219, -1, 2f, 1f, 10f, 0);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_219, -1, 2052, 2);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_219, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_243);
				AI::TASK_PERFORM_SEQUENCE(iLocal_221, iLocal_243);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!PED::IS_PED_INJURED(iLocal_222[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_226))
			{
				...
				AI::CLOSE_SEQUENCE_TASK(iLocal_243);
				AI::TASK_PERFORM_SEQUENCE(iLocal_222[0], iLocal_243);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_222[1], 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				...
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_243);
				AI::TASK_PERFORM_SEQUENCE(iLocal_222[1], iLocal_243);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!PED::IS_PED_INJURED(iLocal_222[2]) && ENTITY::DOES_ENTITY_EXIST(iLocal_219))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
				{
					...
					AI::CLOSE_SEQUENCE_TASK(iLocal_243);
					AI::TASK_PERFORM_SEQUENCE(iLocal_222[2], iLocal_243);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
				}
...
int func_37()
{
	if (bLocal_234 || bLocal_235)
	{
		if (bLocal_234 && bLocal_235)
		{
			if (!UI::DOES_BLIP_EXIST(uLocal_268[0]) && !UI::DOES_BLIP_EXIST(uLocal_268[1]))
			{
				return 1;
			}
		}
...
int func_51(int iParam0)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_52(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return iVar0;
}
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0))
			{
				...
				if (((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_263, PLAYER::PLAYER_PED_ID(), 1) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_263, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0)) || PED::IS_PED_BEING_JACKED(iLocal_218)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_263, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_263, joaat("weapon_stickybomb"), -1))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0))
					{
						...
						AI::TASK_DRIVE_BY(iLocal_218, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
					}
					if (!PED::IS_PED_INJURED(iLocal_219))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_219, 0))
						{
							...
							AI::TASK_DRIVE_BY(iLocal_219, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
						}
					}
					bLocal_48 = true;
					iLocal_254 = 1;
...
void func_55()
{
	if (!PED::IS_PED_INJURED(iLocal_218) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
	{
		...
		{
			AI::TASK_SMART_FLEE_COORD(iLocal_218, vLocal_217, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_218, true);
			iLocal_257 = 1;
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_219) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
	{
		...
		{
			AI::TASK_SMART_FLEE_COORD(iLocal_219, vLocal_217, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_219, true);
			iLocal_257 = 1;
		}
	}
...
void func_58()
{
	if (!bLocal_256)
	{
		...
		if (iLocal_239 == 1)
		{
			if (!PED::IS_PED_INJURED(iLocal_218) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_218, iLocal_226, 0))
				{
					...
					AI::CLOSE_SEQUENCE_TASK(iLocal_243);
					AI::TASK_PERFORM_SEQUENCE(iLocal_218, iLocal_243);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
					PED::SET_PED_KEEP_TASK(iLocal_218, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 2)
		{
			if (!PED::IS_PED_INJURED(iLocal_219) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_219, iLocal_226, 0))
				{
					...
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_226, PLAYER::PLAYER_PED_ID(), 8, 100f, 786469, 1000f, 10f, 1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_243);
					AI::TASK_PERFORM_SEQUENCE(iLocal_219, iLocal_243);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
					PED::SET_PED_KEEP_TASK(iLocal_219, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 3)
		{
			...
			{
				func_53(&uLocal_52, 5);
				AI::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, -1, -1, 2f, 8, 0);
				iLocal_239 = 2;
			}
			if (PED::IS_PED_INJURED(iLocal_219) && !PED::IS_PED_INJURED(iLocal_218))
			{
				func_53(&uLocal_52, 6);
				AI::TASK_ENTER_VEHICLE(iLocal_218, iLocal_226, -1, -1, 2f, 8, 0);
				iLocal_239 = 1;
			}
		}
		if (iLocal_239 == 4)
		{
			if (!PED::IS_PED_INJURED(iLocal_218))
			{
				AI::CLEAR_PED_TASKS(iLocal_218);
				AI::TASK_SMART_FLEE_COORD(iLocal_218, vLocal_217, 1000f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_218, true);
			}
			if (!PED::IS_PED_INJURED(iLocal_219))
			{
				AI::CLEAR_PED_TASKS(iLocal_219);
				AI::TASK_SMART_FLEE_COORD(iLocal_219, vLocal_217, 1000f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_219, true);
			}
			bLocal_256 = true;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_226, 0))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_218) && !PED::IS_PED_HURT(iLocal_218))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_219) && !PED::IS_PED_HURT(iLocal_219))
				{
					...
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_226);
					AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_219, 1);
					AI::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, -1, 0, 2f, 1, 0);
					iLocal_239 = 3;
				}
			}
			else if (!PED::IS_PED_INJURED(iLocal_219))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_226);
				AI::OPEN_SEQUENCE_TASK(&iLocal_243);
				AI::TASK_ENTER_VEHICLE(0, iLocal_226, -1, -1, 2f, 1, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_243);
				AI::TASK_PERFORM_SEQUENCE(iLocal_219, iLocal_243);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_243);
				iLocal_239 = 2;
...
void func_61(int iParam0, var uParam1, int iParam2, float fParam3)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (*uParam1 < 5)
		{
			...
			if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar0), fParam3, 1, 1) || GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar0), fParam3, 0, 1))
			{
				switch (*uParam1)
				{
					case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_226, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_218))
					{
						...
						AI::TASK_ENTER_VEHICLE(iLocal_218, iLocal_226, -1, -1, 2f, 524296, 0);
					}
					else if (!PED::IS_PED_INJURED(iLocal_219))
					{
						func_53(&uLocal_52, 5);
						func_50(&uLocal_52, 5, iLocal_219, "RECSBRobber1", 0, 1);
						func_60(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						AI::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, -1, -1, 2f, 524296, 0);
					}
				}
				else if (!bLocal_47)
				{
								...
								if (iLocal_228 > 40)
								{
									...
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_244, 0))
									{
										...
										while (iVar0 < iLocal_222)
										{
											...
											{
												AI::TASK_COMBAT_PED(iLocal_222[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_222[iVar0], true);
												PED::REGISTER_TARGET(iLocal_222[iVar0], PLAYER::PLAYER_PED_ID());
												PED::_0x52D59AB61DDC05DD(iLocal_222[iVar0], 1);
											}
											iVar0++;
										}
									}
	...
	if (bLocal_47 || bLocal_258)
	{
		...
		if (iLocal_240)
		{
			...
			while (iVar1 < iLocal_222)
			{
				if (!PED::IS_PED_INJURED(iLocal_222[iVar1]))
				{
					AI::TASK_COMBAT_PED(iLocal_222[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					PED::_0x52D59AB61DDC05DD(iLocal_222[iVar1], 1);
...
void func_78()
{
	...
	if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 220.6075f, 2615.145f, 35.8465f, 440.8339f, 2684.23f, 72.6324f, 183.125f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_217, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
	{
		...
		while (iVar0 < iLocal_222)
		{
			if (!PED::IS_PED_INJURED(iLocal_222[iVar0]))
			{
				...
				if (!UI::DOES_BLIP_EXIST(iLocal_267[iVar0]))
				{
					...
					UI::_0x75A16C3DA34F1245(iLocal_267[iVar0], false);
				}
			}
			iVar0++;
		}
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) || (!PED::IS_PED_INJURED(iLocal_218) && !iLocal_249))
		{
			...
			UI::_0x75A16C3DA34F1245(iLocal_265, false);
			iLocal_248 = 0;
			iLocal_249 = 1;
		}
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_219, 0) || (!PED::IS_PED_INJURED(iLocal_219) && !iLocal_250))
		{
			...
			UI::_0x75A16C3DA34F1245(iLocal_266, false);
			iLocal_247 = 0;
			iLocal_250 = 1;
		}
		SYSTEM::SETTIMERA(0);
...
int func_80(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_52(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
		...
		if (!bLocal_47 && !iLocal_240)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
			{
				...
				while (iVar0 < iLocal_222)
				{
					if (UI::DOES_BLIP_EXIST(iLocal_267[iVar0]))
					{
						UI::_0x75A16C3DA34F1245(iLocal_267[iVar0], true);
					}
					iVar0++;
				}
				if (UI::DOES_BLIP_EXIST(iLocal_265))
				{
					UI::_0x75A16C3DA34F1245(iLocal_265, true);
				}
				if (UI::DOES_BLIP_EXIST(iLocal_266))
				{
					UI::_0x75A16C3DA34F1245(iLocal_266, true);
				}
				if (!PED::IS_PED_INJURED(iLocal_222[0]))
				{
					func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
...
void func_84()
{
	...
	while (iVar0 < iLocal_225)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_225[iVar0], 0))
		{
			...
			{
				VEHICLE::DISABLE_VEHICLE_IMPACT_EXPLOSION_ACTIVATION(iLocal_225[iVar0], 0);
			}
		}
		iVar0++;
	}
	...
	else if (bLocal_47)
	{
		...
		if (!iLocal_51)
		{
			...
			while (iVar0 < iLocal_222)
			{
				...
				{
					PED::SET_PED_CAN_BE_TARGETTED(iLocal_222[iVar0], true);
					UI::_0xC594B315EDF2D4AF(iLocal_222[iVar0]);
					if (UI::DOES_BLIP_EXIST(iLocal_267[iVar0]))
					{
						UI::REMOVE_BLIP(&(iLocal_267[iVar0]));
					}
...
void func_85()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_ranger_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_paramedic_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("sheriff"))) && STREAMING::HAS_MODEL_LOADED(joaat("phoenix")))
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(328.0555f, 2612.694f, 43.4932f, 5f, 0, 0, 0, 0, false, 0);
		...
		VEHICLE::DISABLE_VEHICLE_IMPACT_EXPLOSION_ACTIVATION(iLocal_225[0], 1);
		VEHICLE::DISABLE_VEHICLE_IMPACT_EXPLOSION_ACTIVATION(iLocal_225[2], 1);
		VEHICLE::DISABLE_VEHICLE_IMPACT_EXPLOSION_ACTIVATION(iLocal_225[1], 1);
		...
		AI::TASK_STAY_IN_COVER(iLocal_222[0]);
		AI::TASK_STAY_IN_COVER(iLocal_222[1]);
		AI::TASK_STAY_IN_COVER(iLocal_222[2]);
		...
		AI::TASK_GUARD_CURRENT_POSITION(iLocal_219, 35f, 35f, 1);
		...
		AI::TASK_GUARD_CURRENT_POSITION(iLocal_218, 35f, 35f, 1);
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_242, -1533126372);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_242);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_242, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_241, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_242, iLocal_241);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, iLocal_241);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, iLocal_242);
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_222[0], iLocal_218, 3000, 0);
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_222[1], iLocal_218, 3000, 0);
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_222[2], iLocal_218, 3000, 0);
		if (func_45() == 0)
		{
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_125(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
	...
	if (iLocal_46)
	{
		...
		while (iVar0 < iLocal_222)
		{
			if (!PED::IS_PED_INJURED(iLocal_222[iVar0]))
			{
				...
				if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_STAY_IN_COVER(iLocal_222[iVar0]);
					PED::SET_PED_KEEP_TASK(iLocal_222[iVar0], true);
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_218))
