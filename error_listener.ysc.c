...
void func_2()
{
	...
	while (iVar0 < SCRIPT::GET_NUMBER_OF_EVENTS(2))
	{
		...
		if (func_10(iVar1))
		{
			...
			Var2.f_1 = (GAMEPLAY::GET_FRAME_COUNT() - 1);
			Var2 = iVar1;
...
void func_3(int iParam0)
{
	...
	iVar0 = *iParam0;
	if (((func_5() && func_4(iVar0)) && iVar0 != 236) && NETWORK::NETWORK_CAN_BAIL())
	{
...
{
	if (Global_25733.f_61 < 20)
	{
		Global_25733[Global_25733.f_61 /*3*/] = { *iParam0 };
		Global_25733.f_61++;
		return 1;
	}
	return 0;
...
int func_7(int iParam0, var uParam1)
{
	*uParam1 = 0;
	*uParam1 = 0;
	while (*uParam1 < Global_25733.f_61)
	{
		if (Global_25733[*uParam1 /*3*/] == *iParam0 && Global_25733[*uParam1 /*3*/].f_2 == iParam0->f_2)
		{
			return 1;
		}
		*uParam1++;
