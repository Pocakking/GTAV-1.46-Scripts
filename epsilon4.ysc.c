...
void func_251()
{
	if (func_229(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (iLocal_283 == 0)
		{
			...
			if (func_340(Local_298[1 /*8*/]))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_298[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
					...
					if (!iLocal_263)
					{
						if (func_229(Local_81.f_28[0]))
						{
							...
							if (func_229(PLAYER::PLAYER_PED_ID()))
							{
								...
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
