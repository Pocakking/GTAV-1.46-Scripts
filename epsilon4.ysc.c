...
void func_1()
{
	...
	switch (Local_434.f_1)
	{
		case 0:
			...
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar0, sLocal_91))
			{
				func_406(1);
			}
			else
...
void func_11()
{
	...
	while (func_339(PLAYER::PLAYER_PED_ID()) == iLocal_89)
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED("weapons@holster_1h"))
		{
			...
			{
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_19(&iVar2);
		iVar3 = func_18(Var1, Global_106070.f_7660.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_16(Global_106070.f_7660.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_14(Global_106070.f_7660.f_765[iVar2 /*10*/]))
				{
					Global_106070.f_7660.f_765[iVar2 /*10*/] = { Var1 };
					func_15(&Var1);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_106070.f_7660.f_765[iVar0 /*10*/], Global_106070.f_7660.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_22(int iParam0, bool bParam1)
{
	...
	{
		func_187(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_100(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_100(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_92(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_92(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_50(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_165(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_100(iVar10, iParam1, iParam2, -1) };
		if (!func_90(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_100(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_100(iVar10, 14, uVar12[iVar1], -1) };
							func_68(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_83(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_92(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_83(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_100(iVar10, iVar0, func_58(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_100(iVar10, 14, uVar15[iVar1], -1) };
			func_68(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_83(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_92(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_100(iParam0, iParam1, iParam2, -1) };
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_69(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_83(int iParam0)
{
	...
	{
		func_89(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_86(iParam2)];
	if (iVar0 != 0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_86(iParam1)];
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_165(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_99(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_99(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_99(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_102(int iParam0)
{
	...
	func_103(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_87(func_106(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_87(func_105(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_87(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_103(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_92(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_165(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_165(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_165(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_100(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_165(iParam0, 14, iVar4))
										{
											if (!func_56(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_100(iVar0, iVar2, iVar1, -1) };
						if (!func_56(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_92(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_92(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_171()
{
	...
	{
		if (func_167(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_166(PLAYER::PLAYER_PED_ID());
			if (func_168(iVar0) && (!func_108(14) || Global_105021))
			{
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_177(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_182()
{
	...
	{
		func_171();
		GRAPHICS::_0xBF59707B3E5ED531(func_183(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_192(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_191();
...
float func_228(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_240(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_244(PLAYER::PLAYER_ID())) && !func_242(PLAYER::PLAYER_ID(), 0)) && !func_241()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_244(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
void func_248()
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_95, "SET_COLOUR");
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_95, "SET_DISTANCE");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(10f);
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	UI::SET_TEXT_RENDER_ID(iLocal_96);
	...
	if (func_229(Local_298[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_435);
					AI::TASK_WARP_PED_INTO_VEHICLE(0, iLocal_292, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_435);
					AI::TASK_PERFORM_SEQUENCE(Local_81.f_28[1], uLocal_435);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_435);
					func_390("Did Jimmy pass exit");
				}
			}
			else
			{
				AI::TASK_GO_STRAIGHT_TO_COORD(Local_81.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
	...
	if (func_229(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_435);
					AI::TASK_WARP_PED_INTO_VEHICLE(0, iLocal_292, -1);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_292, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_292, 30f, 262275);
					AI::CLOSE_SEQUENCE_TASK(uLocal_435);
					AI::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], uLocal_435);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_435);
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 40000f);
...
void func_255(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_257(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_288(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_289())
		{
			if ((GAMEPLAY::ARE_STRINGS_EQUAL(Local_301.f_14, "NO_RECENT_ANIM") || !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_301, "rcm_epsilonism4", Local_301.f_14, 3)) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_301, "rcm_epsilonism4", Local_301.f_14) >= 0.98f)
			{
				if (fLocal_302 > 80f)
				{
				...
				ENTITY::PLAY_ENTITY_ANIM(Local_301, Local_301.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_289())
	{
		if (!GAMEPLAY::ARE_STRINGS_EQUAL(Local_301.f_14, "NO_RECENT_ANIM"))
		{
...
int func_295(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_86(iParam1)];
...
void func_301()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (iLocal_283 == 0)
		{
			...
			if (func_340(Local_298[1 /*8*/]))
			{
				...
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(1829.75f, 4693.5f, 38.51f, &fVar1, 0, 0);
	...
	if (Local_434.f_1 == 0)
	{
		...
		iLocal_415 = 0;
		iLocal_416 = 0;
		iLocal_417 = GAMEPLAY::GET_GAME_TIMER();
		iLocal_419 = GAMEPLAY::GET_GAME_TIMER();
		iLocal_420 = 0;
		if (iLocal_283 == 0)
		{
			if (func_340(PLAYER::PLAYER_PED_ID()))
			...
			if (func_340(Local_298[1 /*8*/]))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_298[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 40000f);
			}
		...
		iLocal_409 = GAMEPLAY::GET_GAME_TIMER() + 1000;
	...
	if (Local_434.f_1 == 1)
	{
		...
		else
		{
			...
			if (iLocal_283 == 0)
			{
				if (iLocal_408 == 0)
				{
					if (iLocal_409 < GAMEPLAY::GET_GAME_TIMER())
					{
						if (!func_341())
						{
							func_316("EPS4_T0");
							iLocal_409 = GAMEPLAY::GET_GAME_TIMER() + 7500;
							iLocal_408++;
							iLocal_421 = GAMEPLAY::GET_GAME_TIMER();
						}
						else
						{
							iLocal_408 = 2;
				...
				{
					if (CONTROLS::IS_CONTROL_JUST_PRESSED(0, 25) || iLocal_409 < GAMEPLAY::GET_GAME_TIMER())
					{
						UI::CLEAR_HELP(1);
						iLocal_409 = GAMEPLAY::GET_GAME_TIMER() + 1000;
						iLocal_408++;
			...
			if (iLocal_269 == 1)
			{
				...
				{
					if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_229(iLocal_291))
							{
								AI::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 10000, 0, 2);
							}
						}
						iLocal_421 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_270 = 1;
				...
				{
					if (!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_288) >= 7500)
					{
						if ((GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, 0, 1, 0)) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91))
							{
								if (func_229(iLocal_291))
								{
									AI::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
								}
							}
							iLocal_271 = 1;
							iLocal_421 = GAMEPLAY::GET_GAME_TIMER();
				...
				else if (iLocal_268 == 0 && !func_304(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 9f))
				{
					...
					if (CAM::IS_AIM_CAM_ACTIVE())
					{
						...
						{
							if (!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_340(iLocal_291))
												{
													AI::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
												}
												iLocal_286 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_412++;
												if (iLocal_283 == 2)
									...
									{
										if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = GAMEPLAY::GET_GAME_TIMER();
											iLocal_414++;
										}
								...
								{
									if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_340(iLocal_291))
										{
											AI::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
							...
							else if (bLocal_266 != Local_301.f_1)
							{
								...
								if (bLocal_266)
								{
									if (iLocal_287 < GAMEPLAY::GET_GAME_TIMER())
									{
										if (func_280())
										{
											AUDIO::STOP_SCRIPTED_CONVERSATION(1);
										}
										iLocal_286 = (GAMEPLAY::GET_GAME_TIMER() - 7500);
					...
					{
						iLocal_286 = (GAMEPLAY::GET_GAME_TIMER() - 5000);
					}
				}
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_229(Local_298[0 /*8*/]))
							{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, false, 1))
				{
					...
					else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_289) >= 1500)
					{
						if (func_280())
						{
							func_278();
			...
			{
				if (!UI::DOES_BLIP_EXIST(iLocal_94))
				{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						...
						{
							if (!func_280() && !UI::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
					...
					else if (!func_280() && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_274 = 1;
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_288) >= 7500) && !UI::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_288) >= 7500) && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_306(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
	...
	if (Local_434.f_1 == 3)
	{
		...
		func_287();
		CONTROLS::SET_PAD_SHAKE(0, 200, 150);
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_295) > 750)
		{
			func_225();
...
void func_317(var uParam0)
{
	...
	fVar7 = (1f - (GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(vVar2.x, vVar2.y, vVar5.x, vVar5.y) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_284 < GAMEPLAY::GET_GAME_TIMER())
	{
		if (fVar0 <= 6.5f && bVar8)
		{
			AUDIO::STOP_SOUND(Local_301.f_3);
		...
		else
		{
			...
			iLocal_284 = (GAMEPLAY::GET_GAME_TIMER() + iVar10);
			iVar10 = (iVar10 / 3);
			if (iVar10 < 100)
			{
				iVar10 = 100;
			}
			iLocal_285 = (GAMEPLAY::GET_GAME_TIMER() + iVar10);
	...
	if (iLocal_285 > 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_285)
	{
		AUDIO::STOP_SOUND(Local_301.f_3);
		iLocal_285 = 0;
	}
	...
	else
	{
		...
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_95, "SET_DISTANCE");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(fLocal_302);
		GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		UI::SET_TEXT_RENDER_ID(iLocal_96);
		GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
...
void func_318(var uParam0)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iLocal_297);
				while (uParam0->f_3 == -1)
				{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 40000f);
				uParam0->f_2 = 1;
			}
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				if (Local_296[uParam0->f_3 /*6*/].f_4 == 0)
				{
					...
					{
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0f, 0, 0, 0);
					}
					else
					{
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0f, 0, 0, 0);
					}
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 2)
				{
					AI::TASK_ACHIEVE_HEADING(0, Local_296[uParam0->f_3 /*6*/].f_3, 0);
					AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 3)
				{
					AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0f, 0, 0, 0);
				}
				...
				AI::TASK_PERFORM_SEQUENCE(*uParam0, uLocal_97);
		...
		case 4:
			...
			else if (uParam0->f_2 == 0)
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, 0, true, 0) || iLocal_283 > 0)
				{
					...
					iLocal_418 = GAMEPLAY::GET_GAME_TIMER();
					if (iLocal_283 == 0)
					{
			...
			else if (uParam0->f_2 == 1)
			{
				...
				if (AI::IS_PED_STILL(*uParam0))
				{
					if (!iLocal_280)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_418) > 6000)
						{
							AI::OPEN_SEQUENCE_TASK(&uLocal_97);
							if (*uParam0 == Local_298[1 /*8*/])
							{
				...
				{
					if ((((GAMEPLAY::GET_GAME_TIMER() - iLocal_419) > 7500 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_421) > 15000)
				{
					if ((((iLocal_420 < 4 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267) && !func_341())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
		...
		case 5:
			...
			{
				AI::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), 20000, 4.5f, 1073741824, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
void func_320(int iParam0)
{
	if (func_340(iParam0) && func_229(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (AI::IS_PED_GETTING_UP(iLocal_300) || PED::IS_PED_ON_FOOT(iLocal_300))
			{
				if (!func_280() && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
...
void func_334()
{
	...
	if (func_229(Local_298[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(1829.8f, 4693.48f, 38.5f, &fVar0, 0, 0);
...
void func_335()
{
	if (func_229(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			AI::TASK_GO_STRAIGHT_TO_COORD(Local_298[0 /*8*/], Local_296[Local_298[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
...
void func_338()
{
	...
	if (Local_434.f_1 == 1)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_284) > 1250)
		{
		...
		if (!func_401(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
				...
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!iLocal_263)
					{
						if (func_229(Local_81.f_28[0]))
						{
							...
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_97);
								AI::TASK_LOOK_AT_ENTITY(0, Local_81.f_28[0], 15000, 0, 2);
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 40000f);
								AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_81.f_28[0], 0);
								AI::CLOSE_SEQUENCE_TASK(uLocal_97);
								AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_97);
								AI::CLEAR_SEQUENCE_TASK(&uLocal_97);
			...
			if (!iLocal_264)
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					AI::TASK_PLAY_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0f, 0, 0, 0);
					CUTSCENE::REMOVE_CUTSCENE();
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_344(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_355(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_357(iParam0, Global_36117);
}
...
void func_368()
{
	...
	UI::LINK_NAMED_RENDERTARGET(iLocal_90);
	if (UI::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		iLocal_96 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
}
...
int func_410()
{
	...
	iVar0 = func_411(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_414()
{
	...
	{
		if (func_409(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
