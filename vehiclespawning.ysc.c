...
int func_1()
{
	if (!INTERIOR::_IS_INTERIOR_PROP_ENABLED(iLocal_44, "garage_decor_01"))
	{
		INTERIOR::_ENABLE_INTERIOR_PROP(iLocal_44, "garage_decor_01");
	}
	else
	{
...
int func_2()
{
	...
	if (INTERIOR::IS_VALID_INTERIOR(iLocal_44))
	{
		if (!iLocal_40)
		{
			INTERIOR::_LOAD_INTERIOR(iLocal_44);
			iLocal_40 = 1;
		}
