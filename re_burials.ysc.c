					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
										...
										case 0:
											...
											if (!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0))
											{
												if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 281.9148f, 6816.345f, 4.3197f, 48.3924f, 6885.921f, 43.0037f, 226.5f, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_74 - Vector(0f, 0f, 7f), 20f, 15f, 50f, false, true, 0))
												{
													...
													while (iLocal_58 <= 1)
													{
														if (UI::DOES_BLIP_EXIST(iLocal_87[iLocal_58]))
														{
															UI::_0x75A16C3DA34F1245(iLocal_87[iLocal_58], false);
														}
														iLocal_58++;
													}
													if (!func_160())
							...
							case 2:
								if ((func_127(iLocal_52[0], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0) || func_127(iLocal_52[1], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0)) || iLocal_103)
								{
									...
									while (iLocal_58 <= 1)
									{
										if (UI::DOES_BLIP_EXIST(iLocal_87[iLocal_58]))
										{
											UI::_0x75A16C3DA34F1245(iLocal_87[iLocal_58], true);
										}
										iLocal_58++;
									}
									switch (iLocal_102)
									...
									else
									{
										...
										while (iVar0 < iLocal_52)
										{
											if (!PED::IS_PED_INJURED(iLocal_52[iVar0]))
											{
												...
												AI::TASK_SMART_FLEE_PED(iLocal_52[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
												...
												if (UI::DOES_BLIP_EXIST(iLocal_87[iVar0]))
												{
													UI::REMOVE_BLIP(&(iLocal_87[iVar0]));
												}
											}
											iVar0++;
										}
							...
							case 4:
								...
								if (!PED::IS_PED_INJURED(iLocal_51))
								{
									...
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_113, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
									{
										if (PED::IS_PED_IN_GROUP(iLocal_51))
										{
											if (UI::DOES_BLIP_EXIST(iLocal_111))
											{
												UI::REMOVE_BLIP(&iLocal_111);
											}
											if (UI::DOES_BLIP_EXIST(iLocal_112))
											{
												UI::REMOVE_BLIP(&iLocal_112);
											}
											if (func_69())
											{
												iLocal_47 = 5;
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
									{
										if (!PED::IS_PED_INJURED(iLocal_52[0]))
										{
											...
											if (VEHICLE::_0x639431E895B9AA57(iLocal_52[0], iLocal_54, -1, 0, false) || VEHICLE::_0x639431E895B9AA57(iLocal_52[0], iLocal_54, 0, 0, false))
											{
												if (!iLocal_124)
												{
													...
													AI::OPEN_SEQUENCE_TASK(&iLocal_59);
													AI::TASK_CLEAR_LOOK_AT(0);
													AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -0.5f, 0.5f, 0f), PLAYER::PLAYER_PED_ID(), 3f, true, 0.5f, 1082130432, true, 0, 0, -957453492, 20000);
													AI::TASK_ENTER_VEHICLE(0, iLocal_54, -1, -1, 3f, 9, 0);
													AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 30f, 262144, -1f, 10f, 1);
													AI::CLOSE_SEQUENCE_TASK(iLocal_59);
													AI::TASK_PERFORM_SEQUENCE(iLocal_52[0], iLocal_59);
													AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
													PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
													VEHICLE::_0x25367DE49D64CF16(iLocal_54, 1);
													iLocal_124 = 1;
												}
												else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_52[0], 242628503) == 1)
												{
													if (AI::GET_SEQUENCE_PROGRESS(iLocal_52[0]) == 3)
													{
											...
											{
												AI::TASK_COMBAT_PED(iLocal_52[0], PLAYER::PLAYER_PED_ID(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
											}
										}
										if (!PED::IS_PED_INJURED(iLocal_52[1]))
										{
											...
											if (VEHICLE::_0x639431E895B9AA57(iLocal_52[1], iLocal_54, -1, 0, false) || VEHICLE::_0x639431E895B9AA57(iLocal_52[1], iLocal_54, 0, 0, false))
											{
												if (!iLocal_124)
												{
													AI::CLEAR_PED_TASKS(iLocal_52[1]);
													AI::OPEN_SEQUENCE_TASK(&iLocal_59);
													AI::TASK_CLEAR_LOOK_AT(0);
													AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -0.5f, 0.5f, 0f), PLAYER::PLAYER_PED_ID(), 3f, true, 0.5f, 1082130432, true, 0, 0, -957453492, 20000);
													AI::TASK_ENTER_VEHICLE(0, iLocal_54, -1, -1, 3f, 9, 0);
													AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 30f, 262144, -1f, 10f, 1);
													AI::CLOSE_SEQUENCE_TASK(iLocal_59);
													AI::TASK_PERFORM_SEQUENCE(iLocal_52[1], iLocal_59);
													AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
													PED::SET_PED_KEEP_TASK(iLocal_52[1], true);
													VEHICLE::_0x25367DE49D64CF16(iLocal_54, 1);
													iLocal_124 = 1;
												}
												else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_52[1], 242628503) == 1)
												{
													if (AI::GET_SEQUENCE_PROGRESS(iLocal_52[1]) == 3)
													{
						...
						if (iLocal_47 != 3)
						{
							if (func_1())
							{
								...
								{
									SYSTEM::SETTIMERA(0);
									iLocal_84 = GAMEPLAY::GET_GAME_TIMER() + 8500;
									iLocal_68 = 1;
								}
								if (!PED::IS_PED_INJURED(iLocal_51))
								{
						...
						if (((iLocal_47 == 1 || iLocal_47 == 2) || iLocal_47 == 3) || iLocal_47 == 7)
						{
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								if (!bLocal_104)
								{
									if (AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1785177548) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1785177548) != 0)
									{
										AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_51);
										iLocal_303 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, -2f, -4f, 18f, 2);
										AI::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1148846080, 0);
...
void func_2()
{
	if (PED::IS_PED_INJURED(iLocal_52[0]))
	{
		if (UI::DOES_BLIP_EXIST(iLocal_87[0]))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
			...
			func_3(&uLocal_138, 4);
			UI::REMOVE_BLIP(&(iLocal_87[0]));
		}
	}
	if (PED::IS_PED_INJURED(iLocal_52[1]))
	{
		if (UI::DOES_BLIP_EXIST(iLocal_87[1]))
		{
			func_3(&uLocal_138, 3);
			UI::REMOVE_BLIP(&(iLocal_87[1]));
		}
	}
	if (PED::IS_PED_INJURED(iLocal_51))
	{
	...
	if (!PED::IS_PED_INJURED(iLocal_51))
	{
		if (!PED::IS_PED_INJURED(iLocal_52[0]) || !PED::IS_PED_INJURED(iLocal_52[1]))
		{
			if (!func_12())
			{
				...
				{
					case 0:
						if (iLocal_84 < GAMEPLAY::GET_GAME_TIMER())
						{
							if (func_70(&uLocal_138, "REBU2AU", "REBU2_ATT", 4, 0, 0, 0))
							{
								iLocal_84 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 5000));
								iLocal_128++;
							}
						}
						break;
	...
	switch (iLocal_110)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_51) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
			{
				...
				AI::TASK_ENTER_VEHICLE(0, iLocal_55, -1, 0, 1f, 1, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_59);
				AI::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_59);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
				PED::SET_PED_KEEP_TASK(iLocal_51, true);
				func_104();
				SYSTEM::WAIT(0);
		...
		case 1:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_51, iLocal_55, 0))
				{
					...
					{
						AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_53, iLocal_54, 10f, 786599);
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_51, iLocal_55, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_53))
					{
						AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_53, iLocal_55, 10f, 786599);
						PED::SET_PED_KEEP_TASK(iLocal_53, true);
					}
					VEHICLE::_0x25367DE49D64CF16(iLocal_55, 1);
					iLocal_110++;
...
void func_51()
{
	if (!PED::IS_PED_INJURED(iLocal_51))
	{
		...
		{
			AI::TASK_USE_MOBILE_PHONE(iLocal_51, 1, 1);
			AI::TASK_CLEAR_LOOK_AT(iLocal_51);
		}
		if (func_55("REBU2_LV2_9") || iLocal_66 > 1)
		{
			AI::TASK_USE_MOBILE_PHONE(iLocal_51, 0, 1);
		}
	}
	if (func_69() && !func_12())
	{
		...
		switch (iLocal_66)
		{
			...
			case 1:
				iLocal_67 = GAMEPLAY::GET_GAME_TIMER() + 1500;
				iLocal_66++;
				break;
			
			case 2:
				if (iLocal_67 < GAMEPLAY::GET_GAME_TIMER())
				{
			...
			case 4:
				iLocal_67 = GAMEPLAY::GET_GAME_TIMER() + 500;
				iLocal_66++;
				break;
			...
			case 17:
				iLocal_67 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_66++;
				break;
			...
			case 19:
				iLocal_67 = GAMEPLAY::GET_GAME_TIMER() + 2500;
				iLocal_66++;
				break;
	...
	if (!PED::IS_PED_INJURED(iLocal_51))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_61())
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1227113341) != 0)
				{
					AI::TASK_GO_TO_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_51, 0))
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_51, 0, 4194304);
				}
				if (!iLocal_106)
				{
					func_81(0);
			...
			{
				iLocal_106 = 0;
				if (((AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1227113341) == 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 1227113341) == 0) || AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) == 1) || AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) == 0)
				{
					AI::CLEAR_PED_TASKS(iLocal_51);
				}
			}
		}
		else if (((!PED::IS_PED_IN_GROUP(iLocal_51) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_51, 0)) && AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) != 1) && AI::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) != 0)
		{
	...
	if ((iLocal_132 - iLocal_131) > 180000)
	{
		if (!PED::IS_PED_INJURED(iLocal_51))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_51))
			{
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_51, 1740.797f, 4648.756f, 42.6529f, 1f, -1, 0.25f, 0, 40000f);
					PED::SET_PED_KEEP_TASK(iLocal_51, true);
				}
				func_104();
				SYSTEM::WAIT(0);
	...
	if ((iLocal_135 - iLocal_134) > 120000)
	{
		if (!PED::IS_PED_INJURED(iLocal_51))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_51))
			{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_51, vLocal_113, 100f, 100f, 100f, false, true, 0))
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_51, vLocal_113, 1f, -1, 0.25f, 0, 40000f);
					PED::SET_PED_KEEP_TASK(iLocal_51, true);
				}
				else
				{
...
void func_81(bool bParam0)
{
	if (bParam0)
	{
		if (iLocal_119)
		{
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_121))
			{
...
void func_85()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_51))
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!PED::IS_PED_INJURED(iLocal_51))
			{
				AI::TASK_SMART_FLEE_PED(iLocal_51, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_51, true);
			}
			if (!PED::IS_PED_INJURED(iLocal_53))
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_137, 1862763509);
				AI::TASK_COMBAT_PED(iLocal_53, PLAYER::PLAYER_PED_ID(), 0, 16);
				PED::SET_PED_KEEP_TASK(iLocal_53, true);
			}
			func_104();
			SYSTEM::WAIT(0);
...
void func_86()
{
		...
		if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 1.2f, 1.2f, 5f, 0, 1, 0) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_48(1, 0, 1))
			{
				...
				if (!iLocal_89)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_72, 10f, 0);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_72, 4.5f, 0, 0, 0, 0, false, 0);
					...
					if (!PED::IS_PED_INJURED(iLocal_51))
					{
						...
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_51);
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(iLocal_51, 0, 0);
						AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_303, "random@burial", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
						...
						CAM::SET_CAM_ACTIVE(iLocal_71, 1);
	...
	if (iLocal_91 && !bLocal_96)
	{
		...
		CAM::SET_CAM_ACTIVE(iLocal_71, 0);
				...
				if (!func_12())
				{
					...
					if (func_44() == 2 && !func_9())
					{
						if (!UI::DOES_BLIP_EXIST(iLocal_112))
						{
							...
							UI::SET_BLIP_SPRITE(iLocal_112, 269);
							func_88();
						}
					}
					func_87();
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (FIRE::IS_ENTITY_ON_FIRE(iParam0))
			{
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iParam0, true), 2.5f, 1, 0, 0, false);
			}
		}
	}
}
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (func_70(&uLocal_138, "REBU2AU", "REBU2_HPF", 4, 0, 0, 0))
					{
						iLocal_84 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 5500));
						iLocal_128++;
					}
				}
				break;
...
void func_106()
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_52[0]))
		{
			AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_52[0], iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 30f, 262144, -1f, 10f, 1);
			PED::SET_PED_KEEP_TASK(iLocal_52[0], true);
		}
		if (!PED::IS_PED_INJURED(iLocal_52[1]))
		{
			AI::TASK_ENTER_VEHICLE(iLocal_52[1], iLocal_54, -1, 0, 3f, 1, 0);
			PED::SET_PED_KEEP_TASK(iLocal_52[1], true);
		}
	}
	else
	{
		...
		while (iLocal_58 <= 1)
		{
			...
			{
				AI::TASK_SMART_FLEE_PED(iLocal_52[iLocal_58], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
	...
	if (!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1]))
	{
		if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_52[0]) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_52[1]))
		{
			if (func_70(&uLocal_138, "REBU2AU", "REBU2_VH", 4, 0, 0, 0))
			{
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_52[1]);
					AI::TASK_SHOOT_AT_ENTITY(iLocal_52[1], PLAYER::PLAYER_PED_ID(), -1, -957453492);
				}
			}
		}
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1]))
	{
		if (!iLocal_63)
		{
			...
			if (PED::IS_PED_FACING_PED(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 90f))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1]))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&iLocal_59);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					AI::TASK_PLAY_ANIM(0, "random@burial", "a_burial_stop", 8f, -4f, 2000, 0, 0f, 0, 0, 0);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_59);
					AI::TASK_PERFORM_SEQUENCE(iLocal_52[0], iLocal_59);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
		...
		if (iLocal_125 && !iLocal_126)
		{
			if (func_70(&uLocal_138, "REBU2AU", "REBU2_WAR", 4, 0, 0, 0))
			{
				...
				{
					AI::TASK_AIM_GUN_AT_ENTITY(iLocal_52[0], PLAYER::PLAYER_PED_ID(), -1, 0);
				}
				iLocal_126 = 1;
				SYSTEM::SETTIMERB(0);
			}
		...
		if (iLocal_126 && !bLocal_127)
		{
			if (SYSTEM::TIMERB() > 15000 && !func_12())
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[0], 30f, 30f, 30f, 0, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[1], 30f, 30f, 30f, 0, 1, 0))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_52[0], PLAYER::PLAYER_PED_ID(), 0);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 0);
		...
		if (((!iLocal_64 && iLocal_125) && !PED::IS_PED_INJURED(iLocal_52[0])) && !PED::IS_PED_INJURED(iLocal_52[1]))
		{
			...
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_59);
				AI::TASK_GO_TO_ENTITY(0, iLocal_52[1], -1, 2f, 1f, 1073741824, 0);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_52[1], 0);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_59);
				AI::TASK_PERFORM_SEQUENCE(iLocal_52[0], iLocal_59);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
				AI::OPEN_SEQUENCE_TASK(&iLocal_59);
				AI::TASK_GO_TO_ENTITY(0, iLocal_52[0], -1, 2f, 1f, 1073741824, 0);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_52[0], 0);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_59);
				AI::TASK_PERFORM_SEQUENCE(iLocal_52[1], iLocal_59);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_59);
		...
		if (((PED::_0x6CD5A433374D4CFB(iLocal_52[0], PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_52[1], PLAYER::PLAYER_PED_ID())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[0])) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_52[1]))
		{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
				{
					...
					if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
					{
						if (!iLocal_64)
						{
							...
							AI::OPEN_SEQUENCE_TASK(&iLocal_59);
							AI::TASK_CLEAR_LOOK_AT(0);
							AI::TASK_PLAY_ANIM(0, "random@burial", "a_burial_stop", 8f, -8f, 2000, 0, 0f, 0, 0, 0);
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < GAMEPLAY::GET_GAME_TIMER())
				{
					...
					{
						iLocal_84 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4500, 6500));
						iLocal_128++;
					}
				}
				break;
...
void func_124()
{
	switch (iLocal_86)
	{
		...
		case 4:
			iLocal_84 = GAMEPLAY::GET_GAME_TIMER() + 3000;
			iLocal_86++;
			break;
		...
		if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
		{
			if (!PED::IS_PED_INJURED(iLocal_52[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52[0], "random@burial", "a_burial_stop", 3))
				{
					...
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_burial_dirt", iLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1f, 0, 0, 0);
					}
				}
...
int func_126()
{
	if (!iLocal_103)
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(vLocal_74, 100f, 1) || GAMEPLAY::IS_BULLET_IN_AREA(vLocal_74, 100f, 1))
		{
			if (PED::IS_PED_INJURED(iLocal_52[0]) || PED::IS_PED_INJURED(iLocal_52[1]))
			{
				iLocal_49 = 1;
			...
			else if (!GAMEPLAY::IS_BULLET_IN_AREA(vLocal_74, 100f, 1) || !GAMEPLAY::IS_BULLET_IN_AREA(vLocal_74, 100f, 1))
			{
				iLocal_49 = 1;
				return 1;
			}
...
void func_134()
{
	...
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_51, 2, 0);
	...
	while (iLocal_58 <= 1)
	{
		...
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_52[iLocal_58], 2, 0);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_52[iLocal_58], 128, 1);
		...
		PED::SET_PED_MONEY(iLocal_52[iLocal_58], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(800, 2000));
		iLocal_58++;
	}
	...
	AI::TASK_SYNCHRONIZED_SCENE(iLocal_51, iLocal_303, "random@burial", "b_burial", 4f, -4f, 1, 0, 1148846080, 0);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[0], iLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_57[1], iLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_303, true);
	PED::SET_PED_KEEP_TASK(iLocal_51, true);
	AI::TASK_PLAY_ANIM(iLocal_52[0], "random@burial", "a_burial", 8f, -4f, -1, 1, 0f, 0, 0, 0);
	AI::TASK_PLAY_ANIM(iLocal_52[1], "random@burial", "c_burial", 8f, -4f, -1, 1, 0f, 0, 0, 0);
	...
	if (iLocal_122)
	{
		...
		while (iVar0 < iLocal_52)
		{
			if (!PED::IS_PED_INJURED(iLocal_52[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					AI::TASK_COMBAT_PED(iLocal_52[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(iLocal_52[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
		...
		while (iLocal_58 <= 1)
		{
			if (UI::DOES_BLIP_EXIST(iLocal_87[iLocal_58]))
			{
				UI::REMOVE_BLIP(&(iLocal_87[iLocal_58]));
			}
			iLocal_58++;
		}
		if (UI::DOES_BLIP_EXIST(iLocal_88))
