...
void __EntryFunction__()
{
	...
	if (func_508())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_HELI(Global_99633.f_2875.f_12.f_66) || VEHICLE::IS_THIS_MODEL_A_PLANE(Global_99633.f_2875.f_12.f_66))
				{
		...
		switch (iLocal_58)
		{
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					...
					Local_68.f_17 = (GAMEPLAY::GET_GAME_TIMER() - 5000);
					func_8();
					iLocal_60 = 2;
				}
				break;
...
bool func_6(vector3 vParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, fParam2, 0f) };
...
void func_19(int iParam0, struct<2> Param1, float fParam2)
{
	...
	if (fVar3 != 0f)
	{
		fVar1 = GAMEPLAY::ATAN2(fVar2, fVar3);
	}
	else if (fVar2 < 0f)
	{
		fVar1 = -90f;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_32(PLAYER::PLAYER_ID())) && !func_29(PLAYER::PLAYER_ID(), 0)) && !func_28()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_32(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
	...
	if (func_23(Local_75))
	{
		if (func_421(Local_77))
		{
			if (func_58(3))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_75, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				...
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_75, 0);
				AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_75, 0);
				PED::SET_PED_KEEP_TASK(Local_75, 1);
				PED::SET_PED_CONFIG_FLAG(Local_75, 118, 0);
			}
		}
	}
}
...
void func_67()
{
	if (func_421(Local_68.f_9))
	{
		...
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_151, Local_68.f_9, 0);
		}
	}
	if (func_421(Local_75))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_150, Local_75, 0);
		}
	}
}
			...
			if (iLocal_62 == 4)
			{
				if (func_23(Local_75))
				{
					...
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_75))
					{
						...
						{
							AUDIO::STOP_PED_SPEAKING(Local_75, 0);
					...
					else if (func_23(Local_75))
					{
						if (!func_64(Local_75, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_75))
							{
								...
								{
									func_73(&Local_75);
									AI::TASK_SMART_FLEE_PED(Local_75, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_75, 1);
								}
							}
						}
...
void func_83()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_86(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_85(PLAYER::PLAYER_PED_ID());
			if (func_84(iVar0) && (!func_87(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_84(Global_106070.f_2355.f_539.f_4301))
				{
...
void func_99(int iParam0, bool bParam1)
{
	if (func_23(iParam0))
	{
		...
		if (!func_64(iParam0, 1805844857))
		{
			...
			AI::CLEAR_PED_SECONDARY_TASK(iParam0);
			AI::TASK_LOOK_AT_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
			AI::TASK_SMART_FLEE_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
		}
		if (bParam1)
		{
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || AI::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_102()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_102(), func_74(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_114(int iParam0)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_70[iParam0 /*19*/]);
		AI::CLEAR_PED_TASKS(Local_70[iParam0 /*19*/]);
		AI::TASK_CLEAR_LOOK_AT(Local_70[iParam0 /*19*/]);
		if (func_115(1, 0, 1))
		{
		...
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_70[iParam0 /*19*/]) == iLocal_319)
		{
			...
			PED::SET_PED_FLEE_ATTRIBUTES(Local_70[iParam0 /*19*/], 512, 1);
			AI::TASK_LOOK_AT_ENTITY(Local_70[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_70[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
...
void func_118()
{
	...
	{
		func_121(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
	...
	switch (iLocal_60)
	{
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					if (func_23(Local_68.f_9))
					{
						...
						AI::CLEAR_PED_TASKS(Local_68.f_9);
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_75))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_75, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_75, 1);
				}
...
void func_126(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_178(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_175(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_127(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_128(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_147();
			}
...
void func_129(int iParam0, int iParam1)
{
	...
	func_169(iParam0, &(Global_106070.f_32605.f_5510));
}
...
var func_147()
{
	...
	func_157(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_156(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_155(&uVar0, TIME::GET_CLOCK_HOURS());
	func_150(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_149(&uVar0, TIME::GET_CLOCK_MONTH());
	func_148(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_158(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_168(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_168(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_168(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_161(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_158(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_166(iParam0);
			func_165(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_170(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	return func_187(Global_96664.f_2875.f_12.f_66, vParam0, iParam1);
}
...
void func_191(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_192(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_193(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_243(iVar10, iParam1, iParam2, -1) };
		if (!func_242(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_243(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_243(iVar10, 14, uVar12[iVar1], -1) };
							func_213(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_235(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_203(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_203(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_203(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_235(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_243(iVar10, iVar0, func_202(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_243(iVar10, 14, uVar15[iVar1], -1) };
			func_213(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_235(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_203(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_203(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_203(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_307(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_243(iParam0, iParam1, iParam2, -1) };
...
int func_201(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_307(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_213(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_214(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_203(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_203(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_228(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_228(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_228(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_235(int iParam0)
{
	...
	{
		func_241(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_238(iParam2)];
	if (iVar0 != 0)
	{
...
int func_239(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_238(iParam1)];
...
void func_245(int iParam0)
{
	...
	func_246(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_239(func_249(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_239(func_248(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_239(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_252(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_246(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_203(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_307(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_243(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_307(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_307(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_243(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_307(iParam0, 14, iVar4))
										{
											if (!func_199(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_243(iVar0, iVar2, iVar1, -1) };
						if (!func_199(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_203(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_203(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				{
					AI::CLEAR_PED_TASKS(Local_68.f_9);
					Local_68.f_18 = (GAMEPLAY::GET_GAME_TIMER() - 3000);
					Local_68.f_10 = 13;
				}
				if (func_23(Local_68.f_9))
				{
					if (!UI::DOES_BLIP_EXIST(Local_68.f_8))
					{
				...
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						if (func_321(Local_68.f_9, vLocal_329, bVar0, 0, 1, iLocal_136))
						{
							...
							{
								func_320();
								Local_68.f_17 = GAMEPLAY::GET_GAME_TIMER();
						...
						else
						{
							...
							{
								if (func_113(iLocal_120, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_329, 30f))
									{
...
bool func_312(char* sParam0, int iParam1, char* sParam2)
{
...
void func_313(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_62())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_312(sParam2, 0, 0))
				{
		...
		else
		{
			...
			if (iParam6 && !func_62())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_312(sParam1, 0, 0))
				{
...
void func_317(int iParam0, vector3 vParam1, int iParam2, float fParam3)
{
	...
	iVar5 = (GAMEPLAY::GET_GAME_TIMER() - iParam2);
...
void func_320()
{
	if (func_23(Local_68.f_9))
	{
		if (((Local_68.f_10 != 23 && Local_68.f_10 != 24) && Local_68.f_10 != 21) && Local_68.f_10 != 22)
		{
			...
			AI::CLEAR_PED_SECONDARY_TASK(Local_68.f_9);
			AI::CLEAR_PED_TASKS(Local_68.f_9);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_68.f_9, 0, 1);
			WEAPON::SET_PED_DROPS_WEAPON(Local_68.f_9);
			WEAPON::REMOVE_ALL_PED_WEAPONS(Local_68.f_9, 1);
			WEAPON::SET_CURRENT_PED_WEAPON(Local_68.f_9, joaat("weapon_unarmed"), 1);
			PED::SET_PED_CAN_SWITCH_WEAPON(Local_68.f_9, 0);
			PED::SET_PED_ARMOUR(Local_68.f_9, 0);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 1, 0);
			...
			{
				AI::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
			}
...
int func_322(int iParam0, vector3 vParam1, float fParam2, float fParam3)
{
	if (func_105(iParam0, vParam1, fParam2))
	{
		...
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0, 1), fParam3, 1))
			{
				return 1;
			}
		}
...
int func_332(char* sParam0)
{
	if (!func_333(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_319(sParam0)) || func_319("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_333(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_341() || func_340(Global_4456448.f_152990)) || func_339())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_338(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_337(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_334(int iParam0)
{
	if (iParam0 != func_336())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_335(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_356(var uParam0, vector3 vParam1)
{
	...
	if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar0, vVar1, 0))
	{
		if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_grenade"), uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_molotov"), uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_smokegrenade"), uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_bzgas"), uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_stickybomb"), uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(vVar0, vVar1, joaat("weapon_flare"), uParam0, 0))
		{
		}
		else
		{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_68.f_10)
			{
				...
				case 1:
					...
					{
						func_38(&Local_72, 1);
						if (!AI::IS_PED_ACTIVE_IN_SCENARIO(Local_68.f_9))
						{
							AI::TASK_START_SCENARIO_IN_PLACE(Local_68.f_9, "WORLD_HUMAN_SMOKING", 0, 1);
				...
				case 2:
					if (func_105(Local_68.f_9, vLocal_329, 20f))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						}
					}
					else if (PED::IS_PED_HEADTRACKING_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_CLEAR_LOOK_AT(Local_68.f_9);
					}
					break;
				
				case 3:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
						Local_68.f_10 = 4;
					}
					break;
				...
				case 4:
					...
					{
						Local_68.f_18 = (GAMEPLAY::GET_GAME_TIMER() - 5000);
						Local_68.f_10 = 3;
					}
					break;
				...
				case 5:
					...
					AI::TASK_GO_TO_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 20000, 2.5f, 1f, 1073741824, 0);
				...
				case 7:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							PED::_0xF1C03A5352243A30(Local_68.f_9);
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 0, 0);
						AI::TASK_COMBAT_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
						Local_68.f_10 = 8;
					}
					break;
				...
				case 29:
					...
					{
						WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, joaat("weapon_pistol"), -1, 0, 1);
					}
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 0, 0);
					PED::SET_PED_COMBAT_RANGE(Local_68.f_9, 0);
				...
				case 30:
					...
					{
						fVar3 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
						AI::OPEN_SEQUENCE_TASK(&uLocal_142);
						AI::TASK_GOTO_ENTITY_AIMING(0, PLAYER::PLAYER_PED_ID(), fVar3, 30f);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_142);
						AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_142);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_142);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
					}
					break;
				
				case 31:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 0, 1);
						PED::SET_PED_COMBAT_RANGE(Local_68.f_9, 0);
						PED::SET_PED_ACCURACY(Local_68.f_9, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10, 22));
						PED::SET_PED_SHOOT_RATE(Local_68.f_9, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(30, 60));
						PED::SET_PED_FIRING_PATTERN(Local_68.f_9, 2055493265);
						WEAPON::GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, joaat("weapon_pistol"), -1, 0, 1);
							WEAPON::SET_CURRENT_PED_WEAPON(Local_68.f_9, joaat("weapon_pistol"), 0);
						}
						AI::TASK_COMBAT_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
						Local_68.f_10 = 32;
				...
				case 13:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
						...
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 2, 0);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 64, 0);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 128, 0);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 8, 0);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 1, 0);
						PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 32, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 17, 1);
						AI::OPEN_SEQUENCE_TASK(&uLocal_142);
				...
				case 15:
					PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 2, 1);
					PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 64, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 128, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 8, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(Local_68.f_9, 1, 0);
					...
					if (func_7(Local_71[0 /*6*/]))
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_105(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_364(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)) && !func_363(Local_71[0 /*6*/], 2))
						{
							...
							else if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								func_38(&Local_72, 0);
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 3))
								{
								...
								AI::TASK_ENTER_VEHICLE(Local_68.f_9, Local_71[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
								Local_68.f_10 = 16;
							}
						}
				...
				case 17:
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_68.f_9, Local_71[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
						PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 173, 0);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
						Local_68.f_10 = 18;
					}
				...
				case 21:
					...
					{
						if (AI::GET_SCRIPT_TASK_STATUS(Local_68.f_9, -1519143300) == 1)
						{
							AI::UPDATE_TASK_HANDS_UP_DURATION(Local_68.f_9, 500);
						}
						else
						{
							AI::CLEAR_PED_TASKS(Local_68.f_9);
						...
						AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_68.f_9, 1);
						AI::SET_PED_PATH_CAN_USE_LADDERS(Local_68.f_9, 1);
						AI::SET_PED_PATHS_WIDTH_PLANT(Local_68.f_9, 1);
						AI::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_68.f_9, 1);
						AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_68.f_9, 0);
						AI::SET_PED_PATH_AVOID_FIRE(Local_68.f_9, 1);
						PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 167, 1);
						PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 118, 1);
						ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_68.f_9, 1);
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_68.f_9, 1, 1);
						PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 42, 1);
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_68.f_9, iVar1, 0))
								{
									...
									if (fVar4 < 1.75f && func_105(Local_68.f_9, vLocal_329, 8f))
									{
										if (!func_64(Local_68.f_9, -1794415470))
										{
											...
											if (iVar2 != -1)
											{
												AI::TASK_ENTER_VEHICLE(Local_68.f_9, iVar1, 25000, iVar2, 2f, 1048577, 0);
											}
										}
										else if (PED::IS_PED_GETTING_INTO_A_VEHICLE(Local_68.f_9))
										{
											if (PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(Local_68.f_9) != iVar1)
											{
												AI::CLEAR_PED_TASKS(Local_68.f_9);
											}
										}
				...
				case 23:
					if (func_362(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_361())
					{
						if (PED::IS_PED_IN_GROUP(Local_68.f_9))
						{
							PED::REMOVE_PED_FROM_GROUP(Local_68.f_9);
							ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_68.f_9, 0, 1);
							PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 42, 0);
							PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 118, 1);
						}
						...
						if (((!PED::IS_PED_RAGDOLL(Local_68.f_9) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_68.f_9)) && !func_64(Local_68.f_9, -828834893))
						{
							...
							if ((!func_358(Local_68.f_19, 10) && func_105(Local_68.f_9, vLocal_329, 50f)) || !func_113(iLocal_139, 2000))
							{
								...
								else if (AI::GET_SCRIPT_TASK_STATUS(Local_68.f_9, -1519143300) == 1)
								{
									AI::UPDATE_TASK_HANDS_UP_DURATION(Local_68.f_9, -1);
								}
								else
								{
									AI::TASK_HANDS_UP(Local_68.f_9, -1, PLAYER::PLAYER_PED_ID(), -1, 0);
								}
							}
				...
				case 26:
					...
					{
						AI::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_68.f_9, 1);
						AI::SET_PED_PATHS_WIDTH_PLANT(Local_68.f_9, 0);
					}
					else if ((!PED::IS_PED_RAGDOLL(Local_68.f_9) && !AI::IS_PED_GETTING_UP(Local_68.f_9)) && PED::IS_PED_ON_FOOT(Local_68.f_9))
					{
...
int func_361()
{
	...
	if (AI::IS_PED_GETTING_UP(Local_68.f_9) || PED::IS_PED_RAGDOLL(Local_68.f_9))
	{
		iLocal_139 = GAMEPLAY::GET_GAME_TIMER();
		return 1;
	}
...
int func_362(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
		if (GAMEPLAY::IS_BULLET_IN_AREA(vVar0, fParam4, 1))
		{
			return 1;
		}
		...
		if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar1, vVar2, 1))
		{
			return 1;
		}
	}
...
bool func_370(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_56[iVar2 /*4*/].f_3) < iParam4);
}
			...
			case 1:
				if (!iLocal_108)
				{
					...
					if (!func_105(Local_68.f_9, vLocal_329, 25f))
					{
						...
						{
							Local_68.f_18 = GAMEPLAY::GET_GAME_TIMER();
							Local_68.f_10 = 25;
						}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_119) > 7500)
						{
							func_384(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_119) > 10000)
						{
							func_384(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_64(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_329, 25f))
					{
						...
						{
							if (func_113(iLocal_121, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
								...
								{
									iLocal_121 = GAMEPLAY::GET_GAME_TIMER();
								}
							}
						}
						else
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_113(iLocal_120, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_329, 20f))
							{
				...
				if (!iLocal_108)
				{
					...
					else
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_114))
						{
							if (iLocal_96)
							{
								uLocal_114 = func_390(vLocal_328, 5, 1);
							}
						}
						if (!iLocal_83)
						{
...
int func_388(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	...
	if (func_23(*iParam0))
	{
		if (!func_62())
		{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - *iParam2) > (iParam3 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					uVar1 = 16;
					...
					*iParam2 = GAMEPLAY::GET_GAME_TIMER();
					return 1;
				}
			}
		}
...
void func_392(bool bParam0, var uParam1)
{
	...
	if (bParam0)
	{
		*uParam1 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
		...
		GAMEPLAY::CLEAR_AREA(2728.333f, 4144.778f, 43.29292f, 7.5f, 1, 0, 0, false);
	}
	else
	{
...
void func_393(int iParam0, int iParam1, vector3 vParam2)
{
	...
	{
		AI::SET_DRIVE_TASK_CRUISE_SPEED(iParam0, fVar0);
	}
}

void func_394(var uParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_395(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	...
	if (!func_105(iParam1, *(uParam3[*iParam4 /*3*/]), 15f))
	{
		if (!func_64(iParam0, -1817882002) && !func_64(iParam0, -72074166))
		{
			if (iLocal_118 < 7)
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(iParam0, iParam1, *(uParam3[*iParam4 /*3*/]), 35f, 0, iParam2, 786468, 0f, 2f);
			}
			else
			{
				AI::TASK_VEHICLE_GOTO_NAVMESH(iParam0, iParam1, *(uParam3[*iParam4 /*3*/]), 35f, 4980772, 0f);
			}
		}
	}
	else
...
int func_396(int iParam0, int iParam1, int iParam2, int iParam3)
{
	if (func_23(iParam0))
	{
		if (func_7(iParam1))
		{
			...
			{
				AI::TASK_VEHICLE_TEMP_ACTION(iParam0, iParam1, 4, 2000);
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
							...
							if (func_105(Local_68.f_9, vLocal_329, 25f) && func_400(Local_68.f_9, vLocal_329, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (func_399(&(Local_68.f_19)))
									{
										...
										{
											Local_68.f_18 = (GAMEPLAY::GET_GAME_TIMER() - 50000);
											Local_68.f_10 = 3;
										}
									}
						...
						else if (!iLocal_86)
						{
							if (!func_315("BBC_T14", 1) && !func_315("BB1_J2", 1))
							{
								...
								else if (iLocal_61 == 1)
								{
									...
									{
										Local_68.f_17 = (GAMEPLAY::GET_GAME_TIMER() - 3000);
										iLocal_86 = 1;
									}
								}
							}
			...
			case 2:
				...
				func_353(&(Local_68.f_8), "", "", &iLocal_123, iLocal_124, 0);
				iLocal_123 = GAMEPLAY::GET_GAME_TIMER();
...
int func_400(int iParam0, vector3 vParam1, float fParam2)
{
	...
	fVar1 = GAMEPLAY::ABSF((vVar0.z - vParam1.z));
	if (fVar1 <= fParam2)
	{
		return 1;
	}
...
void func_402(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_405(26, func_407(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_62() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
...
int func_413(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (((GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_grenade"), fParam1, 1) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_molotov"), fParam1, 1)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_smokegrenade"), fParam1, 1)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_stickybomb"), 5f, 1))
		{
			if (bParam3)
			{
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_471(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_471(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_437(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_84(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_171(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_440(*iParam1);
				...
				func_438(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_438(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_442(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			...
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_446(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_447(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_463(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_336())
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_464(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_336())
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_465(int iParam0)
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_443(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
void func_476(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_159(iParam0, iParam1))
				{
...
void func_477(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_478(int iParam0)
{
	...
	if (func_158(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_70024.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_164(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_479(0, Global_70024.f_555[0 /*21*/].f_12) || !func_479(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_165(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_479(int iParam0, int iParam1)
{
	...
	return func_132(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
{
	return func_482(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_499(uParam0))
	{
		...
		if (func_498(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_484(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_484(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_486(iParam0, Global_70024.f_139[38], 0))
			{
				func_478(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_486(iParam0, Global_70024.f_139[43], 1))
			{
				func_478(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_168(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_487(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_170(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_170(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_170(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_490(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_489())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_170(iVar2 + 1)))
				{
...
bool func_500()
{
	return func_498(&(Global_99633.f_2875));
}

void func_501()
{
	func_502(&(Global_99633.f_2875));
}
...
int func_503(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_505(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_506()
{
	return func_499(&(Global_99633.f_2875));
}
...
void func_509()
{
	...
	GAMEPLAY::CLEAR_AREA(Local_63, 30f, 0, 0, 0, false);
...
void func_510()
{
	...
	if (func_23(Local_68.f_9))
	{
		AUDIO::STOP_PED_SPEAKING(Local_68.f_9, 1);
		AI::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_68.f_9, 1);
		...
		AI::SET_PED_PATHS_WIDTH_PLANT(Local_68.f_9, 0);
		PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 118, 1);
		PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 137, 1);
		PED::SET_PED_CONFIG_FLAG(Local_68.f_9, 281, 1);
		if (Local_68.f_12 != 0)
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, Local_68.f_12, -1, 1, 1);
		}
		func_355(Local_68.f_9);
		func_511(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_68.f_9);
		AI::TASK_PLAY_ANIM(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0f, 0, 0, 0);
		if (!ENTITY::DOES_ENTITY_EXIST(Local_72))
		{
			Local_72 = OBJECT::CREATE_OBJECT(joaat("prop_phone_ing"), ENTITY::GET_ENTITY_COORDS(Local_68.f_9, 0), 1, 1, 0);
		}
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_70[iVar0 /*19*/]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_70[iVar0 /*19*/], Local_70[iVar0 /*19*/].f_5, -1, 1, 1);
			}
			PED::SET_PED_CONFIG_FLAG(Local_70[iVar0 /*19*/], 137, 1);
	...
	while (iVar0 <= (iLocal_126 - 1))
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_71[iVar0 /*6*/], 1, 1, 0);
		}
		iVar0++;
	}
}

void func_511(var uParam0, char* sParam1, int iParam2)
{
	char cVar0[16];
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_105117) || Global_25461) || func_538()) || func_89(8, -1)) || func_537()) || func_536()) || func_530()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_532()) || Global_25461) || func_538()) || func_89(8, -1)) || func_530()) || func_537()) || func_536()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_105117) || Global_25461) || func_538()) || func_89(8, -1)) || func_530()) || func_537()) || func_536()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_105117) || Global_25461) || func_538()) || func_89(8, -1)) || func_537()) || func_536()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_532() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_89(8, -1)) || func_531()) || func_535()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_532()) || Global_25461) || func_538()) || func_89(8, -1)) || func_536()) || func_530()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_532()) || func_536()) || Global_105117) || Global_25461) || func_538()) || Global_37271) || func_89(8, -1)) || func_530()) || func_535()) || func_531()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_532()) || Global_105117) || Global_25461) || func_538()) || func_89(8, -1)) || func_530()) || func_535()) || func_537()) || func_536()) || func_531())
						{
							return 0;
						}
						break;
...
{
	return func_540(iParam0, Global_36117);
}
...
int func_550()
{
	...
	iVar0 = func_551(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_554()
{
	...
	{
		if (func_544(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
