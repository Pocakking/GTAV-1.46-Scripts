...
void __EntryFunction__()
{
	...
	GAMEPLAY::STOP_SAVE_DATA();
	iVar2 = 12746;
	iVar3 = GAMEPLAY::_0xA09F896CE912481F(0);
	if (iVar2 != iVar3)
	{
	}
...
void func_10(var uParam0, int iParam1)
{
	...
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_12568.f_1), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar3 = { Var2 };
		StringIntConCat(&cVar3, iVar1, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_12568.f_1[iVar1]), &cVar3);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGSCRS", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_12568.f_18), 97, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar4 = { Var2 };
		StringIntConCat(&cVar4, iVar1, 16);
		GAMEPLAY::_0x48F069265A0E4BEC(&(uParam0->f_12568.f_18[iVar1 /*6*/]), &cVar4);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGACT", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_12568.f_115), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar5 = { Var2 };
		StringIntConCat(&cVar5, iVar1, 16);
		GAMEPLAY::REGISTER_ENUM_TO_SAVE(&(uParam0->f_12568.f_115[iVar1]), &cVar5);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var2, "MPATMLOGDAT", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_12568.f_132), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar6 = { Var2 };
		StringIntConCat(&cVar6, iVar1, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_12568.f_132[iVar1]), &cVar6);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
...
void func_11(var uParam0, int iParam1)
{
	...
	while (iVar2 < 16)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/]), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_2", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_1), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_3", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_2), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_4", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_3), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_5", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_4), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_6", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_5), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_7", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_6), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_8", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_7), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_9", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_8), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_10", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_9), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_11", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_10), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_12", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_11), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_13", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_12327.f_15[iVar2 /*13*/].f_12), &cVar1);
		iVar2++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var0, "MP_BOUNTY_SAVED", 24);
	...
	while (iVar2 < 16)
	{
		MemCopy(&cVar1, {Var0}, 8);
		StringIntConCat(&cVar1, iVar2, 32);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_12327.f_224[iVar2]), &cVar1);
		iVar2++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::STOP_SAVE_STRUCT();
...
void func_13(var uParam0, char* sParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 4149, sParam1);
	...
	while (iVar2 < uParam0->f_1275)
	{
		...
		GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_1275[iVar2]), &cVar3);
		iVar2++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar2 < uParam0->f_1285)
	{
		...
		StringIntConCat(&cVar3, iVar2, 64);
		GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_1285[iVar2]), &cVar3);
		iVar2++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < uParam0->f_1304)
	{
		...
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1304[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < uParam0->f_2681)
	{
		...
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2681[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	iVar4 = 0;
	...
	while (iVar4 < uParam0->f_3600)
	{
		...
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3600[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1326[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompDraw", 16);
			...
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1326[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar4++;
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1600[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1600[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar4++;
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1874[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropID", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1874[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar4++;
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2085[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2085[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar4++;
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2296[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2318[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2340[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2362[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2384[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2406[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2428[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2619[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::_0x8269816F6CFD40F8(&(uParam0->f_2450[iVar4 /*8*/]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/]), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_1), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_2), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_3), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_4), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_5), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_6), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_7), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_8), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_9), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_10), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_11), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2641[iVar4 /*13*/].f_12), &cVar6);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3922[iVar4 /*3*/]), &Var1);
		StringCopy(&Var1, "Completed", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_3922[iVar4 /*3*/].f_1), &Var1);
		StringCopy(&Var1, "Initial", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3922[iVar4 /*3*/].f_2), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 24)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3932[iVar4]), &Var1);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		GAMEPLAY::_0xFAA457EF263E8763(&(uParam0->f_3957[iVar4 /*16*/]), &cVar7);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/]), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_1), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_2), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_3), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_4), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_5), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_6), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_7), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_8), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_9), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_10), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_11), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4020[iVar4 /*13*/].f_12), &cVar8);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/]), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_1), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_2), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_3), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_4), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_5), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_6), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_7), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_8), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_9), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_10), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_11), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4060[iVar4 /*13*/].f_12), &cVar9);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar4 < 3)
	{
		...
		GAMEPLAY::_0xFAA457EF263E8763(&(uParam0->f_4100[iVar4 /*16*/]), &cVar10);
		iVar4++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::STOP_SAVE_ARRAY();
...
void func_15(var uParam0, char* sParam1, int iParam2)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 2108, sParam1);
	...
	while (iVar1 < 145)
	{
		...
		StringIntConCat(&Var0, iVar1, 64);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_1927[iVar1]), &Var0);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2073), &Var0);
	StringCopy(&Var0, "bCarAppPlateSet", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2075), &Var0);
	StringCopy(&Var0, "bDeleteCarData", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2074), &Var0);
	StringCopy(&Var0, "iCarAppPlateBack", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2080), &Var0);
	StringCopy(&Var0, "tlCarAppPlateText", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::_0x6F7794F28C6B2535(&(uParam0->f_2076), &Var0);
	StringCopy(&Var0, "iOrderCount", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2081), &Var0);
	StringCopy(&Var0, "iOrderVehicle", 64);
	StringIntConCat(&Var0, iParam2, 64);
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2082), &Var0);
	...
	while (iVar1 < 10)
	{
		...
		StringIntConCat(&Var0, iVar1, 64);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2083[iVar1]), &Var0);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	...
	while (iVar1 < 10)
	{
		...
		StringIntConCat(&Var0, iVar1, 64);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2094[iVar1]), &Var0);
		iVar1++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
...
void func_19(var uParam0, char* sParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 564, sParam1);
...
void func_21(var uParam0, char* sParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 6, sParam1);
...
{
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 141, sParam1);
