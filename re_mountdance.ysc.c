	...
	while (true)
	{
		...
		switch (iLocal_95)
		{
			...
			case 1:
				...
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
			...
			case 3:
				...
				if (func_9(iLocal_91, PLAYER::PLAYER_PED_ID(), 1) < 25f)
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_96))
					{
						...
						UI::SET_BLIP_COLOUR(iLocal_96, 3);
					}
				}
				else if (UI::DOES_BLIP_EXIST(iLocal_96))
				{
					func_4(&iLocal_96);
				}
				...
				if (((((PED::IS_PED_INJURED(iLocal_91) || GAMEPLAY::IS_BULLET_IN_AREA(vVar0, 50f, 1)) || GAMEPLAY::IS_BULLET_IN_AREA(vVar0, 50f, 0)) || GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar0, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar0, 50f)) || (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_91) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_91)) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar0, true) < 25f) && func_1(iLocal_91, PLAYER::PLAYER_PED_ID(), 1126825984, 0)))
				{
					AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 6:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_91, 713668775) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_91, 713668775) != 0)
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_91, false);
					if (iLocal_93 == 1)
					{
						AI::TASK_SMART_FLEE_PED(iLocal_91, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					}
					else
					{
						AI::TASK_WANDER_STANDARD(iLocal_91, 1193033728, 0);
					}
					PED::SET_PED_KEEP_TASK(iLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_91) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_91, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
				{
					func_36(1);
				}
				break;
