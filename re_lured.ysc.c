...
void func_35()
{
	...
	else if (!iLocal_232 && !bLocal_230)
	{
		if ((func_50() || WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_56, false), 12f, 12f, 5f, false, true, 0))
		{
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_56);
				AI::TASK_COMBAT_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 0, 16);
...
int func_50()
{
	...
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_55, 31086, 0f, 0f, 0f), 30f, 1))
		{
			return 1;
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 30f, 30f, 30f, 0, 1, 0) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			...
			{
				if (PED::_0x6CD5A433374D4CFB(iLocal_55, PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_56, PLAYER::PLAYER_PED_ID()))
				{
					func_48();
					SYSTEM::WAIT(0);
...
void func_52()
{
	if (!bLocal_230)
	{
		if (!PED::IS_PED_INJURED(iLocal_56))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iLocal_56, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_231)
				{
					iLocal_236 = 500;
...
void func_83()
{
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			...
			{
				AI::TASK_LOOK_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
				...
				else
				{
					...
					AI::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, -1, 0, 0f, 0, 0, 0);
				...
				iLocal_58 = func_90(iLocal_56, 1, 145);
				AUDIO::TRIGGER_MUSIC_EVENT("RE35_OS");
				SYSTEM::WAIT(500);
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_55, joaat("weapon_pistol"), 200, true, true);
					AI::OPEN_SEQUENCE_TASK(&iLocal_61);
					AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_52, PLAYER::PLAYER_PED_ID(), 2f, false, 0f, 4f, true, 512, 0, -957453492, 20000);
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_61);
					AI::TASK_LOOK_AT_ENTITY(0, iLocal_56, -1, 2048, 2);
					AI::TASK_PAUSE(0, 1000);
					AI::CLOSE_SEQUENCE_TASK(iLocal_61);
					AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_61);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_61);
					func_84(1);
				}
				func_48();
...
int func_90(int iParam0, bool bParam1, int iParam2)
{
	...
	iVar0 = func_91(iParam0, !bParam1, 0);
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!func_33())
				{
					if (iLocal_235 == 0)
					{
						...
						AI::TASK_LOOK_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						iLocal_235++;
						SYSTEM::SETTIMERB(0);
					}
...
void func_94()
{
	if (!PED::IS_PED_INJURED(iLocal_55))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::_0x6CD5A433374D4CFB(iLocal_55, PLAYER::PLAYER_PED_ID()))
			{
				AI::CLEAR_PED_TASKS(iLocal_55);
				AI::OPEN_SEQUENCE_TASK(&iLocal_61);
				AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
...
void func_95()
{
	if (!func_124())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_47, 65f, 60f, 60f, false, true, 0) || Global_106065)
			{
				if (UI::DOES_BLIP_EXIST(iLocal_59))
				{
					UI::REMOVE_BLIP(&iLocal_59);
				}
				iLocal_57 = func_90(iLocal_55, 0, 145);
	...
	if (!iLocal_227)
	{
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 25f, 25f, 25f, 0, 1, 0) && func_124())
			{
				if (func_36(&uLocal_62, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_61);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
					AI::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 49, 0f, 0, 0, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
	{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					SYSTEM::SETTIMERB(0);
					AI::CLEAR_PED_SECONDARY_TASK(iLocal_55);
					AI::OPEN_SEQUENCE_TASK(&iLocal_61);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
					AI::TASK_STAND_STILL(0, 1000);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_51, 2f, -1, 0.25f, 512, 80.1325f);
					AI::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_61);
					AI::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_61);
...
void func_108()
{
	...
	AI::OPEN_SEQUENCE_TASK(&iLocal_61);
	AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 3076, 2);
	AI::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, -1, 1, 0f, 0, 0, 0);
	AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
	AI::CLOSE_SEQUENCE_TASK(iLocal_61);
	AI::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
	AI::CLEAR_SEQUENCE_TASK(&iLocal_61);
	...
	AUDIO::STOP_PED_SPEAKING(iLocal_56, 1);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_56, iLocal_54);
	AI::TASK_LOOK_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
	func_109(&uLocal_62, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_109(&uLocal_62, 4, iLocal_55, "HOBOFEMALE", 0, 1);
	func_109(&uLocal_62, 5, iLocal_56, "HOBOMALE", 0, 1);
	iLocal_45 = 1;
}
