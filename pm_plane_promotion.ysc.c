...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_237))
	{
		...
		else if (iLocal_43 == 2)
		{
			...
			else if (UI::DOES_BLIP_EXIST(iLocal_46))
			{
				UI::CLEAR_PRINTS();
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_237) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_237, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_237)) && iLocal_241) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_242)
		{
			if (CONTROLS::IS_CONTROL_JUST_PRESSED(0, 114))
			{
				if (iLocal_240 == -1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_240) > 2000)
				{
					...
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_237, 0, 0, 0);
					iLocal_240 = GAMEPLAY::GET_GAME_TIMER();
					bLocal_242 = true;
				}
			}
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_240) > 3000)
		{
			bLocal_242 = false;
		}
	}
	...
	switch (iLocal_44)
	{
		case 0:
			...
			else if ((func_20() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_45) > 5000) && iLocal_245)
			{
				StringCopy(&cVar1, "RAND_", 16);
				StringConCat(&cVar1, &cLocal_40, 16);
				if (func_19(49) && GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3) == 0)
				{
		...
		case 1:
			if (func_20() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_45) > 1000)
			{
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_42(iParam0, 1) && !func_41(iParam0)) && !GAMEPLAY::IS_BIT_SET(iParam0->f_13, 0))
					{
						if (bParam22)
						{
				...
				else
				{
					...
					else if (!func_35(vVar3, UI::GET_BLIP_COORDS(iParam0->f_5), 0.1f, 0))
					{
...
int func_27(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_28(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_28(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_29(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_30(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_30(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
						...
						if (func_46(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_64(uParam0->f_17[iVar0], uParam0->f_21))
									{
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar21))
						{
							...
							{
								if (func_58(iVar0, uParam0) || !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_53(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !AI::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], true);
...
void func_51(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
	...
	if (!uParam0->f_6)
	{
		...
		if (fVar0 < uParam0->f_3)
		{
			...
			if (bLocal_242)
			{
				...
				else if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_7) > 1000)
				{
					uParam0->f_6 = 1;
		...
		if (!uParam0->f_6)
		{
			if (!UI::DOES_BLIP_EXIST(uParam0->f_4))
			{
				...
				UI::SET_BLIP_SCALE(uParam0->f_4, 0.75f);
				UI::_0x75A16C3DA34F1245(uParam0->f_4, false);
			}
			if (!UI::DOES_BLIP_EXIST(uParam0->f_5))
			{
...
int func_71(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = UI::ADD_BLIP_FOR_RADIUS(vParam0, fParam1);
	UI::SET_BLIP_COLOUR(iVar0, 5);
	UI::SET_BLIP_ALPHA(iVar0, 64);
	UI::SET_BLIP_AS_SHORT_RANGE(iVar0, bParam2);
	if (!bParam2)
	{
		UI::SET_BLIP_DISPLAY(iVar0, 4);
	}
	return iVar0;
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_126(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_123(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_137()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("PPROM", 0);
	func_141(2, 1);
	...
	while (iVar0 <= 9)
	{
		...
		{
			fVar1 = 0f;
			GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_238[iVar0 /*8*/], &fVar1, 0, 0);
...
void func_142()
{
	...
	if (UI::DOES_BLIP_EXIST(Local_238[0 /*8*/].f_4))
	{
		UI::REMOVE_BLIP(&(Local_238[0 /*8*/].f_4));
	}
	if (UI::DOES_BLIP_EXIST(Local_238[0 /*8*/].f_5))
	{
		UI::REMOVE_BLIP(&(Local_238[0 /*8*/].f_5));
	}
	if (UI::DOES_BLIP_EXIST(Local_238[1 /*8*/].f_4))
	{
		UI::REMOVE_BLIP(&(Local_238[1 /*8*/].f_4));
	}
	if (UI::DOES_BLIP_EXIST(Local_238[1 /*8*/].f_5))
	{
		UI::REMOVE_BLIP(&(Local_238[1 /*8*/].f_5));
	}
