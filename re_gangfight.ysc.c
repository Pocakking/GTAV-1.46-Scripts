	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			...
			if (!func_93())
			{
				...
				UNK1::_0x208784099002BC30("RE_CGF", 0);
				switch (iLocal_44)
				{
					case 0:
						if (func_80())
					...
					case 1:
						...
						if (!func_77() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
						{
							if ((!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_59[0])) && !PED::IS_PED_INJURED(iLocal_59[1]))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, false, true, 0))
								{
									...
									UI::SET_BLIP_PRIORITY(iLocal_56, 9);
									iLocal_57[0] = func_74(iLocal_59[0], 1, 145);
									iLocal_57[1] = func_74(iLocal_59[1], 1, 145);
									UI::_0x75A16C3DA34F1245(iLocal_56, false);
									UI::_0x75A16C3DA34F1245(iLocal_57[0], false);
									UI::_0x75A16C3DA34F1245(iLocal_57[1], false);
									func_64(1);
								}
							}
						}
						else
						{
							...
							while (iVar0 < iLocal_59)
							{
								...
								{
									AI::TASK_SMART_FLEE_PED(iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < iLocal_59)
					{
						...
						{
							AI::TASK_COMBAT_PED(iLocal_59[iVar2], PLAYER::PLAYER_PED_ID(), 0, 16);
						...
						else if (UI::DOES_BLIP_EXIST(iLocal_57[iVar2]))
						{
							UI::REMOVE_BLIP(&(iLocal_57[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_49 && !iLocal_54)
	{
		...
		while (iVar0 < iLocal_59)
		{
			if (UI::DOES_BLIP_EXIST(iLocal_57[iVar0]))
			{
				UI::REMOVE_BLIP(&(iLocal_57[iVar0]));
			}
			if (!PED::IS_PED_INJURED(iLocal_59[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (iVar0 < 2)
				{
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_59[iVar0], iLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 8, 20f, 786469, 150f, 10f, 1);
						PED::SET_PED_KEEP_TASK(iLocal_59[iVar0], true);
					}
					else
					{
						AI::TASK_SMART_FLEE_PED(iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
				}
				else
				{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_2(PLAYER::PLAYER_ID()), vLocal_48, true) > 50f)
	{
		func_140();
	}
}
	...
	switch (iLocal_46)
	{
					...
					if (!PED::IS_PED_INJURED(iLocal_59[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_61[iVar0], 0))
					{
						if (!UI::DOES_BLIP_EXIST(iLocal_57[iVar0]))
						{
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_59[iVar0], 0))
							{
								if (!bLocal_51)
								{
									AI::TASK_DRIVE_BY(iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									...
									AI::TASK_PERFORM_SEQUENCE(iLocal_59[iVar0], iLocal_62);
		...
		case 1:
			...
			while (iVar1 < iLocal_59)
			{
				if (!PED::IS_PED_INJURED(iLocal_59[iVar1]))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_59[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, false, true, 0))
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_59[iVar1], 0))
						{
							...
							AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							AI::CLOSE_SEQUENCE_TASK(iLocal_62);
							AI::TASK_PERFORM_SEQUENCE(iLocal_59[iVar1], iLocal_62);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_59[iVar1], 0))
					{
						AI::TASK_COMBAT_PED(iLocal_59[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_PED_KEEP_TASK(iLocal_59[iVar1], true);
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_61[iVar1], 0))
					{
				...
				if (PED::IS_PED_INJURED(iLocal_59[iVar1]))
				{
					if (UI::DOES_BLIP_EXIST(iLocal_57[iVar1]))
					{
						UI::REMOVE_BLIP(&(iLocal_57[iVar1]));
					}
				}
				iVar1++;
			}
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_58))
			{
				...
				AI::OPEN_SEQUENCE_TASK(&iLocal_62);
				AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2056, 2);
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_58) && !ENTITY::IS_ENTITY_DEAD(iLocal_60, 0))
			{
				...
				AI::TASK_ENTER_VEHICLE(0, iLocal_60, -1, -1, 2f, 8, 0);
				AI::TASK_PAUSE(0, 2000);
				AI::TASK_PLAY_ANIM(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_60, 10f, 786603);
				AI::CLOSE_SEQUENCE_TASK(iLocal_62);
				AI::TASK_PERFORM_SEQUENCE(iLocal_58, iLocal_62);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
...
void func_40(int iParam0)
{
	...
	iVar0 = (GAMEPLAY::GET_GAME_TIMER() + iParam0);
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_58))
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 2060, 2);
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
					{
						if (func_56())
						{
							...
							{
								AI::OPEN_SEQUENCE_TASK(&iLocal_62);
								AI::TASK_OPEN_VEHICLE_DOOR(0, iLocal_60, -1, -1, 1f);
								AI::TASK_LOOK_AT_ENTITY(0, iLocal_59[2], 2000, 0, 2);
								AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_59[2], 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_62);
								AI::TASK_PERFORM_SEQUENCE(iLocal_58, iLocal_62);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
								func_40(2000);
				...
				while (iVar0 < iLocal_59)
				{
					if (!PED::IS_PED_INJURED(iLocal_59[iVar0]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_61[iVar0], 0))
						{
							...
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_59[iVar0], iLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
...
int func_56()
{
	...
	if (((((((!ENTITY::DOES_ENTITY_EXIST(iLocal_61[2]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_61[3])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_61[4])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_61[5])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[2])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[3])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[4])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[5]))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("hexer")))
		{
			...
			iLocal_55 = GAMEPLAY::GET_GAME_TIMER() + 1500;
		}
		if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			...
			while (iVar0 < iLocal_59)
			{
				if (!PED::IS_PED_INJURED(iLocal_59[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_61[iVar0], 0))
				{
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_61[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					...
					AI::OPEN_SEQUENCE_TASK(&iLocal_62);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_48, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(iLocal_62);
					AI::TASK_PERFORM_SEQUENCE(iLocal_59[2], iLocal_62);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
					AI::OPEN_SEQUENCE_TASK(&iLocal_62);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_48, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(iLocal_62);
					AI::TASK_PERFORM_SEQUENCE(iLocal_59[3], iLocal_62);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
					PED::SET_PED_KEEP_TASK(iLocal_59[3], true);
					AI::OPEN_SEQUENCE_TASK(&iLocal_62);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_48, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(iLocal_62);
					AI::TASK_PERFORM_SEQUENCE(iLocal_59[4], iLocal_62);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
					AI::OPEN_SEQUENCE_TASK(&iLocal_62);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_48, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(iLocal_62);
					AI::TASK_PERFORM_SEQUENCE(iLocal_59[5], iLocal_62);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_62);
				}
				iVar0++;
			}
...
void func_58()
{
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		AI::TASK_SMART_FLEE_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_58, true);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_59[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[1], 0))
		{
			ENTITY::SET_ENTITY_HEALTH(iLocal_58, 101, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_58, false);
			AI::TASK_SHOOT_AT_ENTITY(iLocal_59[0], iLocal_58, 1000, 0);
			AI::TASK_SHOOT_AT_ENTITY(iLocal_59[1], iLocal_58, 1000, 0);
		}
		else
		{
			func_4();
		...
		case 3:
			if ((!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_59[0])) && !PED::IS_PED_INJURED(iLocal_59[1]))
			{
				...
				if (SYSTEM::TIMERA() < 28000)
				{
					...
					{
						if (((PED::_0x6CD5A433374D4CFB(iLocal_59[0], PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_59[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[1], PLAYER::PLAYER_PED_ID()))
						{
							AI::TASK_LOOK_AT_ENTITY(iLocal_59[0], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
							AI::TASK_LOOK_AT_ENTITY(iLocal_59[1], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
							if (!iLocal_53)
							{
								func_4();
								func_40(0);
					...
					else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						...
						{
							AI::TASK_AIM_GUN_AT_ENTITY(iLocal_59[0], iLocal_58, -1, 0);
						}
					}
				}
		...
		case 4:
			...
			while (iVar0 < iLocal_59)
			{
				if (!PED::IS_PED_INJURED(iLocal_59[iVar0]))
				{
					...
					AI::TASK_COMBAT_PED(iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_59[iVar0], true);
				}
				iVar0++;
			}
...
int func_68()
{
	switch (func_69(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_75(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_76(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_76(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_77()
{
	...
	if (!bLocal_51)
	{
		...
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_59[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			...
			if (((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar1, vVar0, joaat("weapon_smokegrenade"), 1) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar1, vVar0, joaat("weapon_grenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar1, vVar0, joaat("weapon_grenadelauncher"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar1, vVar0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
		...
		if ((!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_59[0])) && !PED::IS_PED_INJURED(iLocal_59[1]))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((PED::_0x6CD5A433374D4CFB(iLocal_59[0], PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_59[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_59[1], PLAYER::PLAYER_PED_ID()))
				{
					if (!iLocal_50)
					{
						AI::TASK_AIM_GUN_AT_ENTITY(iLocal_59[0], PLAYER::PLAYER_PED_ID(), -1, 0);
						iLocal_50 = 1;
					}
					if (UI::DOES_BLIP_EXIST(iLocal_56))
					{
					...
					if (UI::DOES_BLIP_EXIST(iLocal_57[0]))
					{
						UI::_0x75A16C3DA34F1245(iLocal_57[0], true);
					}
					if (UI::DOES_BLIP_EXIST(iLocal_57[1]))
					{
						UI::_0x75A16C3DA34F1245(iLocal_57[1], true);
					}
					if ((!func_8() || func_6("RECGF_SHUTUP")) || func_6("RECGF_PAYUP"))
					{
						if (iLocal_47 == -1)
						{
							iLocal_47 = GAMEPLAY::GET_GAME_TIMER();
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								func_4();
								func_40(0);
			...
			if (iLocal_47 != -1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_47 + 10000)
			{
				func_4();
				func_40(0);
...
int func_79()
{
	...
	if (((((!ENTITY::DOES_ENTITY_EXIST(iLocal_58) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[1])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_60)) && !ENTITY::DOES_ENTITY_EXIST(iLocal_61[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_61[1]))
	{
		...
		if (((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("picador"))) && STREAMING::HAS_MODEL_LOADED(joaat("hexer"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight")) && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades")) && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("hexer"));
			AI::TASK_PLAY_ANIM(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(iLocal_59[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0f, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (iVar0 < 2)
...
int func_93()
{
	if ((Global_106059 == func_37() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_112(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_115()
{
	...
	func_121(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_120(&uVar0, TIME::GET_CLOCK_MINUTES());
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_132()) || Global_105117) || Global_25461) || func_131()) || func_50(8, -1)) || func_130()) || func_129()) || func_128()) || func_127()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_132()) || Global_25461) || func_131()) || func_50(8, -1)) || func_128()) || func_130()) || func_129()) || func_127()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_132()) || Global_105117) || Global_25461) || func_131()) || func_50(8, -1)) || func_130()) || func_129()) || func_127()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_132() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_50(8, -1)) || func_127()) || func_126()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_132()) || Global_25461) || func_131()) || func_50(8, -1)) || func_129()) || func_128()) || func_127()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_132()) || func_129()) || Global_105117) || Global_25461) || func_131()) || Global_37271) || func_50(8, -1)) || func_128()) || func_126()) || func_127()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_132()) || Global_105117) || Global_25461) || func_131()) || func_50(8, -1)) || func_128()) || func_126()) || func_130()) || func_129()) || func_127())
						{
							return 0;
						}
						break;
