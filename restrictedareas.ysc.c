						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_29(iLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY(&Local_48)) == 0)
									{
										if (!Global_25673[iLocal_37])
										{
											func_26(iLocal_37, Global_25673[iLocal_37]);
										}
									}
								}
								else if (!Global_25673[iLocal_37])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_40)
										{
											...
											{
												if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_49[iLocal_46]) > 8000)
												{
													func_18();
												}
												else if (GAMEPLAY::IS_PROJECTILE_IN_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) + Vector(200f, 200f, 200f), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) - Vector(200f, 200f, 200f), 1))
												{
													func_18();
												}
												else if (iLocal_37 != 4)
											...
											{
												iLocal_49[iLocal_46] = GAMEPLAY::GET_GAME_TIMER();
											}
										}
									}
									else
									{
										...
										if (!bLocal_40)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_37, 0, 0))
											{
												if (!iLocal_37 == 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_49[iLocal_46]) > 8000)
												{
													func_18();
												}
											}
...
void func_18()
{
	switch (iLocal_46)
	{
		...
		case 1:
			if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::IS_PROJECTILE_IN_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) + Vector(200f, 200f, 200f), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) - Vector(200f, 200f, 200f), 1))
			{
				iLocal_47 = 5;
			}
			else
