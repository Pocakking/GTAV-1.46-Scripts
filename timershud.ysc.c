							...
							if (func_218(iVar6))
							{
								if (Global_1368245.f_1324[iVar6 /*11*/][iVar0] == iVar1 + 3 || Global_1368245.f_1180[iVar6 /*11*/][iVar0] == 1)
								{
									if (func_214(Global_1368245.f_1180[iVar6 /*11*/][iVar0]))
									{
										...
										{
											GRAPHICS::_SET_SCREEN_DRAW_POSITION(82, iVar5);
											GRAPHICS::_SCREEN_DRAW_POSITION_RATIO(fLocal_96, fLocal_97, fLocal_98, fLocal_99);
										}
...
void func_42(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, var uParam23, bool bParam24, int iParam25, int iParam26, int iParam27, int iParam28, int iParam29, int iParam30, bool bParam31, int iParam32, int iParam33, var uParam34, int iParam35, int iParam36)
{
	...
	if (func_105())
	{
		...
		if (iParam5 < 1000000)
		{
			if ((unk_0x346268472B5F4E43() == 8 && fParam6 >= 100f) && GAMEPLAY::ARE_STRINGS_EQUAL("AMCH_KMHN", sParam7))
			{
		...
		else if (unk_0x346268472B5F4E43() == 8 && (GAMEPLAY::ARE_STRINGS_EQUAL("HUD_CASH", sParam7) || GAMEPLAY::ARE_STRINGS_EQUAL("HUD_CASH_NEG", sParam7)))
		{
			func_102(uParam2, 0, 0);
		}
		else
...
void func_44(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (!func_55(sVar0))
	{
		if (func_47())
		{
			...
			UI::_ADD_TEXT_COMPONENT_SUBSTRING_CASH(iParam3, 1);
...
void func_61(int iParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, int iParam5, char* sParam6, char* sParam7, int iParam8)
{
	...
	{
		UI::GET_HUD_COLOUR(2, &iVar0, &iVar1, &iVar2, &uVar3);
...
{
	GAMEPLAY::SET_BIT(&(Global_1369750.f_6158[iParam0]), iParam1);
}
...
void func_98(var uParam0)
{
	...
	if (((unk_0x346268472B5F4E43() == 7 && unk_0x346268472B5F4E43() == 1) && !GRAPHICS::GET_IS_WIDESCREEN()) && Global_1369750.f_1090)
	{
		fVar0 = (fVar0 + -0.007f);
	}
	...
	if (((((((((unk_0x346268472B5F4E43() == 8 || unk_0x346268472B5F4E43() == 7) || unk_0x346268472B5F4E43() == 1) && Global_1369750.f_1089 == 0) && Global_1369750.f_1088 == 0) && Global_1369750.f_1081 == 0) && Global_1369750.f_1090 == 0) && Global_1369750.f_1091 == 0) && Global_1369750.f_1092 == 0) && GAMEPLAY::IS_PC_VERSION())
	{
		fVar0 = (fVar0 + -0.005f);
	}
	uParam0->f_9 = fVar0;
...
void func_121(var uParam0, int iParam1)
{
	...
	UI::GET_HUD_COLOUR(iParam1, &uVar1, &uVar2, &uVar3, &uVar4);
	Var0.f_4 = uVar1;
	Var0.f_5 = uVar2;
	Var0.f_6 = uVar3;
	Var0.f_7 = uVar4;
...
void func_163(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, bool bParam11, char* sParam12, int iParam13, float fParam14, int iParam15, int iParam16, int iParam17, bool bParam18, int iParam19, bool bParam20, int iParam21, int iParam22, bool bParam23, int iParam24, int iParam25, bool bParam26, int iParam27, bool bParam28, bool bParam29, int iParam30)
{
	...
	if (func_105())
	{
		...
		if (iParam5 < 1000000)
		{
			if ((unk_0x346268472B5F4E43() == 8 && fParam14 >= 100f) && GAMEPLAY::ARE_STRINGS_EQUAL("AMCH_KMHN", sParam12))
			{
				func_102(uParam2, 0, 0);
			}
		...
		else if (unk_0x346268472B5F4E43() == 8 && (GAMEPLAY::ARE_STRINGS_EQUAL("HUD_CASH", sParam12) || GAMEPLAY::ARE_STRINGS_EQUAL("HUD_CASH_NEG", sParam12)))
		{
			func_102(uParam2, 0, 0);
		}
		else
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			if (bParam18)
			{
				...
				if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("CommonMenu"))
				{
					...
					if (bParam11 == 1)
					{
						...
						fVar12 = UI::_GET_TEXT_SCREEN_WIDTH(1);
					}
					else
					{
						UI::_SET_TEXT_ENTRY_FOR_WIDTH(sParam7);
						fVar12 = UI::_GET_TEXT_SCREEN_WIDTH(1);
					}
			...
			if (bVar4)
			{
				if (iParam21 != 0)
				{
					...
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar21))
					{
