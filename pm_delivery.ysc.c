...
void func_7()
{
	...
	iVar0 = (iLocal_74 - GAMEPLAY::GET_GAME_TIMER());
	if (iVar0 < 0)
	{
		iVar0 = 0;
	}
	if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_78)
	{
	...
	{
		case 0:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 10000))
			{
		...
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 9000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 8000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 7000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 4:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 6000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 5000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 6:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 4500))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 4000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 8:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 3500))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 9:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 3000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 10:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 2500))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 11:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 2000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 12:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 1500))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 13:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 1000))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 14:
			if (GAMEPLAY::GET_GAME_TIMER() >= (iLocal_74 - 500))
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", true);
				iLocal_75++;
			}
		...
		case 15:
			if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_74)
			{
...
void func_9()
{
	...
	if (iLocal_36 >= 3 && iLocal_36 <= 4)
	{
		...
		while (iVar0 < iLocal_85)
		{
			...
			else if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_85[iVar0]))
				{
					AI::TASK_SMART_FLEE_PED(iLocal_85[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	...
	while (iVar1 < iLocal_84)
	{
		...
		{
			if (!UI::DOES_BLIP_EXIST(uLocal_89[iVar1]))
			{
				uLocal_89[iVar1] = func_10(iLocal_84[iVar1], 1, 145);
				AI::OPEN_SEQUENCE_TASK(&iLocal_108);
				AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				AI::CLOSE_SEQUENCE_TASK(iLocal_108);
				AI::TASK_PERFORM_SEQUENCE(iLocal_84[iVar1], iLocal_108);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_108);
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84[iVar1], PLAYER::PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
			{
				if (UI::DOES_BLIP_EXIST(uLocal_89[iVar1]))
				{
					UI::REMOVE_BLIP(&(uLocal_89[iVar1]));
				}
				AI::TASK_SMART_FLEE_PED(iLocal_84[iVar1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_84[iVar1], true);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_84[iVar1]));
			}
		}
		else if (UI::DOES_BLIP_EXIST(uLocal_89[iVar1]))
		{
			UI::REMOVE_BLIP(&(uLocal_89[iVar1]));
		}
		iVar1++;
...
int func_24(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_25(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_25(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
void func_65()
{
	...
	if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_86, 0))
	{
		...
		if (iLocal_36 <= 2)
		{
			iLocal_74 = (TIME::GET_MILLISECONDS_PER_GAME_MINUTE() * ((60 * iLocal_76) + iLocal_77));
			iLocal_74 = (iLocal_74 + GAMEPLAY::GET_GAME_TIMER());
			iLocal_78 = (iLocal_74 - TIME::GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
		}
		else if (iLocal_36 > 6)
		{
			iLocal_74 = (TIME::GET_MILLISECONDS_PER_GAME_MINUTE() * ((60 * iLocal_76) + iLocal_77));
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_86, 0))
	{
		if (func_101() || PED::IS_PED_INJURED(iLocal_84[0]))
		{
			...
			while (iVar0 < iLocal_84)
			{
				...
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_89[iVar0]))
					{
						...
						AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::CLOSE_SEQUENCE_TASK(iLocal_108);
						AI::TASK_PERFORM_SEQUENCE(iLocal_84[iVar0], iLocal_108);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_108);
					}
				}
				else if (UI::DOES_BLIP_EXIST(uLocal_89[iVar0]))
				{
					UI::REMOVE_BLIP(&(uLocal_89[iVar0]));
				}
				iVar0++;
			}
		}
		else if (!iLocal_73)
		{
			if (!PED::IS_PED_INJURED(iLocal_84[0]))
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_84[0], iLocal_86, PLAYER::PLAYER_PED_ID(), 8, 25f, 786469, -1f, -1f, 1);
					iLocal_73 = 1;
				}
			}
		}
...
int func_77(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_85() || func_84(Global_4456448.f_152990)) || func_83())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_81(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_102()
{
	...
	if (iLocal_36 != 5 && iLocal_36 != 6)
	{
		if (iLocal_36 > 6)
		{
			...
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "BAR_DELIVER_BOOZE_RATTLE_MASTER", iLocal_86, 0, 0, 0);
		}
	...
	else
	{
		...
		AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_84[0], iLocal_86, 25f, 786599);
...
int func_104(int iParam0)
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_104780.f_222[iParam0], true, 1);
...
int func_105()
{
	...
	if (PED::IS_PED_INJURED(iLocal_84[0]))
	{
		if (UI::DOES_BLIP_EXIST(uLocal_89[0]))
		{
			UI::REMOVE_BLIP(&(uLocal_89[0]));
		}
	}
	return 0;
}
...
void func_106()
{
	...
	if (STREAMING::HAS_MODEL_LOADED(iLocal_82) && UI::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (iLocal_36 >= 3 && iLocal_36 <= 4)
		{
...
void func_107()
{
	...
	else if (func_111() == 14)
	{
		...
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_64, vLocal_65, true);
