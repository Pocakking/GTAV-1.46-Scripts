...
void func_8()
{
	switch (iLocal_1953)
	{
		case 0:
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Local_53[0 /*2*/], 0, 0, 0, 1, 0, 0, 0, 0);
			}
			VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_53[0 /*2*/], 0);
			VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_53[1 /*2*/], 0);
		...
		case 1:
			...
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), 1) > 400f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_53[0 /*2*/]))
				{
					func_87(9);
				}
			}
			...
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], PLAYER::GET_PLAYERS_LAST_VEHICLE()) || ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[2 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_54[3 /*10*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)))
			{
				...
				if (UI::DOES_BLIP_EXIST(Local_58.f_5))
				{
					UI::_0xC4278F70131BAA6D(Local_58.f_5, 1);
				}
				if (UI::DOES_BLIP_EXIST(iLocal_243))
				{
					UI::REMOVE_BLIP(&iLocal_243);
				}
				if (iLocal_255)
				{
					UI::CLEAR_PRINTS();
		...
		case 2:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_12(&uLocal_78, "DHP1AUD", "DHP1_END", 7, 0, 0, 0))
				{
					...
					AI::TASK_LOOK_AT_ENTITY(Local_54[3 /*10*/], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					AI::OPEN_SEQUENCE_TASK(&uLocal_244);
					...
					AI::CLOSE_SEQUENCE_TASK(uLocal_244);
					AI::TASK_PERFORM_SEQUENCE(Local_54[3 /*10*/], uLocal_244);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					iLocal_1953++;
				}
			}
			else if ((!iLocal_252 && func_30()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_301) > 3000)
			{
		...
		case 3:
			if (!func_11())
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[3 /*10*/]);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					AI::OPEN_SEQUENCE_TASK(&uLocal_244);
					AI::TASK_ENTER_VEHICLE(0, Local_53[3 /*2*/], -1, -1, 2f, 1, 0);
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_53[3 /*2*/], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, 1);
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_53[3 /*2*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_244);
					AI::TASK_PERFORM_SEQUENCE(Local_54[3 /*10*/], uLocal_244);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
				}
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[3 /*10*/]);
					AI::TASK_SMART_FLEE_COORD(Local_54[3 /*10*/], vLocal_52, 300f, -1, 0, 0);
				}
				iLocal_301 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_1953++;
			}
		...
		case 4:
			if (func_10(Local_54[3 /*10*/], PLAYER::PLAYER_PED_ID(), 1) > 70f || (GAMEPLAY::GET_GAME_TIMER() - iLocal_301) > 20000)
			{
...
int func_33(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_34(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_34(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_45(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_46(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_46(1, 0, 1) || GAMEPLAY::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
void func_64(var uParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!GAMEPLAY::IS_STRING_NULL(sParam1))
...
void func_132(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_134(Var7.f_1)) && iVar9 < 50)
			{
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_172(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_189()
{
	...
	switch (iLocal_1953)
	{
		...
		case 2:
				...
				switch (iLocal_262)
				{
					case 0:
						if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
						{
							if (iLocal_261 == -1)
							{
								iLocal_261 = GAMEPLAY::GET_GAME_TIMER() + 5000;
							}
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_261)
							{
			...
			if (func_101(Local_54[6 /*10*/]))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[6 /*10*/]);
			...
			if (func_101(Local_54[7 /*10*/]))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[7 /*10*/]);
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
			...
			if (func_101(Local_54[5 /*10*/]))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_54[5 /*10*/]);
					func_9(&(Local_54[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_220(&Local_58, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((UI::DOES_BLIP_EXIST(Local_58.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, true, 0)) && func_212(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/])))
			{
			...
			else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0 && UI::DOES_BLIP_EXIST(Local_58.f_5))
			{
	...
	if (UI::DOES_BLIP_EXIST(Local_58.f_5))
	{
		UI::SET_BLIP_ROUTE(Local_58.f_5, false);
	}
	if (func_101(PLAYER::PLAYER_PED_ID()) && func_101(Local_53[0 /*2*/]))
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 324.7653f, -2974.495f, -1f, 1) > 2500f)
		{
			func_87(9);
		}
	}
...
int func_194()
{
	...
	switch (iLocal_275)
	{
		case 0:
			...
			iLocal_245 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_pls_sub_water_drips", Local_53[0 /*2*/], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
		...
		case 3:
			if (fLocal_283 >= 40f)
			{
				...
				iLocal_1959 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_275++;
			}
			else
			{
		...
		case 4:
			...
			{
				fVar0 = (1f - func_198((SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_1959 + 1500)) / 3000f), 0f, 1f));
		...
		case 6:
			...
			{
				iLocal_1959 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_275++;
			}
			break;
		
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_1959)
			{
...
void func_203()
{
	if (iLocal_248)
	{
		ROPE::DELETE_ROPE(&(Local_55[0 /*5*/]));
		ROPE::DELETE_ROPE(&(Local_55[1 /*5*/]));
		ROPE::DELETE_ROPE(&(Local_55[2 /*5*/]));
		ROPE::DELETE_ROPE(&(Local_55[3 /*5*/]));
		iLocal_248 = 0;
	}
}
...
int func_216()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[8 /*2*/]))
	{
		...
		ENTITY::_SET_ENTITY_REGISTER(Local_57[8 /*2*/], 0);
	...
	if (!iLocal_249)
	{
		...
		{
			iLocal_290 = ROPE::ADD_ROPE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[7 /*2*/], vLocal_288), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, 0, 0, 1, 1f, 0, 0);
			ROPE::_0x36CCB9BE67B970FD(iLocal_290, 1);
			ROPE::_0xDC57A637A20006ED(iLocal_290, 2);
			ROPE::ROPE_DRAW_SHADOW_ENABLED(&iLocal_290, 0);
			ROPE::ATTACH_ENTITIES_TO_ROPE(iLocal_290, Local_57[7 /*2*/], Local_57[8 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[7 /*2*/], vLocal_288), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[8 /*2*/], vLocal_289), 70f, 0, 0, 0, 0);
			iLocal_249 = 1;
			return 1;
		}
...
void func_223()
{
	...
	switch (iLocal_1953)
	{
		case 0:
			...
			if (func_101(Local_53[0 /*2*/]))
			{
				if (!UI::DOES_BLIP_EXIST(Local_53[0 /*2*/].f_1))
				{
					Local_53[0 /*2*/].f_1 = func_32(Local_53[0 /*2*/], 0, 0);
				}
				vLocal_56 = { ROPE::GET_CGOFFSET(Local_53[0 /*2*/]) };
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_57[2 /*2*/]) && !UI::DOES_BLIP_EXIST(iLocal_243))
			{
				iLocal_243 = func_271(Local_57[2 /*2*/]);
			}
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_243, "SUBBTN_LABEL");
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_54[4 /*10*/], 0);
			}
		...
		case 1:
			if (iLocal_248)
			{
				if (((!ROPE::_0x84DE3B5FB3E666F0(&(Local_55[0 /*5*/])) && !ROPE::_0x84DE3B5FB3E666F0(&(Local_55[1 /*5*/]))) && !ROPE::_0x84DE3B5FB3E666F0(&(Local_55[2 /*5*/]))) && !ROPE::_0x84DE3B5FB3E666F0(&(Local_55[3 /*5*/])))
				{
					ROPE::ROPE_CONVERT_TO_SIMPLE(Local_57[0 /*2*/]);
					ROPE::ROPE_CONVERT_TO_SIMPLE(Local_57[1 /*2*/]);
					if (func_101(Local_53[0 /*2*/]))
					{
						ROPE::SET_CGOFFSET(Local_53[0 /*2*/], vLocal_56);
					}
					if (UI::DOES_BLIP_EXIST(iLocal_243))
					{
						UI::REMOVE_BLIP(&iLocal_243);
				...
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && !func_207(0))
				{
					if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						{
							AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_246, cLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_246, cLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
		...
		case 2:
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_246) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_246) == 1f)
			{
				...
				ROPE::DETACH_ROPE_FROM_ENTITY(Local_55[0 /*5*/], Local_53[0 /*2*/]);
				ROPE::DETACH_ROPE_FROM_ENTITY(Local_55[1 /*5*/], Local_53[0 /*2*/]);
				ROPE::DETACH_ROPE_FROM_ENTITY(Local_55[2 /*5*/], Local_53[0 /*2*/]);
				ROPE::DETACH_ROPE_FROM_ENTITY(Local_55[3 /*5*/], Local_53[0 /*2*/]);
				ROPE::ROPE_CONVERT_TO_SIMPLE(Local_57[0 /*2*/]);
				ROPE::ROPE_CONVERT_TO_SIMPLE(Local_57[1 /*2*/]);
				if (func_101(Local_53[0 /*2*/]))
				{
					ROPE::SET_CGOFFSET(Local_53[0 /*2*/], vLocal_56);
					ROPE::ACTIVATE_PHYSICS(Local_53[0 /*2*/]);
				}
				iLocal_301 = GAMEPLAY::GET_GAME_TIMER();
				AUDIO::TRIGGER_MUSIC_EVENT("DHP1_RELEASED");
				UI::CLEAR_HELP(1);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_246) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_246) >= 0.7f)
			{
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1252.594f, -3008.883f, 8.3191f, 1f, -1, 0.25f, 0, 40000f);
				}
			}
			break;
		
		case 3:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_301) > 1500)
			{
				if (iLocal_294)
				{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_301) > 5000 || CONTROLS::IS_CONTROL_JUST_PRESSED(2, 201))
				{
					if (UI::DOES_BLIP_EXIST(iLocal_243))
					{
						UI::REMOVE_BLIP(&iLocal_243);
		...
		case 5:
			...
			{
				ROPE::DELETE_CHILD_ROPE(Local_55[0 /*5*/]);
				ROPE::DELETE_CHILD_ROPE(Local_55[1 /*5*/]);
				ROPE::DELETE_CHILD_ROPE(Local_55[2 /*5*/]);
				ROPE::DELETE_CHILD_ROPE(Local_55[3 /*5*/]);
				if (iLocal_1962[0] != -1)
				{
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0))
			{
				...
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
				{
					...
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					AI::OPEN_SEQUENCE_TASK(&uLocal_244);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					AI::CLOSE_SEQUENCE_TASK(uLocal_244);
					AI::TASK_PERFORM_SEQUENCE(Local_54[6 /*10*/], uLocal_244);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					...
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					AI::OPEN_SEQUENCE_TASK(&uLocal_244);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.056f, -3006.94f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					AI::CLOSE_SEQUENCE_TASK(uLocal_244);
					AI::TASK_PERFORM_SEQUENCE(Local_54[7 /*10*/], uLocal_244);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
				...
				else
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_SMART_FLEE_COORD(0, 1252.876f, -3014.035f, 8.31909f, 300f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_244);
					AI::TASK_PERFORM_SEQUENCE(Local_54[5 /*10*/], uLocal_244);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
					func_83(&uLocal_309, joaat("s_m_m_security_01"));
				}
				if (func_101(Local_54[4 /*10*/]))
				...
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_54[4 /*10*/], 1);
				AUDIO::STOP_PED_SPEAKING(Local_54[4 /*10*/], 1);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
				AI::OPEN_SEQUENCE_TASK(&uLocal_244);
				AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.994f, -3004.134f, 9.319f, 2f, 20000, 0.25f, 0, 40000f);
				AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_f", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_h", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_f", 1.5f, -1.5f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_SMART_FLEE_COORD(0, 1252.994f, -3004.134f, 9.319f, 300f, -1, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_244);
				AI::TASK_PERFORM_SEQUENCE(Local_54[4 /*10*/], uLocal_244);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_244);
				...
				if (UI::DOES_BLIP_EXIST(Local_53[0 /*2*/].f_1))
				{
					UI::REMOVE_BLIP(&(Local_53[0 /*2*/].f_1));
				}
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), 1) < 5f && !iLocal_253)
			{
	...
	if (((!iLocal_248 && ENTITY::DOES_ENTITY_EXIST(Local_57[0 /*2*/])) && ENTITY::DOES_ENTITY_EXIST(Local_57[1 /*2*/])) && func_101(Local_53[0 /*2*/]))
	{
		...
		{
			ROPE::SET_CG_AT_BOUNDCENTER(Local_53[0 /*2*/]);
			Local_55[0 /*5*/] = ROPE::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_1958, 1, fLocal_1958, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ROPE::ATTACH_ENTITIES_TO_ROPE(Local_55[0 /*5*/], Local_57[0 /*2*/], Local_53[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_53[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_1958, 0, 0, 0, 0);
			Local_55[1 /*5*/] = ROPE::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_1958, 1, fLocal_1958, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ROPE::ATTACH_ENTITIES_TO_ROPE(Local_55[1 /*5*/], Local_57[0 /*2*/], Local_53[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_53[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_1958, 0, 0, 0, 0);
			Local_55[2 /*5*/] = ROPE::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_1958, 1, fLocal_1958, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ROPE::ATTACH_ENTITIES_TO_ROPE(Local_55[2 /*5*/], Local_57[1 /*2*/], Local_53[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_53[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_1958, 0, 0, 0, 0);
			Local_55[3 /*5*/] = ROPE::ADD_ROPE(1260.752f, -3004.994f, 22.68315f, 0f, 0f, 0f, fLocal_1958, 1, fLocal_1958, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ROPE::ATTACH_ENTITIES_TO_ROPE(Local_55[3 /*5*/], Local_57[1 /*2*/], Local_53[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_57[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_53[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_1958, 0, 0, 0, 0);
			iLocal_248 = 1;
			iLocal_250 = 0;
			ROPE::ACTIVATE_PHYSICS(Local_53[0 /*2*/]);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_57[3 /*2*/]) && ((func_101(Local_54[4 /*10*/]) && PED::IS_PED_FLEEING(Local_54[4 /*10*/])) || !func_101(Local_54[4 /*10*/])))
	{
		...
		{
			AI::STOP_ANIM_TASK(Local_54[4 /*10*/], cLocal_50, "cellphone_call_listen_c", -8f);
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_254(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_251(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_264()
{
	...
	{
		if (!ROPE::_0x84DE3B5FB3E666F0(&(Local_55[iLocal_247 /*5*/])))
		{
	...
	if (bVar1)
	{
		if (((((!ROPE::_0x84DE3B5FB3E666F0(&(Local_55[0 /*5*/])) && !ROPE::_0x84DE3B5FB3E666F0(&(Local_55[1 /*5*/]))) && (!Local_55[0 /*5*/].f_4 || !Local_55[1 /*5*/].f_4)) || ((!ROPE::_0x84DE3B5FB3E666F0(&(Local_55[2 /*5*/])) && !ROPE::_0x84DE3B5FB3E666F0(&(Local_55[3 /*5*/]))) && (!Local_55[2 /*5*/].f_4 || !Local_55[3 /*5*/].f_4))) || iVar0 == 3) && iVar0 < 4)
		{
			if (iLocal_1963 > 0)
			{
...
void func_272()
{
	...
	while (iLocal_247 <= (8 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_54[iLocal_247 /*10*/]))
		{
			if (Local_54[iLocal_247 /*10*/] != Local_54[3 /*10*/])
			{
				...
				else if (UI::DOES_BLIP_EXIST(Local_54[iLocal_247 /*10*/].f_2))
				{
					UI::REMOVE_BLIP(&(Local_54[iLocal_247 /*10*/].f_2));
				}
			}
	...
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), 1) > 750f)
		{
			func_87(10);
		}
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), 1) > 700f)
		{
	...
	switch (iLocal_264)
	{
		case 0:
			if (func_101(Local_54[4 /*10*/]))
			{
				if (iLocal_269)
				{
					AI::TASK_PLAY_ANIM(Local_54[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, 0, 0, 0);
					if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
					{
						AI::TASK_FOLLOW_WAYPOINT_RECORDING(Local_54[4 /*10*/], "docksprep1", 0, 8, -1);
					}
					else
					{
		...
		case 1:
			if (!iLocal_269)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_268) > 2000 || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], true), 1) < 10f)
				{
					iLocal_269 = 1;
					iLocal_264 = 0;
				}
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0))
			{
				if (func_101(Local_54[4 /*10*/]))
				{
					if (PED::_0x6CD5A433374D4CFB(Local_54[4 /*10*/], PLAYER::PLAYER_PED_ID()))
					{
						AI::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
					...
					else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], true), 1) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f)
					{
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_54[4 /*10*/]);
						if (!func_277(Local_54[4 /*10*/], 1464580341, 1))
						{
							AI::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
							AI::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0f, 0, 0, 0);
						}
					}
					else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], true), 1) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!func_277(Local_54[4 /*10*/], 1464580341, 1))
						{
							AI::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
					...
					else if (((WEAPON::SET_WEAPON_SMOKEGRENADE_ASSIGNED(PLAYER::PLAYER_PED_ID()) && (TIME::GET_CLOCK_HOURS() >= 19 || TIME::GET_CLOCK_HOURS() < 6)) && func_10(PLAYER::PLAYER_PED_ID(), Local_54[4 /*10*/], 1) < 25f) && (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/])))
					{
						if (!func_277(Local_54[4 /*10*/], 1464580341, 1))
						{
							AI::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
				...
				if (iLocal_1953 > 1)
				{
					if (func_101(Local_54[4 /*10*/]))
					{
						if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(Local_54[4 /*10*/], Local_53[0 /*2*/]))
						{
							...
							iLocal_264 = 3;
							iLocal_266 = 3;
							AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_54[4 /*10*/]);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_54[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, -1, 0.25f, 0, -122.93f);
							iLocal_268 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_269 = 0;
						}
					}
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_54[4 /*10*/]))
				{
					if (iLocal_269)
					{
						if ((AI::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 713668775) != 1) && AI::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 1464580341) != 1)
						{
							...
							if (ENTITY::IS_ENTITY_AT_COORD(Local_54[4 /*10*/], 1228.056f, -3000.427f, 8.4424f, 2f, 2f, 2f, 0, true, 0))
							{
								if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
								{
									AI::TASK_FOLLOW_WAYPOINT_RECORDING(Local_54[4 /*10*/], "docksprep1", 0, 0, -1);
								}
							}
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_272) > 10000)
					{
						if (!AI::WAYPOINT_PLAYBACK_GET_IS_PAUSED(Local_54[4 /*10*/]))
						{
							if (ENTITY::IS_ENTITY_AT_COORD(Local_54[4 /*10*/], 1251.625f, -3003.338f, 8.31909f, 2f, 2f, 2f, 0, true, 0))
							{
								AI::WAYPOINT_PLAYBACK_PAUSE(Local_54[4 /*10*/], 0, 0);
							}
						...
						else
						{
							...
							AI::WAYPOINT_PLAYBACK_RESUME(Local_54[4 /*10*/], 1, -1, 3000);
						}
					}
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_54[4 /*10*/]) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_273) > 4000)
					{
				...
				if (((PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 122) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 123)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 124)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 116))
				{
					...
					iLocal_264 = 3;
					iLocal_266 = 1;
					AI::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0f, 0, 0, 0);
					AI::TASK_HANDS_UP(Local_54[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
				}
		...
		case 2:
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(Local_54[4 /*10*/], PLAYER::PLAYER_PED_ID(), -1, 3104, 2);
				}
			}
			switch (iLocal_265)
			{
				...
				case 1:
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_267) > 4000)
					{
						if (func_101(Local_54[4 /*10*/]))
						{
				...
				case 2:
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_267) > 8000)
					{
						if (func_101(Local_54[4 /*10*/]))
						{
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				{
					if (WEAPON::GET_WEAPONTYPE_GROUP(iLocal_271) != -728555052 && iLocal_271 != joaat("weapon_unarmed"))
					{
						func_218(&uLocal_78, 3, Local_54[4 /*10*/], "CONSTRUCTION2", 0, 1);
						iLocal_264 = 3;
						iLocal_266 = 1;
						AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_54[4 /*10*/]);
						AI::TASK_HANDS_UP(Local_54[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 23))
				{
			...
			switch (iLocal_266)
			{
				...
				case 3:
					if (func_101(Local_54[4 /*10*/]))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(Local_54[4 /*10*/], Local_53[0 /*2*/], -1, 2096, 2);
						}
					}
					else
					{
				...
				case 4:
					if (func_101(Local_54[4 /*10*/]))
					{
						if (!PED::IS_PED_RAGDOLL(Local_54[4 /*10*/]) && !AI::IS_PED_GETTING_UP(Local_54[4 /*10*/]))
						{
							if (func_12(&uLocal_78, "SOL1AUD", "SOL1_COPSIN2", 7, 0, 0, 0))
							{
								AI::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
								AI::OPEN_SEQUENCE_TASK(&uLocal_244);
								AI::TASK_PLAY_ANIM(0, cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, 0, 0, 0);
								if (iLocal_270)
								{
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
									AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
								else
								{
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 1f, 20000, 0.25f, 0, 40000f);
					...
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_267) > 8000)
					{
						...
						if (func_101(Local_54[4 /*10*/]))
						{
							if (iLocal_270)
							{
								...
								{
									AI::TASK_SMART_FLEE_PED(Local_54[4 /*10*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 923520851) != 1)
							{
								AI::TASK_WANDER_IN_AREA(Local_54[4 /*10*/], 1183.287f, -2947.87f, 4.8986f, 100f, 1077936128, 1086324736);
							}
						}
					}
					if (!iLocal_270)
...
void func_278()
{
	switch (iLocal_308)
	{
		case 0:
			switch (iLocal_307)
			{
				case 0:
					if (func_101(Local_53[0 /*2*/]))
					{
						if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							func_283();
							iLocal_305 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_307 = 1;
				...
				case 1:
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_305) > 6000 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0))
					{
						func_218(&uLocal_78, 1, 0, "FLOYD", 0, 1);
		...
		case 2:
			...
			{
				case 0:
					if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0)) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 324.7653f, -2974.495f, -1f, 1) < 110f)
					{
						func_283();
						iLocal_307 = 1;
					}
		...
		case 4:
			if (func_101(Local_53[2 /*2*/]) && func_101(Local_54[3 /*10*/]))
			{
				...
				{
					case 0:
						if (((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_54[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !UI::IS_MESSAGE_BEING_DISPLAYED())
						{
							func_283();
							iLocal_305 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_307 = 1;
					...
					case 1:
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_305) > 2000)
						{
							func_218(&uLocal_78, 1, Local_54[3 /*10*/], "FLOYD", 0, 1);
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), -323.73f, -2613.702f, 5f, 1) < 60f)
				{
					func_281();
					iLocal_307 = 3;
				}
		...
		case 6:
			...
			{
				case 0:
					if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_54[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], true), -323.73f, -2613.702f, 5f, 1) < 40f)
					{
						func_283();
						iLocal_307 = 1;
					}
...
void func_298()
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_53[0 /*2*/]))
	{
		...
		ENTITY::_SET_ENTITY_REGISTER(Local_53[0 /*2*/], 0);
		AUDIO::SET_VEHICLE_RADIO_ENABLED(Local_53[0 /*2*/], 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_54[4 /*10*/]))
	{
		...
		AI::TASK_PLAY_ANIM(Local_54[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0f, 0, 0, 0);
		PED::SET_PED_FLEE_ATTRIBUTES(Local_54[4 /*10*/], 512, 0);
		...
		while (iVar1 < uParam0->f_779)
		{
			if (uParam0->f_779[iVar1 /*5*/])
			{
				...
				if (uParam0->f_779[iVar1 /*5*/].f_2)
				{
					if (uParam0->f_779[iVar1 /*5*/].f_1)
					{
						UI::CLEAR_ADDITIONAL_TEXT(iVar1, true);
...
void func_306()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 300f, 1, 0, 0, false);
	}
	GAMEPLAY::CLEAR_AREA(1219.186f, -2977.9f, 4.8653f, 300f, 1, 0, 0, false);
	iLocal_268 = GAMEPLAY::GET_GAME_TIMER();
	iLocal_251 = 0;
	iLocal_269 = 0;
	iLocal_264 = 0;
...
void func_315()
{
	switch (iLocal_1951)
	{
		...
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1955) > 2500)
			{
				iLocal_1955 = GAMEPLAY::GET_GAME_TIMER();
			}
			break;
	}
}
...
void func_319()
{
	...
	PLAYER::_0xD2B315B6689D537D(PLAYER::PLAYER_ID(), false);
...
void func_324()
{
	...
	while (iLocal_247 <= (8 - 1))
	{
		...
		{
			func_314(&(Local_54[iLocal_247 /*10*/].f_2));
			if (UI::DOES_BLIP_EXIST(Local_54[iLocal_247 /*10*/].f_1))
			{
				UI::REMOVE_BLIP(&(Local_54[iLocal_247 /*10*/].f_1));
			}
	...
	while (iLocal_247 <= (4 - 1))
	{
		if (UI::DOES_BLIP_EXIST(Local_53[iLocal_247 /*2*/].f_1))
		{
			UI::REMOVE_BLIP(&(Local_53[iLocal_247 /*2*/].f_1));
		}
