...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("M_TBOR", 0);
	...
	switch (iLocal_92)
	{
		case 0:
			...
			else
			{
				...
				UI::CLEAR_HELP(1);
				func_28();
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_203))
				{
					func_26(sLocal_203);
				}
				else
...
void func_13(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_15(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
...
void func_51(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_52(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_63(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_63(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_63(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_95(iVar0);
						if (Global_71015 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_63(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_63(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_63(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_63(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_63(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_99(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_98(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_99(func_109(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_63(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_167(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_63(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_63(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_191(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2566070[iParam0 /*3*/][func_98(iParam1)];
		...
		case 6:
			if (bParam1)
			{
				...
				while (!CUTSCENE::HAS_CUTSCENE_LOADED())
				{
					if (CUTSCENE::_0xB56BBBCC2955D9CB())
					{
						CUTSCENE::_0x2A56C06EBEF2B0D9("Michael", PLAYER::PLAYER_PED_ID(), 0);
					}
					SYSTEM::WAIT(0);
				}
				bLocal_202 = false;
...
void func_205(float fParam0, float fParam1)
{
	if (func_8(Local_231) && func_451(Local_229))
	{
		...
		AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_229, Local_231, -1106.365f, -579.0142f, 31.1366f, fParam1, 0, 0, 36438053, 2f, 0.5f);
...
int func_222(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_204, "NONE") && GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_237, "NONE"))
			{
				return 1;
			}
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_204, 0);
		...
		case 7:
			AI::REQUEST_WAYPOINT_RECORDING("Sol1Roco1");
			if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Sol1Roco1"))
			{
				return 1;
			}
			break;
		...
		case 1:
			...
			if (iLocal_93 == 0 || iLocal_96 != 0)
			{
				...
				else
				{
					...
					if (iLocal_221 == 0)
					{
						UI::_0x3D3D15AF7BCAAF83(12, 1, 0);
						UI::_0xA905192A6781C41B(vLocal_211);
...
int func_237()
{
	switch (iLocal_96)
	{
		case 0:
			...
			AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), -1011.155f, -479.7716f, 38.97575f, 1f, -1, 40000f, 0.2f);
		...
		case 2:
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_214) > 4000)
			{
				iLocal_96 = 3;
			}
			break;
...
void func_245()
{
	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("SOL_2_CAR_CHASE"))
	{
		if (iLocal_91 == 2)
		{
			...
			{
				AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_231, "SOL_2_ROCCOS_CAR", 0);
	...
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_214) > 2000)
		{
			if (func_8(Local_231))
			{
				AUDIO::_0x18EB48CFC41F2EA0(Local_231, 0);
		...
		case 1:
			if (!iLocal_420)
			{
				if (!func_30())
				{
					if (iLocal_226 != -1)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_226) > 2000)
						{
			...
			{
				Var0 = { func_250() };
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sLocal_416))
				{
					iLocal_92 = 2;
				}
			}
...
void func_261(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_328(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_263(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_275(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_282(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_284(Var7.f_1)) && iVar9 < 50)
			{
...
int func_295(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_297() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_99(func_296(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_299(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_315(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_300(iVar0, 0), true);
...
var func_317()
{
	...
	func_327(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_326(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_325(&uVar0, TIME::GET_CLOCK_HOURS());
	func_320(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_319(&uVar0, TIME::GET_CLOCK_MONTH());
	func_318(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_323(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_340()
{
	...
	switch (iLocal_92)
	{
		...
		case 1:
			if (!func_30() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_214) > 3000)
			{
...
void func_341()
{
	...
	switch (iLocal_92)
	{
		case 0:
			if (func_195(iLocal_91, bLocal_202))
			{
				...
				if (func_399(0, &iLocal_421, "STOPROCCO", 1092616192, 7))
				{
					...
					UNK1::_0x293220DA1B46CEBC(1f, 10f, 4);
					iLocal_92 = 1;
				}
			}
			break;
		...
		case 2:
			if (iLocal_215 != -1)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_215) > 1000)
				{
					iLocal_92 = 0;
					iLocal_91 = 6;
				}
			...
			else
			{
				...
				if (func_241(&uLocal_97, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					if (!func_30())
					{
						iLocal_215 = GAMEPLAY::GET_GAME_TIMER();
...
int func_352(char* sParam0)
{
	if (!func_353(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_372(sParam0)) || func_372("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_353(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_360() || func_359(Global_4456448.f_152990)) || func_358())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_356(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_354(int iParam0)
{
	if (iParam0 != func_310())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_355(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_374()
{
	if (iLocal_227 != -1)
	{
		if (func_378() > 20f)
		{
			if (!func_30() && !UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (func_377(PLAYER::PLAYER_PED_ID(), Local_229, 30f, 1))
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_227) > 5000)
					{
						if (func_376())
						{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_227) > 12000)
					{
	...
	{
		iLocal_227 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
void func_381()
{
	if (func_451(Local_230))
	{
		...
		if (iLocal_95 != 3)
		{
			...
			{
				AI::TASK_COMBAT_PED(Local_230, PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		switch (iLocal_95)
		{
			...
			case 2:
				...
				{
					AI::TASK_DRIVE_BY(Local_230, PLAYER::PLAYER_PED_ID(), 0, vLocal_209, 35f, 65, 0, -753768974);
				}
				break;
...
void func_385()
{
	if (func_451(Local_229))
	{
		...
		{
			case 1:
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_214) > 250)
				{
					if (func_8(Local_231))
					{
			...
			case 3:
				if (func_8(Local_231))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_229, Local_231, 0))
					{
						if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_231))
						{
							if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_231) > 54)
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_229, Local_231, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 550f, 2f, 1);
			...
			case 5:
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(Local_229, 0, 0);
				}
				else
				{
...
void func_390(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	{
		ENTITY::FREEZE_ENTITY_POSITION(iParam0, false);
		if (func_8(Local_231) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sParam1))
		{
			AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iParam0, Local_231, sParam1, 786468, iParam2, iParam3, -1, -1f, 0, 1073741824);
		}
	}
}
	...
	if ((iLocal_94 > 3 && iLocal_94 != 5) && iLocal_94 != 7)
	{
		if (func_8(Local_231))
		{
			if (!iLocal_222)
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_229, Local_231, PLAYER::PLAYER_PED_ID(), 8, 50f, 34340900, 200f, 2f, 1);
					iLocal_222 = 1;
				}
			}
			else if (!func_377(Local_229, PLAYER::PLAYER_PED_ID(), 145f, 1))
			{
				AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_229, Local_231, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 200f, 2f, 1);
				iLocal_222 = 0;
			}
		}
	}
...
void func_392()
{
	if (iLocal_94 != 7)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_229, -1737.935f, -1125.939f, 12.01733f, -1751.796f, -1114.709f, 16.0172f, 8.77f, 0, true, 0))
		{
			if (func_8(Local_231))
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(Local_229, Local_231, -1844.916f, -1224.451f, 12.01705f, 4, 50f, 2883621, 5f, 2f, 1);
				iLocal_94 = 7;
			}
		}
	}
...
void func_393()
{
	if (func_8(Local_231))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(Local_229.f_6))
			{
				if (!iLocal_218)
				{
					func_29(&(Local_229.f_6));
		...
		else if (UI::DOES_BLIP_EXIST(Local_229.f_6))
		{
			if (iLocal_218)
			{
				func_29(&(Local_229.f_6));
			...
			else if (iLocal_92 == 1)
			{
				if (func_377(PLAYER::PLAYER_PED_ID(), iLocal_233, 15f, 1))
				{
					if (iLocal_225 == -1)
					{
						if (!func_30())
						{
							iLocal_225 = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else if (!func_30())
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_225) > 15000 && !UI::IS_MESSAGE_BEING_DISPLAYED())
						{
...
int func_403(int iParam0, int iParam1)
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0, true) };
	vVar1 = { ENTITY::GET_ENTITY_COORDS(iParam1, true) };
	fVar2 = GAMEPLAY::ABSF((vVar0.z - vVar1.z));
	if (fVar2 <= 1.5f)
	{
		return 1;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_435(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_432(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_406(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_443()
{
	AI::REMOVE_WAYPOINT_RECORDING("Sol1Roco1");
}
