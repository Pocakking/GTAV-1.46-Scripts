...
void func_163()
{
	if ((GAMEPLAY::IS_BIT_SET(iLocal_49, 0) && Global_36117 == 15) && !func_195())
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_49, 1) && GAMEPLAY::IS_BIT_SET(iLocal_49, 0))
			{
				if (!func_74(PLAYER::PLAYER_PED_ID(), vLocal_50, 5f))
				{
					if (GAMEPLAY::IS_BIT_SET(iLocal_49, 20) || func_129())
					{
						if ((func_237(PLAYER::PLAYER_PED_ID()) && !GAMEPLAY::IS_BIT_SET(uLocal_47[0], 17)) && !GAMEPLAY::IS_BIT_SET(uLocal_47[1], 18))
						{
...
void func_211()
{
	...
	if (((((((Global_36117 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(iLocal_49, 5)) && !func_195()) && Global_71202 == -1) && !func_221()) && !func_82(9)) || func_101(35))
	{
		func_220();
		func_218();
		switch (iLocal_39)
...
int func_239()
{
	...
	if (!func_82(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
