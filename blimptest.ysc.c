...
void func_8(vector3 vParam0)
{
	...
	FIRE::ADD_EXPLOSION(vParam0, 8, 1f, 1, 0, 1065353216, 0);
	iVar0 = 0;
	while (iVar0 <= (iVar1 - 1))
	{
		FIRE::ADD_EXPLOSION(vParam0 + vVar2[iVar0 /*3*/], 8, 1f, 1, 0, 1065353216, 0);
		iVar0++;
	}
}
...
void func_11()
{
	...
	if (func_6(iLocal_40))
	{
		...
		if (func_5(PLAYER::PLAYER_PED_ID()))
		{
			...
			GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 500f, 1, 0, 0, false);
		}
	}
