...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_107(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					{
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ScriptParam_85.f_1[0 /*3*/], 8f, 0, 0, 0, 0, false, 0);
					...
					else
					{
						...
						if (!func_84(3) && !Global_93266)
						{
							...
							{
								if ((!func_107(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_83())) && !Global_93266)
								{
									func_100(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_65(iLocal_54))
								{
									...
									else if (!func_107(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_63(&iLocal_60);
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_107(Global_104721, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_63), 0, Global_93269, 0);
								func_7(func_19(iLocal_63), 0, Global_93269, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_63), 0, Global_93269, 0);
								func_7(func_19(iLocal_63), 0, Global_93269, 0, 0);
							}
						}
						func_4();
						func_109(&Global_104721, 0);
...
void func_108()
{
	...
	fLocal_66 = 209f;
	iLocal_69 = 95;
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_76, 10f, 0, 0, 0, 0, false, 0);
	iLocal_63 = 10;
