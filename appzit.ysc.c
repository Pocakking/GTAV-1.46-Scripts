...
void __EntryFunction__()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT(&cLocal_27, 1);
		...
		if (iLocal_33)
		{
			if (iLocal_35 < 101)
			{
				if (SYSTEM::TIMERA() > 30)
				{
					...
					func_10("CELL_4005");
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iLocal_35);
					GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
					func_9(Global_14494, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
					SYSTEM::SETTIMERA(0);
				}
			}
			else
