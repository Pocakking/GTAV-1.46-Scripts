...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (AI::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
		{
			if (AI::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
			{
				AI::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", false);
			}
		}
		fVar0 = (CAM::_0x8BFCEB5EA1B161B6() + 20f);
				...
				if (func_52())
				{
					if (!iLocal_66)
					{
						...
						if (!bLocal_64)
						{
							...
							AI::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_87);
						...
						else
						{
							if (!bLocal_65)
							{
								...
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 150f, -1, 1, 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_87);
							}
							else
							{
					...
					else
					{
						...
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_48, false), true) >= 100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_48, false), 3f))
						{
...
int func_52()
{
	if (func_2(iLocal_48))
	{
		if (!bLocal_64)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_48, false), true) <= 7f || AI::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
			{
				if (!iLocal_66)
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_48, false), true) <= 7f)
					{
					}
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_48, false), true) <= 4.5f || AI::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
		{
			if (!iLocal_66)
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_48, false), true) <= 4.5f)
				{
				}
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
				{
...
void func_55()
{
	switch (iLocal_47)
	{
		...
		case 1:
			if (func_54())
			{
				if (!OBJECT::_DOES_DOOR_EXIST(-1831288286))
				{
					...
					if (func_59())
					{
						if (iLocal_71 == 0)
						{
							if (bLocal_63)
							{
								AI::CLEAR_PED_TASKS(iLocal_48);
								AI::OPEN_SEQUENCE_TASK(&iLocal_87);
								AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
								AI::TASK_PLAY_ANIM(0, "cellphone@", "cellphone_call_out", 8f, -8f, -1, 0, 0f, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_87);
								AI::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_87);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
							}
						...
						{
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_55) >= iLocal_56)
							{
								func_56();
...
int func_59()
{
	if (!PED::IS_COP_PED_IN_AREA_3D(vLocal_78, vLocal_79) && !(GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == GAMEPLAY::GET_HASH_KEY("rm_showroom"))
		{
			if (!func_123())
			{
	...
	else if (PED::IS_COP_PED_IN_AREA_3D(vLocal_78, vLocal_79) || (GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == GAMEPLAY::GET_HASH_KEY("rm_showroom"))
		{
...
int func_65()
{
	switch (func_66(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_73()
{
	switch (iLocal_47)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(-53.57574f, -1095.356f, 24.17232f, -46.52551f, -1094.587f, 27.42232f, 3.75f, 0, 0, 0, 0, 0, 0);
			break;
		...
		case 1:
			if (!func_2(iLocal_49) || !func_2(iLocal_50))
			{
				...
				if (func_2(iLocal_49))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&iLocal_87);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_d", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(iLocal_87, 1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_87);
					AI::TASK_PERFORM_SEQUENCE(iLocal_49, iLocal_87);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
				...
				if (func_2(iLocal_50))
				{
					...
					AI::SET_SEQUENCE_TO_REPEAT(iLocal_87, 1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_87);
					AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_87);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_49, true);
				}
			}
...
int func_90()
{
	if (((((((((((STREAMING::HAS_MODEL_LOADED(Local_45[0 /*20*/]) && STREAMING::HAS_MODEL_LOADED(Local_45[1 /*20*/])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[0 /*20*/].f_17)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[1 /*20*/].f_17)) && func_54()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && STREAMING::HAS_MODEL_LOADED(iLocal_74)) && STREAMING::HAS_MODEL_LOADED(joaat("bjxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("tailgater"))) && STREAMING::HAS_MODEL_LOADED(joaat("baller2")))
	{
		return 1;
	}
	return 0;
...
void func_91(int iParam0)
{
	switch (Local_45[iParam0 /*20*/].f_18)
	{
			...
			if (!Local_45[iParam0 /*20*/].f_19)
			{
				if (!func_2(Local_45[iParam0 /*20*/].f_1))
				{
					...
					if (func_2(Local_45[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							AI::TASK_START_SCENARIO_AT_POSITION(Local_45[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", vLocal_80[iParam0 /*3*/], fLocal_81[iParam0], 0, 0, 1);
		...
		case 2:
			if (func_2(Local_45[iParam0 /*20*/].f_1))
			{
				if (iLocal_67)
				{
					...
					AI::CLEAR_PED_TASKS(Local_45[iParam0 /*20*/].f_1);
					PED::SET_PED_USING_ACTION_MODE(Local_45[iParam0 /*20*/].f_1, true, -1, "DEFAULT_ACTION");
					AI::OPEN_SEQUENCE_TASK(&iLocal_87);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_45[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_87);
					AI::TASK_PERFORM_SEQUENCE(Local_45[iParam0 /*20*/].f_1, iLocal_87);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_87);
					Local_45[iParam0 /*20*/].f_18 = 3;
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(Local_45[iParam0 /*20*/].f_1, false), true) >= 250f)
				{
		...
		case 3:
			...
			{
				func_93(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (AI::GET_SCRIPT_TASK_STATUS(Local_45[iParam0 /*20*/].f_1, 242628503) == 7 || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(Local_45[iParam0 /*20*/].f_1, false), true) <= 5f)
				{
					AI::TASK_LOOK_AT_ENTITY(Local_45[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_COMBAT_PED(Local_45[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		case 4:
			...
			else
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(Local_45[iParam0 /*20*/].f_1, 780511057) == 7)
				{
					AI::TASK_COMBAT_PED(Local_45[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(Local_45[iParam0 /*20*/].f_1, false), true) >= 75f)
				{
					Local_45[iParam0 /*20*/].f_18 = 5;
				}
			}
...
void func_94()
{
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", true);
		}
	}
...
int func_119()
{
	...
	func_117(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_116(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_115(&uVar0, TIME::GET_CLOCK_HOURS());
	func_113(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_114(&uVar0, TIME::GET_CLOCK_MONTH());
	func_112(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_123()
{
	if ((Global_106059 == func_31() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
...
void func_124()
{
	...
	AI::ADD_COVER_BLOCKING_AREA(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, 1, 1, 1, 0);
	if (iLocal_86 == -1)
	{
	...
	AI::REQUEST_WAYPOINT_RECORDING("reyetarian_simeonoffice");
...
void func_132(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_133(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84115[26 /*34*/].f_6) == 0)
			{
				Global_106070.f_7233[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106070.f_7233[iParam0], 1, 1);
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_158()) || Global_25461) || func_157()) || func_46(8, -1)) || func_154()) || func_156()) || func_155()) || func_153()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_105117) || Global_25461) || func_157()) || func_46(8, -1)) || func_156()) || func_155()) || func_153()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_46(8, -1)) || func_153()) || func_152()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_25461) || func_157()) || func_46(8, -1)) || func_155()) || func_154()) || func_153()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_158()) || func_155()) || Global_105117) || Global_25461) || func_157()) || Global_37271) || func_46(8, -1)) || func_154()) || func_152()) || func_153()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_105117) || Global_25461) || func_157()) || func_46(8, -1)) || func_154()) || func_152()) || func_156()) || func_155()) || func_153())
						{
							return 0;
						}
						break;
