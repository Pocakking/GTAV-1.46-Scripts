...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
		...
		case 8:
			iVar10 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
...
int func_55(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_63(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || func_57(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_56(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar1], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
int func_72()
{
	if ((CAM::IS_SCREEN_FADED_OUT() && !func_84()) && !Global_2504480)
	{
		return 1;
	}
	if (!func_83())
...
bool func_84()
{
	return GAMEPLAY::IS_BIT_SET(Global_1668658.f_3315, 10);
}
...
int func_85()
{
	if (Global_2423801[PLAYER::PLAYER_ID() /*413*/].f_309.f_7 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2423801[PLAYER::PLAYER_ID() /*413*/].f_309.f_7, 1, 0))
		{
			return 0;
		}
