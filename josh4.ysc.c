...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_BOC", 0);
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_PEDS(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_428(Local_386.f_28[0]))
			{
				AI::TASK_LOOK_AT_ENTITY(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
			GAMEPLAY::_SET_UNK_MAP_FLAG(2);
			iLocal_394 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_46 = 1;
			break;
...
void func_208()
{
	...
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
	...
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_428(Local_386.f_28[0]))
				{
					AI::CLEAR_PED_TASKS(Local_386.f_28[0]);
					if (func_203(iLocal_391))
					{
						if (GAMEPLAY::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
						...
						else
						{
							...
							if (func_203(iLocal_391))
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			...
			if (func_428(Local_386.f_28[0]))
			{
				...
				if (func_203(iLocal_391))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_386.f_28[0], iLocal_391, 1))
					{
						...
						{
							AI::CLEAR_PED_TASKS(Local_386.f_28[0]);
							AI::TASK_LEAVE_ANY_VEHICLE(Local_386.f_28[0], 0, 4416);
							AI::TASK_SMART_FLEE_PED(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_228(&iLocal_391);
						}
					}
					if (func_428(PLAYER::PLAYER_PED_ID()))
				...
				if (func_428(PLAYER::PLAYER_PED_ID()) && func_428(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						...
						{
							if (!func_205() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_413) > 8000)
							{
	...
	switch (Local_47.f_11)
	{
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_47.f_7))
			{
				...
				AI::CLEAR_PED_TASKS(Local_47.f_8);
...
void func_233()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_394) > 4000)
			{
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_394) > 20000)
			{
				func_476("************************************** TIMEOUT - ARREST next frame");
				if (func_428(Local_386.f_28[1]))
				{
					AI::CLEAR_PED_TASKS(Local_386.f_28[1]);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[1], false);
					AI::TASK_ARREST_PED(Local_386.f_28[1], PLAYER::PLAYER_PED_ID());
				}
				iLocal_48 = 4;
				iLocal_394 = GAMEPLAY::GET_GAME_TIMER();
			}
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				GAMEPLAY::ENABLE_DISPATCH_SERVICE(6, true);
				iVar0 = 1;
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_428(Local_386.f_28[iVar0]))
					{
						AI::CLEAR_PED_TASKS(Local_386.f_28[iVar0]);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[iVar0], false);
						AI::OPEN_SEQUENCE_TASK(&iLocal_389);
						AI::TASK_SHOOT_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, -687903391);
						AI::CLOSE_SEQUENCE_TASK(iLocal_389);
						AI::TASK_PERFORM_SEQUENCE(Local_386.f_28[iVar0], iLocal_389);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_389);
					}
					iVar0++;
				}
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_411) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_386.f_28 - 1))
					{
...
void func_253()
{
	...
	else
	{
		...
		{
			case 0:
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_52) > 1000)
				{
					iLocal_50 = 1;
				}
				break;
			...
			case 1:
				if (!func_205() && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_51)
					{
						func_222(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_256()
{
	...
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		if (func_428(Local_386.f_28[1]))
		{
			...
			CUTSCENE::_0x2A56C06EBEF2B0D9("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_428(Local_386.f_28[2]))
		{
			func_476("Trying to set Cop 2 component variation (intro loop)");
			CUTSCENE::_0x2A56C06EBEF2B0D9("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		case 0:
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
			...
			switch (iLocal_408)
			{
				...
				case 3:
					...
					if (func_268())
					{
						...
						UNK1::_0x293220DA1B46CEBC(0f, 5f, 0);
						iLocal_408 = 4;
					}
					func_267();
				...
				case 4:
					...
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						GAMEPLAY::ENABLE_DISPATCH_SERVICE(6, false);
						iLocal_46 = 2;
					}
					break;
...
void func_267()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_428(Local_386.f_28[0]))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&iLocal_389);
			AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2, 2);
			AI::TASK_PLAY_ANIM(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0f, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(iLocal_389);
			AI::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], iLocal_389);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_428(Local_386.f_28[1]))
		{
			...
			AI::TASK_PLAY_ANIM(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0f, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(iLocal_389);
			AI::TASK_PERFORM_SEQUENCE(Local_386.f_28[1], iLocal_389);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_389);
...
void func_269(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_271(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_291(int iParam0)
{
	...
	if (func_428(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			...
			AI::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
			...
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_428(PLAYER::PLAYER_PED_ID()) && func_258(Local_386.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_294())
						{
							...
							{
								AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					if (func_258(Local_386.f_28[0]))
					{
						...
						{
							AI::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0f, 0, 0, 0);
							func_476("Done Josh leadin anim");
							if (func_258(Local_386.f_28[2]))
							{
								AI::TASK_PLAY_ANIM(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0f, 0, 0, 0);
								func_476("Done Notepad cop leadin anim");
							}
							if (func_258(Local_386.f_28[1]))
							{
								AI::TASK_PLAY_ANIM(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0f, 0, 0, 0);
								func_476("Done Speaker cop leadin anim");
							}
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::_REQUEST_CUTSCENE_EX("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_400 = 1;
						}
					}
				}
						...
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
									...
									{
										UNK1::_0x293220DA1B46CEBC(2f, 3f, 1);
										iLocal_401 = 1;
									}
								}
							}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_304(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_315(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
void func_390(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_391(iParam0, iParam1))
				{
...
{
	return func_400(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_417(uParam0))
	{
		...
		if (func_416(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_402(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_398(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_405(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_364(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_364(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_364(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_408(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_407())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_364(iVar2 + 1)))
				{
...
void func_427()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("JOSH4", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_428(uParam0->f_28[1]))
				{
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						...
						AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_428(uParam0->f_28[2]))
				{
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						AI::CLEAR_PED_TASKS(uParam0->f_28[2]);
						AI::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					}
				}
				else
				{
