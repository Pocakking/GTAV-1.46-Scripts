...
int func_3()
{
	...
	if (!func_2(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_50)
	{
		...
		case 2:
			...
			if ((func_16(iLocal_68, iLocal_66, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || func_16(iLocal_69, iLocal_67, &Local_70, &uLocal_71, 0, 1, 0, 1, 1)) || (func_15(vVar0, 4, 20, 0) && !PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID())))
			{
				...
				{
					AI::TASK_COMBAT_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 0, 16);
				}
	...
	if (bLocal_294)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_289, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_290, 0))
			{
				...
				AI::TASK_VEHICLE_AIM_AT_COORD(iLocal_290, vVar0);
			}
			if (bLocal_292)
			{
				if (!func_28())
		...
		else if (UI::DOES_BLIP_EXIST(iLocal_291))
		{
			UI::REMOVE_BLIP(&iLocal_291);
		}
	}
}
...
void func_29()
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(Local_307.f_27[iVar0]))
		{
			if (!Local_307.f_18[iVar0])
			{
				...
				{
					AI::TASK_COMBAT_PED(Local_307.f_27[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					Local_307.f_18[iVar0] = 1;
				}
			}
			if (!Local_307.f_18[iVar0])
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_27[iVar0]))
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(Local_307.f_27[iVar0], Local_307.f_14[iVar0], 0, 0, -1);
				}
			}
		}
		else if (UI::DOES_BLIP_EXIST(Local_307.f_36[iVar0]))
		{
			UI::REMOVE_BLIP(&(Local_307.f_36[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_31[iVar0]))
		{
			...
			{
				if (UI::DOES_BLIP_EXIST(Local_307.f_40[iVar0]))
				{
					UI::REMOVE_BLIP(&(Local_307.f_40[iVar0]));
				}
			}
		}
		iVar0++;
	...
	if (!Local_307.f_22[0])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_31[0]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_307.f_31[0]);
				AI::TASK_COMBAT_PED(Local_307.f_31[0], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_307.f_22[0] = 1;
			}
		}
	}
	if (!Local_307.f_22[1])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_31[1]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_307.f_31[1]);
				AI::TASK_COMBAT_PED(Local_307.f_31[1], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_307.f_22[1] = 1;
			}
		}
	}
	if (!Local_307.f_22[2])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_31[2]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_307.f_31[2]);
				AI::TASK_COMBAT_PED(Local_307.f_31[2], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_307.f_22[2] = 1;
			}
		}
	}
	if (!Local_307.f_22[3])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_31[3]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_307.f_31[3]);
				AI::TASK_COMBAT_PED(Local_307.f_31[3], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_307.f_22[3] = 1;
			}
		}
	}
	...
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_27[1]))
		{
			if (!Local_307.f_22[0])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_31[0]))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_31[0], Local_307.f_27[1], -2f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
			if (!Local_307.f_22[1])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_31[1]))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_31[1], Local_307.f_27[1], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
		}
	}
	...
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_27[2]))
		{
			if (!Local_307.f_22[2])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_31[2]))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_31[2], Local_307.f_27[2], 1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
			if (!Local_307.f_22[3])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_31[3]))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_31[3], Local_307.f_27[2], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
		}
	}
...
void func_30()
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_64[iVar0]) && !PED::IS_PED_INJURED(Local_252.f_64[iVar0]))
		{
			...
			if ((((func_16(Local_252.f_64[iVar0], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || GAMEPLAY::IS_BULLET_IN_AREA(Local_252[iVar0 /*3*/], 20f, 1)) || GAMEPLAY::IS_SNIPER_BULLET_IN_AREA(Local_252[iVar0 /*3*/] - Vector(20f, 20f, 20f), Local_252[iVar0 /*3*/] + Vector(20f, 20f, 20f))) || iLocal_268) || func_32(&(Local_252.f_64[iVar0])))
			{
				if (!func_2(5))
				{
			...
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_252.f_64[iVar0]))
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(Local_252.f_64[iVar0], Local_252.f_42[iVar0], 0, 0, -1);
					Local_252.f_53[iVar0] = 0;
				}
			}
		}
		else if (UI::DOES_BLIP_EXIST(Local_252.f_75[iVar0]))
		{
			UI::REMOVE_BLIP(&(Local_252.f_75[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(iLocal_264[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_264[iVar0], 0)) && ENTITY::DOES_ENTITY_EXIST(iLocal_263[iVar0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_263[iVar0], 0))
		{
			...
			AI::TASK_VEHICLE_AIM_AT_COORD(iLocal_264[iVar0], vVar1);
...
void func_31(int iParam0)
{
	...
	{
		AI::TASK_SHOOT_AT_ENTITY(Local_252.f_64[iParam0], PLAYER::PLAYER_PED_ID(), -1, 0);
...
void func_65()
{
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[0 /*13*/][0 /*3*/], 1879.944f, 2461.988f, 53.5496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[0 /*13*/][1 /*3*/], 1831.631f, 2522.218f, 54.1376f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[0 /*13*/][2 /*3*/], 1789.07f, 2490.558f, 54.1381f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[0 /*13*/][3 /*3*/], 1789.8f, 2426.876f, 44.7729f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[1 /*13*/][0 /*3*/], 1879.944f, 2461.988f, 53.5496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[1 /*13*/][1 /*3*/], 1831.631f, 2522.218f, 54.1376f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[1 /*13*/][2 /*3*/], 1789.07f, 2490.558f, 54.1381f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[1 /*13*/][3 /*3*/], 1789.8f, 2426.876f, 44.7729f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[2 /*13*/][0 /*3*/], 1655.908f, 2349.021f, 55.1775f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[2 /*13*/][1 /*3*/], 1733.875f, 2385.521f, 44.9049f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[2 /*13*/][2 /*3*/], 1662.234f, 2446.357f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[2 /*13*/][3 /*3*/], 1524.631f, 2426.997f, 44.6212f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[3 /*13*/][0 /*3*/], 1455.081f, 2432.642f, 51.3366f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[3 /*13*/][1 /*3*/], 1576.174f, 2407.076f, 44.8143f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[3 /*13*/][2 /*3*/], 1578.1f, 2486.227f, 44.5655f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[3 /*13*/][3 /*3*/], 1512.837f, 2560.419f, 44.8417f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[4 /*13*/][0 /*3*/], 1484.2f, 2584.409f, 51.9283f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[4 /*13*/][1 /*3*/], 1535.154f, 2538.926f, 44.496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[4 /*13*/][2 /*3*/], 1570.661f, 2587.814f, 44.5655f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[4 /*13*/][3 /*3*/], 1538.227f, 2655.531f, 44.9156f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[5 /*13*/][0 /*3*/], 1505.538f, 2727.242f, 37.6965f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[5 /*13*/][1 /*3*/], 1545.95f, 2632.524f, 44.7178f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[5 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[5 /*13*/][3 /*3*/], 1599.041f, 2713.393f, 44.4309f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[6 /*13*/][0 /*3*/], 1606.661f, 2815.673f, 37.9512f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[6 /*13*/][1 /*3*/], 1602.887f, 2721.398f, 44.651f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[6 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[6 /*13*/][3 /*3*/], 1719.225f, 2766.111f, 44.6846f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[7 /*13*/][0 /*3*/], 1783.204f, 2811.375f, 44.4414f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[7 /*13*/][1 /*3*/], 1709.275f, 2764.432f, 44.5747f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[7 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[7 /*13*/][3 /*3*/], 1822.456f, 2749.189f, 44.9326f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_270[9 /*13*/][0 /*3*/], 1606.661f, 2815.673f, 37.9512f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_270[9 /*13*/][1 /*3*/], 1602.887f, 2721.398f, 44.651f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_270[9 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_270[9 /*13*/][3 /*3*/], 1719.225f, 2766.111f, 44.6846f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
...
void func_66()
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_64[iVar0]) && !ENTITY::IS_ENTITY_DEAD(Local_252.f_64[iVar0], 0))
		{
			...
			AI::SET_PED_DESIRED_MOVE_BLEND_RATIO(Local_252.f_64[iVar0], 0f);
			...
			if (!PED::IS_PED_INJURED(Local_252.f_64[iVar0]))
			{
				if (iVar0 == 0)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_01", 1, 0, 1);
				}
				else if (iVar0 == 1)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_02", 1, 0, 1);
				}
				else if (iVar0 == 2)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_03", 1, 0, 1);
				}
				else if (iVar0 == 3)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_04", 1, 0, 1);
				}
				else if (iVar0 == 4)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_05", 1, 0, 1);
				}
				else if (iVar0 == 5)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_06", 1, 0, 1);
				}
				else if (iVar0 == 6)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_07", 1, 0, 1);
				}
				else if (iVar0 == 7)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_08", 1, 0, 1);
				}
				else if (iVar0 == 9)
				{
					AI::TASK_PATROL(Local_252.f_64[iVar0], "miss_Tower_10", 1, 0, 1);
				}
				else
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(Local_252.f_64[iVar0], Local_252.f_42[iVar0], 0, 0, -1);
...
int func_70()
{
	...
	while (iVar0 < 3)
	{
		while (!AI::GET_IS_WAYPOINT_RECORDING_LOADED(Local_307.f_14[iVar0]))
		{
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
int func_72()
{
	...
	while (iVar0 < 10)
	{
		if (!AI::GET_IS_WAYPOINT_RECORDING_LOADED(Local_252.f_42[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
void func_75()
{
	...
	while (iVar0 < 3)
	{
		AI::REQUEST_WAYPOINT_RECORDING(Local_307.f_14[iVar0]);
		iVar0++;
	}
}
...
void func_77()
{
	...
	while (iVar0 < 10)
	{
		AI::REQUEST_WAYPOINT_RECORDING(Local_252.f_42[iVar0]);
		iVar0++;
	}
...
void func_78()
{
	...
	if (func_28())
	{
		iLocal_295 = (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2);
		if (iLocal_295 == 0)
		{
			bLocal_294 = true;
			STREAMING::REQUEST_MODEL(joaat("polmav"));
...
void func_83(bool bParam0)
{
	...
	if (bParam0)
	{
		GAMEPLAY::CLEAR_AREA(1695.1f, 2595.8f, 50f, 1000f, 1, 0, 0, false);
	}
...
void func_85()
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_27[iVar0]))
		{
			if (UI::DOES_BLIP_EXIST(Local_307.f_36[iVar0]))
			{
				UI::REMOVE_BLIP(&(Local_307.f_36[iVar0]));
			}
...
void func_86()
{
	if (UI::DOES_BLIP_EXIST(iLocal_301))
	{
		UI::REMOVE_BLIP(&iLocal_301);
	}
...
void func_88()
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_64[iVar0]))
		{
			if (UI::DOES_BLIP_EXIST(Local_252.f_75[iVar0]))
			{
				UI::REMOVE_BLIP(&(Local_252.f_75[iVar0]));
			}
...
void func_89()
{
	if (UI::DOES_BLIP_EXIST(iLocal_291))
	{
		UI::REMOVE_BLIP(&iLocal_291);
	}
	...
	if (((ENTITY::DOES_ENTITY_EXIST(*iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && !ENTITY::IS_ENTITY_DEAD(*iParam0, 0)) && !ENTITY::IS_ENTITY_DEAD(*uParam1, 0))
	{
		if (ENTITY::IS_ENTITY_IN_AIR(*iParam0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(*iParam0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					AI::TASK_PLANE_MISSION(*uParam1, *iParam0, 0, 0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 8, 50f, -1f, 30f, 100, 50, 1);
				}
			}
		}
	}
