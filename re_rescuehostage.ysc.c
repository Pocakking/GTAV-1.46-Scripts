		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			switch (iLocal_45)
			{
				...
				case 1:
					if (iLocal_60 == 0)
					{
						iLocal_60 = DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(99, -104.982f, 6408.737f, 30.4905f, 180000f);
					}
					func_104();
					...
					else
					{
						if (Local_93[1 /*10*/].f_7)
						{
							...
							if (UI::DOES_BLIP_EXIST(iLocal_54))
							{
								UI::REMOVE_BLIP(&iLocal_54);
							}
							func_50(&Local_93, 1);
							func_48();
						}
				...
				case 2:
					...
					if (!iLocal_78)
					{
						if (GAMEPLAY::CREATE_INCIDENT(7, vLocal_46, 2, 0f, &uLocal_80, 0, 0))
						{
							iLocal_78 = 1;
						}
					}
				...
				case 3:
					...
					else
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_49))
						{
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_62 + 100)
							{
						...
						{
							if (GAMEPLAY::CREATE_INCIDENT(5, vLocal_46, 2, 0f, &uLocal_81, 0, 0))
							{
								iLocal_78 = 1;
							}
						}
...
void func_3()
{
	if (func_4())
	{
		if (!PED::IS_PED_INJURED(iLocal_49))
		{
			...
			AI::TASK_SMART_FLEE_COORD(iLocal_49, vLocal_46, 50f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_49, true);
		...
		if (!PED::IS_PED_INJURED(iLocal_50))
		{
			...
			AI::TASK_SMART_FLEE_COORD(iLocal_50, vLocal_46, 50f, -1, 0, 0);
...
bool func_4()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_49))
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_49, 31086, 0f, 0f, 0f), 15f, 1))
		{
			bVar0 = true;
		}
	...
	if (!iLocal_73)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_49))
		{
			if (iLocal_64 == -1)
			{
				...
				AI::TASK_PLAY_ANIM(iLocal_49, sLocal_99, "girl_villian_shot", 8f, -2f, -1, 10, 0f, 0, 0, 0);
				...
				if (!PED::IS_PED_INJURED(iLocal_50))
				{
					...
					{
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_64, sLocal_99, "bystander_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50, false);
				...
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_64, sLocal_99, "girl_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_64))
			{
				...
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_64) == 1f)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_50))
					{
						if (bLocal_79)
						{
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_64, sLocal_99, "bystander_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
						}
						else
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_71);
							AI::TASK_LOOK_AT_ENTITY(0, iLocal_49, -1, 1024, 2);
							AI::TASK_GO_TO_ENTITY(0, iLocal_49, 20000, 3f, 1f, 1073741824, 0);
							AI::TASK_STAND_STILL(0, -1);
							AI::CLOSE_SEQUENCE_TASK(iLocal_71);
							AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_71);
						}
						PED::SET_PED_KEEP_TASK(iLocal_50, true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_50, iLocal_57);
					}
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_64, sLocal_99, "girl_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
					PED::SET_PED_KEEP_TASK(iLocal_49, true);
...
void func_51()
{
	if (((((((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0) && PED::_0x6CD5A433374D4CFB(iLocal_48, PLAYER::PLAYER_PED_ID())) || (func_61(iLocal_48, &uLocal_58, &iLocal_59, 0, 0, 1077936128, 0) && PED::_0x6CD5A433374D4CFB(iLocal_48, PLAYER::PLAYER_PED_ID()))) || (func_60(1) && PED::_0x6CD5A433374D4CFB(iLocal_48, PLAYER::PLAYER_PED_ID()))) || func_58()) || func_57()) || func_4()) || func_56()) || PED::IS_PED_RAGDOLL(iLocal_48)) || func_55()) || func_54()) || func_52(iLocal_48))
	{
			...
			if (!WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_48, joaat("weapon_stungun"), 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_49))
				{
					if (!PED::IS_PED_RAGDOLL(iLocal_48))
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_63, sLocal_99, "girl_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_48, iLocal_63, sLocal_99, "villian_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						PED::SET_PED_KEEP_TASK(iLocal_49, true);
						PED::SET_PED_CAN_RAGDOLL(iLocal_49, 0);
					}
				}
	...
	{
		if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_48) && PED::_0x6CD5A433374D4CFB(iLocal_48, PLAYER::PLAYER_PED_ID())) || (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_48) && PED::_0x6CD5A433374D4CFB(iLocal_48, PLAYER::PLAYER_PED_ID())))
		{
			if (UI::DOES_BLIP_EXIST(iLocal_53))
			{
				UI::_0x75A16C3DA34F1245(iLocal_53, true);
			}
			if (!iLocal_72)
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0))
		...
		else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_84, "NULL"))
		{
...
int func_54()
{
	if (func_95())
	{
		if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_91 + 60000))
		{
			bLocal_92 = true;
			return 1;
		}
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_91 + 120000))
	{
		bLocal_92 = true;
		return 1;
	}
...
bool func_58()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)), &uVar3, &Var4);
		fVar6 = Var4.f_1;
		if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
		{
			...
			{
				GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar8), &uVar3, &Var4);
	...
	if (bVar1)
	{
		...
		fVar5 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar2.x, vVar2.y);
...
void func_68()
{
	if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -62.6571f, 6447.08f, 40.49928f, -153.6411f, 6354.579f, 23.99063f, 144.25f, 0, true, 0) || CAM::IS_SPHERE_VISIBLE(vLocal_46, 15f)) || bLocal_68) || func_4())
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_53))
		{
			UI::_0x75A16C3DA34F1245(iLocal_53, false);
		}
		func_69(1);
		iLocal_91 = GAMEPLAY::GET_GAME_TIMER();
...
void func_97()
{
	if (!iLocal_75)
	{
		if (!PED::IS_PED_INJURED(iLocal_48))
		{
			...
			{
				AI::TASK_COMBAT_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 0, 16);
				PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_48, 1);
			}
			else
			{
				AI::TASK_SMART_FLEE_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
			}
	...
	if (iLocal_72)
	{
		...
		else
		{
			if (!PED::IS_PED_INJURED(iLocal_50))
			{
				if (!PED::IS_PED_INJURED(iLocal_48))
				{
					AI::TASK_SMART_FLEE_PED(iLocal_50, iLocal_48, 100f, -1, 0, 0);
				}
				else
				{
	...
	if (bLocal_90 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_50) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_72)
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0f, 0, 0, 0);
				AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_71);
				AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_71);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_71);
				PED::SET_PED_KEEP_TASK(iLocal_50, true);
			}
			else
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_71);
				AI::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_46, 1f, 20000, 1193033728, 1056964608);
				AI::TASK_LOOK_AT_COORD(0, vLocal_46, -1, 2048, 2);
				AI::TASK_PLAY_ANIM(0, sLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_71);
				AI::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_71);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_71);
...
int func_106()
{
	...
	{
		GAMEPLAY::CLEAR_AREA(vLocal_46, 5f, 1, 1, 0, false);
		...
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_48, iLocal_63, sLocal_99, "villian_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_63, sLocal_99, "girl_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		iLocal_65 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_65, true);
		AI::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_65, sLocal_99, "bystander_taking_cover", 1000f, -1.5f, 5, 0, 1148846080, 0);
		...
		AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_50, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49, 11, true);
		AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_49, 0);
...
int func_115(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_151(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
...
void func_157()
{
	...
	if (iLocal_45 != 0)
	{
		...
		DECISIONEVENT::REMOVE_SHOCKING_EVENT(iLocal_60);
		func_107(0);
	}
	if (!PED::IS_PED_INJURED(iLocal_48) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		AI::TASK_SMART_FLEE_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_48, true);
		SYSTEM::WAIT(0);
	}
	func_158(-1);
