				...
				if ((((((((!Global_1573964 && !func_23(3)) && !func_20(PLAYER::PLAYER_ID(), 0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !func_18(PLAYER::PLAYER_ID())) && !func_16(func_17(PLAYER::PLAYER_ID()))) && !func_14(PLAYER::PLAYER_ID(), 146)) && !func_10(PLAYER::PLAYER_ID()))
				{
					if (func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 4, 100, 0))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								if (!func_8(&(Local_115.f_1)))
								{
									func_5(&(Local_115.f_1));
								}
								else if (func_2(&(Local_115.f_1)) > 20f)
								{
						...
						else if (func_8(&(Local_115.f_1)))
						{
							func_1(&(Local_115.f_1));
						}
					}
				}
			}
...
int func_28()
{
	switch (Local_115)
	{
		case 0:
			...
			{
				Local_115.f_4 = PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
		...
		case 2:
			if (Global_1573964 || func_23(3))
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(Local_115.f_4, 0);
			}
			return 1;
			break;
	}
...
int func_33()
{
	...
	if (func_34() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_34()) == 0)
		{
			return 1;
		}
	}
...
void func_51(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_46();
