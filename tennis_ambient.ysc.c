...
void __EntryFunction__()
{
	...
	if (((func_335(10) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) || Global_90255) && !vScriptParam_748.y)
	{
	...
	Var1.f_28 = 1;
	fVar2 = func_324(vScriptParam_748.y, vScriptParam_748.z, 150f);
	iVar3 = 0;
	iVar4 = 0;
	iVar5 = (1 - iVar4);
	func_308(&Var0, &Var1, 1, iVar4, iVar5, &vScriptParam_748, joaat("a_f_y_tennis_01"), joaat("a_m_m_tennis_01"));
	while (true)
	{
		func_307(&Var0);
		if (Global_90255)
		...
		if (NETWORK::NETWORK_IS_IN_SESSION() && !vScriptParam_748.y)
		{
			func_303(&Var0);
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Var0.f_189.f_55) < 5625f || vScriptParam_748.y)
			{
				func_2(&Var0, &Var1, &iVar3, iVar4, iVar5, &uVar6, vScriptParam_748.y);
			}
		}
		func_1(&(Var0.f_281));
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		...
		if ((func_335(10) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) && !vScriptParam_748.y)
		{
			func_303(&Var0);
		}
		SYSTEM::WAIT(0);
...
void func_2(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_302(uParam1))
	{
		...
		case 4:
			if (func_266(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_264(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, vVar13, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, false));
					...
					func_264(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, vVar1, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, false));
		...
		case 8:
			...
			bVar14 = (GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]) && GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam4 /*94*/]));
	...
	if (!func_103(uParam0, 1024))
	{
		...
		if (func_74(uParam0) == 72 || func_74(uParam0) == 73)
		{
			if (func_10(uParam0) != 0)
			{
				...
				GAMEPLAY::_0x8FA9C42FC5D7C64B(iParam1, iVar8, func_9(uParam0), func_8(uParam0), 1065353216, 0);
				func_7(uParam0, GAMEPLAY::GET_GAME_TIMER() + 2871);
			}
		}
		else
		{
			GAMEPLAY::_0xE266ED23311F24D4(iParam1, sVar1, &Var2, fVar5, func_6(uParam0), 0);
		}
...
{
	if (!((!PED::IS_PED_INJURED(func_263(uParam0)) && AI::_0x921CE12C489C4C41(func_263(uParam0))) && GAMEPLAY::ARE_STRINGS_EQUAL(AI::_0x717E4D1F2048376D(func_263(uParam0)), "running")))
	{
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_37(iParam1)];
...
void func_56(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		iVar0 = func_49(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.5f, 0, 3);
...
void func_107(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_44(func_263(uParam0)) == 17 && GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.5f)
	{
...
Vector3 func_122(var uParam0, var uParam1, vector3 vParam2, int iParam3)
{
	...
	{
		fVar6 = func_123(0.4f, 1f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f));
...
int func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar11 = func_142(uParam0, &vVar12, &vVar13, &vLocal_300, &vLocal_302, &vLocal_303, 0, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
	...
	{
		iVar11 = func_142(uParam0, &vVar12, &vVar13, &vLocal_296, &vLocal_298, &vLocal_299, 1, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
			func_141(uParam0, 0.5f);
			func_140(uParam0, 1f);
...
int func_142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = GAMEPLAY::_0x7F8F6405F4777AF6(vVar5, func_115(bParam6, *uParam5, *uParam4), func_115(bParam6, *uParam4, *uParam5), 0);
				...
				if ((uParam3[iVar18 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar14 == 0 && (iVar18 == 72 || iVar18 == 73))
						{
							...
							if (iVar18 == 72)
							{
								iVar23 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_300, &vLocal_302, &vLocal_303, 0, &fVar24, &fVar25, &vVar16);
							}
							else
							{
								iVar23 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_296, &vLocal_298, &vLocal_299, 1, &fVar24, &fVar25, &vVar16);
							}
							if (iVar23 != 0)
							{
...
int func_180(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (func_103(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_49(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar0 = func_49(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2);
		}
		vVar5 = { func_121(vVar6, vVar5, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f)) };
...
void func_199(int iParam0)
{
	if (func_210(iParam0))
	{
		if (!func_209(iParam0))
		{
			iParam0->f_2 = (func_200(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
...
void func_204(int iParam0)
{
	if (func_210(iParam0))
	{
		if (func_209(iParam0))
		{
			iParam0->f_1 = (func_200(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_2);
			iParam0->f_2 = 0f;
...
{
	iParam0->f_1 = (func_200(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_212(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else if (func_103(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(AI::_0x717E4D1F2048376D(func_263(uParam0[iParam1 /*94*/])), "Intro") && AI::_0x30ED88D5E0C56A37(func_263(uParam0[iParam1 /*94*/])))
			{
...
void func_216(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar2 = (GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_324(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				AI::TASK_PLAY_ANIM(0, func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0f, 0, 0, 0);
			}
			if (!bParam8)
			{
...
void func_225(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			ENTITY::SET_ENTITY_HEADING(uParam0->f_32, ENTITY::GET_ENTITY_HEADING(uParam0->f_32));
			func_57(uParam0, 16384);
			fVar2 = (GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_324(bParam8, 180f, 0f));
			vVar3 = { uParam1->f_189.f_29 - ENTITY::GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_68(vVar3, uParam0->f_40) < 0f;
			bVar5 = func_68(vVar3, uParam0->f_43) < 0f;
			func_220(uParam0, 0);
...
void func_234(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(AI::_0x717E4D1F2048376D(func_263(uParam0)), "Intro") && AI::_0x30ED88D5E0C56A37(func_263(uParam0)))
			{
			...
			AI::_0xB0A6CFD2C69C1088(func_263(uParam0), &(uParam1->f_1670), 1);
			AI::_0xD5BB4025AE449A4E(func_263(uParam0), "Speed", uParam0->f_62);
		}
	}
	...
	switch (func_145(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_74(uParam0) == 75)
			{
				...
				{
					AI::TASK_GO_STRAIGHT_TO_COORD(func_263(uParam0), vVar1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_69(&(uParam0->f_4)), vVar2, false, true, 0) || AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7) && !func_226(&(uParam0->f_4), 256))
				{
					func_233(&(uParam0->f_4), 0);
					func_215(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_74(uParam0) == 75)
			{
				GAMEPLAY::_0xF56DFB7B61BE7276(func_281(uParam4), func_281(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, vVar1) <= (0f * 0f) || AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7)
				{
...
void func_260(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_263(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_263(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_263(uParam0[iParam1 /*94*/]), 28422), vLocal_294, vLocal_295, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_263(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_263(uParam0[iParam2 /*94*/]), 28422), vLocal_294, vLocal_295, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	vVar0 = { 0f, 0f, 1f };
	fVar1 = func_324(fParam9 == -1f, GAMEPLAY::GET_FRAME_TIME(), fParam9);
	iVar2 = 0;
...
void func_328(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_330(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
