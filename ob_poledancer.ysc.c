...
void func_3()
{
	if (!PED::IS_PED_INJURED(iLocal_1))
	{
		...
		{
			AI::TASK_PLAY_ANIM(iLocal_1, sLocal_6, sLocal_4, 8f, -8f, -1, 0, 0f, 0, 0, 0);
		}
		...
		else if (!iLocal_7)
		{
			...
			{
				ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(iLocal_1, sLocal_6, sLocal_4, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f));
				iLocal_7 = 1;
			}
		}
	}
