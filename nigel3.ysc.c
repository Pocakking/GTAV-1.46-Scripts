...
{
	iLocal_297 = 0;
	if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_18546.f_382, 5))
	{
		GAMEPLAY::SET_BIT(&(Global_106070.f_18546.f_382), 5);
	}
...
void func_7()
{
	...
	{
		func_9(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_83(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_75(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_83(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_83(iVar10, 14, uVar15[iVar1], -1) };
			func_51(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_66(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_52(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_75(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_75(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_53(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_53(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_53(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_53(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_85(int iParam0)
{
	...
	func_86(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_70(func_89(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_86(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_86(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_75(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_154()
{
	...
	{
		if (func_150(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_165()
{
	...
	{
		func_154();
		GRAPHICS::_0xBF59707B3E5ED531(func_166(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
void func_205()
{
	...
	{
		case 0:
			if (((!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && !AI::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
			{
...
void func_223()
{
	...
	switch (iLocal_56)
	{
		...
		case 1:
			...
			else if (!iLocal_305 && fLocal_313 >= 4f)
			{
				if (func_229(Local_314))
				{
					...
					{
						if ((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || AI::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							vVar3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
							vVar3.z = (vVar3.z + 1f);
							if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar3, &uVar2, 0, 0))
							{
								vVar3.z = uVar2;
			...
			else if (!iLocal_306 && fLocal_313 >= 0.25f)
			{
				if (func_229(Local_63))
				{
					...
					AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_359, "CRASH", Local_63, "NIGEL_03_SOUNDSET", 0, 0);
					iLocal_306 = 1;
				}
			}
		...
		case 2:
			...
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_63, false), vLocal_308, true) > 25f)
				{
			...
			if (bLocal_352)
			{
				UNK1::_0x293220DA1B46CEBC((fVar4 + 2.5f), 2f, 0);
			}
			else
			{
				UNK1::_0x293220DA1B46CEBC(fVar4, 2f, 0);
			}
			iLocal_56 = 0;
			iLocal_55 = 10;
			break;
...
void func_230(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_232(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_234(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_238(PLAYER::PLAYER_ID())) && !func_236(PLAYER::PLAYER_ID(), 0)) && !func_235()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_238(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_243()
{
	...
	switch (iLocal_56)
	{
		case 0:
			...
			if (WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_90[0], &(uLocal_93[0]), &(Local_94[0 /*7*/][0 /*3*/]), &(Local_94[0 /*7*/][1 /*3*/]), &(uLocal_95[0])) != 1 && WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_90[1], &(uLocal_93[1]), &(Local_94[1 /*7*/][0 /*3*/]), &(Local_94[1 /*7*/][1 /*3*/]), &(uLocal_95[0])) != 1)
			{
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_100) && STREAMING::HAS_MODEL_LOADED(iLocal_105)) && func_229(Local_63))
			{
				...
				if (func_229(PLAYER::PLAYER_PED_ID()) && func_229(iLocal_68))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_103, sLocal_100, "out_trunk_al", 1000f, -2f, 0, 0, 1148846080, 0);
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, 0f, -3f, -0.47f), 10f, 1, 0, 0, 0, false, 0);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_ENTITY_COORDS(Local_63, true), 10f, 1, 0, 0, 0, false, 0);
					if (bLocal_111)
					{
		...
		case 1:
			...
			if ((!iLocal_97 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > 500) && !bLocal_98)
			{
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_103) >= 0.852f && !iLocal_99)
			{
				...
				if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar1, &fVar3, 0, 0) && GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar2, &fVar4, 0, 0))
				{
				...
				if (bVar0)
				{
					...
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_100, "out_trunk_trevor", 1000f, -2f, -1, 0, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_103), 0, 0, 0);
					PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
				func_204(&iLocal_106);
			}
		...
		case 2:
			if ((func_229(PLAYER::PLAYER_PED_ID()) && func_229(iLocal_68)) && func_229(Local_63))
			{
				...
				AI::CLEAR_PED_TASKS(iLocal_68);
				AI::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
...
void func_248(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_250() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_250() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_249(iParam0));
...
bool func_252(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_250() /*12745*/].f_8178.f_10, iParam0);
}
	...
	switch (iLocal_56)
	{
		case 0:
			...
			if (iLocal_339 && iLocal_342)
			{
				...
				UNK1::_0x293220DA1B46CEBC(10f, 6f, 1);
				bLocal_357 = false;
				iLocal_351 = 0;
				iLocal_373 = 0;
				iLocal_56 = 1;
		...
		case 1:
			...
			if (func_229(Local_314))
			{
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_03_MIX_SETTINGS"))
				{
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_314, "NIGEL_03_MIX_GROUP", 0);
					AUDIO::START_AUDIO_SCENE("NIGEL_03_MIX_SETTINGS");
					VEHICLE::START_VEHICLE_HORN(Local_314, 30000, GAMEPLAY::GET_HASH_KEY("HELDDOWN"), 0);
					AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_360, "TRAIN_COMING", Local_314, "NIGEL_03_SOUNDSET", 0, 0);
				}
				func_290(0);
			}
			...
			{
				UI::CLEAR_THIS_PRINT("N3BAIL");
				UI::CLEAR_THIS_PRINT("N3EXIT");
			}
					...
					if (uLocal_355[1])
					{
						if (func_287())
						{
							...
							else
							{
								...
								if (iLocal_351)
								{
									iLocal_349 = (GAMEPLAY::GET_GAME_TIMER() - iLocal_349);
...
void func_278()
{
	...
	switch (iLocal_340)
	{
		case 0:
			...
			{
				iLocal_341 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_340 = 1;
			}
			break;
		
		case 1:
			if (func_229(iLocal_68) && GAMEPLAY::GET_GAME_TIMER() > iLocal_341)
			{
		...
		case 2:
			if (!func_209())
			{
				iLocal_341 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 2500));
				iLocal_340 = 1;
			}
			break;
	}
...
void func_279()
{
	...
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_281, "TRUNK_THUMPS", iLocal_68, 0, 0, 0);
		iLocal_283 = 0;
	}
}
	...
	if (func_229(Local_63))
	{
		switch (iLocal_283)
		{
			case 0:
				...
				iLocal_284 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3, 7);
				iLocal_285 = 1;
				iLocal_286 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_287 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(100, 250);
				iLocal_283 = 1;
				break;
			...
			case 1:
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_286) > iLocal_287)
					{
						if (ENTITY::GET_ENTITY_SPEED(Local_63) < 0.5f)
						{
							func_281();
...
void func_281()
{
	iLocal_288 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(-220, -120);
	fLocal_289 = (0.5f * SYSTEM::TO_FLOAT(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(-2, 3)));
}
	...
	if (bLocal_338)
	{
		if (func_229(Local_314))
		{
			...
			if (!bLocal_344)
			{
				if (vVar0.y < 1824.36f)
				{
					iLocal_345 = GAMEPLAY::GET_GAME_TIMER();
					bLocal_344 = true;
				}
			...
			{
				fVar1 = (75f - 25f);
				iVar3 = (GAMEPLAY::GET_GAME_TIMER() - iLocal_345);
				if (iVar3 < 11000)
				{
...
void func_285()
{
	...
	else if (!iLocal_351)
	{
		if (ENTITY::GET_ENTITY_SPEED(Local_63) > 2f && func_284())
		{
			iLocal_349 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_351 = 1;
		}
	}
}
...
void func_290(bool bParam0)
{
	...
	{
		if (iLocal_373 && UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
		{
			UI::CLEAR_HELP(1);
		}
		func_311();
...
int func_294(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_302() || func_301(Global_4456448.f_152990)) || func_300())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_298(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_295(int iParam0)
{
	if (iParam0 != func_297())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_296(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_317(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_387(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_319(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_331(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_343(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_345(Var7.f_1)) && iVar9 < 50)
			{
...
int func_356(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_8() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_70(func_357(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_359(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_374(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_360(iVar0, 0), true);
...
var func_376()
{
	...
	func_379(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_382(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_56)
	{
		case 0:
			...
			else
			{
				...
				if (!UI::DOES_BLIP_EXIST(iLocal_107))
				{
					iLocal_107 = func_316(Local_63, 1, 5);
				}
				if (!bLocal_294)
				...
				else if (WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_90[0], &(uLocal_93[0]), &(Local_94[0 /*7*/][0 /*3*/]), &(Local_94[0 /*7*/][1 /*3*/]), &(uLocal_95[0])) != 1 && WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_90[1], &(uLocal_93[1]), &(Local_94[1 /*7*/][0 /*3*/]), &(Local_94[1 /*7*/][1 /*3*/]), &(uLocal_95[0])) != 1)
				{
					if (uLocal_93[0] == 1 || uLocal_93[1] == 1)
					{
						func_310("N3TRUNK", -1);
		...
		case 1:
			...
			else
			{
				switch (iLocal_96)
				{
					...
					case 5:
						if (!iLocal_60 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_61) > 5000)
						{
							func_315("N3RTCAR", 7500, 1);
							func_396(&uLocal_324);
							iLocal_60 = 1;
						}
						if ((func_395(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, vLocal_87), 0.8f) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) && !((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || AI::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())))
						{
							iLocal_56 = 2;
							iLocal_57 = 1;
							iLocal_283 = 2;
		...
		case 2:
			...
			switch (iLocal_57)
			{
				...
				case 1:
					iLocal_90[0] = WORLDPROBE::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, vLocal_91[2 /*3*/]), vLocal_92[2 /*3*/], ENTITY::GET_ENTITY_ROTATION(Local_63, 2), 2, 19, 0, 4);
					iLocal_90[1] = WORLDPROBE::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, vLocal_91[3 /*3*/]), vLocal_92[3 /*3*/], ENTITY::GET_ENTITY_ROTATION(Local_63, 2), 2, 19, 0, 4);
					iLocal_55 = 8;
					break;
...
void func_397()
{
	if (func_229(Local_63))
	{
		iLocal_90[0] = WORLDPROBE::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, vLocal_91[0 /*3*/]), vLocal_92[0 /*3*/], ENTITY::GET_ENTITY_ROTATION(Local_63, 2), 2, 19, 0, 4);
		iLocal_90[1] = WORLDPROBE::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_63, vLocal_91[1 /*3*/]), vLocal_92[1 /*3*/], ENTITY::GET_ENTITY_ROTATION(Local_63, 2), 2, 19, 0, 4);
	}
}
...
void func_398()
{
	if (func_229(iLocal_68))
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_63, 0))
		{
			...
			{
				case 0:
					iLocal_291 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 12000));
					iLocal_290 = 1;
					break;
				
				case 1:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_291 && !func_209())
					{
						func_279();
						iLocal_290 = 2;
					}
...
void func_399()
{
	...
	switch (iLocal_58)
	{
					...
					if (iLocal_114 == 3)
					{
						if (!func_395(PLAYER::PLAYER_PED_ID(), vLocal_108, 150f))
						{
							if (func_273(&uLocal_115, Local_112[iLocal_114 /*8*/], Local_112[iLocal_114 /*8*/].f_1, 7, 0, 0, 0))
							{
								...
								if (iLocal_114 == 0)
								{
									UNK1::_0x293220DA1B46CEBC(2f, 5f, 0);
								}
								iLocal_58 = 4;
							}
						}
		...
		case 5:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_282) < 7500)
			{
				if (!bLocal_295)
				{
					func_310("N3REL1", -1);
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_282) > 10000)
			{
				if (iLocal_114 < 4)
				{
					iLocal_58 = 0;
		...
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_63, 0))
		{
			switch (iLocal_298)
			{
				...
				case 2:
					...
					{
						bLocal_299 = false;
						iLocal_300 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_298 = 3;
					}
					break;
				
				case 3:
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_300) > 8000)
					{
						iLocal_298 = 0;
					}
					break;
	...
	if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_63, 0))
	{
		switch (iLocal_301)
		{
			...
			case 2:
				if (!func_209())
				{
					iLocal_302 = GAMEPLAY::GET_GAME_TIMER() + 3000;
					iLocal_290 = 0;
					iLocal_301 = 3;
				}
				break;
			...
			case 3:
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_302)
				{
					iLocal_301 = 0;
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_63);
				}
	...
	switch (iLocal_56)
	{
		case 0:
			...
			if (func_474(1, 1093140480, 0))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(20.6534f, -1302.867f, 28.0513f, 15f, 0, 0, 0, 0, false, 0);
...
void func_420()
{
	if (func_229(iLocal_69))
	{
		...
		AI::TASK_PLAY_ANIM(iLocal_69, sLocal_72, sLocal_73, 1000f, -16f, -1, 1, 0f, 0, 0, 0);
		PED::_0x2208438012482A1A(iLocal_69, 1, 0);
		AI::TASK_LOOK_AT_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
void func_421()
{
	if (func_229(iLocal_70))
	{
		...
		AI::TASK_PLAY_ANIM(iLocal_70, sLocal_72, sLocal_75, 1000f, -16f, -1, 1, 0f, 0, 0, 0);
		PED::_0x2208438012482A1A(iLocal_70, 1, 0);
		AI::TASK_LOOK_AT_ENTITY(iLocal_70, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
void func_435()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(-39.5317f, -1257.184f, 28.2361f, 8f, 0);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_463(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_460(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_437(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
			...
			case 1:
				...
				else if (!iLocal_79)
				{
					if (func_498(iLocal_69, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_498(iLocal_70, 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						...
						AI::TASK_SMART_FLEE_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_69, true);
						AI::TASK_PLAY_ANIM(iLocal_70, sLocal_72, "Cower_Enter_MsT", 16f, -16f, -1, 0, 0f, 0, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_70, true);
					...
					else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_69, Local_63))
					{
						...
						AI::TASK_SMART_FLEE_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
						AI::TASK_SMART_FLEE_PED(iLocal_70, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
						iLocal_317 = 1;
						iLocal_316 = 2;
					}
						...
						switch (iLocal_315)
						{
							...
							case 1:
								if (iLocal_320 < 3)
								{
									...
									{
										if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_321) > 20000 && func_395(PLAYER::PLAYER_PED_ID(), vLocal_84, 30f))
										{
								...
								else if (iLocal_323 < 6)
								{
									if (!func_209() && func_229(PLAYER::PLAYER_PED_ID()))
									{
										if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_321) > 20000 && func_395(PLAYER::PLAYER_PED_ID(), vLocal_84, 30f)) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_312("N3DRIVE", 0, 0)))
										{
...
int func_518()
{
	...
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_63))
	{
		if (iLocal_66)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_67) > 7000)
			{
				iVar0 = 1;
			}
		}
...
void func_519()
{
	switch (iLocal_56)
	{
		case 0:
			func_242(&iLocal_107);
			UI::CLEAR_PRINTS();
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_378))
			{
				sLocal_378 = "DEFAULT";
			}
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_378, "DEFAULT"))
			{
				func_574(1);
			}
			else
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_526(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_537(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
void func_557()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("NIGEL3", 0);
	func_565(64, 2, 0);
	GAMEPLAY::CLEAR_BIT(&(Global_106070.f_18546.f_382), 5);
	if (func_229(PLAYER::PLAYER_PED_ID()))
	{
