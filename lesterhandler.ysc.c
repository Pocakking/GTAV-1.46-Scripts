		...
		if (!GAMEPLAY::IS_BIT_SET(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					AI::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar1, 8f, -8f, -1, 262152, 0, 2, 0);
					AI::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar1, 8f, -8f, -1, 262153, 0, 2, 0);
