...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_27(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_90805[iVar0]))
			{
	...
	if (Global_88350 != 8)
	{
		if (Global_88351 == -1)
		{
			...
			if (func_7())
			{
				...
				iVar12 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar9);
				switch (iVar12)
				{
					case 0:
						iVar11 = 19;
				...
				{
					Global_88351 = GAMEPLAY::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_8(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_BOX(vParam0, vParam1, 1, 1))
		{
			*uParam2++;
			if (*uParam2 > 6)
			{
		...
		else if ((FIRE::IS_EXPLOSION_IN_AREA(0, vParam0, vParam1) || FIRE::IS_EXPLOSION_IN_AREA(2, vParam0, vParam1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam1, joaat("weapon_grenadelauncher"), 1))
		{
			Global_88350 = 5;
		}
	}
...
void func_12(vector3 vParam0, vector3 vParam1, var uParam2)
{
	if ((PED::IS_PED_DUCKING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) || PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), vParam0, vParam1, 0, 1, 0))
		{
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > *uParam2 + 10000)
			{
				Global_88350 = 1;
			}
		}
...
void func_13(vector3 vParam0, vector3 vParam1)
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
	{
		...
		{
			if (GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam1, iVar0, 1))
			{
				Global_88350 = 0;
			}
		}
...
void func_32(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)
{
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		...
		else if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam5))
		{
...
{
	iParam0->f_1 = (func_36(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_41(int iParam0, vector3 vParam1, float fParam2)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_93282)
...
int func_42(int iParam0)
{
	...
	if (GAMEPLAY::GET_RANDOM_EVENT_FLAG() && Global_106060)
	{
		return 0;
	}
	if (!func_27(iParam0))
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_106070.f_9057.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_61(int iParam0)
{
	...
	while (iVar1 < Global_106070.f_7660.f_198)
	{
		...
		{
			func_62(Global_106070.f_7660.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_69()
{
	...
	while (iVar6 < 11)
	{
		...
		else if (!OBJECT::_DOES_DOOR_EXIST(iVar3))
		{
		}
		else
		{
