...
void __EntryFunction__()
{
	...
	GAMEPLAY::SET_BIT(&Global_71453, 7);
	...
	if (func_54(PLAYER::PLAYER_PED_ID()))
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 60f, 0);
	...
	if (CAM::DOES_CAM_EXIST(iLocal_181))
	{
		...
		iVar6 = GAMEPLAY::GET_GAME_TIMER() + 5000;
	}
	...
	while (GAMEPLAY::GET_GAME_TIMER() < iVar6)
	{
		SYSTEM::WAIT(0);
	}
	if (CAM::DOES_CAM_EXIST(iLocal_181))
	...
	iLocal_187 = GAMEPLAY::GET_GAME_TIMER() + 5000;
	func_8("FGND_SKIPRIDE", -1);
	CONTROLS::SET_PAD_SHAKE(0, 1000, 255);
	while (true)
	{
		func_6();
		func_15();
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_187)
		{
			if (fLocal_190 > 0.01f)
			{
				...
				iLocal_187 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(8000, 13000));
			}
		}
		if (iLocal_179 == 0)
		{
...
void func_6()
{
	...
	fVar0 = SYSTEM::TO_FLOAT(GAMEPLAY::ABSI((vLocal_192[iLocal_191 + 1 /*3*/] - vLocal_192[iLocal_191 /*3*/])));
...
void func_17(var uParam0)
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			CONTROLS::SET_PAD_SHAKE(0, iLocal_184, iLocal_185);
		}
	}
...
void func_19()
{
	...
	{
		case 0:
			fLocal_163 = (fLocal_163 + (GAMEPLAY::GET_FRAME_TIME() / 2f));
			if (fLocal_163 >= 5f)
			{
				fLocal_163 = 5f;
				iLocal_168 = 1;
		...
		case 2:
			fLocal_163 = (fLocal_163 - GAMEPLAY::GET_FRAME_TIME());
			if (fLocal_163 <= 0f)
			{
				fLocal_163 = 0f;
				iLocal_168 = 3;
...
void func_184(bool bParam0)
{
	...
	{
		UI::CLEAR_HELP(1);
		GAMEPLAY::CLEAR_BIT(&Global_71453, 7);
		func_1(500, 1);
	}
	func_225(303, 0, 0);
...
void func_191(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_193() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_193() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_192(iParam0));
...
bool func_196(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_193() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_226()
{
	...
	{
		func_214(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
