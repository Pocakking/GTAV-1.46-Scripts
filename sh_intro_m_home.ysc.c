...
void __EntryFunction__()
{
	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 1:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -871.9259f, 162.0005f, 52.99224f, -741.5948f, 155.0873f, 113.0255f, 90f, 0, true, 0))
					{
						...
						iLocal_50 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_37 = 2;
					}
				}
				break;
					...
					if (func_218(vVar0, vVar1, 100f) || iLocal_40)
					{
						if (func_215() || iLocal_40)
						{
							if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
							{
								...
								{
									INTERIOR::_LOAD_INTERIOR(iLocal_51);
									iLocal_41 = 1;
								}
							}
							if (INTERIOR::IS_VALID_INTERIOR(iLocal_52))
							{
								...
								{
									INTERIOR::_LOAD_INTERIOR(iLocal_52);
									iLocal_42 = 1;
								}
							}
							if (Global_105117)
							...
							if ((vVar0.z > 59f && vVar0.z < 90f) || iLocal_40)
							{
								if (func_219(&uLocal_53, vVar0) || iLocal_40)
								{
									if (func_209() || iLocal_40)
									{
										...
										{
											if ((iLocal_43 || STREAMING::IS_NEW_LOAD_SCENE_LOADED()) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > 12000)
											{
												STREAMING::NEW_LOAD_SCENE_STOP();
												iLocal_50 = GAMEPLAY::GET_GAME_TIMER();
												func_208(1);
			...
			case 3:
				if ((((INTERIOR::IS_VALID_INTERIOR(iLocal_51) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && INTERIOR::IS_VALID_INTERIOR(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > 500)
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					iLocal_50 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_38 = 0;
			...
			case 5:
				func_1(25);
				GAMEPLAY::SET_BIT(&(Global_2621447[17]), 1);
				GAMEPLAY::SET_BIT(&(Global_2621447[18]), 1);
				GAMEPLAY::SET_BIT(&(Global_2621447[19]), 1);
				func_223();
				break;
		}
		SYSTEM::WAIT(0);
...
void func_2()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_38)
		{
			case 0:
				if (func_198(0, 1093140480, 0))
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_COPS(-808.7974f, 169.3193f, 70.9558f, 150f, 0);
					GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(-808.7974f, 169.3193f, 70.9558f, 100f, 0);
			...
			case 1:
				...
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 12f;
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && INTERIOR::IS_VALID_INTERIOR(iLocal_51)) && INTERIOR::IS_VALID_INTERIOR(iLocal_52)) && INTERIOR::IS_INTERIOR_READY(iLocal_51)) && INTERIOR::IS_INTERIOR_READY(iLocal_52)) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > iVar5) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
			...
			case 2:
				...
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 10f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > iVar5) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
			...
			case 4:
				...
				vVar3 = { func_61(vVar1[0 /*3*/]) };
				fVar4 = 12f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > (iVar5 / 2)) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (CAM::_0xEE778F8C7E1142E2(CAM::_0x19CAFA3C87F7C2FF()) == 4 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) >= (iVar5 - 300))
					{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > iVar5)
				{
					iLocal_38 = 6;
				}
				break;
			...
			case 6:
				...
				if (CAM::DOES_CAM_EXIST(iLocal_46))
				{
					CAM::SET_CAM_ACTIVE(iLocal_46, 0);
		...
		if (iLocal_38 > 0 && iLocal_38 < 6)
		{
			...
			CONTROLS::SET_INPUT_EXCLUSIVE(2, 18);
			if (!iLocal_45)
			{
				if (func_4(1000))
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_49) > 1000)
					{
						iLocal_45 = 1;
					}
				}
...
void func_10()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			GAMEPLAY::CLEAR_AREA(-857.1225f, 157.4701f, 63.7638f, 5f, 1, 0, 0, false);
...
var func_32()
{
	...
	func_42(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_41(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_40(&uVar0, TIME::GET_CLOCK_HOURS());
	func_35(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_34(&uVar0, TIME::GET_CLOCK_MONTH());
	func_33(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_38(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_56(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_62(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_64(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_116(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_116(iVar10, 14, uVar15[iVar1], -1) };
			func_85(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_107(14);
			if (Global_71015 == 1)
			{
...
int func_66(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_181(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_181(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_86(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_112(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_110(iParam1)];
...
void func_118(int iParam0)
{
	...
	func_119(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_112(func_122(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_119(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_119(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_183()
{
	...
	{
		if (func_185(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
