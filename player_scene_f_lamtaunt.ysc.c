	...
	while (iLocal_289 && func_124(2, 0))
	{
		...
		switch (iLocal_98)
		{
			...
			case 2:
				if (func_120())
				{
					func_119(&uLocal_100, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_119(&uLocal_100, 2, Global_93018, "LAMAR", 0, 1);
					iLocal_98 = 3;
				}
				break;
...
int func_2()
{
	...
	{
		func_112(&(iLocal_290[iVar0]), iVar0);
		iVar0++;
	}
	func_112(&Global_93018, iLocal_290);
	func_3(Global_93018);
	return 0;
}
...
void func_3(int iParam0)
{
		...
		if (!iLocal_369 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_97(75, ENTITY::GET_ENTITY_COORDS(iParam0, false), 250f, -1);
						if (func_35(Global_89061, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_369 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_367 > 0)
		{
			if (iLocal_368 == 0)
			{
				if (iLocal_367 + 15000 < GAMEPLAY::GET_GAME_TIMER())
				{
			...
			else if (iLocal_367 + 10000 < GAMEPLAY::GET_GAME_TIMER())
			{
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)
{
	...
	switch (iVar3)
	{
		...
		case 2:
			if (Global_88333[2] == 65 || Global_88333[2] == 66)
			{
				return 0;
			}
	...
	{
		if (GAMEPLAY::ABSF((vVar1.z - vVar0.z)) > 2f)
		{
			return 0;
		}
	}
	...
	if (!CONTROLS::IS_CONTROL_JUST_PRESSED(0, 46) && !CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 46))
	{
		return 0;
	}
	if (!bVar5)
	...
	if (UI::DOES_TEXT_LABEL_EXIST(&cVar7))
	{
		iVar8 = 1;
	}
	else
	...
	if (iVar8 || func_26(sParam3, &Var4, uParam4))
	{
		if (iVar3 == 5)
		{
			if (iVar2 == 0)
			{
				func_119(uParam2, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (iVar2 == 1)
			{
				func_119(uParam2, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (iVar2 == 2)
			{
				func_119(uParam2, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		{
			func_119(uParam2, 0, PLAYER::PLAYER_PED_ID(), sVar0, 0, 1);
...
{
	if (UI::HAS_THIS_ADDITIONAL_TEXT_LOADED(sParam0, iParam1))
	{
		return 1;
	}
	else if (!func_25() && !AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		if (!UI::IS_STREAMING_ADDITIONAL_TEXT(iParam1))
		{
...
int func_26(char* sParam0, char* sParam1, var uParam2)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		if (UI::DOES_TEXT_LABEL_EXIST(&cVar0))
		{
			StringCopy(&cVar1, "", 16);
		}
		else
		...
		while (iVar6 < *uParam2)
		{
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam2[iVar6 /*4*/]))
			{
				iVar7 = 0;
				while (iVar7 < Var3)
				{
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Var3[iVar7 /*4*/])))
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam2[iVar6 /*4*/], &(Var3[iVar7 /*4*/])))
						{
							iVar8 = iVar7;
							while (iVar8 <= (Var3 - 1))
							{
		...
		iVar9 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar5 + 1);
...
void func_33()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_29(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_30(iVar0) && (!func_19(14) || Global_105021))
			{
...
int func_37(int iParam0, int iParam1, int iParam2)
{
	...
	return func_38(Global_106070.f_28022[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_41(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_43() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_43() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_42(iParam0));
...
bool func_47(int iParam0)
{
	if (iParam0 == 8)
	{
		return func_48(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_48(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_48(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_48(137, -1, -1);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_43() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_75(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14682)
	{
		...
		{
			func_79(Global_14494, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_76(1);
			func_79(Global_14494, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14493), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (Global_2458186)
							{
								if (iVar1 == 14)
								{
									func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16885), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2952[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2390[iVar1 /*15*/].f_4)
					{
						if (Global_2952[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16890), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71205)
								{
									...
									func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14513)
									...
									func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2390[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_77(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2952[iVar0] = 1;
						}
					}
...
void func_83()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_84(Global_106070.f_14113[iVar2 /*104*/].f_18, Global_106070.f_14113[Global_16889 /*104*/].f_18))
		{
			Global_16889 = iVar2;
		}
		iVar2++;
...
int func_86(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_87(&(Var1[0 /*4*/]), iVar2))
			{
				iParam2 = 1;
			}
			else if (func_87(&(Var1[1 /*4*/]), iVar2))
			{
				iParam2 = 0;
			}
			else
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			if (func_86(iParam0, iParam1, 0, &(Var0[0 /*4*/])) && func_86(iParam0, iParam1, 1, &(Var0[1 /*4*/])))
			{
				...
				if (func_87(&(Var0[0 /*4*/]), iVar1))
				{
					iParam2 = 1;
				}
				else if (func_87(&(Var0[1 /*4*/]), iVar1))
				{
					iParam2 = 0;
				}
				else
...
void func_97(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	Global_36118[iParam0 /*5*/] = { vParam1 };
	Global_36118[iParam0 /*5*/].f_3 = fParam2;
	Global_36118[iParam0 /*5*/].f_4 = iParam3;
}
...
int func_99(int iParam0, int iParam1)
{
	...
	bVar1 = false;
	if (GAMEPLAY::IS_BIT_SET(Var0.f_2, func_100()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_106070.f_7660.f_919[func_100()])
		{
			return 5;
		}
	}
...
int func_108(vector3 vParam0, bool bParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		switch (iLocal_292[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_349, &(Local_359[iParam1 /*16*/]), 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657) > fVar1)
					{
						if (func_118(vLocal_298[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
						...
						if (PED::IS_PED_INJURED(*iParam0))
						{
							...
							AI::TASK_GO_STRAIGHT_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90656) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
				{
					SYSTEM::WAIT(0);
					if (PED::IS_PED_INJURED(*iParam0))
					{
			...
			case 2:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(*iParam0, 713668775) != 1)
				{
					...
					AI::TASK_WANDER_IN_AREA(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (AI::IS_SCENARIO_TYPE_ENABLED(sLocal_365))
				{
					AI::SET_SCENARIO_TYPE_ENABLED(sLocal_365, false);
				}
				...
				{
					if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 1))
					{
						AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], fLocal_300[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					vVar6 = { func_113(vLocal_295 + vLocal_298[iParam1 /*3*/], func_116((fLocal_300[iParam1] * 0.9f), 10f, 100f), 0f) };
			...
			case 10:
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_293, Global_88331);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_88331, iLocal_293);
				AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(*iParam0, 15f, 0);
...
Vector3 func_113(vector3 vParam0, float fParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar3 < 10)
	{
		vVar0 = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-fParam1, fParam1), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-fParam1, fParam1), 0f };
		if (((vVar0.x * vVar0.x) + (vVar0.y * vVar0.y)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			vVar0.z = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-fVar2, fVar2);
			return vParam0 + vVar0;
		}
		iVar3++;
	}
	return func_114(vParam0, fParam1, fParam2);
}

Vector3 func_114(vector3 vParam0, float fParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_115(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
	vVar0.z = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_115(vector3 vParam0, float fParam1)
{
	float fVar0;
...
int func_120()
{
	...
	if (!func_121())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657);
			if (!iLocal_364)
			{
				if (fVar0 < fLocal_363)
				{
	...
	{
		func_112(&(iLocal_290[iVar1]), iVar1);
		iVar1++;
	}
	func_112(&Global_93018, iLocal_290);
	return 0;
	...
	if (!func_121())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			...
			while (iVar0 < iLocal_290)
			{
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_290[iVar0], Global_90657, &cLocal_349, &(Local_359[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_292[iVar0] = 0;
				}
				else
				{
			...
			PED::_DISPOSE_SYNCHRONIZED_SCENE(Global_90657);
			return 1;
		}
	}
	return 0;
...
int func_123()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90656))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_290)
		{
			if (!PED::IS_PED_INJURED(iLocal_290[iVar0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_290[iVar0], Global_90656, &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			func_119(&uLocal_100, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_93018))
		{
			func_119(&uLocal_100, 4, Global_93018, "LAMAR", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_290[0]))
		{
			func_119(&uLocal_100, 5, iLocal_290[0], "GangMember1", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_290[1]))
		{
			func_119(&uLocal_100, 6, iLocal_290[1], "GangMember2", 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_124(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_125(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_132()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_349))
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93018))
	{
		if (func_31(19) == ENTITY::GET_ENTITY_MODEL(Global_93018))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_93018, true, 1);
		}
		func_133(&Global_93018, Global_88331);
		PED::SET_PED_CONFIG_FLAG(Global_93018, 132, true);
		PED::SET_PED_CONFIG_FLAG(Global_93018, 317, true);
		func_133(&Global_93018, Global_88331);
	}
	...
	while (iVar0 < iLocal_290)
	{
		if (iLocal_291[iVar0] != 0)
		{
			...
			AI::TASK_PLAY_ANIM(iLocal_290[iVar0], &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -8f, -1, 9, 0f, 0, 0, 0);
...
void func_134()
{
	...
	iLocal_99 = Global_92700;
	func_138(iLocal_99, &vLocal_295, &fLocal_296, &cVar0);
	func_136(iLocal_99, &sLocal_301, &cLocal_317, &cLocal_333, &uVar1, &uVar2);
	switch (iLocal_99)
	{
		case 218:
			vLocal_297[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_297[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_298[0 /*3*/] = { -77.3f, -4.1f, 1f };
			vLocal_298[1 /*3*/] = { vLocal_298[0 /*3*/] };
			vLocal_298[iLocal_290 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_299[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_299[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_300[0] = 30f;
		...
		case 225:
			...
			Local_360 = { func_135("FRAS_IG_10", 3) };
			fLocal_363 = 0f;
			break;
...
struct<4> func_135(char* sParam0, int iParam1)
{
	struct<4> Var0;
	
	StringCopy(&Var0, sParam0, 16);
	switch (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iParam1))
	{
		case 0:
...
int func_136(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
	...
	switch (iParam0)
	{
		...
		case 305:
			func_137(iParam0, sParam1, sParam2, sParam3);
			return 1;
			break;
...
void func_137(int iParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
int func_138(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	int iVar0;
	
	if (func_140(iParam0, uParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
...
bool func_139(var uParam0)
{
	...
	*uParam0 = 5;
	...
	while (iVar3 < 5)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7201.f_11[iVar3], 0))
		{
			vVar4 = { Global_88530[iVar3 /*9*/].f_3 };
...
int func_140(int iParam0, var uParam1, char* sParam2)
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			if (iVar1 < 5)
			{
				*uParam1 = Global_88530[iVar1 /*9*/].f_6;
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_144(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_144(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_144(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_143(iParam0, &vVar0, uParam1))
			{
		...
		case 9:
			return func_140(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_140(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_140(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_140(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_140(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_140(303, uParam1, sParam2);
			break;
		...
		case 306:
			...
			*uParam1 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-vVar4.x, -vVar4.y);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 307:
			...
			*uParam1 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-vVar5.x, -vVar5.y);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 308:
			...
			*uParam1 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-vVar6.x, -vVar6.y);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 309:
			...
			*uParam1 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-vVar7.x, -vVar7.y);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
...
int func_141(int iParam0, int iParam1, var uParam2, var uParam3)
{
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_141(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_141(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_141(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_141(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 60:
			if (func_141(iParam0, 59, uParam2, uParam3))
			{
		...
		case 77:
			if (func_141(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
		...
		case 131:
			...
			{
				case 13:
					if (func_141(iParam0, 130, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) };
						*uParam3 = (*uParam3 + GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f));
						return 1;
...
void func_145()
{
	...
	if (!AI::IS_SCENARIO_TYPE_ENABLED(sLocal_365))
	{
		AI::SET_SCENARIO_TYPE_ENABLED(sLocal_365, true);
	}
