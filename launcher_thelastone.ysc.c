	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_105157[Var0 /*10*/].f_9 != -1)
			{
				...
				func_266(&(Global_105157[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
...
int func_182(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_173(2))
	{
		if (!func_145())
		{
			if (((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_188(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				...
				else
				{
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								CUTSCENE::REMOVE_CUTSCENE();
								CUTSCENE::_REQUEST_CUTSCENE_EX(sParam2, 5, 8);
								func_190(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::_REQUEST_CUTSCENE_EX(sParam2, 6, 8);
							func_190(*iParam0, 1);
							*uParam1 = 2;
						}
					}
