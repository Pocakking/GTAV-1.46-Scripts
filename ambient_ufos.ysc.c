	...
	while (true)
	{
		...
		switch (iLocal_71)
		{
			...
			case 3:
				...
				{
					iLocal_69 = (GAMEPLAY::GET_GAME_TIMER() - iLocal_68);
			...
			case 4:
				...
				func_7();
				func_6();
				if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_81 + iLocal_82))
				{
					func_4(&iLocal_80);
				}
...
void func_6()
{
	if (bLocal_92)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_87)
		{
			if (iLocal_89 != -1)
			{
				func_4(&iLocal_89);
				iLocal_87 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_86);
			}
			else
			{
				iLocal_89 = AUDIO::GET_SOUND_ID();
				AUDIO::PLAY_SOUND(iLocal_89, "ent_amb_elec_crackle", 0, 0, 0, 1);
				iLocal_87 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_84);
			}
		}
	}
}
...
void func_7()
{
	if (bLocal_91)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_88)
		{
			if (iLocal_90 != -1)
			{
				func_4(&iLocal_90);
				iLocal_88 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_85);
			}
			else
			{
				iLocal_90 = AUDIO::GET_SOUND_ID();
				AUDIO::PLAY_SOUND(iLocal_90, "spl_stun_npc_master", 0, 0, 0, 1);
				iLocal_88 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_83);
			}
		}
	}
}
