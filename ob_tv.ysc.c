...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_69))
		{
			...
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(iScriptParam_69))
			{
				func_67();
			}
					...
					switch (iLocal_29)
					{
						case 0:
							...
							if (iLocal_41 == 5)
							{
								...
								{
									uLocal_39 = OBJECT::_0xB48FCED898292E52(-809.962f, 170.919f, 75.7407f, 3f, "des_tvsmash");
									if (OBJECT::_0x52AF537A0C5B8AAD(uLocal_39))
									{
										OBJECT::_0x5C29F698D404C5E1(uLocal_39, 9);
									}
							...
							else
							{
								...
								Global_25519[iLocal_41 /*11*/] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2);
						...
						case 2:
							...
							if (!GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_44, "NULL"))
							{
							...
							if (!func_63(iLocal_41))
							{
								...
								GRAPHICS::SET_TV_CHANNEL(Global_25519[iLocal_41 /*11*/]);
							...
							else
							{
								...
								GRAPHICS::_0xF7B38B8305F1FE8B(iLocal_42, func_40(iLocal_43), Global_25519[iLocal_41 /*11*/].f_9);
...
void func_1()
{
	if (iLocal_41 != -1)
	{
		Global_25519[iLocal_41 /*11*/] = GRAPHICS::GET_TV_CHANNEL();
	}
...
void func_3()
{
	if (!iLocal_33 == -1)
	{
		UI::SET_TEXT_RENDER_ID(iLocal_33);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_35))
		{
...
void func_4()
{
	if (iLocal_65)
	{
		...
		if (!GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_53, "NULL"))
		{
...
float func_30(int iParam0)
{
	if (func_33(iParam0))
	{
		...
		{
			return (func_31(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
void func_52()
{
	...
	iLocal_33 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("tvscreen");
	func_3();
}
...
{
	iParam0->f_1 = (func_31(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
