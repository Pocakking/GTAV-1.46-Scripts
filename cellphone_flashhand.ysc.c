...
void __EntryFunction__()
{
	...
	if (Global_14495 == 0)
	{
		...
		{
			UI::GET_HUD_COLOUR(18, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			UI::GET_HUD_COLOUR(9, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			UI::GET_HUD_COLOUR(6, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
		}
		else
		{
			UI::GET_HUD_COLOUR(9, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			UI::GET_HUD_COLOUR(126, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
			UI::GET_HUD_COLOUR(6, &iLocal_60, &iLocal_61, &iLocal_62, &uLocal_63);
			func_99(Global_14494, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(iLocal_60), SYSTEM::TO_FLOAT(iLocal_61), SYSTEM::TO_FLOAT(iLocal_62), -1082130432);
		}
	...
	if (Global_71205)
	{
		...
		if (Global_4268543 == 0)
		{
			...
			if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var1) && NETWORK::_0x72D918C99BCACC54(0)) && Global_4268546 == 0)
			{
				...
				if (iVar2 == 0)
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_14494, "SET_BACKGROUND_CREW_IMAGE");
	...
	while (true)
	{
					...
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						else
						{
							...
							if (Global_14466[Global_14458 /*3*/].f_1 != Local_33.f_1)
							{
								...
								if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appemail")) < 1)
								{
									func_62();
								}
							}
		...
		if (!UI::IS_PAUSE_MENU_ACTIVE())
		{
			if (Global_14441.f_1 != Global_14459[Global_14458 /*3*/].f_1 || func_69())
			{
				if (Global_14513.f_1 > 3)
				{
					...
					if (!func_54() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-1641206367) == 0)
					{
		...
		if (Global_14681 == 0)
		{
			...
			func_45();
			func_44();
			UI::SET_TEXT_RENDER_ID(iLocal_39);
			if (Global_14499 == 1)
			{
		...
		else if (!GAMEPLAY::IS_BIT_SET(Global_2383, 23))
		{
			if (Global_14513.f_1 == 5 || Global_14513.f_1 == 6)
			{
				if (Global_14681 == 0)
				{
					if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appcamera")) < 1 && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appemail")) < 1)
					{
						if (Global_14456 == 0)
						{
		...
		else if (SCRIPT::HAS_SCRIPT_LOADED(&(Global_2390[Global_14516 /*15*/].f_5)))
		{
			if (Global_14516 == 0)
			{
				if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_2390[Global_14516 /*15*/].f_9) == 0)
				{
			...
			else
			{
				...
				else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_2390[Global_14516 /*15*/].f_9) == 0)
				{
...
void func_7()
{
	...
	if (iLocal_40 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_18) > 500)
	{
		CONTROLS::SET_INPUT_EXCLUSIVE(0, Global_14483);
		if (Global_14513.f_1 == 3)
		{
		...
		SYSTEM::SETTIMERA(0);
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_2390[2 /*15*/].f_9) == 0)
		{
...
float func_13(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_15((SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
...
void func_18()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2384, 10) || iLocal_72 == 1)
	{
...
void func_43()
{
	...
	else if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appemail")) < 1)
	{
			...
			else if (Global_15822 == 4 || Global_15822 == 3)
			{
				...
				else
				{
					...
					if (Global_106070.f_28022[Global_1698 /*29*/].f_24[Global_14513] == 0)
					{
						...
						func_72(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1698 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_99(Global_14494, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_72(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), &(Global_106070.f_28022[Global_1698 /*29*/].f_7), &cVar0, &(Global_106070.f_28022[Global_1698 /*29*/].f_3), 0);
					}
				}
				func_99(Global_14494, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_72(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_80()
{
	...
	iLocal_68 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 8);
	if (iLocal_68 < 2)
	{
		if (iLocal_43 > 2)
		{
	...
	func_99(Global_14494, "SET_PROVIDER_ICON", SYSTEM::TO_FLOAT(iLocal_42), SYSTEM::TO_FLOAT(iLocal_43), -1082130432, -1082130432, -1082130432);
}
...
int func_81()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_86(iVar0))
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660[iVar2 /*15*/].f_2, iVar0))
				{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_651[iVar2 /*14*/].f_2, iVar0))
				{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_106070.f_7660.f_765[iVar2 /*10*/].f_2, iVar0))
				{
...
int func_84(vector3 vParam0, int iParam1)
{
	if (iParam1 != -1)
	{
		...
		if (SYSTEM::VDIST2(vParam0, Global_36118[iParam1 /*5*/]) <= (Global_36118[iParam1 /*5*/].f_3 * Global_36118[iParam1 /*5*/].f_3))
		{
			return 1;
		}
...
void func_97()
{
	...
	iLocal_45 = TIME::GET_CLOCK_MINUTES();
	if (iLocal_45 != Global_2386)
	{
		Global_2386 = iLocal_45;
		iLocal_44 = TIME::GET_CLOCK_HOURS();
		iLocal_46 = TIME::GET_CLOCK_DAY_OF_WEEK();
		switch (iLocal_46)
		{
			case 0:
		...
		func_72(Global_14494, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_44), SYSTEM::TO_FLOAT(iLocal_45), -1f, -1f, -1f, &Local_47, 0, 0, 0, 0);
		if (Global_14456 == 0)
		{
			func_80();
		}
...
void func_106()
{
	...
	if (GAMEPLAY::IS_PC_VERSION())
	{
		...
		else if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_70) >= 300 || iLocal_70 == 0) || iLocal_70 > GAMEPLAY::GET_GAME_TIMER())
		{
	...
	{
		if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_70) >= 300 || iLocal_70 == 0) || iLocal_70 > GAMEPLAY::GET_GAME_TIMER())
		{
			CONTROLS::SET_PAD_SHAKE(0, 100, 100);
			iLocal_70 = GAMEPLAY::GET_GAME_TIMER();
		}
