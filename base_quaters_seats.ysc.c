...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 1:
			if (func_50(uParam0))
			{
				uParam0->f_29.f_6 = GAMEPLAY::GET_GAME_TIMER();
				func_51(uParam0, 2);
			}
			break;
		...
		case 2:
			if (func_49(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_29.f_6) > 150)
					{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				...
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0, 2) };
				iVar5 = vVar4.z;
				AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar3, 1f, 500, iVar5, 0.15f);
			}
			func_51(uParam0, 5);
			break;
		...
		case 5:
			...
			if (Var2 == 3)
			{
				iVar6 = AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 1920390111);
			}
			else
			{
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				uParam0->f_29.f_8.f_4 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
		...
		case 8:
			iVar8 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_29.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_29.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!UI::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_29), 0)) && !func_8(&(uParam0->f_29), 4)) && !func_21()) && !func_19(1)) && uParam0->f_29.f_8.f_2 != 3)
			{
...
int func_42(var uParam0)
{
	...
	switch (uParam0->f_29.f_8)
	{
		...
		default:
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, func_14(uParam0->f_29.f_8));
	}
	return iVar0;
}
...
void func_53(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		uParam0->f_29.f_7 = GAMEPLAY::GET_FRAME_COUNT();
	}
	...
	else if ((GAMEPLAY::GET_FRAME_COUNT() - uParam0->f_29.f_7) < 5)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_54(uParam0));
	}
}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_29), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_71()
{
	if (Global_1589596 != func_59())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1589596, 1, 0))
		{
			return 0;
		}
...
void func_72()
{
	func_75(2, &uLocal_153, 0);
	func_75(3, &uLocal_153, 1);
	func_73(&uLocal_153, 6564);
}
...
void func_75(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_78(func_79(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_78(func_77(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_78(func_76(), fVar1) + vVar0 };
...
Vector3 func_79()
{
	return func_78(Vector(-60f, 4841.945f, 362.58f) - func_80(), (180f - -66.83f));
}
...
void func_82()
{
	func_83(2, &uLocal_153, 0);
	func_83(3, &uLocal_153, 1);
}
...
void func_83(int iParam0, var uParam1, int iParam2)
{
	...
	func_88(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = 5;
	(uParam1[iParam2 /*14*/])->f_8 = { func_78(func_86(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_78(func_85(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_78(func_84(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
Vector3 func_86()
{
	return func_78(Vector(-60f, 4845.8f, 364.74f) - func_87(), -4f);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1589747[iParam0 /*790*/].f_273.f_262.f_1, 0);
}
