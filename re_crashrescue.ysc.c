...
void func_1()
{
	switch (iLocal_269)
	{
		case 0:
			if (func_19(iLocal_67))
			{
				...
				if (!func_333())
				{
					...
					iLocal_270 = GAMEPLAY::GET_GAME_TIMER() + 6000;
					if (bLocal_272)
					{
		...
		case 1:
			if (func_19(iLocal_67))
			{
				if (func_8(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_270)
				{
					iLocal_269++;
				}
			}
		...
		case 2:
			if (!func_333())
			{
				...
				iLocal_270 = GAMEPLAY::GET_GAME_TIMER() + 500;
				iLocal_269++;
			}
			break;
		
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_270 && CAM::IS_SCREEN_FADED_IN())
			{
				if (!PED::IS_PED_INJURED(iLocal_67))
				{
					...
					iLocal_270 = GAMEPLAY::GET_GAME_TIMER() + 2000;
					iLocal_269++;
				}
			}
			break;
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_270 && func_8(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0)) || GAMEPLAY::GET_GAME_TIMER() > iLocal_270 + 6000)
			{
				func_316();
			}
			break;
...
void func_3()
{
	...
	{
		if (func_7(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
	...
	switch (iLocal_53)
	{
		case 0:
			...
			if (iVar0 == 1)
			{
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_68, true), 20f, 1, 0, 0, false);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_68, true), 20f, 0);
				SYSTEM::WAIT(0);
				iLocal_53 = 1;
			}
			break;
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67) && !PED::IS_PED_INJURED(iLocal_68))
			{
				if (func_70(&uLocal_76, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					GAMEPLAY::CLEAR_AREA(vLocal_56, 4f, 1, 0, 0, false);
					func_60(&iVar1);
					iLocal_259 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, vLocal_73, 2);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_259, sLocal_257, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, sLocal_257, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_28()
{
	...
	{
		func_30(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
void func_51(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_52(iParam0));
...
int func_61(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar1 = { func_62() };
...
void func_63(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_67(PLAYER::PLAYER_ID())) && !func_65(PLAYER::PLAYER_ID(), 0)) && !func_64()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_67(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_71(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_73(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_124(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_124(iVar10, 14, uVar15[iVar1], -1) };
			func_94(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_116(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_84(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_84(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_126(int iParam0)
{
	...
	func_127(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_127(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_127(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_84(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_188(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_203()
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		else if (GAMEPLAY::GET_GAME_TIMER() < iLocal_270)
		{
			...
			if (func_215())
			{
				...
				if (bLocal_244)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), 1) || func_208(iLocal_68, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
						...
						AI::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				...
				if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_67) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_ON_ANY_BIKE(iLocal_67))
					{
						...
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, -2017877118) == 7)
						{
							AI::TASK_PLAY_ANIM(iLocal_67, sLocal_256, "LOOP", 2f, -8f, -1, 1, 0f, 0, 0, 0);
						}
					}
				}
			}
...
void func_206()
{
	if (!bLocal_244 && func_214(PLAYER::PLAYER_PED_ID(), vLocal_56, 150f))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			...
			iLocal_259 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, vLocal_73, 2);
			AI::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, sLocal_257, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_244 = true;
		}
	}
}
...
int func_210(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_211(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_215()
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iLocal_67, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		...
		else if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_67, -828834893) == 7)
				{
					AI::CLEAR_PED_TASKS(iLocal_67);
	...
	else if (UI::DOES_BLIP_EXIST(iLocal_65))
	{
...
int func_219(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_211(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
...
int func_225()
{
	...
	{
		if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID()))))
		{
			return 1;
		}
	}
...
void func_227()
{
	switch (iLocal_54)
	{
		case 0:
			iLocal_59 = 0;
			iLocal_54 = 1;
			iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			break;
		...
		case 2:
			...
			{
				iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 1500;
				iLocal_59 = 0;
				iLocal_54 = 3;
			}
			break;
		...
		case 3:
			...
			{
				iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 6000;
				iLocal_59 = 0;
				iLocal_54 = 4;
			}
			break;
		...
		case 4:
			if (iLocal_59 == 0)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_58 && !func_333())
				{
					if (func_215())
					{
			...
			else if (iLocal_59 == 3)
			{
				if (!func_333())
				{
					...
					if (iLocal_64 < 3)
					{
						iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 20000;
						iLocal_59 = 0;
					}
					else
					{
...
void func_228(int iParam0, bool bParam1)
{
	if (!func_333())
	{
		...
		else
		{
			...
			iLocal_58 = (GAMEPLAY::GET_GAME_TIMER() + iParam0);
		}
	}
}
	...
	switch (iLocal_63)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_72, &(vLocal_72.f_2), 0, 0);
				vLocal_73 = { func_235() };
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), 5f, 1, 0, 0, false);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_67, true), 20f, 0);
				...
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
		...
		case 4:
			...
			if (iLocal_242)
			{
				...
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_67);
			...
			else
			{
				if (!bLocal_243)
				{
					...
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sVar1, "idle_intro", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				}
				CAM::_0xC819F3CBB62BF692(0, 0, 3, 0);
			}
			iLocal_242 = 0;
			iLocal_270 = (GAMEPLAY::GET_GAME_TIMER() + 180000);
			iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 3000;
...
int func_233()
{
	...
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar2), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar1 = { func_62() };
		if ((vVar0[1 /*3*/] - vVar0[0 /*3*/]) > vVar1.x)
		{
			return 0;
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_333())
						{
							...
							{
								iLocal_65 = func_248(iLocal_67, 1, 1, 5);
								UI::_0x75A16C3DA34F1245(iLocal_65, false);
							}
							func_8(&uLocal_76, "RECRAAU", "RECRA_PLEAD", 3, 0, 0, 0);
							AI::TASK_LOOK_AT_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 18000;
							iLocal_60 = 2;
						}
						break;
					...
					case 2:
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_58 && !func_333())
						{
							...
							iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 12000;
							iLocal_60 = 3;
						}
						break;
					...
					case 3:
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_58 && !func_333())
						{
							...
							iLocal_58 = GAMEPLAY::GET_GAME_TIMER() + 9500;
						}
						break;
					}
				}
...
int func_241()
{
	switch (func_242(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_254()
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_67, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_255()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_MODEL_LOADED(iLocal_248)) && STREAMING::HAS_MODEL_LOADED(iLocal_247)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_249)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_253)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_254)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_252)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		GAMEPLAY::GET_MODEL_DIMENSIONS(iLocal_248, &uVar0, &vVar1);
		...
		AI::TASK_PLAY_ANIM(iLocal_67, sLocal_249, "BASE", 8f, -8f, -1, 9, 0f, 0, 0, 0);
		if (func_19(iLocal_67))
		{
...
int func_273(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_308(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_286(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_289()
{
	...
	func_292(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_291(&uVar0, TIME::GET_CLOCK_MONTH());
	func_290(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_306()) || Global_105117) || Global_25461) || func_305()) || func_16(8, -1)) || func_304()) || func_303()) || func_302()) || func_301()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_306()) || Global_25461) || func_305()) || func_16(8, -1)) || func_302()) || func_304()) || func_303()) || func_301()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_306()) || Global_105117) || Global_25461) || func_305()) || func_16(8, -1)) || func_304()) || func_303()) || func_301()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_306() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_16(8, -1)) || func_301()) || func_300()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_306()) || Global_25461) || func_305()) || func_16(8, -1)) || func_303()) || func_302()) || func_301()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_306()) || func_303()) || Global_105117) || Global_25461) || func_305()) || Global_37271) || func_16(8, -1)) || func_302()) || func_300()) || func_301()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_306()) || Global_105117) || Global_25461) || func_305()) || func_16(8, -1)) || func_302()) || func_300()) || func_304()) || func_303()) || func_301())
						{
							return 0;
						}
						break;
