...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_85(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_88.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
				...
				case 3:
					...
					else
					{
						...
						if (!func_71(3) && !Global_93266)
						{
							...
							{
								if ((!func_85(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_70())) && !Global_93266)
								{
									func_78(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_45(uLocal_54))
								{
									...
									else if (!func_85(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_43(&iLocal_60);
