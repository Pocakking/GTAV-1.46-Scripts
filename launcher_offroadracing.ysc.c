...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_136(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_274.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
				...
				case 3:
					...
					else
					{
						...
						if (!func_108(3) && !Global_93266)
						{
							...
							{
								if ((!func_136(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_107())) && !Global_93266)
								{
									func_129(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_86(iLocal_54))
								{
									...
									else if (!func_136(uLocal_58, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_84(&iLocal_60);
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_136(Global_104721, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_30(iLocal_63), 0, Global_93269, 0);
...
void func_19(char[4] cParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_63()
{
	...
	{
		if (func_66(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_95, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_266)
		{
			...
			case 1:
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_95, iVar1);
				AI::CLEAR_SEQUENCE_TASK(&iVar1);
				iLocal_266 = 2;
				break;
			
			case 2:
				if ((AI::GET_SCRIPT_TASK_STATUS(iLocal_95, 242628503) != 1 || PED::IS_PED_FACING_PED(iLocal_95, PLAYER::PLAYER_PED_ID(), 20f)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_95, PLAYER::PLAYER_PED_ID(), -1);
					if (!iLocal_100)
					{
			...
			case 3:
				...
				{
					func_33(&iLocal_87);
					AI::TASK_PLAY_ANIM(iLocal_95, "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0f, 0, 0, 0);
					iLocal_266 = 4;
				}
				break;
			...
			case 4:
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_95, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 225f)
				{
					...
					AI::TASK_ACHIEVE_HEADING(0, Local_267.f_83.f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_267.f_83.f_12, Local_267.f_83.f_13, 4f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar2);
					AI::TASK_PERFORM_SEQUENCE(iLocal_95, iVar2);
...
void func_74()
{
	...
	while (iVar2 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_267[iVar2 /*14*/].f_1) && ENTITY::DOES_ENTITY_EXIST(Local_267[iVar2 /*14*/]))
		{
				...
				if (func_26(&(vLocal_83[iVar2 /*3*/])))
				{
					if (func_23(&(vLocal_83[iVar2 /*3*/])) > fLocal_93[iVar2])
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_267[iVar2 /*14*/].f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_267[iVar2 /*14*/], Local_267[iVar2 /*14*/].f_1, 0))
						{
							...
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_267[iVar2 /*14*/].f_1, 1, iVar0);
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_267[iVar2 /*14*/].f_1, 31, iVar1);
							AI::CLOSE_SEQUENCE_TASK(iVar3);
							if (!PED::IS_PED_INJURED(Local_267[iVar2 /*14*/]))
							{
								AI::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
							}
							AI::CLEAR_SEQUENCE_TASK(&iVar3);
						}
						func_33(&(vLocal_83[iVar2 /*3*/]));
						fLocal_93[iVar2] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
					}
				}
				else
				{
			...
			{
				if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_267[iVar2 /*14*/]) && !PED::IS_PED_RAGDOLL(Local_267[iVar2 /*14*/])) && !AI::IS_PED_GETTING_UP(Local_267[iVar2 /*14*/]))
				{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iVar3);
					AI::TASK_ACHIEVE_HEADING(0, Local_267[iVar2 /*14*/].f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_12, Local_267[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
					AI::CLEAR_SEQUENCE_TASK(&iVar3);
					Local_267[iVar2 /*14*/].f_11 = 0;
				}
				if (PED::IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]) || AI::IS_PED_GETTING_UP(Local_267[iVar2 /*14*/]))
				{
					if (!Local_267[iVar2 /*14*/].f_10 && (PED::IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]) || AI::IS_PED_GETTING_UP(Local_267[iVar2 /*14*/])))
					{
						Local_267.f_101++;
					}
				...
				else if (Local_267[iVar2 /*14*/].f_10)
				{
					...
					AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_ACHIEVE_HEADING(0, Local_267[iVar2 /*14*/].f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_12, Local_267[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_267.f_83.f_1) && ENTITY::DOES_ENTITY_EXIST(Local_267.f_83))
	{
			...
			if (func_26(&iLocal_84))
			{
				if (func_23(&iLocal_84) > fLocal_94)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_267.f_83.f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_267.f_83, Local_267.f_83.f_1, 0))
					{
						...
						iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
						AI::OPEN_SEQUENCE_TASK(&iVar3);
						AI::TASK_VEHICLE_TEMP_ACTION(0, Local_267.f_83.f_1, 1, iVar0);
						AI::TASK_VEHICLE_TEMP_ACTION(0, Local_267.f_83.f_1, 31, iVar1);
						AI::CLOSE_SEQUENCE_TASK(iVar3);
						if (!PED::IS_PED_INJURED(Local_267.f_83))
						{
							AI::TASK_PERFORM_SEQUENCE(Local_267.f_83, iVar3);
						}
						AI::CLEAR_SEQUENCE_TASK(&iVar3);
					}
					func_33(&iLocal_84);
					fLocal_94 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
				}
			}
			else
			{
		...
		{
			if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_267.f_83) && !PED::IS_PED_RAGDOLL(Local_267.f_83)) && !AI::IS_PED_GETTING_UP(Local_267.f_83))
			{
			...
			if (PED::IS_PED_RAGDOLL(Local_267.f_83) || AI::IS_PED_GETTING_UP(Local_267.f_83))
			{
			...
			else if (Local_267.f_83.f_10)
			{
				...
				AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::TASK_ACHIEVE_HEADING(0, Local_267.f_83.f_9, 1000);
				AI::TASK_PLAY_ANIM(0, Local_267.f_83.f_12, Local_267.f_83.f_13, 8f, -8f, -1, 0, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iVar3);
				AI::TASK_PERFORM_SEQUENCE(Local_267.f_83, iVar3);
				AI::CLEAR_SEQUENCE_TASK(&iVar3);
				iLocal_266 = 4;
...
void func_77()
{
	...
	while (iVar2 < iVar0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iVar0[iVar2]) && !PED::IS_PED_INJURED(iVar0[iVar2]))
		{
			...
			{
				AI::TASK_SMART_FLEE_PED(iVar0[iVar2], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
			else
			{
				AI::OPEN_SEQUENCE_TASK(&iVar1);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(300, 900));
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iVar1);
				AI::TASK_PERFORM_SEQUENCE(iVar0[iVar2], iVar1);
				AI::CLEAR_SEQUENCE_TASK(&iVar1);
			}
		}
		iVar2++;
...
int func_79(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
		{
			...
			if (GAMEPLAY::IS_PROJECTILE_IN_AREA((vVar1.x - 5f), (vVar1.y - 5f), (vVar1.z - 5f), (vVar1.x + 5f), (vVar1.y + 5f), (vVar1.z + 5f), 0))
			{
				return 1;
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_105()) || Global_105117) || Global_25461) || func_104()) || func_90(8, -1)) || func_103()) || func_102()) || func_101()) || func_92()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_105()) || Global_25461) || func_104()) || func_90(8, -1)) || func_101()) || func_103()) || func_102()) || func_92()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_105()) || Global_105117) || Global_25461) || func_104()) || func_90(8, -1)) || func_103()) || func_102()) || func_92()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_105() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_90(8, -1)) || func_92()) || func_100()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_105()) || Global_25461) || func_104()) || func_90(8, -1)) || func_102()) || func_101()) || func_92()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_105()) || func_102()) || Global_105117) || Global_25461) || func_104()) || Global_37271) || func_90(8, -1)) || func_101()) || func_100()) || func_92()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_105()) || Global_105117) || Global_25461) || func_104()) || func_90(8, -1)) || func_101()) || func_100()) || func_103()) || func_102()) || func_92())
						{
							return 0;
						}
						break;
	...
	if (bLocal_96)
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar1))
		{
			if (AI::DOES_SCENARIO_GROUP_EXIST(sVar1))
			{
				...
				{
					AI::SET_SCENARIO_GROUP_ENABLED(sVar1, true);
				}
			}
		}
	}
...
void func_112()
{
	...
	if (fLocal_74 > 9f)
	{
		...
		while (iVar5 < Local_267)
		{
			if (!func_117(Local_267[iVar5 /*14*/].f_2))
			{
				...
				else
				{
					...
					AI::TASK_PLAY_ANIM(0, sVar3, sVar4, 8f, -8f, -1, 8193, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
					AI::TASK_PERFORM_SEQUENCE(Local_267[iVar5 /*14*/], iVar0);
		...
		else
		{
			...
			AI::TASK_PLAY_ANIM(0, "amb@world_human_aa_smoke@male@idle_a", sVar4, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(iVar0);
			AI::TASK_PERFORM_SEQUENCE(Local_267.f_83, iVar0);
			AI::CLEAR_SEQUENCE_TASK(&iVar0);
		}
	}
...
void func_121()
{
	switch (iLocal_82)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-227.43f, 3888.9f, 36.41f, 50f, 1, 0, 0, 0, false, 0);
		...
		case 3:
			...
			GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(-1943.822f, 4462.286f, 0f, -229.0783f, 4227.072f, 50f, 250f, 0, 0, 0, 0, 0, 0);
		...
		case 5:
			...
			GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(2242.488f, 2568.146f, -10f, 2242.488f, 1568.146f, 200f, 1000f, 0, 0, 0, 0, 0, 0);
			break;
		
		case 2:
			AI::SET_SCENARIO_GROUP_ENABLED("QUARRY", false);
			PATHFIND::SET_ROADS_IN_ANGLED_AREA(2809.948f, 2993.644f, -9.3564f, 2952.969f, 2530.636f, 177.1921f, 500f, 1, false, 1);
			GAMEPLAY::CLEAR_ANGLED_AREA_OF_VEHICLES(2809.948f, 2993.644f, -9.3564f, 2952.969f, 2530.636f, 177.1921f, 500f, 0, 0, 0, 0, 0, 0);
			break;
	}
}
...
bool func_138(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_25834[iVar0 /*23*/].f_11, 15);
	}
	return GAMEPLAY::IS_BIT_SET(Global_25834[iVar0 /*23*/].f_11, 0);
}
