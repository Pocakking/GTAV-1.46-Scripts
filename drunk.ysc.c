...
void func_12(char* sParam0, var uParam1, char* sParam2)
{
	...
	GAMEPLAY::CLEAR_AREA(uParam1->f_5, 5f, 1, 0, 0, false);
	...
	if (!func_47(uParam1->f_22, 0f, 0f, 0f, 0))
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 0, 0, 0, 0, false, 0);
		GAMEPLAY::CLEAR_AREA(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 1, 0, 0, false);
	}
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
	...
	GAMEPLAY::CLEAR_AREA(uParam1->f_5, 15f, 1, 0, 0, false);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), uParam1->f_16, uParam1->f_17, 1000f, -1.5f, 10000, 33, 0f, 0, 0, 0);
		}
	}
	else
	{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar4))
	{
		...
		while (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar4) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			func_35(0);
			iVar15 = GAMEPLAY::GET_GAME_TIMER();
			...
			iVar18 = 0;
			if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY(sVar13)))
			{
				iVar19 = (CONTROLS::GET_CONTROL_VALUE(2, 195) - 128);
				iVar20 = (CONTROLS::GET_CONTROL_VALUE(2, 196) - 128);
			...
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4 && uParam1->f_52 > 0f)
			{
				if (fVar0 >= uParam1->f_52)
				{
					if (!uParam1->f_32)
					{
						...
						fVar24 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar22, vVar23, 1);
						...
						fVar33 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar31, vVar32, 1);
			...
			if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY(sVar14)) || iVar18)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					switch (uParam1->f_4)
					{
						...
						case -668482597:
							...
							if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
							{
								...
								fVar43 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar41, vVar42, 1);
...
int func_51(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		SYSTEM::WAIT(0);
		GAMEPLAY::CLEAR_AREA(vParam0, 5000f, 1, 0, 0, false);
...
int func_97(int iParam0)
{
	...
	if (func_100(Local_43.f_1))
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar2) && !GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar3))
		{
			...
			if (!PED::IS_PED_INJURED(Local_43.f_1))
			{
				AI::TASK_PLAY_ANIM(Local_43.f_1, sVar2, sVar3, 1.5f, -1.5f, -1, 48, 0f, 0, 0, 0);
				sLocal_50 = sVar3;
			}
		}
	}
...
bool func_104(int iParam0)
{
	...
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(vLocal_52.z))
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar1))
		{
			return 1;
	...
	return GAMEPLAY::ARE_STRINGS_EQUAL(vLocal_52.z, sVar1);
}
...
bool func_110()
{
	...
	fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vVar1, 1);
	return fVar2 < 7f;
}
...
void func_111()
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_50))
	{
		if (!func_100(Local_43.f_1))
		{
			...
			{
				AI::STOP_ANIM_TASK(Local_43.f_1, sVar1, sLocal_50, -4f);
			}
			sLocal_50 = "";
			return;
		}
...
void func_127()
{
	...
	func_128();
	AI::TASK_ENTER_VEHICLE(Local_43.f_1, Local_43.f_4, -1, iVar4, 2f, 1, 0);
	vLocal_52.x = 7;
}
