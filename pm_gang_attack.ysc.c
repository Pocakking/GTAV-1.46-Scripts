...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			iLocal_212 = GAMEPLAY::GET_GAME_TIMER();
		}
		func_1();
	}
}
...
void func_1()
{
	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar1 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_104780.f_225[iVar1]))
					{
						uLocal_221[iVar1] = Global_104780.f_225[iVar1];
						Global_104780.f_225[iVar1] = 0;
				...
				while (iVar1 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_104780.f_222[iVar1]))
					{
						uLocal_220[iVar1] = Global_104780.f_222[iVar1];
						Global_104780.f_222[iVar1] = 0;
	...
	while (iVar1 <= 5)
	{
		...
		if (UI::DOES_BLIP_EXIST(uLocal_223[iVar1]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar1]) || PED::IS_PED_INJURED(uLocal_221[iVar1]))
			{
				UI::REMOVE_BLIP(&(uLocal_223[iVar1]));
			}
		}
		iVar1++;
	}
...
void func_9()
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar0]) && !PED::IS_PED_INJURED(uLocal_221[iVar0]))
		{
			...
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						AI::TASK_COMBAT_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						AI::TASK_SMART_FLEE_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 1, 0);
					}
					break;
				}
		}
	...
	switch (iLocal_211)
	{
		...
		case 3:
			if ((func_31() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_212) > 3000) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
			{
		...
		case 4:
			if (func_31() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_212) > 1000)
			{
				iVar4 = func_30();
				if (iVar4 != -1 && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_221[iVar4]))
				{
	...
	if (!func_36(vParam1))
	{
		...
		if (iVar0 == joaat("weapon_molotov"))
		{
			...
			if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 0)
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iParam0, iVar2);
		...
		{
			AI::TASK_SHOOT_AT_COORD(iParam0, vParam1, -1, -687903391);
		}
	}
...
Vector3 func_34(vector3 vParam0, float fParam1)
{
	...
	return vParam0 + func_35(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1));
}
...
int func_37(int iParam0)
{
	...
	if (((((((((((func_38(Global_104780.f_35, 134217728) || PED::_0x6CD5A433374D4CFB(uLocal_221[iParam0], PLAYER::PLAYER_PED_ID())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uLocal_221[iParam0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_221[iParam0])) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f, 1)) || GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f, 1, 1)) || FIRE::IS_EXPLOSION_IN_SPHERE(21, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(10, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(7, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(0, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(1, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], true), 15f)) || iLocal_219)
	{
		return 1;
	}
	return 0;
				...
				case 1:
					...
					else if (!PED::IS_PED_IN_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
					{
						if (func_5(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 1) > 4f)
						{
							if (!func_32(uLocal_221[iVar0], 780511057, 1))
							{
								PED::_0xE4723DB6E736CCFF(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0f, 0f, 0f, 4f, 0);
								AI::TASK_COMBAT_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
							}
						}
						else if (!func_32(uLocal_221[iVar0], -1794415470, 1))
						{
							AI::TASK_ENTER_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
						}
					}
					else if (!func_32(uLocal_221[iVar0], 538064912, 1))
					{
						AI::TASK_VEHICLE_SHOOT_AT_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 1101004800);
					}
					break;
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_221[iVar0], 0))
					{
						if (iLocal_215 == iVar0)
						{
							if (func_40(uLocal_221[iVar0], 0) != -1)
							{
								...
								{
									AI::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), 0);
								}
							}
							else if (!func_32(uLocal_221[iVar0], -1273030092, 1) || iLocal_215 != iLocal_216)
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0]))
								{
									AI::TASK_DRIVE_BY(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
								}
							}
						}
						else if (func_40(uLocal_221[iVar0], 0) == -1)
						{
							...
							{
								AI::TASK_VEHICLE_ESCORT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iLocal_215], 0), -1, 40f, 786468, -1f, 20, 20f);
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0]))
...
void func_48()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_224, -1533126372);
	switch (iVar0)
	{
		case 0:
...
void func_55()
{
	...
	while (iVar0 <= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar0]))
		{
			...
			{
				AI::TASK_SMART_FLEE_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 1);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_221[iVar0]));
		}
		if (UI::DOES_BLIP_EXIST(uLocal_223[iVar0]))
		{
			UI::REMOVE_BLIP(&(uLocal_223[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
