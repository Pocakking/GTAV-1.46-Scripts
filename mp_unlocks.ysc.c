		...
		case 3:
			while (iLocal_113 == 0)
			{
				...
				if (UI::_0x2E22FEFA0100275E())
				{
					...
					{
						UI::_0x7E17BE53E1AAABAF(&uVar0, &iVar1, &iVar2);
						if (iVar1 == 50)
						{
							iLocal_117 = iVar2;
							func_1(&uLocal_119);
...
int func_1(var uParam0)
{
	...
	if (iVar0 > 16)
	{
		...
		UI::_ADD_FRONTEND_MENU_CONTEXT(-1871331138);
	}
	else
	{
		iLocal_118 = 0;
...
int func_19()
{
	...
	iVar0 = Global_1378933[func_14(-1)];
...
int func_32(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2567520[iParam0 /*3*/][func_14(iParam1)];
	if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
int func_39(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			if ((((func_41() || func_40()) || GAMEPLAY::IS_PC_VERSION()) || GAMEPLAY::IS_ORBIS_VERSION()) || GAMEPLAY::IS_DURANGO_VERSION())
			{
				iVar0 += 2;
				iVar0 += 2;
				iVar0++;
				iVar0 += 7;
				if (Global_262145.f_22355)
				{
					iVar0++;
				}
				return (46 + iVar0);
		...
		case 6:
			if ((NETWORK::_0x67A5589628E0CFF6() || func_41()) || func_40())
			{
				...
				iVar0 += 19;
				iVar0 += 8;
				return (Global_262145.f_21247 + iVar0);
			}
			else
			{
...
void func_45()
{
	...
	UI::_0x7E17BE53E1AAABAF(&uVar0, &uVar1, &uVar2);
	func_43(0);
	iLocal_117 = 0;
...
int func_48()
{
	...
	while (iVar0 < 1200)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_794709.f_4[iVar0 /*88*/].f_76, 14))
		{
...
int func_49(int iParam0)
{
	...
	iVar1 = func_52(iVar0);
	iVar2 = func_51(iVar0);
	if ((CONTROLS::IS_CONTROL_JUST_RELEASED(2, iParam0) || CONTROLS::IS_DISABLED_CONTROL_JUST_RELEASED(2, iParam0)) || func_50(iParam0, &(Global_1368245.f_1060), 1))
	{
...
void func_53()
{
	...
	{
		iVar0 = CONTROLS::GET_CONTROL_VALUE(2, 221);
		if (iVar0 > 180)
		{
