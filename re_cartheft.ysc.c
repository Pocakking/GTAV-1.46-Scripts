					...
					case 1:
						if (!PED::IS_PED_INJURED(iLocal_72))
						{
							...
							else
							{
								...
								{
									AI::TASK_SMART_FLEE_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
						...
						else
						{
							...
							{
								AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_71, iLocal_73, 20f, iLocal_119);
								PED::SET_PED_KEEP_TASK(iLocal_71, true);
								SYSTEM::WAIT(0);
							}
							func_114(0);
			...
			if (func_162(iLocal_73) && !func_104())
			{
				if (func_102())
				{
								...
								if (!PED::IS_PED_INJURED(iLocal_72))
								{
									if (PED::IS_PED_IN_VEHICLE(iLocal_72, iLocal_73, 0))
									{
										if (iLocal_121 == 2)
										{
											...
											AI::OPEN_SEQUENCE_TASK(&iLocal_74);
											AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 30f, iLocal_120, 200f, 10f, 0);
											AI::CLOSE_SEQUENCE_TASK(iLocal_74);
											AI::TASK_PERFORM_SEQUENCE(iLocal_72, iLocal_74);
											AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
										}
										else
										{
											ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_72, true, 1);
											AI::OPEN_SEQUENCE_TASK(&iLocal_74);
											AI::TASK_VEHICLE_TEMP_ACTION(0, iLocal_73, 30, 1000);
											AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 40f, iLocal_120, 200f, 10f, 1);
											AI::CLOSE_SEQUENCE_TASK(iLocal_74);
											AI::TASK_PERFORM_SEQUENCE(iLocal_72, iLocal_74);
											AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
										}
									...
									else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_73, iLocal_71, 20f, 20f, 7f, 0, 1, 0))
									{
										...
										if (func_55())
										{
											if (VEHICLE::_0x639431E895B9AA57(iLocal_71, iLocal_73, -1, 0, false))
											{
												...
												AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_71, iLocal_73, 35f, iLocal_119);
												PED::SET_PED_KEEP_TASK(iLocal_71, true);
												func_114(1);
											}
										}
					...
					else
					{
						if (!PED::IS_PED_INJURED(iLocal_72))
						{
							if (PED::IS_PED_IN_VEHICLE(iLocal_72, iLocal_73, 0))
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_72, iLocal_73, PLAYER::PLAYER_PED_ID(), 8, 50f, iLocal_120, 10f, 10f, 0);
								PED::SET_PED_KEEP_TASK(iLocal_72, true);
								STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(ENTITY::GET_ENTITY_MODEL(iLocal_72));
							}
							else
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_71))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&iLocal_74);
						AI::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_88, 1f, 20000, 1193033728, 1056964608);
						AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_74);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
					}
					func_231();
				}
	...
	if (((!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_162(iLocal_73)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_126))
	{
		switch (iLocal_49)
		{
			...
			case 1:
				...
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_71, iLocal_122, sLocal_126, sLocal_128, 1000f, -2f, 0, 0, 1148846080, 0);
				...
				GAMEPLAY::CLEAR_AREA(vLocal_84, 10f, 1, 0, 0, false);
				SYSTEM::SETTIMERA(0);
				if (iLocal_121 == 2)
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_122))
					{
						if (iLocal_132 == 0)
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122) >= 0.83f)
							{
								...
								AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_126, sLocal_129, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122), 0, 0, 0);
			...
			case 5:
				UI::HIDE_HUD_AND_RADAR_THIS_FRAME();
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_125) > 100)
				{
					if (func_3(iLocal_71) && func_162(iLocal_73))
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_74);
						AI::TASK_VEHICLE_TEMP_ACTION(0, iLocal_73, 9, 1000);
						AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_73, 25f, iLocal_119);
						AI::CLOSE_SEQUENCE_TASK(iLocal_74);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
						PED::SET_PED_RESET_FLAG(iLocal_71, 310, true);
...
void func_33(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_37(PLAYER::PLAYER_ID())) && !func_35(PLAYER::PLAYER_ID(), 0)) && !func_34()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_37(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
int func_60(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_61(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_61(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!UI::DOES_PED_HAVE_AI_BLIP(iParam0))
		{
			...
			{
				UI::SET_BLIP_PRIORITY(*iParam1, 7);
			}
		}
		if (!iParam9 == -1)
		{
		...
		*iParam1 = UI::_0x7CD934010E115C2C(iParam0);
		if (!iParam9 == -1)
		{
			if (UI::DOES_BLIP_EXIST(*iParam1))
			{
				if (!iParam8 == -1)
				{
					UI::SET_BLIP_COLOUR(*iParam1, iParam8);
				}
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam7))
				{
					...
					UI::END_TEXT_COMMAND_SET_BLIP_NAME(*iParam1);
				}
				UI::SET_BLIP_PRIORITY(*iParam1, 7);
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(iParam1->f_6, 2))
		{
			if (UI::DOES_BLIP_EXIST(*iParam1))
			{
				GAMEPLAY::SET_BIT(&(iParam1->f_6), 2);
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
		{
			iParam1->f_1 = UI::_0x56176892826A4FE8(iParam0);
			if (!GAMEPLAY::IS_BIT_SET(iParam1->f_6, 3))
			{
				if (UI::DOES_BLIP_EXIST(iParam1->f_1))
				{
					if (!iParam8 == -1)
					{
						UI::SET_BLIP_COLOUR(iParam1->f_1, iParam8);
					}
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam7))
					{
						UI::BEGIN_TEXT_COMMAND_SET_BLIP_NAME("STRING");
						...
						UI::END_TEXT_COMMAND_SET_BLIP_NAME(iParam1->f_1);
					}
					UI::SET_BLIP_PRIORITY(iParam1->f_1, 7);
					GAMEPLAY::SET_BIT(&(iParam1->f_6), 3);
				}
			}
			else if (!UI::DOES_BLIP_EXIST(iParam1->f_1))
			{
				iParam1->f_1 = 0;
				GAMEPLAY::CLEAR_BIT(&(iParam1->f_6), 3);
			}
		}
		else if (UI::DOES_BLIP_EXIST(iParam1->f_1))
		{
			...
			if (iLocal_77)
			{
				if (!PED::IS_PED_INJURED(iLocal_72))
				{
					if (!iLocal_118)
					{
						...
						{
							AI::TASK_DRIVE_BY(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 40f, 100, 1, -753768974);
							iLocal_118 = 1;
						}
					}
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_123 + 7000)
					{
...
void func_69()
{
	if (func_162(iLocal_73) && UI::DOES_BLIP_EXIST(iLocal_60))
	{
...
int func_78(char* sParam0)
{
	if (!func_79(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_65(sParam0)) || func_65("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_80(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_81(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
		...
		switch (iLocal_48)
		{
			case 0:
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
				{
					...
					else if (!PED::IS_PED_RAGDOLL(iLocal_71) && !AI::IS_PED_GETTING_UP(iLocal_71))
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						...
						{
							AI::TASK_ACHIEVE_HEADING(iLocal_71, 345f, 0);
							iLocal_48 = 1;
						}
						else
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_74);
							AI::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 2f, -8f, -1, 0, 0f, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_80, "arms_waving", 8f, -2f, -1, 0, 0f, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(iLocal_74);
							AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
							iLocal_124 = GAMEPLAY::GET_GAME_TIMER();
			...
			case 1:
				...
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1)
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_74);
						AI::TASK_PLAY_ANIM(0, sLocal_80, sLocal_82, 4f, -2f, -1, 0, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_74);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
						iLocal_48 = 2;
				...
				else if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 60f))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1)
					{
						...
						if (bLocal_57 == 0)
						{
							AI::TASK_PLAY_ANIM(0, sLocal_80, "pointing", 8f, -4f, -1, 0, 0f, 0, 0, 0);
						}
						AI::CLOSE_SEQUENCE_TASK(iLocal_74);
						AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
			...
			case 2:
				...
				if (iLocal_121 == 2)
				{
					...
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 0);
					}
					if (func_108(iLocal_71, PLAYER::PLAYER_PED_ID(), 1) < 25f)
					{
						if (!func_18())
						{
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_124) > 6000)
							{
								func_107();
							}
						}
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1 && !func_109(iLocal_71, -875674219))
				{
					if (iLocal_121 == 1)
					{
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) == 7)
							{
								AI::OPEN_SEQUENCE_TASK(&iLocal_74);
								AI::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_85, 1f, 20000, fLocal_90, 1056964608);
						...
						{
							AI::TASK_PLAY_ANIM(iLocal_71, sLocal_79, "waiting", 4f, -4f, -1, 0, 0f, 0, 0, 0);
							if (func_108(iLocal_71, PLAYER::PLAYER_PED_ID(), 1) < 25f)
							{
								func_107();
							}
			...
			case 3:
					...
					if (func_106())
					{
						if (iLocal_55)
						{
							if (iLocal_121 == 1)
							{
								AI::OPEN_SEQUENCE_TASK(&iLocal_74);
								AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
								AI::TASK_PLAY_ANIM(0, "RANDOM@CAR_THIEF@WAITING_IG_4", "idle_a", 2f, -2f, -1, 0, 0f, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_74);
								AI::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_74);
								iLocal_55 = 0;
						...
						else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_71, "RANDOM@CAR_THIEF@WAITING_IG_4", "idle_a", 3))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) == 7)
							{
								...
								else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_124) > 6000)
								{
									iLocal_55 = 1;
								}
							}
				...
				else
				{
					...
					{
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_71, 2106541073) == 7)
						{
							AI::TASK_GO_STRAIGHT_TO_COORD(iLocal_71, vLocal_85, 1f, 20000, fLocal_90, 1056964608);
						}
					}
					else if (!PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 50f))
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1);
					}
					iLocal_55 = 1;
				}
				break;
...
void func_120()
{
	...
	{
		func_122(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_150(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_121() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_9(func_148(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_154()
{
	switch (func_155(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
bool func_161(int iParam0)
{
	...
	if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
	{
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			...
			{
				if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_71, 31086, 0f, 0f, 0f), 4f, 0))
				{
					bVar0 = true;
				}
	...
	if (((((((STREAMING::HAS_MODEL_LOADED(iVar3) && STREAMING::HAS_MODEL_LOADED(iVar4)) && STREAMING::HAS_MODEL_LOADED(iVar5)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_79)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_80)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_81)) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4")) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_121 == 1)
		{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				fLocal_51 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
			}
			iLocal_71 = PED::CREATE_PED(5, iVar3, vLocal_50, fLocal_51, 1, true);
			AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_71, sVar7);
			AI::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
		...
		AI::TASK_LOOK_AT_ENTITY(iLocal_71, iLocal_72, -1, 0, 2);
...
int func_181()
{
	if ((Global_106059 == func_134() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106060)
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_201(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_204()
{
	...
	func_210(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_209(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_208(&uVar0, TIME::GET_CLOCK_HOURS());
	func_207(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_206(&uVar0, TIME::GET_CLOCK_MONTH());
	func_205(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_221()) || Global_105117) || Global_25461) || func_220()) || func_52(8, -1)) || func_219()) || func_218()) || func_217()) || func_216()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_221()) || Global_25461) || func_220()) || func_52(8, -1)) || func_217()) || func_219()) || func_218()) || func_216()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_221()) || Global_105117) || Global_25461) || func_220()) || func_52(8, -1)) || func_219()) || func_218()) || func_216()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_221() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_52(8, -1)) || func_216()) || func_215()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_221()) || Global_25461) || func_220()) || func_52(8, -1)) || func_218()) || func_217()) || func_216()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_221()) || func_218()) || Global_105117) || Global_25461) || func_220()) || Global_37271) || func_52(8, -1)) || func_217()) || func_215()) || func_216()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_221()) || Global_105117) || Global_25461) || func_220()) || func_52(8, -1)) || func_217()) || func_215()) || func_219()) || func_218()) || func_216())
						{
							return 0;
						}
						break;
