					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
							...
							case 1:
								if (!func_135())
								{
									if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_59, 75f, 75f, 75f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_58)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 15f, 15f, 15f, 0, 1, 0))
									{
										if (!func_161())
										{
											AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, -1, 0, 2);
							...
							case 3:
								...
								if (!PED::IS_PED_INJURED(iLocal_58))
								{
									...
									if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0))
									{
										if (!iLocal_85)
										{
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "random@homelandsecurity", "idle_girl", 3) && !PED::IS_PED_RAGDOLL(iLocal_58))
											{
												...
												AI::OPEN_SEQUENCE_TASK(&iLocal_102);
												AI::TASK_PLAY_ANIM(0, "random@homelandsecurity", "idle_to_knees_girl", 1000f, -8f, -1, 8192, 0f, 0, 0, 0);
												AI::TASK_PLAY_ANIM(0, "random@homelandsecurity", "knees_loop_girl", 8f, -8f, -1, 8321, 0f, 0, 0, 0);
												AI::CLOSE_SEQUENCE_TASK(iLocal_102);
												AI::TASK_PERFORM_SEQUENCE(iLocal_58, iLocal_102);
												AI::CLEAR_SEQUENCE_TASK(&iLocal_102);
												iLocal_85 = 1;
											}
											else
											{
												AI::TASK_COWER(iLocal_58, -1);
												iLocal_85 = 1;
											}
										}
										else if ((((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "random@homelandsecurity", "idle_girl", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "random@homelandsecurity", "idle_to_knees_girl", 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "random@homelandsecurity", "knees_loop_girl", 1)) && AI::GET_SCRIPT_TASK_STATUS(iLocal_58, 474215631) != 0) && AI::GET_SCRIPT_TASK_STATUS(iLocal_58, 474215631) != 1)
										{
											iLocal_85 = 0;
										}
									}
									else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0))
									{
										...
										{
											if (UI::DOES_BLIP_EXIST(iLocal_88))
											{
												UI::REMOVE_BLIP(&iLocal_88);
											}
										}
									}
								}
								...
								if (!func_108())
								{
									if (iLocal_95 < GAMEPLAY::GET_GAME_TIMER())
									{
										if (func_107())
										{
										...
										iLocal_95 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4500, 5000));
									}
								}
								if (PED::IS_PED_INJURED(iLocal_50[0]))
								{
									if (UI::DOES_BLIP_EXIST(iLocal_89[0]))
									{
										UI::REMOVE_BLIP(&(iLocal_89[0]));
									}
									func_105(&uLocal_120, 5);
								}
								else if (PED::_0x6CD5A433374D4CFB(iLocal_50[0], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
								{
								}
								else if (UI::DOES_BLIP_EXIST(iLocal_89[0]))
								{
									UI::REMOVE_BLIP(&(iLocal_89[0]));
								}
								if (PED::IS_PED_INJURED(iLocal_50[1]))
								{
									if (UI::DOES_BLIP_EXIST(iLocal_89[1]))
									{
										UI::REMOVE_BLIP(&(iLocal_89[1]));
									}
									func_105(&uLocal_120, 4);
								}
								else if (PED::_0x6CD5A433374D4CFB(iLocal_50[1], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[1], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
								{
								}
								else if (UI::DOES_BLIP_EXIST(iLocal_89[1]))
								{
									UI::REMOVE_BLIP(&(iLocal_89[1]));
								}
							...
							case 4:
								if (!bLocal_64)
								{
									if (!PED::IS_PED_INJURED(iLocal_58))
									{
										...
										{
											AI::TASK_PLAY_ANIM(iLocal_58, "random@homelandsecurity", "knees_to_stand_girl", 4f, -4f, -1, 0, 0.3f, 0, 0, 0);
										}
										else
										{
								...
								if (bLocal_64)
								{
									if (!PED::IS_PED_INJURED(iLocal_58))
									{
										...
										else if (!UI::DOES_BLIP_EXIST(iLocal_88))
										{
								...
								if (!PED::IS_PED_INJURED(iLocal_50[0]))
								{
									if (PED::_0x6CD5A433374D4CFB(iLocal_50[0], PLAYER::PLAYER_PED_ID()))
									{
								...
								if (!PED::IS_PED_INJURED(iLocal_50[1]))
								{
									if (PED::_0x6CD5A433374D4CFB(iLocal_50[1], PLAYER::PLAYER_PED_ID()))
									{
										if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
										{
										}
										...
										if (PED::IS_PED_IN_GROUP(iLocal_58))
										{
											...
											else
											{
												...
												if (!PED::IS_PED_INJURED(iLocal_58))
												{
													...
													AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_68, 1f, -1, 0.25f, 0, 38.9844f);
						...
						if (iLocal_47 == 4 || iLocal_47 == 5)
						{
							if (!PED::IS_PED_INJURED(iLocal_58))
							{
								...
								{
									AI::TASK_SMART_FLEE_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
									func_96();
									func_109();
								}
							}
...
void func_34(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_35(Global_106070.f_28022[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_38(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_40() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_40() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_42(int iParam0)
{
	...
	if (iParam0 == 9)
	{
		return func_43(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_43(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_43(137, -1, -1);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_40() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_48(int iParam0, int iParam1)
{
	...
	if (func_58(&Global_4268566))
	{
		if (func_56(&Global_4268566, iParam0))
		{
			return 0;
		}
...
void func_52(var uParam0)
{
	...
	func_54(uParam0, (Global_4268565 - 0.5f));
}
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				...
				if (func_101() == 2 && !func_93())
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_91))
					{
						...
						UI::SET_BLIP_SPRITE(iLocal_91, 269);
						func_91();
					}
				}
			}
...
int func_94(vector3 vParam0, bool bParam1)
{
	int iVar0;
	
	iVar0 = UI::ADD_BLIP_FOR_COORD(vParam0);
	UI::SET_BLIP_SCALE(iVar0, func_95(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_100(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_95(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_110()
{
	if (!iLocal_77)
	{
		if (!PED::IS_PED_INJURED(iLocal_50[0]))
		{
			...
			AI::CLEAR_PED_TASKS(iLocal_50[0]);
			AI::OPEN_SEQUENCE_TASK(&iLocal_102);
			AI::TASK_CLEAR_LOOK_AT(0);
			AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
			AI::CLOSE_SEQUENCE_TASK(iLocal_102);
			AI::TASK_PERFORM_SEQUENCE(iLocal_50[0], iLocal_102);
			AI::CLEAR_SEQUENCE_TASK(&iLocal_102);
			PED::SET_PED_KEEP_TASK(iLocal_50[0], true);
			if (UI::DOES_BLIP_EXIST(iLocal_89[0]))
			{
				UI::SET_BLIP_AS_FRIENDLY(iLocal_89[0], false);
			}
			SYSTEM::SETTIMERB(0);
			iLocal_77 = 1;
		}
	...
	if (!iLocal_78)
	{
		if (UI::DOES_BLIP_EXIST(iLocal_89[1]))
		{
			UI::SET_BLIP_AS_FRIENDLY(iLocal_89[1], false);
		}
		func_96();
		SYSTEM::WAIT(0);
		if (!PED::IS_PED_INJURED(iLocal_50[1]))
		{
			...
			if ((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50[1], "random@homelandsecurity", "idle_cop_ground", 3) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_115)) && !PED::IS_PED_RAGDOLL(iLocal_50[1]))
			{
				...
				AI::OPEN_SEQUENCE_TASK(&iLocal_102);
				AI::TASK_PLAY_ANIM(0, "random@homelandsecurity", "idle_to_stand_cop_ground", 4f, -2f, 1400, 8192, 0f, 0, 0, 0);
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				AI::CLOSE_SEQUENCE_TASK(iLocal_102);
				AI::TASK_PERFORM_SEQUENCE(iLocal_50[1], iLocal_102);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_102);
			...
			{
				AI::TASK_COMBAT_PED(iLocal_50[1], PLAYER::PLAYER_PED_ID(), 0, 16);
				PED::SET_PED_KEEP_TASK(iLocal_50[1], true);
				iLocal_78 = 1;
			}
		}
	...
	{
		if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50[1], "random@homelandsecurity", "idle_cop_ground", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50[1], "random@homelandsecurity", "idle_to_stand_cop_ground", 1)) && AI::GET_SCRIPT_TASK_STATUS(iLocal_50[1], 780511057) != 0) && AI::GET_SCRIPT_TASK_STATUS(iLocal_50[1], 780511057) != 1)
		{
			iLocal_78 = 1;
		}
	}
	...
	if (!bLocal_104)
	{
		switch (iLocal_49)
		{
			...
			case 5:
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_102);
					AI::TASK_LOOK_AT_ENTITY(0, iLocal_58, -1, 2054, 2);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_58, -1);
					AI::CLOSE_SEQUENCE_TASK(iLocal_102);
					AI::TASK_PERFORM_SEQUENCE(iLocal_50[0], iLocal_102);
					PED::SET_PED_KEEP_TASK(iLocal_50[0], true);
					iLocal_83 = 1;
							...
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_115) > 0.98f)
							{
								if (!func_108())
								{
									if (PED::IS_PED_FACING_PED(iLocal_50[0], iLocal_58, 10f))
									{
										...
										{
											AI::TASK_CLEAR_LOOK_AT(iLocal_50[0]);
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_115))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_115) > 0.9f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_50[0]))
							{
								AI::TASK_ENTER_VEHICLE(iLocal_50[0], iLocal_53, -1, -1, 1f, 9, 0);
								iLocal_49 = 7;
							}
						}
					}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_115))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_115) > 0.95f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_50[1]))
							{
								AI::TASK_ENTER_VEHICLE(iLocal_50[1], iLocal_53, -1, 0, 1f, 9, 0);
								PED::SET_PED_KEEP_TASK(iLocal_50[1], true);
								iLocal_49 = 8;
							}
						}
			...
			case 8:
				...
				if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0) && !PED::IS_PED_INJURED(iLocal_50[0])) && !PED::IS_PED_INJURED(iLocal_50[1]))
				{
					...
					{
						AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_50[0], iLocal_53, 15f, 786468);
			...
			case 13:
				...
				if (iLocal_107)
				{
					if (!PED::IS_PED_INJURED(iLocal_50[1]))
					{
						if (!PED::IS_PED_INJURED(iLocal_58))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_50[1], 1785177548) != 1)
							{
								AI::OPEN_SEQUENCE_TASK(&iLocal_102);
								AI::TASK_CLEAR_LOOK_AT(0);
								AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_58, 0);
								AI::TASK_LOOK_AT_ENTITY(0, iLocal_58, 20000, 0, 2);
								AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_58, -1f, 0f, 0f, 1f, -1, 1036831949, 1);
								AI::CLOSE_SEQUENCE_TASK(iLocal_102);
								AI::TASK_PERFORM_SEQUENCE(iLocal_50[1], iLocal_102);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_102);
							}
						}
						else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_50[1], 1785177548) != 1)
						{
							AI::OPEN_SEQUENCE_TASK(&iLocal_102);
							AI::TASK_CLEAR_LOOK_AT(0);
					...
					if (!PED::IS_PED_INJURED(iLocal_58))
					{
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_58, 1785177548) != 1)
						{
							AI::TASK_SEEK_COVER_FROM_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 0);
							PED::SET_PED_KEEP_TASK(iLocal_58, true);
						}
					}
				}
			...
			case 14:
				...
				if (!PED::IS_PED_INJURED(iLocal_50[0]))
				{
					...
					iLocal_83 = 0;
					SYSTEM::SETTIMERA(0);
					iLocal_93 = (GAMEPLAY::GET_GAME_TIMER() - 4500);
					iLocal_49 = 5;
				}
			}
	}
				...
				if (PED::IS_PED_IN_VEHICLE(iLocal_58, iLocal_53, 0))
				{
					if (func_121(iLocal_58, 0) == 2)
					{
						if (iLocal_95 < GAMEPLAY::GET_GAME_TIMER())
						{
							...
							iLocal_95 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 4000));
						}
					}
				}
			}
...
int func_128()
{
	switch (func_129(&Global_25518, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_132(iParam0, Global_36117);
}
...
void func_134()
{
	if (UI::DOES_BLIP_EXIST(iLocal_87))
	{
		UI::REMOVE_BLIP(&iLocal_87);
	}
	if (!UI::DOES_BLIP_EXIST(iLocal_88))
	{
		...
		{
			iLocal_88 = func_99(iLocal_58, 0, 145);
			UI::_0x75A16C3DA34F1245(iLocal_88, false);
		}
	}
	else
	{
		UI::_0x75A16C3DA34F1245(iLocal_88, true);
	}
	iLocal_92 = 0;
	while (iLocal_92 <= 1)
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_89[iLocal_92]))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_50[iLocal_92], 0))
			{
				iLocal_89[iLocal_92] = func_99(iLocal_50[iLocal_92], 0, 145);
				UI::_0x75A16C3DA34F1245(iLocal_89[iLocal_92], false);
			}
		}
		else
		{
			UI::_0x75A16C3DA34F1245(iLocal_89[iLocal_92], true);
		}
		iLocal_92++;
	}
}
...
int func_135()
{
	...
	if (!bLocal_99)
	{
		if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vLocal_54 - Vector(30f, 30f, 30f), vLocal_54 + Vector(30f, 30f, 30f), 1) || GAMEPLAY::IS_BULLET_IN_BOX(vLocal_54 - Vector(30f, 30f, 30f), vLocal_54 + Vector(30f, 30f, 30f), 1))
		{
			iLocal_48 = 2;
			return 1;
		}
		if (!PED::IS_PED_INJURED(iLocal_50[0]) && !PED::IS_PED_INJURED(iLocal_50[1]))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
			{
				if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 7) || (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[0], PLAYER::PLAYER_PED_ID(), 6f, 6f, 6f, 0, 1, 0)))
				{
					...
					{
						if (PED::_0x6CD5A433374D4CFB(iLocal_50[0], PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_50[1], PLAYER::PLAYER_PED_ID()))
						{
							iLocal_48 = 2;
							return 1;
						}
...
void func_136()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_59, 50f, 0);
	PATHFIND::SET_PED_PATHS_IN_AREA(419f, -1387f, 28f, 427f, -1370f, 29f, false, 0);
	GAMEPLAY::SET_BIT(&uLocal_97, 5);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_119, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_119);
	...
	if (func_101() == 0)
	{
		func_137(&uLocal_120, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_101() == 1)
	{
		func_137(&uLocal_120, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_115 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
	PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_115, iLocal_53, 0);
	AI::TASK_SYNCHRONIZED_SCENE(iLocal_58, iLocal_115, "random@homelandsecurity", "idle_girl", 4f, -2f, 1, 0, 1148846080, 0);
	AI::TASK_SYNCHRONIZED_SCENE(iLocal_50[0], iLocal_115, "random@homelandsecurity", "idle_cop_gun", 4f, -2f, 1, 0, 1148846080, 0);
	AI::TASK_SYNCHRONIZED_SCENE(iLocal_50[1], iLocal_115, "random@homelandsecurity", "idle_cop_ground", 4f, -2f, 1, 0, 1148846080, 0);
...
int func_145(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_142(func_143(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_165(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_201(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
...
int func_182()
{
	...
	func_188(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_187(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_186(&uVar0, TIME::GET_CLOCK_HOURS());
	func_185(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_184(&uVar0, TIME::GET_CLOCK_MONTH());
	func_183(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_105117) || Global_25461) || func_198()) || func_76(8, -1)) || func_197()) || func_196()) || func_195()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_199()) || Global_25461) || func_198()) || func_76(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_105117) || Global_25461) || func_198()) || func_76(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5) || Global_36664 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_105117) || Global_25461) || func_198()) || func_76(8, -1)) || func_197()) || func_196()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_199() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_76(8, -1)) || func_194()) || func_193()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_199()) || Global_25461) || func_198()) || func_76(8, -1)) || func_196()) || func_195()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_199()) || func_196()) || Global_105117) || Global_25461) || func_198()) || Global_37271) || func_76(8, -1)) || func_195()) || func_193()) || func_194()) || Global_106070.f_7660.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_199()) || Global_105117) || Global_25461) || func_198()) || func_76(8, -1)) || func_195()) || func_193()) || func_197()) || func_196()) || func_194())
						{
							return 0;
						}
						break;
		...
		while (iVar0 < iLocal_50)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_50[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_50[iVar0]))
				{
					if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_AIM_GUN_AT_COORD(iLocal_50[iVar0], func_219(PLAYER::PLAYER_ID()), -1, 0, 0);
...
void func_208(int iParam0)
{
	...
	if (func_161())
	{
		...
		func_211(30000);
		StringCopy(&cVar0, func_210(Global_106059, 1), 64);
