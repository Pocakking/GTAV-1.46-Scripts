	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				GAMEPLAY::SET_BIT(&iVar3, 1);
				GAMEPLAY::SET_BIT(&iVar3, 5);
				...
				AI::TASK_PLAY_ANIM(iVar12, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0f, 0, 0, 0);
				if (!UI::DOES_BLIP_EXIST(iLocal_219))
				{
				}
				iVar14 = 0;
				while (iVar14 <= (iLocal_49 - 1))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iVar11[iVar14]))
					{
						...
						PED::SET_PED_MONEY(iVar11[iVar14], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(200, 500));
					}
					iVar14++;
				}
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE(iVar11[0], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar11[1]))
				{
					AI::TASK_SYNCHRONIZED_SCENE(iVar11[1], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar11[2]))
				{
					AI::TASK_SYNCHRONIZED_SCENE(iVar11[2], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
			...
			case 5:
				...
				if (iVar2 < 3)
				{
					if ((((((((func_73(&iVar11, &uVar6, &uVar5, &uVar4, iVar3, bVar7, 1075838976, 0) || func_72(iVar11[0], 0)) || func_72(iVar11[1], 0)) || func_72(iVar11[2], 0)) || GAMEPLAY::IS_BULLET_IN_AREA(vLocal_222[0 /*3*/], 40f, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_smokegrenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenadelauncher"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_stickybomb"), 1))
					{
						iVar15 = 0;
						while (iVar15 < iVar11)
						{
							if (!PED::IS_PED_INJURED(iVar11[iVar15]))
							{
								...
								if (!PED::IS_PED_INJURED(iVar11[iVar15]))
								{
									AI::CLEAR_PED_TASKS(iVar11[iVar15]);
									...
									AI::TASK_PERFORM_SEQUENCE(iVar11[iVar15], iLocal_48);
						...
						if (!PED::IS_PED_INJURED(iVar12))
						{
							if (!PED::IS_PED_INJURED(iVar12))
							{
								AI::CLEAR_PED_TASKS(iVar12);
								AI::OPEN_SEQUENCE_TASK(&iLocal_48);
								AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000, 2048, 2);
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_48);
								AI::TASK_PERFORM_SEQUENCE(iVar12, iLocal_48);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
...
int func_1(int iParam0, struct<6> Param1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (*iParam0 >= 3)
	{
		...
		{
			if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_236, 9f, 9f, 9f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, false, true, 0)) || AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
			{
				*iParam0 = 6;
			}
		}
	...
	switch (*iParam0)
	{
			...
			if (func_54(iParam2, iParam3))
			{
				...
				if (!PED::IS_PED_INJURED(iParam2))
				{
					...
					if (!func_72(iParam2, 0))
					{
						...
						{
							if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::_0x6CD5A433374D4CFB(iParam2, PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								...
								{
									AI::CLEAR_PED_SECONDARY_TASK(iParam2);
									AI::TASK_LOOK_AT_ENTITY(iParam2, PLAYER::PLAYER_PED_ID(), 5000, 1024, 2);
									func_70();
									SYSTEM::WAIT(1000);
									...
									while (iVar0 < *iParam3)
									{
										...
										{
											AI::CLEAR_PED_SECONDARY_TASK((*iParam3)[iVar0]);
											AI::TASK_SMART_FLEE_PED((*iParam3)[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									...
									if (!PED::IS_PED_INJURED(iParam2))
									{
										AI::TASK_SMART_FLEE_PED(iParam2, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
				...
				else if (PED::IS_PED_RAGDOLL(iParam2))
				{
					...
					{
						AI::STOP_ANIM_TASK(iParam2, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -8f);
					}
				}
			}
			else
		...
		case 2:
			...
			{
				if (!UI::DOES_BLIP_EXIST(iLocal_218[1]))
				{
				}
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE((*iParam3)[0], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam3)[1]))
				{
					AI::TASK_SYNCHRONIZED_SCENE((*iParam3)[1], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam3)[2]))
				{
					AI::TASK_SYNCHRONIZED_SCENE((*iParam3)[2], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				*iParam0 = 3;
			}
			break;
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_51))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.3f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[0]))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&iLocal_48);
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(0f, 0f, 1f), PLAYER::PLAYER_PED_ID(), 2f, false, 3.5f, 5f, true, 0, 0, -957453492, 20000);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_48);
						AI::TASK_PERFORM_SEQUENCE((*iParam3)[0], iLocal_48);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.35f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[1]))
					{
						...
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_48);
						AI::TASK_PERFORM_SEQUENCE((*iParam3)[1], iLocal_48);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.275f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[2]))
					{
						...
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_48);
						AI::TASK_PERFORM_SEQUENCE((*iParam3)[2], iLocal_48);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
		...
		case 6:
			...
			if (func_31(iParam3))
			{
				*iParam5 = 1;
				...
				if (!UI::DOES_BLIP_EXIST(iLocal_220))
				{
				}
				while (func_69())
				{
...
int func_34(struct<6> Param0, int iParam1, var uParam2)
{
	switch (iLocal_231)
	{
		...
		case 1:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iParam1, 242628503) == 7 || ENTITY::IS_ENTITY_AT_ENTITY(iParam1, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_69())
					{
		...
		case 2:
			if (!PED::IS_PED_INJURED((*uParam2)[2]))
			{
				...
				if (!PED::IS_PED_INJURED((*uParam2)[2]))
				{
					...
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, (*uParam2)[0], 0f, -0.5f, 0f, 1f, 10000, 1036831949, 1);
					AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_48);
					AI::TASK_PERFORM_SEQUENCE((*uParam2)[2], iLocal_48);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
					iLocal_48 = 0;
				}
			}
...
void func_36(var uParam0)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!UI::DOES_BLIP_EXIST(iLocal_218[iVar0]))
		{
			if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
			{
...
int func_38(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_39(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_39(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_41(var uParam0, int iParam1)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(iParam1);
...
int func_54(int iParam0, var uParam1)
{
	switch (iLocal_234)
	{
			...
			if (!PED::IS_PED_INJURED(iParam0))
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1272.878f, -1532.84f, 36.4104f, 1339.482f, -1623.636f, 71.4792f, 105.1875f, 0, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iParam0)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0, 15f, 15f, 15f, 0, 1, 0))
				{
					...
					if (!UI::DOES_BLIP_EXIST(iLocal_220))
					{
						...
						UI::_0x75A16C3DA34F1245(iLocal_220, false);
					}
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									...
									if (UI::DOES_BLIP_EXIST(iLocal_220))
									{
										UI::_0x75A16C3DA34F1245(iLocal_220, true);
									}
							...
							else if (iLocal_225 == 0)
							{
								...
								if (!PED::IS_PED_INJURED(iParam0))
								{
									AI::OPEN_SEQUENCE_TASK(&iLocal_48);
									AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 20000, 1024, 2);
									AI::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 2f, -2f, -1, 49, 0f, 0, 0, 0);
									AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
									AI::CLOSE_SEQUENCE_TASK(iLocal_48);
									AI::TASK_PERFORM_SEQUENCE(iParam0, iLocal_48);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
		...
		case 1:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_224, 13f, 0, 0, 0, 0, false, 0);
				AI::CLEAR_PED_SECONDARY_TASK(iParam0);
				if (!PED::IS_PED_INJURED(iParam0))
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_48);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_224, 2f, 20000, 0.25f, 0, 32.2195f);
			...
			else if (!PED::IS_PED_INJURED(iParam0))
			{
				if (SYSTEM::TIMERA() > 8000 && ENTITY::IS_ENTITY_AT_COORD(iParam0, vLocal_224, 3f, 3f, 3f, false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 60f))
					{
						if (func_158())
						{
							AI::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0f, 0, 0, 0);
						}
						else
						{
							AI::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0f, 0, 0, 0);
						}
						func_44(&uLocal_53, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
						SYSTEM::SETTIMERA(0);
					}
				}
				if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::_0x6CD5A433374D4CFB(iParam0, PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
...
void func_56(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		{
			if ((PED::_0x6CD5A433374D4CFB((*uParam1)[iVar0], PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), (*uParam1)[iVar0])) || PED::_0x6CD5A433374D4CFB(iParam0, PLAYER::PLAYER_PED_ID()))
			{
				func_70();
				if (!PED::IS_PED_INJURED((*uParam1)[iVar0]))
				{
					...
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_48);
					AI::TASK_PERFORM_SEQUENCE((*uParam1)[iVar0], iLocal_48);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_48);
...
int func_113(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_140(Global_106070.f_24967.f_43[iParam1]))
		{
			return 0;
		}
