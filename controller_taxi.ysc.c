...
void __EntryFunction__()
{
	...
	iLocal_78 = UI::_GET_BLIP_INFO_ID_ITERATOR();
					...
					if (iVar1 != 2)
					{
						if ((!GAMEPLAY::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_68(5))
						{
							...
							if (func_64())
							{
								...
								switch (iLocal_102)
								{
									...
									case 2:
										...
										if (func_53(&iLocal_114) > 15f)
										{
											...
											fLocal_107 = (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(10f, 40f) + func_53(&iLocal_114));
											iLocal_102 = 3;
										}
										else if (iLocal_108)
										{
								...
								if (((CONTROLS::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_25610) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_105) > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
							...
							else
							{
								...
								if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_106) > 60000 && !func_58("TC_HOWTOSTART")) && iLocal_112)
								{
									iLocal_112 = 0;
								}
								if (bLocal_110)
			...
			case 8:
				if (func_64())
				{
					if (!func_21())
					{
						...
						iLocal_96 = SYSTEM::START_NEW_SCRIPT(&vLocal_97, 25000);
...
{
	iParam0->f_1 = (func_54(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_83()
{
	...
	if (UI::GET_LENGTH_OF_LITERAL_STRING(&vLocal_97) != 0)
	{
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&vLocal_97);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_101))
