...
void __EntryFunction__()
{
	...
	func_83(&Local_41, 2);
	Local_41.f_4 = 3;
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_40, 5f, 0, 0, 0, 0, false, 0);
	...
	while (true)
	{
		...
		if (func_43(&Local_41))
		{
			if (func_37(&Local_41))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_41.f_14, 8.5f, 0, 0, 0, 0, false, 0);
		...
		if (Global_106070.f_10021.f_104 != 0)
		{
			iLocal_49 = (Global_106070.f_10021.f_104 + 14 % func_18(TIME::GET_CLOCK_MONTH(), TIME::GET_CLOCK_YEAR()));
			if (((TIME::GET_CLOCK_DAY_OF_MONTH() == iLocal_49 && !func_17(0)) && !PLAYER::IS_PLAYER_DEAD(PLAYER::PLAYER_ID())) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				func_4(func_16());
			}
		}
		func_1(&iLocal_230, &uLocal_232, &iLocal_231);
		if ((iLocal_59 > 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_59) && iLocal_231 == 99)
		{
			iLocal_59 = 0;
			if (func_86())
			{
...
void func_1(int iParam0, var uParam1, int iParam2)
{
	...
	switch (*iParam2)
	{
		...
		case 1:
			...
			GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("EPS_CAR_TITLE");
			GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			GRAPHICS::_BEGIN_TEXT_COMMAND_SCALEFORM("EPS_CAR_NOTE");
...
int func_3()
{
	...
	while (iVar0 < 5)
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_51, iVar0))
		{
			iVar1++;
		}
		iVar0++;
...
{
	return GAMEPLAY::IS_BIT_SET(iLocal_51, iParam0);
}
...
bool func_15(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(iLocal_51, iParam0 + 5);
}
...
int func_37(var uParam0)
{
	...
	{
		Global_106070.f_10021.f_104 = TIME::GET_CLOCK_DAY_OF_MONTH();
		iLocal_59 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_60);
	}
	return iVar2;
}
...
void func_39(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&iLocal_51, iParam0);
		iLocal_52 = iParam0;
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&iLocal_51, iParam0);
	}
}
...
void func_40(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&iLocal_51, iParam0 + 5);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&iLocal_51, iParam0 + 5);
	}
}
			...
			switch (iLocal_50)
			{
				case 0:
					...
					if ((Local_41.f_26 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
					{
						...
						else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_58) > 500)
						{
							if (iLocal_55 == 0)
							{
								UI::CLEAR_PRINTS();
...
void func_62(int iParam0)
{
	...
	{
		case 1:
			if (!UI::DOES_BLIP_EXIST(iLocal_44))
			{
				iLocal_44 = UI::ADD_BLIP_FOR_COORD(vLocal_40);
				if (UI::DOES_BLIP_EXIST(iLocal_44))
				{
					UI::SET_BLIP_SPRITE(iLocal_44, 206);
					UI::SET_BLIP_COLOUR(iLocal_44, 42);
				}
			}
			*iParam0 = 2;
			iLocal_50 = 0;
...
void func_88()
{
	...
	while (iVar0 < 5)
	{
		GAMEPLAY::SET_BIT(&iLocal_51, iVar0);
		iVar0++;
	}
}
