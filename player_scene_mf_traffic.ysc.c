...
int func_2()
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_85, true) > 100f)
	{
		return 1;
	}
	return 0;
...
int func_11()
{
	...
	{
		func_13();
		func_12(&iLocal_87, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1.75f, 2.25f));
		return 1;
	}
	if (!func_9(&iLocal_87))
	{
		func_12(&iLocal_87, (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1.75f, 2.25f) * 2f));
	}
	return 0;
}
...
void func_14(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iParam1, vVar1, fParam2, 0, ENTITY::GET_ENTITY_MODEL(iParam1), iParam3, 2f, 5f);
...
int func_20(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_21(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_19(14) || Global_105021))
			{
...
void func_32()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 12)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_69[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_85 + vLocal_71[iVar0 /*3*/], 10f, 1, 0, 0, false);
					...
					ENTITY::_SET_ENTITY_REGISTER(iLocal_69[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_73[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_85 + vLocal_75[iVar0 /*3*/], 10f, 1, 0, 0, false);
					...
					ENTITY::_SET_ENTITY_REGISTER(iLocal_73[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_77[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_85 + vLocal_79[iVar0 /*3*/], 10f, 1, 0, 0, false);
					...
					ENTITY::_SET_ENTITY_REGISTER(iLocal_77[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_81[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_85 + vLocal_83[iVar0 /*3*/], 10f, 1, 0, 0, false);
					...
					ENTITY::_SET_ENTITY_REGISTER(iLocal_81[iVar0], true);
				}
			}
			iVar0++;
		}
	...
	while (iVar0 < 12)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69[iVar0], 0))
		{
			...
			func_33(iVar3);
			ENTITY::_SET_ENTITY_REGISTER(iLocal_69[iVar0], true);
			ENTITY::_SET_ENTITY_REGISTER(iVar3, true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_73[iVar0], 0))
		{
			if (VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_73[iVar0]) > 0)
			{
				...
				func_33(iVar4);
				ENTITY::_SET_ENTITY_REGISTER(iLocal_69[iVar0], true);
				ENTITY::_SET_ENTITY_REGISTER(iVar4, true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
		{
			if (VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_77[iVar0]) > 0)
			{
				...
				func_33(iVar5);
				ENTITY::_SET_ENTITY_REGISTER(iLocal_69[iVar0], true);
				ENTITY::_SET_ENTITY_REGISTER(iVar5, true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_81[iVar0], 0))
		{
			if (VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_81[iVar0]) > 0)
			{
				...
				func_33(iVar6);
				ENTITY::_SET_ENTITY_REGISTER(iLocal_69[iVar0], true);
				ENTITY::_SET_ENTITY_REGISTER(iVar6, true);
...
int func_35()
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar3);
	iVar2 = 0;
	while (iVar2 < iLocal_68)
	{
		...
		default:
			...
			while (iVar6 < *uParam12)
			{
				...
				*(uParam12[iVar6 /*3*/]) = { 0f, 0f, 0f };
				(*uParam13)[iVar6] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f);
				iVar6++;
			}
			break;
	}
	...
	*(uParam0[1 /*3*/]) = { Vector(0f, -21.4697f, -0.889f) + func_44(-1090519040, 1056964608) };
	...
	while (iVar1 <= (*uParam0 - 1))
	{
		...
		*(uParam0[iVar1 /*3*/]) = { *(uParam0[iVar1 /*3*/]) + func_44(-1090519040, 1056964608) };
		(*uParam1)[iVar1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-22f, -15f);
		iVar1++;
	}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_54(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_54(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_54(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
