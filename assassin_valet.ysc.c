...
void __EntryFunction__()
{
	...
	uLocal_52 = UI::_0x4A9923385BDB9DAD();
	uLocal_53 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	iLocal_228 = -1;
	fLocal_230 = 1f;
	iLocal_337 = 100;
	iLocal_338 = 3;
							...
							if (!PED::IS_PED_INJURED(iLocal_943))
							{
								...
								if (iLocal_937 == 1)
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_1067))
									{
										...
										{
											AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1067, iLocal_1067, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
										}
									}
								...
								else if (iLocal_937 == 8)
								{
									...
									{
										AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1065, iLocal_1065, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
									}
								...
								{
									AI::TASK_AIM_GUN_AT_ENTITY(iLocal_943, PLAYER::PLAYER_PED_ID(), -1, 0);
									func_2(iLocal_943);
								}
							}
						}
	...
	if (iLocal_931 > 11)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_939))
		{
			if (!PED::IS_PED_INJURED(iLocal_939))
			{
				...
				else if (UI::DOES_BLIP_EXIST(uLocal_950))
				{
					if (func_24(iLocal_938, iLocal_939, 1) >= (fVar0 * 0.5f))
					{
						if (!UI::IS_BLIP_FLASHING(uLocal_950))
						{
							UI::SET_BLIP_FLASHES(uLocal_950, 1);
						}
					}
					else if (UI::IS_BLIP_FLASHING(uLocal_950))
					{
						UI::SET_BLIP_FLASHES(uLocal_950, 0);
					}
				}
			}
		}
...
int func_64(char* sParam0)
{
	if (!func_65(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_86(sParam0)) || func_86("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_65(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_73() || func_72(Global_4456448.f_152990)) || func_71())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_69(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_66(int iParam0)
{
	if (iParam0 != func_68())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_67(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
	...
	switch (iLocal_1027)
	{
		case 0:
			if (!func_22())
			{
				...
				{
					AI::TASK_CLEAR_LOOK_AT(iLocal_941[0]);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[1], 0))
				{
					AI::TASK_CLEAR_LOOK_AT(iLocal_941[1]);
				}
				iVar0 = func_96();
				if (bLocal_982)
				{
...
int func_93()
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_941[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_941[iVar0], 0))
		{
			...
			if (PED::_0x6CD5A433374D4CFB(iLocal_941[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_942[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_942[iVar0], 0))
		{
			...
			if (PED::_0x6CD5A433374D4CFB(iLocal_942[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_940[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_940[iVar0], 0))
		{
			...
			if (PED::_0x6CD5A433374D4CFB(iLocal_940[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
...
int func_101(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(iParam0) == 3 && PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(iLocal_938) == iParam0)
			{
				return 1;
			}
		}
...
int func_103(int iParam0)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
	{
		...
		{
			if (GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(-1223.024f, -187.3076f, 39.02538f, -1220.311f, -186.2481f, 40.42538f, 6.5f, joaat("weapon_stickybomb"), 0) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(-1223.024f, -187.3076f, 38.02538f, -1220.311f, -186.2481f, 40.42538f, 4.5f, joaat("weapon_stickybomb"), 0))
			{
				*iParam0 = 8;
				return 1;
			}
	...
	switch (iLocal_934[iParam0])
	{
		...
		case 1:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
			{
				if (func_129())
				{
					if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1066))
					{
						if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_942[iParam0], iLocal_1066, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
						}
					}
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_942[iParam0], iLocal_1066, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					{
						if (!iLocal_959)
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
							{
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1273030092) != 1)
								{
									AI::TASK_VEHICLE_ESCORT(iLocal_942[iParam0], iLocal_1066, iLocal_1065, -1, 45f, 786981, 10f, -1, 10f);
								}
							}
						}
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 780511057) != 1)
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
						...
						else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 780511057) != 1)
						{
							AI::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
						}
					}
		...
		case 6:
			if (bLocal_984)
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
				AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				AI::TASK_LOOK_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 1500), 2048, 4);
				AI::TASK_LOOK_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2000, 2500), 2048, 4);
				AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 11000), 30f, 1f, 1073741824, 0);
				AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
				{
					AI::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], uLocal_1072);
				}
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
			}
			else
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
				AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				AI::TASK_AIM_GUN_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 3500), 1, 0);
				AI::TASK_AIM_GUN_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 3500), 0, 0);
				AI::TASK_AIM_GUN_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 3500), 0, 0);
				AI::TASK_AIM_GUN_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 3500), 0, 0);
				AI::TASK_AIM_GUN_AT_COORD(0, func_123(), -1, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
				{
					AI::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], uLocal_1072);
		...
		case 7:
			if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 1435919172) != 1)
				{
					AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_942[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
...
void func_111(vector3 vParam0, float fParam1, float fParam2)
{
	...
	{
		if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065))
		{
			fParam1 = (fParam1 * 2f);
			iVar0 = 1;
		}
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_24(iParam1, iParam0, 0) > fParam2 && func_23(iParam1, 1) < fParam3)
				{
					...
					{
						AI::TASK_VEHICLE_MISSION(iParam1, iParam0, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 6, 35f, 786469, -1f, -1f, 1);
			...
			else if (PED::IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
			{
				if (func_23(iParam1, 1) > fParam4)
				{
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, PLAYER::PLAYER_PED_ID(), 6, 35f, 786469, -1f, -1f, 1);
						AI::ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, PLAYER::PLAYER_PED_ID());
					}
				}
...
void func_121(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iLocal_938) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		AI::TASK_AIM_GUN_AT_ENTITY(0, iLocal_938, -1, 0);
...
void func_122(int iParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_938, 0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_938, 0))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
			AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 256);
			AI::TASK_COMBAT_PED(0, iLocal_938, 0, 16);
			AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
			if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
			{
				AI::TASK_PERFORM_SEQUENCE(iParam0, uLocal_1072);
			}
			AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
		}
		else if (!PED::IS_PED_INJURED(iParam0))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 780511057) != 1)
			{
				...
				AI::TASK_COMBAT_PED(iParam0, iLocal_938, 0, 16);
			}
		}
	}
}
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_938, iParam0, vParam1, 0, 1, 0))
			{
				if (PED::IS_PED_FACING_PED(iParam0, iLocal_938, 160f))
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_938, 17))
					{
						AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
						iLocal_937 = 5;
						iLocal_959 = 1;
					}
				}
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(*iParam0, 0))
		{
			if (!iLocal_961)
			{
				if (*iParam0 == iLocal_943)
				{
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
					AI::OPEN_SEQUENCE_TASK(&uVar0);
					AI::TASK_GO_TO_ENTITY(0, iLocal_938, 20000, 2f, 1f, 1073741824, 0);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_938, -1);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::TASK_PERFORM_SEQUENCE(*iParam0, uVar0);
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
					iLocal_961 = 1;
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(*iParam0, iLocal_938, -1);
				}
			}
...
void func_128(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1794415470) != 1)
				{
					AI::TASK_ENTER_VEHICLE(iLocal_942[iParam0], iLocal_1066, 20000, iVar0, 2f, 1, 0);
				}
			}
		}
	}
...
void func_130(vector3 vParam0, vector3 vParam1, float fParam2)
{
	if (!iLocal_959)
	{
		if (GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vParam0, vParam1, fParam2, joaat("weapon_stickybomb"), 0))
		{
			iLocal_959 = 1;
		}
	}
	...
	switch (iLocal_933[iParam0])
	{
		case 0:
			if (!PED::IS_PED_INJURED(iVar0))
			{
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
				AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
				AI::TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1054[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				AI::TASK_ACHIEVE_HEADING(0, fLocal_1041[iParam0], 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				AI::TASK_PERFORM_SEQUENCE(iVar0, uLocal_1072);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
				{
					if (!bLocal_994)
					{
						if (AI::GET_SCRIPT_TASK_STATUS(iVar0, -2017877118) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar0, 242628503) != 1)
						{
		...
		case 4:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (!PED::IS_PED_INJURED(iVar0))
				{
					if (iParam0 == 0)
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_941[0], iLocal_941[1], -1, 0, 2);
						if (!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
							AI::TASK_ENTER_VEHICLE(iVar0, iLocal_1065, 30000, -1, 1f, 1, 0);
						}
					}
					else if (iParam0 == 1)
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_941[1], iLocal_941[0], -1, 0, 2);
						if (!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
							AI::TASK_ENTER_VEHICLE(iVar0, iLocal_1065, 30000, 0, 1f, 1, 0);
						}
					}
					else if (iParam0 == 2)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
						{
							if (!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1066, 0))
							{
								AI::TASK_ENTER_VEHICLE(iVar0, iLocal_1066, 30000, 1, 1f, 1, 0);
							}
						}
					}
				}
		...
		case 5:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iVar0, 150319005) != 1)
				{
					if (iParam0 == 0)
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[1], -1, 2048, 4);
					}
					else if (iParam0 == 1)
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[0], -1, 2048, 4);
					}
				}
			}
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					...
					if (iLocal_959)
					{
						if (!PED::IS_PED_INJURED(iVar0))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iVar0, 780511057) != 1)
							{
								...
								AI::TASK_COMBAT_PED(iVar0, iLocal_938, 0, 16);
							}
						}
					}
				}
			...
			if (!iLocal_959)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0)
					{
						if (!PED::IS_PED_INJURED(iVar0))
						{
							VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1065, 1, 1, 0);
							if (func_133())
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							}
							else
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
							}
						}
					}
		...
		case 7:
			if (iLocal_959)
			{
				if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1065, 1, 0) == iLocal_939)
				{
					if (!PED::IS_PED_INJURED(iVar0))
					{
						if (bLocal_974 || (iLocal_988 && !AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065)))
						{
							...
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
									...
									{
										AI::TASK_VEHICLE_MISSION(iVar0, iLocal_1065, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 8, 35f, 786469, -1f, -1f, 1);
									}
								}
								else if (AI::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
								{
									AI::TASK_VEHICLE_MISSION_PED_TARGET(iVar0, iLocal_1065, PLAYER::PLAYER_PED_ID(), 8, 35f, 786469, -1f, -1f, 1);
								}
							}
						}
					}
			...
			else if (bLocal_974 || (iLocal_988 && !AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065)))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
							{
								AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1065, vLocal_1057, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
		...
		case 8:
			if (bLocal_984)
			{
				...
				AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				AI::TASK_LOOK_AT_COORD(0, func_123(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 1500), 2048, 4);
				AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(15000, 16000), 30f, 1f, 1073741824, 0);
				AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[iParam0], 0))
				{
					AI::TASK_PERFORM_SEQUENCE(iLocal_941[iParam0], uLocal_1072);
				}
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
			}
			else
		...
		case 9:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_941[iParam0], 1435919172) != 1)
				{
					AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_941[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
...
void func_138(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iParam0, -1207174364) != 1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, 1630799643) != 1)
			{
				AI::TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_938, -1, 0);
			}
		}
...
void func_140(int iParam0, var uParam1)
{
	...
	if (iVar0 == 0)
	{
		AI::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 1)
	{
		AI::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 2)
	{
		AI::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 3)
	{
		AI::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	*uParam1 = iVar0;
}
...
void func_142(int iParam0)
{
	...
	switch (iLocal_936[iParam0])
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
					{
						if (iParam0 == 0)
						{
							AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_940[iParam0], iLocal_939, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
							{
								...
								AI::TASK_GO_TO_COORD_ANY_MEANS(0, -1222.992f, -191.0932f, 38.17538f, 1f, 0, 0, 786603, -1082130432);
								AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_GUARD_STAND", 0, 0);
								AI::TASK_ENTER_VEHICLE(0, iLocal_1066, 30000, 2, 1f, 1, 0);
								AI::CLOSE_SEQUENCE_TASK(uVar2);
								AI::TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], uVar2);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_940[iParam0], iVar0, 0))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], -1794415470) != 1)
								{
									AI::TASK_ENTER_VEHICLE(iLocal_940[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
								}
							}
						}
						else
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_940[iParam0], iVar0, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					{
						if (iLocal_959)
						{
							if (!bLocal_989)
							{
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], 780511057) != 1)
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
									...
									AI::TASK_COMBAT_PED(iLocal_940[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
								}
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], 780511057) != 1)
							{
								AI::TASK_COMBAT_PED(iLocal_940[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
							}
						}
		...
		case 3:
			...
			if (bLocal_984)
			{
				...
				AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				AI::TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], uLocal_1072);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
			}
			else if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
			{
				...
				if (!iLocal_956 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_940[iParam0], 0))
				{
					...
					if (PED::IS_PED_INJURED(iLocal_939))
					{
						AI::TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1250, 0, 0f, 0, 0, 0);
						AI::TASK_AIM_GUN_AT_COORD(0, func_123(), 3000, 0, 1);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
					else
					{
						AI::TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 700, 0, 0f, 0, 0, 0);
						AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
					AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
					iLocal_956 = 1;
				}
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_1065) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					{
						...
						vVar5 = { vVar4 - vVar5 };
						PED::_0xE4723DB6E736CCFF(iLocal_940[iParam0], iLocal_1065, vVar5, 1.5f, 0);
					}
					AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					if (PED::IS_PED_INJURED(iLocal_939) && !func_44(func_143(), vVar4, 0))
					{
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar4, func_123(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
						AI::TASK_PUT_PED_DIRECTLY_INTO_COVER(0, vVar4, -1, 0, 0.25f, 0, 0, 0, 1);
					}
					else
					{
						AI::TASK_AIM_GUN_AT_COORD(0, func_123(), 1500, 1, 0);
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
						{
							AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
						}
					}
					AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
				}
		...
		case 5:
			...
			if (!PED::IS_PED_INJURED(iLocal_939))
			{
				if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
					{
						AI::TASK_COMBAT_PED(iLocal_940[iParam0], iLocal_938, 0, 16);
					}
					else
					{
						AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_940[iParam0], iLocal_939, PLAYER::PLAYER_PED_ID(), 3f, 1, 0.005f, 1082130432, 1, 0, -957453492);
					}
				}
	...
	else if (iLocal_936[iParam0] < 5)
	{
		if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
		{
			...
			AI::TASK_CLEAR_DEFENSIVE_AREA(iLocal_940[iParam0]);
	...
	switch (iLocal_935)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_941[0], 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
					{
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_939, -1794415470) != 1)
						{
							if (!iLocal_959 && !iLocal_983)
							{
								AI::TASK_ENTER_VEHICLE(iLocal_939, iLocal_1065, 30000, 1, 1f, 1, 0);
							}
							else
							{
								AI::TASK_ENTER_VEHICLE(iLocal_939, iLocal_1065, 30000, 1, 2f, 1, 0);
							}
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_939, -828834893) != 1)
					{
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_939, 0, 256);
					}
				}
				else if (!bLocal_989)
				{
					...
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
					AI::OPEN_SEQUENCE_TASK(&uVar0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0f, 0, 0, 0);
					AI::TASK_SMART_FLEE_PED(0, iLocal_938, 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
					{
						AI::TASK_PERFORM_SEQUENCE(iLocal_939, uVar0);
					}
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
					bLocal_989 = true;
				}
				else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_939, 1435919172) != 1)
				{
					AI::TASK_SMART_FLEE_PED(iLocal_939, iLocal_938, 200f, -1, 0, 0);
				}
				if (!iLocal_1004)
				{
...
void func_151()
{
	...
	switch (iLocal_1035)
	{
		...
		case 1:
			...
			if (func_230(&uLocal_342, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
...
void func_161(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_163() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_163() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_162(iParam0));
...
bool func_167(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_163() /*12745*/].f_8178.f_10, iParam0);
}
...
void func_194(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_200(uParam0->f_1, 256) || (func_200(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(func_200(uParam0->f_1, 4096));
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		}
		iVar5 = 0;
		iVar6 = 0;
	...
	while (bVar0)
	{
		...
		if ((uParam0->f_565 || uParam0->f_566) && uParam0->f_56 != 0)
		{
			if (IntToFloat(uParam0->f_572) > (IntToFloat(uParam0->f_558 + 1165) - (15000f * fParam2)))
			{
				...
				uParam0->f_559 = func_204((uParam0->f_559 + (((1f / 0.3f) * uParam0->f_573) * SYSTEM::TIMESTEP())), 0f, 1f);
				uParam0->f_573 = func_204((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
			}
		}
		else
		{
			uParam0->f_559 = func_204((uParam0->f_559 - ((((1f / 0.3f) * uParam0->f_573) * 0.01f) * SYSTEM::TIMESTEP())), 0f, 1f);
			uParam0->f_573 = func_204((uParam0->f_573 + 0.07f), 0.75f, 1.15f);
		}
...
void func_203(var uParam0, bool bParam1)
{
	...
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, true));
	func_198("ES_HELP");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
	...
	if (bParam1)
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
		func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, true));
		func_198("ES_XPAND");
		if (GAMEPLAY::IS_PC_VERSION())
		{
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
...
void func_205(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_220();
		GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_223((2f - 0.5f)) - 0.001388889f)), fVar6, func_218(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
	...
	while (iVar17 < uParam0->f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_215(uParam0, iVar17, (fVar1 + func_223(2f)), fVar9, fVar10, SYSTEM::ROUND((IntToFloat(iVar0) * fVar12)));
		}
		else
		{
			return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_204((fVar11 / (0.6f * func_223(25f))), 0f, 1f);
					func_220();
					GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_223((2f * 0.5f))), fVar6, func_218(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_223((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_223((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					UI::END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_223((2f * 2f))), 0);
					break;
...
var func_211(int iParam0, bool bParam1)
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Global_17367.f_6863[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_213(PLAYER::PLAYER_ID()) };
...
void func_215(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	UI::SET_TEXT_JUSTIFICATION(1);
	UI::SET_TEXT_SCALE(1f, func_217(14f));
	UI::SET_TEXT_CENTRE(0);
	UI::SET_TEXT_FONT(0);
	func_220();
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(7, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_208(5, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(5, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_208(6, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(6, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_216(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			UI::SET_TEXT_SCALE(1f, func_217(18f));
			UI::SET_TEXT_FONT(4);
			if (iParam0 < 0)
			{
...
void func_231(var uParam0)
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(2);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, true));
	func_198("ES_HELP_TU");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, true));
	func_198("ES_HELP_TD");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, true));
	func_198("ES_HELP_AB");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
...
void func_232(var uParam0)
{
	...
	fVar0 = 0f;
	UI::SET_TEXT_JUSTIFICATION(0);
	UI::SET_TEXT_SCALE(1f, func_217(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_234()
{
	...
	if (!iLocal_331)
	{
		...
		if (Global_87504)
		{
			func_239(&uLocal_342, 6, &(Local_919.f_12), "MTPHPERSKI", SYSTEM::FLOOR(fLocal_326), 0, 3, 0);
			func_239(&uLocal_342, 6, &(Local_919.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_239(&uLocal_342, 6, &(Local_919.f_30), "MTPHPERSKI", SYSTEM::ROUND((fLocal_328 + fLocal_327)), 0, 3, 0);
			func_238();
		}
		else
		{
			if (bLocal_330)
			{
				func_239(&uLocal_342, 6, &(Local_919.f_12), "MTPHPERRET", SYSTEM::FLOOR(fLocal_326), 0, 3, 0);
			}
			else
			{
				func_239(&uLocal_342, 9, &(Local_919.f_12), "", SYSTEM::FLOOR(fLocal_326), 0, 0, 0);
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_919.f_18)))
			{
				if (bLocal_329)
				{
					func_239(&uLocal_342, 6, &(Local_919.f_24), "", 0, 0, 2, 0);
					func_239(&uLocal_342, 3, &(Local_919.f_30), "", SYSTEM::ROUND((fLocal_328 + fLocal_327)), 0, 2, 0);
				}
				else
				{
					func_239(&uLocal_342, 6, &(Local_919.f_24), "", 0, 0, 1, 0);
					func_239(&uLocal_342, 3, &(Local_919.f_30), "", SYSTEM::ROUND(fLocal_327), 0, 0, 0);
				}
			}
			else
			{
...
void func_235()
{
	...
	{
		func_236(38, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_236(39, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_236(40, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_236(40, SYSTEM::ROUND(fLocal_327), 1);
		}
	...
	{
		func_236(52, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_236(53, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_236(56, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_236(56, SYSTEM::ROUND(fLocal_327), 1);
		}
	...
	{
		func_236(66, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_236(67, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_236(68, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_236(68, SYSTEM::ROUND(fLocal_327), 1);
		}
	...
	{
		func_236(81, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_236(82, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_236(83, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_236(83, SYSTEM::ROUND(fLocal_327), 1);
		}
	...
	{
		func_236(97, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_236(98, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_236(99, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_236(99, SYSTEM::ROUND(fLocal_327), 1);
		}
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_940[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_940[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(iLocal_940[iVar0]);
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_941[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_941[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(iLocal_941[iVar0]);
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_942[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_942[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(iLocal_942[iVar0]);
			...
			else
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_942[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_942[0], 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_1066, 0))
					{
						...
						{
							AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_942[0]);
						}
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_942[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_942[1], 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_1066, 0))
					{
						...
						{
							AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_942[1]);
						}
					}
				}
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
...
void func_251(bool bParam0)
{
	...
	if (bParam0)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_950))
		{
			UI::REMOVE_BLIP(&uLocal_950);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_951[iVar0]))
		{
			UI::REMOVE_BLIP(&(uLocal_951[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_952[iVar0]))
		{
			UI::REMOVE_BLIP(&(uLocal_952[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
float func_257(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
{
	func_269();
	iLocal_1022 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iLocal_1020);
	...
	if (!UI::DOES_BLIP_EXIST(uLocal_950))
	{
		uLocal_950 = func_268(iLocal_939, 0, 0);
	}
	UI::SET_BLIP_SCALE(uLocal_950, 1f);
}
...
int func_268(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
	{
		UI::SET_BLIP_SCALE(uVar0, func_197(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_197(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
...
void func_269()
{
	...
	while (iVar0 < 3)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_1052[iVar0 /*3*/], 5f) && !func_273(iVar0, 6f))
		{
...
float func_271(vector3 vParam0, int iParam1)
{
	return func_26(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), vParam0, iParam1);
}
...
void func_278()
{
	switch (iLocal_1018)
	{
		case 0:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1065, 0, 1, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_282()
{
	...
	while (iVar1 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_941[iVar1]))
		{
			...
			PED::SET_PED_CONFIG_FLAG(iLocal_941[iVar1], 104, 1);
...
void func_300(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_369(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_362(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_302(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_302(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_13();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_322(PLAYER::PLAYER_PED_ID());
		func_315(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_314())
		{
			func_308(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_316(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_321(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_318(Var7.f_1)) && iVar9 < 50)
			{
...
int func_326(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_348())
		{
			*uParam0 = func_332(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_328(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_330() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_309(func_329(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_332(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_347(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_333(iVar0, 0), 1);
...
var func_349()
{
	...
	func_359(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_358(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_357(&uVar0, TIME::GET_CLOCK_HOURS());
	func_352(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_351(&uVar0, TIME::GET_CLOCK_MONTH());
	func_350(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_355(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_372()
{
	...
	{
		case 0:
			if (func_403(1084227584, 1) || (bLocal_976 && STREAMING::_0x7D41E9D2D17C5B2D(uLocal_955)))
			{
				func_402(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, vLocal_1413, fLocal_1414, 1, 1, 1, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1220.57f, -185.96f, 38.4f, 50f, 0, 0, 0, 0, false, 0);
					...
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_1065) >= 7000f)
					{
						...
						while (iLocal_1017 < 3)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[iLocal_1017], 0))
							{
								...
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_941[iLocal_1017], 242628503) != 1)
								{
									AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
									AI::OPEN_SEQUENCE_TASK(&uLocal_1072);
									AI::TASK_LEAVE_ANY_VEHICLE(0, iVar0, 0);
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1052[iLocal_1017 /*3*/], 1f, 20000, 0.25f, 0, 40000f);
									AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
									AI::TASK_PERFORM_SEQUENCE(iLocal_941[iLocal_1017], uLocal_1072);
									AI::CLEAR_SEQUENCE_TASK(&uLocal_1072);
								}
							}
							iLocal_1017++;
...
{
	if (func_377() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_380(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_384(PLAYER::PLAYER_ID())) && !func_382(PLAYER::PLAYER_ID(), 0)) && !func_381()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_384(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
		}
		Global_71203 = 0;
...
int func_386(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_397()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1068))
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1068, 0, 1, 0);
...
void func_401()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1065))
	{
		...
		VEHICLE::_0x2B6747FAA9DB9D6B(iLocal_1065, 1);
...
int func_403(float fParam0, int iParam1)
{
	...
	if (((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_404(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam0, 1, 1056964608, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!func_416())
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_949))
					{
						uLocal_949 = func_415(vLocal_1061, 1);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_949, "ASS_VA_DESTBLIP");
						func_414(&uLocal_949, -1234.307f, -250.6783f, 38.2238f, 28.914f);
						if (!iLocal_958)
						{
				...
				else if (STREAMING::_0x7D41E9D2D17C5B2D(uLocal_955) && func_412())
				{
					func_411();
					func_253();
					iLocal_931 = 8;
			...
			{
				func_410(uLocal_949, "ASS_VA_LOSECOPS");
			}
			else
			{
				func_31(3);
...
bool func_413(char* sParam0, int iParam1, char* sParam2)
{
...
var func_415(vector3 vParam0, int iParam1)
{
	var uVar0;
...
void func_418()
{
	...
	switch (iLocal_1025)
	{
		case 0:
			...
			if ((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_bevhills_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_f_m_bevhills_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_f_m_bevhills_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("taxi"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_hipster_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("OJAS_HotelTaxi01"))
			{
				iLocal_1025++;
			}
			break;
		...
		case 1:
			...
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			AI::TASK_LOOK_AT_ENTITY(0, Local_1427[1], -1, 0, 2);
			AI::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.679f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
			AI::CLOSE_SEQUENCE_TASK(uVar0);
			if (!ENTITY::IS_ENTITY_DEAD(Local_1427[0], 0))
			{
				AI::TASK_PERFORM_SEQUENCE(Local_1427[0], uVar0);
			}
			AI::CLEAR_SEQUENCE_TASK(&uVar0);
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			AI::TASK_LOOK_AT_ENTITY(0, Local_1427[0], -1, 0, 2);
			AI::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
			AI::CLOSE_SEQUENCE_TASK(uVar0);
			if (!ENTITY::IS_ENTITY_DEAD(Local_1427[1], 0))
			{
				AI::TASK_PERFORM_SEQUENCE(Local_1427[1], uVar0);
			}
			AI::CLEAR_SEQUENCE_TASK(&uVar0);
			...
			AI::TASK_LOOK_AT_ENTITY(Local_1427.f_3, Local_1427[0], -1, 0, 2);
			...
			AI::TASK_PLAY_ANIM(Local_1427.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(Local_1427.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0f, 0, 0, 0);
			...
			AI::TASK_PLAY_ANIM(Local_1427.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(Local_1427.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0f, 0, 0, 0);
			Local_1427.f_11 = 1;
...
void func_421()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_944))
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_944))
		{
			...
			PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_944, 16);
			PED::SET_PED_CONFIG_FLAG(iLocal_944, 208, 1);
			if (fVar1 < 5f)
			{
			...
			switch (iLocal_1016)
			{
				case 0:
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
						if ((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || (ENTITY::DOES_ENTITY_EXIST(iLocal_944) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_944, PLAYER::PLAYER_PED_ID(), 1))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1426, PLAYER::PLAYER_PED_ID(), 1))
						{
							...
							AI::TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0f, 0, 0, 0);
							iLocal_1016 = 1;
						}
					}
					break;
				...
				case 1:
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						...
						{
							AI::OPEN_SEQUENCE_TASK(&uVar0);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1502.029f, -948.687f, 7.65061f, 1f, 20000, 1f, 1, 40000f);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1462.339f, -964.178f, 6.3394f, 1f, -1, 1f, 1, 40000f);
							AI::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_944), 0);
							AI::CLOSE_SEQUENCE_TASK(uVar0);
							AI::TASK_PERFORM_SEQUENCE(iLocal_944, uVar0);
							AI::CLEAR_SEQUENCE_TASK(&uVar0);
...
void func_427()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_93232.f_20, 13))
	{
		func_510();
	}
	func_428(0, -1, 1);
...
int func_435()
{
	...
	iVar0 = 0;
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_1074) && STREAMING::HAS_MODEL_LOADED(iLocal_1077)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(102, "ASSOJva")) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(107, "ASSOJva")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_101")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_101a")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_104")) && STREAMING::HAS_ANIM_DICT_LOADED("ODDJOBS@ASSASSINATE@GUARD")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@")) && UI::HAS_ADDITIONAL_TEXT_LOADED(3))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_438()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_1080);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1080, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_1080, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_1080);
	GAMEPLAY::CLEAR_AREA(-1220.57f, -185.96f, 38.4f, 200f, 1, 0, 0, false);
...
void func_440()
{
	...
	while (iLocal_1017 <= 4)
	{
		fLocal_1042[iLocal_1017] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f);
		iLocal_1017++;
	}
	fLocal_327 = 7000f;
	fLocal_328 = 2000f;
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				GAMEPLAY::CLEAR_AREA(-1507.715f, -941.1313f, 8.37286f, 10f, 1, 0, 0, false);
				...
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 1000f, -4f, -1, 513, 0f, 0, 0, 0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0)))
			{
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Lester", 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_944) && !PED::IS_PED_INJURED(iLocal_944))
					{
						...
						AI::TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
...
void func_443()
{
	...
	{
		iLocal_1426 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, -403891623, 1, 0, 1);
	}
}
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar0))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
					{
						if ((iVar0 != iLocal_1071[0] && iVar0 != iLocal_1071[1]) && iVar0 != iLocal_1071[2])
						{
							...
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1071[iLocal_1036 + 1], 1, 0);
							VEHICLE::_0x02398B627547189C(iLocal_1071[iLocal_1036 + 1], 0);
							iLocal_1036++;
						}
					}
				}
...
void func_449(int iParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if ((bParam1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1) || !bParam1)
		{
			AI::OPEN_SEQUENCE_TASK(&uVar0);
	...
	switch (iLocal_1026)
	{
		case 0:
			if (((iLocal_979 || iLocal_963) || func_23(Local_1427[0], 0) < 1f) || func_23(Local_1427[1], 0) < 1f)
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(Local_1427[0], Local_1427[1], -1, 0, 2);
					AI::TASK_LOOK_AT_ENTITY(Local_1427[1], Local_1427[0], -1, 0, 2);
				}
				...
				{
					AI::CLEAR_PED_TASKS(Local_1427[1]);
					AI::TASK_ENTER_VEHICLE(Local_1427[1], Local_1427.f_4, 20000, 2, 1f, 1, 0);
				}
		...
		case 1:
			if (!iLocal_999)
			{
				if (func_52(&iLocal_1096))
				{
					if (func_46(&iLocal_1096) > 3f)
					{
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_1427[0], -1794415470) != 1)
							{
								AI::CLEAR_PED_TASKS(Local_1427[0]);
								AI::TASK_ENTER_VEHICLE(Local_1427[0], Local_1427.f_4, 20000, 1, 1f, 1, 0);
								iLocal_999 = 1;
							}
						}
					}
			...
			if (!PED::IS_PED_INJURED(Local_1427[0]) && !PED::IS_PED_INJURED(Local_1427[1]))
			{
				if (PED::IS_PED_IN_VEHICLE(Local_1427[0], Local_1427.f_4, 0) && PED::IS_PED_IN_VEHICLE(Local_1427[1], Local_1427.f_4, 0))
				{
					...
					{
						AI::TASK_CLEAR_LOOK_AT(Local_1427.f_3);
						func_50(&iLocal_1096);
					}
					iLocal_1026++;
				}
		...
		case 2:
			if (func_52(&iLocal_1096))
			{
				if (func_46(&iLocal_1096) > 3f)
				{
					...
					{
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1427.f_3, Local_1427.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1026++;
					}
				}
			}
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Local_1427.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_1427.f_4, 0))
			{
				if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_1427.f_4) || iLocal_1002)
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(Local_1427.f_3, Local_1427.f_4, 10f, 786603);
					iLocal_1026++;
				}
			}
			break;
...
void func_451()
{
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
		PED::SET_PED_FLEE_ATTRIBUTES(Local_1427[0], 2, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
		PED::SET_PED_FLEE_ATTRIBUTES(Local_1427[1], 2, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427.f_8[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427.f_8[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427.f_5[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		AI::TASK_SMART_FLEE_PED(Local_1427.f_5[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
}
	...
	if (func_506(uParam0))
	{
		...
		if (func_505(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_483(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_306(iParam0, 0, 0)) || func_306(iParam0, 1, 0)) || func_306(iParam0, 2, 0)) || func_291(iParam0) != 145) || func_473(iParam0)) || func_472(iParam0)) || func_471(iParam0)) || func_470(iParam0)) || !func_460(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_472(iParam0))
		{
		}
...
int func_483(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_485(iParam0, uVar1[iVar3], 1) && func_484(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_44(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_487(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_293(iParam0, iParam1))
				{
...
void func_488(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_496(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_495())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_296(iVar2 + 1)))
				{
...
int func_489(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_493(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_492(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_504(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_518()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_28[0]))
	{
		...
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Global_89824.f_28[0]));
	}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_520(PLAYER::PLAYER_PED_ID(), 1);
