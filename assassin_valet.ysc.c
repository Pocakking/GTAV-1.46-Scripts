...
void __EntryFunction__()
{
	...
	iLocal_53 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	iLocal_228 = -1;
	fLocal_230 = 1f;
	iLocal_337 = 100;
	iLocal_338 = 3;
	...
	if (iLocal_931 > 11)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_939))
		{
			if (!PED::IS_PED_INJURED(iLocal_939))
			{
				...
				else if (UI::DOES_BLIP_EXIST(iLocal_950))
				{
					if (func_24(iLocal_938, iLocal_939, 1) >= (fVar0 * 0.5f))
					{
						if (!UI::IS_BLIP_FLASHING(iLocal_950))
						{
							UI::SET_BLIP_FLASHES(iLocal_950, 1);
						}
					}
					else if (UI::IS_BLIP_FLASHING(iLocal_950))
					{
						UI::SET_BLIP_FLASHES(iLocal_950, 0);
					}
				}
			}
		}
		...
		case 3:
			...
			else if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
			{
				...
				else
				{
					...
					{
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar4, func_123(), 2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
...
void func_251(bool bParam0)
{
	...
	if (bParam0)
	{
		if (UI::DOES_BLIP_EXIST(iLocal_950))
		{
			UI::REMOVE_BLIP(&iLocal_950);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
...
void func_267()
{
	...
	UI::SET_BLIP_SCALE(iLocal_950, 1f);
}
...
int func_268(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
	{
		UI::SET_BLIP_SCALE(iVar0, func_197(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_197(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
...
int func_332(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_347(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_333(iVar0, 0), true);
						...
						while (iLocal_1017 < 3)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[iLocal_1017], 0))
							{
								...
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_941[iLocal_1017], 242628503) != 1)
								{
									...
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1052[iLocal_1017 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
									AI::CLOSE_SEQUENCE_TASK(uLocal_1072);
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!func_416())
				{
					if (!UI::DOES_BLIP_EXIST(iLocal_949))
					{
						iLocal_949 = func_415(vLocal_1061, 1);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_949, "ASS_VA_DESTBLIP");
			...
			switch (iLocal_1016)
			{
				...
				case 1:
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						...
						{
							AI::OPEN_SEQUENCE_TASK(&uVar0);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1502.029f, -948.687f, 7.65061f, 1f, 20000, 1f, 1, 1193033728);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_44(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
...
void func_518()
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_28[0], true, 1);
