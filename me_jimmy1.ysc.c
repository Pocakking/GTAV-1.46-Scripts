...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("M_PO", 0);
		switch (iLocal_295)
		{
			case 0:
				func_395();
...
void func_3()
{
	...
	else if (func_36(iLocal_299) && func_36(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			{
				if (iLocal_281 < 4 && GAMEPLAY::GET_GAME_TIMER() > iLocal_279)
				{
					func_22();
					if (!func_21())
					{
						...
						{
							iLocal_281++;
							iLocal_279 = GAMEPLAY::GET_GAME_TIMER() + 9000;
						}
					}
				}
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_299, -1519143300) != 1)
				{
					AI::TASK_HANDS_UP(iLocal_299, -1, 0, -1, 0);
				}
			}
			else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_299, -1519143300) == 1)
			{
				AI::CLEAR_PED_TASKS(iLocal_299);
			}
		}
	}
}
...
void func_54(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_56(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
	{
		...
		switch (iLocal_296)
		{
			case 0:
				...
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_299, -1, 2050, 4);
				if (func_43(iVar0))
				{
			...
			case 2:
				if (func_43(iVar0))
				{
					...
					if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
					{
						...
						iLocal_251 = GAMEPLAY::GET_GAME_TIMER() + 25000;
						iLocal_296 = 3;
					}
				}
				else
			...
			case 3:
				...
				if (((!func_21() && func_76(iLocal_299, vLocal_250, 4f)) || bLocal_252) || GAMEPLAY::GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_21())
...
void func_67(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_72(PLAYER::PLAYER_ID())) && !func_69(PLAYER::PLAYER_ID(), 0)) && !func_68()) && !bParam4)
			{
...
void func_83(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_84(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_135(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_127(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_135(iVar10, 14, uVar15[iVar1], -1) };
			func_105(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_127(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_106(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_137(int iParam0)
{
	...
	func_138(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_131(func_141(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_138(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_138(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_95(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_199(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_95(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_95(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
	{
		...
		switch (iLocal_296)
		{
			...
			case 3:
				...
				if (((!func_21() && (func_76(iLocal_299, vLocal_247, 2f) || func_76(iLocal_299, vLocal_248, 2f))) || bLocal_252) || GAMEPLAY::GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_21())
	...
	if (func_36(iLocal_299) && func_43(iLocal_304))
	{
		switch (iLocal_234)
		{
			...
			case 2:
				...
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_266 = 0;
				iLocal_267 = -1;
				iLocal_234 = 12;
				break;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				if (iLocal_237 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_304, 7))
				{
					iLocal_234 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						{
							iLocal_266 = 1;
							iLocal_267 = GAMEPLAY::GET_GAME_TIMER() + 1000;
						}
						iLocal_233 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_233, true);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_back", 4f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.95f)
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_backseat", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 16;
					}
				}
				else
			...
			case 17:
				if (PED::IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, 0) && iLocal_237)
				{
					...
					{
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_299, 0, 65536);
						UNK1::_0x293220DA1B46CEBC(3f, 0f, 3);
					}
					iLocal_234 = 1;
				}
				break;
	...
	if (func_36(iLocal_299))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_299, 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_299, 0, 4416);
				}
			}
		}
	}
...
void func_222()
{
	if ((iLocal_278 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_275) && (func_225() || func_224()))
	{
			...
			if (iLocal_276 > 60)
			{
				if (!func_21() && func_223())
				{
					if (func_4(&uLocal_67, "MEJ1AUD", "MEJ1_STILL", sLocal_277[iLocal_278], 7, 0, 0))
					{
						iLocal_278++;
						iLocal_276 = 0;
						iLocal_275 = GAMEPLAY::GET_GAME_TIMER() + 9000;
					}
				}
			}
		}
...
void func_226()
{
	...
	if ((iLocal_270 < 6 && GAMEPLAY::GET_GAME_TIMER() > iLocal_268) && func_225())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_43(iVar0))
			{
				if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
				{
					...
					{
						iLocal_270++;
						iLocal_268 = GAMEPLAY::GET_GAME_TIMER() + 9000;
					}
				}
			}
		}
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if (func_331() == 1)
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_292, 10f, 0, 0, 0, 0, false, 0);
			}
			else
			{
...
void func_241()
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_287)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		...
		iLocal_287 = GAMEPLAY::GET_GAME_TIMER() + 1000;
	}
}
...
void func_242()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_282)
	{
		if ((!func_21() && func_223()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iLocal_282 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
		}
	}
}
...
void func_243()
{
	if ((iLocal_285 < 12 && GAMEPLAY::GET_GAME_TIMER() > iLocal_283) && func_36(iLocal_301[0]))
	{
		if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 30f)
		{
			if (!func_21() && func_223())
			{
				...
				{
					iLocal_285++;
					iLocal_283 = GAMEPLAY::GET_GAME_TIMER() + 9000;
				}
			}
		}
	}
...
void func_244()
{
	...
	if ((iLocal_274 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_271) && (func_225() || func_224()))
	{
		if (PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			if (bLocal_289)
			{
				...
				{
					iLocal_274++;
					iLocal_271 = GAMEPLAY::GET_GAME_TIMER() + 9000;
					PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
				}
			}
			else if (!func_21())
...
void func_245()
{
	if (iLocal_238 == 0)
	{
		if (((iLocal_240 == -1 && !func_21()) && func_223()) && func_225())
		{
			...
			{
				iLocal_239++;
				iLocal_263 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_263)
			{
	...
	{
		if (((!func_21() && func_223()) && func_225()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_263)
		{
...
void func_246()
{
	if (((((iLocal_288 && ENTITY::DOES_ENTITY_EXIST(iLocal_301[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_301[1])) && ENTITY::DOES_ENTITY_EXIST(iLocal_301[2])) && func_36(iLocal_299)) && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
...
void func_272(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_274(Var7.f_1)) && iVar9 < 50)
			{
...
int func_285(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_287() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_131(func_286(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if ((((func_43(iLocal_304) && func_36(iLocal_301[0])) && func_36(iLocal_301[1])) && func_36(iLocal_301[2])) && func_36(iLocal_299))
			{
				...
				AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_301[0], iLocal_304, 12f, 786468);
		...
		case 1:
			...
			{
				if (iLocal_266 && GAMEPLAY::GET_GAME_TIMER() > iLocal_267)
				{
				...
				if ((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_304) < 850 || func_347()) || func_345()) || func_344(iLocal_304, &uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_304) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_304) < 50f) || (func_36(iLocal_301[0]) && !PED::IS_PED_IN_VEHICLE(iLocal_301[0], iLocal_304, 0))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 1, 5000))
				{
					...
					{
						AI::TASK_VEHICLE_TEMP_ACTION(iLocal_301[0], iLocal_304, 20, 1000);
					}
					VEHICLE::_SET_VEHICLE_HALT(iLocal_304, 20f, 1, 0);
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_304))
				{
					...
					while (iVar2 < 3)
					{
						if (func_36(iLocal_301[iVar2]))
						{
							...
							AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(iVar3);
							AI::TASK_PERFORM_SEQUENCE(iLocal_301[iVar2], iVar3);
							AI::CLEAR_SEQUENCE_TASK(&iVar3);
							if (iVar2 == 0 && !func_345())
							{
								func_22();
		...
		case 3:
			...
			if ((func_43(iLocal_304) && func_36(PLAYER::PLAYER_PED_ID())) && func_36(iLocal_299))
			{
				...
				if (bLocal_320)
				{
					if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_299) < 5f)
					{
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_299);
						func_336();
					}
				}
...
void func_335()
{
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_262)
		{
			if (!func_21() && !UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (func_39(&uLocal_67, "MEJ1AUD", "MEJ1_HERE", 7, 0, 0, 0))
				{
					iLocal_262 = GAMEPLAY::GET_GAME_TIMER() + 15000;
				}
			}
		}
	}
...
int func_347()
{
	...
	if (iLocal_323)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_324)
		{
			return 1;
		}
	}
	else
	{
		...
		{
			iLocal_323 = 1;
			iLocal_324 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		}
	}
	return 0;
}
...
int func_354(char* sParam0)
{
	if (!func_355(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_339(sParam0)) || func_339("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_355(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_362() || func_361(Global_4456448.f_152990)) || func_360())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_358(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_356(int iParam0)
{
	if (iParam0 != func_300())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_357(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
...
void func_376()
{
	if (iLocal_256 > 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_256)
	{
		if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
		{
			if ((func_219(PLAYER::PLAYER_PED_ID(), iLocal_299) < 50f && !func_21()) && !func_377("MEJ1_02", 0, 0))
			{
				if (iLocal_259)
				{
					...
					{
						iLocal_256 = GAMEPLAY::GET_GAME_TIMER() + 10000;
						iLocal_259 = 0;
					}
				}
...
void func_378()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_301[0])) && func_43(iLocal_304))
	{
		if (iLocal_254 == -1 && iLocal_255 == -1)
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_304, PLAYER::PLAYER_PED_ID(), 1) || bLocal_257)
			{
				...
				if (func_4(&uLocal_67, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_301[0], iLocal_304, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					UNK1::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_234 = 2;
					fLocal_293 = 200f;
					fLocal_294 = 500f;
			...
			else if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_304))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_264)
				{
					...
					if (bVar0)
					{
						iLocal_264 = GAMEPLAY::GET_GAME_TIMER() + 10000;
					}
				}
			}
		}
		...
		else if (((iLocal_254 < 8 && func_219(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f) && !func_21()) && !func_377("MEJ1_02", 0, 0))
		{
			...
			{
				iLocal_263 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				iLocal_258 = 1;
				iLocal_256 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
...
void func_380()
{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_265)
		{
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_304, 0f, -20f, 0f) };
			if (func_383(PLAYER::PLAYER_PED_ID(), vVar0, 20f))
			{
				iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, iLocal_301);
				iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 6);
				iVar2 *= 1000;
				func_381(iLocal_301[iVar1], iVar2, 0);
				iLocal_265 = (GAMEPLAY::GET_GAME_TIMER() + iVar2);
			}
		}
	}
}
		...
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iParam0))
			{
				...
				if (func_43(iVar5))
				{
					...
					AI::CLEAR_SEQUENCE_TASK(&iVar3);
					AI::OPEN_SEQUENCE_TASK(&iVar3);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar0, 4f, -8f, -1, 16 | iParam2, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar2, 8f, -4f, -1, 16 | iParam2, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar3);
...
void func_387()
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			UI::SET_BLIP_COLOUR(iLocal_298, 3);
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_298, "MEJ1_JIM");
			UI::SET_BLIP_ROUTE(iLocal_298, true);
		...
		case 1:
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_290, true) < 1400f)
			{
				iLocal_296 = 2;
			}
			break;
...
void func_389()
{
	...
	if (func_43(iLocal_304))
	{
		...
		if (!func_36(iLocal_299))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_46(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_232))
			{
				...
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_299, 1);
				AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_299, 1);
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "base", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 0;
			}
		}
	}
	else if (STREAMING::HAS_MODEL_LOADED(iLocal_305))
	{
		...
		iLocal_266 = 0;
		iLocal_267 = -1;
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_304, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0);
	}
}
...
void func_395()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("MEJ1", 0);
...
int func_407(int iParam0)
{
	if (*iParam0 < 0)
	{
		*iParam0 = GAMEPLAY::GET_GAME_TIMER() + 1000;
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > *iParam0)
	{
		return 1;
...
void func_478(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_258(iParam0, iParam1))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_282(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_493(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_261(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_261(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_261(iVar1 + 1));
			}
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_261(iVar2 + 1)))
				{
