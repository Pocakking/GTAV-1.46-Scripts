		...
		switch (iLocal_235[iParam1])
		{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &sLocal_249, &(Local_298[iParam1 /*16*/]), 2))
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_239[iParam1], 0))
						{
							...
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657) > 0.817f)
								{
						...
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657) > fLocal_313)
						{
			...
			case 10:
				...
				if (func_6(iLocal_236[iParam1], iLocal_237[iParam1], &sVar8, &cVar9, &iVar10, &iVar11) && func_4(iLocal_236[iParam1], iLocal_237[iParam1], &vVar12, &fVar13))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_312, &sVar8, &cVar9, 1000f, -8f, 0, 0, 1000f, 0);
			...
			case 1:
				if (iLocal_237[iParam1] != Global_88333[iLocal_236[iParam1]])
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Global_93018))
					{
						Global_88333[iLocal_236[iParam1]] = 140;
						Global_88349 = iLocal_237[iParam1];
...
int func_9()
{
	...
	if (!func_28())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_299))
			{
			}
			else if (!iLocal_303)
			{
...
int func_29()
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_299) && !iLocal_303)
	{
		if (func_11(&uLocal_67, "PRSAUD", &Local_299, 3, 0, 0, 0, 0))
		{
			iLocal_303 = 1;
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90657, &sLocal_249, &(Local_298[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
					iLocal_235[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_239[iVar0], 0))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90657, &(Local_244[iVar0 /*16*/]), &sLocal_249, 8f, 8f, 0, 1148846080);
				}
				iVar0++;
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_299) && iLocal_303)
...
int func_30()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90656))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90656, &sLocal_249, &(Local_297[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_239[iVar0], 0))
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_243[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90656, &(Local_243[iVar0 /*16*/]), &sLocal_249, 8f, 8f, 0, 1148846080);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_239[iVar0]))
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_299))
		{
			...
			if (iLocal_66 == 156)
			{
				func_31(&uLocal_67, 3, Global_93018, "JIMMY", 0, 1);
...
void func_40()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_233)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_305) && iLocal_308[iVar0] > 0)
			{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&sLocal_249))
		{
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_234[iVar0] != 145)
		{
			if (func_165(&(iLocal_233[iVar0]), iLocal_234[iVar0], vLocal_245 + vLocal_247[iVar0 /*3*/], (fLocal_246 + fLocal_248[iVar0]), 1))
			{
				...
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_297[iVar0 /*16*/])))
				{
					AI::TASK_PLAY_ANIM(iLocal_233[iVar0], &sLocal_249, &(Local_297[iVar0 /*16*/]), 8f, -8f, -1, 9, 0f, 0, 0, 0);
					iLocal_235[iVar0] = 0;
				}
	...
	switch (iParam1)
	{
		...
		case 9:
			if (iParam2 == 108)
			{
				iVar0 = 12;
				iVar1 = 32;
				if (GAMEPLAY::IS_BIT_SET(Global_106070.f_2355.f_539.f_3796[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32)))
				{
...
int func_43(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_44(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_44(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_44(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_44(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_65(int iParam0)
{
	...
	func_66(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_69(func_72(iParam1, uParam0->f_2), Global_71014, 0);
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_66(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_66(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_44(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_63(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_44(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_44(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_44(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_155(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_63(iVar10, 14, uVar15[iVar1], -1) };
			func_149(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_155(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_44(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_44(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_44(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_133(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_43(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_43(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_150(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
void func_170()
{
	...
	{
		case 86:
			vLocal_247[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_248[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_234[0] = 14;
			iLocal_236[0] = 0;
			iLocal_237[0] = 19;
			Global_88333[iLocal_236[0]] = 140;
		...
		case 168:
			vLocal_247[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_248[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			vLocal_247[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_248[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_234[0] = 14;
			iLocal_234[1] = 15;
			iLocal_236[0] = 0;
			iLocal_236[1] = 1;
		...
		case 173:
			...
			vLocal_241[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_242[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		default:
			vLocal_247[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_247[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_248[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_248[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_234[0] = 145;
			iLocal_234[1] = 145;
