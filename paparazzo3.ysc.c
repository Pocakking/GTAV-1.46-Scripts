...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		UNK1::_0x208784099002BC30("SF_PTP", 0);
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_268(1, 1093140480, 0))
			{
				...
				UNK1::_0x293220DA1B46CEBC(5f, 0f, 0);
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_58, 0))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
...
void func_243(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_247(PLAYER::PLAYER_ID())) && !func_245(PLAYER::PLAYER_ID(), 0)) && !func_244()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_247(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_253(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_255(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_218(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
				{
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_226))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.99f)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_227))
						{
							...
							AI::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							PED::_0x2208438012482A1A(Local_43.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
							{
...
void func_283()
{
	...
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", PED::GET_PED_BONE_COORDS(Local_43.f_28[0], 28422, vLocal_232), ENTITY::GET_ENTITY_ROTATION(Local_43.f_41[3], 2), 1f, 0, 0, 0);
...
void func_292()
{
	...
	UI::REQUEST_ADDITIONAL_TEXT("PAP3", 0);
...
void func_304()
{
	...
	{
		case 0:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_236, "DEFAULT"))
			{
				func_447(1);
			}
			else
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_310(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iLocal_37)
	{
		...
		case 3:
			if (func_219(uParam0->f_41[0]))
			{
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
