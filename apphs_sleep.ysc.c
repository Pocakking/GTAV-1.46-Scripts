...
void func_12()
{
	if (Global_14491 == 0)
	{
		if (func_11(2, Global_14482, 0))
		{
			...
			uLocal_21 = GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION();
			while (!GRAPHICS::_0x768FF8961BA904D6(uLocal_21))
			{
				SYSTEM::WAIT(0);
			}
			Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_259 = iLocal_18[GRAPHICS::_0x2DE7EFA66B906036(uLocal_21)];
...
void func_19()
{
	...
	while (iVar1 < 9)
	{
		iVar2 = 0;
		iVar3 = 9;
		Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_84[iVar3] = 5000;
		while (iVar2 < 9)
		{
			if (Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_124[iVar2] == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					if (Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_84[iVar2] < Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_84[iVar3])
					{
						iVar3 = iVar2;
						func_20(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(iVar1), SYSTEM::TO_FLOAT(Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_104[iVar3]), -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iLocal_23 /*281*/].f_7[iVar3 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar2++;
...
void func_22()
{
	func_9(Global_14494, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_24()
{
	func_9(Global_14494, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14502, 1);
	func_25();
}
			...
			if (Global_3188[Global_14513 /*2811*/][iVar2 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					if (iVar2 == 0)
					{
						...
						{
							iVar3 = iVar2;
							func_20(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(iVar1), -1f, -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iVar3 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
