...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("launcher_carwash")) > 1)
	{
...
int func_7()
{
	...
	if (!func_6(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
...
void func_56(int iParam0)
{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > uLocal_60[iParam0])
		{
			iLocal_61[iParam0] = WORLDPROBE::_0xE6AC6C45FBE83004(vLocal_59[iParam0 /*3*/], vLocal_59[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 4);
		}
	}
	else
	{
		iVar0 = WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_61[iParam0], &iVar4, &uVar2, &uVar3, &iVar1);
		if (iVar0 == 2)
		{
			Local_40[iParam0 /*24*/].f_8 = 0;
			if (iVar4 > 0)
		...
		uLocal_60[iParam0] = GAMEPLAY::GET_GAME_TIMER() + 250;
	}
}
