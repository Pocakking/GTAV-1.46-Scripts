...
void __EntryFunction__()
{
			...
			while (iVar0 < iLocal_49)
			{
				if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(iLocal_49[iVar0], iLocal_50, -1, func_243(iLocal_50), 2f, 1, 0);
						}
					}
					else
					{
						AI::TASK_STAND_STILL(iLocal_49[iVar0], 10000);
					}
				}
				iVar0++;
			}
	...
	while (true)
	{
						...
						if (func_156())
						{
							if ((iLocal_44 == 3 && !(CAM::IS_SPHERE_VISIBLE(vLocal_63, 3f) && func_155(PLAYER::PLAYER_PED_ID(), vLocal_63, 1) < 150f)) || iLocal_44 != 3)
							{
								if (iLocal_44 == 3)
								{
									...
									{
										GAMEPLAY::CLEAR_AREA(vLocal_63, 4f, 1, 0, 0, false);
									}
									iLocal_46 = 4;
									bLocal_79 = true;
								}
		...
		else
		{
			...
			if (!UI::DOES_BLIP_EXIST(iLocal_57))
			{
				...
				if (((!ENTITY::IS_ENTITY_DEAD(iLocal_50, 0) && bLocal_79) && !bLocal_81) && (!func_133(0) || (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_stickybomb"), 0) && !func_133(1))))
				{
					...
					{
						case 0:
							if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_50, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < 225f)
							{
						...
						case 2:
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_101) > 2000 && WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_stickybomb"), 0))
							{
		...
		if (bLocal_77)
		{
			if (!bLocal_78)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_93) > 5000)
				{
		...
		if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_93) > 10000 && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) && !iLocal_92)
		{
		...
		if (iLocal_97 != 0)
		{
			...
			{
				DECISIONEVENT::REMOVE_SHOCKING_EVENT(iLocal_97);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
		{
		...
		if (!bLocal_79 && !bLocal_288)
		{
			...
			{
				AI::TASK_PLAY_ANIM(iLocal_49[iLocal_96], "random@security_van", "sec_hand_override", 1000f, -4f, -1, 49, 0f, 0, 0, 0);
			}
		}
		if (!iLocal_86)
		{
	...
	if (!bLocal_89)
	{
		if (!bLocal_79)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
			{
				...
				else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_102) > 3000)
				{
...
void func_24(vector3 vParam0, bool bParam1)
{
	if (!bLocal_89 && !bLocal_81)
	{
		...
		GAMEPLAY::SET_BIT(&iLocal_104, 4);
		GAMEPLAY::SET_BIT(&iLocal_104, 1);
		if (bParam1)
		{
...
int func_26(int iParam0)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_27(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return iVar0;
}
...
void func_28()
{
	...
	switch (iLocal_47)
	{
					...
					if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_50, 2) > 0.25f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_50, 3) > 0.25f) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
						{
							if (ENTITY::IS_ENTITY_ATTACHED(iLocal_52))
							{
								...
								ROPE::ACTIVATE_PHYSICS(iLocal_52);
							...
							else if (GAMEPLAY::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iLocal_52, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, vLocal_276), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, vLocal_277), 0) >= 1f)
							{
								iLocal_47 = 3;
								iLocal_91[0] = 0;
								iLocal_91[1] = 0;
							}
							else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_278) > 5000)
							{
								func_24(0f, 0f, 0f, 0);
							}
						}
		...
		case 3:
			...
			{
				if (ENTITY::GET_ENTITY_SPEED(iLocal_52) == 0f && (GAMEPLAY::GET_GAME_TIMER() - iLocal_278) > 1000)
				{
...
int func_30()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && ENTITY::IS_ENTITY_ATTACHED(iLocal_53))
	{
		if (!iLocal_272)
		{
			if (GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iLocal_53, true), joaat("weapon_stickybomb"), 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_53, true), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0))
			{
				iLocal_272 = 1;
			}
		}
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_273) > 200 && ENTITY::DOES_ENTITY_EXIST(iLocal_50))
		{
			if (GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 0f, (1.2195f - 0.27f)), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, fLocal_275, (1.2195f + 0.09f)), 0.45f, 1))
			{
...
void func_33()
{
	...
	if (!UI::DOES_BLIP_EXIST(iLocal_57))
	{
		if (!bLocal_80)
		{
			if ((!PED::IS_PED_INJURED(iLocal_49[1]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0)) && !bLocal_89)
			{
				if (!bLocal_79)
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_56[1]))
					{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_56[0]) && UI::GET_BLIP_HUD_COLOUR(uLocal_56[0]) != 119)
			{
				UI::REMOVE_BLIP(&(uLocal_56[0]));
			}
			if (UI::DOES_BLIP_EXIST(uLocal_56[1]) && UI::GET_BLIP_HUD_COLOUR(uLocal_56[1]) != 119)
			{
				UI::REMOVE_BLIP(&(uLocal_56[1]));
			}
			if (UI::DOES_BLIP_EXIST(iLocal_55) && UI::GET_BLIP_HUD_COLOUR(iLocal_55) != 119)
			{
				UI::REMOVE_BLIP(&iLocal_55);
			}
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
			...
			else if (UI::DOES_BLIP_EXIST(iLocal_55))
			{
				UI::REMOVE_BLIP(&iLocal_55);
			}
			if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && UI::DOES_BLIP_EXIST(iLocal_55)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_50, 0))
				{
					if (UI::GET_BLIP_ALPHA(iLocal_55) != 0)
					{
						UI::SET_BLIP_ALPHA(iLocal_55, 0);
					}
				}
				else if (UI::GET_BLIP_ALPHA(iLocal_55) != 255)
				{
			...
			while (iVar0 < iLocal_49)
			{
				...
				if (iVar2[iVar0])
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_56[iVar0]))
					{
						uLocal_56[iVar0] = func_36(iLocal_49[iVar0], 1, 145);
					}
				}
				else if (UI::DOES_BLIP_EXIST(uLocal_56[iVar0]))
				{
					UI::REMOVE_BLIP(&(uLocal_56[iVar0]));
				}
				iVar0++;
			}
	...
	if (UI::DOES_BLIP_EXIST(uLocal_56[0]))
	{
		UI::_0x75A16C3DA34F1245(uLocal_56[0], iLocal_90);
	}
	if (UI::DOES_BLIP_EXIST(uLocal_56[1]))
	{
		UI::_0x75A16C3DA34F1245(uLocal_56[1], bLocal_90);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_55))
	{
		UI::_0x75A16C3DA34F1245(iLocal_55, bLocal_90);
	}
	if (UI::DOES_BLIP_EXIST(iLocal_58))
	{
		UI::_0x75A16C3DA34F1245(iLocal_58, bLocal_90);
	}
	if (!bLocal_90)
	{
...
int func_35(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_27(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
			...
			case 0:
				...
				while (iVar0 < iLocal_49)
				{
					if (!PED::IS_PED_INJURED(iLocal_49[iVar0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_52))
					{
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_49[iVar0]);
							...
							AI::TASK_PERFORM_SEQUENCE(iLocal_49[iVar0], iLocal_54);
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_49[iLocal_96]);
				}
				SYSTEM::SETTIMERA(0);
				iLocal_48++;
				break;
			...
			case 1:
				if (func_70(iLocal_96))
				{
					if (!PED::IS_PED_INJURED(iLocal_49[iLocal_96]))
					{
						...
						AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::CLOSE_SEQUENCE_TASK(iLocal_54);
						AI::TASK_PERFORM_SEQUENCE(iLocal_49[iLocal_96], iLocal_54);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_54);
					}
					iLocal_48++;
				}
				...
				if (!PED::IS_PED_INJURED(iLocal_49[0]) || !PED::IS_PED_INJURED(iLocal_49[1]))
				{
					...
					while (iVar0 < iLocal_49)
					{
						if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
						{
							...
							{
								PED::_0xE4723DB6E736CCFF(iLocal_49[iVar0], iLocal_50, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -4f, 0f), 5f, 0);
								iLocal_91[iVar0] = 1;
							}
							if (((OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !iLocal_91[iVar0]) && iLocal_47 == 3) && !bLocal_89)
							{
								PED::_0xE4723DB6E736CCFF(iLocal_49[iVar0], iLocal_50, OBJECT::GET_PICKUP_COORDS(iLocal_103), 5f, 0);
								iLocal_91[iVar0] = 1;
							}
							if (bLocal_89)
							{
					...
					if (IntToFloat((GAMEPLAY::GET_GAME_TIMER() - iLocal_292)) > GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(10000f, 15000f))
					{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
					{
						if (!bLocal_79)
						{
							if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_50, 0) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_295) > 5000)
							{
...
bool func_66()
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_282) > 250)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = 0;
		...
		if (!PED::IS_PED_INJURED(iLocal_49[iParam0]))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_52, iLocal_49[iParam0]))
			{
				...
				else
				{
					...
					AI::TASK_PLAY_ANIM(iLocal_49[iParam0], "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0f, 0, 0, 0);
				}
			}
		}
	}
...
void func_71(int iParam0, bool bParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		fVar1 = ((ENTITY::GET_ENTITY_HEADING(iLocal_50) + GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y)) + 45f);
		fVar2 = ((ENTITY::GET_ENTITY_HEADING(iLocal_50) + GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y)) - 45f);
		...
		if (bVar5)
		{
			...
			while (iVar4 < iLocal_49)
			{
				if ((((((!PED::IS_PED_INJURED(iLocal_49[iVar4]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar4], true), vVar3[iVar4 /*3*/]) > 2f) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_294[iVar4]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49[iVar4], 0)) && !iLocal_281[iVar4]) && (iParam0 == -1 || iParam0 == iVar4))
				{
					if (bParam1)
					{
						if (func_66())
						...
						AI::TASK_PERFORM_SEQUENCE(iLocal_49[iVar4], iVar6);
						AI::CLEAR_SEQUENCE_TASK(&iVar6);
					}
					iLocal_294[iVar4] = GAMEPLAY::GET_GAME_TIMER();
				}
				iVar4++;
			}
		}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
	{
		switch (iLocal_48)
		{
			...
			case 1:
				...
				{
					if ((GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), OBJECT::GET_PICKUP_COORDS(iLocal_103), true) < 2f && !PED::IS_PED_RAGDOLL(iParam0)) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_102) > 3000)
					{
			...
			case 2:
				if (!PED::IS_PED_INJURED(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
					{
						if (bLocal_80)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_285, 2f, -1, 0.1f, 512, vLocal_284.z);
						}
						else
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_285, 1f, -1, 0.1f, 512, vLocal_284.z);
						}
						iLocal_48++;
					}
				}
			...
			case 3:
				if (!PED::IS_PED_INJURED(iParam0))
				{
					...
					else
					{
						...
						{
							if (GAMEPLAY::ABSF((fVar0 - vLocal_284.z)) < 15f)
							{
								...
								if (bLocal_80)
								{
									AI::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, iLocal_286, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									AI::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
			...
			case 5:
				if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > fLocal_297) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286))
				{
					if (!bLocal_80)
					{
						if (!PED::IS_PED_INJURED(iLocal_49[0]))
						{
							AI::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, -1, -1, 1f, 1, 0);
						}
					}
					iLocal_48++;
				}
...
int func_74(int iParam0)
{
	...
	{
		uVar7 = 4;
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &Var1, &Var2);
	...
	switch (iLocal_48)
	{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_83()))
				{
					if (!PED::IS_PED_INJURED(func_83()))
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(func_83(), iLocal_50, 20000, -1, 2f, 1, 0);
						}
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_49[1]) && func_83() != iLocal_49[1])
				{
					...
					{
						AI::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, -1, 0, 2f, 1, 0);
					}
				}
				iLocal_48++;
			}
		...
		case 1:
			if (func_82())
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(func_83(), iLocal_50, PLAYER::PLAYER_PED_ID(), 8, 50f, 786484, 100f, 5f, 1);
					iLocal_48++;
				}
			}
			break;
		...
		case 2:
			if (func_81())
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_83()))
				{
					AI::TASK_VEHICLE_MISSION(func_83(), iLocal_50, 0, 5, 0f, 786484, 100f, 100f, 1);
					iLocal_48++;
				}
			}
			break;
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_50) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, -1, 0))) && (ENTITY::IS_ENTITY_DEAD(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, -1, 0), 0) || PED::IS_PED_INJURED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, -1, 0))))
	{
		...
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_50, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 100f)
		{
			if (!PED::IS_PED_INJURED(iLocal_49[iVar1]) && AI::GET_SCRIPT_TASK_STATUS(iLocal_49[iVar1], 242628503) != 1)
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_49[iVar1], iVar2);
			...
			if ((!PED::IS_PED_INJURED(iLocal_49[0]) || !PED::IS_PED_INJURED(iLocal_49[1])) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				while (iVar0 < iLocal_49)
				{
					if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
					{
						...
						{
							AI::TASK_LEAVE_ANY_VEHICLE(iLocal_49[iVar0], 0, 256);
						}
						AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iVar1);
						AI::TASK_PERFORM_SEQUENCE(iLocal_49[iVar0], iVar1);
			...
			case 0:
				if (func_4(&Local_106, cLocal_105, "RESEC_CAR1", 8, 0, 0, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_52) && ENTITY::IS_ENTITY_ATTACHED(iLocal_52))
					{
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_49[0]);
						}
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_49[1]);
						}
						iLocal_48++;
					}
					else
...
void func_88(int iParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(iLocal_49[iParam0]);
		AI::OPEN_SEQUENCE_TASK(&iLocal_54);
		...
		AI::CLOSE_SEQUENCE_TASK(iLocal_54);
		AI::TASK_PERFORM_SEQUENCE(iLocal_49[iParam0], iLocal_54);
		AI::CLEAR_SEQUENCE_TASK(&iLocal_54);
		if (iLocal_97 == 0)
		{
			iLocal_97 = DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(116, ENTITY::GET_ENTITY_COORDS(iLocal_49[iParam0], true), -1f);
		}
	}
}
	...
	switch (iLocal_48)
	{
		...
		case 2:
			if (!func_93())
			{
				...
				func_71(-1, 1);
				if (IntToFloat((GAMEPLAY::GET_GAME_TIMER() - iLocal_292)) > GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(5000f, 7500f))
				{
					if (!func_67())
					{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		{
			if ((ENTITY::IS_ENTITY_A_PED(iParam0) && !PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0))) || (ENTITY::IS_ENTITY_A_VEHICLE(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iParam0), 0)))
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_291) > iParam1)
				{
				...
				if (!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1]))
				{
					...
					if (PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && PED::IS_PED_IN_VEHICLE(iLocal_49[1], iLocal_50, 0))
					{
						if (iLocal_45 == 2)
						{
							...
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, -574.6195f, -847.232f, 25.2925f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							AI::CLOSE_SEQUENCE_TASK(iVar0);
							AI::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar0);
						...
						{
							AI::OPEN_SEQUENCE_TASK(&iVar1);
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, -551.2968f, -1119.418f, 20.4011f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							AI::CLOSE_SEQUENCE_TASK(iVar1);
							AI::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar1);
							AI::CLEAR_SEQUENCE_TASK(&iVar1);
							iLocal_48++;
						}
						else if (iLocal_45 == 7)
						{
							AI::OPEN_SEQUENCE_TASK(&iVar2);
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, 2786.752f, 4358.032f, 48.6794f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							AI::CLOSE_SEQUENCE_TASK(iVar2);
							AI::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar2);
							AI::CLEAR_SEQUENCE_TASK(&iVar2);
							iLocal_48++;
						}
						else
						{
							AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_49[0], iLocal_50, 10f, 786603);
							iLocal_48++;
						}
					}
					else
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && AI::GET_SCRIPT_TASK_STATUS(iLocal_49[0], -1794415470) != 1)
						{
							AI::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, -1, -1, 1f, 8388608, 0);
						}
						if (!PED::IS_PED_IN_VEHICLE(iLocal_49[1], iLocal_50, 0) && AI::GET_SCRIPT_TASK_STATUS(iLocal_49[1], -1794415470) != 1)
						{
							AI::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, -1, 0, 1f, 8388608, 0);
						}
					}
				}
			}
	...
	if ((!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1])) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0))
	{
		switch (iLocal_48)
		{
			case 0:
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_285, 1f, -1, 0.1f, 512, vLocal_284.z);
				AI::TASK_ACHIEVE_HEADING(0, vLocal_284.z, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_54);
				AI::TASK_PERFORM_SEQUENCE(iLocal_49[1], iLocal_54);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_54);
				iLocal_48++;
				break;
			...
			case 1:
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_287))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_63) < 22500f && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(iLocal_50))
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_49[0], iLocal_287, "random@security_van", "driver_idle", 2f, -8f, 13, 0, 1148846080, 0);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_287, true);
					}
				}
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_49[1], 242628503) != 1)
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_54);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_285, 1f, -1, 0.1f, 512, vLocal_284.z);
					AI::TASK_ACHIEVE_HEADING(0, vLocal_284.z, 0);
				...
				if (GAMEPLAY::ABSF((fVar0 - vLocal_284.z)) < 15f && SYSTEM::VDIST(vLocal_285, ENTITY::GET_ENTITY_COORDS(iLocal_49[1], true)) < 0.2f)
				{
					PED::CLEAR_PED_ALTERNATE_WALK_ANIM(iLocal_49[1], -1056964608);
					AI::CLEAR_PED_TASKS(iLocal_49[1]);
					bLocal_288 = true;
					iLocal_286 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_49[1], iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, iLocal_286, "van_case_into_van_calm", "random@security_van", 4f, -1000f, 0, -1000f);
					iLocal_48++;
				}
				break;
			...
			case 3:
				...
				if (!iLocal_289)
				{
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > 0.6f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286))
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_287))
						{
							AI::CLEAR_PED_TASKS(iLocal_49[0]);
							iLocal_287 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_49[0], iLocal_287, "random@security_van", "driver_exit_calm", 4f, -4f, 9, 0, 1148846080, 0);
						}
						iLocal_289 = 1;
					}
				}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_49[1], GAMEPLAY::GET_HASH_KEY("ENDS_IN_WALK")))
				{
					AI::CLEAR_PED_TASKS(iLocal_49[1]);
					AI::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, -1, 0, 1f, 1, 0);
					SYSTEM::SETTIMERA(0);
				}
		...
		if (iLocal_46 != 4)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_49[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_49[0], "random@security_van", "driver_idle", 3))
				{
					if (iLocal_45 != 2)
					{
						AI::TASK_PLAY_ANIM_ADVANCED(iLocal_49[0], "random@security_van", "driver_exit_panic", vLocal_283, vLocal_284, 1000f, -8f, -1, 4096, 0f, 2, 0);
					}
					else
					{
						AI::CLEAR_PED_TASKS(iLocal_49[0]);
						AI::TASK_PLAY_ANIM(iLocal_49[0], "random@security_van", "driver_exit_panic", 1000f, -8f, -1, 0, 0f, 0, 0, 0);
					}
				}
			}
...
int func_149()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			...
			{
				fLocal_280 = (fLocal_280 + GAMEPLAY::GET_FRAME_TIME());
			}
			else if (fLocal_280 > 0f)
			{
				fLocal_280 = (fLocal_280 - (GAMEPLAY::GET_FRAME_TIME() * 10f));
			}
			else if (fLocal_280 < 0f)
			{
				fLocal_280 = 0f;
...
void func_154()
{
	...
	VEHICLE::_SET_VEHICLE_CREATES_MONEY_PICKUPS_WHEN_EXPLODED(iLocal_50, 0);
	...
	else
	{
		...
		AI::TASK_LOOK_AT_ENTITY(iLocal_49[1], iLocal_49[0], -1, 0, 2);
	}
	func_79(iLocal_49[1]);
...
void func_182()
{
	...
	iLocal_94 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 8000);
	switch (iLocal_45)
	{
		case 1:
