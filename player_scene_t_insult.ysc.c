...
int func_2()
{
	...
	{
		fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657);
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_318))
		{
			if (!iLocal_322)
			{
				if (fVar1 < fLocal_321)
		...
		switch (iLocal_234[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					...
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657);
						if (fVar2 > fVar0)
						{
				...
				{
					AI::CLEAR_PED_TASKS(iParam0);
					if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_308[iParam1 /*16*/])))
					{
						...
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_316[iParam1 /*16*/])))
						{
					...
					else
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
						iVar9 = 0;
						while (iVar9 < iLocal_239)
						{
							if (iLocal_240[iVar9] != 0)
							{
								if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_313[iVar9 /*16*/])))
								{
			...
			case 1:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					AI::TASK_WANDER_IN_AREA(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fLocal_248[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_233[iParam1], &Local_297, &(Local_308[iParam1 /*16*/]), 2))
				{
					if (iLocal_66 == 288)
					{
						if (iLocal_323 <= 0)
						{
							iLocal_323 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 15000));
						}
						...
						if (iLocal_323 > 0)
						{
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_323)
							{
				...
				else
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
					iVar14 = 0;
					while (iVar14 < iLocal_239)
					{
						if (iLocal_240[iVar14] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_313[iVar14 /*16*/])))
							{
				...
				switch (iLocal_236[iParam1])
				{
					...
					case 0:
						iVar15 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1500, 4000);
						AI::TASK_LOOK_AT_ENTITY(iLocal_233[iParam1], PLAYER::PLAYER_PED_ID(), iVar15, 0, 2);
						iLocal_237[iParam1] = ((GAMEPLAY::GET_GAME_TIMER() + iVar15) + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 2000));
						iLocal_236[iParam1] = 1;
						break;
					
					case 1:
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_237[iParam1])
						{
				...
				if (bVar16)
				{
					...
					iVar18 = 4276;
					iVar19 = 0;
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_309[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_233[iParam1], false);
					PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_233[iParam1], iVar18);
					...
					while (iVar20 < iLocal_239)
					{
						...
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_314[iVar20 /*16*/])))
							{
			...
			case 11:
				...
				if (!bVar21)
				{
					...
					iVar23 = 180;
					iVar24 = 0;
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
					iVar25 = 0;
					while (iVar25 < iLocal_239)
					{
						if (iLocal_240[iVar25] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_315[iVar25 /*16*/])))
							{
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_233[iParam1], &Local_297, &(Local_310[iParam1 /*16*/]), 2))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar26 = 0;
					while (iVar26 < iLocal_239)
					{
						if (iLocal_240[iVar26] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_315[iVar26 /*16*/])))
							{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90657, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_239)
			{
				...
				{
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_312[iVar0 /*16*/])))
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90657, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90656))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90656, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90656, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
int func_33(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_34(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_41()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_235)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_316[iVar0 /*16*/])))
			{
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			...
			AI::TASK_PLAY_ANIM(iLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_42()
{
	...
	switch (iLocal_66)
	{
		case 237:
			...
			fLocal_321 = 0.15f;
			vLocal_245[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_245[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_246[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			vLocal_246[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			fLocal_247[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_247[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_248[0] = 50f;
			fLocal_248[1] = 50f;
		...
		case 244:
			...
			StringCopy(&(Local_308[0 /*16*/]), "", 64);
			vLocal_245[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_51(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_51(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_51(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
