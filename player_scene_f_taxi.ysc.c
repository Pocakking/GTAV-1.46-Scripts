...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		...
		if (fVar2 < (4.5f * 4.5f))
		{
			AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
		{
			...
			if (!func_5(Global_93018, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_93018, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
			...
			AI::TASK_VEHICLE_TEMP_ACTION(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_93018, iLocal_70, 2))
			...
			if (!func_3(&uVar0))
			{
				...
				AI::TASK_VEHICLE_TEMP_ACTION(0, iLocal_70, 24, 50);
				AI::TASK_PAUSE(0, 2000);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				AI::CLOSE_SEQUENCE_TASK(iVar2);
				AI::TASK_PERFORM_SEQUENCE(iLocal_68, iVar2);
...
int func_8(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_21()
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_93018) || !ENTITY::DOES_ENTITY_EXIST(iLocal_70)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_69) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_93018, Global_88331);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_93018, "A_F_Y_BevHills_01_White_FULL_01");
	}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_26(uParam1, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
int func_30(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_31(Global_92701[iParam0 /*98*/], 0))
	{
		func_29(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_48(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_48(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_48(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
