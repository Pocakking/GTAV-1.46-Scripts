...
void func_1()
{
	...
	{
		func_2(&iLocal_42);
		AI::TASK_SMART_FLEE_PED(iLocal_42, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || AI::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_11()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_11(), func_3(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_16(bool bParam0)
{
	...
	if (func_23())
	{
		Var0 = { func_22() };
		sVar1 = func_21();
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sVar1))
		{
			if (bParam0)
			{
				func_19();
...
char* func_21()
{
	if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24958, 3))
	{
		return "BB4_loiter";
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24958, 2))
	{
		return "BB3_loiter";
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24958, 1))
	{
		return "BB2_loiter";
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_24958, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
...
int func_43(vector3 vParam0, vector3 vParam1, int iParam2, float fParam3)
{
	...
	if (iLocal_44 < iLocal_45)
	{
		if (!func_23())
		{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_43) > (iParam2 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					uVar0 = 16;
...
void func_50()
{
	...
	if (func_51(iLocal_42))
	{
		...
		AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_42, 0);
		AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_42, 0);
