...
void func_66()
{
	if (func_428(Local_68.f_9))
	{
		...
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_152, Local_68.f_9, 0);
		}
	}
	if (func_428(Local_75))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_151, Local_75, 0);
		}
	}
}
...
void func_114(int iParam0)
{
	if (func_22(Local_69[iParam0 /*19*/]))
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iParam0 /*19*/]) == iLocal_320)
		{
			...
			AI::TASK_LOOK_AT_ENTITY(Local_69[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			if (!PED::IS_PED_FLEEING(Local_69[iParam0 /*19*/]))
			{
				...
				AI::TASK_CLEAR_LOOK_AT(Local_69[iParam0 /*19*/]);
				AI::CLEAR_PED_SECONDARY_TASK(Local_69[iParam0 /*19*/]);
				AI::CLEAR_PED_TASKS(Local_69[iParam0 /*19*/]);
				AI::TASK_HANDS_UP(Local_69[iParam0 /*19*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
			}
				...
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_122, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_68.f_9, vLocal_331, 30f))
									{
			...
			switch (Local_68.f_10)
			{
				...
				case 30:
					if (!func_63(Local_68.f_9, 242628503))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&uLocal_143);
						AI::TASK_GOTO_ENTITY_AIMING(0, PLAYER::PLAYER_PED_ID(), fVar3, 30f);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_143);
						AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_143);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 1f, 1, 0.5f, 1082130432, 1, 0, 0, -957453492, 20000);
						...
						AI::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_332, 50f);
						AI::CLOSE_SEQUENCE_TASK(uLocal_143);
						AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_143);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
				...
				case 33:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&uLocal_143);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						AI::CLOSE_SEQUENCE_TASK(uLocal_143);
						AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_143);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
				...
				case 13:
					if (func_113(Local_68.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 17, 1);
						AI::TASK_SMART_FLEE_PED(Local_68.f_9, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
						PED::SET_PED_KEEP_TASK(Local_68.f_9, 1);
						Local_68.f_10 = 14;
					}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_68.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_121) > 7500)
						{
							func_385(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_121) > 10000)
						{
							func_385(1);
						}
					}
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_105(Local_68.f_9, vLocal_331, 25f))
					{
						...
						{
							if (func_113(iLocal_123, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_122, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_68.f_9, vLocal_331, 20f))
							{
				...
				if (!iLocal_108)
				{
					...
					else
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_115))
						{
							if (iLocal_94)
							{
								uLocal_115 = func_389(vLocal_330, 5, 1);
							}
						}
						if (!iLocal_83)
						{
		...
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			...
			switch (Local_69[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_22(Local_68.f_9) || (PED::IS_PED_FLEEING(Local_68.f_9) && AI::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_68.f_9) > 1f))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_69[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								AI::UPDATE_TASK_HANDS_UP_DURATION(Local_69[iVar0 /*19*/], iVar2);
							}
							else
							{
								AI::CLEAR_PED_TASKS(Local_69[iVar0 /*19*/]);
								AI::CLEAR_PED_SECONDARY_TASK(Local_69[iVar0 /*19*/]);
							}
							Local_69[iVar0 /*19*/].f_14 = 4;
							func_109(&(Local_69[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_63(Local_69[iVar0 /*19*/], 780511057))
					{
						...
						if (func_105(Local_69[iVar0 /*19*/], vLocal_331, 5f))
						{
							if (!func_357(Local_69[iVar0 /*19*/].f_16, 10))
							{
								...
								AI::TASK_COMBAT_PED(Local_69[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					else
					{
						...
						{
							AI::CLEAR_PED_TASKS(Local_69[iVar0 /*19*/]);
							AI::TASK_LOOK_AT_ENTITY(Local_69[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_69[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_69[iVar0 /*19*/], 0);
						}
...
void func_396(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			Local_69[iVar0 /*19*/].f_15 = GAMEPLAY::GET_GAME_TIMER();
	...
	if (!iLocal_92)
	{
		if (!func_61())
		{
			if (func_105(Local_68.f_9, vLocal_331, (25f + 5f)))
			{
				...
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_329))
				{
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_478(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_478(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_448(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_447(*iParam1);
...
void func_484(vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
{
	return func_489(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
...
int func_491(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_493(iParam0, Global_70024.f_139[38], 0))
			{
				func_485(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_493(iParam0, Global_70024.f_139[43], 1))
			{
				func_485(43);
				return 1;
			}
...
void func_494(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_497(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_496())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_517()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		if (Local_68.f_12 != 0)
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, Local_68.f_12, -1, 0, 1);
		}
		func_354(Local_68.f_9);
		...
		AI::OPEN_SEQUENCE_TASK(&uLocal_143);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_c", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0f, 0, 0, 0);
		AI::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
		AI::CLOSE_SEQUENCE_TASK(uLocal_143);
		AI::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
		AI::CLEAR_SEQUENCE_TASK(&uLocal_143);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			...
			switch (iVar0)
			{
				case 0:
					AI::OPEN_SEQUENCE_TASK(&uLocal_143);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_143);
					AI::TASK_PERFORM_SEQUENCE(Local_69[iVar0 /*19*/], uLocal_143);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_143);
					break;
				
				case 1:
					AI::OPEN_SEQUENCE_TASK(&uLocal_143);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_b", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_143);
				...
				case 2:
					AI::OPEN_SEQUENCE_TASK(&uLocal_143);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_c", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0f, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_143);
