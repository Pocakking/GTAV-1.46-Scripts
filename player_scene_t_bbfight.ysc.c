...
int func_2()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
	{
		...
		if (func_20(iVar1))
		{
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_357))
			{
				if (!iLocal_361)
				{
					if (fVar0 < fLocal_360)
					...
					{
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_351))
						{
							func_15(&uLocal_110, func_16(), PLAYER::PLAYER_PED_ID(), &Local_351, 0, 1);
						}
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_354))
						{
...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_19(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_105021))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						AI::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90656, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
					{
						AI::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90657, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657))
							{
						...
						if (iLocal_109 == 165)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
							{
								sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								STREAMING::REQUEST_ANIM_DICT(sVar4);
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657))
								{
									if (STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
									{
										AI::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, 0);
						...
						if (iLocal_109 == 259)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657))
							{
								AI::TASK_PUT_PED_DIRECTLY_INTO_MELEE((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), 0f, -1f, 0f, 0);
								PED::_0x2208438012482A1A((*iParam0)[iVar0], 0, 0);
								SYSTEM::WAIT(0);
								(*iParam1)[iVar0] = 10;
								break;
						...
						if (iLocal_109 == 246 && iVar0 == 0)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90657))
							{
								...
								if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
								{
									AI::TASK_PUT_PED_DIRECTLY_INTO_MELEE(PLAYER::PLAYER_PED_ID(), (*iParam0)[iVar0], 0f, -1f, 0f, 0);
									SYSTEM::WAIT(0);
								}
								(*iParam1)[iVar0] = 10;
								break;
				...
				case 200:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90656))
					{
						AI::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0f, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
					{
				...
				case 201:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90657))
					{
						AI::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0f, 0, 0, 0);
						AI::TASK_LOOK_AT_ENTITY((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						STREAMING::REQUEST_ANIM_DICT(&cLocal_338);
						(*iParam1)[iVar0] = 202;
					}
					break;
				...
				case 0:
					...
					fVar13 = GAMEPLAY::ABSF((fVar11 - fVar12));
					if (fVar13 > 45f)
					{
						if (!AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 1920390111) == 1)
						{
							AI::TASK_ACHIEVE_HEADING((*iParam0)[iVar0], fVar12, 0);
						}
						break;
					}
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
				...
				case 10:
					if (AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						iVar17 = 0;
						...
						AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED((*iParam0)[iVar0], 25f, -1, 0);
				...
				case 5:
					...
					if (!AI::PED_HAS_USE_SCENARIO_TASK((*iParam0)[iVar0]))
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Local_349[iVar0 /*16*/]), "any"))
						{
							if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_283 + vLocal_285[iVar0 /*3*/], 20f, 1))
							{
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 20f, 0);
								iLocal_350[iVar0] = GAMEPLAY::GET_GAME_TIMER();
							}
						}
						else
						{
							...
							AI::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, iVar18);
							iLocal_350[iVar0] = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_280[iVar0]))
					{
						...
						{
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_350[iVar0] + 1000)
							{
								OBJECT::DELETE_OBJECT(&(iLocal_280[iVar0]));
								ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_280[iVar0]));
							}
...
int func_23(int iParam0, float fParam1)
{
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_25834[iVar0 /*23*/].f_16 == 9)
			{
			}
			else
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_25834[iVar0 /*23*/].f_11, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
...
int func_40()
{
	...
	if (Global_2437022.f_74)
	{
		return 1;
	}
	if (Global_90805.f_44 == 1)
	{
		if (Global_90805.f_46 == 0)
		{
			return 1;
		}
	}
...
int func_42(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_93018) && iParam1 != 0)
		{
			Global_93018 = 0;
		}
	}
...
void func_50()
{
	...
	while (iVar0 < iLocal_276)
	{
		if (iLocal_278[iVar0] != 0)
		{
			...
			AI::TASK_STAND_STILL(iLocal_276[iVar0], -1);
			if (iLocal_109 == 285)
			{
...
void func_51()
{
	...
	switch (iLocal_109)
	{
		...
		case 166:
			...
			fLocal_286[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		case 259:
			vLocal_285[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_285[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_286[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_286[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		default:
			...
			iLocal_278[0] = joaat("a_m_y_musclbeac_01");
			iLocal_278[1] = joaat("a_m_y_musclbeac_01");
			vLocal_287[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_288[0 /*3*/] = { 1f, 1f, 1f };
			fLocal_289[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			break;
	}
}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[0];
			StringCopy(sParam2, func_61(Global_106070.f_2355.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[1];
			StringCopy(sParam2, func_61(Global_106070.f_2355.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_106070.f_2355.f_539.f_2290[2];
			StringCopy(sParam2, func_61(Global_106070.f_2355.f_539.f_2294[2]), 32);
			return 1;
			break;
