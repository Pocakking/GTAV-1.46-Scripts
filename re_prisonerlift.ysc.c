							...
							case 0:
								switch (iLocal_53)
								{
										...
										if (iLocal_54 == 0)
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 20f, 20f, 8f, 0, 1, 0))
												{
													...
													{
														UI::_0x75A16C3DA34F1245(iLocal_89, true);
													}
													func_89();
													if (!func_88())
													{
										...
										else if (iLocal_54 == 1)
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												if (bLocal_83)
												{
													...
													{
														AI::CLEAR_PED_SECONDARY_TASK(iLocal_64);
													}
													...
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
													{
														if (!func_71(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
														{
															if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_64, 40f, 40f, 20f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 17))
															{
																...
																AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, PLAYER::GET_PLAYERS_LAST_VEHICLE(), PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
									...
									case 6:
										...
										{
											AI::OPEN_SEQUENCE_TASK(&iLocal_66);
											...
											AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_77, 1f, -1, 0.25f, 0, 333.9002f);
											AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
											AI::CLOSE_SEQUENCE_TASK(iLocal_66);
											AI::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
											AI::CLEAR_SEQUENCE_TASK(&iLocal_66);
											PED::SET_PED_KEEP_TASK(iLocal_64, true);
										...
										if (func_64())
										{
											if (!PED::IS_PED_INJURED(iLocal_64))
											{
												...
												AI::TASK_SMART_FLEE_COORD(iLocal_64, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
												PED::SET_PED_KEEP_TASK(iLocal_64, true);
												SYSTEM::WAIT(0);
											}
											func_86();
										...
										if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
										{
												...
												if (!iLocal_85)
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, 0))
													{
														if (!PED::IS_PED_INJURED(iLocal_64))
														{
															...
															AI::TASK_ENTER_VEHICLE(iLocal_64, iLocal_67, -1, -1, 2f, 1, 0);
															PED::SET_PED_KEEP_TASK(iLocal_64, true);
															iLocal_53 = 12;
														}
													}
													if (!PED::IS_PED_INJURED(iLocal_64))
													{
														...
														{
															AI::TASK_COMBAT_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 0, 16);
															func_51();
															iLocal_85 = 1;
														}
													}
											...
											else
											{
												...
												if (!PED::IS_PED_INJURED(iLocal_64))
												{
													...
													AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
													AI::CLOSE_SEQUENCE_TASK(iLocal_66);
													AI::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
													AI::CLEAR_SEQUENCE_TASK(&iLocal_66);
													PED::SET_PED_KEEP_TASK(iLocal_64, true);
									...
									case 12:
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), 1))
											{
												if (UI::DOES_BLIP_EXIST(iLocal_89))
												{
													UI::SET_BLIP_AS_FRIENDLY(iLocal_89, false);
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
											{
												if (!func_71(iLocal_67))
												{
													if (PED::IS_PED_IN_VEHICLE(iLocal_64, iLocal_67, 0))
													{
														...
														AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_64, iLocal_67, PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
														PED::SET_PED_KEEP_TASK(iLocal_64, true);
														iLocal_53 = 13;
													}
													...
													else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_64, -1794415470) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_64, -1794415470) != 0)
													{
														if (AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 780511057) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 780511057) != 0)
														{
														}
														else
														{
									...
									case 13:
										...
										if (!PED::IS_PED_INJURED(iLocal_64))
										{
											...
											else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 242628503) != 0)
											{
												iLocal_53 = 11;
											}
...
int func_6(vector3 vParam0, bool bParam1)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_7(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_8()
{
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_88())
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_64, 1227113341) != 0)
				{
					AI::TASK_GO_TO_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_64, 0))
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_64, 0, 0);
				}
				if (!iLocal_95)
				{
					if (!func_83())
...
void func_10()
{
	if (!PED::IS_PED_INJURED(iLocal_64))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_64, 8f, 8f, 8f, 0, 1, 0))
		{
			...
			else if (UI::DOES_BLIP_EXIST(iLocal_62))
			{
				UI::REMOVE_BLIP(&iLocal_62);
			}
		}
		else
		{
...
int func_12(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_7(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 2000)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
					{
						...
						AI::TASK_VEHICLE_TEMP_ACTION(PLAYER::PLAYER_PED_ID(), iLocal_67, 24, 2000);
						iLocal_90++;
					}
				}
			}
				...
				if (SYSTEM::TIMERA() > 4000)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_64))
						{
							...
							AI::TASK_LEAVE_VEHICLE(iLocal_64, iLocal_67, 320);
							if (!UI::DOES_BLIP_EXIST(iLocal_89))
							{
...
void func_53()
{
	if (UI::DOES_BLIP_EXIST(iLocal_62))
	{
		UI::SET_BLIP_ROUTE(iLocal_62, false);
		UI::REMOVE_BLIP(&iLocal_62);
		if (!PED::IS_PED_INJURED(iLocal_64))
		{
			UI::CLEAR_PRINTS();
				...
				if (iLocal_54 == 0)
				{
					if (!func_83())
					{
						if (func_72(&uLocal_114, "PRI1AU", "PRI1_CH", 4, 0, 0, 0))
						{
							...
							GAMEPLAY::CLEAR_BIT(&uLocal_78, 3);
							iLocal_80 = 1;
							iLocal_53 = 3;
						}
					}
		...
		if (iLocal_53 < 2)
		{
			...
			if (iLocal_54 == 0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_69))
				{
					...
					{
						AI::TASK_SMART_FLEE_PED(iLocal_64, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_64, true);
						return 1;
					}
				}
			...
			if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true), 20f, 1))
			{
				return 1;
			}
			if ((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64, true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_64, true) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1))
			{
				return 1;
			}
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				...
				else if (!bLocal_94)
				{
					...
					AI::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, (fLocal_93 - 3f), 1f, 1073741824, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_66);
					AI::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_66);
					if (!func_83())
		...
		case 2:
			...
			if (!iLocal_96)
			{
				if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2.5f)
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_64);
						AI::TASK_OPEN_VEHICLE_DOOR(iLocal_64, iLocal_67, -1, 0, 1f);
						iLocal_96 = 1;
					}
				}
				if (!func_83())
	...
	switch (*uParam0)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_64))
			{
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), 0);
					*uParam0++;
				}
			}
			break;
...
void func_89()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_67, 0) && !PED::IS_PED_INJURED(iLocal_64)) && !bLocal_83)
		{
			...
			if (iLocal_54 == 0)
			{
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_67, 10000, 2048, 2);
				AI::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0f, 0, 0, 0);
				AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, fLocal_93, 1f, 1, 0, -957453492);
			}
			else if (iLocal_54 == 1)
			{
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_67, 10000, 2052, 2);
				AI::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0f, 0, 0, 0);
...
void func_101()
{
	...
	{
		iLocal_89 = func_11(iLocal_64, 0, 145);
		UI::_0x75A16C3DA34F1245(iLocal_89, false);
	}
}
...
void func_102()
{
	...
	GAMEPLAY::ENABLE_DISPATCH_SERVICE(11, false);
	...
	if (iLocal_54 == 0)
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_68, 50f, 0);
		GAMEPLAY::CLEAR_AREA(vLocal_68, 10f, 0, 0, 0, false);
	...
	if (iLocal_107)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_64))
		{
			...
			else if (iLocal_54 == 1)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_66);
					AI::TASK_ENTER_VEHICLE(0, iLocal_67, -1, -1, 2f, 9, 0);
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_66);
					AI::TASK_PERFORM_SEQUENCE(iLocal_64, iLocal_66);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_66);
		...
		GAMEPLAY::ENABLE_DISPATCH_SERVICE(11, true);
...
Vector3 func_185()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_59, true);
		iLocal_58 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_60, true) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_60, true);
			iLocal_58 = 2;
		}
		if (iLocal_58 == 1)
		{
