...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_229 == 0)
		{
			if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 18) || CONTROLS::IS_CONTROL_JUST_PRESSED(2, 51))
			{
				func_23(500, 0);
				iLocal_229 = 1;
			}
...
void func_1(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	{
		uParam0->f_14 = (uParam0->f_14 + func_2(((((vVar6.x - uParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		uParam0->f_14.f_1 = (uParam0->f_14.f_1 + func_2(((((vVar6.y - uParam0->f_14.f_1) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		uParam0->f_14.f_2 = (uParam0->f_14.f_2 + func_2(((((vVar6.z - uParam0->f_14.f_2) * 0.05f) * fVar5) * fParam7), -3f, 3f));
	}
	if (uParam0->f_26)
	{
...
void func_19(var uParam0, float fParam1)
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, sLocal_160, sVar0, 1000f, -8f, 0, 0, 1148846080, 0);
	...
	AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_160, func_21(iLocal_170), 1000f, -8f, -1, 1, 0f, 0, 0, 0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
void func_31()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_166, 60f, 0);
	...
	while (GAMEPLAY::GET_GAME_TIMER() < iLocal_175)
	{
		SYSTEM::WAIT(0);
	}
	SYSTEM::WAIT(0);
...
void func_33()
{
	...
	func_43(64, 1, 0, 1, 0);
	iLocal_161 = OBJECT::CREATE_OBJECT(iLocal_158, 0f, 1f, 2f, 1, 1, 0);
	ENTITY::SET_ENTITY_COORDS(iLocal_161, vLocal_166, 1, 0, 0, 1);
...
void func_34(var uParam0, int iParam1, bool bParam2)
{
	...
	func_38(uParam0);
	uParam0->f_2 = iParam1;
	uParam0->f_3 = OBJECT::CREATE_OBJECT(iLocal_159, 0f, 1f, 2f, 1, 1, 0);
	func_25(uParam0);
	if (bParam2 == 1)
	{
	...
	while (iVar0 < 2)
	{
		...
		if (iVar2 != 0)
		{
			...
			if (func_30(uParam0->f_4[iVar0]))
			{
				...
				{
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_4[iVar0], uParam0->f_1, sLocal_160, sVar3, 1000f, -8f, 0, 0, 1148846080, 0);
...
void func_57()
{
	...
	{
		if (func_61(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_60(PLAYER::PLAYER_PED_ID());
			if (func_59(iVar0) && (!func_58(14) || Global_105021))
			{
				if (Global_106070.f_2355.f_539.f_4301 != iVar0 && func_59(Global_106070.f_2355.f_539.f_4301))
				{
...
int func_66(int iParam0, int iParam1)
{
	...
	GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &Var0, &Var1);
	GAMEPLAY::GET_MODEL_DIMENSIONS(iParam1, &Var2, &Var3);
	if (GAMEPLAY::ABSF((Var1 - Var0)) > GAMEPLAY::ABSF((Var3 - Var2)))
	{
		return 0;
	}
	if (GAMEPLAY::ABSF((Var1.f_1 - Var0.f_1)) > GAMEPLAY::ABSF((Var3.f_1 - Var2.f_1)))
	{
		return 0;
	}
	return 1;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_121(iVar10, iParam1, iParam2, -1) };
		if (!func_120(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_121(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_121(iVar10, 14, uVar12[iVar1], -1) };
			...
			{
				Global_71017[1 /*14*/] = { func_121(iVar10, iVar0, func_79(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_121(iVar10, 14, uVar15[iVar1], -1) };
			func_90(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_112(14);
			if (Global_71015 == 1)
			{
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_185(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_121(iParam0, iParam1, iParam2, -1) };
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_185(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_112(int iParam0)
{
	...
	{
		func_119(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_123(int iParam0)
{
	...
	func_124(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_117(func_127(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_117(func_126(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_117(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_124(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_124(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_124(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_124(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_185(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_121(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_185(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_185(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_121(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_121(iVar0, iVar2, iVar1, -1) };
...
void func_187(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_191(PLAYER::PLAYER_ID())) && !func_189(PLAYER::PLAYER_ID(), 0)) && !func_188()) && !bParam4)
			{
...
int func_199(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_113, iParam1) || GAMEPLAY::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_208(bool bParam0)
{
	if (bParam0)
	{
		UI::CLEAR_HELP(1);
		func_23(500, 1);
		GAMEPLAY::CLEAR_BIT(&Global_71453, 6);
	}
	func_254();
	func_252(1, 1, 1, 1);
	func_202(0);
...
void func_210()
{
	...
	{
		func_213(13, SYSTEM::FLOOR(Global_106070.f_10166.f_3853));
	}
...
int func_218(int iParam0, int iParam1, int iParam2)
{
	...
	return func_219(Global_106070.f_28022[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_222(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106070.f_20536.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_224() /*12745*/].f_8178.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_20536.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_224() /*12745*/].f_8178.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_223(iParam0));
...
bool func_226(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_224() /*12745*/].f_8178.f_10, iParam0);
}
...
int func_232(int iParam0, int iParam1)
{
	...
	if (func_242(&Global_4268566))
	{
		if (func_240(&Global_4268566, iParam0))
		{
			return 0;
		}
		if (func_233(&Global_4268566, iParam0))
		{
			return 1;
		}
	}
...
void func_236(var uParam0)
{
	...
	func_238(uParam0, (Global_4268565 - 0.5f));
}
