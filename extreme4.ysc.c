...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			UI::CLEAR_PRINTS();
			UI::CLEAR_HELP(1);
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_92))
			{
				func_340(1);
			}
			else
		...
		case 1:
			...
			if (func_311(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (func_222(Local_91))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_85 = 2;
				}
			}
			if (GAMEPLAY::GET_GAME_TIMER() < iLocal_292 + 5000)
			{
				if (UNK1::_IS_RECORDING())
				{
...
void func_166(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_167(&uVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}
...
void func_223()
{
	...
	while (GAMEPLAY::GET_GAME_TIMER() < iLocal_296 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_293) == 1f)
				{
					if (func_311(Local_91))
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_294, 0);
						CAM::SET_CAM_ACTIVE(iLocal_286, 1);
		...
		else if (!iLocal_302)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_294) == 1f)
			{
				if (func_311(Local_91))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_295, 1);
					CAM::SET_CAM_ACTIVE(iLocal_287, 1);
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 600 && fVar1 == 1f)
		{
			if (!iLocal_299)
			{
				iLocal_299 = 1;
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 630)
		{
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&iLocal_99);
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_311(Local_91))
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_311(Local_91))
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				...
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
				CAM::SET_CAM_ACTIVE(iLocal_284, 1);
				iVar0 = 7;
			}
		}
	}
	...
	if (func_222(Local_91))
	{
		...
		AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_91);
		PED::_0x2208438012482A1A(Local_91, 0, 0);
	...
	switch (iLocal_85)
	{
		case 0:
			...
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_305 || GAMEPLAY::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, true, 0))
					{
					...
					if (!iLocal_90)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
						{
							if (func_311(Local_91))
							{
								...
								CAM::SET_CAM_ACTIVE(iLocal_285, 1);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
								iLocal_293 = PED::CREATE_SYNCHRONIZED_SCENE(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								AI::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_261()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((CONTROLS::IS_CONTROL_PRESSED(0, 30) || CONTROLS::IS_CONTROL_PRESSED(0, 31)) || CONTROLS::IS_CONTROL_PRESSED(0, 23)) || CONTROLS::IS_CONTROL_PRESSED(0, 21)) || CONTROLS::IS_CONTROL_PRESSED(0, 22)) || (func_273() && CONTROLS::IS_CONTROL_PRESSED(0, 1))) || (func_273() && CONTROLS::IS_CONTROL_PRESSED(0, 2))) || (func_273() && CONTROLS::IS_CONTROL_PRESSED(0, 32)))
			{
				...
				if (func_311(Local_91))
				{
					...
					if (func_310(PLAYER::PLAYER_PED_ID(), Local_91, 32f, 1))
					{
						...
						else
						{
							...
							{
								AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_91, -1, 0, 2);
							}
						}
					}
...
void func_262()
{
	if (func_311(Local_91))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			AI::TASK_PERFORM_SEQUENCE(Local_91, uLocal_95);
		}
	}
}
...
void func_263()
{
	if (!func_260())
	{
		if (iLocal_290 < 5)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > (iLocal_291 + (8000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000))))
			{
...
void func_274()
{
	...
	else
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_238(800, 0);
		iLocal_88 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()
{
	...
	AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_80.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, 0, 0, 0, 0, false, 0);
	...
	{
		iLocal_100 = OBJECT::CREATE_OBJECT(1165008631, 1666.282f, -11.20408f, 172.7773f, 1, true, 0);
		ENTITY::SET_ENTITY_ROTATION(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_101))
	{
		iLocal_101 = OBJECT::CREATE_OBJECT(1165008631, 1667.076f, -12.07778f, 173.2611f, 1, true, 0);
	...
	if (func_311(Local_91))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			...
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::SET_SEQUENCE_TO_REPEAT(uLocal_95, 1);
...
void func_285()
{
	switch (iLocal_86)
	{
		case 0:
			...
			{
				if (!iLocal_305 || GAMEPLAY::GET_GAME_TIMER() > iLocal_306 + 3500)
				{
					func_286();
					UNK1::_0x48621C9FCA3EBD28(1);
...
void func_290()
{
	...
	if (((!func_324() && func_311(Local_80.f_28[0])) && func_311(PLAYER::PLAYER_PED_ID())) && iLocal_305 == 1)
	{
		...
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], -1, 0, 2);
			AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			...
			iLocal_306 = GAMEPLAY::GET_GAME_TIMER();
		}
		else
		{
...
void func_291()
{
	...
	if (iLocal_305)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_91, -1, 0, 2);
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			CAM::GET_IS_MULTIPLAYER_BRIEF(1);
...
void func_292()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_91, true), 1);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					UI::SET_BLIP_FLASHES(iLocal_94, 1);
				}
			}
			else if (UI::DOES_BLIP_EXIST(iLocal_94))
			{
				UI::SET_BLIP_FLASHES(iLocal_94, 0);
			}
		}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_295(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_307(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_309(iParam0, Global_36117);
}
...
void func_312()
{
	...
	while (((!STREAMING::HAS_MODEL_LOADED(joaat("prop_box_guncase_03a")) || !STREAMING::HAS_MODEL_LOADED(1165008631)) || !STREAMING::HAS_MODEL_LOADED(joaat("p_parachute_s"))) || !STREAMING::HAS_MODEL_LOADED(joaat("bmx")))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_91))
	{
		...
		AUDIO::DISABLE_PED_PAIN_AUDIO(Local_91, 1);
...
int func_344()
{
	...
	iVar0 = func_345(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_348()
{
	...
	{
		if (func_343(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
