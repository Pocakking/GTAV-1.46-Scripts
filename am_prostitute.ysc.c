...
void func_2()
{
	...
	switch (iLocal_52)
	{
		...
		case 3:
			if ((SCRIPT::HAS_SCRIPT_LOADED("pb_prostitute") && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("pb_prostitute")) <= 0) && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE("pb_prostitute", PLAYER::NETWORK_PLAYER_ID_TO_INT(), 1, 0))
			{
				iVar4 = func_12(iVar2);
...
int func_4()
{
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("pb_prostitute")) <= 0 && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE("pb_prostitute", PLAYER::NETWORK_PLAYER_ID_TO_INT(), 1, 0))
	{
		return 1;
	}
	if (iLocal_57 == 0)
...
int func_16(int iParam0)
{
	...
	{
		if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar1, "GB_VEHICLE_EXPORT"))
		{
			return 0;
		}
		if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar1, "BUSINESS_BATTLES_SELL"))
		{
			return 0;
		}
		if (GAMEPLAY::ARE_STRINGS_EQUAL(sVar1, "BUSINESS_BATTLES"))
		{
			return 0;
		}
	}
...
int func_32()
{
	...
	if (func_33() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_33()) == 0)
		{
			return 1;
		}
	}
