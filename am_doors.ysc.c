...
void func_1()
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_96[iLocal_70 /*4*/].f_2, iLocal_71))
			{
				GAMEPLAY::SET_BIT(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
			else
			{
				GAMEPLAY::CLEAR_BIT(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Local_73.f_9[iLocal_71]), iLocal_70);
			GAMEPLAY::CLEAR_BIT(&(Local_73.f_9[iLocal_71]), iLocal_70);
		}
	...
	if (iLocal_94[iParam0] == 0)
	{
		if (OBJECT::_0x4BC2854478F3A749(iParam1) == -1)
		{
			if (OBJECT::_0x160AA1B32F6139B8(iParam1) != iParam2)
			{
				...
				{
					GAMEPLAY::SET_BIT(&(iLocal_94[iParam0]), iVar0);
...
void func_9()
{
	...
	if ((GAMEPLAY::IS_BIT_SET(Global_2533185, iLocal_72) || GAMEPLAY::IS_BIT_SET(Global_2533185.f_1, iLocal_72)) || GAMEPLAY::IS_BIT_SET(Global_2533185.f_2, iLocal_72))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2533185, iLocal_72))
		{
			GAMEPLAY::SET_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2533185.f_1, iLocal_72))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2533185.f_2, iLocal_72))
		{
			GAMEPLAY::SET_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_3), iLocal_72);
		}
	}
	else if (fVar0 <= 20f)
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_72))
			{
				GAMEPLAY::SET_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
			}
		}
		...
		if ((iLocal_72 == 2 || iLocal_72 == 3) || iLocal_72 == 4)
		{
			if (func_11() >= 0)
			{
				...
				else if (GAMEPLAY::IS_BIT_SET(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_72) && !OBJECT::IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_72 /*17*/].f_3, Local_69[iLocal_72 /*17*/].f_6, Local_69[iLocal_72 /*17*/].f_9, 0, 1))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
				}
			}
	...
	else if (GAMEPLAY::IS_BIT_SET(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_72))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_96[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_72);
	}
	iLocal_72++;
...
void func_14()
{
	...
	{
		func_22(iVar0, &Var3);
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_13(PLAYER::PLAYER_ID()), Var3.f_1, 1) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
...
int func_36()
{
	...
	if (func_37() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_37()) == 0)
		{
			return 1;
		}
	}
...
void func_55(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_49();
