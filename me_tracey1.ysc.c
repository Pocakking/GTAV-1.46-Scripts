...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("M_DD", 0);
		if (iLocal_363 > GAMEPLAY::GET_GAME_TIMER())
		{
...
int func_2()
{
	switch (iLocal_54)
	{
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_258) > 15000)
			{
				func_22(&uLocal_56, 3);
		...
		case 5:
			...
			{
				iLocal_258 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_54 = 4;
			}
			break;
...
void func_11()
{
	...
	{
		if (func_14(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_24(int iParam0)
{
	...
	if (TIME::GET_CLOCK_DAY_OF_MONTH() != iLocal_251)
	{
		iVar0 = (60 * ((24 - iLocal_252) + TIME::GET_CLOCK_HOURS()));
		iVar0 = ((iVar0 - iLocal_253) + TIME::GET_CLOCK_MINUTES());
	}
	else
	{
		iVar0 = (((60 * TIME::GET_CLOCK_HOURS()) + TIME::GET_CLOCK_MINUTES()) - (iLocal_253 + (60 * iLocal_252)));
	}
	if (iVar0 >= (60 * iParam0))
	{
		return 1;
...
{
	UI::CLEAR_THIS_PRINT(vLocal_282[iParam0 /*3*/].f_2);
}
...
void func_34()
{
	...
	switch (iLocal_53)
	{
		case 0:
			...
			if (func_179(iLocal_233, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_331)
				{
					...
					AI::TASK_PAUSE(0, 650);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_233, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_330, 1f, 20000, 0.25f, 0, 40000f);
				...
				else
				{
					...
					AI::TASK_PAUSE(0, 650);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_233, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -820.1358f, 176.9053f, 70.6086f, 1f, 20000, 0.25f, 0, 40000f);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_330, 1f, 20000, 0.25f, 0, 40000f);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
				}
				AI::CLEAR_PED_TASKS(iLocal_239);
				AI::TASK_PERFORM_SEQUENCE(iLocal_239, iVar0);
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_329, 8f, 1, 0, 0, 0, false, 0);
				if (!bLocal_331)
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-820.2315f, 176.7027f, 70.6122f, 8f, 1, 0, 0, 0, false, 0);
				}
				if (bLocal_331)
				{
					iLocal_316 = GAMEPLAY::GET_GAME_TIMER() + 10000;
		...
		case 1:
			...
			if (!iLocal_314)
			{
				if (func_3(&uLocal_56, "MET1AUD", "MET1_ATHOME", 7, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_316)
				{
					iLocal_314 = 1;
				}
			}
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_320)
				{
					iLocal_53 = 2;
				}
			}
			else if ((func_56(iLocal_239, vLocal_330, 2f) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_316) > 5000) || bLocal_317)
			{
				if (bLocal_318)
				{
					...
					iLocal_319 = 1;
					iLocal_320 = GAMEPLAY::GET_GAME_TIMER() + 300;
				}
				else
				{
					iLocal_53 = 2;
		...
		case 2:
			...
			else
			{
				if (bLocal_317)
				{
					AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_239);
...
void func_36(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_39(0) && Global_71451.f_1 == 1) && func_38(Global_71451))
		{
		}
		else
		{
	...
	if (Global_106070.f_9057 || func_39(0))
	{
		iVar0 = func_37();
...
int func_51(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93018))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_93019))
		{
			return 0;
		}
...
void func_59(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_61(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_112(iVar10, iParam1, iParam2, -1) };
		if (!func_111(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_112(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_112(iVar10, 14, uVar12[iVar1], -1) };
							func_82(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_104(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_112(iVar10, iVar0, func_71(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_112(iVar10, 14, uVar15[iVar1], -1) };
			func_82(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_104(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
int func_63(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_176(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_71017[1 /*14*/] = { func_112(iParam0, iParam1, iParam2, -1) };
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_176(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_83(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_72(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_72(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_97(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_97(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_97(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_104(int iParam0)
{
	...
	{
		func_110(iParam0, Global_71017[1 /*14*/].f_5, Global_71017[1 /*14*/].f_2, 2, Global_71017[1 /*14*/].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_107(iParam2)];
	if (iVar0 != 0)
	{
...
int func_108(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_107(iParam1)];
...
void func_114(int iParam0)
{
	...
	func_115(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_108(func_118(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_108(func_117(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_108(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_115(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_115(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_115(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_115(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_72(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_71017[1 /*14*/] = { func_112(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_176(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_112(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_176(iParam0, 14, iVar4))
										{
											if (!func_68(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_112(iVar0, iVar2, iVar1, -1) };
						if (!func_68(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_53)
	{
		...
		case 1:
			...
			if (iLocal_255)
			{
				if (func_194(5))
				{
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_23())
					{
						func_28(5);
					}
				}
			...
			{
				if (func_194(2) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_23()))
				{
					func_28(2);
				}
				...
				{
					iLocal_257 = 1;
					AI::TASK_ENTER_VEHICLE(iLocal_239, iLocal_233, 20000, 0, 2f, 1, 0);
				}
				if (PED::IS_PED_IN_VEHICLE(iLocal_239, iLocal_233, 0))
				{
					iLocal_256 = 0;
			...
			else if (iLocal_259)
			{
				if (iLocal_260)
				{
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || (iLocal_308 >= 4 && !func_23()))
					{
						func_28(3);
						iLocal_260 = 0;
					}
...
void func_182(int iParam0)
{
	if (iLocal_341 != iParam0)
	{
		...
		while (iLocal_339 <= 7)
		{
			...
			{
				if (!GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_342[iLocal_339], "NONE"))
				{
...
void func_185()
{
	...
	if (iLocal_308 == 0)
	{
		if (bLocal_277)
		{
			if (bLocal_278)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&iVar0);
					AI::TASK_PLAY_ANIM(0, sLocal_246, "react_intro", 8f, -8f, 4900, 8, 0f, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_246, "react_loop", 8f, -4f, 12400, 8, 0f, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
					AI::CLEAR_PED_TASKS(iLocal_239);
					AI::TASK_PERFORM_SEQUENCE(iLocal_239, iVar0);
					iLocal_308 += 4;
	...
	else
	{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > vLocal_307[3 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_329, 50f))
			{
				if (func_3(&uLocal_56, vLocal_307[3 /*3*/].f_1, vLocal_307[3 /*3*/].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_278)
					{
						...
						AI::CLEAR_PED_TASKS(iLocal_239);
						AI::TASK_PERFORM_SEQUENCE(iLocal_239, iVar1);
					}
					iLocal_308++;
				}
			}
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > vLocal_307[4 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_329, 50f))
			{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > vLocal_307[5 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_329, 50f))
			{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > vLocal_307[6 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_329, 50f))
			{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_309) > vLocal_307[7 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_329, 50f))
			{
...
bool func_187(char* sParam0, int iParam1, char* sParam2)
{
...
void func_195()
{
	if (bLocal_262 == 0)
	{
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_264 && PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			iLocal_263++;
			PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
			iLocal_264 = GAMEPLAY::GET_GAME_TIMER() + 2000;
		}
...
void func_198(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_271(&(Global_93232.f_3));
				if (iVar6 > -1)
				{
...
{
	func_200(&Global_99633, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_212(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_220(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2566070[iParam0 /*3*/][func_107(iParam1)];
...
void func_224(int iParam0, bool bParam1)
{
	...
	if (func_12(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_225(iParam0, &(Global_106070.f_2355.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_225(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_227(Var7.f_1)) && iVar9 < 50)
			{
...
int func_238(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_240() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_108(func_239(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_242(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_258(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_243(iVar0, 0), true);
...
Vector3 func_243(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_254(Global_95303);
			break;
		
		case 46:
			if (Global_1589591 != func_253())
			{
				if (func_252(Global_1589591))
				{
					return func_245(2, 2);
				}
				else if (func_244(Global_1589591))
				{
...
var func_260()
{
	...
	func_270(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_269(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_268(&uVar0, TIME::GET_CLOCK_HOURS());
	func_263(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_262(&uVar0, TIME::GET_CLOCK_MONTH());
	func_261(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_266(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_278(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_279(Global_106070.f_9057.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_279(Global_106070.f_9057.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_279(Global_106070.f_9057.f_99.f_205[11]);
			break;
		
		case 90:
			return func_279(Global_106070.f_9057.f_99.f_205[7]);
			break;
		
		case 93:
			return func_279(Global_106070.f_9057.f_99.f_205[9]);
			break;
	}
	return 0;
}
	...
	switch (iLocal_53)
	{
		case 0:
			...
			if (func_26(iLocal_240))
			{
				...
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_240, 2, 0);
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_240, 0))
				{
					AI::OPEN_SEQUENCE_TASK(&iVar0);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
					AI::TASK_PERFORM_SEQUENCE(iLocal_240, iVar0);
					AI::CLEAR_SEQUENCE_TASK(&iVar0);
				}
				else
				{
					AI::TASK_SMART_FLEE_COORD(iLocal_240, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, 0, 0);
				}
				iLocal_300 = 0;
				bLocal_301 = false;
				iLocal_302 = 0;
				...
				bLocal_290 = false;
				bLocal_289 = false;
				iLocal_288 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_304 = 0;
				if (func_23())
				{
					func_54();
				...
				bLocal_346 = false;
				func_338();
				uLocal_347[0] = GAMEPLAY::GET_GAME_TIMER() + 10000;
				uLocal_347[1] = GAMEPLAY::GET_GAME_TIMER() + 10000;
				func_27(&iLocal_247);
				iLocal_247 = func_193(iLocal_240, 1, 0, 5);
				func_337(&iLocal_247, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_249, &iLocal_250, 1, 1);
				ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_240, 1, 0f);
		...
		case 1:
			...
			if (func_26(iLocal_240))
			{
				...
				else
				{
					...
					else if ((((PED::IS_PED_ON_FOOT(iLocal_240) && !PED::IS_PED_RAGDOLL(iLocal_240)) && !AI::IS_PED_GETTING_UP(iLocal_240)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_240)) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_240))
					{
...
void func_287()
{
	if (!bLocal_345)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_344) > 3000)
		{
			func_290(1);
			if (((func_289(vLocal_343[0 /*3*/], vLocal_343[2 /*3*/], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_240)) && !PED::IS_PED_RAGDOLL(iLocal_240)) && !AI::IS_PED_GETTING_UP(iLocal_240))
			{
				AI::TASK_COWER(iLocal_240, -1);
				bLocal_345 = true;
			}
		}
		if (!bLocal_345)
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() > uLocal_347[0] && func_191(PLAYER::PLAYER_PED_ID(), iLocal_240, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_240)) && !AI::IS_PED_GETTING_UP(iLocal_240))
				{
					func_288(0, 0);
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > uLocal_347[1])
				{
					if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_240, 0f, 1f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_240, 0f, 7f, 5f), 5f, 0, true, 0) && !PED::IS_PED_RAGDOLL(iLocal_240)) && !AI::IS_PED_GETTING_UP(iLocal_240))
					{
						func_288(0, 1);
					}
					else
					{
						uLocal_347[1] = GAMEPLAY::GET_GAME_TIMER() + 2000;
					}
				}
			}
...
void func_288(int iParam0, bool bParam1)
{
	...
	{
		AI::TASK_SMART_FLEE_PED(iLocal_240, PLAYER::PLAYER_PED_ID(), 2000f, -1, 0, 0);
		uLocal_347[0] = GAMEPLAY::GET_GAME_TIMER() + 10000;
		if (bParam1)
		{
			uLocal_347[1] = GAMEPLAY::GET_GAME_TIMER() + 10000;
...
{
	iLocal_344 = GAMEPLAY::GET_GAME_TIMER();
...
void func_291()
{
	...
	if (func_294() && GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
	{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_288) > 4000)
			{
		...
		case 4:
			if (func_187("MET1KSTKRED", 0, 0) || func_187("MET1KSTKBLU", 0, 0))
			{
				...
				{
					iLocal_272 = GAMEPLAY::GET_GAME_TIMER();
					bLocal_289 = false;
					bLocal_290 = false;
					iLocal_291 = 0;
					bLocal_297 = true;
		...
		case 10:
			if (!func_23())
			{
				...
				if (bLocal_297)
				{
					iLocal_299 = GAMEPLAY::GET_GAME_TIMER() + 15000;
				}
				iLocal_288 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_304 = 0;
			}
...
int func_292()
{
	...
	if (Global_15822 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (UI::DOES_TEXT_LABEL_EXIST(&(Global_14690[iVar0 /*6*/])))
			{
				cVar1 = { Global_15441 };
				StringConCat(&cVar1, "SL", 24);
				sVar2 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
...
int func_294()
{
	...
	{
		iVar0 = (GAMEPLAY::GET_GAME_TIMER() - iLocal_298);
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_187(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_187(sParam2, 0, 0))
					{
...
bool func_297(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar2 /*4*/].f_3) < iParam4);
}
...
int func_316(char* sParam0)
{
	if (!func_317(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_286(sParam0)) || func_286("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_317(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_324() || func_323(Global_4456448.f_152990)) || func_322())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_321(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_320(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_318(int iParam0)
{
	if (iParam0 != func_253())
	{
		...
		else if ((Global_1312857 && iParam0 == PLAYER::PLAYER_ID()) && func_319(iParam0, 1, 0))
		{
			return Global_2423801[iParam0 /*413*/].f_309.f_4 != -1;
		}
	}
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_26(iLocal_240))
			{
				...
				{
					if (func_194(4) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_23()))
					{
						func_28(4);
					}
					iLocal_288 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_299 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_298 = (GAMEPLAY::GET_GAME_TIMER() - 4500);
					iLocal_294 = 0;
					iLocal_286 = 0;
					iLocal_287 = 0;
					bLocal_289 = false;
					...
					iLocal_291 = 0;
					bLocal_297 = false;
					iLocal_292 = (GAMEPLAY::GET_GAME_TIMER() - 1000);
					vLocal_270[0 /*3*/] = { vLocal_321 };
					vLocal_270[1 /*3*/] = { vLocal_270[0 /*3*/] };
					vLocal_270[2 /*3*/] = { vLocal_270[1 /*3*/] };
					iLocal_271 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_272 = GAMEPLAY::GET_GAME_TIMER();
					if (!iLocal_274)
					{
						iLocal_274 = 1;
						AI::CLEAR_PED_TASKS(iLocal_240);
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_240, Local_237, PLAYER::PLAYER_PED_ID(), 8, 25f, 786477, 100f, 1f, 1);
					}
					iLocal_344 = GAMEPLAY::GET_GAME_TIMER();
					...
					if (UI::DOES_BLIP_EXIST(iLocal_247))
					{
		...
		case 1:
			if (func_26(iLocal_240))
			{
				...
				if ((UI::DOES_BLIP_EXIST(iLocal_247) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_233, 0)) && PED::IS_PED_IN_VEHICLE(iLocal_239, iLocal_233, 0))
				{
					func_354(iLocal_247, iLocal_240, 220f, 0.75f, 0);
				}
				func_308(&uLocal_221, iLocal_240, 0, 0, 1, 1, 1);
...
void func_340()
{
	...
	iLocal_293 = (GAMEPLAY::GET_GAME_TIMER() - iLocal_292);
	...
	{
		case 0:
			if ((((GAMEPLAY::GET_GAME_TIMER() - iLocal_288) > 4000 && func_26(iLocal_240)) && !func_186()) && !func_23())
			{
				func_21(&uLocal_56, 4, iLocal_240, "Stalker", 0, 1);
				iLocal_294 = 1;
			}
		...
		case 1:
			if (func_26(iLocal_240))
			{
				...
				else if (func_341() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_272) > 6000)
				{
					iLocal_294 = 7;
				}
...
void func_343()
{
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_271) > 3000)
	{
...
void func_349()
{
	if (iLocal_356 == 0)
	{
		if (bLocal_348 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_352) > iLocal_354)
		{
			iLocal_352 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_356 = 2;
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_352) > iLocal_355 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_237, 0f, -0.5f, -1.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_237, 0f, 6f, 2f), 12f, 0, true, 0))
		{
			iLocal_352 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_356 = 1;
		}
	...
	if (iLocal_356 == 1)
	{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_352) < iLocal_353 && func_350(1))
		{
	...
	if (iLocal_356 == 2)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_352) < iLocal_353 && func_350(0))
		{
...
int func_351()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_237))
	{
		...
		if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_237))
		{
			if (iLocal_268)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_269) > 7000)
				{
					return 1;
				}
			}
		...
		case 0:
			if (!func_361())
			{
				...
				if (func_357(Local_237.f_6, Local_237.f_9, 0))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&iVar0);
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_237, ENTITY::GET_ENTITY_COORDS(iLocal_233, true), 4, 35f, 2883621, 10f, 12f, 1);
					AI::TASK_VEHICLE_ESCORT(0, Local_237, iLocal_233, -1, 25f, 2883621, -1f, 20, 20f);
					AI::CLOSE_SEQUENCE_TASK(iVar0);
					AI::TASK_PERFORM_SEQUENCE(iLocal_240, iVar0);
					AI::CLEAR_SEQUENCE_TASK(&iVar0);
			...
			if (func_26(iLocal_240))
			{
				if (func_26(Local_237))
				{
					if (!iLocal_276)
					{
						...
						{
							AI::TASK_PLAY_ANIM(iLocal_239, "missmichael_event@tracy", "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							STREAMING::REMOVE_ANIM_DICT("missmichael_event@tracy");
							if (!UI::DOES_BLIP_EXIST(iLocal_247))
							{
								iLocal_247 = func_196(Local_237, 0, 5);
								UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_247, "MET1LBSTALK");
								func_182(4);
							}
							iLocal_276 = 1;
						}
...
int func_357(vector3 vParam0, float fParam1, int iParam2)
{
	...
	else if (iLocal_242)
	{
		...
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_237.f_6, 5f, 0, 0, 0, 0, false, 0);
			...
			VEHICLE::_0x1A78AD3D8240536F(Local_237, 1);
			...
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_237, "M_E_TRACEY_STALKERS_CAR_GROUP", 0);
			iLocal_267 = 1;
			...
			iLocal_242 = 0;
			iLocal_363 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			return 1;
		}
	}
	else
...
void func_362()
{
	if (iLocal_362 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_361)
	{
		...
		case 1:
			if (!func_361())
			{
				...
				if (iLocal_255)
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_239);
						AI::TASK_SMART_FLEE_PED(iLocal_239, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						if (func_23())
						{
							if (func_292() == 3)
							{
				...
				else
				{
					switch (iLocal_266)
					{
						...
						case 3:
							...
							{
								iLocal_334 = GAMEPLAY::GET_GAME_TIMER() + 2000;
								iLocal_266 = 4;
							}
							break;
						...
						case 4:
							...
							else if (!func_23() && GAMEPLAY::GET_GAME_TIMER() > iLocal_334)
							{
								if (!func_188())
								{
									if (bLocal_262 && !GAMEPLAY::ARE_STRINGS_EQUAL(Local_325[iLocal_326 /*8*/].f_6, "NULL"))
									{
						...
						case 5:
							...
							else if (!UI::DOES_BLIP_EXIST(iLocal_247))
							{
								iLocal_247 = func_283(Local_325[iLocal_326 /*8*/], 5, 1);
							}
							else
						...
						case 6:
							...
							{
								iLocal_336 = 1;
								iLocal_334 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_335);
								iLocal_266 = 7;
							}
							break;
						...
						case 7:
							if (iLocal_336)
							{
								if (GAMEPLAY::GET_GAME_TIMER() > iLocal_334)
								{
									iLocal_336 = 0;
								}
							}
							...
							{
								iLocal_334 = GAMEPLAY::GET_GAME_TIMER();
								iLocal_266 = 0;
							}
							else
							{
...
void func_363()
{
	...
	{
		if (func_341() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_272) > 18000)
		{
...
void func_364()
{
	...
	Var3[0 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	if (Var3[0 /*4*/][0] < 2)
	{
		Var3[0 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var3[0 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var3[0 /*4*/][0] > 1)
	{
		Var3[0 /*4*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var3[0 /*4*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	Var2[0 /*5*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(300, 600);
	Var2[0 /*5*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(400, 1000);
	Var2[0 /*5*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var2[0 /*5*/][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[0]));
	AI::TASK_PAUSE(0, Var2[0 /*5*/][0]);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[0 /*4*/][0] /*3*/], Var2[0 /*5*/][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[0 /*4*/][1] /*3*/], Var2[0 /*5*/][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[0 /*4*/][2] /*3*/], Var2[0 /*5*/][3], 2048, 2);
	AI::CLOSE_SEQUENCE_TASK(uVar0[0]);
	AI::TASK_PERFORM_SEQUENCE(iLocal_239, uVar0[0]);
	AI::CLEAR_SEQUENCE_TASK(&(uVar0[0]));
	Var3[1 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	...
	if (Var3[1 /*4*/][0] < 2)
	{
		Var3[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var3[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var3[1 /*4*/][0] > 1)
	{
		Var3[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	...
	Var2[1 /*5*/][0] = 0;
	Var2[1 /*5*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var2[1 /*5*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var2[1 /*5*/][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[1]));
	AI::TASK_PAUSE(0, Var2[1 /*5*/][0]);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[1 /*4*/][0] /*3*/], Var2[1 /*5*/][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[1 /*4*/][1] /*3*/], Var2[1 /*5*/][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar1[Var3[1 /*4*/][2] /*3*/], Var2[1 /*5*/][3], 2048, 2);
	AI::CLOSE_SEQUENCE_TASK(uVar0[1]);
	AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0[1]);
	AI::CLEAR_SEQUENCE_TASK(&(uVar0[1]));
}
			...
			if (!func_361())
			{
				if (!func_2())
				{
					if (((func_388(&iLocal_239, vLocal_323, fLocal_324, 1) && func_378(&iLocal_233, 15, vLocal_321, fLocal_322, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_246)) && func_26(iLocal_233))
					{
						...
						func_377();
						AI::TASK_PLAY_ANIM(iLocal_239, sLocal_246, "nervous_loop", 8f, -8f, -1, 1, 0f, 0, 0, 0);
					...
					switch (iLocal_254)
					{
						case 0:
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, true, 0))
							{
								...
								AI::OPEN_SEQUENCE_TASK(&iVar0);
								AI::TASK_PLAY_ANIM(0, sLocal_246, "breakout", 8f, -4f, -1, 0, 0f, 0, 0, 0);
								AI::TASK_ENTER_VEHICLE(0, iLocal_233, 60000, 0, 2f, 1, 0);
								AI::CLOSE_SEQUENCE_TASK(iVar0);
								AI::CLEAR_PED_TASKS(iLocal_239);
								AI::TASK_LOOK_AT_ENTITY(iLocal_239, PLAYER::PLAYER_PED_ID(), 4000, 0, 3);
								AI::TASK_PERFORM_SEQUENCE(iLocal_239, iVar0);
								AI::CLEAR_SEQUENCE_TASK(&iVar0);
								PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 170, true);
								UNK1::_0x48621C9FCA3EBD28(3);
								iLocal_361 = GAMEPLAY::GET_GAME_TIMER() + 10000;
								iLocal_362 = 1;
								iLocal_254 = 1;
							}
							else
						...
						case 1:
							...
							AI::TASK_LOOK_AT_ENTITY(iLocal_239, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
							break;
						...
						case 2:
							...
							if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_233, 0))
							{
								...
								else if (func_194(2))
								{
									func_27(&iLocal_247);
									iLocal_247 = func_193(iLocal_239, 1, 1, 5);
									UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_247, "MET1LBTRAC");
									func_28(2);
								}
							}
							AI::TASK_LOOK_AT_ENTITY(iLocal_239, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
...
void func_376()
{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_283) > 5000 && func_191(iLocal_239, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_285 = 9;
			}
			break;
...
int func_378(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	...
	if (!func_12(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_106070.f_2355.f_539.f_3598[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_106070.f_2355.f_539.f_3598[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_3598[0 /*197*/][iVar1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_382(iParam0, &(Global_106070.f_2355.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_81));
	...
	switch (iLocal_53)
	{
		...
		case 2:
			if (!func_2())
			{
				...
				GAMEPLAY::CLEAR_AREA(vLocal_321, 30f, 0, 0, 0, false);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_321, 30f, 0, 0, 0, 0, false, 0);
				iLocal_53 = 0;
				iLocal_52 = 2;
			}
			break;
...
int func_391(vector3 vParam0, bool bParam1)
{
	...
	iVar0 = UI::ADD_BLIP_FOR_COORD(vParam0);
	UI::SET_BLIP_PRIORITY(iVar0, 7);
	UI::SET_BLIP_SCALE(iVar0, 0.7f);
	UI::SET_BLIP_COLOUR(iVar0, 3);
	UI::SET_BLIP_ROUTE(iVar0, bParam1);
	UI::SET_BLIP_NAME_FROM_TEXT_FILE(iVar0, "MET1LBTRAC");
	return iVar0;
}
...
void func_393(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		...
		{
			if (func_423(24) != Global_96664.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_420(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_394(Global_96664.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_395(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_412(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_106070.f_32605.f_4801 = func_260();
			}
...
void func_396(int iParam0, int iParam1)
{
	...
	func_211(iParam0, &(Global_106070.f_32605.f_5510));
}
...
int func_412(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_235(Global_106070.f_32605.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_235(Global_106070.f_2355.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_235(Global_106070.f_2355.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_413(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_412(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_418(iParam0);
			func_417(uParam1, &(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_424()
{
	...
	if (bLocal_278 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_281) > 8000)
	{
		UNK1::_0x293220DA1B46CEBC((2.5f + 8f), 2f, 3);
		iLocal_280 = 1;
	}
	if (!bLocal_278 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_281) > 2000)
	{
		UNK1::_0x293220DA1B46CEBC((2.5f + 2f), 2f, 3);
		iLocal_280 = 1;
	}
}
...
int func_427()
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_233))
	{
		if (iLocal_235)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_236) > 7000)
			{
				return 1;
			}
		}
		...
		{
			iLocal_235 = 1;
			iLocal_236 = GAMEPLAY::GET_GAME_TIMER();
		}
	}
	else
	{
...
void func_430()
{
	switch (iLocal_53)
	{
		case 0:
			func_27(&iLocal_247);
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_340))
			{
				sLocal_340 = "DEFAULT";
			}
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_340, "DEFAULT"))
			{
				func_434(0);
			}
			else
...
int func_435(int iParam0)
{
	...
	func_436(&(Global_106070.f_2355.f_539), iVar1);
...
void func_436(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_438(Global_106070.f_18505[iVar0], &vVar2, &fVar3))
			{
				Global_106070.f_18505[iVar0] = 318;
				func_437(&(uParam0->f_2276[iVar0]));
...
void func_441(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		fLocal_358 = fVar1;
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_357, 10f, 0, 0, 0, 0, false, 0);
...
void func_442(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_460(bool bParam0)
{
	...
	else
	{
		...
		if (func_26(iLocal_233))
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_233, 0f, -8f, 0f), 6f, 0, 0, 0, 0, false, 0);
		}
	}
	...
	if (func_26(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam0)
		{
			if (func_491())
			{
				...
				fLocal_358 = 251.1f;
				bLocal_359 = true;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, false, 0);
				func_489();
				while (!func_488())
				{
					SYSTEM::WAIT(0);
			...
			{
				GAMEPLAY::CLEAR_AREA(181.2331f, -33.9939f, 67.2522f, 3f, 1, 0, 0, false);
...
void func_462()
{
	iLocal_251 = TIME::GET_CLOCK_DAY_OF_MONTH();
	iLocal_252 = TIME::GET_CLOCK_HOURS();
	iLocal_253 = TIME::GET_CLOCK_MINUTES();
}

int func_463(vector3 vParam0, float fParam1)
{
	return func_464(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	if (func_487(uParam0))
	{
		...
		if (func_486(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_469(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
void func_465(int iParam0)
{
	...
	if (func_412(&(Global_70024.f_555[0 /*21*/]), iParam0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_70024.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_416(iParam0, 0)) && Global_70933.f_66 == 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] != 0) && Global_106070.f_32605.f_1958[Global_70024.f_555[0 /*21*/].f_14] > 3) && (!func_466(0, Global_70024.f_555[0 /*21*/].f_12) || !func_466(1, Global_70024.f_555[0 /*21*/].f_12)))
			{
				func_417(&(Global_106070.f_32605.f_69[Global_70024.f_555[0 /*21*/].f_14 /*78*/]), &Global_70933);
...
int func_466(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_467(&(Global_106070.f_32605.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_399(Global_106070.f_32605.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_469(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	{
		case joaat("cargobob"):
			if (func_471(iParam0, Global_70024.f_139[38], 0))
			{
				func_465(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_471(iParam0, Global_70024.f_139[43], 1))
			{
				func_465(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_235(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_473(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90658[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90658[iVar0]) == func_209(iParam0, iParam1))
				{
...
void func_474(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_212(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_212(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_212(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_477(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_476())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_212(iVar2 + 1)))
				{
...
void func_485(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	while (iVar0 < 68)
	{
		if (func_412(&(Global_70024.f_555[0 /*21*/]), iVar0))
		{
...
bool func_488()
{
	return func_486(&(Global_99633.f_2875));
}

void func_489()
{
	func_490(&(Global_99633.f_2875));
}
...
bool func_491()
{
	return func_487(&(Global_99633.f_2875));
}
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_382(iParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_382(iParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_499(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_12(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_213(iParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_502(*iParam1);
				...
				func_500(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_106070.f_20090[iParam0 /*43*/].f_1));
				...
				func_500(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_106070.f_20090[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_504(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			...
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_508(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_509(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_524(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_253())
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_525(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1 && Global_2423801[iParam0 /*413*/].f_309.f_7 != func_253())
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_526(int iParam0)
{
	if (iParam0 != func_253())
	{
		if (func_319(iParam0, 1, 1))
		{
			if (Global_2423801[iParam0 /*413*/].f_309.f_4 != -1)
			{
				return func_505(Global_2423801[iParam0 /*413*/].f_309.f_4) == 9;
			}
		}
	}
	return 0;
...
int func_531(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_533(Global_99633.f_2875.f_12.f_66))
	{
		return 0;
	}
...
void func_537()
{
	...
	iLocal_355 = 1500;
	iLocal_353 = 3500;
	UI::REQUEST_ADDITIONAL_TEXT("MET1", 0);
	func_546();
	func_544();
	func_543();
	func_542();
