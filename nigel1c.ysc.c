...
void func_1()
{
	...
	if (func_276(iLocal_422) && func_276(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			AI::CLEAR_PED_TASKS(iLocal_422);
			AI::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
		}
		if (!PED::IS_PED_FLEEING(iLocal_422))
		{
			if ((func_30(iLocal_422, 1126825984) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1)) && !func_22(iLocal_422, 1, 0, 0, 0))
			{
				...
				AI::CLEAR_PED_TASKS(iLocal_422);
				AI::TASK_LOOK_AT_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				AI::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				iLocal_638 = 1;
			}
		}
		if ((iLocal_638 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_651) && func_21(PLAYER::PLAYER_PED_ID(), iLocal_422, 10f, 1))
		{
			if (func_20())
			{
			...
			{
				iLocal_651 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				iLocal_637 = 1;
			}
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_422))
	{
		...
		else if (func_28(iLocal_422, 1, 8f, 15f) || func_23(iLocal_422, 5f, 0, 0))
		{
			if (func_276(iLocal_422) && !PED::IS_PED_FLEEING(iLocal_422))
			{
				...
				AI::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			if (func_276(iLocal_423) && !PED::IS_PED_FLEEING(iLocal_423))
			{
				AI::TASK_SMART_FLEE_PED(iLocal_423, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			iLocal_414 = 2;
			iLocal_420 = 0;
			iLocal_419 = 10;
...
void func_42()
{
	...
	switch (iLocal_420)
	{
		case 0:
			...
			UI::CLEAR_PRINTS();
			UI::CLEAR_HELP(1);
			if (UI::DOES_BLIP_EXIST(iLocal_451))
			{
				UI::REMOVE_BLIP(&iLocal_451);
			}
			AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FAIL");
...
void func_59()
{
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_276(iLocal_423))
			{
				AI::CLEAR_PED_TASKS(iLocal_423);
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_423, 0.5f, 1f, 0f), 2.5f, 20000, 0.25f, 0, 40000f);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -650.2209f, -120.7035f, 36.832f, 2.5f, 20000, 1f, 0, 40000f);
				AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 50f, -1, 1, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			if (AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1C_SCENE"))
			{
			...
			if (func_276(iLocal_422))
			{
				...
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_422, iLocal_423, 0f, 0f, 0f, 2f, -1, 3f, 1);
				}
			}
			iLocal_673 = -1;
			iLocal_420 = 1;
		...
		case 1:
			if (!func_20())
			{
				if (iLocal_673 < 0)
				{
					iLocal_673 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_673)
				{
					AI::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
...
void func_65()
{
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_276(iLocal_423))
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_423);
			}
			AUDIO::STOP_SCRIPTED_CONVERSATION(true);
			if (UI::DOES_BLIP_EXIST(iLocal_451))
			{
			...
			if (func_276(iLocal_423))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_430, sLocal_655, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_423, iLocal_430, sLocal_655, "take_collar_dog", 8f, -4f, 1, 16, 1148846080, 0);
		...
		case 1:
			...
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COLLAR", iLocal_423, "NIGEL_1C_SOUNDSET", 0, 0);
			...
			else if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_430) && !func_20())
			{
				if (func_79(&uLocal_452, "NIG1CAU", "NIG1C_COLLAR", "NIG1C_COLLAR_3", 7, 0, 0))
				{
					...
					{
						CAM::SET_CAM_ACTIVE(iLocal_622, 0);
...
void func_80(bool bParam0)
{
	...
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_656, 50f, 0, 0, 0, 0, false, 0);
		...
		GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_656, 50f, 0);
	}
}
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_136(iVar10, 14, uVar12[iVar1], -1) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_96(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_128(iVar0);
						if (Global_71015 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_136(iVar10, 14, uVar15[iVar1], -1) };
			func_106(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_128(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_96(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
void func_106(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_107(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_108(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_108(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_108(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_108(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_132(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2535519[iParam0 /*3*/][func_131(iParam1)];
...
void func_138(int iParam0)
{
	...
	func_139(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_132(func_142(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_132(func_141(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_132(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_145(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_139(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_139(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_96(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_200(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_96(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_96(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_420)
	{
		case 0:
			if (func_276(iLocal_423))
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_653, "chop_growl", 8f, -8f, -1, 9, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
...
void func_219()
{
			...
			if ((func_276(Local_421[0 /*16*/]) && func_276(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_421[0 /*16*/]))
			{
				if (func_221() || func_21(Local_421[0 /*16*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					if (func_21(Local_421[0 /*16*/], PLAYER::PLAYER_PED_ID(), 12f, 1))
					{
						...
						{
							AI::CLEAR_PED_TASKS(Local_421[0 /*16*/]);
							AI::OPEN_SEQUENCE_TASK(&iLocal_617);
							AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
							AI::CLOSE_SEQUENCE_TASK(iLocal_617);
							AI::TASK_PERFORM_SEQUENCE(Local_421[0 /*16*/], iLocal_617);
							AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
							iLocal_630 = 1;
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_421[0 /*16*/], 5000, 0, 2);
						}
					}
				}
			}
		...
		if (iLocal_636 == 1)
		{
			if ((func_276(Local_421[1 /*16*/]) && func_276(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_421[1 /*16*/]))
			{
				if (func_21(Local_421[1 /*16*/], PLAYER::PLAYER_PED_ID(), 8f, 1))
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_421[1 /*16*/]);
						AI::OPEN_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[1 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_421[1 /*16*/], iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_421[1 /*16*/], 3500, 0, 2);
						iLocal_636 = 0;
					}
				}
			}
	...
	if (iLocal_634 == 1)
	{
		if (func_220() > 40)
		{
			...
			{
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_423, -1, 0, 2);
				iLocal_634 = 0;
				iLocal_635 = 1;
			}
		}
...
int func_220()
{
	...
	AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &uVar0);
	return uVar0;
}
...
bool func_223(char* sParam0, int iParam1, char* sParam2)
{
		...
		if (func_214(Local_445) && func_276(iLocal_423))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_445))
			{
				...
				if (func_225() > 35)
				{
					...
					AI::CLEAR_PED_TASKS(Local_445.f_1);
					AI::TASK_VEHICLE_DRIVE_WANDER(Local_445.f_1, Local_445, 20f, 139);
					if (func_214(Local_447))
					{
						AI::TASK_VEHICLE_DRIVE_WANDER(Local_447.f_1, Local_447, 15f, 139);
					}
					iLocal_628 = 1;
				}
				if (iLocal_626 == 0)
			...
			else if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
			{
				if (func_225() == 19)
				{
					...
					AI::TASK_LOOK_AT_ENTITY(Local_445.f_1, iLocal_423, -1, 0, 2);
...
int func_225()
{
	...
	AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(iLocal_423, true), &uVar0);
	return uVar0;
}
		...
		if (func_214(Local_443) && func_276(iLocal_423))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_443))
			{
				...
				if (func_225() > 32)
				{
					...
					AI::CLEAR_PED_TASKS(Local_443.f_1);
					AI::TASK_VEHICLE_DRIVE_WANDER(Local_443.f_1, Local_443, 20f, 786599);
					iLocal_627 = 1;
				}
				if (iLocal_625 == 0)
				{
			...
			else if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
			{
				if (func_225() > 25)
				{
					...
					AI::TASK_LOOK_AT_ENTITY(Local_443.f_1, iLocal_423, -1, 0, 2);
					if (func_276(iLocal_429))
					{
						AI::TASK_LOOK_AT_ENTITY(iLocal_429, iLocal_423, -1, 0, 2);
					}
				}
			}
		...
		if ((func_214(Local_442) && func_214(Local_441)) && func_214(Local_446))
		{
			if (iLocal_624 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, true, 0))
				{
					...
					AI::TASK_LOOK_AT_ENTITY(Local_441.f_1, iLocal_423, 5000, 0, 2);
					if (func_276(Local_421[2 /*16*/]))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_PAUSE(0, 500);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "reaction_backward_big_intro_c", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_421[2 /*16*/], iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
					}
					iLocal_624 = 1;
				}
			...
			{
				case 0:
					if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
					{
						if (func_225() > 8)
						{
							iLocal_412 = 1;
				...
				case 3:
					...
					AI::TASK_VEHICLE_MISSION(Local_446.f_1, Local_446, Local_442, 2, 20f, 262144, 0.5f, 2f, 1);
					AI::TASK_VEHICLE_MISSION(Local_442.f_1, Local_442, Local_446, 2, 20f, 262144, 0.5f, 2f, 1);
				...
				case 4:
					...
					{
						AI::OPEN_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_VEHICLE_TEMP_ACTION(0, Local_446, 5, 1000);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_446.f_1, iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_VEHICLE_TEMP_ACTION(Local_442.f_1, Local_442, 4, 1000);
						VEHICLE::SMASH_VEHICLE_WINDOW(Local_442, 2);
						VEHICLE::SMASH_VEHICLE_WINDOW(Local_442, 0);
						iLocal_632 = 1;
						DECISIONEVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(79, Local_446, -1f);
						if (func_214(Local_449))
						{
							AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_449.f_1, Local_449, -567.85f, -288.8f, 34.08f, 12f, 0, iLocal_437, 24, 5f, 5f);
						}
						iLocal_412 = 5;
					}
					break;
				...
				case 5:
					if (ENTITY::GET_ENTITY_SPEED(Local_442) < 0.5f && ENTITY::GET_ENTITY_SPEED(Local_446) < 0.5f)
					{
						...
						AI::TASK_LEAVE_VEHICLE(0, Local_446, 0);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_442.f_1, -1f, 1f, 0f), 1.3f, 20000, 0.25f, 0, 40000f);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_442.f_1, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_446.f_1, iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
						AI::OPEN_SEQUENCE_TASK(&iLocal_617);
						AI::TASK_LEAVE_VEHICLE(0, Local_441, 0);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_446, 2500);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_442.f_1, -1f, 1f, 0f), 1.2f, 20000, 1f, 0, 40000f);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_442.f_1, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0f, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_441.f_1, iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
	...
	if ((func_276(Local_446.f_1) && func_29(Local_446)) && func_276(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_417)
		{
			case 0:
				...
				{
					AI::CLEAR_PED_TASKS(Local_446.f_1);
					if (func_231() == joaat("weapon_unarmed"))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 5, true);
					}
					AI::TASK_COMBAT_PED(Local_446.f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_417 = 1;
				}
			...
			case 1:
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446, 0))
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_446.f_1);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_446.f_1, PLAYER::PLAYER_PED_ID(), -1);
				...
				if (func_229(Local_446.f_1, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 17, true);
					AI::CLEAR_PED_TASKS(Local_446.f_1);
					AI::TASK_SMART_FLEE_PED(Local_446.f_1, PLAYER::PLAYER_PED_ID(), 60f, -1, 0, 0);
					iLocal_417 = 4;
				}
				break;
			...
			case 2:
				...
				if (func_64(PLAYER::PLAYER_PED_ID(), Local_446.f_1, 1) > 20f)
				{
					...
					AI::TASK_ENTER_VEHICLE(0, Local_446, -1, -1, 1f, 1, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_617);
					AI::TASK_PERFORM_SEQUENCE(Local_446.f_1, iLocal_617);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
					iLocal_417 = 3;
	...
	if (func_276(Local_441.f_1))
	{
		switch (iLocal_418)
		{
			case 0:
				if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_442, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_441, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446, 0))
				{
					AI::CLEAR_PED_TASKS(Local_441.f_1);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_441.f_1, PLAYER::PLAYER_PED_ID(), 0);
					iLocal_418 = 1;
				}
				break;
	...
	if (func_214(Local_444) && func_276(iLocal_423))
	{
		switch (iLocal_413)
		{
			...
			case 1:
				...
				{
					AI::TASK_VEHICLE_MISSION(Local_444.f_1, Local_444, Local_442, 12, 15f, 262144, 20f, 5f, 1);
				}
			...
			case 2:
				AI::SET_DRIVE_TASK_CRUISE_SPEED(Local_444.f_1, 15f);
			...
			case 3:
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_VEHICLE_TEMP_ACTION(0, Local_444, 10, 500);
				AI::TASK_VEHICLE_TEMP_ACTION(0, Local_444, 4, 1000);
				AI::TASK_PAUSE(0, 1000);
				AI::TASK_LEAVE_VEHICLE(0, Local_444, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_444.f_1, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			...
			case 4:
				if ((AI::GET_SCRIPT_TASK_STATUS(Local_444.f_1, 242628503) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_444, -1, 0)) && !PED::IS_PED_FLEEING(Local_444.f_1))
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_617);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_444, -2f, 2f, 0f), 2f, 20000, 0.25f, 0, 40000f);
					if (func_276(Local_441.f_1))
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_441.f_1, 5000);
					}
					else
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5000);
					}
					AI::TASK_ENTER_VEHICLE(0, Local_444, -1, -1, 1.8f, 9, 0);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_444, 10f, 131);
					AI::CLOSE_SEQUENCE_TASK(iLocal_617);
					AI::TASK_PERFORM_SEQUENCE(Local_444.f_1, iLocal_617);
					AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
					iLocal_413 = 5;
				...
				{
					AI::CLEAR_PED_TASKS(Local_444.f_1);
					iLocal_413 = 6;
				}
			...
			case 6:
				...
				AI::TASK_ENTER_VEHICLE(0, Local_444, -1, -1, 2.5f, 9, 0);
				AI::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_444, PLAYER::PLAYER_PED_ID(), 8, 20f, 20, 100f, 5f, 1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_444.f_1, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
				iLocal_413 = 7;
...
void func_234()
{
	...
	switch (iLocal_420)
	{
		case 0:
			...
			iLocal_634 = 0;
			iLocal_636 = 0;
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-628.8963f, -183.1741f, 36.76265f, 50f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-679.2649f, -250.0605f, 35.60568f, 21.75f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-655.583f, -298.5198f, 34.45316f, 39.75f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-670.7004f, -99.16148f, 36.77983f, 60f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-561.3182f, -153.0898f, 36.6348f, 50f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-590.6263f, -247.0923f, 34.69418f, 35f, 1, 0, 0, 0, false, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_656, 50f, 0, 0, 0, 0, false, 0);
			if (!func_241())
			{
				return;
			...
			{
				AI::TASK_START_SCENARIO_IN_PLACE(Local_421[0 /*16*/], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
			}
			if (func_276(Local_421[2 /*16*/]))
			{
				AI::TASK_START_SCENARIO_IN_PLACE(Local_421[2 /*16*/], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
			}
			if (func_276(Local_421[4 /*16*/]))
			{
				AI::TASK_START_SCENARIO_IN_PLACE(Local_421[4 /*16*/], "WORLD_HUMAN_STAND_MOBILE", 0, 0);
			}
			if (func_276(Local_421[1 /*16*/]))
			{
				AI::TASK_START_SCENARIO_IN_PLACE(Local_421[1 /*16*/], "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
			...
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_448, -758.84f, -115.64f, 36.89f, 12f, 0, Local_448.f_2, 17, 1f, 1f);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_448.f_1, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			if (func_214(Local_447))
			{
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_447, -655.18f, -202.16f, 36.43f, 18f, 0, iLocal_440, 17, 1f, 1f);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_447, -643.56f, -196.16f, 36.58f, 10f, 0, iLocal_440, 17, 1f, 1f);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_447, -633.4f, -191.1f, 36.67f, 5f, 0, iLocal_440, 17, 1f, 1f);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_447.f_1, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
		...
		case 1:
			...
			else if (iLocal_640 == 0)
			{
				if (func_214(Local_448))
				{
					if (func_220() > 25)
					{
						AI::CLEAR_PED_TASKS(Local_448.f_1);
						ENTITY::SET_ENTITY_COORDS(Local_448, -678.85f, -95.08f, 36.86f, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(Local_448, 208.7f);
						AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_448.f_1, Local_448, -567.85f, -288.8f, 34.08f, 12f, 0, iLocal_435, 786599, 5f, 5f);
						iLocal_640 = 1;
					}
				}
			}
...
void func_235()
{
	if (func_276(iLocal_422))
	{
		AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1);
	}
	iLocal_420 = 0;
	iLocal_419 = 7;
}
...
void func_236()
{
	if (func_276(Local_421[4 /*16*/]) && func_276(iLocal_423))
	{
		if (Local_421[4 /*16*/].f_13 == 0)
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_421[4 /*16*/]);
				...
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -631.84f, -153.48f, 36.83f, 1f, 20000, 0.25f, 0, 40000f);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_423, 0);
				AI::TASK_PAUSE(0, 1500);
				AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_421[4 /*16*/], iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
	...
	if (!Local_421[iParam0 /*16*/].f_14)
	{
		if (func_276(Local_421[iParam0 /*16*/]) && func_276(iLocal_423))
		{
			if (!Local_421[iParam0 /*16*/].f_13)
			{
				if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
				{
					if (func_225() > Local_421[iParam0 /*16*/].f_12)
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[iParam0 /*16*/].f_6, 1f, 20000, 0.25f, 0, 40000f);
						AI::CLOSE_SEQUENCE_TASK(iLocal_617);
						AI::TASK_PERFORM_SEQUENCE(Local_421[iParam0 /*16*/], iLocal_617);
						AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			...
			else if (func_21(Local_421[iParam0 /*16*/], iLocal_423, 3f, 1))
			{
				...
				AI::CLEAR_PED_TASKS(Local_421[iParam0 /*16*/]);
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
				if (vVar0.y > 0.7f)
				{
					AI::TASK_PLAY_ANIM(0, sLocal_652, Local_421[iParam0 /*16*/].f_15, 8f, -4f, -1, 0, 0f, 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM(0, sLocal_652, "avoid_rb", 8f, -4f, -1, 0, 0f, 0, 0, 0);
				}
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_423, 0);
				AI::TASK_PAUSE(0, 1000);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[iParam0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(Local_421[iParam0 /*16*/], iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
...
void func_238()
{
	if ((func_276(iLocal_422) && func_239(iLocal_422, vLocal_425, 1) < 5f) && func_239(PLAYER::PLAYER_PED_ID(), vLocal_425, 1) < 25f)
	{
		if (iLocal_427)
		{
			...
			{
				iLocal_427 = 0;
				iLocal_428 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				AI::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_423, -1, 0, 2);
			}
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_428 && !func_20())
		{
...
int func_241()
{
	...
	{
		if (STREAMING::HAS_MODEL_LOADED(1938952078))
		{
			iLocal_450 = VEHICLE::CREATE_VEHICLE(1938952078, -637.88f, -112.82f, 38.1f, 83.08f, true, true, false);
...
void func_242()
{
	...
	AI::REQUEST_WAYPOINT_RECORDING(sLocal_426);
...
void func_243()
{
	...
	switch (iLocal_420)
	{
		case 0:
			...
			func_80(0);
			AI::WAYPOINT_RECORDING_GET_NUM_POINTS(sLocal_426, &iLocal_621);
			AI::WAYPOINT_RECORDING_GET_COORD(sLocal_426, (iLocal_621 - 1), &vLocal_620);
			if (func_276(iLocal_423))
			{
				AI::CLEAR_PED_TASKS(iLocal_423);
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
				AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_426, 0, 616, -1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			if ((iLocal_674 != 1 && func_276(iLocal_422)) && func_276(iLocal_423))
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_423, 1500);
				}
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_425, 2.2f, 20000, 0.25f, 0, 40000f);
				AI::TASK_CLEAR_LOOK_AT(0);
				AI::TASK_PLAY_ANIM(0, sLocal_652, "IDLE_D", 2f, -8f, -1, 8193, 0f, 0, 0, 0);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(iLocal_422, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			iLocal_427 = 1;
			iLocal_428 = 0;
	...
	switch (iLocal_415)
	{
		...
		case 1:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				Var1.f_4 = 1f;
				Var1.f_5 = 0.5f;
				Var1.f_16 = GAMEPLAY::GET_HASH_KEY("BONEMASK_HEAD_NECK_AND_L_ARM");
				Var1.f_20 = 48;
				Var1.f_21 = 1024;
				AI::TASK_SCRIPTED_ANIMATION(PLAYER::PLAYER_PED_ID(), &Var1, &Var0, &Var0, 0.25f, 0.25f);
			}
			UNK1::_0x293220DA1B46CEBC(3f, 2f, 0);
			...
			iLocal_672 = GAMEPLAY::GET_GAME_TIMER() + 750;
			iLocal_415 = 2;
			break;
		
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_672 && func_276(iLocal_422))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_422))
				{
					PED::_0xFE07FF6495D52E2A(iLocal_422, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		...
		case 3:
			...
			{
				AI::TASK_LOOK_AT_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
				AI::OPEN_SEQUENCE_TASK(&iLocal_617);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				AI::TASK_PLAY_ANIM(0, sLocal_654, "gesture_easy_now", 8f, -8f, -1, 8, 0f, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(iLocal_617);
				AI::TASK_PERFORM_SEQUENCE(iLocal_422, iLocal_617);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_617);
				iLocal_641 = 1;
				iLocal_672 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_415 = 5;
			}
			break;
		...
		case 5:
			func_250();
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_672 && func_276(iLocal_423))
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_423, -628.1631f, -261.5749f, 37.6045f, 1.5f, 20000, 0.25f, 0, -15.13f);
				iLocal_415 = 4;
			}
			break;
...
void func_251()
{
	...
	{
		case 0:
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_422, -1, 0, 2);
			if (!UI::DOES_BLIP_EXIST(iLocal_451))
			{
				UNK1::_0x293220DA1B46CEBC(2f, 10f, 1);
				iLocal_451 = func_245(iLocal_423, 1, 1, 5);
...
void func_252()
{
	...
	if (func_276(iLocal_422))
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_647 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_648, vLocal_649, fLocal_650, 0, true, 0))
		{
			bVar0 = false;
			if (UI::IS_MESSAGE_BEING_DISPLAYED())
			{
			...
			if (bVar0)
			{
				iLocal_647 = GAMEPLAY::GET_GAME_TIMER() + 7000;
			}
		}
	}
}
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_257(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_306(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_136(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_96(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_96(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
void func_311(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&cVar1, {func_266(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&cVar1, 0, Global_93269, 0);
		func_312(&cVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}

void func_312(char[4] cParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
{
	return func_433(&(Global_99633.f_2875), vParam0, fParam1, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_431(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_438(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_441(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_440())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_458(int iParam0)
{
	...
	func_50(Local_444);
	func_48(&iLocal_450);
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-669.0843f, -209.1426f, 36.27277f, 25.25f, 0, 0, 0, 0, false, 0);
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_656, 50f, 0, 0, 0, 0, false, 0);
...
void func_464()
{
	...
	if (func_470())
	{
		...
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-633.4493f, -248.2691f, 35.87451f, 50f, 0, 0, 0, 0, false, 0);
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_656, 50f, 0, 0, 0, 0, false, 0);
		func_465();
		func_242();
		iLocal_422 = Local_411.f_28[0];
		...
		func_61(&uLocal_452, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		func_61(&uLocal_452, 3, iLocal_422, "KERRY", 0, 1);
		iLocal_647 = GAMEPLAY::GET_GAME_TIMER() + 3000;
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(1938952078, true);
		iLocal_420 = 0;
		iLocal_419 = 1;
	}
}
...
int func_470()
{
	if ((STREAMING::HAS_MODEL_LOADED(iLocal_431) && STREAMING::HAS_MODEL_LOADED(iLocal_433)) && UI::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		return 1;
	}
	return 0;
...
int func_476(var uParam0)
{
	...
	switch (iLocal_40)
	{
		...
		case 2:
			...
			AI::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "price_tag", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "such_a_good", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "this_looks", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0f, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sVar2, "who_would", 8f, -8f, -1, 0, 0f, 0, 0, 0);
...
void func_479()
{
	...
	func_491();
	func_513(2, 0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(1938952078, false);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
