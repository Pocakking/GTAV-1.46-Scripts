...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		func_144(Global_106070.f_19945.f_3, &vVar1, &fVar3, &uVar0, &uVar2);
		if (Global_106070.f_19945.f_3 >= 5 || uLocal_257)
		{
		...
		switch (*iParam0)
		{
			...
			case 17:
				if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_245))
				{
					...
					else
					{
						...
						if (UI::DOES_BLIP_EXIST(iLocal_267))
						{
							UI::REMOVE_BLIP(&iLocal_267);
						}
			...
			case 19:
				if ((GAMEPLAY::GET_GAME_TIMER() - *uParam2) > iLocal_249)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
int func_76(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 49)
	{
		if (iParam1 == 6 || iParam1 == func_92(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_77(iVar0, 0), true);
...
int func_106()
{
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_51.z = 1;
			iLocal_245 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_51, 9, 25000);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
...
void func_117()
{
	switch (iLocal_70)
	{
		case 1:
			if (!func_137())
			{
				if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_136(&iLocal_58))
				{
					AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
					func_134(&iLocal_58);
				}
				else if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_136(&iLocal_58))
				{
...
float func_131(int iParam0)
{
	if (func_136(iParam0))
	{
		...
		{
			return (func_132(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_132(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_143(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	switch (iLocal_71)
	{
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_254, fLocal_255) || func_22(Global_106070.f_19945.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_269))
					{
...
int func_145(var uParam0, bool bParam1, bool bParam2)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_248) < iLocal_249)
	{
		return 0;
	}
	return 1;
