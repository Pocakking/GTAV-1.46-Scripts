...
void func_3(int iParam0)
{
	...
	iVar0 = iParam0;
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_385), iVar0);
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_386), iVar0);
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_387), iVar0);
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_389), iVar0);
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_393), iVar0);
	GAMEPLAY::CLEAR_BIT(&(Global_2415861.f_388), iVar0);
}
				...
				if (NETWORK::_NETWORK_GET_PED_PLAYER(iVar1) != -1)
				{
					if (func_5(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_29(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
