...
void __EntryFunction__()
{
	...
	while (true)
	{
		UNK1::_0x208784099002BC30("SF_PRC", 0);
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	{
		case 0:
			UNK1::_0x293220DA1B46CEBC(8f, 0f, 1);
			iLocal_232 = GAMEPLAY::GET_GAME_TIMER() + 500;
			iLocal_225 = 1;
			break;
		...
		case 1:
			...
			if (func_205(Local_56.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[1]))
			{
				if (func_205(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[1], 128, 1);
						AI::TASK_SMART_FLEE_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
				}
				else
				{
					AI::TASK_WANDER_STANDARD(Local_56.f_28[1], 1193033728, 0);
				}
			}
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_232)
			{
				iLocal_225 = 2;
			}
			break;
...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		func_171(&(Global_105157[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_23(var uParam0)
{
	...
	*uParam0 = 145;
	...
	func_27(&(uParam0->f_2869));
	func_25(&(uParam0->f_2875));
	func_24(&(uParam0->f_2965));
}
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	Global_71017[1 /*14*/] = { func_84(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_71017[1 /*14*/] = { func_84(iVar0, iParam1, uVar6[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_71017[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_149(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_64, Global_106070.f_2355.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_71017[1 /*14*/] = { func_84(iVar10, iParam1, iParam2, -1) };
		if (!func_74(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_71017[1 /*14*/] = { func_84(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_71017[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71017[1 /*14*/] = { func_84(iVar10, 14, uVar12[iVar1], -1) };
							func_52(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
							func_67(14);
							if (Global_71015 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_71015 == 1)
						{
			...
			{
				Global_71017[1 /*14*/] = { func_84(iVar10, iVar0, func_42(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71017[1 /*14*/] = { func_84(iVar10, 14, uVar15[iVar1], -1) };
			func_52(iParam0, Global_71017[1 /*14*/].f_12, Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4);
			func_67(14);
			if (Global_71015 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_71017[1 /*14*/].f_3, Global_71017[1 /*14*/].f_4, iParam4);
		}
		if (Global_71015 == 1)
		{
			iVar2 = 0;
...
{
	Global_71017[1 /*14*/] = { func_84(iParam0, iParam1, iParam2, -1) };
...
void func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_53(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_149(iParam0, Global_106070.f_2355.f_539[iVar0 /*65*/].f_61, Global_106070.f_2355.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_83(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[0], Global_106070.f_2355.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_83(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[1], Global_106070.f_2355.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_83(&Var1, -99, -99, Global_106070.f_2355.f_539.f_196[2], Global_106070.f_2355.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_86(int iParam0)
{
	...
	func_87(&(Global_71017[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_71014, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_71(iVar1, Global_71014, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_87(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_87(&(Global_71017[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_87(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71186)
		{
			...
			func_87(&(Global_71017[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_76(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_149(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_149(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_149(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_71017[2 /*14*/] = { func_84(iVar0, 14, iVar4, -1) };
									if (Global_71017[2 /*14*/].f_12 == iVar3)
									{
										if (func_149(iParam0, 14, iVar4))
										{
											if (!func_40(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_71017[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_71017[2 /*14*/] = { func_84(iVar0, iVar2, iVar1, -1) };
						if (!func_40(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_71017[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_71017[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_71017[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_151(Global_106070.f_2355.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_150(PLAYER::PLAYER_PED_ID());
			if (func_152(iVar0) && (!func_92(14) || Global_105021))
			{
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&cVar1, {func_157(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&cVar1, 0, Global_93269, 0);
		func_161(&cVar1, Var0.f_3, Global_93269, iParam1, iParam2);
	}
}

void func_161(char[4] cParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_166()
{
	...
	{
		func_155();
		GRAPHICS::_0xBF59707B3E5ED531(func_167(Global_106070.f_2355.f_539.f_4301));
	}
	else
	{
...
{
	func_176(iParam0, 1);
	Global_106070.f_18546[iParam0 /*6*/].f_3 = func_175();
...
void func_207()
{
	if (!bLocal_325)
	{
		if (iLocal_326 == -1)
		{
			...
			{
				iLocal_326 = GAMEPLAY::GET_GAME_TIMER() + 500;
			}
		}
		else if (iLocal_326 > GAMEPLAY::GET_GAME_TIMER())
		{
			if ((!func_205(Local_56.f_28[0]) && !func_205(Local_56.f_28[1])) && !func_205(Local_56.f_28[2]))
			{
				bLocal_325 = true;
...
void func_213()
{
	if ((func_205(Local_56.f_28[0]) && func_214(Local_56.f_35[0])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_316))
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[0]))
		{
			if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_56.f_35[0]) >= iLocal_318)
			{
				if (bLocal_278)
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[0], Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, 1);
				}
				else
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[0], Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, 1);
				}
			}
		}
	}
	if ((func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317))
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[1]))
		{
			if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_56.f_35[1]) >= iLocal_319)
			{
				if (func_205(Local_56.f_28[0]))
				{
					if (bLocal_278)
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[1], Local_56.f_35[1], Local_56.f_28[0], 7, 15f, 786468, 100f, 1f, 1);
					}
					else
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[1], Local_56.f_35[1], Local_56.f_28[0], 7, 40f, 786468, 100f, 1f, 1);
					}
				}
				else
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(Local_56.f_28[1], Local_56.f_35[1], 15f, 786597);
				}
			}
		}
	}
...
void func_215()
{
	...
	{
		if (((((!PED::IS_PED_FLEEING(Local_56.f_28[2]) && !AI::IS_PED_GETTING_UP(Local_56.f_28[2])) && !PED::IS_PED_PRONE(Local_56.f_28[2])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2])) && !func_217(Local_56.f_28[2], 63541484)) && !func_217(Local_56.f_28[2], 242628503))
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 1) || (func_214(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], 1))) || (func_214(Local_56.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[0], 1)))
			{
				...
				PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[2], 128, 1);
				AI::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
		}
	}
}
...
void func_218()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 1)) && !AI::IS_PED_GETTING_UP(Local_56.f_28[1])) && !PED::IS_PED_PRONE(Local_56.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[1])) && !func_217(Local_56.f_28[1], 63541484)) && !func_217(Local_56.f_28[1], 242628503))
		{
			func_216(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[1], 128, 1);
			AI::TASK_SMART_FLEE_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	...
	if (func_205(Local_56.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[1], sLocal_252, sLocal_268, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[1]))
			{
				...
				{
					AI::STOP_ANIM_TASK(Local_56.f_28[1], sLocal_252, sLocal_268, -8f);
				}
			}
		...
		{
			AI::TASK_PLAY_ANIM(Local_56.f_28[1], sLocal_252, sLocal_268, 1000f, -8f, -1, 57, 0f, 0, 0, 0);
		}
	}
}
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_229(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_229(sParam2, 0, 0))
					{
...
void func_230()
{
	...
	{
		if (((((((iLocal_234 < 4 && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !func_242()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_235) && func_225(Local_56.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 1)) && !PED::IS_PED_FLEEING(Local_56.f_28[1]))
		{
			if (func_231(&uLocal_58, "PAP4AUD", "PAP4_CAMERA", sLocal_233[iLocal_234], 7, 0, 0))
			{
				iLocal_234++;
				iLocal_235 = GAMEPLAY::GET_GAME_TIMER() + 15000;
			}
		}
	}
}
		...
		if (PED::IS_PED_IN_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 0))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[0]))
			{
				if (func_244(&uLocal_58, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					...
					{
						AI::TASK_COMBAT_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
						func_223(&(Local_56.f_41[0]), 0);
					}
					if (UI::DOES_BLIP_EXIST(iLocal_57))
					{
						UI::SET_BLIP_SCALE(iLocal_57, 0.7f);
					}
				}
			}
		}
				...
				if (!func_242())
				{
					if (iLocal_247 < 3)
					{
						if (func_231(&uLocal_58, "PAP4AUD", "PAP4_ATTACK", sLocal_246[iLocal_247], 7, 0, 0))
						{
							...
							iLocal_247++;
							iLocal_248 = GAMEPLAY::GET_GAME_TIMER() + 15000;
						}
					}
...
bool func_250(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_50[iVar2 /*4*/].f_3) < iParam4);
}
...
void func_267()
{
	if (func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1]))
	{
		...
		{
			AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[1], Local_56.f_35[1], sLocal_317, 786597, 0, 8, -1, -1f, 0, 1073741824);
		}
	}
}
...
void func_268()
{
	if ((func_214(Local_56.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[1], PLAYER::PLAYER_PED_ID(), 1))) && !bLocal_263)
	{
		if ((func_205(Local_56.f_28[1]) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
		{
			...
			AI::TASK_COMBAT_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 0, 16);
			bLocal_263 = true;
		}
		...
		if (func_205(Local_56.f_28[0]))
		{
			if ((!PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0) && !PED::IS_PED_IN_MELEE_COMBAT(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[0]))
			{
				...
				{
					AI::STOP_ANIM_TASK(Local_56.f_28[0], sLocal_252, sLocal_253, -8f);
					AI::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					func_223(&(Local_56.f_41[0]), 0);
				}
				else
				{
...
void func_269()
{
	if (((func_205(Local_56.f_28[0]) && func_205(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[0]))
	{
		...
		else if (!PED::IS_PED_FLEEING(Local_56.f_28[0]))
		{
			...
			PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[0], 2, 0);
			iLocal_264 = 1;
			AI::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_223(&(Local_56.f_41[0]), 0);
			func_219();
	...
	if (func_205(Local_56.f_28[0]))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1))
		{
			if ((((!bLocal_261 && iLocal_260) && !func_271(Local_56.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_56.f_28[0]);
				}
				PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[0], 2, 0);
				func_223(&(Local_56.f_41[0]), 0);
				iLocal_264 = 1;
				AI::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 400f, -1, 1, 0);
				func_219();
				iLocal_304 = 3;
				iLocal_260 = 0;
				bLocal_261 = true;
		...
		else if ((((!bLocal_261 && iLocal_260) && !func_271(Local_56.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[0], 2, 1);
			AI::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 400f, -1, 1, 0);
			func_223(&(Local_56.f_41[0]), 0);
			func_219();
			iLocal_304 = 3;
	...
	switch (iLocal_295)
	{
		case 1:
			...
			if (bVar0)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_56.f_28[0]);
					AI::CLEAR_PED_SECONDARY_TASK(Local_56.f_28[0]);
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_297, 2f, 20000, 0.25f, 0, 40000f);
				}
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				AI::CLOSE_SEQUENCE_TASK(iVar1);
				AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[0], iVar1);
				...
				if (func_205(Local_56.f_28[1]) && !PED::IS_PED_FLEEING(Local_56.f_28[1]))
				{
					...
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_56.f_28[1], 0, 0);
					}
					else
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], Local_56.f_28[0], -1);
					}
				}
				if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 1))
					{
						AI::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
					else if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_56.f_28[2], 0, 4416);
					}
					else
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), -1);
					}
				}
				iLocal_296 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				if (UI::DOES_BLIP_EXIST(iLocal_57))
				{
					UI::SET_BLIP_SCALE(iLocal_57, 0.7f);
				}
		...
		case 2:
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_296)
			{
				if ((func_205(Local_56.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0)) && iLocal_260)
				{
					...
					if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_298, 2f, 20000, 0.25f, 0, 40000f);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						AI::CLOSE_SEQUENCE_TASK(iVar2);
						AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar2);
		...
		case 3:
			if (func_225(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0]) > 20f)
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_297, 1f, 20000, 0.25f, 0, 40000f);
				if (func_205(Local_56.f_28[1]))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[1], -1);
				}
				else
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				...
				AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[0], iVar3);
...
void func_274()
{
	AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), -1);
	iLocal_296 = GAMEPLAY::GET_GAME_TIMER() + 3000;
	if (UI::DOES_BLIP_EXIST(iLocal_57))
	{
		UI::SET_BLIP_SCALE(iLocal_57, 0.7f);
...
void func_275()
{
	...
	if (((func_205(Local_56.f_28[1]) && func_205(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
	{
		...
		if (fVar0 > 20f)
		{
			...
			{
				AI::TASK_GOTO_ENTITY_OFFSET(Local_56.f_28[1], Local_56.f_28[0], 20000, 0.5f, 0f, 2f, 2);
			}
		}
		else if (fVar0 < 10f)
		{
		...
		case 0:
			if (func_205(Local_56.f_28[0]) && func_205(Local_56.f_28[1]))
			{
				if (func_244(&uLocal_58, "PAP4AUD", "PAP4_TV_TALK", 7, 0, 0, 0))
				{
					...
					PED::SET_PED_DIES_WHEN_INJURED(Local_56.f_28[0], 1);
					iLocal_247 = 0;
					iLocal_234 = 0;
					bLocal_278 = true;
					bLocal_279 = true;
...
void func_278()
{
	if ((((func_205(Local_56.f_28[0]) && func_205(Local_56.f_28[1])) && func_205(PLAYER::PLAYER_PED_ID())) && !bLocal_263) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
	{
		if (PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0))
		{
			...
			{
				func_279();
				iLocal_280 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 3))
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_281)
			{
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), -1);
					iLocal_282 = 1;
				}
				iLocal_281 = (GAMEPLAY::GET_GAME_TIMER() + 4000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 20) * 100);
			}
		}
	}
}
...
void func_279()
{
	...
	if ((((!bLocal_308 && func_205(PLAYER::PLAYER_PED_ID())) && func_205(Local_56.f_28[1])) && func_205(Local_56.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar4, 3f, 20000, 0.25f, 0, 40000f);
		AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[0], 0);
		AI::CLOSE_SEQUENCE_TASK(iVar5);
		AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[1], iVar5);
...
void func_281()
{
	...
	{
		if ((((((!AI::IS_PED_GETTING_UP(Local_56.f_28[0]) && !PED::IS_PED_PRONE(Local_56.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1)) && !func_217(Local_56.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[0]))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 3) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_252))
			{
				AI::TASK_PLAY_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 4f, -8f, -1, 57, 0f, 0, 0, 0);
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 3))
		{
...
void func_285(bool bParam0)
{
	...
	if (bLocal_266)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_265))
		{
			...
			if (func_205(Local_56.f_28[0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, sLocal_252, sVar1, fVar4, -4f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[1]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, sLocal_252, sVar2, 1000f, -2f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[2]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, sLocal_252, sVar3, fVar4, -4f, 1, 16, 1148846080, 0);
			}
		}
	}
...
void func_286()
{
	if (func_205(Local_56.f_28[0]) && func_205(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0))
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_249)
			{
				if (func_244(&uLocal_58, "PAP4AUD", "PAP4_FIST", 7, 0, 0, 0))
				{
					iLocal_249 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				}
			}
		}
	}
		...
		if (bLocal_278)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_295()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321)) || !func_205(Local_56.f_28[1])) || !func_205(Local_56.f_28[2]))
			{
				...
				if (func_242())
				{
					Var0 = { func_294() };
					sVar1 = func_293(&Var0);
					if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar1, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1)) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				...
				if (func_242())
				{
					Var2 = { func_294() };
					sVar3 = func_293(&Var2);
					if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar3, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((func_248(Local_56.f_28[0], 1126825984) && func_295()) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object")) || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				if (func_217(Local_56.f_28[0], 780511057))
				{
					...
					if (func_242())
					{
						Var4 = { func_294() };
						sVar5 = func_293(&Var4);
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar5, "PAP4_THREAT"))
						{
							func_219();
						}
					}
				...
				else
				{
					...
					if (func_242())
					{
						Var6 = { func_294() };
						sVar7 = func_293(&Var6);
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar7, "PAP4_THREAT"))
						{
							func_219();
						}
					}
			...
			else if (((((func_248(Local_56.f_28[0], 1126825984) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1)) || iLocal_262) && (func_292(PLAYER::PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_292(PLAYER::PLAYER_PED_ID()) == joaat("object")))
			{
				if (func_205(Local_56.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0))
				{
					...
					func_223(&(Local_56.f_41[0]), 0);
					bLocal_266 = false;
					iLocal_249 = GAMEPLAY::GET_GAME_TIMER();
					func_219();
					func_223(&(Local_56.f_41[0]), 0);
				}
			}
			...
			else if ((func_205(Local_56.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_56.f_28[0]) < 150 || (func_261(Local_56.f_28[0], 0, 0, 0, 0) && func_295())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_266(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 20f, 1)) || (func_205(Local_56.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))) || (func_205(Local_56.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1))) || (func_205(Local_56.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1))) || iLocal_259))
			{
				...
				switch (iLocal_258)
				{
					case 0:
						...
						{
							AI::TASK_PLAY_ANIM(Local_56.f_28[0], sLocal_254, "flinch_additive_a", 4f, -8f, -1, 272, 0f, 0, 0, 0);
						}
						else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_56.f_28[0], sLocal_254, "flinch_additive_a") > 0.7f)
						{
							AI::STOP_ANIM_TASK(Local_56.f_28[0], sLocal_254, "flinch_additive_a", -8f);
							iLocal_258++;
						}
						break;
			...
			if (((((((((func_261(Local_56.f_28[1], 0, 0, 0, 0) && func_295()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_248(Local_56.f_28[1], 1126825984) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_214(Local_56.f_35[1])) || PED::IS_PED_RAGDOLL(Local_56.f_28[1])) || func_289(Local_56.f_28[1])) || func_271(Local_56.f_28[0])) || func_271(Local_56.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321))
			{
				if (!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 0))
				{
					if (func_242())
					{
						Var8 = { func_294() };
						sVar9 = func_293(&Var8);
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar9, "PAP4_THREAT") && !GAMEPLAY::ARE_STRINGS_EQUAL(sVar9, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
			...
			if (((((((((((func_247(Local_56.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295()) || (func_247(Local_56.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || (func_247(Local_56.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || func_289(Local_56.f_28[2])) || func_289(Local_56.f_28[0])) || func_289(Local_56.f_28[1])) || PED::IS_PED_RAGDOLL(Local_56.f_28[2])) || !func_214(Local_56.f_35[1])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321)) || func_271(Local_56.f_28[0])) || func_271(Local_56.f_28[1]))
			{
				if (!PED::IS_PED_FLEEING(Local_56.f_28[2]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 0))
				{
					if (func_242())
					{
						...
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(sVar11, "PAP4_THREAT") && !GAMEPLAY::ARE_STRINGS_EQUAL(sVar11, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
...
void func_296()
{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_231)
		{
			func_297();
			iLocal_231 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		}
	}
}
...
int func_297()
{
	...
	if (!bVar0 && !bVar1)
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		}
		return 1;
	}
	return 0;
...
void func_298()
{
	if (func_205(Local_56.f_28[0]))
	{
		if (func_214(Local_56.f_35[0]) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_316))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_56.f_28[0], Local_56.f_35[0]) && !func_217(Local_56.f_28[0], -1273030092))
			{
				...
				AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[0], Local_56.f_35[0], sLocal_316, 786597, 0, 8, -1, -1f, 0, 1073741824);
				if (UI::DOES_BLIP_EXIST(iLocal_57))
				{
					UI::SET_BLIP_SCALE(iLocal_57, 1f);
				}
				func_212(0);
			}
...
void func_299(bool bParam0, bool bParam1)
{
	...
	{
		if (iLocal_251 && GAMEPLAY::GET_GAME_TIMER() > iLocal_250)
		{
			if (iLocal_295 == 0)
			{
				func_300();
			...
			if (((((iLocal_305 && !func_217(Local_56.f_28[0], -1794415470)) && !func_217(Local_56.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[0], -1, 0)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) && !iLocal_264)
			{
				if (!func_297() && !func_243())
				{
					...
					if (bVar0 || bParam0)
					{
						...
						if (bParam1)
						{
							AI::TASK_ENTER_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 20000, -1, 2f, 1, 0);
						}
						else
						{
							AI::TASK_ENTER_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 20000, -1, 1f, 1, 0);
						}
						if (func_205(Local_56.f_28[1]))
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], Local_56.f_28[0], -1);
						...
						if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
						{
							if (bParam0 || (func_214(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], 1)))
							{
								...
								else if (func_214(Local_56.f_35[0]))
								{
									...
									AI::TASK_ENTER_VEHICLE(0, Local_56.f_35[0], 20000, 0, 2f, 1, 0);
									AI::CLOSE_SEQUENCE_TASK(iVar2);
									AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar2);
									AI::CLEAR_SEQUENCE_TASK(&iVar2);
								}
							...
							{
								AI::TASK_ENTER_VEHICLE(Local_56.f_28[2], Local_56.f_35[1], 20000, 0, 1f, 1, 0);
							}
						}
						iLocal_250 = GAMEPLAY::GET_GAME_TIMER() + 1500;
						iLocal_251 = 1;
						iLocal_304 = 3;
						bLocal_266 = false;
					}
...
void func_300()
{
	...
	if (func_205(Local_56.f_28[1]))
	{
		if ((((!func_217(Local_56.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 0))
		{
			AI::OPEN_SEQUENCE_TASK(&iVar0);
			if (func_205(Local_56.f_28[0]))
			{
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[0], 6000);
			}
			if (func_214(Local_56.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[1], -1, 0))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_313, vLocal_314, fLocal_315, 0, true, 1);
				AI::TASK_ENTER_VEHICLE(0, Local_56.f_35[1], 20000, -1, 2f, 1, 0);
			}
			AI::CLOSE_SEQUENCE_TASK(iVar0);
			AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[1], iVar0);
...
void func_303()
{
	switch (iLocal_225)
	{
		case 0:
			...
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_240)
			{
				...
				if (func_338(1, 1093140480, 0))
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_PEDS(-483.5037f, 231.0559f, 82.1456f, 15f, 0);
					GAMEPLAY::CLEAR_AREA_OF_OBJECTS(-483.5037f, 231.0559f, 82.1456f, 15f, 0);
					iLocal_327 = 1;
					iLocal_225 = 1;
				}
			}
		...
		case 1:
			...
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (iLocal_244 && GAMEPLAY::GET_GAME_TIMER() > iLocal_245)
				{
					if (iLocal_245 < 0)
					{
						iLocal_245 = GAMEPLAY::GET_GAME_TIMER() + 4000;
					}
					else
					{
						ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
...
void func_305(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_309(PLAYER::PLAYER_ID())) && !func_307(PLAYER::PLAYER_ID(), 0)) && !func_306()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_309(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_71203 = 0;
...
void func_313()
{
	...
	if (func_205(Local_56.f_28[0]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, sLocal_252, sLocal_267, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[1]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, sLocal_252, sLocal_268, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[2]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, sLocal_252, sLocal_269, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	bLocal_266 = true;
}
...
void func_341()
{
	...
	{
		case 0:
			UI::REQUEST_ADDITIONAL_TEXT("PAP4", 0);
			...
			AI::REQUEST_WAYPOINT_RECORDING(sLocal_316);
			AI::REQUEST_WAYPOINT_RECORDING(sLocal_317);
			...
			if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_takedown_a"), 0);
				GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_takedown_heavy"), 0);
				GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_armed_takedown"), 0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_322, sLocal_324, Local_56.f_41[1], sLocal_323, 0, 0);
				}
				iLocal_225 = 2;
			}
			break;
		...
		case 2:
			...
			else
			{
				...
				if ((CAM::IS_SCREEN_FADED_IN() && func_206(Local_56.f_28[0])) && func_226(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 1) > 6f)
				{
					...
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], -1, 0, 2);
					iLocal_240 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				}
				else
				{
					iLocal_240 = -1;
...
void func_342()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_283, 50f, 0, 0, 0, 0, false, 0);
	func_313();
	if (func_349())
	{
		func_346(0, -1, 1);
...
void func_344(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if (Global_71459 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_357(Global_71460, Global_71462, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_368(0) || Global_71474) || Global_71463 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71459)
...
{
	return func_370(iParam0, Global_36117);
}
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_380(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iVar3, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar4 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_205(uParam0->f_28[1]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0f, 0, 0, 0);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_205(uParam0->f_28[2]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0f, 0, 0, 0);
...
void func_395()
{
	...
	if (func_205(Local_56.f_28[0]))
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 0))
		{
			AI::TASK_WANDER_STANDARD(Local_56.f_28[0], 1193033728, 0);
		}
	}
	if (func_205(Local_56.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[1]))
	{
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				AI::TASK_VEHICLE_DRIVE_WANDER(Local_56.f_28[1], Local_56.f_35[1], 20f, 786597);
			}
	...
	if (func_205(Local_56.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[2]))
	{
		...
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 1))
			{
				...
				if (func_214(iVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 1) || !func_205(Local_56.f_28[0])))
				{
					...
					AI::CLOSE_SEQUENCE_TASK(iVar1);
					AI::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar1);
					AI::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			}
		...
		{
			AI::TASK_WANDER_STANDARD(Local_56.f_28[2], 1193033728, 0);
		}
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_takedown_a"), 1);
	GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_takedown_heavy"), 1);
	GAMEPLAY::_0xA6A12939F16D85BE(GAMEPLAY::GET_HASH_KEY("ACT_armed_takedown"), 1);
	STREAMING::REMOVE_ANIM_DICT(sLocal_252);
	STREAMING::REMOVE_ANIM_DICT(sLocal_255);
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_316))
	{
		AI::REMOVE_WAYPOINT_RECORDING(sLocal_316);
	}
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317))
	{
		AI::REMOVE_WAYPOINT_RECORDING(sLocal_317);
	}
	AUDIO::STOP_SOUND(iLocal_322);
	func_211(&iLocal_57);
	func_223(&(Local_56.f_41[0]), 0);
...
void func_396(var uParam0, int iParam1, int iParam2)
{
	...
	AI::OPEN_SEQUENCE_TASK(&iVar0);
	AI::TASK_PAUSE(0, iParam1);
	if ((iParam2 && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255)) && iLocal_310)
	{
		AI::TASK_PLAY_ANIM(0, sLocal_255, sLocal_257, 8f, -8f, -1, 8192, 0f, 0, 0, 0);
		iLocal_310 = 0;
	}
	AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(iVar0);
...
int func_402()
{
	...
	iVar0 = func_403(&(Global_93232.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_406()
{
	...
	{
		if (func_401(&(Global_93232.f_3)) > -1)
		{
			return 1;
		}
	}
