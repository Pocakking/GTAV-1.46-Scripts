	...
	switch (iLocal_71)
	{
		...
		case 6:
			...
			if (!func_28(2))
			{
				...
				{
					ENTITY::CREATE_MODEL_HIDE(vLocal_58, 200f, -1241212535, 0);
					func_27(2, 1);
				}
			}
			if (func_66() && !func_65())
...
bool func_16(int iParam0)
{
	...
	iVar1 = GAMEPLAY::GET_BITS_IN_RANGE(Global_106070.f_10021.f_133, 0, (iVar0 - 1));
...
void func_27(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&iLocal_78, iParam0);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&iLocal_78, iParam0);
	}
}

bool func_28(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(iLocal_78, iParam0);
}
	...
	switch (iLocal_60)
	{
		...
		case 2:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				INTERIOR::_LOAD_INTERIOR(iLocal_59);
				iLocal_72 = (GAMEPLAY::GET_GAME_TIMER() + 40000);
				while ((!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || !INTERIOR::IS_INTERIOR_READY(iLocal_59)) && iLocal_72 > GAMEPLAY::GET_GAME_TIMER())
				{
					SYSTEM::WAIT(0);
				}
				STREAMING::NEW_LOAD_SCENE_STOP();
				if (iLocal_72 <= GAMEPLAY::GET_GAME_TIMER())
				{
	...
	switch (iLocal_61)
	{
		...
		case 2:
			...
			if (CONTROLS::IS_CONTROL_JUST_PRESSED(2, 51))
			{
				...
				{
					iLocal_72 = GAMEPLAY::GET_GAME_TIMER() + 300;
...
void func_61(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_106070.f_10021.f_133), iParam0);
		if (!bParam2)
		{
	...
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106070.f_10021.f_133), iParam0);
	}
}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_106070.f_10021.f_133, iParam0);
}
...
void func_76(vector3 vParam0)
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("murdermystery")) > 1)
	{
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	iVar0 = 0;
...
void func_77()
{
	switch (iLocal_71)
	{
		...
		case 4:
			func_79(-671910391);
			func_78(sLocal_74);
			iLocal_66 = PED::CREATE_PED(26, -671910391, func_68(4), 184.5548f, 1, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-671910391);
			AI::TASK_PLAY_ANIM(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0f, 0, 0, 0);
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 5:
			if (OBJECT::_DOES_DOOR_EXIST(iLocal_63))
			{
		...
		case 6:
			...
			if (func_28(2))
			{
				ENTITY::REMOVE_MODEL_HIDE(vLocal_58, 200f, -1241212535, false);
			}
			break;
	}
}
